...
- Aggiunto: Il browser Android supporta la traduzione gratuita delle immagini.
...
- Migliorato: Migliorata l'esperienza utente della funzione di anteprima del confronto contestuale.
...
- Ottimizzato il rilevamento delle traduzioni di carte arXiv
...
- Quando gli esperti AI sono utilizzati per "Selezione Intelligente", diversi esperti AI possono essere personalizzati per diversi siti web. Questo può essere impostato in [Impostazioni] -> [Esperti AI] -> [Inserisci qualsiasi esperto].
...
- Ottimizzata la frequenza delle richieste del servizio di traduzione
...
- Ottimizzazione: Regolata la dimensione del carattere dei messaggi di errore di traduzione per migliorarne la leggibilità.
...
- **Supporto linguistico Deepl**: Aggiunto supporto per il portoghese (Brasile).
...
- Risolti problemi di traduzione di Azure
...
- Supporto per sottotitoli di Youtube solo per traduzioni
...
- Risolvere il problema che le immagini su alcune pagine web: diventano più grandi dopo la copia
- Risolvere: la sezione dei commenti di medium non viene tradotta
- Risolvere il problema che le immagini su alcune pagine di: vengono copiate in modo errato
...
- Fix: lo stile di creazione degli eBook non funziona
...
- Fix: problema di carattere specifico del costruttore di ebook, come alcuni percorsi di capitolo sono `xxx' xxxx`.
...
- Fix: limite massimo di token OpenAI, cambia il massimo di caratteri da 1500 a 1300.
...
- Fix: alto uso di memoria per userscripts ed estensione (rimuovendo opencc zh-CN a zh-TW, invece con Google translate)
...
- Feat: Supporto zoom dimensione font personalizzata
...
- Fix mostra caratteristica beta
...
- Fix volc traduci per rilevamento automatico lingua
...
- Fix seleziona popup un servizio non configurato, vai alla pagina opzioni.
...
- Rimuovi contenitore a lato come contenitore di traduzione.
...
- Correggi la corrispondenza regex
...
- Correggi il controllo dell'elemento inline
...
- Supporta la non traduzione degli hashtag come #hash, tag come @xxx, $tag, come $APPL
