...
- [versione beta nello store di Firefox](https://addons.mozilla.org/firefox/addon/immersive-translate-beta/)
- [Github Release Assets](https://github.com/immersive-translate/immersive-translate/releases)

## 1.15.1 Preview (2025-03-02)

- Aggiunto: Il browser Android supporta la traduzione gratuita delle immagini. 【In attesa, necessario attendere il rilascio del browser】
- Aggiunto: Gemini supporta il portoghese (Brasile).
- Aggiunto: Servizi di traduzione Grok, Ollama, Groq, Azure-OpenAI.
...
- Risolto: Problemi di sincronizzazione dei tempi dei sottotitoli su YouTube dopo aver guardato annunci.
...
- Risolto: Problema di traduzione dei caratteri di spazio bianco nel testo ricco [#2175](https://github.com/immersive-translate/immersive-translate/issues/2175).
...
- Risolto: Problema di traduzione del testo arricchito [#2163](https://github.com/immersive-translate/immersive-translate/issues/2163)
...
- Migliorato supporto di input per Baidu, Gmail e altri campi di input
- Supporto per l'intestazione della richiesta anthropic-dangerous-direct-browser-access per Claude Anthropic API
- Supporto per il download di sottotitoli da video Hulu, Bloomberg e Domestika
- DeepX supporta la traduzione di testo arricchito
...
- Ottimizzata la performance della traduzione di testo arricchito.
...
- Ora puoi segnalare rapidamente problemi di traduzione delle pagine web nella sfera fluttuante della traduzione immersiva. Dopo aver tradotto una pagina web, se ci sono problemi, puoi cliccare sul pulsante [Feedback] sul lato destro della sfera fluttuante, compilare la descrizione del problema, e lo gestiremo il prima possibile.
- I file Epub ora supportano la traduzione di testo arricchito (cioè, preservando il formato del testo originale di ogni paragrafo, come link, grassetto, ecc.)
- Supporto per sottotitoli bilingue in tempo reale nelle riunioni video della versione web di Microsoft Teams (Apri il link della riunione Teams, attiva i sottotitoli bilingue nel pannello di traduzione immersiva, e poi aggiorna)
...
- Risolti problemi con la traduzione di testo arricchito per servizi di traduzione come Google, DeepL (ad esempio, pagine che visualizzano direttamente `<button>` ecc.)
...
- Risolto il problema dei sottotitoli bilingue che non funzionano su Mubi.
...
- Nuova funzionalità: traduzione Manga (Beta), nei siti web di manga supportati, un pulsante di traduzione manga apparirà sotto la sfera flottante di traduzione rapida della pagina web. Cliccando su di esso si attiverà la traduzione manga. Questa funzionalità è disponibile per i membri Pro (500 pagine al mese, pacchetti aggiuntivi possono essere acquistati), attualmente supporta i seguenti siti:
...
- Risolto il problema per cui il collegamento rapido della sfera flottante non poteva tradurre su iOS 18.
...
- Risolto il problema per cui la modifica della lingua di destinazione e di altre impostazioni nel pannello popup si resettava al cliccare sulla sfera flottante di traduzione.
...
- Supporto per la traduzione di sottotitoli video [Unreal Sensei](https://www.unrealsenseiacademy.com/)
...
- Supporto per la traduzione di sottotitoli video per [Kanopy](https://www.kanopy.com/), [RachelsEnglishAcademy](https://www.rachelsenglishacademy.com/), [Hulu](https://www.hulu.com/), [Three.js Journey](https://threejs-journey.com/).
...
- Supporto per la traduzione di sottotitoli video sulle piattaforme [LinkedIn](https://www.linkedin.com/) e [Viu](https://www.viu.com/).
...
- Supporto per la traduzione di sottotitoli per YouTube Live e la piattaforma [Mubi](https://mubi.com/).
...
- **Voce di traduzione documenti integrata:** Ora puoi tradurre file PDF, ePub e sottotitoli tramite un'unica voce di caricamento. Basta fare clic sul pulsante [PDF/ePub] nel pannello popup, senza bisogno di selezionare [Altro] più.
...
- **Aggiornamento della Configurazione openAI**: Ora supporta l'impostazione del numero di configurazioni al secondo in decimali, come 0.5, il che significa 1 richiesta ogni 2 secondi.
...
- Corretto: Risolto il problema in cui solo una parte del contenuto scompariva su Hacknews [#1264](https://github.com/immersive-translate/immersive-translate/issues/1264).
...
- Risolto il problema del tremolio della pagina di traduzione della casella di input di reddit
...
- Risolto il problema che alcune piattaforme non riuscivano a riconoscere se il mouse fosse supportato o meno
...
- Le regole personalizzate ora supportano la fusione con le regole predefinite integrate, ad esempio: `{"id": "youtube", "selectors.add":["#test"]}` significa aggiungere un `#test` ai selettori esistenti, `selectors` significa sovrascrivere il predefinito, `selectors.remove` significa eliminare uno dei selettori predefiniti.
...
- Fix: Avanzamento del costruttore di Ebook fermo al 99%.
...
- Feat: Aggiungi avanzamento della traduzione per il costruttore di ebook, e una bella pioggia di coriandoli dopo il successo.
- Feat: Aggiungi riprova a tutti i paragrafi falliti per il pulsante di riprova.
...
- Supporta la non traduzione di hashtag come #hash, tag come @xxx, $tag, come $APPL
