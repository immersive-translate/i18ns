...
- Risolto: Un problema con la traduzione al passaggio del mouse che non funzionava nella modalità "Prima traduzione, segue il testo originale".
...
- Risolto: Problema in cui i file lunghi di PDF-Pro non venivano tradotti automaticamente.
...
- Adottato algoritmo di suddivisione intelligente delle frasi AI per sottotitoli inglesi generati automaticamente su YouTube [Pro Disponibile]
...
- I sottotitoli bilingue di YouTube ora supportano la suddivisione intelligente delle frasi (Beta) (Solo quando si abilita manualmente la traduzione immersiva dei sottotitoli di YouTube in [Impostazioni] - [Sottotitoli Video], e i sottotitoli video originali sono sottotitoli inglesi generati automaticamente)
...
- Supporto per la traduzione di pagine web e sottotitoli video in lingue come l'arabo, l'ebraico, ecc., affrontando problemi di visualizzazione RTL (da destra a sinistra)
...
- **Nuova guida per l'utente**: Quando i nuovi utenti aprono per la prima volta una pagina in una lingua non target, viene visualizzata una bolla di guida di aiuto a sfera mobile.
...
- Riparato il problema in cui i sottotitoli originali del video non venivano visualizzati quando "Il sito corrente è impostato per non tradurre mai".
...
- La traduzione di ebook bilingue tradurrà ora anche l'indice.
- La funzione di Miglioramento della Ricerca (alcune pagine di Google Search mostrano risultati di ricerca bilingue) non è ora abilitata per impostazione predefinita e verrà rimossa nella prossima release.
...
- Ottimizza Grease Monkey, rilevamento della lingua di Safari
...
- Ignora la lingua mai tradotta durante il passaggio del mouse
...
- Risolti i problemi di interruzione dei paragrafi in alcuni casi in:
...
- Feat: Nuova pagina guida per i nuovi utenti.
...
- Fix: Traduzione di documenti PDF
...
- Feat: Consenti a terze parti di inviare eventi di documenti per chiamare `toggleTranslatePage`
...
- Fix: problema di caratteri specifici del costruttore di ebook, come alcuni percorsi di capitoli sono `xxx' xxxx`.
...
- Fix: migliore per dividere lunghi paragrafi, 1.5 miliardi, 25.5%, Mr. non sarà considerato come un confine
...
- Supporta non tradurre gli hashtag come #hash, i tag come @xxx, $tag, come $APPL
