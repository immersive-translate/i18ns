...
- Performance: Escludi alcune pagine pubblicitarie figlio nel sito web, e le prestazioni sono migliorate un po'
...
- Feat: Aggiungi riprova tutti i paragrafi falliti per il pulsante di riprova.
...
- Fix: limite massimo di token OpenAI, cambia max caratteri da 1500 a 1300.
