...
- Risolto: Problema di traduzione di Google con i caratteri di escape.
...
- Risolto: Problemi di visualizzazione con il menu di traduzione del clic destro in Safari su MacOS 15.
...
- Dopo aver selezionato il testo, il menu contestuale cambierà in [Traduci il testo], cliccando sul quale puoi saltare automaticamente alla pagina di traduzione del testo di Immersive Translation
...
- Migliora la performance di traduzione per pagine di contenuto lungo
...
- **Impostazioni dei Tasti di Scorciatoia**: Aggiunto un nuovo menu di livello superiore "Scorciatoie" e le seguenti funzioni di tasti di scorciatoia personalizzabili:
...
- Risolto il problema di download esteso del PDF
...
- Ottimizza la contestualizzazione della traduzione di DeepL
...
- Fix: Problema dell'area di passaggio del mouse.
...
- Fix: postMessage quando la pagina di inizializzazione ha rotto alcuni siti, ora lo faremo solo quando traduciamo davvero le pagine
...
- Fix: errore tag multiplo del codice.[#178](https://github.com/immersive-translate/immersive-translate/issues/178)
...
- Fix: stile globale non cambiato dopo la generazione di elementi dinamici
...
- Fix: corrispondenza url con più \*
...
- Fix traduzione dell'intera pagina, il piè di pagina viene ignorato
...
- Fix problema di caricamento google drive (davvero) [#81](https://github.com/immersive-translate/immersive-translate/issues/81)

## 0.2.49

- Rimuovi scorciatoie alt+d, alt+s perché potrebbero entrare in conflitto con le scorciatoie native.
- Fix problema di caricamento google drive [#81](https://github.com/immersive-translate/immersive-translate/issues/81)
...
- Fix getpocket.com
- Fix piè di pagina a parte per area corpo
