...
La **Release version** è la versione stabile ufficiale, disponibile sui principali app store come
...
- Aggiunto: Supporto al contesto per Deepseek, Gemini, Cluade.
- Risolto: L'aggiornamento dei termini non invia nuove richieste di traduzione.
- Migliorato: Aggiunta della lingua ungherese all'interfaccia.
...
- Migliorato: Filtri per testo sporco nel servizio di traduzione deepl.
...
- Migliorato: Aggiunta un'entrata di revisione del negozio nelle opzioni **More** sul pannello.
...
- Migliorato: Per Twitter, le traduzioni di contenuti multilinea sono impostate per non andare a capo per impostazione predefinita. Il capo avverrà solo quando il contenuto supera le 10 righe o i 1000 caratteri. Il capo può essere abilitato tramite le impostazioni **Advanced Settings** -> **Enable automatic line wrapping for long paragraphs**.
...
- Adottato algoritmo di suddivisione intelligente delle frasi per i sottotitoli inglesi auto-generati su YouTube [Pro Disponibile]
...
- Risolto il problema per cui modificare la lingua di destinazione e altre impostazioni nel pannello popup si resettava cliccando sulla sfera di traduzione.
...
- Ottimizzata la frequenza di controllo delle richieste di servizio di traduzione
...
- Supporto per la traduzione dei nodi tag di input.
...
- **Supporto mobile per la traduzione di paragrafi specifici:** La versione mobile ora supporta la traduzione di paragrafi specificati e ha aggiunto una varietà di operazioni di scorciatoia, tra cui scorrimento a sinistra, scorrimento a destra, doppio tocco, triplo tocco e gesti multi-dito. Questi non sono abilitati per impostazione predefinita e richiedono che l'utente selezioni attivamente il gesto di attivazione nella pagina delle impostazioni sotto [Passaggio del mouse].
- **Aggiornamento versione predefinita Gemini:** La versione predefinita è ora `v1beta`.
- **Risolta traduzione cinese classica:** Risolta la funzionalità di traduzione cinese classica di Microsoft e OpenAI.
- **Ottimizzazione traduzione giapponese:** Ulteriormente ottimizzata la traduzione giapponese di OpenAI per migliorare l'accuratezza e la fluidità.
...
- **Aggiornamento interfaccia utente del pannello popup:** Il nuovo design mira a migliorare l'usabilità e la comprensibilità. Questo aggiornamento include:
  ...
  - **Nuove funzionalità nel menu principale:**
    ...
    - **Impostazioni traduzione video:** L'ingresso per le impostazioni di "Traduzione video" è stato anche posizionato nel menu principale per regolazioni rapide.
...
- **Aggiornamento interfaccia utente della pagina delle impostazioni del plugin**:
...
- Risolto: Risolto il problema per cui solo parte del contenuto scompariva su Hacknews [#1264](https://github.com/immersive-translate/immersive-translate/issues/1264).
...
- Riparato i sottotitoli video originali che non vengono visualizzati quando "Il sito corrente è impostato per non tradurre mai".
...
- Risolto il problema della creazione di eBook Epub dal pannello cliccando sulle traduzioni non funzionanti
...
- Risolto il problema di traduzione di Azure
...
- Supporto per la configurazione dei pulsanti di traduzione rapida della hoverball (supporto sia per PC che per mobile)
...
- Ottimizza la traduzione OpenAI dei file di sottotitoli per la contestualizzazione
...
- Traduzione della casella di input: visualizza un promemoria pop-up quando viene utilizzata per la prima volta e l'utente può scegliere di disabilitarlo temporaneamente o permanentemente per evitare tocchi accidentali.
...
- risoluzione del problema di scorrimento automatico mobile nella lettura online di epub
...
- Risolto il problema che alcuni passaggi giapponesi non venivano tradotti.

## 0.7.9

- PDF supporta finalmente l'esportazione di versioni bilingue! Puoi cliccare sul pulsante [Salva] per esportare il file PDF bilingue tradotto.
...
- Aggiungi cambio di stato dell'icona del browser, quando una pagina web è stata tradotta, verrà aggiunto un ✅ nell'angolo in basso a destra dell'icona del browser automaticamente.
- Abilita automaticamente la traduzione dei siti web inglesi più utilizzati per i nuovi utenti
- Risolvi i problemi di traduzione con https://claude.ai/
...
- Ottimizza gli avvisi di errore
- Ottimizza la selezione della lingua di destinazione, ora mostrerà solo le lingue supportate dal servizio di traduzione corrispondente
- Ottimizzazione della traduzione PDF
...
- Ingrandisci la scala dei piccoli caratteri PDF su Chrome e Safari

## 0.6.15

- Ripara il problema che quando si aprono i file PDF, il pannello dell'estensione avvisa che non ci sono permessi.
...
- Supporto cinese tradizionale e cinese semplificato
...
- Funzionalità: lo stile di traduzione della linea di divisione aggiunge una linea di divisione verticale per le traduzioni su una sola riga
- Risolto: casi molto rari di divisione dei paragrafi.
- Una grande pagina di orientamento alla configurazione iniziale per i nuovi utenti iOS.

## 0.5.11

- Supporto alla traduzione dei sottotitoli per l'esportazione delle traduzioni solo
- Risolto: alcuni elementi non vengono riconosciuti al passaggio del mouse
...
- Corretto il problema che la modifica della scorciatoia del mouse hover richiedeva un aggiornamento della pagina per avere effetto

- Corretto un problema con il riconoscimento dell'interruzione di riga nei file TXT.

- Molti aggiornamenti!

- La funzione 'Mostra solo traduzione' è arrivata! Clicca su 'Altro' -> 'Passa a Mostra solo traduzioni'.
...
- Corretto il problema dello schermo bianco dopo la traduzione di siti web con idratazione, come Next.js

- Corretto il problema in cui la modifica della scorciatoia del mouse hover richiedeva un aggiornamento della pagina per avere effetto

- Corretto il problema con il riconoscimento delle interruzioni di riga nei file TXT.
...
- Funzione: Ristruttura la traduzione PDF, ora puoi tradurre la maggior parte dei PDF con Immersive Translate
...
- Correzione: Evita la Content Security Policy per [Mastondon](https://mastodon.social/)
...
- Correzione: problema dell'estensione safari iOS 15.0.
- Correzione: scorciatoie dell'estensione safari macOS
...
- Correzione: rilevamento degli spazi bianchi dei tag sup, sub.
- Funzione: supporta il sito web ChatGPT Plus come servizio di traduzione, questa è una funzione beta, quindi puoi accedervi abilitando la funzione Beta nelle impostazioni dello sviluppatore. È molto lento, perché chatgpt può inviare solo una richiesta alla volta. Assicurati di avere un account ChatGPT Plus, perché ci sono più limiti sull'account gratuito, e non sono sicuro se questo comporta rischi per il tuo account, fai attenzione ad Assicurati di avere un account ChatGPT Plus, perché ci sono più limiti sull'account gratuito, e non sono sicuro se questo comporta rischi per il tuo account, fai attenzione ad usarlo.
...
- Correzione: postMessage quando la pagina di inizializzazione ha rotto alcuni siti, ora lo faremo solo quando traduciamo davvero le pagine
...
- Correzione: lo stato di input dei servizi di traduzione del switch UI delle opzioni non è cambiato.
...
- Correzione: costruttore di ebook per Kindle
...
- Correzione: interfaccia del modulo delle opzioni
- Correzione: prompt Open AI
- Funzione: Supporta più chiavi OpenAI, usa `,` per dividerle.

## 0.2.80

- Funzione: Aggiungi menu Abilita/Disabilita per popup -> altro
- Correzione: conflitto messaggio DingTalk

## 0.2.79

- Correzione: Open AI per paragrafo di spazio
...
- Fix: errore multiplo del tag code.[#178](https://github.com/immersive-translate/immersive-translate/issues/178)
...
- Feat: Supporto per il conteggio personalizzato del testo di traduzione immediata per diversi servizi di traduzione.

## 0.2.74

- Feat: Supporto Tencent (alpha)
- Fix: traduzione openai
- Fix: controllo inline dei tag sconosciuti

## 0.2.73

- Feat: Supporto Tema di Traduzione Grigio
- Fix: Pagina Trending di Github

## 0.2.72

- Fix: problema di rete del servizio di traduzione su firefox mobile.
...
- Feat: Supporto verifica del servizio di traduzione su options.html
...
- Supporto richiesta di limitazione per più frame
- Non tradurre il titolo della pagina quando in iframe

## 0.2.64

- Fix: scelta dei servizi di traduzione openl
...
- Fix: sincronizzazione google drive nativa firefox android.
...
- Fix traduzione duplicata per elementi inline con elemento code.
...
- Fix traduzione dell'intera pagina, piè di pagina ignorato
- Aggiungi note alla pagina informazioni
- Supporto url personalizzato da Config incorporato

## 0.2.53

- Fix errore di sincronizzazione google drive userscript.
...
- Fix getpocket.com
- Fix piè di pagina aside per area corpo
...
- Fix tag giapponesi rb, rt ignorati.
- Migliore per interfaccia utente popup
...
- Fix problema di richiesta macaque
- Fix altezza linea evidenziata
...
- Fix cambio url client, auto mantenere lo stato di traduzione.
- Rimuovi contenitore aside come contenitore di traduzione.
...
- Fix problema di rimbalzo touch
...
- Supporto Tre Dita su dispositivo Touch per attivare la traduzione delle pagine
...
- Fix escludi elementi segno
- Fix controllo tipo deno
- rimuovi importmap
- Fix traduzione menu contestuali
- ripristina pagina quando mai tradurre questo sito abilitato
- Aggiungi descrizione per aggiungere url

## 0.2.8

- Rileva la lingua dell'agente utente per la lingua dell'interfaccia
- Fix bug interruzione di riga.
...
- Fix
  ...
  problema di corrispondenza url file

## 0.2.5

- aumento versione per test ci

## 0.2.4

- cattura errore di connessione messaggio per popup.
...
- Fix telegra.ph per prevenire il cambiamento degli elementi
...
- Modifica descrizione tema di traduzione
...
- Fix timeout su chrome
- Fix errore di divisione delle frasi.
...
- Fix dimensione del font dell'interfaccia opzioni

## 0.0.50

- Fix traduzione di blocchi img.
...
- fix spazi bianchi pre per alcuni articoli
...
- Aggiungi opzione log di debug per sviluppatori
...
- Supporto per impostare la modalità di traduzione immediata, in modo da poter tradurre la pagina web il più rapidamente possibile.
- Supporto per impostare l'area della pagina che deve essere tradotta, in modo da poter tradurre più aree.
...
- Più interfaccia di configurazione
- Riflette il tema
...
- Fix errore dello userscript Firefox.

## 0.0.23

- Migliore per rilevamento cinese
- Fix problema innerText di reddit
...
- Supporto per interfaccia popup di base
