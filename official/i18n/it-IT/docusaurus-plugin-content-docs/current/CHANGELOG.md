...
- Risolto: Un problema in cui il servizio di traduzione AI emetteva erroneamente cinese semplificato quando traduceva il cinese tradizionale.
...
- Aggiunta l'opzione per "Segnalare problemi di traduzione della pagina web corrente" e l'opzione per "Accendere/spegnere rapidamente il float ball" nelle opzioni aggiuntive del pannello.
...
- Dopo aver selezionato il testo, il menu del clic destro cambierà in [Traduci il testo], cliccando sul quale puoi saltare automaticamente alla pagina di traduzione del testo di Immersive Translation
...
- Supporto per impostare il carattere della traduzione in modalità solo traduzione.
...
- Risolto il problema di traduzione della casella di input di Reddit che causava tremolii della pagina
...
- Risolto il problema per cui alcune piattaforme non potevano riconoscere se il mouse era supportato o meno
  - Ci sono alcuni browser desktop che supportano sia il touchscreen che il mouse, e Immersive Translate non è tecnicamente in grado di rilevare se tali piattaforme supportano il mouse, quindi abbiamo aggiunto l'opzione [Forza Abilita Supporto Mouse] nelle impostazioni [Mouse Hover]
...
- Supporto per i sottotitoli di Youtube solo per le traduzioni
...
- Risolto il conflitto dei sottotitoli di YouTube con il plugin Dual subtitle (la traduzione dei sottotitoli di YouTube di Immersive Translate non è abilitata quando viene rilevato il plugin Dual di YouTube per evitare conflitti)
...
- Risolto: impostazioni delle scorciatoie del passaggio del mouse per lo script utente
...
- Risolto: permesso dello script utente (solo per lo script utente).
...
- Risolto: popup dello script utente di Firefox mancante.
...
- Risolto: popup della Content Security Policy per l'estensione, e in parte per lo script utente.
...
- Risolto: esportazione ebook dello script utente
...
- Correzione: openl scegliere servizi di traduzione
...
- Risolto il problema della distanza tra le righe nei PDF
...
- Risolto il file di esempio PDF
...
- Risolto l'errore di divisione delle frasi.
...
- Risolto l'errore di divisione di tencent.
...
- Supporto per impostare il primo conteggio di x testi da tradurre immediatamente.
