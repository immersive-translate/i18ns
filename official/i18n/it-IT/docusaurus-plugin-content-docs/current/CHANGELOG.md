...
- Aggiunto: Funzione di traduzione della selezione del testo
...
- Aggiunto: La **Traduzione Sottotitoli** in tempo reale ora supporta l'attivazione tramite "pallina fluttuante", disponibile su Zoom, Google Meet e Microsoft Teams.
...
- Aggiunta l'opzione per "Segnalare problemi di traduzione della pagina corrente" e l'opzione per "Accendere/spegnere rapidamente la pallina fluttuante" nelle opzioni aggiuntive del pannello.
...
- I sottotitoli bilingue di YouTube ora supportano la suddivisione intelligente delle frasi (Beta) (Solo quando si abilita manualmente la traduzione immersiva dei sottotitoli di YouTube in [Impostazioni] - [Sottotitoli Video], e i sottotitoli originali del video sono sottotitoli auto-generati in inglese)
...
- Risolti i problemi di layout del testo delle traduzioni di fumetti per le lingue con script latino.
...
- Supportato la visualizzazione di sottotitoli bilingue nella modalità a schermo intero di YouTube su iOS.
...
- **Ingresso di traduzione documenti integrato:** Ora puoi tradurre file PDF, ePub e sottotitoli tramite un ingresso di caricamento unificato. Basta cliccare sul pulsante [PDF/ePub] nel pannello popup, non è più necessario selezionare [Altro].
...
- Risolto il problema di creazione di eBook Epub dal pannello facendo clic sulle traduzioni che non funzionano
...
- Supporta [Abilita Pro Membership](/pricing), che consente agli utenti di godere delle traduzioni Deepl e OpenAI e delle impostazioni di sincronizzazione cloud.
...
- Funzionalità: lo stile di traduzione della linea divisa aggiunge una linea di divisione verticale per le traduzioni su una sola riga
...
- Correzione traduzione dell'intera pagina, piè di pagina ignorato
...
- Correzione maschera toggle userscript
...
- Correzione segno di esclusione frame
...
- La scorciatoia predefinita per attivare la traduzione è stata cambiata in `alt+A`, poiché
...
- Risolto il problema dell'errore dello userscript su Firefox.
