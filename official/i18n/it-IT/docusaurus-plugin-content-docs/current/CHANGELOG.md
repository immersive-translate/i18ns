...
- Ottimizzato: Migliorato il supporto per la traduzione di immagini su alcuni siti web.
...
- Google Meet ora supporta i sottotitoli bilingue per le riunioni in diretta: Ora puoi goderti la funzione di sottotitoli bilingue nelle riunioni di Google Meet. Basta aprire il link della riunione, attivare i sottotitoli bilingue nel pannello di traduzione immersiva e poi aggiornare la pagina per sperimentarlo.
...
- Dopo aver selezionato il testo, il menu contestuale cambierà in [Traduci il testo], cliccando su di esso si può automaticamente passare alla pagina di traduzione del testo di Immersive Translation
...
- Nuova funzionalità: traduzione Manga (Beta), nei siti web di manga supportati, apparirà un pulsante di traduzione manga sotto la sfera flottante di traduzione rapida della pagina web. Cliccandolo si attiverà la traduzione manga. Questa funzionalità è disponibile per i membri Pro (500 pagine al mese, pacchetti aggiuntivi possono essere acquistati), attualmente supporta i seguenti siti:
...
- Aggiunta una configurazione di scorciatoia per [Traduci paragrafo specificato] nel pannello a sfera mobile
...
- **Aggiornamento dell'interfaccia utente del pannello popup:** Il nuovo design mira a migliorare l'usabilità e la comprensibilità. Questo aggiornamento include:
  ...
  - **Nuove funzionalità nel menu principale:**
    ...
    - **Impostazioni di traduzione video:** L'ingresso per le impostazioni di "Traduzione video" è stato posizionato anche nel menu principale per regolazioni rapide.
...
- Risolto problemi di download PDF estesi.
...
- Risolto problemi di traduzione Azure.
...
- Supporto pdf per il download solo delle traduzioni
...
- Supporto per la traduzione dei risultati di Input Enhanced Support ctrl+z Undo
...
- Risoluzione di bug del web of science
...
- Funzione: Lo stile di traduzione con linea di divisione aggiunge una linea di divisione verticale per le traduzioni su una sola riga
...
- Risolto: problema di stile di lettura online eBook non funzionante
...
- Risolto: popup userscript mancante su Firefox.
...
- Risolto: scorciatoie estensione safari macOS
...
- Funzione: supporta ChatGPT Plus Website come servizio di traduzione, questa è una funzione beta, quindi puoi accedervi abilitando la funzione Beta nelle impostazioni dello sviluppatore. È molto lento, perché chatgpt può inviare solo una richiesta alla volta. Assicurati di avere un account ChatGPT Plus, perché ci sono più limiti sull'account gratuito, e non sono sicuro se questo comporti rischi per il tuo account, fai attenzione ad usarlo.

## 0.4.1

- Risolto: menu contestuale di Firefox scomparso dopo il riavvio.
...
- Funzione: Aggiungi progresso di traduzione per il costruttore di ebook, e una bella pioggia di coriandoli dopo il successo.
- Funzione: Aggiungi riprova per tutti i paragrafi falliti per il pulsante di riprova.
...
- Fix: Open AI per paragrafo con spazio
...
- Feat: Supporto per conteggio testo di traduzione immediata personalizzato per diversi servizi di traduzione.
...
- Fix: problema di rete del servizio di traduzione verifica su firefox mobile.
...
- Feat: supporto css iniettato su developer board
...
- Fix getpocket.com
- Fix footer a lato per area corpo
...
- Cambia evidenziazione in segna
...
- Supporto Tre Dita su dispositivo Touch per attivare/disattivare pagine di traduzione
...
- abilita tutti i siti per rilevare la lingua del paragrafo.
