...
- Aggiunto: Servizi di traduzione OpenRouter
- Risolto: Problema in cui alcuni paragrafi non venivano tradotti durante la traduzione delle pagine web
- Risolto: Problema di fusione dei sottotitoli di Netflix
- Compatibile: Problema di visualizzazione dei sottotitoli di YouTube su Mac "360 Extreme Browser Pro"
...
- Risolto: Problema di traduzione dei sottotitoli di Google Meet e Microsoft Teams.
...
- Nuovo: La traduzione gratuita delle immagini è ora disponibile (attualmente supportata solo su versioni PC dei browser Chrome ed Edge), accessibile tramite il menu contestuale.
...
- Migliorato: Migliorate le descrizioni per la lingua dell'interfaccia in cinese tradizionale.
...
- Aggiunto: La **Subtitles Translation** in tempo reale per le riunioni ora supporta l'attivazione tramite "float ball", disponibile su Zoom, Google Meet e Microsoft Teams.
...
- Aggiunto: Modalità Forece Enable Mouse Support (Abilita questa funzione solo se la funzione di passaggio del mouse non è disponibile su dispositivi tablet) **Settings** -> **Advanced Settings** -> **Forece Enable Mouse Support**
...
- Risolto un problema in cui [Advanced Settings -> Minimum number of characters required for translating a paragraph] non aveva effetto in alcuni casi

## 1.8.4 (2024-08-30)

- Il servizio di traduzione DeepL ora supporta ufficialmente il cinese tradizionale come lingua di destinazione (in precedenza, tradurre in cinese tradizionale con DeepL comportava un ulteriore processo di conversione da cinese semplificato a tradizionale di terze parti).
...
- Adottato algoritmo di suddivisione intelligente delle frasi AI per i sottotitoli generati automaticamente in inglese su YouTube [Pro Disponibile]
...
- Supporto per la personalizzazione degli esperti AI, l'ingresso è in fondo alla pagina [Settings]->[AI Expert].
...
- I sottotitoli bilingue di YouTube ora supportano la suddivisione intelligente delle frasi (Beta) (Solo quando si abilita manualmente la traduzione immersiva dei sottotitoli di YouTube in [Settings] - [Video Subtitles], e i sottotitoli video originali sono sottotitoli generati automaticamente in inglese)
...
- Risolti i problemi di layout delle traduzioni di fumetti per le lingue con script latino.
...
- Risolto il problema per cui la scorciatoia della sfera fluttuante non poteva tradurre su iOS 18.
...
- Risolto il tempo di sincronizzazione multi-dispositivo degli utenti Pro non sincronizzato
...
- Risolto il problema per cui la dimensione del font non si ridimensionava proporzionalmente quando YouTube è a schermo intero [#1681](https://github.com/immersive-translate/immersive-translate/issues/1681)
...
- Ottimizzati i popup di errore, i popup di errore per problemi di rete rilevano automaticamente i servizi di traduzione gratuiti validi.
...
- Supporto per la traduzione dei sottotitoli video su piattaforme come [LinkedIn](https://www.linkedin.com/) e [Viu](https://www.viu.com/).
...
- Supporto per impostare il font della traduzione in modalità solo traduzione.
...
- Aggiunta una configurazione di scorciatoie per [Traduci paragrafo specificato] nel pannello a sfera mobile sui dispositivi mobili.
...
- **Sottotitoli Bilingue su YouTube:** Aggiunto un accesso rapido nella finestra di riproduzione video di YouTube per abilitare o nascondere i sottotitoli bilingue (questa funzione può essere disattivata).
...
- Ottimizzato: Quando si utilizza il passaggio del mouse, il problema per cui perdere il focus sulla pagina e poi riattivare diventa inefficace.
...
- Risolto il problema di traduzione della casella di input di Reddit
...
- Modifica della condivisione bilingue (modalità di aggiornamento) aggiunta nell'ultima versione alla condivisione di snapshot di pagina bilingue, in modo che il contenuto condiviso sia più originale, oltre a una maggiore adattabilità.
...
- Risolto il problema di traduzione della chiave di autenticazione personalizzata di DeepL
...
- Ottimizzazione del problema delle traduzioni di OpenAI che aggiungono punti senza motivo, (se non viene rilevato alcun punto nel testo originale, se openai restituisce un punto, allora viene rimosso)
...
- Le funzionalità sono in gran parte invariate (nuove funzionalità saranno disponibili nella prossima release!)
...
- Risolto: impostazioni delle scorciatoie del passaggio del mouse dello userscript
...
- Risolto: lo stato di input dei servizi di traduzione dell'interruttore UI delle opzioni non cambiato.
...
- Risolto: Gestione errori di Deepl
...
- Funzionalità: Supporto traduzione pagina web txt
...
- Correzione: alcuni siti usano `span` per gli stili, quindi usiamo `font` invece di span per il wrapper di destinazione della traduzione
...
- Funzionalità: Supporto frame principale personalizzato perché alcuni siti non usano il body come frame principale
...
- Funzionalità: Supporto zoom dimensione carattere personalizzato
...
- Correzione traduzione dell'intera pagina, il footer è ignorato
...
- Correzione innerText elemento è undefined
- Correzione traduzione caiyun lingua sorgente undefined
...
- Correzione footer a parte per area corpo
...
- Correzione tag rb, rt giapponese ignorato.
- Migliore per popup ui più
...
- Correzione altezza linea evidenziata segno
...
- Correzione cambio url client, rimane automaticamente lo stato di traduzione.
- Rimuovi contenitore a parte come contenitore di traduzione.
- Refactoring posizione popup.
...
- Risolto il problema della versione compatta mobile di reddit
...
- aggiunto supporto mobile per reddit
...
- Risolto il problema del vuoto su Wikipedia
...
- La scorciatoia predefinita per attivare/disattivare la traduzione è stata cambiata in `alt+A`, perché
