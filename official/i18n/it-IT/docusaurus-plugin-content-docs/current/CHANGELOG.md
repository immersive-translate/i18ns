...
- Ottimizzato: Migliorato il supporto per la traduzione di immagini su determinati siti web.
...
- Nuovo: La traduzione gratuita delle immagini è ora disponibile (attualmente supportata solo sulle versioni PC dei browser Chrome ed Edge), accessibile tramite il menu contestuale.
...
- Migliorato: **Image Translation** è ora compatibile con weibo.com (supportato solo su Chrome ed Edge).
...
- Migliorato: Aggiunta una voce di revisione dello store nelle opzioni **More** sul pannello.
...
- Migliorato: Miglioramento dell'input e funzionalità di passaggio del mouse all'interno di iframe incorporati nelle pagine web
...
- Aggiunto: Visualizza messaggio di errore quando la traduzione dei sottotitoli video fallisce
...
- Google Meet ora supporta sottotitoli bilingue per riunioni dal vivo: Ora puoi goderti la funzione di sottotitoli bilingue nelle riunioni di Google Meet. Basta aprire il link della riunione, attivare i sottotitoli bilingue nel pannello di traduzione immersiva e poi aggiornare la pagina per sperimentarlo.
- Aggiunta l'opzione per "Segnalare problemi di traduzione della pagina corrente" e l'opzione per "Attivare/disattivare rapidamente la sfera fluttuante" nelle opzioni più del pannello.
...
- A causa delle restrizioni del sito web di Youtube, lo script Chrome Tampermonkey non supporta più i sottotitoli bilingue di Youtube. Si prega di utilizzare la [versione del plugin](https://immersivetranslate.com/).
...
- Dopo aver selezionato il testo, il menu del clic destro cambierà in [Traduci il testo], cliccando su di esso puoi saltare automaticamente alla pagina di traduzione del testo di Immersive Translation
- Nuovo servizio di traduzione gratuito per grandi modelli: SiliconCloud, disponibile per tutti gli utenti.
- Aggiunta traduzione del grande modello Zero-One-Thing, che può essere utilizzata compilando l'API Key dopo la registrazione sulla piattaforma Zero-One-Thing.
...
- Adotta l'algoritmo di suddivisione intelligente delle frasi AI per i sottotitoli generati automaticamente in inglese su YouTube [Pro Disponibile]
...
- I sottotitoli bilingue di YouTube ora supportano la suddivisione intelligente delle frasi (Beta) (Solo quando si abilita manualmente la traduzione immersiva dei sottotitoli di YouTube in [Impostazioni] - [Sottotitoli Video], e i sottotitoli video originali sono sottotitoli generati automaticamente in inglese)
- Aggiunto servizio di traduzione Tencent [【Hunyuan Large Model】](https://immersivetranslate.com/docs/services/tencent-hunyuan/)

## 1.6.5

- Risolvi i problemi di layout del testo delle traduzioni di fumetti per le lingue nel sistema di scrittura latino.
...
- Risolto il problema in cui i sottotitoli non venivano visualizzati su YouTube in modalità "Solo Traduzione".
...
- Nuova funzionalità: traduzione Manga (Beta), nei siti web di manga supportati, un pulsante di traduzione manga apparirà sotto la sfera fluttuante di traduzione rapida della pagina web. Cliccando su di esso si attiverà la traduzione manga. Questa funzionalità è disponibile per i membri Pro (500 pagine al mese, pacchetti aggiuntivi possono essere acquistati), attualmente supporta i seguenti siti:
...
- Ottimizzati i prompt multipli di OpenAI, supportando il formato YAML, che migliora la flessibilità e la facilità d'uso della configurazione
...
- **Aggiornamento dell'interfaccia utente del pannello popup:** Il nuovo design mira a migliorare l'usabilità e la comprensibilità. Questo aggiornamento include:
  ...
  - **Nuove funzionalità nel menu principale:**
    ...
    - **Voce di traduzione documenti:** La voce per tradurre "file PDF/ePub/sottotitoli" è stata spostata nel menu principale per un accesso rapido.
    - **Impostazioni di traduzione video:** La voce per le impostazioni di "Traduzione video" è stata anch'essa posizionata nel menu principale per regolazioni rapide.
    - **Nuova voce per la documentazione d'uso:** Fornisce guide operative dettagliate e documenti di aiuto.

- **Voce di traduzione documenti integrata:** Ora puoi tradurre file PDF, ePub e sottotitoli tramite un'unica voce di caricamento. Basta cliccare sul pulsante [PDF/ePub] nel pannello popup, senza bisogno di selezionare [Altro] più.
...
- Risolto il problema di anomalia di visualizzazione del plugin mobile quando si aprono pagine PDF.
...
- Aggiunti sottotitoli bilingue per supportare le piattaforme [TED](https://www.ted.com), [Frontend Masters](https://frontendmasters.com/), [edx](https://www.edx.org/), [CodeWithChris](https://www.edx.org/), [Skillshare](https://www.ted.com) piattaforme. https://learn.codewithchris.com/enrollments), [Skillshare](https://www.skillshare.com/) Piattaforme
...
- La funzione di miglioramento della ricerca (alcune pagine di Google Search visualizzano risultati di ricerca bilingue) ora non è abilitata per impostazione predefinita e verrà rimossa nel prossimo rilascio.

## 0.12.5

- Risolto il problema della creazione di eBook Epub dal pannello facendo clic sulle traduzioni non funzionanti
...
- Modifica la condivisione bilingue (modalità di aggiornamento) aggiunta nell'ultima versione alla condivisione di snapshot di pagina bilingue, in modo che il contenuto condiviso sia più originale, oltre a una maggiore adattabilità.
- Risolto il problema degli emoji alla fine della casella di input di Twitter che non possono essere tradotti
- Risolto il problema in cui il contenuto dei plug-in di terze parti viene tradotto in alcuni scenari
...
- Risolto il conflitto dei sottotitoli di Youtube con il plugin dei sottotitoli doppi (la traduzione dei sottotitoli di Youtube di Immersive Translate non è abilitata quando viene rilevato il plugin Youtube Dual per evitare conflitti)
...
- Risolto il problema della traduzione della chiave di autenticazione personalizzata DeppL
...
- Ottimizza la contestualizzazione della traduzione DeepL
- Ottimizza la contestualizzazione della traduzione dei file di sottotitoli di OpenAI

## 0.10.1

- Aumentare la priorità della traduzione del corpo per ottimizzare l'esperienza di traduzione
- Risolvere il problema del testo non tradotto quando si fa clic su "ins more"
...
- Correggere la traduzione automatica quando readwise è evidenziato
...
- Correzione: problema di traduzione di tutte le regioni di Gmail
...
- Risolvere: dettagli di Github non tradotti dopo l'espansione.

## 0.5.14

- Risolvere il problema che le immagini su alcune pagine web di: diventano più grandi dopo la copia
- Risolvere: sezione commenti di medium non tradotta
...
- Fix: Casi molto rari di divisione dei paragrafi.
...
- Fix: le interruzioni di riga parziali nei tweet non sono riconosciute
- Fix: lo stile di creazione di eBook non funziona

## 0.5.10

- Fix: le interruzioni di riga nei tweet non sono riconosciute
...
- Risolve le interruzioni di paragrafo in alcuni casi in:
...
- Ristrutturazione del parsing del core web, il che significa:
  ...
  - Traduzione di pagine web su larga scala in pochi secondi
    - Ad esempio,: https://pve.proxmox.com/pve-docs/pve-admin-guide.html, che prima richiedeva 30 secondi, ora viene capovolta in pochi secondi.
...
- Fix: Traduzione documento PDF
- Feat: Aggiungi nuova pagina guida per il cliente

## 0.5.2

- Fix: impostazioni scorciatoie del passaggio del mouse per userscript
...
- Fix: Popup mancante per Userscript su Firefox.

## 0.4.6

- Feat: Consenti a terze parti di inviare eventi di documento per chiamare `toggleTranslatePage`
- Feat: App iOS aggiunge pulsante di abilitazione estensione e link alle comunità
- UI: Il modello del campo delle impostazioni OpenAI utilizza la selezione invece della casella di input del testo.

## 0.4.5

- Fix: Problema di estensione safari su iOS 15.0.
- Fix: Scorciatoie estensione safari su macOS
...
- Feat: Supporta la traduzione di file di sottotitoli locali (.srt,.ass,etc.)
...
- Feat: Ora possiamo personalizzare il colore di sfondo del tema di traduzione del Marker.
- Fix: postMessage quando la pagina di avvio ha rotto alcuni siti, ora lo faremo solo quando traduciamo davvero le pagine
- Fix: problema di progresso dell'ebook.
- Fix: migliore per dividere un lungo paragrafo, 1.5 miliardi, 25.5%, Mr. non sarà considerato come un confine
...
- Fix: Progresso del costruttore di Ebook fermo al 99%.

## 0.3.9

- Fix: lo stato di input dei servizi di traduzione del commutatore UI delle opzioni non è cambiato.
...
- Fix: Spostamento del cursore di input del modulo delle opzioni.
...
- Fix: Alcuni siti utilizzano `span` per gli stili, quindi utilizziamo `font` invece di span per l'involucro del target di traduzione
...
- Fix visualizzazione caratteristica beta
...
- Supporto abilitazione caratteristica beta nel pannello sviluppatore
...
- Fix tag giapponese rb, rt ignora.
...
- incrementa la versione per il test ci
...
- refactoring del segno dell'elemento
...
- Supporta il non tradurre gli hashtag come #hash, i tag come @xxx, $tag, come $APPL
