...
- Aggiunta l'opzione per "Segnalare problemi di traduzione della pagina web corrente" e l'opzione per "Attivare/disattivare rapidamente il float ball" nelle opzioni più del pannello.
...
- Risolto il problema per cui il collegamento della sfera flottante non poteva tradurre sotto iOS 18.
...
- Risolto il conflitto dei sottotitoli di Youtube con il plugin dei sottotitoli doppi (Immersive Translate della traduzione dei sottotitoli di Youtube non è abilitato quando viene rilevato il plugin Youtube Dual per evitare conflitti)
...
- Supporta [Enable Pro Membership](/pricing), che consente agli utenti di godere delle traduzioni Deepl e OpenAI e delle impostazioni di sincronizzazione cloud.
...
- Risolto: lo stile di creazione eBook non funzionante
...
- Risolte le interruzioni di paragrafo in alcuni casi in:
...
- Risolto: problema dell'area di passaggio del mouse.
...
- Risolto: impostazioni delle scorciatoie per il passaggio del mouse nello userscript
...
- Risolto: il menu contestuale di Firefox scompariva dopo il riavvio.
...
- Funzione: aggiungi opzioni di tempo di traduzione temporanea del sito web in `Impostazioni avanzate`
...
- Migliore per suggerimenti userscript cattivi
...
- Supporto per controllare la nuova versione
