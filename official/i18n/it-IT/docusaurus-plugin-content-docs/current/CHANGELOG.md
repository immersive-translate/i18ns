...
- Risolto: Un problema con la traduzione al passaggio del mouse che non funzionava nella modalità "Traduzione prima, testo originale segue".
...
- Ottimizzato: Migliorato il supporto per la traduzione delle immagini su determinati siti web.
...
- Risolto: Dopo aver cambiato i servizi di traduzione, il servizio di traduzione nella "**Enhanced Input Box**" non si aggiorna.
...
- ~~Migliorato: Aggiunta l'opzione per personalizzare la "**Enable Sidebar & Navbar Translation**" nelle "**Advanced Settings**".~~
...
- Risolto: Problemi di visualizzazione con il menu di traduzione contestuale in Safari su MacOS 15.
- Risolto: Problemi con la funzionalità di annullamento Ctrl+Z nell'**Enhanced input** su determinati siti web.
...
- Aggiunto: Visualizzare un avviso quando la lingua di origine e la lingua di destinazione sono le stesse
...
- Migliorato: Miglioramento dell'input e funzionalità di passaggio del mouse all'interno di iframe incorporati sulle pagine web
...
- Aggiunto: Visualizzare un messaggio di errore quando la traduzione dei sottotitoli video fallisce
...
- Rimosso: Modello "SiliconCloud" qwen1.5-7B-chat (a causa della cessazione ufficiale)
- Risolto: Risolto problema di compatibilità di accesso con il plugin Safari su macOS 15

## 1.9.7 (2024-09-20)

- Supporto migliorato per l'input in Baidu, Gmail e altri campi di input
...
- Il servizio di traduzione DeepL ora supporta ufficialmente il Cinese Tradizionale come lingua di destinazione (in precedenza, tradurre in Cinese Tradizionale con DeepL comportava un processo di conversione aggiuntivo da Cinese Semplificato a Cinese Tradizionale di terze parti).
...
- Aggiunta l'opzione per "Segnalare problemi di traduzione della pagina corrente" e l'opzione per "Attivare/disattivare rapidamente la sfera fluttuante" nelle opzioni aggiuntive del pannello.
...
- Le impostazioni di scelta rapida ora consentono di assegnare tasti di scelta rapida unici per qualsiasi servizio di traduzione
- Ottimizzato il rilevamento delle traduzioni di articoli arXiv
...
- Dopo aver selezionato il testo, il menu del clic destro cambierà in [Traduci il testo], cliccando su di esso si può automaticamente passare alla pagina di traduzione del testo di Immersive Translation
- Nuovo servizio di traduzione gratuito per grandi modelli: SiliconCloud, disponibile per tutti gli utenti.
- Aggiunta la traduzione del grande modello Zero-One-Thing, che può essere utilizzata compilando l'API Key dopo la registrazione sulla piattaforma Zero-One-Thing.
...
- Supporto per la traduzione dei sottotitoli delle riunioni della versione web di ZOOM
...
- Nuova funzionalità: traduzione di manga (Beta), nei siti web di manga supportati, un pulsante di traduzione di manga apparirà sotto la sfera fluttuante di traduzione rapida della pagina web. Cliccando su di esso si attiverà la traduzione di manga. Questa funzionalità è disponibile per i membri Pro (500 pagine al mese, pacchetti aggiuntivi possono essere acquistati), attualmente supporta i seguenti siti:
...
- Risolto il problema per cui i Prompts personalizzati erano inefficaci quando se ne usavano troppi.
...
- Risolto il problema per cui modificare la lingua di destinazione e altre impostazioni nel pannello popup si resettava cliccando sulla sfera fluttuante di traduzione.
...
- Ottimizzato significativamente le prestazioni di traduzione di grandi pagine web, creazione di ePub e file di sottotitoli.
- Risolto il bug della sincronizzazione multi-dispositivo in Pro.

## 1.5.4

- I membri Pro supportano i servizi di traduzione Claude e Gemini pronti all'uso (Beta)
...
- Risolto il problema delle dimensioni del font che non si scalavano proporzionalmente quando YouTube è a schermo intero [#1681](https://github.com/immersive-translate/immersive-translate/issues/1681)
...
- Risolto il problema della finestra di dialogo dei messaggi non tradotta quando si apre la pagina di Reddit
...
- Ottimizza le prestazioni di traduzione per grandi file in PDF-Pro
...
- Ottimizzata ulteriormente la velocità di traduzione dei sottotitoli di YouTube
...
- Il pannello passa a visualizzare solo il pulsante di traduzione modificato per avere effetto solo sulla pagina corrente
...
- Supporto per la traduzione di pagine web e sottotitoli video in lingue come l'arabo, l'ebraico, ecc., affrontando i problemi di visualizzazione RTL (da destra a sinistra)
- Risolto il problema della traduzione di Gemini in ebraico
- Risolto un problema in cui alcuni sottotitoli in cinese tradizionale su YouTube non potevano essere visualizzati correttamente
...
- Risolto il problema in cui i segnaposto nella creazione di ePub non venivano sostituiti correttamente
...
- Risolto il problema in cui la configurazione del colore del testo non supportava l'anteprima RGBA [#1435](https://github.com/immersive-translate/immersive-translate/issues/1435)
- Risolto il problema in cui l'aggiornamento della versione del plugin Safari richiedeva sempre la pagina di successo dell'installazione
- Microsoft ha aggiunto il supporto per il vietnamita
- Risolto il problema in cui i sottotitoli tradotti sul sito edx non venivano visualizzati
...
- Risolto il problema di traduzione del paragrafo con Perplexity.ai [#707](https://github.com/immersive-translate/immersive-translate/issues/707).
...
- Risolto un problema in cui alcuni utenti Pro non potevano modificare le impostazioni nel browser Chrome.
...
- Risolto un problema in cui la pagina delle impostazioni continuava a mostrare il caricamento in alcuni casi su Safari.
...
- Ottimizzazione: Pagina delle impostazioni, interfaccia utente della lista URL (per evitare ambiguità, le caselle di controllo non sono visualizzate per impostazione predefinita).
...
- Risolto: Alcuni stili tradotti (come le sottolineature) non erano efficaci in Safari.
- Risolto: Durante la traduzione della pagina, il problema in cui il passaggio del mouse non attivava la ritraduzione.
...
- **Esperienza di traduzione immersiva:** Per adattarsi meglio alle abitudini degli utenti, abbiamo spostato la scorciatoia per i sottotitoli bilingue in modalità a schermo intero sulla piattaforma YouTube sul lato sinistro.

## 1.1.5

- Risolto il problema in cui il menu a discesa in modalità scura su Windows non aveva colore.
...
- **Voce di traduzione documenti integrata:** Ora puoi tradurre file PDF, ePub e sottotitoli tramite un ingresso di caricamento unificato. Basta cliccare sul pulsante [PDF/ePub] nel pannello popup, senza bisogno di selezionare [Altro] più.
...
- Risolto il problema in cui la traduzione dei campi di input contenenti URL traduceva solo parti del contenuto.

## 1.1.2

- Risolto: Il problema in cui il cambio di servizi di traduzione non aveva effetto quando la pagina non era ancora stata tradotta.
- Ottimizzazione: Nel processo di traduzione di Epub e PDF, se alcuni contenuti non riescono a essere tradotti, ora è possibile passare a un altro servizio di traduzione sul pannello senza riavviare l'intero processo di traduzione (la logica precedente era di utilizzare immediatamente un nuovo servizio di traduzione per ritradurre l'intero libro). Ciò significa che a metà della traduzione, puoi passare a un diverso servizio di traduzione e cliccare su [Riprova tutti i paragrafi non riusciti], dopodiché il sistema continuerà la traduzione utilizzando il nuovo servizio.
...
- **Impostazioni dei Tasti di Scorciatoia**: Aggiunto un nuovo menu di primo livello "Scorciatoie" e le seguenti funzioni di tasti di scorciatoia personalizzabili:
  ...
  - Aggiunti tasti di scorciatoia dedicati per 6 servizi di traduzione (come DeepL, OpenAI, Google, Microsoft, Gemini, Tencent Interactive Translation) per facilitare il passaggio temporaneo tra i servizi di traduzione.
...
- Correzione: Problema di riconoscimento della lingua di destinazione predefinita su alcune macchine dopo la prima installazione.
...
- Ottimizzato: Quando si utilizza il passaggio del mouse, il problema in cui si perde il focus sulla pagina e poi si riattiva diventa inefficace.
- Corretto: Il problema in cui la cache esiste ancora dopo aver modificato il prompt/modello in OpenAI.
...
- Ottimizzato: Imposta automaticamente la lingua di destinazione in base alla lingua del browser.
...
- Corretto: Risolto il problema in cui i titoli sulla pagina dell'elenco jstor non venivano tradotti [#1268](https://github.com/immersive-translate/immersive-translate/issues/1268).
- Corretto: Risolto il problema in cui solo parte del contenuto scompariva su Hacknews [#1264](https://github.com/immersive-translate/immersive-translate/issues/1264).
...
- Corretto il problema di autorizzazione del dominio Gemini sotto lo script Tampermonkey.
...
- Corretto il problema in cui le traduzioni non rispondevano in tempo quando la pagina web veniva scorsa fino alla posizione centrale in alcuni casi.
- Corretto il bug in cui l'interruttore dei sottotitoli su alcuni siti video causava la visualizzazione ripetuta della traduzione.
- Corretto il problema in cui il mouse passava sopra per continuare a tradurre senza tenere premuto il tasto di scelta rapida in alcuni casi.
...
- Corretto [Quando si attiva temporaneamente la traduzione della pagina web per un lungo periodo, facendo clic sul pannello [Traduci sempre questo sito web] non si annulla la traduzione sempre #1172](https://github.com/immersive-translate/immersive-translate/issues/1172)
...
- Corretto il problema di clic tremolante del pannello di azione hoverball della pagina di Firefox.
- Supporto per la collaborazione sotto il sito pubmed.ncbi.nlm.nih.gov e il plugin scholarscope
- Corretto il problema di tremolio della pagina di traduzione della casella di input di reddit

## 0.12.6

- Corretto il problema che la traduzione di YouTube/Web of Science ecc. non è sensibile quando si cambiano le schede.
...
- La funzione di Miglioramento della Ricerca (alcune pagine di Google Search visualizzano risultati di ricerca bilingue) ora non è abilitata per impostazione predefinita e verrà rimossa nella prossima release.

## 0.12.5

- Corretto il problema di creazione di eBook Epub dal pannello facendo clic sulle traduzioni non funzionanti
...
- [Correggi problema di visualizzazione della modalità di apprendimento #1180](https://github.com/immersive-translate/immersive-translate/issues/1180)
...
- Corretto alcuni problemi di miglioramento della casella di input sotto Safari
...
- Modifica la condivisione bilingue (modalità di aggiornamento) aggiunta nella versione precedente alla condivisione di snapshot di pagina bilingue, in modo che il contenuto condiviso sia più originale, oltre a una maggiore adattabilità.
- Corretto emoji alla fine della casella di input di Twitter che non può essere tradotto
- Corretto la situazione in cui il contenuto di plug-in di terze parti viene tradotto in alcuni scenari
- Riparato clic non reattivo della hoverball PDF online
...
- Ottimizza l'esperienza, correggi alcuni bug
...
- Corretto clic tremolante della hoverball della pagina
- Correzione dei problemi di traduzione di Azure

## 0.10.9

- Corretto alcuni problemi minori
...
- Corretto la traduzione del file txt

## 0.10.7

- Supporto per il passaggio del mouse premere nuovamente Ctrl per mostrare il testo originale
...
- Corretto il problema che i file txt locali non possono essere tradotti

## 0.10.5

- Corretto Youtube che occasionalmente ritorna alla homepage

## 0.10.4

- Corretto conflitto di sottotitoli di Youtube con il plugin Dual subtitle (Immersive Translate della traduzione dei sottotitoli di Youtube non è abilitato quando viene rilevato il plugin Dual di Youtube per evitare conflitti)
- Aggiunta [Funzione Disabilita Permanentemente Sottotitoli Video], se ci sono altri problemi di conflitto e non si desidera abilitare la funzione di sottotitoli bilingue con Immersive Translate.
- Ottimizza le interruzioni dei sottotitoli

## 0.10.3

- Corretto problema di traduzione della chiave di autenticazione personalizzata DeppL
...
- Aumentare la priorità della traduzione del corpo per ottimizzare l'esperienza di traduzione
- Risolvere il problema del testo non tradotto quando si fa clic su "ins"

## 0.9.8

- Ottimizzare l'esperienza, correggere alcuni bug

## 0.9.7

- Risolvere il problema della traduzione automatica quando readwise è evidenziato
...
- Ottimizzare il rilevamento del miglioramento dell'input per ridurre i tocchi accidentali
- Traduzione di e-book e sottotitoli online

## 0.9.3

- Traduzione della casella di input: visualizza un promemoria pop-up quando viene utilizzata per la prima volta, e l'utente può scegliere di disabilitarla temporaneamente o permanentemente per evitare tocchi accidentali.
...
- Risolvere i problemi di nome file con la creazione di ebook Epub
...
- Risolvere il problema di accesso a Google su Safari
...
- Il servizio di traduzione della casella di input può essere impostato separatamente
...
- Disabilitare temporaneamente la funzione di esportazione PDF di Safari a causa della restrizione di Safari sui download dei plug-in (bug).
- Risolvere alcuni altri problemi

## 0.7.10

- Aggiornamento dell'interfaccia utente del pannello dell'icona del browser popup, un po' più di design ～
- Risolve il problema che alcuni passaggi in giapponese non vengono tradotti.

## 0.7.9

- Finalmente il PDF supporta l'esportazione di versioni bilingue! Puoi fare clic sul pulsante [Salva] per esportare il file PDF bilingue tradotto.
...
- Abilitare automaticamente la traduzione di siti web inglesi frequentemente utilizzati per i nuovi utenti
- Risolvere i problemi di traduzione con https://claude.ai/
...
- Risolvere il problema dell'icona di Grease Monkey non visualizzata
...
- Modificare le impostazioni predefinite: A causa del feedback di un gran numero di utenti che non utilizzeranno lo strumento di traduzione dopo l'installazione, la loro aspettativa dello strumento di traduzione è che traduca automaticamente le pagine web in inglese dopo l'installazione, quindi da questa versione in poi, per gli utenti cinesi, l'opzione di tradurre le pagine in inglese per impostazione predefinita è stata attivata (se l'utente ha avuto una precedente impostazione della lingua che verrà sempre tradotta, allora verrà rispettata, e la modifica modifica solo le impostazioni iniziali dell'estensione), e deve essere annullata, può essere facilmente annullata nel [pannello popup o nella pagina delle impostazioni](/docs/faq/#%E5%A6%82%E4%BD%95%E5%85%B3%E9%97%AD%E8%87%AA%E5%8A%A8%E7%BF%BB%E8%AF%91)

## 0.6.19

- Risolvere i bug PDF
- Risolvere il bug del web of science
- Adattamento feeder.com
- Risolvere il problema di epub che non traduce alcuni libri

## 0.6.18

- Risolvere il problema di overflow della larghezza del popup di Safari.
- Ottimizzazione del processo di costruzione

## 0.6.17

- Ottimizzare gli avvisi di errore
- Ottimizzare la selezione della lingua di destinazione, ora mostrerà solo le lingue supportate dal servizio di traduzione corrispondente
- Ottimizzazione della traduzione PDF
- Adattato per il sito web Good Reads, Amazon e South China Morning Post

## 0.6.16

- Aggiungere la visualizzazione della pagina senza permessi PDF
- Riparare la visualizzazione dei paragrafi dell'elenco di testo PDF
- Ingrandire la scala dei piccoli caratteri PDF su Chrome e Safari

## 0.6.15

- Riparare il problema che quando si aprono file PDF, il pannello dell'estensione avvisa che non ci sono permessi.
- Risolvere il problema che il miglioramento della casella di input non è abilitato quando il sito è impostato per non tradurre mai.
...
- Risolvere il problema della traduzione ripetuta al passaggio del mouse
- Supporto alla traduzione PDF per trascinare per cambiare la dimensione e modificare il contenuto della traduzione

## 0.6.12

- Risolve il problema delle immagini di traduzione Epub che diventano più piccole in alcuni browser
...
- Aggiornare i colori di caricamento predefiniti nelle traduzioni
...
- Risolvere: alcune aree non vengono tradotte (quora)

## 0.6.5

- Ottimizzazione di Google Bard
- La traduzione della casella di input supporta la traduzione diretta dell'intero testo senza prefissi.
- Ottimizzare il problema delle traduzioni OpenAI che aggiungono punti senza motivo, (se non viene rilevato un punto nel testo originale, se openai restituisce un punto, allora rimuoverlo)
...
[Fai clic qui per una rapida introduzione di 30 secondi](/docs/input/)
...
- Risolvere il problema che: gli eBook bilingue non hanno immagini dopo l'esportazione

## 0.5.16

- Risolvere: problema di traduzione openai in cinese tradizionale

## 0.5.15

- Ottimizzare: Il numero minimo di caratteri in un paragrafo che attiva la traduzione è stato modificato a un minimo di 4 caratteri per ridurre la confusione, mentre si utilizzano altre funzionalità per evitare di tradurre le aree di navigazione e di fine del sito.
- Risolvere: i dettagli di Github non vengono tradotti dopo l'espansione.

## 0.5.14

- Risolvere il problema che le immagini su alcune pagine web di: diventano più grandi dopo la copia
- Risolvere: la sezione dei commenti di medium non viene tradotta
- Risolvere il problema che le immagini su alcune pagine di: sono state copiate in modo errato

## 0.5.12

- Feature: Lo stile di traduzione con linea di divisione aggiunge una linea di divisione verticale per le traduzioni su una sola riga
- Fix: Casi molto rari di divisione del paragrafo.
...
- Fix: Alcuni elementi non sono riconosciuti dal passaggio del mouse
- Fix: le interruzioni di riga parziali dei tweet non sono riconosciute
- Fix: lo stile di creazione di eBook non funziona

## 0.5.10

- Fix: le interruzioni di riga dei tweet non sono riconosciute
- Fix: la pagina dei dettagli di Reddit restituisce alcuni paragrafi che non possono essere tradotti
- Risolto un problema con: dove alcuni tag di codice non erano riconosciuti correttamente.

## 0.5.9

- Risolve le interruzioni di paragrafo in alcuni casi a:
- Fix: Tampermonkey Toggle mostra solo le traduzioni
- Fix: problema di funzionamento dello stile di lettura online degli eBook

## 0.5.8

- Risolto il problema che: l'impostazione temporanea della durata della traduzione del sito web non ha effetto.
...
- Ottimizza il problema della limitazione della frequenza delle richieste OpenAI
...
- Risolto il problema che la modifica della scorciatoia del passaggio del mouse richiedeva un aggiornamento della pagina per avere effetto
...
- Risolto il problema in cui la modifica della scorciatoia del passaggio del mouse richiedeva un aggiornamento della pagina per avere effetto

- Risolto il problema con il riconoscimento delle interruzioni di riga nei file TXT.

## 0.5.6

- Fix: problema di popup della nuova scheda su macOS.
- Feat: Nuova pagina guida per il nuovo utente.

## 0.5.5

- Fix: Problema dell'area del passaggio del mouse.

## 0.5.4

- Fix: Pagina Spa duplicata

## 0.5.3

- Fix: Ascoltatore di tasti di scelta rapida per il passaggio del mouse.
- Fix: Traduzione del documento PDF
- Feat: Aggiungi nuova pagina guida per il cliente

## 0.5.2

- Fix: impostazioni delle scorciatoie del passaggio del mouse per userscript

## 0.5.1

- Fix: OpenAI API non funziona.

## 0.5.0

- Feat: Traduci il paragrafo corrente quando il mouse passa sopra.
- Feat: Ristrutturazione della traduzione PDF, ora puoi tradurre la maggior parte dei PDF con Immersive Translate
- Fix: Disabilita il menu contestuale non funzionante [#428](https://github.com/immersive-translate/immersive-translate/issues/428)
- Fix: Evita la Content Security Policy per [Mastondon](https://mastodon.social/)

## 0.4.11

- Fix: permesso userscript (solo per userscript).

## 0.4.8

- Feat: Bing Translate a Microsoft Translate per una qualità più stabile.
- Fix: Pagina web TXT pura come [questa](https://edoras.sdsu.edu/~vinge/misc/singularity.html)
- Performance: Escludi alcune pagine pubblicitarie figlie nel sito web, e le prestazioni sono migliorate un po'

## 0.4.7

- Fix: Popup userscript mancante su Firefox.

## 0.4.6

- Feat: Consenti a terze parti di inviare eventi di documento per chiamare `toggleTranslatePage`
- Feat: l'app iOS aggiunge il pulsante di abilitazione dell'estensione e il link alle comunità
- UI: Il modello del campo delle impostazioni OpenAI utilizza la selezione invece della casella di input del testo.

## 0.4.5

- Fix: problema dell'estensione safari su iOS 15.0.
- Fix: scorciatoie dell'estensione safari su macOS
- Fix: popup della politica di sicurezza dei contenuti per l'estensione, e in parte per userscript.
...
- Fix: rilevamento degli spazi bianchi nei tag sup, sub.
- Feat: supporta il sito web ChatGPT Plus come servizio di traduzione, questa è una funzione beta, quindi puoi accedervi abilitando la funzione Beta nelle impostazioni dello sviluppatore. È molto lento, perché chatgpt può inviare solo una richiesta alla volta. Assicurati di avere un account ChatGPT Plus, perché ci sono più limiti sull'account gratuito, e non sono sicuro se questo comporta rischi per il tuo account, fai attenzione ad Assicurati di avere un account ChatGPT Plus, perché ci sono più limiti sull'account gratuito, e non sono sicuro se questo comporta rischi per il tuo account, fai attenzione ad usarlo.

## 0.4.1

- Fix: il menu contestuale di Firefox scompare dopo il riavvio.
- Supporto Azure openai

## 0.4.0

- Feat: Supporta la traduzione di file di sottotitoli locali (.srt,.ass,ecc.)

## 0.3.17

- Feat: Supporta la traduzione di file .txt locali.
- Fix: Il menu contestuale potrebbe non essere disponibile a volte. [#273](https://github.com/immersive-translate/immersive-translate/issues/273)

## 0.3.16

- Fix: mantieni &nbsp; come spazio bianco.
- Rimuovi: Rimuovi Papago, poiché [il servizio è inattivo](https://github.com/immersive-translate/immersive-translate/issues/310)
...
- Fix: colore di sfondo della selezione pdf
- Fix: rilevamento degli spazi bianchi

## 0.3.13

- Fix: problema di caratteri specifici del costruttore di ebook, come alcuni percorsi di capitolo sono `xxx' xxxx`.
...
- Fix: prompt predefinito di Gpt4

## 0.3.12

- Feat: Ora possiamo personalizzare il colore di sfondo del tema di traduzione del marcatore.
- Fix: postMessage quando la pagina di avvio ha rotto alcuni siti, ora lo faremo solo quando traduciamo davvero le pagine
- Fix: problema di avanzamento dell'ebook.
- Fix: migliore per dividere il lungo paragrafo, 1,5 miliardi, 25,5%, Mr. non sarà considerato come un confine

## 0.3.11

- Fix: colore del testo in modalità scura del lettore di ebook
- Fix: prompt openAI

## 0.3.10

- Migliore: rileva il contenitore giapponese/coreano.
- Fix: Progresso del costruttore di Ebook fermato al 99%.

## 0.3.9

- Fix: lo stato di input dei servizi di traduzione dell'interruttore UI delle opzioni non è cambiato.

## 0.3.8

- UI: colore di caricamento più trasparente
- Fix: Rileva la lingua dell'ebook.
- Feat: Aggiungi il progresso della traduzione per il costruttore di ebook, e una bella pioggia di coriandoli dopo il successo.
- Feat: Aggiungi il pulsante di riprova per tutti i paragrafi falliti.
- Fix: Gestione degli errori di Deepl

## 0.3.7

- Fix: il lettore di ebook non può caricare immagini su Chrome.

## 0.3.6

- UI: migliore per creare l'interfaccia della pagina dell'ebook

## 0.3.5

- Fix: esportazione ebook userscript
- Feat: aggiungi endpoint API personalizzato per OpenAI
- Feat: aggiungi opzioni di tempo di traduzione temporanea del sito web su `Impostazioni avanzate`
...
- Fix: creatore di ebook per Kindle
- Modifica: colore dell'icona di caricamento, da nero a blu, per adattarsi alla pagina web in modalità scura.
- Feat: Supporta la traduzione html locale per l'estensione

## 0.3.2

- Fix: Spostamento del cursore del modulo di input delle opzioni.
- Feat: OpenAI supporta apiUrl personalizzato per le impostazioni dello sviluppatore.

## 0.3.1

- Feat: aggiorna l'icona scura alla trasparenza.
- Fix: Ordine errato per lungo paragrafo
...
- Feat: Supporta l'icona scura per firefox

## 0.2.86

- Aggiungi opzione di lunghezza massima del testo per richiesta con Open AI
- Fix: identificatore ebook duplicato
- Feat: Supporta la traduzione della pagina web txt

## 0.2.85

- Fix: alcuni file epub non possono essere trovati.

## 0.2.84

- Feat: Supporta Lettore e Creatore di Ebook

## 0.2.83

- Feat: Consenti al modulo di input della password di mostrare la password.

## 0.2.82

- Fix: Alcuni siti utilizzano `span` per gli stili, quindi utilizziamo `font` invece di span per il wrapper di destinazione della traduzione
- Fix: limite massimo di token OpenAI, cambia i caratteri massimi da 1500 a 1300.
...
- Feat: Aggiungi Menu Abilita/Disabilita per popup -> more
...
- Fix: errore tag multiplo di codice.[#178](https://github.com/immersive-translate/immersive-translate/issues/178)
...
- Fix: segnaposto Open AI

## 0.2.69

- Feat: Supporto Open AI come servizio di traduzione.
- Feat: Supporto verifica servizio di traduzione su options.html
- Feat: Supporto frame principale personalizzato poiché alcuni siti non utilizzano il body come frame principale
...
- Better: Supporto Deepl Free
- Fix: alto utilizzo di memoria per userscripts ed estensioni (rimuovendo opencc zh-CN a zh-TW, invece con Google translate)
...
- Fix: traduzione file PDF fallita, Bug da 0.2.60 per supportare deepl da zh-CN a zh-TW
...
- Fix: openl scegliere servizi di traduzione
- Feat: Supporto opzione traduzione titolo

## 0.2.63

- Feat: Supporto Servizio di Traduzione Azure
- Feat: Supporto Servizio di Traduzione Papago
- Fix: sincronizzazione google drive android firefox nativo.
...
- Better: ridurre la dimensione del file

## 0.2.60

- Feat: Supporto zh-CN a zh-TW per Deepl
- Feat: Caratteristica Immersive Translate Deepl
- Feat: Supporto zoom dimensione carattere personalizzato
- Fix: stile forum Steam
- Fix: stile globale non cambiato dopo generazione elementi dinamici
- Fix: promuovere priorità esclusione
...
- Fix: elemento translate=no sovrascrive
...
- Better: apri pagina impostazioni su nuova scheda (ma non per Stay)
...
- Rimuovi permessi schede per rifiuto chrome store
- Fix traduzione dell'intera pagina, il footer è ignorato
...
- Fix toggle mask userscript
- Fix logica toggle mask

## 0.2.43

- Fix toggle mask userscript con evento touch.
...
- Fix problema di sincronizzazione cloud userscript
...
- Fix visualizzazione funzione beta
- Fix pagina impostazioni popup su nuova scheda
- Fix sostituzione segnaposto traduzione

## 0.2.39

- Supporto scorciatoie per mostrare traduzione maschera
- Supporto abilitazione funzione beta nel pannello sviluppatore
...
- Rimuovi contenitore laterale come contenitore di traduzione.
...
- Fix distanza altezza linea pdf

## 0.2.9

- Correggi il segno degli elementi esclusi
- Correggi il controllo del tipo di deno
- rimuovi importmap
- Correggi la traduzione dei menu contestuali
- ripristina la pagina quando l'opzione "non tradurre mai questo sito" è abilitata
- Aggiungi descrizione per aggiungere URL

## 0.2.8

- Rileva la lingua dell'agente utente per la lingua dell'interfaccia
- Correggi il bug dell'interruzione di riga.
...
- aggiorna la versione per il test ci
...
- Correggi il file di esempio PDF
...
- Correggi la corrispondenza delle espressioni regolari
- Correggi i commenti di youtube.
- Correggi la versione compatta mobile di reddit
- Correggi il problema della traduzione del testo completo

## 0.2.0

- Correggi PDF a due colonne.
...
- Pubblica su Firefox addon
- Pubblica su Edge
- correggi il margine del pdf.
- Cambia il file di esempio pdf

## 0.0.62

- Correggi il formato pdf, rientro.
- Correggi telegra.ph per prevenire il cambiamento degli elementi
...
- Cambia l'interfaccia utente del popup, per un uso più facile

## 0.0.56

- Correggi il timeout di chrome
- Correggi l'errore di divisione della frase.

## 0.0.55

- Correggi la visualizzazione dell'elemento none.
- rifattorizza il segno dell'elemento

## 0.0.54

- Supporta l'interruzione di riga per X caratteri.

## 0.0.53

- usa sendMessage invece di connect, perché chrome disconnetterà la porta dopo
  5 minuti
- migliore per rilevare i contenitori di testo

## 0.0.52

- Non tradurre il paragrafo che ha solo elementi segnaposto, per
  [esempio](https://github.com/nank1ro/solidart), la prima riga.
- Migliore per rilevare gli elementi figli.
...
- Correggi la dimensione del font dell'interfaccia utente delle opzioni

## 0.0.50

- Correggi l'immagine del blocco tradotta.

## 0.0.49

- Correggi l'estensione di firefox

## 0.0.48

- Correggi l'estensione di chrome

## 0.0.47

- riscrivi il messaggio con lo sfondo, usa connect invece di sendMessage
- aggiungi il supporto mobile di reddit
- correggi lo spazio bianco pre per alcuni articoli

## 0.0.46

- Format meta info dello userscript

## 0.0.45

- lo userscript usa un file.
- aggiungi timeout per la richiesta di cache

## 0.0.44

- Correggi l'errore di divisione di tencent.
- Correggi l'errore dell'elemento sup inline.
- Migliore per twitter

## 0.0.43

- Correggi tweet br
- Correggi la traduzione globale.

## 0.0.42

- Correggi il tag BR
- tratta i tag di blocco secondo le regole

## 0.0.41

- Correggi il controllo degli elementi inline
- Aggiungi l'opzione di log di debug per sviluppatori

## 0.0.39

- Correggi il servizio di traduzione che contiene mock2

## 0.0.38

- Supporta il risultato della cache per lo userscript
- Aggiungi l'interfaccia utente delle opzioni
- Supporta il rilevamento di più contenitori di contenuti

## 0.0.37

- Correggi il cambiamento del servizio di traduzione del popup che non funziona
- Correggi la traduzione del contenuto del post mobile di reddit.

## 0.0.36

- Correggi il carattere speciale di Wikipedia
  [#6](https://github.com/immersive-translate/next-immersive-translate/issues/6)
- Correggi la dimensione dell'icona dello userscript.
- abilita tutti i siti a rilevare la lingua del paragrafo.

## 0.0.35

- Correggi youtube per andare alla pagina successiva
- Supporta la pagina di ricerca di Youtube.
- Correggi l'interruttore avanzato delle opzioni.
- Correggi il tag img, tag nascosto
  [#5](https://github.com/immersive-translate/next-immersive-translate/issues/5)
- Correggi l'aggiornamento forzato di Google Search
  [#4](https://github.com/immersive-translate/next-immersive-translate/issues/4)
- Supporta il risultato della tabella di Google
  [#3](https://github.com/immersive-translate/next-immersive-translate/issues/3)
- Correggi il vuoto di Wikipedia
...
- La scorciatoia predefinita per attivare la traduzione è stata cambiata in `alt+A`, perché
  è il tasto più conveniente da digitare.

### Altri

- Supporta la modalità di traduzione immediata, così puoi far tradurre la pagina web
  il più rapidamente possibile.
- Supporta l'impostazione dell'area della pagina che deve essere tradotta, così puoi tradurre più aree.
- Supporta l'impostazione del primo conteggio di x testi da tradurre immediatamente.
- Correggi la traduzione duplicata quando si cambia la traduzione
- Migliore interfaccia utente del popup

## 0.0.33

- Supporta più lingue, zh-TW, en

## 0.0.32

- Correggi la traduzione del file locale dopo il salvataggio. Corretto
  [#1](https://github.com/immersive-translate/next-immersive-translate/issues/1)
- Aggiungi il file dist js al repository pubblico

## 0.0.31

- Supporta la traduzione dell'intera pagina
- Supporta la traduzione immediata della pagina
...
- Correggi il paragrafo valido.
- Aggiungi tema punteggiato, thinDashed
- Migliore per il tema tratteggiato, evidenziato

## 0.0.28

- Correggi la sottolineatura
- Aggiungi tema tratteggiato, carta
- Correggi il rilevamento dell'intestazione

## 0.0.27

- Supporta translationTheme

## 0.0.26

- Correggi il permesso di connessione dello userscript volc alpha.
- Correggi la versione cliccabile.

## 0.0.25

- Supporta selectorMatches, così possiamo abbinare tutti i manstondon ora.
- Correggi l'errore dello userscript di Firefox.

## 0.0.23

- Migliore per il rilevamento del cinese
- Correggi il problema di innerText di reddit

## 0.0.22

- Supporta deeplx
- Correggi la traduzione multipla quando si cambia servizio

## 0.0.21

- Correggi alcuni tag span che sono elementi di blocco

## 0.0.20

- Supporta la non traduzione degli hashtag come #hash, dei tag come @xxx, $tag, come $APPL
- Supporta l'elemento di blocco

## 0.0.18

- Supporta deepl, bing, baidu, youdao, volc, openl, caiyun.
...
- Correggi l'ordine del codice.
- Supporta l'interfaccia utente di base del popup

## 0.0.4.6

- Supporta il controllo della nuova versione

## 0.0.3

- Supporta i file locali

## 0.0.2

- Supporta gli elementi dinamici
- Supporta la traduzione visibile