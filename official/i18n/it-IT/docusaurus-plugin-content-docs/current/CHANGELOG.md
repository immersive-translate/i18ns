...
- Aggiunto: Supporto per impostare il numero di schermate da pre-tradurre durante la navigazione della pagina corrente.
...
- Risolto: Un problema con la traduzione al passaggio del mouse che non funzionava in modalità "Prima traduzione, segue il testo originale".
...
- Risolto: Errore `401: Authentication Fails` con API Key personalizzata di DeepSeek.
...
- Migliorato: BBC ora supporta i sottotitoli.
...
- Risolto il problema per cui la modifica della lingua di destinazione e altre impostazioni nel pannello popup si resettava al clic sulla sfera fluttuante di traduzione.
...
- Ottimizzata significativamente la performance della traduzione di grandi pagine web, creazione di ePub e file di sottotitoli.
...
- Risolti i problemi di confine delle parole quando si avvolgono lunghi paragrafi [#86](https://github.com/immersive-translate/immersive-translate/issues/86)
...
- Ottimizzata la copertura delle impostazioni di sincronizzazione cloud
- Ottimizzate le parole di prompt per i servizi di traduzione AI
...
- Ottimizza la performance di traduzione per grandi file in PDF-Pro
- Migliora la performance di traduzione per pagine di contenuti lunghi
...
- Ottimizzata significativamente la velocità di traduzione dei sottotitoli di YouTube, e aggiunto il supporto per il passaggio tra l'ordine cinese e inglese, personalizzazione del colore e della dimensione del font, ecc.
...
- Il servizio di traduzione Gemini è nascosto per impostazione predefinita, può essere abilitato nelle impostazioni per sviluppatori per mostrare la beta di questo servizio di traduzione

## 1.3.4

- Supporto per il servizio di traduzione gratuito Yandex
- Ottimizzate le parole prompt di Gemini
- I sottotitoli video supportano l'impostazione per la visualizzazione bilingue/originale e traduzione
- Supporto per lo spazio tra cinese e inglese nei risultati di traduzione di OpenAI
- L'interruttore del pannello per visualizzare solo il pulsante di traduzione è stato modificato per avere effetto solo sulla pagina corrente
...
- Supporto PDF per regolazioni di spaziatura tra linee e parole per riconoscere nuovamente i paragrafi
...
- Risolvere: problema di traduzione di tutte le regioni di Gmail
...
- Risolvere il problema che alcuni passaggi in giapponese non vengono tradotti.
...
- Risolvere il problema delle immagini di traduzione Epub che diventano più piccole in alcuni browser
...
- Risolvere il problema che le immagini su alcune pagine di: sono copiate in modo errato
...
- Fix traduzione dell'intera pagina, il piè di pagina è ignorato
...
- Fix Google Auth Necessario Accesso su Chrome/Firefox
...
- Fix hover maschera quando si attiva nuovamente la maschera.
...
- Fix altezza linea evidenziata mark
...
- Fix cambio url client, auto mantiene lo stato di traduzione.
- Rimuovi contenitore laterale come contenitore di traduzione.
- Refactor posizione popup.

## 0.2.17

- Cambia evidenziazione in mark
...
- Correggi il segno degli elementi da escludere
...
- Correggi il problema di traduzione del testo completo
