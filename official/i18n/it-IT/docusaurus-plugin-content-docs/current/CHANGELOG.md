...
- Fixed: Un problema in cui il tasto di scelta rapida per la traduzione al passaggio del mouse non funzionava su dispositivi che supportano sia il mouse che il touch.
- Added: Supporto per la traduzione del grande modello Youdao Ziyue.

## 1.15.7 Release (2025-03-19)

- Added: Pre-traduzione dinamica del contenuto da tradurre durante la navigazione delle pagine.
- Fixed: Un problema in cui il servizio di traduzione AI emetteva erroneamente cinese semplificato quando traduceva cinese tradizionale.
- Fixed: Un problema con la traduzione al passaggio del mouse che non funzionava in modalità "Traduzione prima, testo originale segue".
- Fixed: Problemi di compatibilità con la modalità "Solo traduzione" quando utilizzata con plugin di lettura come Reader View.
- Optimized: Migliorata la qualità del servizio di traduzione AI per il contenuto principale.
- Optimized: Migliorato il supporto per la traduzione delle immagini su alcuni siti web.
- Optimized: Ottimizzato il formato del testo misto cinese e inglese.
- Optimized: Il servizio di traduzione Gemini supporta il prompt di sistema personalizzato (System Prompt).
- Optimized: Migliorata la velocità dello userscript.

## 1.15.2 Release (2025-03-02)

- Added: Gemini supporta il portoghese (Brasile).
- Added: Servizio di traduzione Grok, Ollama, Groq, Azure-OpenAI.
- Fixed: Problema di traduzione dei sottotitoli in Google Meet e Microsoft Teams.
- Fixed: Problema di traduzione di Google con caratteri di escape.
- Optimized: Migliorata l'accuratezza dell'identificazione automatica della lingua del contenuto tradotto.
- Optimized: [Traduzione gratuita delle immagini] supporta il formato per le lingue da destra a sinistra.
- Optimized: Compatibile con modelli come o1, o3 che non supportano il ruolo di sistema (il parametro del ruolo di sistema non verrà passato quando la configurazione del System Prompt è vuota).

## 1.14.16 Release (2025-02-21)

- Added: Deepseek, Gemini, Claude supportano il cambio di contesto.
- Fixed: L'aggiornamento dei termini non invia una nuova richiesta di traduzione.
- Improved: La lingua dell'interfaccia aggiunge l'ungherese.
- Improved: Qualità della traduzione di Google.
- Improved: Formattazione gratuita delle immagini.

## 1.14.12 Release (2025-02-19)

- Improved: La pausa della traduzione cancella immediatamente la coda delle richieste.
- Improved: Filtra il testo sporco nel servizio di traduzione deepl.
- Fix: Traduzione della barra laterale non valida nelle impostazioni avanzate.
- Fix: Problema di visualizzazione della traduzione personalizzata deepseek.

## 1.14.11 Release (2025-02-18)

- Fix: Errore `401: Authentication Fails` della chiave API personalizzata di DeepSeek.

## 1.14.10 Release (2025-02-17)

- New: L'abbonamento Pro supporta il servizio di traduzione DeepSeek (v3).
- Fix: Risolto il problema del file di configurazione utente che superava il limite di dimensione.
- Improved: L'elemento del menu contestuale può essere chiuso (operato nelle impostazioni avanzate).
- Improved: Migliorate le capacità di riconoscimento della lingua per Greasemonkey e Safari su pagine con lingue minori.
- Improved: Accesso all'interfaccia del servizio di test della pagina delle impostazioni online.
- Improved: Migliorata l'esperienza utente della funzione di anteprima del confronto del contesto.
- Improved: Logica di giudizio della modalità touch e mouse.

## 1.14.8 Release (2025-02-10)

- Fixed: Problema in cui i file lunghi PDF-Pro non venivano tradotti automaticamente.
- Improved: Microsoft, Google e Tencent ora supportano il cantonese.
- Improved: La BBC ora supporta i sottotitoli.

## 1.14.6 Preview (2025-02-08)

- Fixed: Problema in cui **Mouse Hover Translation** non poteva tradurre il testo ricco.
- Improved: La versione Tampermonkey ora supporta la traduzione dei sottotitoli di YouTube.

## 1.14.4 Release (2025-02-07)

- Fixed: Problema con il rilevamento errato della lingua in **Enhanced Input Box**.
- Fixed: Problema di abbinamento intelligente degli esperti AI nei servizi di traduzione personalizzati.
- Fixed: Problema di sincronizzazione di Google Drive su alcuni browser.
- Fixed: Problema di traduzione dei commenti live di YouTube.
- Fixed: Problema di sovrapposizione dei sottotitoli in alcuni video di YouTube.
- Improved: Fallimento nella traduzione dei manga su siti come shonenjumpplus nel browser Safari.

## 1.13.8 Release (2025-01-24)

- New: La traduzione gratuita delle immagini è ora disponibile (attualmente supportata solo sulle versioni PC dei browser Chrome e Edge), accessibile tramite il menu contestuale.
- Fixed: Risolto un problema in cui alcuni contenuti venivano persi durante la traduzione multi-segmento in Gemini.
- Optimized: Migliorato il caricamento dei sottotitoli di YouTube.
- New: Il servizio di traduzione AI ora supporta il norvegese.

## 1.13.6 Preview (2025-01-17)

- Improved: **AI Expert** può essere utilizzato con **AI Context-Aware Translation**.
- Improved: **Image Translation** è ora compatibile con weibo.com (supportato solo su Chrome e Edge).
- Improved: Quando la lingua dell'interfaccia è impostata su inglese, la lingua di destinazione predefinita per **Enhanced Input Box** è cambiata in cinese.
- Improved: Aggiunta una voce di revisione del negozio nelle opzioni **More** sul pannello.

## 1.13.5 Release (2025-01-14)

- Improved: Compatibile con il modello di pensiero Gemini 2.0.
- Improved: Supporta lo stile grassetto in modalità solo traduzione.

## 1.13.4 Preview (2025-01-13)

- Added: I membri Pro possono ora utilizzare direttamente il modello **Zhipu 4 Plus**.
- Improved: Traduzione Gemini.

## 1.13.1 (2025-01-10)

- Added: Quando il testo tradotto e il testo originale appartengono allo stesso sistema di scrittura, visualizza la traduzione utilizzando uno stile specializzato.
- Fixed: Il problema in cui **Mouse Hover Translation** non funziona su alcuni siti web.
- Improved: DeepLx ora supporta l'arabo.
- Improved: Migliorato il riconoscimento della lingua originale. In precedenza, le pagine contenenti più lingue potevano non essere tradotte, ma ora vengono tradotte correttamente.
- Improved: Per Twitter, le traduzioni di contenuti multilinea sono impostate per non andare a capo per impostazione predefinita. L'andata a capo avverrà solo quando il contenuto supera le 10 righe o i 1000 caratteri. L'andata a capo può essere abilitata tramite le impostazioni **Advanced Settings** -> **Enable automatic line wrapping for long paragraphs**.

## 1.12.8 (2025-01-03)

- Fix: il problema in cui la pagina delle impostazioni di iOS 18.3 non può essere visualizzata correttamente.
- Fix: la mancanza di righe vuote durante la traduzione dei tweet.
- Fix: il problema dei numeri decimali che vengono forzatamente spezzati quando si traducono testi lunghi.

## 1.12.7 Release (2024-12-30)

- Improved: Bing/Google ora supportano il portoghese (Brasile).
- Improved: Migliorate le descrizioni per la lingua dell'interfaccia utente in cinese tradizionale.
- Improved: Regolazione del layout per le lingue da destra a sinistra nei pannelli e nelle pagine delle impostazioni.

## 1.12.6 (2024-12-26)

- Fix: Problema in cui la funzione di passaggio del mouse carica il servizio di traduzione sbagliato in determinate condizioni.
- Fix: Problema in cui l'abilitazione temporanea dei sottotitoli bilingue su YouTube non funziona.
- Fix: Dopo aver cambiato i servizi di traduzione, il servizio di traduzione in "**Enhanced Input Box**" non si aggiorna.
- Fix: L'interruttore "**YouTube Enable Bilingual**" nella pagina delle impostazioni non funziona.
- Improved: Rimosso il modello gemini-1.0-pro deprecato.

## 1.12.4 (2024-12-13)

- Added: **AI Context-Aware Translation** può migliorare l'accuratezza della traduzione di contenuti professionali. (Disponibile solo per i membri Pro, supportato esclusivamente dai modelli OpenAI) **Options** -> **Grneral** -> **Enable AI Context-Aware Translation**
- Fix: Alcuni bug nell'effetto di traduzione multi-linea su Twitter.
- Fix: Problemi con la traduzione di alcune formule a causa del testo ricco.
- Improved: Quando si traduce su **x.com**, i video con sottotitoli avranno automaticamente i sottotitoli bilingue tradotti.
- Improved: I video senza sottotitoli mostreranno un'icona di traduzione e forniranno una ragione per cui la traduzione non è possibile.

## 1.11.7 (2024-11-25)

- Added: Bing/Google ora supportano il khmer (cambogiano).
- Added: Consenti ai file ePub incompleti di continuare la traduzione da dove erano stati interrotti al momento della reimportazione.
- Fixed: Problema con la traduzione delle immagini di Twitter nel browser Safari.
- Fixed: I tasti di scelta rapida diventano inefficaci quando si attiva o disattiva la funzione "**Hover Translation**".
- Improved: Migliorata la visualizzazione della traduzione bilingue multilinea su Twitter e YouTube.
- Improved: La traduzione del testo ricco è disattivata per impostazione predefinita in modalità bilingue per migliorare la qualità della traduzione.
- ~~Improved: Aggiunta l'opzione per personalizzare la "**Enable Sidebar & Navbar Translation**" in "**Advanced Settings**".~~
- Improved: Le immagini non vengono più tradotte in modalità "**Hover - immediately translate this paragraph**".

## 1.11.4 (2024-11-16)

- Fixed: Problema con la traduzione delle formule causato dal "Twitter Translation Improvement" nella versione 1.11.2.

## 1.11.2 (2024-11-13)

- Fixed: Problema in cui il contenuto scompare dopo aver cliccato su "vedi di più" in modalità solo traduzione di Facebook.
- ~~Improved: Migliorata la visualizzazione delle traduzioni bilingue multilinea su Twitter.~~
- Improved: Aggiornata l'interfaccia utente dell'elenco a discesa del servizio di traduzione nel pannello.

## 1.11.1 (2024-11-05)

- Added: La **Subtitles Translation** in tempo reale ora supporta l'attivazione tramite "float ball", disponibile su Zoom, Google Meet e Microsoft Teams.
- Fixed: Problemi di sincronizzazione dei sottotitoli su YouTube dopo aver guardato annunci.
- Fixed: Problemi di visualizzazione con il menu di traduzione contestuale in Safari su MacOS 15.
- Fixed: Problemi con la funzionalità di annullamento Ctrl+Z nell'**Enhanced input** su alcuni siti web.
...
- Migliorato: Soluzione per la visualizzazione dei sottotitoli di Netflix

## 1.10.5 (2024-10-23)

- Aggiunto: Visualizzazione di un avviso quando la lingua di origine e la lingua di destinazione sono le stesse
- Risolto: Problema di traduzione dei caratteri di spazio nel testo formattato [#2175](https://github.com/immersive-translate/immersive-translate/issues/2175)
- Migliorato: Funzionalità di miglioramento dell'input e passaggio del mouse all'interno di iframe incorporati nelle pagine web

## 1.10.2 (2024-10-11)

- Aggiunto: Traduzione delle immagini (versione Beta)
- Aggiunto: Modalità Forece Enable Mouse Support (abilitare questa funzione solo se la funzione di passaggio del mouse non è disponibile su dispositivi tablet) **Impostazioni** -> **Impostazioni Avanzate** -> **Forece Enable Mouse Support**
- Aggiunto: Visualizzazione del messaggio di errore quando la traduzione dei sottotitoli video fallisce
- Risolto: Problema di traduzione del testo formattato [#2163](https://github.com/immersive-translate/immersive-translate/issues/2163)
...
- DeepX supporta la traduzione di testo formattato
...
- Ottimizzata la performance della traduzione di testo formattato.
...
- Aggiunta l'opzione per "Segnalare problemi di traduzione della pagina web corrente" e l'opzione per "Attivare/disattivare rapidamente la sfera fluttuante" nelle opzioni più del pannello.
...
- I file Epub ora supportano la traduzione di testo formattato (cioè, preservando il formato del testo originale di ogni paragrafo, come link, grassetto, ecc.)
...
- A causa delle restrizioni del sito web di Youtube, lo script Tampermonkey di Chrome non supporta più i sottotitoli bilingue di Youtube. Si prega di utilizzare la [versione del plugin](https://immersivetranslate.com/).
...
- Risolti problemi con la traduzione di testo formattato per servizi di traduzione come Google, DeepL (ad esempio, pagine che visualizzano direttamente `<button>` ecc.)
...
- Dopo aver selezionato il testo, il menu contestuale cambierà in [Traduci il testo], cliccando su di esso si può automaticamente saltare alla pagina di traduzione del testo di Immersive Translation
...
- Adottato algoritmo di suddivisione delle frasi intelligente AI per sottotitoli inglesi auto-generati su YouTube [Pro Disponibile]
...
- Risolvi i problemi di layout del testo delle traduzioni di fumetti per le lingue con script latino.
...
- Risolto il problema per cui modificare la lingua di destinazione e altre impostazioni nel pannello popup si resettava cliccando sulla sfera flottante di traduzione.
...
- Risolto il problema per cui i cambiamenti frequenti al colore della traduzione tramite la tavolozza dei colori erano inefficaci [#1628](https://github.com/immersive-translate/immersive-translate/issues/1628)
...
- Il pannello passa per visualizzare solo il pulsante di traduzione modificato per avere effetto solo sulla pagina corrente
...
- Supporto per la traduzione dei nodi di tag di input.
...
- Ora puoi specificare un carattere per la traduzione nella pagina delle impostazioni -> [Impostazioni di base] -> [Stile di traduzione]
...
- **Rimozione Funzionalità**: Rimossa la funzione di miglioramento delle informazioni bilingue (visualizzazione simultanea dei risultati di ricerca in inglese sulle pagine di ricerca di Google).
...
- Ottimizzato: Quando si utilizza il passaggio del mouse, il problema in cui la perdita di focus sulla pagina e poi il riattivarsi diventa inefficace.
...
- Risolto il problema in cui il mouse passava per continuare a tradurre senza tenere premuto il tasto di scelta rapida in alcuni casi.
...
- Ottimizzazione della traduzione dei file di sottotitoli OpenAI per la contestualizzazione

## 0.10.1

- Aumentata la priorità della traduzione del corpo per ottimizzare l'esperienza di traduzione
- Risolto il problema del testo non tradotto al clic su "altro" in ins
...
- Problemi con i file di sottotitoli safari non riconosciuti
...
- Funzione: Lo stile di traduzione Split Line aggiunge una linea di divisione verticale per le traduzioni su una sola riga
...
- Risolto: Tampermonkey Toggle mostra solo le traduzioni
...
- Funzione: Aggiungi nuova pagina guida per il cliente
...
- Funzione: l'app iOS aggiunge il pulsante di abilitazione dell'estensione e il link alle comunità
...
- Funzione: supporta il sito web ChatGPT Plus come servizio di traduzione, questa è una funzione beta, quindi puoi accedervi abilitando la funzione Beta nelle impostazioni dello sviluppatore. È molto lento, perché chatgpt può inviare solo una richiesta alla volta. Assicurati di avere un account ChatGPT Plus, perché ci sono più limiti sull'account gratuito, e non sono sicuro se questo comporti rischi per il tuo account, fai attenzione ad Assicurati di avere un account ChatGPT Plus, perché ci sono più limiti sull'account gratuito, e non sono sicuro se questo comporti rischi per il tuo account, fai attenzione ad usarlo.
...
- Funzione: Supporta la traduzione di file di sottotitoli locali (.srt,.ass,ecc.)
...
- Risolto: postMessage quando la pagina di avvio ha rotto alcuni siti, ora lo faremo solo quando traduciamo davvero le pagine
- Risolto: problema di avanzamento dell'ebook.
...
- Risolto: Avanzamento del costruttore di Ebook fermo al 99%.

## 0.3.9

- Risolto: lo stato di input dei servizi di traduzione del switch UI delle opzioni non cambiava.

## 0.3.8

- UI: colore di caricamento più trasparente
- Risolto: Rileva la lingua dell'ebook.
- Funzione: Aggiungi avanzamento della traduzione per il costruttore di ebook, e una bella pioggia di coriandoli dopo il successo.
- Funzione: Aggiungi riprova a tutti i paragrafi falliti per il pulsante di riprova.
...
- Risolto: spostamento del cursore del modulo di input delle opzioni.
...
- Funzione: Supporta l'icona scura per firefox
...
- Funzione: Consenti al modulo di input della password di mostrare la password.
...
- Fix: opzioni form UI
- Fix: Open AI prompt
- Feat: Supporto per OpenAI multiple keys, usa `,` per separarli.
...
- Fix: Open AI per paragrafo spaziale
...
- Feat: Supporto per il conteggio del testo di traduzione immediata personalizzato per diversi servizi di traduzione.
...
- Fix: alto uso di memoria per userscripts ed estensioni (rimuovendo opencc zh-CN a zh-TW, invece con Google translate)
...
- Feat: Supporto dimensione carattere personalizzata zoom
...
- Fix innerText elemento è undefined
- Fix traduzione caiyun lingua sorgente undefined
...
- Fix visualizzazione funzionalità beta
...
- Fix volc traduzione per rilevamento lingua automatico
...
- Aggiungi impostazioni avanzate per traduzione newline
...
- incrementa versione per test ci

## 0.2.4

- cattura errore di connessione del messaggio per popup.
...
- Fix telegra.ph prevenire il cambiamento dell'elemento
...
- lo userscript usa un file unico.
...
- Aggiungi opzione di log debug per sviluppatori
...
- Supporto per risultato Cache per userscript
- Aggiungi interfaccia utente delle opzioni
- Supporto per rilevare più contenitori di contenuti

## 0.0.37

- Fix cambio servizio di traduzione nel popup non funziona
...
- Supporto per pagina di ricerca di Youtube.
