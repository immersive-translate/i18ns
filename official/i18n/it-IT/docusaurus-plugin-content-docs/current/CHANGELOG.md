...
- Risolto: risolto un problema per cui il menu a discesa a capsula della traduzione nei campi di input poteva fuoriuscire in basso in WhatsApp.
- Aggiunto: i servizi API personalizzati ora completano automaticamente i percorsi degli endpoint OpenAI / Anthropic in base al Base URL.
- Migliorato: migliorato l'accesso alla traduzione dei documenti nel popup per maggiore visibilità e facilità d'uso.

## 1.30.1 Release (2026-06-04)

- Migliorato: la traduzione nei campi di input ora supporta la ritraduzione dopo il cambio della lingua di destinazione.

## 1.29.9 Preview (2026-05-27)

- Migliorato: migliorata l'esperienza di traduzione del testo nella barra laterale.
- Migliorato: le richieste di traduzione dei sottotitoli online ora sono controllate dal limite di paragrafi del servizio di traduzione.
- Migliorato: migliorati i messaggi delle finestre di dialogo per gli errori 403 / Cloudflare.
- Aggiunto: aggiunto un interruttore per la cache della traduzione in Altre funzionalità nel popup.
- Aggiunto: aggiunti interruttori indipendenti per sito per la traduzione dei sottotitoli.
...
- Aggiunto: aggiunto il supporto per la traduzione del sito di fumetti toptoon.com.

## 1.29.4 Release (2026-05-14)

- Risolto: risolto un problema per cui non era possibile generare sottotitoli AI per alcuni video su Twitter.
- Risolto: risolto un problema per cui la [traduzione tramite selezione del testo] non funzionava su Reddit.
- Risolto: risolto un problema per cui la barra laterale non poteva essere aperta in Atlas Browser.

## 1.29.1 Release (2026-05-07)

- Aggiunto: supporto al servizio di traduzione plamo.
- Migliorato: migliorati i marcatori di impaginazione per le lingue RTL nella modalità Solo traduzione.
- Migliorato: migliorato il riconoscimento di alcune forme plurali dei termini inglesi, riducendo le mancate corrispondenze terminologiche.
- Corretto: corretto il problema di tremolio dei sottotitoli durante la traduzione dei sottotitoli di Teams.
- Corretto: corretto un problema per cui [Traduzione tramite selezione] non riusciva a rilevare correttamente il testo negli scenari con ShadowRoot.
