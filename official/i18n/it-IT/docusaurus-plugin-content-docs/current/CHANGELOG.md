...
- Aggiunto: gestione del glossario AI (supporta solo i servizi di traduzione AI)
- Aggiunto: la versione PC supporta la funzione di traduzione della selezione del testo (non-userscript)
- Aggiunto: supporto PC per abilitare i sottotitoli AI su Youtube (membri Pro)
- Aggiunto: il plugin Safari supporta gli acquisti in-app
- Risolto: problema in cui alcuni paragrafi non venivano tradotti durante la traduzione delle pagine web
...
- Risolto: degrado della qualità della traduzione AI per il cinese tradizionale.
...
- Ottimizzato: [traduzione gratuita delle immagini] supporta il formato per le lingue da destra a sinistra.
...
- Nuovo: il supporto per i membri Pro include il servizio di traduzione DeepSeek (v3).
...
- Aggiunto: consenti ai file ePub incompleti di continuare la traduzione da dove erano stati interrotti al momento della re-importazione.
...
- Aggiunto: Modalità Forza Abilitazione Supporto Mouse (abilitare questa funzione solo se la funzione di passaggio del mouse non è disponibile su dispositivi tablet) **Impostazioni** -> **Impostazioni Avanzate** -> **Forza Abilitazione Supporto Mouse**
...
- Supporto per l'intestazione della richiesta di accesso diretto pericoloso del browser antropico per l'API Claude Anthropic
- Supporto per il download di sottotitoli da video di Hulu, Bloomberg e Domestika
- DeepX supporta la traduzione di testo ricco
- Risolto il problema con gli esperti AI personalizzati che non si sincronizzano
...
- Il servizio di traduzione DeepL ora supporta ufficialmente il cinese tradizionale come lingua di destinazione (in precedenza, la traduzione in cinese tradizionale con DeepL comportava un processo di conversione aggiuntivo da cinese semplificato a tradizionale tramite terze parti).
...
- Aggiunta l'opzione per "Segnalare problemi di traduzione della pagina corrente" e l'opzione per "Attivare/disattivare rapidamente il float ball" nelle opzioni aggiuntive del pannello.
...
- Adottato algoritmo di suddivisione intelligente delle frasi per i sottotitoli auto-generati in inglese su YouTube [Pro Disponibile]
- Ottimizza la traduzione con il clic destro in "Traduci in xx lingua di destinazione"
...
- I sottotitoli bilingue di YouTube ora supportano la suddivisione intelligente delle frasi (Beta) (Solo quando si abilita manualmente la traduzione immersiva dei sottotitoli di YouTube in [Impostazioni] - [Sottotitoli Video], e i sottotitoli video originali sono sottotitoli auto-generati in inglese)
...
- Risolti i problemi di layout dei testi delle traduzioni di fumetti per le lingue con script latino.
...
- Risolto un problema per cui i servizi AI personalizzati non potevano selezionare esperti AI.

## 1.6.4

- Quando si utilizzano esperti AI per la "Selezione Intelligente", diversi esperti AI possono essere personalizzati per diversi siti web. Questo può essere impostato in [Impostazioni] -> [Esperti AI] -> [Inserisci qualsiasi esperto].
...
- Nuova funzionalità: traduzione di manga (Beta), nei siti web di manga supportati, apparirà un pulsante di traduzione di manga sotto la sfera flottante di traduzione rapida della pagina web. Cliccandolo si attiverà la traduzione di manga. Questa funzionalità è disponibile per i membri Pro (500 pagine al mese, pacchetti aggiuntivi possono essere acquistati), attualmente supporta i seguenti siti:
...
- Nascondi la sfera flottante durante la stampa della pagina
...
- Ottimizzato la copia dell'interfaccia in cinese tradizionale.
...
- Le opzioni più del pannello ora supportano [l'ingresso di traduzione del testo](https://app.immersivetranslate.com/text/)
...
- Ottimizzazione delle parole chiave del prompt Gemini
- Supporto per i sottotitoli video con impostazione per la visualizzazione bilingue/originale e traduzione
- Supporto per lo spazio tra cinese e inglese nei risultati di traduzione OpenAI
- Modifica del pulsante di commutazione del pannello per visualizzare solo il pulsante di traduzione, che ora ha effetto solo sulla pagina corrente
...
- Risolto il problema della traduzione Gemini in ebraico
- Risolto un problema per cui alcuni sottotitoli in cinese tradizionale su YouTube non venivano visualizzati correttamente
...
- Recentemente, le richieste di servizio di traduzione Microsoft dalla Cina sono state instabili; quando si verificano errori, il sistema rileva automaticamente il servizio di traduzione attualmente disponibile, consentendo agli utenti di passare rapidamente.
...
- Supporto per la traduzione dei sottotitoli su YouTube Live e sulla piattaforma [Mubi](https://mubi.com/).
...
- **Supporto mobile per la traduzione di paragrafi specifici:** La versione mobile ora supporta la traduzione di paragrafi specifici e ha aggiunto una varietà di operazioni di scorciatoia, tra cui scorrimento a sinistra, scorrimento a destra, doppio tocco, triplo tocco e gesti multi-dito. Questi non sono abilitati per impostazione predefinita e richiedono all'utente di selezionare attivamente il gesto di attivazione nella pagina delle impostazioni sotto [Passaggio del mouse].
- **Aggiornamento della versione predefinita di Gemini:** La versione predefinita è ora `v1beta`.
- **Risolto il problema della traduzione del cinese classico:** Risolto il problema della traduzione del cinese classico di Microsoft e OpenAI.
...
- **Guida per i nuovi utenti**: Quando i nuovi utenti aprono per la prima volta una pagina in una lingua non di destinazione, viene visualizzata una bolla di aiuto fluttuante.

### Ottimizzazione e Correzioni

- **Ottimizzazione UI**: Ridisegnata l'interfaccia utente per i messaggi di errore di traduzione della pagina per renderli più comprensibili. Quando ci sono molti errori, un pop-up avviserà attivamente l'utente.
...
- Per le versioni precedenti dello script Tampermonkey, è stato ora aggiunto un avviso di aggiornamento alla pagina delle impostazioni.
...
- Risolto il bug per cui il cambio di sottotitoli su alcuni siti di video causava la visualizzazione ripetuta della traduzione.
...
- Le pagine PDF online senza estensione .pdf possono ora passare direttamente alla pagina di traduzione PDF facendo clic sulla hoverball sulla pagina.
...
- Risolto il problema per cui il contenuto di plug-in di terze parti viene tradotto in alcuni scenari
...
- Risolto il problema per cui alcune piattaforme non potevano riconoscere se il mouse era supportato o meno
...
- Aggiungi avviso di aggiornamento per la versione bassa di Grease Monkey
...
- Risolto il conflitto dei sottotitoli di Youtube con il plugin Dual subtitle (la traduzione dei sottotitoli di Youtube di Immersive Translate non è abilitata quando viene rilevato il plugin Youtube Dual per evitare conflitti)
...
- Ottimizzazione del rilevamento del miglioramento dell'input per ridurre i tocchi falsi
...
- Supporta [Abilita Pro Membership](/pricing), che consente agli utenti di usufruire delle traduzioni Deepl e OpenAI e delle impostazioni di sincronizzazione cloud.
...
- Il PDF supporta finalmente l'esportazione di versioni bilingue! Puoi cliccare sul pulsante [Salva] per esportare il file PDF bilingue tradotto.
...
- Risoluzione di una serie di problemi
...
- Modifica delle impostazioni predefinite: a causa del gran numero di feedback degli utenti che non utilizzeranno lo strumento di traduzione dopo l'installazione, la loro aspettativa dello strumento di traduzione è che traduca automaticamente le pagine web in inglese dopo l'installazione, quindi da questa versione in poi, per gli utenti cinesi, l'opzione di tradurre le pagine in inglese per impostazione predefinita è stata attivata (se l'utente ha avuto una precedente impostazione della lingua che verrà sempre tradotta, allora verrà rispettata, e la modifica modifica solo le impostazioni iniziali dell'estensione), e deve essere annullata, può essere facilmente annullata nel [pannello popup o nella pagina delle impostazioni](/docs/faq/#%E5%A6%82%E4%BD%95%E5%85%B3%E9%97%AD%E8%87%AA%E5%8A%A8%E7%BF%BB%E8%AF%91)
...
- Risolto: popup mancante di Firefox Userscript.

## 0.4.6

- Funzionalità: Consenti a terze parti di inviare eventi di documento per chiamare `toggleTranslatePage`
- Funzionalità: app iOS aggiunge pulsante di abilitazione dell'estensione e link alle comunità
...
- Risolto: popup della content security policy per l'estensione, e in parte per userscript.
...
- Funzionalità: Ora possiamo personalizzare il colore di sfondo del tema di traduzione del Marker.
...
- Risolto: lo stato di input dei servizi di traduzione dell'interruttore UI delle opzioni non è cambiato.

## 0.3.8

- UI: colore di caricamento più trasparente
- Risolto: Rileva la lingua dell'ebook.
- Funzionalità: Aggiungi avanzamento della traduzione per il costruttore di ebook, e una bella pioggia di coriandoli dopo il successo.
...
- Risolto: movimento del cursore del modulo di input delle opzioni.
- Funzionalità: OpenAI supporta apiUrl personalizzato per le impostazioni di sviluppo.
...
- Correzione: alcuni siti utilizzano `span` per gli stili, quindi utilizziamo `font` invece di span per il wrapper del target di traduzione
- Correzione: limite massimo di token OpenAI, cambia i caratteri massimi da 1500 a 1300.

## 0.2.81

- Correzione: m.youtube.com
- Correzione: opzioni form UI
...
- Funzionalità: Aggiungi nuovo tema Bordo Solido (新增新主题，实线边框)
...
- Funzionalità: Supporto conteggio testo di traduzione immediata personalizzato per diversi servizi di traduzione.
...
- Funzionalità: Supporto Tema di Traduzione Grigio
...
- Funzionalità: Supporto frame principale personalizzato poiché alcuni siti non utilizzano il body come frame principale
...
- Funzionalità: Aggiungi `<all>` per tradurre sempre le lingue, quindi ora puoi usarlo per tradurre tutte le lingue tranne la lingua target, e mai tradurre le lingue
- Correzione: Consenti configurazione API Google personalizzata
- Miglioramento: Supporto Deepl Free
- Correzione: alto uso di memoria per userscripts ed estensione (rimuovendo opencc zh-CN a zh-TW, invece con Google translate)
...
- Correzione: openl scelta servizi di traduzione
...
- Correzione: sincronizzazione google drive android nativa firefox.
...
- Miglioramento per rilevamento conteggio giapponese
...
- Miglioramento: riduci dimensione file

## 0.2.60

- Funzionalità: Supporto zh-CN a zh-TW per Deepl
- Funzionalità: Funzionalità Immersive Translate Deepl
- Funzionalità: Supporto zoom dimensione font personalizzato
- Correzione: stile forum Steam
- Correzione: stile globale non cambiato dopo elementi dinamici generati
- Correzione: promuovi priorità esclusione
- UI: modifica pagina about
- Correzione: alcuni elementi matematici rimangono originali

## 0.2.59

- Correzione: Elemento Blocco tag sconosciuti
...
- Correzione controllo inline/blocco tag sconosciuti
- Funzionalità: supporto css iniettato su pannello sviluppatore
- Funzionalità: taglia authKey, appid appSecret
- Miglioramento: apri pagina impostazioni su nuova scheda (ma non per Stay)
...
- Correzione traduzione intera pagina, footer ignorato
...
- Miglioramento per velocità, aggiungendo minLength a 50 per rilevamento lingua.
...
- Correzione toggle mask userscript
- Correzione logica toggle mask

## 0.2.43

- Correzione toggle mask userscript con evento touch.
- Correzione velocità (rimuovendo sleep(300))

## 0.2.42

- Correzione hover mask quando si attiva nuovamente la maschera.
...
- Correzione impostazione popup pagina su nuova scheda
...
- Correzione footer a lato per area corpo
- Correzione icona import/export

## 0.2.37

- Correzione esclusione segno frame
...
- Correzione tag giapponese rb, rt ignora.
- Miglioramento per popup ui più
- Miglioramento per suggerimenti userscript errati
...
- Correzione segno altezza linea evidenziata
...
- Aggiungi tema di traduzione evidenziata
...
- Supporto per il gestore di scorciatoie Grease Monkey.
...
- Cambiata l'interfaccia utente del popup, per un uso più facile
...
- refactoring del marcatore degli elementi
...
- Risolto il problema della cache
...
- Risolto il problema della divisione di tencent.
...
- Risolto il problema del controllo degli elementi inline
- Aggiunta opzione di log di debug per sviluppatori
...
- Aggiunta interfaccia utente delle opzioni
...
- Aggiunto file dist js al repository pubblico
...
- Risolto il problema della validità del paragrafo.
...
- Risolto il problema dello userscript su Firefox.
...
- Risolto il problema dell'ordine del codice.
- Supporto per l'interfaccia utente di base del popup
