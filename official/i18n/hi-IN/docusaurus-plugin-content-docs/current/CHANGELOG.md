...
- जोड़ा गया: Gemini अब पुर्तगाली (ब्राज़ील) का समर्थन करता है।
...
- सुधार: Greasemonkey और Safari के लिए भाषा पहचान क्षमताओं में सुधार किया गया है, जिन पृष्ठों में मामूली भाषाएं हैं।
...
- ठीक किया गया: जहां PDF-Pro लंबी फाइलें स्वचालित रूप से अनुवादित नहीं होती थीं।
...
- ठीक किया गया: **Mouse Hover Translation** समृद्ध पाठ का अनुवाद नहीं कर सकता था।
...
- ठीक किया गया: **Mouse Hover Translation** कुछ वेबसाइटों पर काम नहीं करने की समस्या।
...
- सुधार: Twitter के लिए, मल्टीलाइन सामग्री अनुवादों को डिफ़ॉल्ट रूप से रैप नहीं किया जाता है। रैपिंग केवल तब होगी जब सामग्री 10 पंक्तियों या 1000 वर्णों से अधिक हो। रैपिंग को सेटिंग्स के माध्यम से सक्षम किया जा सकता है **Advanced Settings** -> **Enable automatic line wrapping for long paragraphs**।
...
- ठीक किया गया: Facebook के केवल अनुवाद मोड में "see more" पर क्लिक करने के बाद सामग्री गायब हो जाती है।
...
- ठीक किया गया: **Enhanced input** शॉर्टकट कुंजियाँ ट्रिगर नहीं हो रही
...
- सुधार: वेबपृष्ठों पर एम्बेडेड iframes के भीतर इनपुट संवर्धन और माउस होवर कार्यक्षमता
...
- Google Meet अब लाइव मीटिंग्स के लिए द्विभाषी उपशीर्षकों का समर्थन करता है: अब, आप Google Meet मीटिंग्स में द्विभाषी उपशीर्षक सुविधा का आनंद ले सकते हैं। बस मीटिंग लिंक खोलें, इमर्सिव अनुवाद पैनल में द्विभाषी उपशीर्षक सक्रिय करें, और फिर इसे अनुभव करने के लिए पृष्ठ को ताज़ा करें।
...
- Microsoft Teams वेब संस्करण वीडियो मीटिंग्स में वास्तविक समय द्विभाषी उपशीर्षकों का समर्थन (Teams मीटिंग लिंक खोलें, इमर्सिव अनुवाद पैनल में द्विभाषी उपशीर्षक चालू करें, और फिर ताज़ा करें)
...
- एक नया शॉर्टकट सेटिंग जोड़ा गया जो वीडियो उपशीर्षकों के लिए अंतर्निहित मशीन अनुवाद उपशीर्षकों का उपयोग करने के लिए त्वरित टॉगलिंग की अनुमति देता है
...
- **प्लगइन सेटिंग्स पृष्ठ UI अपडेट**:
  ...
  - "उन्नत सेटिंग्स" में, एक नया विकल्प जोड़ा गया है जो एक पैराग्राफ का अनुवाद करने के लिए आवश्यक न्यूनतम वर्णों की संख्या को कॉन्फ़िगर करने की अनुमति देता है। डिफ़ॉल्ट रूप से यह 4 वर्ण है, लेकिन इसे अधिक (जैसे, 20) सेट किया जा सकता है, ताकि केवल लंबे पैराग्राफ का अनुवाद किया जाए।
...
- **नया उपयोगकर्ता गाइड**: जब नए उपयोगकर्ता पहली बार एक गैर-लक्ष्य भाषा में पृष्ठ खोलते हैं, तो एक फ्लोटिंग बॉल सहायता गाइड बबल प्रदर्शित होता है।
...
- **बग फिक्स**:
  ...
  - इनपुट बॉक्स वृद्धि सुविधा में 3 से कम वर्णों का अनुवाद न होने की समस्या को ठीक किया गया।
...
- [जब अस्थायी रूप से लंबे समय के लिए वेबपेज अनुवाद चालू किया जाता है, तो पैनल पर [हमेशा इस वेबसाइट का अनुवाद करें] पर क्लिक करने से हमेशा अनुवाद रद्द नहीं होता है #1172](https://github.com/immersive-translate/immersive-translate/issues/1172) को ठीक किया गया।
...
- मोबाइल पर होवरबॉल अब लंबे प्रेस ऑपरेशन का समर्थन करता है, अनुवाद करने के लिए शॉर्ट प्रेस, पैनल खोलने के लिए लंबे प्रेस।
...
- [अस्थायी रूप से लंबे समय के लिए वेब अनुवाद चालू करने से हमेशा अनुवाद रद्द नहीं होता है #1172](https://github.com/immersive-translate/immersive-translate/issues/1172)
...
- Twitter इनपुट बॉक्स के अंत में इमोजी का अनुवाद नहीं किया जा सकता है।
...
- कुछ प्लेटफार्मों की समस्या को हल किया गया जो यह पहचान नहीं सकते थे कि माउस समर्थित है या नहीं।
  - कुछ डेस्कटॉप ब्राउज़र हैं जो टचस्क्रीन और माउस दोनों का समर्थन करते हैं, और Immersive Translate तकनीकी रूप से यह पता लगाने में असमर्थ है कि क्या ऐसे प्लेटफॉर्म माउस का समर्थन करते हैं, इसलिए हमने [माउस होवर] सेटिंग में [फोर्स एनेबल माउस सपोर्ट] विकल्प जोड़ा है।
...
- Youtube उपशीर्षक द्विभाषी उपशीर्षक प्लगइन के साथ संघर्ष को ठीक करें (जब Youtube द्विभाषी प्लगइन का पता लगाया जाता है तो Youtube उपशीर्षक अनुवाद सक्षम नहीं होता है ताकि संघर्ष से बचा जा सके)।
...
- लेख पृष्ठों के लिए, अब साइडबार सामग्री के बाकी हिस्से से पहले मुख्य पाठ का अनुवाद किया जाएगा।
...
- कस्टम नियम अब डिफ़ॉल्ट अंतर्निहित नियमों के साथ विलय का समर्थन करते हैं, उदाहरण के लिए: `{"id": "youtube", "selectors.add":["#test"]}` का अर्थ है मौजूदा चयनकर्ताओं में एक `#test` जोड़ना, `selectors` का अर्थ है डिफ़ॉल्ट को ओवरराइड करना, `selectors.remove` का अर्थ है डिफ़ॉल्ट चयनकर्ताओं में से एक को हटाना, और `selectors.remove` का अर्थ है डिफ़ॉल्ट चयनकर्ताओं में से एक को हटाना।
...
- Arigato अनुवादक सेटिंग फ़ील्ड्स और शब्दावली id सेट करने का समर्थन करता है
...
- खोज एन्हांसमेंट का समर्थन करें, जब सक्षम हो, जब आप Google/Google News में चीनी में खोज करते हैं, तो दाएं कॉलम स्वचालित रूप से संबंधित अंग्रेजी कीवर्ड के खोज परिणाम दिखाएगा, जो डिफ़ॉल्ट रूप से सक्षम है।
...
- जब साइट को कभी अनुवाद नहीं करने के लिए सेट किया गया हो तो इनपुट बॉक्स एन्हांसमेंट सक्षम नहीं होने की समस्या को ठीक करें।
...
- अनुकूलन: अनुवाद को ट्रिगर करने वाले पैराग्राफ में न्यूनतम वर्णों की संख्या को 4 वर्णों के न्यूनतम तक संशोधित किया गया ताकि भ्रम को कम किया जा सके, जबकि साइट के नेविगेशन और अंत क्षेत्रों का अनुवाद करने से बचने के लिए अन्य सुविधाओं का उपयोग किया जा सके।
- Fix: Github विवरण का विस्तार करने के बाद अनुवाद नहीं हो रहा।

## 0.5.14

- कुछ वेब पेजों पर छवियों की समस्या को ठीक करें: कॉपी करने के बाद बड़ा हो जाता है
- Fix: माध्यम टिप्पणी अनुभाग का अनुवाद नहीं हो रहा
- कुछ पृष्ठों पर छवियों की समस्या को ठीक किया गया: गलत तरीके से कॉपी किया गया
...
- Feat: PDF अनुवाद का पुनर्गठन, अब आप Immersive Translate के साथ अधिकांश PDFs का अनुवाद कर सकते हैं
...
- संस्करण: अब से, हम हर महीने माइनर संस्करण संख्या बदलेंगे, उदाहरण के लिए, अब मार्च में, संस्करण 0.3.0 से शुरू होगा, अप्रैल में, संस्करण संख्या 0.3.0 से शुरू होगी, अगले अप्रैल में, संस्करण संख्या 1.4.0 होगी, और इसी तरह। ऐसा इसलिए है क्योंकि एक्सटेंशन के लिए अर्थशास्त्र का पालन करना कोई मतलब नहीं है, लेकिन समय के नियमों के अनुसार संस्करण संख्याओं को मानकीकृत करना विकास को अद्यतन रखने के लिए प्रेरणा है, और उपयोगकर्ताओं के लिए समस्याओं को अधिक आसानी से ढूंढना है।
...
- रेखांकन को ठीक करें
- डैश, पेपर थीम जोड़ें
- हेडर का पता लगाया गया, इसे ठीक करें
