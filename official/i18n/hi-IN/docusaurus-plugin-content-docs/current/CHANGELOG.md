...
- ठीक किया गया: "Translation first, original text follows" मोड में होवर अनुवाद काम नहीं करने की समस्या।
- ठीक किया गया: "Translation Only" मोड के साथ Reader View जैसे रीडिंग प्लगइन्स का उपयोग करते समय संगतता समस्याएं।
...
- सुधार: ऑनलाइन सेटिंग्स पृष्ठ परीक्षण सेवा इंटरफ़ेस तक पहुंच।
...
- ठीक किया गया: PDF-Pro लंबे फाइलों का स्वतः अनुवाद नहीं होने की समस्या।
...
- सुधार: पैनल में **More** विकल्पों में एक स्टोर समीक्षा प्रविष्टि जोड़ी गई।

## 1.13.5 Release (2025-01-14)

- सुधार: Gemini 2.0 थिंकिंग मॉडल के साथ संगत।
...
- सुधार: मूल भाषा की पहचान में सुधार। पहले, कई भाषाओं वाले पृष्ठों का अनुवाद नहीं हो पाता था, लेकिन अब उनका सही अनुवाद होता है।
...
- ठीक किया गया: YouTube पर अस्थायी रूप से द्विभाषी उपशीर्षक सक्षम करने पर काम नहीं करता।
...
- सुधार: "**Hover - immediately translate this paragraph**" मोड में छवियों का अनुवाद नहीं किया जाता है।
...
- ठीक किया गया: Facebook के अनुवाद-केवल मोड में "see more" पर क्लिक करने के बाद सामग्री गायब होने की समस्या।
...
- ठीक किया गया: विज्ञापन देखने के बाद YouTube पर समकालिक उपशीर्षक समय की समस्याएं।
...
- सुधार: स्थापना पैकेज के आकार को कम करें।
...
- जोड़ा गया: फोर्स एनेबल माउस सपोर्ट मोड (इस सुविधा को केवल तभी सक्षम करें जब टैबलेट डिवाइस पर माउस होवर फ़ंक्शन उपलब्ध न हो) **सेटिंग्स** -> **एडवांस्ड सेटिंग्स** -> **फोर्स एनेबल माउस सपोर्ट**
...
- द्विभाषी तुलना या केवल अनुवाद मोड में भाषाओं और वेबसाइटों के लिए अपवादों को कॉन्फ़िगर करने का समर्थन (सेटिंग्स पेज -> एडवांस्ड सेटिंग्स में कॉन्फ़िगर करें)। उदाहरण के लिए: यदि आपका डिफ़ॉल्ट अनुवाद मोड द्विभाषी तुलना है, लेकिन आप नहीं चाहते कि पारंपरिक चीनी भी द्विभाषी तुलना का उपयोग करे, तो आप द्विभाषी तुलना के लिए अपवाद भाषाओं में पारंपरिक चीनी जोड़ सकते हैं, ताकि पारंपरिक चीनी अनुवाद के लिए केवल अनुवाद मोड का उपयोग करे। इसी तरह, यदि आपका डिफ़ॉल्ट अनुवाद मोड केवल अनुवाद है, लेकिन आप चाहते हैं कि कोई विशेष भाषा या वेबसाइट द्विभाषी तुलना मोड का उपयोग करे, तो आप उस भाषा या वेबसाइट को अपवाद भाषाओं में भी जोड़ सकते हैं।
...
- [एडवांस्ड सेटिंग्स -> पैराग्राफ का अनुवाद करने के लिए आवश्यक न्यूनतम वर्णों की संख्या] कुछ मामलों में प्रभावी नहीं होने की समस्या को ठीक किया गया
...
- YouTube पर स्वचालित रूप से उत्पन्न अंग्रेजी सबटाइटल के लिए AI बुद्धिमान वाक्य विभाजन एल्गोरिदम अपनाया गया [प्रो उपलब्ध]
...
- पैनल स्विच केवल अनुवाद बटन प्रदर्शित करने के लिए संशोधित किया गया ताकि यह केवल वर्तमान पृष्ठ पर प्रभावी हो
...
- वीडियो उपशीर्षक प्लेटफ़ॉर्म समर्थन [DeepLearning.ai](https://learn.deeplearning.ai)
- वेब पेज अनुवाद और वीडियो उपशीर्षक अनुवाद के लिए समर्थन, जैसे कि अरबी, हिब्रू आदि भाषाओं में, RTL (दाएं-से-बाएं) प्रदर्शन मुद्दों को संबोधित करते हुए
- हिब्रू में Gemini अनुवाद को ठीक किया
- YouTube पर कुछ पारंपरिक चीनी उपशीर्षकों को सही ढंग से प्रदर्शित न कर पाने की समस्या को ठीक किया
- Safari पर Twitter उपशीर्षकों के प्रदर्शन की समस्या को ठीक किया
- पृष्ठ के नीचे तत्काल अनुवाद के लिए शॉर्टकट को ठीक किया

## 1.2.4

- ePub निर्माण में प्लेसहोल्डर्स को सही ढंग से प्रतिस्थापित न कर पाने की समस्या को ठीक किया
...
- पाठ रंग को कॉन्फ़िगर करने की समस्या को ठीक किया जो RGBA पूर्वावलोकन का समर्थन नहीं करता था [#1435](https://github.com/immersive-translate/immersive-translate/issues/1435)
- Safari प्लगइन संस्करण को अपग्रेड करने पर हमेशा स्थापना सफलता पृष्ठ को प्रदर्शित करने की समस्या को ठीक किया
- Microsoft ने वियतनामी के लिए समर्थन जोड़ा
- edx साइट पर अनुवादित उपशीर्षकों के प्रदर्शित न होने की समस्या को ठीक किया

## 1.2.2

- वीडियो उपशीर्षक अनुवाद समर्थन [pluto](https://pluto.tv/), [STARZ](https://www.starz.com/), [Paramount Plus](https://www.paramountplus.com/), [Rotten Tomatoes](https://www.rottentomatoes.com/), [Dailymotion](https://www.dailymotion.com/), [FMovies](https://fmoviesz.to/), [AniWatch](https://aniwatch.to/), [iQIYI](https://www.iq.com/), [Youku](https://www.youku.tv/), [movie-web](https://movie-web.app/). Twitter पर कुछ CC उपशीर्षक वाले वीडियो के अनुवाद का भी समर्थन करता है।
- त्रुटि पॉप-अप को अनुकूलित किया, नेटवर्क समस्या त्रुटि पॉप-अप स्वचालित रूप से मान्य मुफ्त अनुवाद सेवाओं का पता लगाता है।
- YouTube फुलस्क्रीन प्लेबैक के लिए immersive iOS APP समर्थन को ठीक किया।
...
- कुछ Pro उपयोगकर्ताओं के Chrome ब्राउज़र में सेटिंग्स को संशोधित न कर पाने की समस्या को ठीक किया।
- iOS पर YouTube के फुलस्क्रीन मोड में द्विभाषी उपशीर्षक प्रदर्शन का समर्थन किया।
...
- Netflix पर द्विभाषी उपशीर्षकों के निरंतर प्लेबैक की समस्या को ठीक किया
...
- **विशिष्ट पैराग्राफ का अनुवाद करने के लिए मोबाइल समर्थन:** मोबाइल संस्करण अब निर्दिष्ट पैराग्राफ का अनुवाद करने का समर्थन करता है और इसमें विभिन्न शॉर्टकट ऑपरेशन जोड़े गए हैं, जिनमें बाएं स्वाइप, दाएं स्वाइप, डबल-टैपिंग, ट्रिपल-टैपिंग, और मल्टी-फिंगर टच जेस्चर शामिल हैं। ये डिफ़ॉल्ट रूप से सक्षम नहीं हैं और उपयोगकर्ता को [माउस होवर] के तहत सेटिंग्स पृष्ठ में ट्रिगरिंग जेस्चर को सक्रिय रूप से चुनने की आवश्यकता होती है।
- **Gemini डिफ़ॉल्ट संस्करण अपडेट:** डिफ़ॉल्ट संस्करण अब `v1beta` है।
- **क्लासिकल चीनी अनुवाद को ठीक किया:** Microsoft और OpenAI की क्लासिकल चीनी अनुवाद कार्यक्षमता को ठीक किया।
- **जापानी अनुवाद अनुकूलन:** OpenAI के जापानी अनुवाद को और अनुकूलित किया गया है ताकि सटीकता और प्रवाह में सुधार हो सके।
- **इमर्सिव अनुवाद अनुभव:** उपयोगकर्ता की आदतों के साथ बेहतर अनुकूलन के लिए, हमने YouTube प्लेटफ़ॉर्म पर फुल-स्क्रीन मोड में द्विभाषी उपशीर्षकों के लिए शॉर्टकट को बाईं ओर स्थानांतरित कर दिया है।

## 1.1.5

- Windows पर डार्क मोड में ड्रॉपडाउन मेनू में कोई रंग न होने की समस्या को ठीक किया।
- Windows पर "More" विकल्प के बाईं ओर संरेखित न होने की समस्या को ठीक किया।
...
- PDF पृष्ठों को खोलते समय मोबाइल प्लगइन के प्रदर्शन विसंगति समस्या को ठीक किया।
...
- URL वाले इनपुट फ़ील्ड का अनुवाद करते समय केवल सामग्री के कुछ हिस्सों का अनुवाद करने की समस्या को ठीक किया।
...
- YouTube के लिए द्विभाषी उपशीर्षकों के शॉर्टकट की समस्या को ठीक किया जिसमें अत्यधिक लंबा अंग्रेजी पाठ था।
...
- **YouTube द्विभाषी उपशीर्षक**: YouTube वीडियो प्लेबैक विंडो में द्विभाषी उपशीर्षकों को सक्षम या छिपाने के लिए एक त्वरित पहुंच जोड़ी गई (इस सुविधा को बंद किया जा सकता है)।
...
- **बग फिक्स**:
  ...
  - पृष्ठ के फोकस खोने पर माउसओवर अनुवाद विफल होने की समस्या को ठीक किया।
  - इनपुट बॉक्स एन्हांसमेंट सुविधा में 3 से कम वर्णों का अनुवाद न होने की समस्या को ठीक किया।
...
- "वर्तमान साइट को कभी अनुवाद न करें" सेट करने पर मूल वीडियो उपशीर्षक प्रदर्शित नहीं होने की मरम्मत की गई।
...
- पैनल से अनुवाद पर क्लिक करके Epub ईबुक बनाने की समस्या को ठीक किया गया।
...
- पीडीएफ फ़ाइल प्रारंभिककरण समस्याओं को अनुकूलित करें।
...
- सफारी के तहत कुछ इनपुट बॉक्स संवर्धन समस्याओं को ठीक किया गया।
...
- कुछ प्लेटफार्मों की समस्या को हल किया गया जो यह पहचान नहीं सकते थे कि माउस समर्थित है या नहीं।
  - कुछ डेस्कटॉप ब्राउज़र हैं जो टचस्क्रीन और माउस दोनों का समर्थन करते हैं, और Immersive Translate तकनीकी रूप से यह पता लगाने में असमर्थ है कि क्या ऐसे प्लेटफार्म माउस का समर्थन करते हैं, इसलिए हमने [माउस होवर] सेटिंग में [माउस समर्थन को जबरन सक्षम करें] विकल्प जोड़ा है।
...
- यूट्यूब उपशीर्षक का द्वैध उपशीर्षक प्लगइन के साथ संघर्ष को ठीक करें (जब यूट्यूब द्वैध प्लगइन का पता लगाया जाता है तो यूट्यूब उपशीर्षक अनुवाद का Immersive Translate सक्षम नहीं होता है ताकि संघर्ष से बचा जा सके)।
...
- खोज एन्हांसमेंट का समर्थन करें, जब सक्षम किया जाता है, जब आप Google/Google News में चीनी में खोज करते हैं, तो दाएं कॉलम में स्वचालित रूप से संबंधित अंग्रेजी कीवर्ड के खोज परिणाम दिखाए जाएंगे, जो डिफ़ॉल्ट रूप से सक्षम है।
...
- डिफ़ॉल्ट सेटिंग्स को संशोधित करें: बड़ी संख्या में उपयोगकर्ताओं की प्रतिक्रिया के कारण कि वे इंस्टॉलेशन के बाद अनुवाद उपकरण का उपयोग नहीं करेंगे, उनके अनुवाद उपकरण की अपेक्षा यह है कि यह इंस्टॉलेशन के बाद स्वचालित रूप से अंग्रेजी वेब पृष्ठों का अनुवाद करेगा, इसलिए इस संस्करण से, चीनी उपयोगकर्ताओं के लिए, डिफ़ॉल्ट रूप से अंग्रेजी पृष्ठों का अनुवाद करने का विकल्प चालू कर दिया गया है (यदि उपयोगकर्ता ने पहले भाषा सेटिंग की है जो हमेशा अनुवादित होगी, तो इसे सम्मानित किया जाएगा, और परिवर्तन केवल एक्सटेंशन की प्रारंभिक सेटिंग्स को संशोधित करता है), और इसे रद्द करने की आवश्यकता है, इसे आसानी से [पॉपअप पैनल या सेटिंग्स पृष्ठ](/docs/faq/#%E5%A6%82%E4%BD%95%E5%85%B3%E9%97%AD%E8%87%AA%E5%8A%A8%E7%BF%BB%E8%AF%91) में रद्द किया जा सकता है।
...
- PDF फ़ाइलें खोलते समय एक्सटेंशन पैनल में कोई अनुमति नहीं होने की समस्या को ठीक करें।
...
- एक्सटेंशन पैनल अब असमर्थित पृष्ठों को इंगित कर सकता है (जैसे कि बिना अनुमति वाले पृष्ठ और गैर-HTML पृष्ठ)
...
- ठीक करें: कुछ क्षेत्रों का अनुवाद न होना (quora)

## 0.6.5

- Google Bard अनुकूलन
- इनपुट बॉक्स अनुवाद उपसर्गों के बिना सीधे पूरे टेक्स्ट बॉक्स का अनुवाद करने का समर्थन करता है।
- OpenAI अनुवादों के बिना सोचे-समझे अवधि जोड़ने की समस्या को अनुकूलित करें, (यदि मूल पाठ में कोई अवधि का पता नहीं चलता है, तो यदि openai एक अवधि लौटाता है, तो इसे हटा दें)
...
- प्रकार: // Hello World, फिर पैराग्राफ का अनुवाद करने के लिए स्पेस बार को तीन बार दबाएं।
- एक निश्चित भाषा में अनुवाद करने के लिए सेट करें: /ja Hello World, फिर पैराग्राफ का अनुवाद करने के लिए स्पेस बार को तीन बार दबाएं।

[त्वरित 30-सेकंड का परिचय देखने के लिए यहां क्लिक करें](/docs/input/)

## 0.6.0

- जून में पहली रिलीज़, पिछले व्यक्तिगत उपडोमेनhttps://immersive-translate.owenyoung.comसे नए डोमेन https://immersivetranslate.com/ में माइग्रेट किया गया
- कार्यक्षमता में बड़े पैमाने पर कोई बदलाव नहीं (नई सुविधाएँ उपलब्ध होंगी)

# 0.5.11

- उपशीर्षक अनुवाद समर्थन केवल अनुवाद निर्यात के लिए
- ठीक करें: कुछ तत्व माउस होवरिंग द्वारा पहचाने नहीं जाते
- ठीक करें: ट्वीट आंशिक लाइन ब्रेक पहचाने नहीं जाते
- ठीक करें: ईबुक लेखन शैली काम नहीं कर रही

## 0.5.10

- ठीक करें: ट्वीट लाइन ब्रेक पहचाने नहीं जाते
...
- कुछ मामलों में पैराग्राफ ब्रेक को ठीक करें:
- ठीक करें: Tampermonkey टॉगल केवल अनुवाद दिखाता है
- ठीक करें: ईबुक ऑनलाइन पढ़ने की शैली काम नहीं कर रही
...
- वेब कोर पार्सिंग को फिर से बनाया गया है, जिसका अर्थ है।
  ...
  - बड़ी वेबसाइटों के लिए तात्कालिक अनुवाद
...
- ठीक करें: macOS नया टैब पॉपअप समस्या।
- फीट: नए उपयोगकर्ता के लिए नया गाइड पृष्ठ।

## 0.5.5

- ठीक करें: माउस ओवर क्षेत्र समस्या।

## 0.5.4

- ठीक करें: Spa पृष्ठ डुप्लिकेट

## 0.5.3

- ठीक करें: माउस होवर हॉटकी श्रोता।
- ठीक करें: PDF दस्तावेज़ अनुवाद
- फीट: नया क्लाइंट गाइड पृष्ठ जोड़ें

## 0.5.2

- ठीक करें: userscript माउस होवर शॉर्टकट सेटिंग्स

## 0.5.1

- ठीक करें: OpenAI API काम नहीं करता।

## 0.5.0

- फीट: माउस होवर पर वर्तमान पैराग्राफ का अनुवाद करें।
- फीट: PDF अनुवाद को पुनर्गठित करें, अब आप Immersive Translate के साथ अधिकांश PDFs का अनुवाद कर सकते हैं
- ठीक करें: संदर्भ मेनू अक्षम काम नहीं कर रहा [#428](https://github.com/immersive-translate/immersive-translate/issues/428)
- ठीक करें: [Mastondon](https://mastodon.social/) के लिए सामग्री सुरक्षा नीति से बचें

## 0.4.11

- ठीक करें: userscript अनुमति (केवल userscript के लिए)।

## 0.4.8

- फीट: अधिक स्थिर गुणवत्ता के लिए Bing Translate को Microsoft Translate में बदलें।
- ठीक करें: शुद्ध TXT वेब पृष्ठ जैसे [यह](https://edoras.sdsu.edu/~vinge/misc/singularity.html)
- प्रदर्शन: वेबसाइट में कुछ बाल विज्ञापन पृष्ठों को बाहर करें, और प्रदर्शन में थोड़ा सुधार हुआ है

## 0.4.7

- ठीक करें: Firefox Userscript पॉपअप गायब।

## 0.4.6

- फीट: तीसरे पक्ष को `toggleTranslatePage` कॉल करने के लिए दस्तावेज़ ईवेंट भेजने की अनुमति दें
...
- ठीक करें: iOS 15.0 सफारी एक्सटेंशन समस्या।
- ठीक करें: macOS सफारी एक्सटेंशन शॉर्टकट
- ठीक करें: एक्सटेंशन के लिए सामग्री सुरक्षा नीति पॉपअप, और आंशिक रूप से userscript के लिए।
...
- ठीक करें: sup, sub टैग व्हाइटस्पेस पहचान।
...
- ठीक करें: पुनरारंभ के बाद फ़ायरफ़ॉक्स संदर्भ मेनू गायब हो गया।
...
- ठीक करें: संदर्भ मेनू कभी-कभी उपलब्ध नहीं हो सकता। [#273](https://github.com/immersive-translate/immersive-translate/issues/273)

## 0.3.16

- ठीक करें: &nbsp; को व्हाइटस्पेस के रूप में रखें।
...
- ठीक करें: pdf चयन पृष्ठभूमि रंग
- ठीक करें: व्हाइटस्पेस पहचान

## 0.3.13

- ठीक करें: ईबुक बिल्डर विशिष्ट वर्ण समस्या, जैसे कुछ अध्याय पथ `xxx' xxxx` है।
- UI: डिफ़ॉल्ट रूप से openai कस्टम विकल्पों को फोल्ड करें।
- UI: epub निर्यात के लिए निर्यात स्थिति जोड़ें।
- ठीक करें: Gpt4 डिफ़ॉल्ट प्रॉम्प्ट

## 0.3.12

- फीट: अब हम कस्टम मार्कर अनुवाद थीम पृष्ठभूमि रंग को अनुकूलित कर सकते हैं।
- ठीक करें: जब पृष्ठ टूट गया तो postMessage, अब हम यह केवल तभी करेंगे जब हम वास्तव में पृष्ठों का अनुवाद करेंगे
- ठीक करें: ईबुक प्रगति समस्या।
- ठीक करें: लंबे पैराग्राफ को विभाजित करने के लिए बेहतर, 1.5 बिलियन, 25.5%, श्री को सीमा के रूप में नहीं माना जाएगा

## 0.3.11

- ठीक करें: ईबुक रीडर डार्क मोड टेक्स्ट रंग
- ठीक करें: openAI प्रॉम्प्ट

## 0.3.10

- बेहतर: जापानी/कोरियाई कंटेनर का पता लगाएं।
- ठीक करें: ईबुक बिल्डर प्रगति 99% रुकी हुई।

## 0.3.9

- ठीक करें: विकल्प UI स्विच अनुवाद सेवाओं का इनपुट राज्य नहीं बदला।

## 0.3.8

- UI: लोडिंग रंग अधिक पारदर्शी
- ठीक करें: ईबुक भाषा का पता लगाएं।
...
- ठीक करें: Deepl त्रुटि हैंडल

## 0.3.7

- ठीक करें: ईबुक रीडर Chrome पर छवियों को लोड नहीं कर सकता।
...
- ठीक करें: userscript ईबुक निर्यात
...
- ठीक करें: Kindle के लिए ईबुक निर्माता
- परिवर्तन: लोडिंग आइकन रंग, काले से नीले, डार्क मोड वेब पृष्ठ के लिए अनुकूलन के लिए।
- फीट: एक्सटेंशन के लिए स्थानीय html अनुवाद का समर्थन करें

## 0.3.2

- ठीक करें: विकल्प फ़ॉर्म इनपुट कर्सर चल रहा है।
- फीट: OpenAI डेवलप सेटिंग्स के लिए कस्टम apiUrl का समर्थन करता है।

## 0.3.1

- फीट: डार्क आइकन को पारदर्शिता में अपडेट करें।
- ठीक करें: लंबे पैराग्राफ के लिए गलत क्रम

## 0.3.0

- संस्करण: अब से, हम हर महीने माइनर संस्करण संख्या बदलेंगे, उदाहरण के लिए, अब मार्च में, संस्करण 0.3.0 से शुरू होगा, अप्रैल में, संस्करण संख्या 0.4.0 होगी, और इसी तरह। ऐसा इसलिए है क्योंकि एक्सटेंशन के लिए अर्थशास्त्र का पालन करना कोई मतलब नहीं है, लेकिन समय के नियमों के अनुसार संस्करण संख्याओं को मानकीकृत करना विकास को अद्यतन रखने के लिए प्रेरणा है, और उपयोगकर्ताओं के लिए समस्याओं को अधिक आसानी से ढूंढना है।
- फीट: Firefox के लिए डार्क आइकन का समर्थन करें

## 0.2.86

- OpenAI के साथ प्रति अनुरोध अधिकतम पाठ लंबाई विकल्प जोड़ें
...
- फीट: पासवर्ड इनपुट फॉर्म पासवर्ड दिखाने की अनुमति दें।
...
- ठीक करें: फ़ायरफ़ॉक्स संदर्भ मेनू पुनरारंभ के बाद गायब हो गया।
- समर्थन Azure openai
...
- ठीक करें: विकल्प फॉर्म इनपुट कर्सर चल रहा है।
- फीट: OpenAI डेवलप सेटिंग्स के लिए कस्टम apiUrl का समर्थन करता है।
...
- संस्करण: अब से, हम हर महीने माइनर संस्करण संख्या बदलेंगे, उदाहरण के लिए, अब मार्च में, संस्करण 0.3.0 से शुरू होगा, अप्रैल में, संस्करण संख्या 1.4.0 होगी, और इसी तरह। ऐसा इसलिए है क्योंकि एक्सटेंशन के लिए अर्थशास्त्र का पालन करना कोई मतलब नहीं है, लेकिन समय के नियमों के अनुसार संस्करण संख्याओं को मानकीकृत करना विकास को अद्यतन रखने के लिए प्रेरणा है, और उपयोगकर्ताओं के लिए समस्याओं को अधिक आसानी से ढूंढना है।
- फीट: Firefox के लिए डार्क आइकन का समर्थन करें

## 0.2.56

- प्रति अनुरोध अधिकतम पाठ लंबाई विकल्प जोड़ें OpenAI के साथ

## 0.2.55

- ठीक करें: कुछ ईबुक फ़ाइलें नहीं मिल सकतीं।
...
- ठीक करें: कुछ साइटें `span` का उपयोग शैलियों के लिए करती हैं, इसलिए हम अनुवाद लक्ष्य रैपर के लिए span के बजाय `font` का उपयोग करते हैं
- ठीक करें: OpenAI अधिकतम टोकन सीमा, अधिकतम वर्णों को 1500 से 1300 में बदलें
