...
- जोड़ा गया: Deepseek, Gemini, Cluade समर्थन संदर्भ स्विच।
...
- सुधार: Greasemonkey और Safari के लिए भाषा पहचान क्षमताओं में सुधार किया गया है, जिन पृष्ठों में मामूली भाषाएँ हैं।
...
- जोड़ा गया: जब अनुवादित पाठ और मूल पाठ एक ही लेखन प्रणाली से संबंधित होते हैं, तो अनुवाद को एक विशेष शैली का उपयोग करके प्रदर्शित करें।
- ठीक किया गया: समस्या जहां **Mouse Hover Translation** कुछ वेबसाइटों पर काम नहीं करता है।
- सुधार: DeepLx अब अरबी का समर्थन करता है।
- सुधार: मूल भाषा पहचान में सुधार किया गया। पहले, कई भाषाओं वाले पृष्ठों का अनुवाद नहीं हो सकता था, लेकिन अब उनका सही अनुवाद किया जाता है।
- सुधार: Twitter के लिए, मल्टीलाइन सामग्री अनुवादों को डिफ़ॉल्ट रूप से रैप नहीं किया जाता है। रैपिंग केवल तभी होगी जब सामग्री 10 पंक्तियों या 1000 वर्णों से अधिक हो। रैपिंग को सेटिंग्स के माध्यम से सक्षम किया जा सकता है **Advanced Settings** -> **Enable automatic line wrapping for long paragraphs**।
...
- सुधार: बिना उपशीर्षक वाले वीडियो में एक अनुवाद आइकन प्रदर्शित होगा और अनुवाद क्यों संभव नहीं है इसका कारण प्रदान करेगा।
...
- सुधार: द्विभाषी मोड में अनुवाद गुणवत्ता में सुधार के लिए समृद्ध पाठ अनुवाद को डिफ़ॉल्ट रूप से बंद कर दिया गया है।
...
- सुधार: उन समस्याओं को संबोधित किया गया जहां PDF अनुवाद के दौरान अनुवाद बटन काम नहीं कर सकता
- सुधार: अनुवादित सूत्रों के प्रतिपादन को बढ़ाया गया
- सुधार: भाषा चयन सूची
...
- Google Meet अब लाइव मीटिंग्स के लिए द्विभाषी उपशीर्षक का समर्थन करता है: अब, आप Google Meet मीटिंग्स में द्विभाषी उपशीर्षक सुविधा का आनंद ले सकते हैं। बस मीटिंग लिंक खोलें, इमर्सिव अनुवाद पैनल में द्विभाषी उपशीर्षक सक्रिय करें, और फिर इसे अनुभव करने के लिए पृष्ठ को रिफ्रेश करें।
...
- YouTube में "केवल अनुवाद" मोड में उपशीर्षक प्रदर्शित न होने की समस्या को ठीक किया गया।
...
- वीडियो उपशीर्षक प्लेटफॉर्म [DeepLearning.ai](https://learn.deeplearning.ai) का समर्थन करता है
...
- वीडियो उपशीर्षक अनुवाद [Unreal Sensei](https://www.unrealsenseiacademy.com/) का समर्थन करता है
...
- पाठ रंग को कॉन्फ़िगर करने के मुद्दे को ठीक किया गया जो RGBA preview का समर्थन नहीं करता था [#1435](https://github.com/immersive-translate/immersive-translate/issues/1435)
- Safari plugin संस्करण को अपग्रेड करने पर हमेशा इंस्टॉलेशन सफलता पृष्ठ को प्रॉम्प्ट करने वाले मुद्दे को ठीक किया गया
- माइक्रोसॉफ्ट ने वियतनामी के लिए समर्थन जोड़ा
- edx साइट पर अनुवादित उपशीर्षक प्रदर्शित नहीं होने के मुद्दे को ठीक किया गया

## 1.2.2

- [pluto](https://pluto.tv/), [STARZ](https://www.starz.com/), [Paramount Plus](https://www.paramountplus.com/), [Rotten Tomatoes](https://www.rottentomatoes.com/), [Dailymotion](https://www.dailymotion.com/), [FMovies](https://fmoviesz.to/), [AniWatch](https://aniwatch.to/), [iQIYI](https://www.iq.com/), [Youku](https://www.youku.tv/), [movie-web](https://movie-web.app/) के लिए वीडियो उपशीर्षक अनुवाद समर्थन। ट्विटर पर कुछ CC उपशीर्षक वाले वीडियो के अनुवाद का भी समर्थन करता है।
...
- immersive iOS APP के लिए YouTube फुलस्क्रीन प्लेबैक समर्थन को ठीक किया गया।
- Perplexity.ai के साथ पैराग्राफ अनुवाद मुद्दे को ठीक किया गया [#707](https://github.com/immersive-translate/immersive-translate/issues/707)।
...
- कुछ Pro उपयोगकर्ता Chrome ब्राउज़र में सेटिंग्स को संशोधित नहीं कर सकते थे, इस मुद्दे को ठीक किया गया।
...
- Safari पर कुछ मामलों में सेटिंग्स पृष्ठ लगातार लोडिंग दिखाता था, इस मुद्दे को ठीक किया गया।
...
- मुख्य अनुवाद सेवा का अनुसरण करने के लिए बाल अनुवाद सेवा के लिए एक विकल्प जोड़ा गया
...
- ऑनलाइन PDFs सही ढंग से नहीं खुलने के मुद्दे को ठीक किया गया
- Netflix पर द्विभाषी उपशीर्षक के निरंतर प्लेबैक के मुद्दे को ठीक किया गया
...
- एक नया शॉर्टकट सेटिंग जोड़ा गया जो वीडियो उपशीर्षक के अंतर्निहित मशीन अनुवाद उपशीर्षक का उपयोग करने के लिए त्वरित टॉगलिंग की अनुमति देता है
...
- **क्लासिकल चाइनीज अनुवाद को ठीक किया गया:** माइक्रोसॉफ्ट और OpenAI के क्लासिकल चाइनीज अनुवाद कार्यक्षमता को ठीक किया गया।
- **जापानी अनुवाद अनुकूलन:** OpenAI के जापानी अनुवाद को और अनुकूलित किया गया ताकि सटीकता और प्रवाह में सुधार हो सके।
- **इमर्सिव अनुवाद अनुभव:** उपयोगकर्ता की आदतों के साथ बेहतर अनुकूलन के लिए, हमने YouTube प्लेटफॉर्म पर फुल-स्क्रीन मोड में द्विभाषी उपशीर्षक के लिए शॉर्टकट को बाईं ओर स्थानांतरित कर दिया है।

## 1.1.5

- Windows पर डार्क मोड में ड्रॉपडाउन मेनू का कोई रंग नहीं होने के मुद्दे को ठीक किया गया।
- Windows पर "More" विकल्प के बाईं ओर संरेखित नहीं होने के मुद्दे को ठीक किया गया।
...
- **पॉपअप पैनल UI अपग्रेड:** नया डिज़ाइन उपयोगिता और समझ को सुधारने का लक्ष्य रखता है। इस अपडेट में शामिल हैं:
  ...
  - **मुख्य मेनू में नई विशेषताएं:**
    ...
    - **दस्तावेज़ अनुवाद प्रविष्टि:** "PDF/ePub/subtitle files" का अनुवाद करने के लिए प्रविष्टि को त्वरित पहुंच के लिए मुख्य मेनू में स्थानांतरित कर दिया गया है।
...
- **5 वीडियो वेबसाइटों के लिए समर्थन जोड़ा गया:**
  - Youtube Music पर पॉडकास्ट के उपशीर्षक का समर्थन।
...
- URL वाले इनपुट फ़ील्ड का अनुवाद करते समय केवल सामग्री के कुछ हिस्सों का अनुवाद होने के मुद्दे को ठीक किया गया।

## 1.1.2

- ठीक किया गया: पृष्ठ का अनुवाद नहीं होने पर अनुवाद सेवाओं को स्विच करने का मुद्दा प्रभावी नहीं होता था।
...
- YouTube के लिए द्विभाषी उपशीर्षक शॉर्टकट के लिए अत्यधिक लंबे अंग्रेजी पाठ के मुद्दे को ठीक किया गया।
...
- **प्लगइन सेटिंग्स पृष्ठ UI अपडेट**:
  ...
  - "Advanced Settings" में, एक नया विकल्प जोड़ा गया है जो एक पैराग्राफ का अनुवाद करने के लिए आवश्यक न्यूनतम वर्णों की संख्या को कॉन्फ़िगर करने की अनुमति देता है। डिफ़ॉल्ट 4 वर्ण हैं, लेकिन इसे उच्चतर सेट किया जा सकता है (जैसे, 20), ताकि केवल लंबे पैराग्राफ का अनुवाद किया जाएगा।
...
- **YouTube द्विभाषी उपशीर्षक**: YouTube वीडियो प्लेबैक विंडो में द्विभाषी उपशीर्षक को सक्षम या छिपाने के लिए त्वरित पहुंच जोड़ी गई (इस सुविधा को बंद किया जा सकता है)।
...
- **UI अनुकूलन**: पृष्ठ अनुवाद त्रुटि संकेतों के लिए UI को फिर से डिज़ाइन किया गया ताकि उन्हें समझना आसान हो सके। जब कई त्रुटियाँ होती हैं, तो एक पॉप-अप सक्रिय रूप से उपयोगकर्ता को प्रॉम्प्ट करेगा।

- **बग फिक्स**:

  - पृष्ठ का ध्यान खोने पर माउसओवर अनुवाद विफल होने के मुद्दे को ठीक किया गया।
  - इनपुट बॉक्स एन्हांसमेंट सुविधा में 3 से कम वर्णों का अनुवाद नहीं होने के मुद्दे को ठीक किया गया।
  - द्विभाषी Epubs के उत्पादन के दौरान कुछ निर्देशिकाओं का अनुवाद नहीं होने के मुद्दे को ठीक किया गया।
...
- ठीक किया गया: पहली स्थापना के बाद कुछ मशीनों पर डिफ़ॉल्ट लक्ष्य भाषा पहचान मुद्दा।
...
- ऑप्टिमाइज़ किया गया: ब्राउज़र भाषा के आधार पर स्वचालित रूप से लक्ष्य भाषा सेट की गई।
...
- कुछ मामलों में जब वेबपेज को मध्य स्थिति में स्क्रॉल किया गया था, तब अनुवाद समय पर प्रतिक्रिया नहीं देने की समस्या को ठीक किया गया।
...
- [जब लंबे समय के लिए वेबपेज अनुवाद को अस्थायी रूप से चालू किया जाता है, तो पैनल पर [हमेशा इस वेबसाइट का अनुवाद करें] पर क्लिक करने से हमेशा अनुवाद रद्द नहीं होता #1172](https://github.com/immersive-translate/immersive-translate/issues/1172) को ठीक किया गया।

## 0.12.7

- [TED](https://www.ted.com), [Frontend Masters](https://frontendmasters.com/), [edx](https://www.edx.org/), [CodeWithChris](https://www.edx.org/), [Skillshare](https://www.ted.com) प्लेटफॉर्म्स के लिए द्विभाषी सबटाइटल्स जोड़े गए। https://learn.codewithchris.com/enrollments), [Skillshare](https://www.skillshare.com/) प्लेटफॉर्म्स
...
- पैनल पर क्लिक करके अनुवादों से Epub ईबुक्स बनाने का कार्य न करने की समस्या को ठीक किया गया।

## 0.12.4

- जब आप पैनल में द्विभाषी सबटाइटल्स चालू करते हैं, तो यह पहले पृष्ठ को स्वचालित रूप से रिफ्रेश करेगा (द्विभाषी सबटाइटल्स को अधिक सटीक रूप से प्रदर्शित करने के लिए), और कुछ साइट्स पर उपयोगकर्ताओं को साइट पर "CC" बटन को मैन्युअल रूप से क्लिक करना होगा।
- Grease Monkey, Safari भाषा पहचान को ऑप्टिमाइज़ किया गया।
- [Arxiv](https://arxiv.org/abs/1910.06709) पेपर्स साइट पर सभी पेपर्स के द्विभाषी संस्करणों के लिए त्वरित पहुंच प्रदान की गई।
...
- [लर्निंग मोड डिस्प्ले समस्या को ठीक किया गया #1180](https://github.com/immersive-translate/immersive-translate/issues/1180)
...
- Grease Monkey और Safari में भाषा पहचान को ऑप्टिमाइज़ किया गया।
...
- Twitter इनपुट बॉक्स के अंत में इमोजी का अनुवाद न होने की समस्या को ठीक किया गया।
- कुछ परिदृश्यों में तृतीय-पक्ष प्लग-इन्स की सामग्री का अनुवाद होने की स्थिति को ठीक किया गया।
- ऑनलाइन pdf होवरबॉल क्लिक अनुत्तरदायी समस्या को ठीक किया गया।

## 0.11.5

- अब आप Immersive Translate के लिए अनुवादित द्विभाषी पृष्ठ का सार्वजनिक लिंक उत्पन्न कर सकते हैं।
  - [क्लिक करें](/docs/share/) Immersive Translate शेयरिंग आइकन पर इसे एक क्लिक में उत्पन्न करने के लिए!
- कुछ प्लेटफॉर्म्स पर माउस का समर्थन है या नहीं, यह पहचानने में समस्या को हल किया गया।
...
- अनुभव को ऑप्टिमाइज़ किया गया, कुछ बग्स को ठीक किया गया।
...
- OpenAI के प्रॉम्प्ट की लंबाई को 90 से घटाकर 40 कर दिया गया, जिससे और भी अधिक ट्रैफ़िक बचता है।
...
- txt फ़ाइल अनुवाद को ठीक किया गया।
...
- Grease Monkey निम्न संस्करण अपडेट अलर्ट जोड़ें।
- स्थानीय txt फ़ाइलों का अनुवाद न होने की समस्या को ठीक किया गया।

## 0.10.5

- Youtube के कभी-कभी होमपेज पर लौटने की समस्या को ठीक किया गया।

## 0.10.4

- Youtube सबटाइटल का द्विभाषी सबटाइटल प्लगइन के साथ संघर्ष को ठीक किया गया (जब Youtube द्विभाषी प्लगइन का पता लगाया जाता है तो Youtube सबटाइटल अनुवाद सक्षम नहीं होता है ताकि संघर्ष से बचा जा सके)।
...
- कस्टम DeppL Auth Key अनुवाद समस्या को ठीक किया गया।

## 0.10.3

- Youtube वीडियो के लिए द्विभाषी सबटाइटल्स के साथ पूर्ण समर्थन 🎉।
...
- OpenAI अनुवाद के लिए सबटाइटल फ़ाइलों का संदर्भीकरण ऑप्टिमाइज़ करें।

## 0.10.1

- अनुवाद अनुभव को ऑप्टिमाइज़ करने के लिए मुख्य अनुवाद की प्राथमिकता बढ़ाएं।
- ins क्लिक अधिक पाठ का अनुवाद न होने की समस्या को ठीक किया गया।
...
- जब readwise हाइलाइट किया जाता है तो स्वचालित अनुवाद को ठीक किया गया।
...
- इनपुट संवर्धन पहचान को ऑप्टिमाइज़ करें ताकि गलत स्पर्श कम हो।
- ई-बुक और सबटाइटल अनुवाद ऑनलाइन।

## 0.9.3

- इनपुट बॉक्स अनुवाद: जब इसे पहली बार उपयोग किया जाता है, तो यह एक पॉप-अप अनुस्मारक प्रदर्शित करता है, और उपयोगकर्ता इसे इस बार या स्थायी रूप से अक्षम करने का विकल्प चुन सकता है ताकि आकस्मिक स्पर्शों से बचा जा सके।
...
- PDF अनुवाद उपकरण को ऑनलाइन संस्करण में स्थानांतरित किया गया है: https://app.immersivetranslate.com/pdf/ , ताकि Grease Monkey और Safari PDF अनुवाद का उपयोग कर सकें, और समस्याओं को बेहतर तरीके से हल किया जा सके बिना समस्या को हल करने के लिए एक संस्करण जारी किए।
...
- PDF अनुवाद के लिए अनुवाद शैली के त्वरित नियंत्रण के लिए नए विकल्प हैं (PDF फाइलें बहुत अजीब होती हैं और इन विकल्पों को चालू करना कुछ PDF फाइलों के लिए उपयोगी हो सकता है जिनका स्वरूप गड़बड़ है)
...
- Arigato अनुवादक सेटिंग फ़ील्ड और शब्दावली आईडी का समर्थन करता है
...
- PDF फाइलें खोलते समय एक्सटेंशन पैनल यह संकेत देने की समस्या को ठीक करें कि कोई अनुमति नहीं है।
...
- ठीक करें: ईबुक निर्माण शैली काम नहीं कर रही
...
- उस समस्या को ठीक करें: वेबसाइट अनुवाद अवधि की अस्थायी सेटिंग प्रभावी नहीं होती है।
...
- केवल अनुवाद दिखाने की सुविधा यहाँ है! [More] -> [Switch to show translations only] पर क्लिक करें।
  ...
  - कस्टम शॉर्टकट का समर्थन, इंटरफ़ेस सेटिंग्स -> शॉर्टकट सेटिंग्स में सेट करें
...
- ShadowRoot की सभी वेबसाइटों के अनुवाद का समर्थन किया गया है।
...
- माउस होवर शॉर्टकट को संशोधित करने की समस्या को ठीक किया गया, जिसके लिए पृष्ठ को प्रभावी होने के लिए ताज़ा करना आवश्यक था
...
- माउस होवर शॉर्टकट को बदलने की समस्या को ठीक किया गया, जिसके लिए पृष्ठ को प्रभावी होने के लिए ताज़ा करना आवश्यक था

- TXT फ़ाइलों में लाइन ब्रेक पहचान की समस्या को ठीक किया गया।

## 0.5.6

- ठीक करें: macOS नए टैब पॉपअप समस्या।
...
- विशेषता: जब माउस होवर होता है तो वर्तमान पैराग्राफ का अनुवाद करें।
- विशेषता: PDF अनुवाद का पुनर्निर्माण, अब आप Immersive Translate के साथ अधिकांश PDFs का अनुवाद कर सकते हैं
- ठीक करें: Context Menu को अक्षम करना काम नहीं कर रहा [#428](https://github.com/immersive-translate/immersive-translate/issues/428)
- ठीक करें: [Mastondon](https://mastodon.social/) के लिए Content Security Policy से बचें
...
- विशेषता: तीसरे पक्ष को `toggleTranslatePage` को कॉल करने के लिए दस्तावेज़ ईवेंट भेजने की अनुमति दें
- विशेषता: iOS ऐप में एक्सटेंशन बटन और समुदाय लिंक सक्षम करें
- UI: OpenAI सेटिंग्स फ़ील्ड मॉडल का उपयोग टेक्स्ट इनपुट बॉक्स के बजाय चयन के रूप में करें।
...
- ठीक करें: जब पृष्ठ टूट गया तो postMessage कुछ साइटों को तोड़ दिया, अब हम इसे केवल तभी करेंगे जब हम वास्तव में पृष्ठों का अनुवाद करेंगे
...
- ठीक करें: ईबुक बिल्डर प्रगति 99% रुका हुआ।
...
- ठीक करें: विकल्प फ़ॉर्म इनपुट कर्सर चलना।
- विशेषता: OpenAI समर्थन कस्टम apiUrl के लिए विकास सेटिंग्स।
...
- संस्करण: अब से, हम हर महीने माइनर संस्करण संख्या बदलेंगे, उदाहरण के लिए, अब मार्च में, संस्करण 0.3.0 से शुरू होगा, अप्रैल में, संस्करण संख्या 0.3.0 से शुरू होगी, अगले अप्रैल में, संस्करण संख्या 1.4.0 होगी, और इसी तरह। यह इसलिए है क्योंकि एक्सटेंशन के लिए अर्थ का पालन करना कोई मतलब नहीं है, लेकिन समय के नियमों के अनुसार संस्करण संख्याओं को मानकीकृत करना विकास को अद्यतन रखने के लिए प्रेरणा है, और उपयोगकर्ताओं के लिए समस्याओं को अधिक आसानी से ढूंढना है।
...
- विशेषता: txt वेब पृष्ठ अनुवाद का समर्थन करें

## 0.2.85

- ठीक करें: कुछ epub फ़ाइलें नहीं मिल सकती हैं।
...
- ठीक करें: विकल्प फ़ॉर्म UI
- ठीक करें: Open AI प्रॉम्प्ट
- विशेषता: OpenAI के लिए कई कुंजियों का समर्थन करें, उन्हें `,` से विभाजित करें।
...
- Feat: Tencent का समर्थन करें (alpha)
- Fix: openai अनुवाद
...
- Feat: विकल्पों पर अनुवाद सेवा सत्यापित करने का समर्थन करें।html
- Feat: कुछ साइटें मुख्य फ्रेम के रूप में बॉडी का उपयोग नहीं कर रही हैं, इसलिए कस्टम मुख्य फ्रेम का समर्थन करें

## 0.2.68

- Support Caiyun (Alpha)
- Fix अज्ञात ब्लॉक टैग
...
- Better: Deepl फ्री समर्थन
- Fix: उपयोगकर्ता स्क्रिप्ट और एक्सटेंशन के लिए उच्च मेमोरी उपयोग (opencc zh-CN को zh-TW से हटाकर, इसके बजाय Google अनुवाद के साथ)
...
- Feat: कुछ साइटों जैसे reddit को ठीक करने के लिए waitForSelectors नियम जोड़ें

## 0.2.61

- Fix: उपयोगकर्ता स्क्रिप्ट ग्रीसी फोर्क के लिए बहुत बड़ी है
- Better: फ़ाइल आकार कम करें

## 0.2.60

- Feat: Deepl के लिए zh-CN से zh-TW का समर्थन करें
- Feat: इमर्सिव अनुवाद Deepl सुविधा
...
- Fix: कुछ गणितीय तत्व मूल रूप से बने रहें
...
- इनलाइन तत्वों के लिए डुप्लिकेट अनुवाद को ठीक करें जिनमें कोड तत्व है।
- अज्ञात टैग इनलाइन/ब्लॉक जांच को ठीक करें
- Feat: डेवलपर बोर्ड पर इंजेक्टेड CSS का समर्थन करें
- Feat: authKey, appid appSecret को ट्रिम करें
- Better: नई टैब में सेटिंग पेज खोलें (लेकिन स्टे के लिए नहीं)
...
- डेवलपर पैनल पर बीटा सुविधा सक्षम करने का समर्थन करें
...
- शैडो रूट अनुवाद का समर्थन करें। उदाहरण के लिए:
...
- उपयोगकर्ता स्क्रिप्ट के लिए मानक मिलान को हटाएं
...
- सफारी globalThis.GM काम नहीं कर रहा है को ठीक करें

## 0.2.13

- उपयोगकर्ता स्क्रिप्ट पॉपअप ड्रैगिंग का समर्थन करें
- टच डिवाइस पर तीन उंगलियों का समर्थन करें पृष्ठों का अनुवाद करने के लिए टॉगल ट्रिगर करें
...
- Fix
  ...
  अन्नास आर्काइव पृष्ठ की मुख्य सामग्री का अनुवाद नहीं किया जा सका
...
- तत्वों को चिह्नित करने के लिए बहिष्कृत करें
...
- Fix
  ...
  एक से अधिक बार संदर्भ बनाएं

## 0.2.2

- PDF नमूना फ़ाइल ठीक करें
- Firefox pdf स्थानीय फ़ाइल ठीक करें
- pdf शॉर्टकट ठीक करें
...
- reddit मोबाइल कॉम्पैक्ट संस्करण ठीक करें
- पूर्णपाठ अनुवाद समस्या ठीक करें

## 0.2.0

- PDF दो कॉलम ठीक करें।
- Chrome/Edge स्टोर संस्करण बग ठीक करें।
- ठीक करें
...
- pdf मार्जिन ठीक करें।
- नमूना pdf फ़ाइल बदलें

## 0.0.62

- pdf प्रारूप, इंडेंट ठीक करें।
- telegra.ph तत्व परिवर्तन को रोकें ठीक करें

## 0.0.61

- span तत्व बंद ठीक करें।
...
- ब्लॉक img का अनुवाद ठीक करें।

## 0.0.49

- firefox एक्सटेंशन ठीक करें

## 0.0.48

- chrome एक्सटेंशन ठीक करें
...
- userscript मेटा जानकारी प्रारूपित करें
...
- tencent विभाजन त्रुटि ठीक करें।
...
- पॉपअप अनुवाद सेवा बदलने पर काम नहीं करने की समस्या ठीक करें
- reddit मोबाइल पोस्ट सामग्री अनुवाद ठीक करें।

## 0.0.36

- विकिपीडिया विशेष वर्ण ठीक करें
  [#6] (https://github.com/immersive-translate/next-immersive-translate/issues/6)
- userscript आइकन आकार ठीक करें।
- सभी साइटों को अनुच्छेद भाषा का पता लगाने में सक्षम करें।

## 0.0.35

- यूट्यूब पर अगली पृष्ठ पर जाने की समस्या ठीक करें
...
- सहेजने के बाद स्थानीय फ़ाइल का अनुवाद ठीक करें। ठीक किया गया
...
- हैश टैग जैसे #hash, at टैग जैसे @xxx, $tag, जैसे $APPL का अनुवाद नहीं करने का समर्थन करें
