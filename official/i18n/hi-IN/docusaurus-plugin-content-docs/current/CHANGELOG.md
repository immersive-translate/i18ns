...
- जोड़ा गया: टेक्स्ट चयन अनुवाद सुविधा
- जोड़ा गया: AI शब्दावली पुस्तकालय प्रबंधन
- जोड़ा गया: PC समर्थन Youtube AI उपशीर्षक सक्षम करने के लिए (Pro सदस्य)
...
- ठीक किया गया: Midjourney इनपुट बॉक्स वृद्धि मुद्दा जो मूल पाठ को दोहराता है।
...
- ठीक किया गया: एक समस्या जहां AI अनुवाद सेवा पारंपरिक चीनी का अनुवाद करते समय गलत तरीके से सरलीकृत चीनी आउटपुट करती थी।
- ठीक किया गया: "अनुवाद पहले, मूल पाठ बाद में" मोड में होवर अनुवाद काम नहीं करने का मुद्दा।
- ठीक किया गया: "केवल अनुवाद" मोड के साथ संगतता मुद्दे जब Reader View जैसे पढ़ने के प्लगइन्स के साथ उपयोग किया जाता है।
...
- ठीक किया गया: PDF-Pro लंबी फ़ाइलों का स्वचालित रूप से अनुवाद नहीं होने का मुद्दा।
...
- ठीक किया गया: माउस होवर फ़ंक्शन कुछ स्थितियों में गलत अनुवाद सेवा लोड करने का मुद्दा।
...
- ठीक किया गया: समृद्ध पाठ के कारण कुछ सूत्रों के अनुवाद के मुद्दे
...
- ठीक किया गया: संस्करण 1.11.2 में "Twitter अनुवाद सुधार" के कारण सूत्र अनुवाद का मुद्दा।
...
- कॉमिक अनुवाद के लिए लैटिन लिपि में भाषाओं के कॉमिक अनुवाद के लेआउट मुद्दों को ठीक किया गया।
...
- बड़ी वेब पेजों का अनुवाद, ePub निर्माण, और उपशीर्षक फ़ाइलों के अनुवाद के प्रदर्शन को महत्वपूर्ण रूप से अनुकूलित किया गया।
...
- YouTube उपशीर्षकों के अनुवाद की गति को महत्वपूर्ण रूप से अनुकूलित किया गया, और चीनी और अंग्रेजी क्रम के बीच स्विच करने, फ़ॉन्ट रंग और आकार को अनुकूलित करने आदि का समर्थन जोड़ा गया
...
- Safari पर Twitter उपशीर्षकों के प्रदर्शन की समस्या को ठीक किया गया
...
- **पॉपअप पैनल UI अपग्रेड:** नया डिज़ाइन उपयोगिता और समझ को बेहतर बनाने का लक्ष्य रखता है। इस अपडेट में शामिल हैं:

  - **मुख्य मेनू में नई सुविधाएँ:**
...
- PDF पृष्ठ खोलते समय मोबाइल प्लगइन के प्रदर्शन विसंगति समस्या को ठीक किया गया।
...
- URL वाले इनपुट फ़ील्ड का अनुवाद करते समय केवल सामग्री के कुछ हिस्सों का अनुवाद करने की समस्या को ठीक किया गया।
...
- **शॉर्टकट कुंजी सेटिंग्स**: एक नया शीर्ष-स्तरीय मेनू "शॉर्टकट" और निम्नलिखित अनुकूलन योग्य शॉर्टकट कुंजी कार्य जोड़े गए:
  ...
  - पृष्ठ पर माउस होवर पर "प्रत्यक्ष अनुवाद" को अस्थायी रूप से सक्षम करने के लिए कुंजियों के संयोजन को निर्दिष्ट करें। इसे फिर से दबाने से यह कार्य रद्द हो जाएगा।
...
- उस समस्या को हल किया गया जहां कुछ प्लेटफार्म यह पहचान नहीं सकते थे कि माउस समर्थित है या नहीं।
...
- अनुभव को अनुकूलित करें, कुछ बग ठीक करें।
...
- PDF अनुवाद उपकरण को ऑनलाइन संस्करण में माइग्रेट किया गया है: https://app.immersivetranslate.com/pdf/ , ताकि Grease Monkey और Safari PDF अनुवाद का उपयोग कर सकें, और समस्याओं को बेहतर तरीके से हल किया जा सके बिना समस्या को हल करने के लिए संस्करण जारी किए बिना।
...
- समस्या को ठीक करें कि जब साइट को कभी अनुवाद न करने के लिए सेट किया जाता है तो इनपुट बॉक्स एन्हांसमेंट सक्षम नहीं होता है।
...
- PDF अनुवाद समर्थन खींचें आकार बदलने और अनुवाद की सामग्री को संपादित करने के लिए
...
- TXT फ़ाइलों में पंक्ति फ़ीड पहचान की समस्या का समाधान किया गया।
...
- समस्या का समाधान: ईबुक बिल्डर प्रगति 99% पर रुकी।
...
- संस्करण: अब से, हम हर महीने माइनर संस्करण संख्या बदलेंगे, उदाहरण के लिए, अब मार्च में, संस्करण 0.3.0 से शुरू होगा, अप्रैल में, संस्करण संख्या 0.3.0 से शुरू होगी, अगले अप्रैल में, संस्करण संख्या 1.4.0 होगी, और इसी तरह। ऐसा इसलिए है क्योंकि एक्सटेंशन के लिए अर्थपूर्णता का पालन करना कोई मतलब नहीं है, लेकिन समय के नियमों के अनुसार संस्करण संख्याओं को मानकीकृत करना विकास को अद्यतन रखने के लिए प्रेरणा है, और उपयोगकर्ताओं के लिए समस्याओं को अधिक आसानी से ढूंढना है।
...
- विशेषता: विकल्पों पर अनुवाद सेवा सत्यापित करने का समर्थन करें।html
- विशेषता: कस्टम मुख्य फ्रेम का समर्थन करें क्योंकि कुछ साइटें मुख्य फ्रेम के रूप में बॉडी का उपयोग नहीं कर रही हैं
...
- ठीक करें: उपयोगकर्ता स्क्रिप्ट और एक्सटेंशन के लिए उच्च मेमोरी उपयोग (opencc zh-CN को zh-TW से हटाकर, इसके बजाय Google अनुवाद के साथ)
...
- सीआई: फ़ायरफ़ॉक्स पर स्रोत कोड सबमिट करें
...
- बॉडी क्षेत्र के लिए साइड पाद को ठीक करें
