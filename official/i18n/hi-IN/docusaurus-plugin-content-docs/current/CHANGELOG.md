...
- ठीक किया गया: "केवल अनुवाद" मोड के साथ रीडिंग प्लगइन्स जैसे Reader View का उपयोग करते समय संगतता समस्याएं।
...
- सुधार किया गया: Greasemonkey और Safari के लिए भाषा पहचान क्षमताओं में सुधार किया गया।
- सुधार किया गया: ऑनलाइन सेटिंग्स पृष्ठ परीक्षण सेवा इंटरफ़ेस पहुंच।
- सुधार किया गया: संदर्भ तुलना पूर्वावलोकन सुविधा का उपयोगकर्ता अनुभव बढ़ाया गया।
- सुधार किया गया: टच और माउस मोड निर्णय तर्क।

## 1.14.8 Release (2025-02-10)

- ठीक किया गया: PDF-Pro लंबे फ़ाइलों का स्वतः अनुवाद नहीं होने की समस्या।
...
- ठीक किया गया: **Mouse Hover Translation** समृद्ध पाठ का अनुवाद नहीं कर सकता की समस्या।
...
- सुधार किया गया: Twitter के लिए, बहु-पंक्ति सामग्री अनुवादों को डिफ़ॉल्ट रूप से लपेटा नहीं जाता है। लपेटना केवल तभी होगा जब सामग्री 10 पंक्तियों या 1000 वर्णों से अधिक हो। लपेटना सेटिंग्स के माध्यम से सक्षम किया जा सकता है **Advanced Settings** -> **Enable automatic line wrapping for long paragraphs**।
...
- जोड़ा गया: अधूरी ePub फ़ाइलों को पुनः आयात करने पर जहां से छोड़ा गया था वहां से अनुवाद जारी रखने की अनुमति दें।
...
- सुधार किया गया: "**Hover - immediately translate this paragraph**" मोड में छवियों का अनुवाद अब नहीं किया जाता है।
...
- जोड़ा गया: रीयल-टाइम मीटिंग **Subtitles Translation** अब "फ्लोट बॉल" के माध्यम से सक्रियण का समर्थन करता है, जो Zoom, Google Meet, और Microsoft Teams पर उपलब्ध है।
...
- [PDF Pro](https://app.immersivetranslate.com/pdf-pro/) सूत्र की प्रतिलिपि बनाने का समर्थन करता है (सूत्र पर राइट-क्लिक करें और कॉपी मेनू देखें)
...
- लैटिन लिपि में भाषाओं के लिए कॉमिक अनुवादों के टेक्स्ट लेआउट मुद्दों को ठीक किया गया।
...
- जब AI विशेषज्ञ "Intelligent Selection" के लिए उपयोग किए जाते हैं, तो विभिन्न वेबसाइटों के लिए विभिन्न AI विशेषज्ञों को अनुकूलित किया जा सकता है। इसे [Settings] -> [AI Experts] -> [Enter any expert] में सेट किया जा सकता है।
- "Translation Only" मोड में YouTube में सबटाइटल न दिखने की समस्या को ठीक किया गया।
...
- वीडियो द्विभाषी उपशीर्षकों में, जब लक्ष्य भाषा सरल चीनी होती है और मूल पाठ पारंपरिक चीनी होता है, तो मूल पाठ स्वचालित रूप से सरल चीनी में परिवर्तित हो जाएगा, और इसके विपरीत।
...
- [VK Video](https://vk.com/video) द्विभाषी उपशीर्षकों के लिए समर्थन
...
- वेब पेज अनुवाद और वीडियो सबटाइटल अनुवाद के लिए समर्थन, जैसे अरबी, हिब्रू आदि भाषाओं में, RTL (राइट-टू-लेफ्ट) डिस्प्ले मुद्दों का समाधान
- हिब्रू में Gemini अनुवाद को ठीक किया गया
- यूट्यूब पर कुछ पारंपरिक चीनी सबटाइटल्स सही ढंग से प्रदर्शित नहीं होने की समस्या को ठीक किया गया
- सफारी पर ट्विटर सबटाइटल्स के डिस्प्ले मुद्दे को ठीक किया गया
- पेज के नीचे तत्काल अनुवाद के लिए शॉर्टकट को ठीक किया गया
...
- चीन के भीतर से हाल के Microsoft अनुवाद सेवा अनुरोध अस्थिर रहे हैं; जब त्रुटियाँ होती हैं, तो सिस्टम स्वचालित रूप से वर्तमान में उपलब्ध अनुवाद सेवा का पता लगाता है, जिससे उपयोगकर्ता जल्दी से स्विच कर सकते हैं।
...
- यूट्यूब फुलस्क्रीन प्लेबैक के लिए इमर्सिव iOS ऐप समर्थन को ठीक किया गया।
...
- कुछ प्रो उपयोगकर्ता Chrome ब्राउज़र में सेटिंग्स को संशोधित नहीं कर सकते थे, इस समस्या को ठीक किया गया।
- iOS पर यूट्यूब के फुलस्क्रीन मोड में द्विभाषी सबटाइटल्स डिस्प्ले का समर्थन किया गया।
...
- सफारी पर कुछ मामलों में सेटिंग्स पृष्ठ लगातार लोडिंग दिखाने की समस्या को ठीक किया गया।
- इनपुट टैग नोड्स के अनुवाद के लिए समर्थन।
- त्रुटि पॉपअप UI को अनुकूलित किया गया।

## 1.1.9

- यूट्यूब लाइव और [Mubi](https://mubi.com/) प्लेटफॉर्म के लिए सबटाइटल अनुवाद समर्थन।
- अनुकूलन: सेटिंग्स पृष्ठ, URL सूची इंटरैक्शन UI (स्पष्टता से बचने के लिए, चेकबॉक्स डिफ़ॉल्ट रूप से प्रदर्शित नहीं होते हैं)।
- अनुवाद-केवल मोड में अनुवाद फ़ॉन्ट सेट करने के लिए समर्थन।
- नेटफ्लिक्स, टेड, ब्लूमबर्ग, उडेमी, कोर्सेरा पर वीडियो सबटाइटल्स को सक्षम करने के लिए त्वरित पहुंच जोड़ी गई।
- ठीक किया गया: कुछ अनुवादित शैलियाँ (जैसे कि अंडरलाइन) सफारी में प्रभावी नहीं थीं।
- ठीक किया गया: पेज अनुवाद के दौरान, माउस को होवर करने पर पुनः अनुवाद को ट्रिगर नहीं करने की समस्या।
...
- नेटफ्लिक्स पर द्विभाषी सबटाइटल्स के निरंतर प्लेबैक की समस्या को ठीक किया गया
...
- **मोबाइल के लिए विशिष्ट पैराग्राफ का अनुवाद समर्थन:** मोबाइल संस्करण अब निर्दिष्ट पैराग्राफ का अनुवाद करने का समर्थन करता है और इसमें विभिन्न शॉर्टकट ऑपरेशन्स जोड़े गए हैं, जिनमें बाएं स्वाइप करना, दाएं स्वाइप करना, डबल-टैपिंग, ट्रिपल-टैपिंग, और मल्टी-फिंगर टच जेस्चर शामिल हैं। ये डिफ़ॉल्ट रूप से सक्षम नहीं हैं और उपयोगकर्ता को सक्रिय रूप से सेटिंग्स पृष्ठ के तहत [माउस होवर] में ट्रिगरिंग जेस्चर का चयन करना होगा।
...
- **इमर्सिव अनुवाद अनुभव:** उपयोगकर्ता की आदतों के बेहतर अनुकूलन के लिए, हमने यूट्यूब प्लेटफॉर्म पर फुल-स्क्रीन मोड में द्विभाषी सबटाइटल्स के लिए शॉर्टकट को बाईं ओर स्थानांतरित कर दिया है।

## 1.1.5

- विंडोज़ पर डार्क मोड में ड्रॉपडाउन मेनू में कोई रंग नहीं होने की समस्या को ठीक किया गया।
- विंडोज़ पर "More" विकल्प के बाईं ओर संरेखित नहीं होने की समस्या को ठीक किया गया।
...
- **पॉपअप पैनल UI अपग्रेड:** नया डिज़ाइन उपयोगिता और समझ को सुधारने का लक्ष्य रखता है। इस अपडेट में शामिल हैं:
  ...
  - **मुख्य मेनू में नई विशेषताएं:**
    - **द्विभाषी/केवल अनुवाद मोड स्विच:** अब आप मुख्य मेनू में अनुवाद बटन के बाईं ओर स्थित "द्विभाषी अनुवाद मोड" और "केवल अनुवाद मोड" के बीच स्विच कर सकते हैं।
...
- **5 वीडियो वेबसाइटों के लिए समर्थन जोड़ा गया:**
  - यूट्यूब म्यूजिक पर पॉडकास्ट के सबटाइटल्स के लिए समर्थन।
...
- मोबाइल प्लगइन के PDF पृष्ठ खोलने पर डिस्प्ले विसंगति समस्या को ठीक किया गया।
...
- यूट्यूब के लिए द्विभाषी सबटाइटल्स शॉर्टकट की समस्या को ठीक किया गया जिसमें अंग्रेजी टेक्स्ट बहुत लंबा था।
...
- **यूट्यूब द्विभाषी सबटाइटल्स**: यूट्यूब वीडियो प्लेबैक विंडो में द्विभाषी सबटाइटल्स को सक्षम या छिपाने के लिए एक त्वरित पहुंच जोड़ी गई (इस सुविधा को बंद किया जा सकता है)।
...
- **बग फिक्स**:
  ...
  - पृष्ठ का ध्यान खोने पर माउसओवर अनुवाद विफल होने की समस्या को ठीक किया गया।
  - इनपुट बॉक्स एन्हांसमेंट फीचर में 3 से कम वर्णों का अनुवाद नहीं होने की समस्या को ठीक किया गया।
  - द्विभाषी Epubs के उत्पादन के दौरान कुछ निर्देशिकाओं का अनुवाद नहीं होने की समस्या को ठीक किया गया।

- **फ़ीचर हटाना**: द्विभाषी जानकारी एन्हांसमेंट फीचर (Google खोज पृष्ठों पर एक साथ अंग्रेजी खोज परिणाम प्रदर्शित करना) को हटा दिया गया।
...
- [जब अस्थायी रूप से लंबे समय के लिए वेबपेज अनुवाद चालू किया जाता है, तो पैनल पर [हमेशा इस वेबसाइट का अनुवाद करें] पर क्लिक करने से हमेशा अनुवाद रद्द नहीं होता #1172](https://github.com/immersive-translate/immersive-translate/issues/1172)
...
- pubmed.ncbi.nlm.nih.gov साइट और स्कॉलर्स्कोप प्लगइन के तहत सहयोग के लिए समर्थन
- रेडिट इनपुट बॉक्स अनुवाद पृष्ठ झटके की समस्या को ठीक करें
...
- पैनल से अनुवाद पर क्लिक करके Epub ईबुक बनाने की समस्या को ठीक करें

## 0.12.4

- जब आप पैनल में द्विभाषी उपशीर्षक चालू करते हैं, तो यह पहले पृष्ठ को स्वचालित रूप से रीफ्रेश करेगा (द्विभाषी उपशीर्षक को अधिक सटीक रूप से प्रदर्शित करने के लिए), और कुछ साइटों को अभी भी उपशीर्षक चालू करने के लिए उपयोगकर्ताओं को साइट पर "CC" बटन पर मैन्युअल रूप से क्लिक करने की आवश्यकता होती है।
...
- [अस्थायी रूप से लंबे समय के लिए वेब अनुवाद चालू करना हमेशा अनुवाद रद्द नहीं करता है #1172](https://github.com/immersive-translate/immersive-translate/issues/1172)
...
- [Arxiv](https://arxiv.org/abs/1910.06709) पेपर साइट के दाईं ओर एक त्वरित-अनुवाद पीडीएफ पोर्टल जोड़ा गया, जो एक साफ एचटीएमएल पृष्ठ पर जाता है (केवल कुछ पेपर द्वारा समर्थित, क्योंकि इसके लिए मूल लेखकों को स्रोत कोड जमा करने की आवश्यकता होती है, इसलिए लगभग 50% पेपर इस पोर्टल को दिखाएंगे)
...
- प्लगइन और आधिकारिक वेबसाइट के लिए 11 नई इंटरफ़ेस भाषाएं जोड़ी गईं, अब समर्थित इंटरफ़ेस भाषाएं 14 तक पहुंच गई हैं, जिनमें चीनी सरलीकृत, चीनी पारंपरिक, अंग्रेजी, जापानी, कोरियाई, रूसी, स्पेनिश, पुर्तगाली, हिंदी, इतालवी, जर्मन, फ्रेंच, अरबी और फारसी शामिल हैं।
- पिछले संस्करण में जोड़े गए द्विभाषी साझाकरण (रीफ्रेशिंग मोड) को द्विभाषी पृष्ठ स्नैपशॉट साझाकरण में संशोधित करें, ताकि साझा की गई सामग्री अधिक मूल हो, साथ ही व्यापक अनुकूलता।
...
- कुछ प्लेटफार्मों की समस्या को हल किया गया जो यह पहचान नहीं सकते थे कि माउस समर्थित है या नहीं
  - कुछ डेस्कटॉप ब्राउज़र हैं जो टचस्क्रीन और माउस दोनों का समर्थन करते हैं, और Immersive Translates तकनीकी रूप से यह पता लगाने में असमर्थ है कि क्या ऐसे प्लेटफॉर्म माउस का समर्थन करते हैं, इसलिए हमने [माउस होवर] सेटिंग में [फोर्स एनेबल माउस सपोर्ट] विकल्प जोड़ा है
...
- [स्थायी रूप से वीडियो उपशीर्षक फ़ंक्शन अक्षम करें] जोड़ा गया, यदि अन्य संघर्ष मुद्दे हैं और आप Immersive Translate के साथ द्विभाषी उपशीर्षक फ़ंक्शन को सक्षम नहीं करना चाहते हैं।
...
- द्विभाषी उपशीर्षकों के साथ यूट्यूब वीडियो के लिए पूर्ण समर्थन 🎉।
...
- गलत स्पर्श को कम करने के लिए इनपुट एन्हांसमेंट डिटेक्शन को अनुकूलित करें
- ई-बुक और सबटाइटल अनुवाद ऑनलाइन

## 0.9.3

- इनपुट बॉक्स अनुवाद: जब इसे पहली बार उपयोग किया जाता है तो एक पॉप-अप रिमाइंडर प्रदर्शित करता है, और उपयोगकर्ता इसे इस बार या स्थायी रूप से अक्षम करने का विकल्प चुन सकता है ताकि आकस्मिक स्पर्श से बचा जा सके।
- केवल अनुवाद निर्यात गति अनुकूलन, यदि आप केवल अनुवाद निर्यात करने का विकल्प चुनते हैं, तो आप सीधे सिस्टम PDF Preview को निर्यात करने के लिए कॉल कर सकते हैं, तेज़।
...
- कस्टम नियम अब डिफ़ॉल्ट बिल्ट-इन नियमों के साथ मर्जिंग का समर्थन करते हैं, उदाहरण के लिए: `{"id": "youtube", "selectors.add":["#test"]}` का अर्थ है मौजूदा चयनकर्ताओं में एक `#test` जोड़ना, `selectors` का अर्थ है डिफ़ॉल्ट को ओवरराइड करना, `selectors.remove` का अर्थ है डिफ़ॉल्ट चयनकर्ताओं में से एक को हटाना, और `selectors.remove` का अर्थ है डिफ़ॉल्ट चयनकर्ताओं में से एक को हटाना।
...
- इनपुट बॉक्स एन्हांसमेंट: // उपसर्ग को छोड़ने की अनुमति देता है और 3 स्पेस के साथ पूरे इनपुट बॉक्स के अनुवाद को ट्रिगर करता है, या आप सेटिंग्स पेज में इस विकल्प को बंद कर सकते हैं।
...
- डिफ़ॉल्ट सेटिंग्स को संशोधित करें: बड़ी संख्या में उपयोगकर्ताओं की प्रतिक्रिया के कारण कि वे इंस्टॉलेशन के बाद अनुवाद उपकरण का उपयोग नहीं करेंगे, उनके अनुवाद उपकरण की अपेक्षा यह है कि यह इंस्टॉलेशन के बाद स्वचालित रूप से अंग्रेजी वेब पेजों का अनुवाद करेगा, इसलिए इस संस्करण से, चीनी उपयोगकर्ताओं के लिए, डिफ़ॉल्ट रूप से अंग्रेजी पृष्ठों का अनुवाद करने का विकल्प चालू कर दिया गया है (यदि उपयोगकर्ता ने पहले भाषा सेटिंग की है जो हमेशा अनुवादित होगी, तो इसे सम्मानित किया जाएगा, और परिवर्तन केवल एक्सटेंशन की प्रारंभिक सेटिंग्स को संशोधित करता है), और इसे रद्द करने की आवश्यकता है, इसे आसानी से [Popup panel or settings page](/docs/faq/#%E5%A6%82%E4%BD%95%E5%85%B3%E9%97%AD%E8%87%AA%E5%8A%A8%E7%BF%BB%E8%AF%91) में रद्द किया जा सकता है।
...
- PDF फाइलें खोलते समय एक्सटेंशन पैनल के पास कोई अनुमति नहीं होने की समस्या को ठीक करें।
...
- Safari सबटाइटल फाइलों को मान्यता नहीं मिलने की समस्याएं
...
- जून में पहला रिलीज़, पिछले व्यक्तिगत उपडोमेन से माइग्रेट किया गया https://immersive-translate.owenyoung.com से नए डोमेन https://immersivetranslate.com/
- कार्यक्षमता में बड़े पैमाने पर कोई बदलाव नहीं (अगले रिलीज़ में नई सुविधाएँ उपलब्ध होंगी!)
...
- अनुकूलित करें: अनुवाद को ट्रिगर करने वाले पैराग्राफ में न्यूनतम वर्णों की संख्या को 4 वर्णों के न्यूनतम तक संशोधित किया गया ताकि भ्रम को कम किया जा सके, जबकि साइट के नेविगेशन और अंत क्षेत्रों का अनुवाद करने से बचने के लिए अन्य सुविधाओं का उपयोग किया जा सके।
- ठीक करें: Github विवरण का विस्तार करने के बाद अनुवाद नहीं हो रहा है।

## 0.5.14

- कुछ वेब पेजों पर छवियों की समस्या को ठीक करें: कॉपी करने के बाद बड़ी हो जाती हैं
- ठीक करें: माध्यम टिप्पणी अनुभाग का अनुवाद नहीं हो रहा है
...
- Fix: संदर्भ मेनू को अक्षम करना काम नहीं कर रहा [#428](https://github.com/immersive-translate/immersive-translate/issues/428)
...
- Feat: अब हम कस्टम मार्कर अनुवाद थीम पृष्ठभूमि रंग को अनुकूलित कर सकते हैं।
...
- Fix: ईबुक बिल्डर प्रगति 99% पर रुकी।
...
- Fix: विकल्प फ़ॉर्म इनपुट कर्सर चल रहा है।
...
- संस्करण: अब से, हम हर महीने माइनर संस्करण संख्या बदलेंगे, उदाहरण के लिए, अब मार्च में, संस्करण 0.3.0 से शुरू होगा, अप्रैल में, संस्करण संख्या 0.3.0 से शुरू होगी, अगले अप्रैल में, संस्करण संख्या 1.4.0 होगी, और इसी तरह। ऐसा इसलिए है क्योंकि एक्सटेंशन के लिए यह अर्थ नहीं रखता कि वे अर्थशास्त्र का पालन करें, लेकिन समय के नियमों के अनुसार संस्करण संख्याओं को मानकीकृत करना विकास को अद्यतन रखने के लिए प्रेरणा है, और उपयोगकर्ताओं के लिए समस्याओं को अधिक आसानी से ढूंढना है।
...
- Feat: पासवर्ड दिखाने के लिए पासवर्ड इनपुट फ़ॉर्म की अनुमति दें।
...
- यूट्यूब पर अगली पृष्ठ पर जाने की समस्या को ठीक करें
