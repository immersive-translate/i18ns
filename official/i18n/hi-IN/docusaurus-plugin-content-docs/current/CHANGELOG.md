...
- जोड़ा गया: PC में Youtube AI उपशीर्षक सक्षम करने का समर्थन (Pro सदस्य)
...
- ठीक किया गया: Midjourney इनपुट बॉक्स में मूल टेक्स्ट को दोहराने की समस्या।

## 1.15.8 Release (2025-03-20)

- ठीक किया गया: उन उपकरणों पर होवर अनुवाद शॉर्टकट कुंजी न काम करने की समस्या जो माउस और टच दोनों का समर्थन करते हैं।
...
- ठीक किया गया: "अनुवाद पहले, मूल पाठ बाद में" मोड में होवर अनुवाद न काम करने की समस्या।
...
- ठीक किया गया: उपयोगकर्ता कॉन्फ़िगरेशन फ़ाइल के आकार की सीमा से अधिक होने की समस्या।
...
- ठीक किया गया: PDF-Pro लंबे फाइलों का स्वचालित रूप से अनुवाद न होने की समस्या।
- सुधार किया गया: Microsoft, Google, और Tencent अब कैन्टोनीज़ का समर्थन करते हैं।
...
- ठीक किया गया: Gemini में मल्टी-सेगमेंट अनुवाद के दौरान कुछ सामग्री छूटने की समस्या।
...
- ठीक किया गया: कुछ वेबसाइटों पर **Mouse Hover Translation** काम न करने की समस्या।
- सुधार किया गया: DeepLx अब अरबी का समर्थन करता है।
- सुधार किया गया: मूल भाषा की पहचान में सुधार किया गया। पहले, कई भाषाओं वाले पृष्ठों का अनुवाद नहीं हो पाता था, लेकिन अब उनका सही अनुवाद होता है।
- सुधार किया गया: Twitter के लिए, मल्टीलाइन सामग्री अनुवादों को डिफ़ॉल्ट रूप से रैप नहीं किया जाता है। रैपिंग केवल तब होगी जब सामग्री 10 पंक्तियों या 1000 वर्णों से अधिक हो। रैपिंग को सेटिंग्स के माध्यम से सक्षम किया जा सकता है **Advanced Settings** -> **Enable automatic line wrapping for long paragraphs**।
...
- सुधार किया गया: पैनल और सेटिंग्स पृष्ठों में दाएं से बाएं भाषाओं के लिए लेआउट समायोजन।

## 1.12.6 (2024-12-26)

- ठीक किया गया: कुछ स्थितियों में माउस होवर फ़ंक्शन गलत अनुवाद सेवा लोड करता है।
- ठीक किया गया: YouTube पर अस्थायी रूप से द्विभाषी उपशीर्षक सक्षम करने पर काम न करने की समस्या।
...
- सुधार किया गया: बिना उपशीर्षक वाले वीडियो में अनुवाद आइकन प्रदर्शित होगा और अनुवाद न होने का कारण प्रदान करेगा।
...
- सुधार किया गया: द्विभाषी मोड में अनुवाद गुणवत्ता में सुधार के लिए समृद्ध पाठ अनुवाद डिफ़ॉल्ट रूप से बंद कर दिया गया है।
- ~~सुधार किया गया: "**Enable Sidebar & Navbar Translation**" को कस्टमाइज़ करने का विकल्प "**Advanced Settings**" में जोड़ा गया।~~
- सुधार किया गया: "**Hover - तुरंत इस पैराग्राफ का अनुवाद करें**" मोड में छवियों का अनुवाद नहीं किया जाता है।

## 1.11.4 (2024-11-16)

- Fixed: "Twitter Translation Improvement" के कारण version 1.11.2 में फॉर्मूला अनुवाद के साथ समस्या।

## 1.11.2 (2024-11-13)

- Fixed: Facebook के translation-only मोड में "see more" पर क्लिक करने के बाद सामग्री गायब होने की समस्या।
- ~~Improved: Twitter पर मल्टीलाइन द्विभाषी अनुवाद के प्रदर्शन को बेहतर बनाया गया।~~
...
- Fixed: विज्ञापन देखने के बाद YouTube पर उपशीर्षक समय के मुद्दों को सिंक्रनाइज़ किया गया।
- Fixed: MacOS 15 पर Safari में राइट-क्लिक अनुवाद मेनू के प्रदर्शन के मुद्दे।
- Fixed: कुछ वेबसाइटों पर **Enhanced input** में Ctrl+Z undo कार्यक्षमता के साथ समस्याएं।
...
- Added: Forece Enable Mouse Support मोड (इस सुविधा को केवल तभी सक्षम करें जब टैबलेट उपकरणों पर माउस होवर फ़ंक्शन उपलब्ध न हो) **Settings** -> **Advanced Settings** -> **Forece Enable Mouse Support**
...
- Improved: उन मुद्दों को संबोधित किया जहां PDF अनुवाद के दौरान अनुवाद बटन काम नहीं कर सकता था
...
- द्विभाषी कंट्रास्ट या केवल अनुवाद मोड में भाषाओं और वेबसाइटों के लिए अपवादों को कॉन्फ़िगर करने का समर्थन (सेटिंग्स पृष्ठ -> उन्नत सेटिंग्स में कॉन्फ़िगर करें)। उदाहरण के लिए: यदि आपका डिफ़ॉल्ट अनुवाद मोड द्विभाषी कंट्रास्ट है, लेकिन आप नहीं चाहते कि पारंपरिक चीनी भी द्विभाषी कंट्रास्ट का उपयोग करे, तो आप पारंपरिक चीनी को द्विभाषी कंट्रास्ट के लिए अपवाद भाषाओं में जोड़ सकते हैं, ताकि पारंपरिक चीनी केवल अनुवाद मोड का उपयोग करे। इसी तरह, यदि आपका डिफ़ॉल्ट अनुवाद मोड केवल अनुवाद है, लेकिन आप चाहते हैं कि कोई विशेष भाषा या वेबसाइट द्विभाषी कंट्रास्ट मोड का उपयोग करे, तो आप उस भाषा या वेबसाइट को अपवाद भाषाओं में भी जोड़ सकते हैं।
...
- अब आप इनपुट बॉक्स में टेक्स्ट का अनुवाद राइट-क्लिक के साथ कर सकते हैं: वेबपृष्ठ पर किसी इनपुट बॉक्स में किसी भी टेक्स्ट का चयन करें, अनुवाद चुनने के लिए राइट-क्लिक करें, और immersive translation स्वचालित रूप से चयनित टेक्स्ट को इनपुट बॉक्स की लक्ष्य भाषा में अनुवाद करेगा, जिससे इनपुट बॉक्स में मूल भाषा के टेक्स्ट को अन्य भाषाओं में जल्दी से अनुवाद करना सुविधाजनक हो जाता है।
...
- मंगा अनुवाद के लिए उपयोगकर्ता फीडबैक बटन जोड़ा गया (मंगा का अनुवाद करने के बाद, फ्लोटिंग बॉल के दाईं ओर [Feedback] बटन पर क्लिक करके अनुवाद गुणवत्ता पर फीडबैक दें)।
...
- ठीक किया गया: पृष्ठ अनुवाद के दौरान, माउस को घुमाने पर पुनः अनुवाद को ट्रिगर नहीं करने की समस्या।
...
- YouTube के लिए द्विभाषी उपशीर्षकों के शॉर्टकट की समस्या को ठीक किया गया जिसमें अत्यधिक लंबा अंग्रेजी पाठ था।
...
- **शॉर्टकट कुंजी सेटिंग्स**: एक नया शीर्ष-स्तरीय मेनू "शॉर्टकट्स" और निम्नलिखित अनुकूलन योग्य शॉर्टकट कुंजी कार्य जोड़े गए:
  ...
  - वर्तमान इनपुट बॉक्स की सामग्री का अनुवाद करने के लिए कुंजियों के संयोजन को निर्दिष्ट करें, जो पहले के त्वरित रूप से स्पेस बार को तीन बार दबाने के तरीके को पूरक करता है।
...
- Twitter Space के लिए वास्तविक समय उपशीर्षक अनुवाद का समर्थन किया गया।
...
- उस समस्या को ठीक किया गया जहां माउस को होवर करने पर कुछ मामलों में शॉर्टकट कुंजी को दबाए बिना अनुवाद जारी रहता था।
...
- [जब अस्थायी रूप से लंबे समय के लिए वेबपृष्ठ अनुवाद चालू किया जाता है, तो पैनल पर [हमेशा इस वेबसाइट का अनुवाद करें] पर क्लिक करने से हमेशा अनुवाद रद्द नहीं होता #1172](https://github.com/immersive-translate/immersive-translate/issues/1172) को ठीक किया गया।
...
- YouTube/Web of Science आदि के अनुवाद टैब स्विच करते समय संवेदनशील नहीं होने की समस्या को ठीक किया गया।
...
- [अस्थायी रूप से वेब अनुवाद को एक निश्चित समय के लिए चालू करना हमेशा अनुवाद रद्द नहीं करता है #1172](https://github.com/immersive-translate/immersive-translate/issues/1172)
...
- Twitter इनपुट बॉक्स के अंत में इमोजी का अनुवाद नहीं हो सकता है, इस समस्या को ठीक किया गया।
...
- अब आप Immersive Translate के लिए अनुवादित द्विभाषी पृष्ठ का सार्वजनिक लिंक उत्पन्न कर सकते हैं।
  - [क्लिक करें](/docs/share/) Immersive Translate साझाकरण आइकन पर एक क्लिक में इसे उत्पन्न करने के लिए!
- उस समस्या को हल किया गया कि कुछ प्लेटफार्मों पर यह पहचान नहीं हो पाती थी कि माउस समर्थित है या नहीं।
...
- Youtube के सबटाइटल को Dual subtitle plugin के साथ होने वाले संघर्ष को ठीक किया (जब Youtube Dual plugin का पता चलता है तो संघर्ष से बचने के लिए Youtube सबटाइटल अनुवाद सक्षम नहीं होता है)
- [Permanently Disable Video Subtitle Function] जोड़ा गया, अगर अन्य संघर्षपूर्ण मुद्दे हैं और आप Immersive Translate के साथ द्विभाषी सबटाइटल फ़ंक्शन को सक्षम नहीं करना चाहते हैं।
- सबटाइटल ब्रेक्स को ऑप्टिमाइज़ किया

## 0.10.3

- Custom DeppL Auth Key Translation Issue को ठीक किया

## 0.10.3

- Youtube वीडियो के लिए द्विभाषी सबटाइटल के साथ पूर्ण समर्थन 🎉।
- लेख पृष्ठों के लिए, अब साइडबार सामग्री के बाकी हिस्सों से पहले बॉडी टेक्स्ट का अनुवाद किया जाएगा
- DeepL Translation Contextualization को ऑप्टिमाइज़ किया
- OpenAI के सबटाइटल फाइलों के अनुवाद को संदर्भ के लिए ऑप्टिमाइज़ किया

## 0.10.1

- अनुवाद अनुभव को ऑप्टिमाइज़ करने के लिए बॉडी अनुवाद की प्राथमिकता बढ़ाई
- ins क्लिक अधिक टेक्स्ट का अनुवाद न होने की समस्या को ठीक किया

## 0.9.8

- अनुभव को ऑप्टिमाइज़ किया, कुछ बग्स को ठीक किया

## 0.9.7

- जब readwise हाइलाइट किया जाता है तो ऑटो-ट्रांसलेशन को ठीक किया
...
- इनपुट एन्हांसमेंट डिटेक्शन को ऑप्टिमाइज़ किया ताकि गलत टच को कम किया जा सके
- ई-बुक और सबटाइटल अनुवाद ऑनलाइन

## 0.9.3

- इनपुट बॉक्स अनुवाद: जब पहली बार उपयोग किया जाता है तो एक पॉप-अप रिमाइंडर दिखाता है, और उपयोगकर्ता इसे इस बार या स्थायी रूप से अक्षम करने का विकल्प चुन सकता है ताकि आकस्मिक टच से बचा जा सके।
- केवल अनुवाद निर्यात गति अनुकूलन के लिए PDF, यदि आप केवल अनुवाद निर्यात करने का चयन करते हैं, तो आप सीधे सिस्टम PDF प्रीव्यू को कॉल कर सकते हैं, तेज़।
- Deeplx कई URL का समर्थन करता है, बस उन्हें . के साथ विभाजित करें।

## 0.9.2

- PDF अनुवाद टूल को ऑनलाइन संस्करण में माइग्रेट किया गया है: https://app.immersivetranslate.com/pdf/ , ताकि Grease Monkey और Safari PDF अनुवाद का उपयोग कर सकें, और समस्याओं को बेहतर तरीके से हल किया जा सके बिना समस्या को हल करने के लिए संस्करण जारी किए बिना।
- POPUP UI ऑप्टिमाइज़ेशन, पैनल अधिक सुंदर है!

## 0.9.1

- Epub ईबुक निर्माण के साथ फ़ाइलनाम मुद्दों को ठीक किया
...
- Safari Google लॉगिन समस्या को ठीक किया
...
- AliCloud Translation के लिए समर्थन
- कुछ बग्स को ठीक किया
...
- PDF अनुवाद के लिए अनुवाद शैली के त्वरित नियंत्रण के लिए नए विकल्प (PDF फाइलें बहुत अजीब होती हैं और इन विकल्पों को चालू करना कुछ PDF फाइलों के लिए उपयोगी हो सकता है जिनका फॉर्मेटिंग गड़बड़ है)
- iOS और macOS संस्करण Apple Store Country Store पर वापस आ गए हैं

## 0.7.15

- हमें Apple द्वारा सूचित किया गया है कि OpenAI Translations को iOS और macOS से अस्थायी रूप से हटा दिया गया है, और हम इसे चीन में फिर से लॉन्च करने की कोशिश कर रहे हैं।

## 0.7.11- 0.7.14

- ठीक करें: Gmail Translate All Regions समस्या
- Safari के प्लग-इन डाउनलोड पर प्रतिबंध के कारण Safari के PDF निर्यात फ़ंक्शन को अस्थायी रूप से अक्षम कर दिया गया है (बग)।
- कुछ अन्य समस्याओं को ठीक किया

## 0.7.10

- पॉपअप ब्राउज़र आइकन पैनल UI अपग्रेड, थोड़ा अधिक डिज़ाइन ～
- कुछ जापानी अनुच्छेदों का अनुवाद न होने की समस्या को ठीक किया।
...
- कस्टम नियम अब डिफ़ॉल्ट बिल्ट-इन नियमों के साथ मर्जिंग का समर्थन करते हैं, उदाहरण के लिए: `{"id": "youtube", "selectors.add":["#test"]}` का अर्थ है मौजूदा चयनकर्ताओं में `#test` जोड़ना, `selectors` का अर्थ है डिफ़ॉल्ट को ओवरराइड करना, `selectors.remove` का अर्थ है डिफ़ॉल्ट चयनकर्ताओं में से एक को हटाना, और `selectors.remove` का अर्थ है डिफ़ॉल्ट चयनकर्ताओं में से एक को हटाना।
...
- अन्य संबंधित प्लगइन्स के साथ संघर्ष को रोकने के लिए Youtube सबटाइटल अनुवाद को सक्षम/अक्षम करने का समर्थन करता है।
- Arigato Translator सेटिंग फ़ील्ड्स और टर्मिनोलॉजी आईडी का समर्थन करता है

## 0.7.2

- इनपुट बॉक्स एन्हांसमेंट: // उपसर्ग को छोड़ने की अनुमति देता है और 3 स्पेस के साथ पूरे इनपुट बॉक्स के अनुवाद को ट्रिगर करता है, या आप सेटिंग्स पृष्ठ में इस विकल्प को बंद कर सकते हैं।
...
- डिफ़ॉल्ट सेटिंग्स को संशोधित करें: बड़ी संख्या में उपयोगकर्ताओं की प्रतिक्रिया के कारण कि वे इंस्टॉलेशन के बाद अनुवाद टूल का उपयोग नहीं करेंगे, उनके अनुवाद टूल की अपेक्षा यह है कि यह इंस्टॉलेशन के बाद स्वचालित रूप से अंग्रेजी वेब पेजों का अनुवाद करेगा, इसलिए इस संस्करण से, चीनी उपयोगकर्ताओं के लिए, डिफ़ॉल्ट रूप से अंग्रेजी पृष्ठों का अनुवाद करने का विकल्प चालू कर दिया गया है (यदि उपयोगकर्ता ने पहले भाषा की सेटिंग की है जो हमेशा अनुवादित होगी, तो इसे सम्मानित किया जाएगा, और परिवर्तन केवल एक्सटेंशन की प्रारंभिक सेटिंग्स को संशोधित करता है), और इसे रद्द करने की आवश्यकता है, इसे आसानी से [पॉपअप पैनल या सेटिंग्स पृष्ठ](/docs/faq/#%E5%A6%82%E4%BD%95%E5%85%B3%E9%97%AD%E8%87%AA%E5%8A%A8%E7%BF%BB%E8%AF%91) में रद्द किया जा सकता है।
...
- त्रुटि अलर्ट को ऑप्टिमाइज़ करें
- लक्ष्य भाषा चयन को ऑप्टिमाइज़ करें, अब यह केवल संबंधित अनुवाद सेवा द्वारा समर्थित भाषाओं को दिखाएगा
- PDF अनुवाद अनुकूलन
...
- PDF टेक्स्ट सूची अनुच्छेदों के प्रदर्शन की मरम्मत करें
...
- इनपुट बॉक्स अनुवाद को ऑप्टिमाइज़ किया गया, अब Bard में आसानी से काम करता है!
...
- जब इनपुट बॉक्स को बिना उपसर्ग के कॉन्फ़िगर किया जाता है, तो यह `ja Hello` जापानी में अनुवाद का समर्थन करता है और `English Hello` अंग्रेजी में अनुवाद का समर्थन करता है।
...
- Google Bard अनुकूलन
- इनपुट बॉक्स अनुवाद बिना उपसर्गों के पूरे टेक्स्ट बॉक्स का सीधा अनुवाद का समर्थन करता है।
- OpenAI अनुवादों के बेतुके ढंग से पीरियड्स जोड़ने की समस्या को ऑप्टिमाइज़ करें, (यदि मूल पाठ में कोई पीरियड नहीं पाया जाता है, तो यदि openai एक पीरियड लौटाता है, तो उसे हटा दें)
- सफारी सबटाइटल फाइलों को मान्यता नहीं मिलने की समस्याएं

## 0.6.3

इनपुट बॉक्स अनुवाद के लिए डिफ़ॉल्ट भाषा अब स्पेस को छोड़ सकती है, यानी //Hello World का भी अनुवाद किया जा सकता है।
...
- कार्यक्षमता में बड़े पैमाने पर कोई बदलाव नहीं (अगली रिलीज़ में नए फीचर्स उपलब्ध होंगे!)
...
- समस्या का समाधान: कुछ कोड टैग सही तरीके से पहचाने नहीं गए।
...
- समस्या का समाधान: Context Menu को अक्षम करना काम नहीं कर रहा [#428](https://github.com/immersive-translate/immersive-translate/issues/428)
...
- UI: openai के लिए कोई API कुंजी की अनुमति नहीं
...
- समस्या का समाधान: जब पृष्ठ को प्रारंभ करते समय postMessage कुछ साइटों को तोड़ता है, अब हम यह केवल तभी करेंगे जब हम वास्तव में पृष्ठों का अनुवाद करते हैं
...
- समस्या का समाधान: Ebook Builder प्रगति 99% रुकी हुई।
...
- संस्करण: अब से, हम हर महीने छोटे संस्करण संख्या को बदलेंगे, उदाहरण के लिए, अब मार्च में, संस्करण 0.3.0 से शुरू होगा, अप्रैल में, संस्करण संख्या 0.3.0 से शुरू होगी, अगले अप्रैल में, संस्करण संख्या 1.4.0 होगी, और इसी तरह। यह इसलिए है क्योंकि एक्सटेंशन के लिए यह अर्थहीन है कि वे अर्थशास्त्र का पालन करें, लेकिन समय के नियमों के अनुसार संस्करण संख्याओं को मानकीकृत करना विकास को अद्यतन रखने के लिए प्रेरणा है, और उपयोगकर्ताओं के लिए समस्याओं को अधिक आसानी से ढूंढने के लिए।
...
- विशेषता: Ebook Reader और Maker का समर्थन करें
...
- ठीक करें: कुछ साइटें शैलियों के लिए `span` का उपयोग करती हैं, इसलिए हम अनुवाद लक्ष्य आवरण के लिए span के बजाय `font` का उपयोग करते हैं
...
- विशेषता: options.html पर अनुवाद सेवा सत्यापित करने का समर्थन करें
...
- ठीक करें: कस्टम गूगल API कॉन्फ़िगर करने की अनुमति दें
...
- ठीक करें: PDF फाइल अनुवाद विफल, 0.2.60 से बग deepl से zh-CN से zh-TW का समर्थन करने के लिए
...
- प्रदर्शन: अनुरोधों को क्रमिक से सहसंयोजक में बदलें
- जापानी गणना का पता लगाने के लिए बेहतर

## 0.2.62

- विशेषता: waitForSelectors नियम जोड़ें, कुछ साइटों जैसे reddit को ठीक करने के लिए
...
- विशेषता: Immersive Translate Deepl विशेषता
...
- ठीक करें: कुछ गणित तत्व मूल रूप से बने रहें
...
- विशेषता: डेवलपर बोर्ड पर इंजेक्टेड css का समर्थन करें
- विशेषता: authKey, appid appSecret ट्रिम करें
- बेहतर: नई टैब पर सेटिंग पेज खोलें (लेकिन स्टे के लिए नहीं)

## 0.2.55

- deepl api charset ठीक करने का प्रयास करें

## 0.2.54

- क्रोम स्टोर अस्वीकृति के लिए टैब अनुमति हटाएं
- पूरे पेज का अनुवाद ठीक करें, फुटर को अनदेखा किया गया है
...
- caiyun अनुवाद अनिर्दिष्ट स्रोत भाषा ठीक करें
...
- मास्क होवर ठीक करें जब मास्क को फिर से टॉगल करें।
...
- उपयोगकर्ता स्क्रिप्ट niu अनुवाद ठीक करें
...
- बॉडी क्षेत्र के लिए साइड फुटर ठीक करें
- आयात/निर्यात आइकन ठीक करें

## 0.2.37

- फ्रेम बहिष्करण मार्क ठीक करें
...
- 3 थीम जोड़ें
- Niu अनुवाद सेवा जोड़ें

## 0.2.32

- PDF बुनियादी अनुवाद ठीक करें
- पॉपअप एक गैर-कॉन्फ़िगर सेवा का चयन करें, विकल्प पृष्ठ पर जाएं।
- स्टे ओपन सेटिंग्स ठीक करें।
- कई भाषाओं का पता लगाने की गति ठीक करें
...
- shadowroot अनुवाद का समर्थन करें। उदाहरण के लिए:
...
- स्टे.app उपयोगकर्ता स्क्रिप्ट ब्राउज़र API ठीक करें
...
- अधिक आसान उपयोग के लिए पॉपअप ui बदलें
...
- उस अनुच्छेद का अनुवाद न करें जिसमें केवल प्लेसहोल्डर तत्व होते हैं, उदाहरण के लिए
...
- पॉपअप अनुवाद सेवा को बदलने का अनुवाद नहीं करने को ठीक करें
