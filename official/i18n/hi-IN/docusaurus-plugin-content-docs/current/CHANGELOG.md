...
- सुधार किया गया: Gemini 2.0 थिंकिंग मॉडल के साथ संगत।
...
- उन्नत सेटिंग्स में "अनुवाद न करने योग्य शब्दों" के प्रबंधन में सुधार किया गया।
...
- arXiv पेपर अनुवादों के लिए अनुकूलन का पता लगाया गया
...
- Youtube उपशीर्षकों के अनुवाद की गति को काफी अनुकूलित किया गया, और चीनी और अंग्रेजी क्रम के बीच स्विच करने, फ़ॉन्ट रंग और आकार को अनुकूलित करने आदि के लिए समर्थन जोड़ा गया
...
- वेब पेज अनुवाद और वीडियो उपशीर्षक अनुवाद के लिए समर्थन, जैसे अरबी, हिब्रू आदि भाषाओं में, RTL (दाएं-से-बाएं) प्रदर्शन मुद्दों को संबोधित करते हुए
...
- Safari प्लगइन संस्करण को अपग्रेड करने पर हमेशा स्थापना सफलता पृष्ठ को संकेत देने की समस्या को ठीक किया
...
- त्रुटि पॉप-अप को अनुकूलित किया, नेटवर्क समस्या त्रुटि पॉप-अप स्वचालित रूप से मान्य मुफ्त अनुवाद सेवाओं का पता लगाते हैं।
...
- विशिष्ट वेबसाइटों/भाषाओं को केवल अनुवादित पाठ प्रदर्शित करने के लिए सेट करने का समर्थन।
...
- ठीक किया गया: कुछ अनुवादित शैलियाँ (जैसे रेखांकित) Safari में प्रभावी नहीं थीं।
...
- एक नई शॉर्टकट सेटिंग का समर्थन किया गया जो वीडियो उपशीर्षकों के अंतर्निहित मशीन अनुवाद उपशीर्षकों का उपयोग करने के लिए त्वरित टॉगलिंग की अनुमति देता है
- Sci-Hub वेबसाइट पर, फ्लोटिंग बॉल पर क्लिक करने से वेबपेज में एम्बेडेड PDFs का अनुवाद होगा

## 1.1.6

- **विशिष्ट पैराग्राफ का अनुवाद करने के लिए मोबाइल समर्थन:** मोबाइल संस्करण अब निर्दिष्ट पैराग्राफ का अनुवाद करने का समर्थन करता है और इसमें विभिन्न शॉर्टकट संचालन जोड़े गए हैं, जिनमें बाएं स्वाइप करना, दाएं स्वाइप करना, डबल-टैपिंग, ट्रिपल-टैपिंग, और मल्टी-फिंगर टच जेस्चर शामिल हैं। ये डिफ़ॉल्ट रूप से सक्षम नहीं हैं और उपयोगकर्ता को सक्रिय रूप से सेटिंग्स पृष्ठ के तहत [माउस होवर] में ट्रिगरिंग जेस्चर का चयन करना होगा।
...
- **प्लगइन सेटिंग्स पृष्ठ UI अपडेट**:
  ...
  - "उन्नत सेटिंग्स" में, एक नया विकल्प जोड़ा गया है जो एक पैराग्राफ का अनुवाद करने के लिए आवश्यक न्यूनतम वर्णों की संख्या को कॉन्फ़िगर करने की अनुमति देता है। डिफ़ॉल्ट 4 वर्ण हैं, लेकिन इसे उच्चतर सेट किया जा सकता है (जैसे, 20), ताकि केवल लंबे पैराग्राफ का अनुवाद किया जाएगा।
...
- अनुकूलित: माउस होवर का उपयोग करते समय, पृष्ठ पर ध्यान खोने और फिर से ट्रिगर करने की समस्या अप्रभावी हो जाती है।
...
- कुछ प्लेटफार्मों की समस्या को हल किया गया जो यह पहचान नहीं सकते थे कि माउस समर्थित है या नहीं।
  - कुछ डेस्कटॉप ब्राउज़र हैं जो टचस्क्रीन और माउस दोनों का समर्थन करते हैं, और Immersive Translate तकनीकी रूप से यह पता लगाने में असमर्थ है कि ऐसे प्लेटफार्म माउस का समर्थन करते हैं या नहीं, इसलिए हमने [माउस होवर] सेटिंग में [माउस समर्थन को जबरन सक्षम करें] विकल्प जोड़ा है।
...
- उपयोगकर्ता के लॉगआउट करने पर कैश को साफ करने की समस्या को ठीक किया गया।
...
- गलत स्पर्शों को कम करने के लिए इनपुट एन्हांसमेंट डिटेक्शन को अनुकूलित करें
- ई-बुक और सबटाइटल अनुवाद ऑनलाइन

## 0.9.3

- इनपुट बॉक्स अनुवाद: जब इसे पहली बार उपयोग किया जाता है, तो एक पॉप-अप रिमाइंडर प्रदर्शित होता है, और उपयोगकर्ता इसे इस बार या स्थायी रूप से अक्षम करने का विकल्प चुन सकता है ताकि आकस्मिक स्पर्शों से बचा जा सके।
...
- Deeplx कई URLs का समर्थन करता है, बस उन्हें . से विभाजित करें
...
- अन्य संबंधित प्लगइन्स के साथ संघर्षों को रोकने के लिए Youtube सबटाइटल अनुवाद को सक्षम/अक्षम करने का समर्थन करता है।
...
[30-सेकंड की त्वरित परिचय के लिए यहां क्लिक करें](/docs/input/)
...
- समस्या को ठीक करें कि: द्विभाषी eBooks में निर्यात के बाद चित्र नहीं होते
...
- कुछ वेब पेजों पर छवियों के: कॉपी करने के बाद बड़े होने की समस्या को ठीक करें
...
- माउस होवर शॉर्टकट को बदलने की समस्या को ठीक किया गया, जिसके लिए प्रभावी होने के लिए पृष्ठ को ताज़ा करने की आवश्यकता थी
...
- Feat: PDF अनुवाद का पुनर्निर्माण, अब आप Immersive Translate के साथ अधिकांश PDFs का अनुवाद कर सकते हैं
...
- संस्करण: अब से, हम हर महीने माइनर संस्करण संख्या बदलेंगे, उदाहरण के लिए, अब मार्च में, संस्करण 0.3.0 से शुरू होगा, अप्रैल में, संस्करण संख्या 0.3.0 से शुरू होगी, अप्रैल में, संस्करण संख्या 0.4.0 से शुरू होगी, अगले अप्रैल में, संस्करण संख्या 1.4.0 होगी, और इसी तरह। ऐसा इसलिए है क्योंकि एक्सटेंशन के लिए यह अर्थहीन है कि वे अर्थशास्त्र का पालन करें, लेकिन समय के नियमों के अनुसार संस्करण संख्याओं को मानकीकृत करना विकास को अद्यतन रखने के लिए प्रेरणा है, और उपयोगकर्ताओं के लिए समस्याओं को अधिक आसानी से ढूंढना है।
...
- यूट्यूब को अगली पेज पर जाने के लिए ठीक करें
...
- तत्काल अनुवाद मोड सेट करने का समर्थन करें, ताकि आप वेब पेज को यथासंभव जल्दी अनुवाद कर सकें।
