...
- Added: जब स्रोत भाषा और लक्ष्य भाषा समान हों तो चेतावनी प्रदर्शित करें
...
- Improved: वेबपेजों पर एम्बेडेड iframes के भीतर इनपुट एन्हांसमेंट और माउस होवर कार्यक्षमता

## 1.10.2 (2024-10-11)

- Added: इमेज अनुवाद (बीटा संस्करण)
- Added: Forece Enable Mouse Support मोड (इस सुविधा को केवल तभी सक्षम करें जब टैबलेट डिवाइस पर माउस होवर फ़ंक्शन उपलब्ध न हो) **Settings** -> **Advanced Settings** -> **Forece Enable Mouse Support**
- Added: जब वीडियो उपशीर्षक अनुवाद विफल हो जाए तो त्रुटि संदेश प्रदर्शित करें
- Fixed: रिच टेक्स्ट अनुवाद समस्या [#2163](https://github.com/immersive-translate/immersive-translate/issues/2163)
- Improved: उन समस्याओं का समाधान किया गया जहां PDF अनुवाद के दौरान अनुवाद बटन काम नहीं कर सकता था
- Improved: अनुवादित सूत्रों की रेंडरिंग को बढ़ाया गया
...
- कस्टम AI विशेषज्ञों के सिंक न होने की समस्या का समाधान किया गया
...
- एक ही Twitter पेज पर कई वीडियो के लिए द्विभाषी उपशीर्षक प्रदर्शन की समस्या का समाधान किया गया
...
- Tiktok निजी संदेश इंटरफ़ेस में इनपुट बॉक्स के गलत अनुवाद की समस्या का समाधान किया गया
- Read Comic Online पर कॉमिक्स का अनुवाद न हो पाने की समस्या का समाधान किया गया
- [Advanced Settings -> Minimum number of characters required for translating a paragraph] कुछ मामलों में प्रभावी न होने की समस्या का समाधान किया गया
...
- Google Meet अब लाइव मीटिंग्स के लिए द्विभाषी उपशीर्षकों का समर्थन करता है: अब, आप Google Meet मीटिंग्स में द्विभाषी उपशीर्षक सुविधा का आनंद ले सकते हैं। बस मीटिंग लिंक खोलें, इमर्सिव अनुवाद पैनल में द्विभाषी उपशीर्षक सक्रिय करें, और फिर इसे अनुभव करने के लिए पेज को रिफ्रेश करें।
...
- Microsoft Teams वेब संस्करण वीडियो मीटिंग्स में वास्तविक समय द्विभाषी उपशीर्षकों का समर्थन (Teams मीटिंग लिंक खोलें, इमर्सिव अनुवाद पैनल में द्विभाषी उपशीर्षक चालू करें, और फिर रिफ्रेश करें)
...
- टेक्स्ट का चयन करने के बाद, राइट-क्लिक मेनू [Translate the text] में बदल जाएगा, जिस पर क्लिक करके आप स्वचालित रूप से इमर्सिव अनुवाद टेक्स्ट अनुवाद पृष्ठ पर जा सकते हैं
...
- मंगा अनुवाद के लिए नया उपयोगकर्ता फीडबैक बटन (मंगा का अनुवाद करने के बाद, अनुवाद गुणवत्ता पर फीडबैक देने के लिए होवर बॉल के दाईं ओर [Feedback] बटन पर क्लिक करें)।
...
- कस्टम AI मॉडल सूची `-all` सिंटैक्स का समर्थन करती है, जो सभी पूर्वनिर्धारित मॉडलों को हटा सकती है।
...
- बहुत अधिक कस्टम प्रॉम्प्ट्स का उपयोग करने पर अप्रभावी होने की समस्या को ठीक किया गया।
...
- बड़े वेब पृष्ठों का अनुवाद, ePub निर्माण, और उपशीर्षक फ़ाइलों के प्रदर्शन को काफी अनुकूलित किया गया।
...
- AI अनुवाद सेवाओं के लिए [AI Expert] सेट करने का समर्थन, जो अनुवाद रणनीति को निर्दिष्ट करता है, वर्तमान में एक बीटा सुविधा है, जिसे बीटा सक्षम करने के बाद [Developer Settings](https://dash.immersivetranslate.com/#developer) में सक्षम किया जा सकता है, और [AI Expert] मेनू को रिफ्रेश करने के बाद देखा जा सकता है।
- AI अनुवाद सेवाएं अब मॉडल सूची को अनुकूलित कर सकती हैं, जैसे [OpenAI], सिस्टम में केवल कुछ सबसे सामान्य रूप से उपयोग किए जाने वाले मॉडल अंतर्निहित होते हैं। मॉडल ड्रॉपडाउन सूची पर क्लिक करने पर, आप जो अंतिम आइटम देखते हैं वह [Set More Models] है, सेटिंग के बाद, यह स्वचालित रूप से याद किया जाएगा ताकि उपयोगकर्ताओं को विभिन्न कस्टम मॉडलों का परीक्षण करने में सुविधा हो।
...
- Youtube उपशीर्षकों की अनुवाद गति को और अधिक अनुकूलित किया गया
...
- Youtube उपशीर्षकों की अनुवाद गति को काफी अनुकूलित किया गया, और चीनी और अंग्रेजी क्रम के बीच स्विच करने, फ़ॉन्ट रंग और आकार को अनुकूलित करने आदि का समर्थन जोड़ा गया
...
- कुछ प्रो उपयोगकर्ता Chrome ब्राउज़र में सेटिंग्स को संशोधित नहीं कर पाने की समस्या को ठीक किया गया।
...
- YouTube लाइव और [Mubi](https://mubi.com/) प्लेटफॉर्म के लिए उपशीर्षक अनुवाद समर्थन।
...
- **शॉर्टकट कुंजी सेटिंग्स**: एक नया शीर्ष-स्तरीय मेनू "शॉर्टकट्स" और निम्नलिखित अनुकूलन योग्य शॉर्टकट कुंजी कार्य जोड़े गए:
  ...
  - पृष्ठ पर "माउस होवर पर सीधे अनुवाद" को अस्थायी रूप से सक्षम करने के लिए कुंजियों के संयोजन को निर्दिष्ट करें। इसे फिर से दबाने पर इस फ़ंक्शन को रद्द कर देगा।
...
- **प्लगइन सेटिंग्स पृष्ठ UI अपडेट**:
  ...
  - "उन्नत सेटिंग्स" में, एक नया विकल्प जोड़ा गया है जो एक पैराग्राफ का अनुवाद करने के लिए आवश्यक न्यूनतम वर्णों की संख्या को कॉन्फ़िगर करता है। डिफ़ॉल्ट 4 वर्ण है, लेकिन इसे उच्च (जैसे, 20) पर सेट किया जा सकता है, ताकि केवल लंबे पैराग्राफ का अनुवाद किया जाए।
...
- जब आप पैनल में द्विभाषी सबटाइटल्स चालू करते हैं, तो यह पहले पृष्ठ को स्वचालित रूप से रीफ्रेश करेगा (द्विभाषी सबटाइटल्स को अधिक सटीक रूप से प्रदर्शित करने के लिए), और कुछ साइटों को अभी भी उपयोगकर्ताओं को साइट पर "CC" बटन पर मैन्युअल रूप से क्लिक करने की आवश्यकता होती है।
...
- [वीडियो सबटाइटल्स को स्थायी रूप से अक्षम करें] सुविधा के काम न करने के लिए फिक्स [#1175](https://github.com/immersive-translate/immersive-translate/issues/1175)

## 0.12.2

- अधिक वीडियो प्लेटफार्मों के लिए द्विभाषी सबटाइटल समर्थन प्रदान किया गया है, जो अब समर्थित हैं: [Youtube](https://www.youtube.com/), [Netflix](https://www.netflix.com), [Udemy](https://www.udemy.com/), [Khanacademy](https://www.khanacademy.org/), [Coursera](https://www.coursera.org/), [Vimeo](https://vimeo.com/), [Nebula](https://nebula.tv), [Bloomberg](https://www.bloomberg.com), [Bilibili](https://www.bilibili.com/), आदि। (ध्यान दें कि तकनीकी सीमाओं के कारण, कुछ वेबसाइटों को पहली बार द्विभाषी सबटाइटल्स चालू करने के बाद पृष्ठ को रीफ्रेश करने की आवश्यकता होती है या द्विभाषी सबटाइटल्स प्रदर्शित करने के लिए अनुवाद पूरा होने की प्रतीक्षा करनी होती है)। (ध्यान दें कि तकनीकी सीमाओं के कारण, कुछ वेबसाइटों को पहली बार द्विभाषी सबटाइटल्स खोलने के बाद पृष्ठ को रीफ्रेश करने की आवश्यकता होती है, या द्विभाषी सबटाइटल्स प्रदर्शित करने के लिए अनुवाद पूरा होने की प्रतीक्षा करनी होती है)
...
- सफारी के तहत कुछ इनपुट बॉक्स संवर्धन मुद्दों को ठीक किया।
...
- OpenAI के प्रॉम्प्ट की लंबाई 90 से घटाकर 40 कर दी गई, जिससे और भी अधिक ट्रैफिक बचता है।
...
- सफारी उपशीर्षक फ़ाइलों के पहचाने न जाने की समस्याएं
...
- समस्या को ठीक किया गया कि: वेबसाइट अनुवाद अवधि की अस्थायी सेटिंग प्रभावी नहीं होती।
...
- ठीक किया गया: जब पृष्ठ को तोड़ने पर postMessage कुछ साइटों को तोड़ता है, अब हम यह केवल तभी करेंगे जब हम वास्तव में पृष्ठों का अनुवाद करेंगे
...
- ठीक किया गया: विकल्प UI स्विच अनुवाद सेवाओं का इनपुट राज्य नहीं बदला।
...
- Fix chrome timeout
- Fix विभाजित वाक्य त्रुटि।

## 0.0.55

- Fix display none तत्व दिखाएं।
...
- Fix block img का अनुवाद किया गया।
...
- Fix tencent त्रुटि विभाजित करें।
- Fix inline sup तत्व त्रुटि।
- ट्विटर के लिए बेहतर
...
- पॉपअप अनुवाद सेवा बदलने पर काम नहीं करता, इसे ठीक करें
- reddit मोबाइल पोस्ट सामग्री का अनुवाद ठीक करें।

## 0.0.36

- Fix Wikipedia विशेष वर्ण
...
- Fix youtube अगले पृष्ठ पर जाएं
...
- स्थानीय फ़ाइल को सहेजने के बाद अनुवाद करें, इसे ठीक किया गया
...
- कुछ span टैग ब्लॉक तत्व हैं, इसे ठीक करें
