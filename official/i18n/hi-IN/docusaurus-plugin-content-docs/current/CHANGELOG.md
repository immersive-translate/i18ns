...
**Preview संस्करण** अधिक बार प्रकाशित होता है और इसमें कुछ प्रायोगिक विशेषताएँ शामिल होती हैं। Release संस्करण की तुलना में, इसमें अधिक बग हो सकते हैं। यह मुख्य रूप से निम्नलिखित पर जारी किया जाता है
...
- जोड़ा गया: Android ब्राउज़र मुफ्त छवि अनुवाद का समर्थन करता है।
- जोड़ा गया: Gemini पुर्तगाली (ब्राज़ील) का समर्थन करता है।
- जोड़ा गया: Grok, Ollama, Groq, Azure-OpenAI अनुवाद सेवाएँ।
- अनुकूलित: अनुवादित सामग्री की भाषा को स्वचालित रूप से पहचानने की सटीकता में सुधार किया गया।
- अनुकूलित: [मुफ्त छवि अनुवाद] दाएँ से बाएँ भाषाओं के लिए स्वरूपण का समर्थन करता है।
...
- ठीक किया गया: Google अनुवाद समस्या एस्केप कैरेक्टर्स के साथ।
...
- सुधार: Greasemonkey और Safari के लिए भाषा पहचान क्षमताओं में सुधार किया गया है जिन पृष्ठों पर मामूली भाषाएँ हैं।
...
- सुधार: मूल भाषा की पहचान में सुधार किया गया। पहले, कई भाषाओं वाले पृष्ठों का अनुवाद नहीं हो पाता था, लेकिन अब उनका सही अनुवाद होता है।
- सुधार: Twitter के लिए, मल्टीलाइन सामग्री अनुवादों को डिफ़ॉल्ट रूप से न लपेटने के लिए सेट किया गया है। लपेटना केवल तभी होगा जब सामग्री 10 पंक्तियों या 1000 वर्णों से अधिक हो। लपेटना सेटिंग्स के माध्यम से सक्षम किया जा सकता है **Advanced Settings** -> **Enable automatic line wrapping for long paragraphs**।

## 1.12.8 (2025-01-03)

- ठीक किया गया: समस्या जहां iOS 18.3 सेटिंग्स पृष्ठ सही ढंग से प्रदर्शित नहीं हो पाता।
...
- सुधार: पारंपरिक चीनी उपयोगकर्ता इंटरफ़ेस भाषा के लिए विवरण में सुधार किया गया।
- सुधार: पैनल और सेटिंग्स पृष्ठों में दाएँ से बाएँ भाषाओं के लिए लेआउट समायोजन।
...
- ठीक किया गया: Twitter पर मल्टीलाइन अनुवाद प्रभाव में कुछ बग।
- ठीक किया गया: समृद्ध पाठ के कारण कुछ सूत्रों के अनुवाद में समस्याएँ।
...
- जोड़ा गया: अधूरी ePub फाइलों को पुनः आयात करने पर जहां से छोड़ा था वहां से अनुवाद जारी रखने की अनुमति दें।
...
- ठीक किया गया: समस्या जहां Facebook के अनुवाद-केवल मोड में "see more" पर क्लिक करने के बाद सामग्री गायब हो जाती है।
...
- ठीक किया गया: विज्ञापन देखने के बाद YouTube पर उपशीर्षक समयबद्धन समस्याएँ।
- ठीक किया गया: MacOS 15 पर Safari में राइट-क्लिक अनुवाद मेनू के प्रदर्शन की समस्याएँ।
- ठीक किया गया: कुछ वेबसाइटों पर **Enhanced input** में Ctrl+Z पूर्ववत कार्यक्षमता की समस्याएँ।

## 1.10.6 (2024-10-25)

- ठीक किया गया: **Enhanced input** शॉर्टकट कुंजियाँ ट्रिगर नहीं हो रही हैं
...
- जोड़ा गया: माउस समर्थन मोड को मजबूरन सक्षम करें (इस सुविधा को केवल तभी सक्षम करें जब टैबलेट उपकरणों पर माउस होवर फ़ंक्शन उपलब्ध न हो) **सेटिंग्स** -> **उन्नत सेटिंग्स** -> **माउस समर्थन को मजबूरन सक्षम करें**
...
- Google Meet अब लाइव मीटिंग्स के लिए द्विभाषी उपशीर्षक का समर्थन करता है: अब, आप Google Meet मीटिंग्स में द्विभाषी उपशीर्षक सुविधा का आनंद ले सकते हैं। बस मीटिंग लिंक खोलें, इमर्सिव अनुवाद पैनल में द्विभाषी उपशीर्षक सक्रिय करें, और फिर इसे अनुभव करने के लिए पृष्ठ को ताज़ा करें।
...
- Microsoft Teams वेब संस्करण वीडियो मीटिंग्स में वास्तविक समय द्विभाषी उपशीर्षक का समर्थन (Teams मीटिंग लिंक खोलें, इमर्सिव अनुवाद पैनल में द्विभाषी उपशीर्षक चालू करें, और फिर ताज़ा करें)
...
- टेक्स्ट का चयन करने के बाद, राइट-क्लिक मेनू [टेक्स्ट का अनुवाद करें] में बदल जाएगा, जिस पर क्लिक करके आप स्वचालित रूप से इमर्सिव अनुवाद टेक्स्ट अनुवाद पृष्ठ पर जा सकते हैं
...
- मंगा अनुवाद के लिए उपयोगकर्ता प्रतिक्रिया बटन जोड़ा गया (मंगा का अनुवाद करने के बाद, फ्लोटिंग बॉल के दाईं ओर [प्रतिक्रिया] बटन पर क्लिक करके अनुवाद गुणवत्ता पर प्रतिक्रिया दें)।

## 1.7.7

- YouTube पर स्वचालित रूप से उत्पन्न अंग्रेजी उपशीर्षकों के लिए AI बुद्धिमान वाक्य विभाजन एल्गोरिदम अपनाया गया [प्रो उपलब्ध]
...
- जब AI विशेषज्ञ "बुद्धिमान चयन" के लिए उपयोग किए जाते हैं, तो विभिन्न वेबसाइटों के लिए विभिन्न AI विशेषज्ञों को अनुकूलित किया जा सकता है। इसे [सेटिंग्स] -> [AI विशेषज्ञ] -> [किसी भी विशेषज्ञ में प्रवेश करें] में सेट किया जा सकता है।
...
- वीडियो द्विभाषी उपशीर्षकों में, जब लक्ष्य भाषा सरलीकृत चीनी होती है और मूल पाठ पारंपरिक चीनी होता है, तो मूल पाठ स्वचालित रूप से सरलीकृत चीनी में परिवर्तित हो जाएगा, और इसके विपरीत।
...
- टेक्स्ट रंग को कॉन्फ़िगर करने की समस्या को ठीक किया जो RGBA Preview का समर्थन नहीं करता था [#1435](https://github.com/immersive-translate/immersive-translate/issues/1435)
...
- कुछ Pro उपयोगकर्ताओं के लिए Chrome ब्राउज़र में सेटिंग्स को संशोधित न कर पाने की समस्या को ठीक किया।
- iOS पर YouTube के फुलस्क्रीन मोड में द्विभाषी उपशीर्षकों के प्रदर्शन का समर्थन किया।
...
- Safari पर कुछ मामलों में सेटिंग्स पृष्ठ के लगातार लोडिंग दिखाने की समस्या को ठीक किया।
...
- मुख्य अनुवाद सेवा का पालन करने के लिए चाइल्ड अनुवाद सेवा के लिए एक विकल्प जोड़ा गया
...
- एक नई शॉर्टकट सेटिंग के लिए समर्थन जोड़ा गया जो वीडियो उपशीर्षकों के अंतर्निहित मशीन अनुवाद उपशीर्षकों का उपयोग करने के लिए त्वरित टॉगलिंग की अनुमति देता है
- Sci-Hub वेबसाइट पर, फ्लोटिंग बॉल पर क्लिक करने से वेबपेज में एम्बेडेड PDFs का अनुवाद होगा

## 1.1.6

- **विशिष्ट पैराग्राफ का अनुवाद करने के लिए मोबाइल समर्थन:** मोबाइल संस्करण अब निर्दिष्ट पैराग्राफ का अनुवाद करने का समर्थन करता है और इसमें विभिन्न शॉर्टकट ऑपरेशन जोड़े गए हैं, जिनमें बाएं स्वाइप करना, दाएं स्वाइप करना, डबल-टैप करना, ट्रिपल-टैप करना, और मल्टी-फिंगर टच जेस्चर शामिल हैं। ये डिफ़ॉल्ट रूप से सक्षम नहीं हैं और उपयोगकर्ता को [माउस होवर] के तहत सेटिंग्स पृष्ठ में ट्रिगरिंग जेस्चर को सक्रिय रूप से चुनने की आवश्यकता होती है।
...
- शॉर्टकट्स के साथ अनुवाद मोड स्विच करते समय एक अनुस्मारक फ़ंक्शन जोड़ा गया।
- URL युक्त इनपुट फ़ील्ड का अनुवाद करते समय केवल सामग्री के कुछ हिस्सों का अनुवाद करने की समस्या को ठीक किया गया।

## 1.1.2

- ठीक किया गया: पृष्ठ का अनुवाद न होने पर अनुवाद सेवाओं को स्विच करने की समस्या का प्रभाव नहीं पड़ा।
...
- **शॉर्टकट कुंजी सेटिंग्स**: एक नया शीर्ष-स्तरीय मेनू "शॉर्टकट्स" और निम्नलिखित अनुकूलन योग्य शॉर्टकट कुंजी कार्य जोड़े गए:
  ...
  - वर्तमान इनपुट बॉक्स की सामग्री का अनुवाद करने के लिए कुंजियों के संयोजन को निर्दिष्ट करें, पिछले तरीके को पूरक करते हुए जल्दी से स्पेस बार को तीन बार हिट करें।
  - पृष्ठ पर "माउस होवर पर सीधे अनुवाद" को अस्थायी रूप से सक्षम करने के लिए कुंजियों के संयोजन को निर्दिष्ट करें। इसे फिर से दबाने से इस फ़ंक्शन को रद्द कर दिया जाएगा।
...
- **प्लगइन सेटिंग्स पृष्ठ UI अपडेट**:
  ...
  - "उन्नत सेटिंग्स" में, एक नया विकल्प जोड़ा गया है जो एक पैराग्राफ का अनुवाद करने के लिए आवश्यक न्यूनतम वर्णों की संख्या को कॉन्फ़िगर करने की अनुमति देता है। डिफ़ॉल्ट 4 वर्ण हैं, लेकिन इसे अधिक (जैसे, 20) पर सेट किया जा सकता है, ताकि केवल लंबे पैराग्राफ का अनुवाद किया जाएगा।
...
- **नए उपयोगकर्ता गाइड**: जब नए उपयोगकर्ता पहली बार एक गैर-लक्ष्य भाषा में एक पृष्ठ खोलते हैं, तो एक फ्लोटिंग बॉल सहायता गाइड बबल प्रदर्शित होता है।
...
- **बग फिक्स**:
  ...
  - इनपुट बॉक्स एन्हांसमेंट सुविधा में 3 से कम वर्णों का अनुवाद न होने की समस्या को ठीक किया गया।
...
- पैनल से अनुवाद पर क्लिक करके Epub ईबुक बनाने का कार्य न करने की समस्या को ठीक करें।
...
- पिछले संस्करण में जोड़े गए द्विभाषी साझाकरण (रीफ्रेशिंग मोड) को द्विभाषी पृष्ठ स्नैपशॉट साझाकरण में संशोधित करें, ताकि साझा की गई सामग्री अधिक मूल हो, साथ ही व्यापक अनुकूलता हो।
...
- कुछ प्लेटफार्मों की समस्या को हल किया गया जो यह पहचान नहीं सकते थे कि माउस समर्थित है या नहीं।
  - कुछ डेस्कटॉप ब्राउज़र हैं जो टचस्क्रीन और माउस दोनों का समर्थन करते हैं, और Immersive Translate तकनीकी रूप से यह पता लगाने में असमर्थ है कि ऐसे प्लेटफार्म माउस का समर्थन करते हैं या नहीं, इसलिए हमने [माउस होवर] सेटिंग में [फोर्स एनेबल माउस सपोर्ट] विकल्प जोड़ा है।
...
- यूट्यूब उपशीर्षक द्विभाषी उपशीर्षक प्लगइन के साथ संघर्ष को ठीक करें (जब यूट्यूब द्विभाषी प्लगइन का पता लगाया जाता है तो यूट्यूब उपशीर्षक अनुवाद का Immersive Translate सक्षम नहीं होता है ताकि संघर्ष से बचा जा सके)।
...
- Fix ins क्लिक अधिक पाठ का अनुवाद न होने की समस्या
...
- इनपुट बॉक्स अनुवाद: जब इसका पहली बार उपयोग किया जाता है तो एक पॉप-अप रिमाइंडर प्रदर्शित करता है, और उपयोगकर्ता आकस्मिक स्पर्शों से बचने के लिए इसे इस बार या स्थायी रूप से अक्षम करने का विकल्प चुन सकता है।
...
- PDF अनुवाद उपकरण को ऑनलाइन संस्करण में माइग्रेट किया गया है: https://app.immersivetranslate.com/pdf/ , ताकि Grease Monkey और Safari PDF अनुवाद का उपयोग कर सकें, और समस्याओं को बेहतर तरीके से दोहराया जा सके बिना समस्या को हल करने के लिए संस्करण जारी करने की आवश्यकता के।
...
- Fix: Gmail Translate All Regions समस्या
...
- Arigato Translator फ़ील्ड और शब्दावली id सेटिंग का समर्थन करता है
...
- खोज एन्हांसमेंट का समर्थन करें, जब सक्षम किया जाता है, जब आप Google/Google News में चीनी में खोज करते हैं, तो दाएं कॉलम स्वचालित रूप से संबंधित अंग्रेजी कीवर्ड के खोज परिणाम दिखाएगा, जो डिफ़ॉल्ट रूप से सक्षम है।
...
- Fix: बहुत ही दुर्लभ मामलों में पैराग्राफ विभाजन।
...
- Fix: Context Menu कभी-कभी उपलब्ध नहीं हो सकता। [#273](https://github.com/immersive-translate/immersive-translate/issues/273)
...
- ब्लॉक इमेज का अनुवाद किया गया है।
