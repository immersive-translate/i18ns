...
- जोड़ा गया: जब अनुवादित टेक्स्ट और मूल टेक्स्ट एक ही लेखन प्रणाली के होते हैं, तो अनुवाद को एक विशेष शैली का उपयोग करके प्रदर्शित किया जाता है।
...
- ऑनलाइन पीडीएफ होवरबॉल क्लिक अनुत्तरदायी को ठीक करें
...
- उस समस्या को हल किया गया कि कुछ प्लेटफार्मों पर यह पहचान नहीं हो पाती कि माउस समर्थित है या नहीं
...
- माउस होवर समर्थन फिर से Ctrl दबाकर मूल पाठ दिखाने के लिए
...
- Youtube वीडियो के लिए द्विभाषी उपशीर्षकों के साथ पूर्ण समर्थन 🎉।
...
- केवल अनुवाद निर्यात गति अनुकूलन, यदि आप केवल अनुवाद निर्यात करने का विकल्प चुनते हैं, तो आप सीधे सिस्टम PDF पूर्वावलोकन को कॉल कर सकते हैं, तेज़।
...
- एक्सटेंशन पैनल अब असमर्थित पृष्ठों को इंगित कर सकता है (जैसे कि पृष्ठ जिनकी कोई अनुमति नहीं है और गैर-HTML पृष्ठ)
...
- जून में पहली रिलीज़, पिछले व्यक्तिगत उपडोमेन से माइग्रेट किया गयाhttps://immersive-translate.owenyoung.comसे नए डोमेनhttps://immersivetranslate.com/
- कार्यक्षमता काफी हद तक अपरिवर्तित है (नई सुविधाएँ अगले रिलीज़ में उपलब्ध होंगी!)

## 0.5.17

- Fix the problem that: द्विभाषी eBooks निर्यात करने के बाद चित्र नहीं होते हैं
...
- Optimize: अनुवाद को ट्रिगर करने वाले पैराग्राफ में न्यूनतम वर्णों की संख्या को 4 वर्णों तक संशोधित किया गया है ताकि भ्रम को कम किया जा सके, जबकि साइट के नेविगेशन और अंत क्षेत्रों का अनुवाद करने से बचने के लिए अन्य सुविधाओं का उपयोग किया गया है।
- Fix: Github विवरण विस्तार के बाद अनुवाद नहीं हो रहा है।

## 0.5.14

- Fix: कुछ वेब पृष्ठों पर छवियों की समस्या: कॉपी करने के बाद बड़ी हो जाती हैं
- Fix: माध्यम टिप्पणी अनुभाग का अनुवाद नहीं हो रहा है
- कुछ पृष्ठों पर छवियों की समस्या को ठीक किया गया: गलत तरीके से कॉपी की गई थीं

## 0.5.12

- Feature: स्प्लिट लाइन अनुवाद शैली एकल पंक्ति अनुवादों के लिए एक ऊर्ध्वाधर विभाजन रेखा जोड़ती है
...
- Fix: ट्वीट आंशिक पंक्ति विराम पहचाने नहीं जाते हैं
- Fix: ईबुक लेखन शैली काम नहीं कर रही है

## 0.5.10

- Fix: ट्वीट पंक्ति विराम पहचाने नहीं जाते हैं
...
- Fix: ईबुक ऑनलाइन पढ़ने की शैली काम नहीं कर रही है

## 0.5.8

- समस्या को ठीक करें कि: वेबसाइट अनुवाद अवधि की अस्थायी सेटिंग प्रभावी नहीं होती है।
...
- ChatGPT डिफ़ॉल्ट रूप से मोबाइल मॉडल है, जो तेज़ है!

- वेब कोर पार्सिंग पुनर्निर्माण, जिसका अर्थ है:

  - सेकंड में बड़े पैमाने पर वेब पृष्ठ अनुवाद
    - उदाहरण के लिए,: https://pve.proxmox.com/pve-docs/pve-admin-guide.html, जिसे पहले 30 सेकंड लगे, अब सेकंड में पलट गया है।
...
- Fix: उपयोगकर्ता स्क्रिप्ट माउस होवर शॉर्टकट सेटिंग्स
...
- Fix: संदर्भ मेनू अक्षम काम नहीं कर रहा है [#428](https://github.com/immersive-translate/immersive-translate/issues/428)
- Fix: [Mastondon](https://mastodon.social/) के लिए सामग्री सुरक्षा नीति से बचें

## 0.4.11

- Fix: उपयोगकर्ता स्क्रिप्ट अनुमति (केवल उपयोगकर्ता स्क्रिप्ट के लिए)।
...
- Fix: Firefox उपयोगकर्ता स्क्रिप्ट पॉपअप गायब।
...
- Fix: एक्सटेंशन के लिए सामग्री सुरक्षा नीति पॉपअप, और आंशिक रूप से उपयोगकर्ता स्क्रिप्ट के लिए।
...
- Feat: अनुवाद सेवा के रूप में ChatGPT Plus वेबसाइट का समर्थन करें, यह एक बीटा सुविधा है, इसलिए आप इसे डेवलपर सेटिंग्स पर बीटा सुविधा सक्षम करके एक्सेस कर सकते हैं। यह बहुत धीमा है, क्योंकि चैटजीपीटी एक बार में केवल एक अनुरोध भेज सकता है। सुनिश्चित करें कि आपके पास ChatGPT Plus खाता है, क्योंकि मुफ्त खाते पर अधिक सीमाएं हैं, और मुझे यकीन नहीं है कि यह आपके खाते के लिए जोखिम लाता है, इसका उपयोग करने में सावधानी बरतें।
...
- Fix: जब init पृष्ठ कुछ साइटों को तोड़ता है तो postMessage, अब हम इसे केवल तभी करेंगे जब हम वास्तव में पृष्ठों का अनुवाद करेंगे
...
- Fix: उपयोगकर्ता स्क्रिप्ट ईबुक निर्यात
- Feat: OpenAI के लिए कस्टम API एंडपॉइंट जोड़ें
- Feat: `उन्नत सेटिंग्स` पर अस्थायी अनुवाद वेबसाइट समय विकल्प जोड़ें
...
- Feat: OpenAI समर्थन कस्टम apiUrl डेवलप सेटिंग्स के लिए।
...
- संस्करण: अब से, हम हर महीने माइनर संस्करण संख्या बदलेंगे, उदाहरण के लिए, अब मार्च में, संस्करण 0.3.0 से शुरू होगा, अप्रैल में, संस्करण संख्या 0.3.0 से शुरू होगी, अप्रैल में, संस्करण संख्या 0.4.0 से शुरू होगी, अगले अप्रैल में, संस्करण संख्या 1.4.0 होगी, और इसी तरह। ऐसा इसलिए है क्योंकि एक्सटेंशन के लिए यह अर्थ नहीं रखता है कि वे अर्थशास्त्र का पालन करें, लेकिन समय के नियमों के अनुसार संस्करण संख्याओं को मानकीकृत करना विकास को अद्यतन रखने के लिए प्रेरणा है, और उपयोगकर्ताओं के लिए समस्याओं को अधिक आसानी से ढूंढना है।
...
- प्रदर्शन: अनुरोधों को क्रमिक से सहसंयोजन में बदलें
...
- शरीर क्षेत्र के लिए पाद लेख ठीक करें
...
- के बारे में पृष्ठ पर योगदान जोड़ें
...
- जब इस साइट का अनुवाद कभी सक्षम नहीं होता है तो पृष्ठ को पुनर्स्थापित करें
...
- बिंदीदार, पतलीDashed थीम जोड़ें
