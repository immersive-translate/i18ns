...
**Preview संस्करण** अधिक बार प्रकाशित होता है और इसमें कुछ प्रायोगिक विशेषताएं शामिल होती हैं। Release संस्करण की तुलना में, इसमें अधिक बग हो सकते हैं। इसे मुख्य रूप से निम्नलिखित पर जारी किया जाता है
...
- जोड़ा गया: पृष्ठों को ब्राउज़ करते समय अनुवादित सामग्री का डायनामिक पूर्व-अनुवाद।
...
- सुधार किया गया: Greasemonkey और Safari के लिए भाषा पहचान क्षमताओं में सुधार किया गया है, जिन पृष्ठों पर मामूली भाषाएं हैं।
...
- ठीक किया गया: जहां **Mouse Hover Translation** समृद्ध पाठ का अनुवाद नहीं कर सकता था।
...
- ठीक किया गया: जहां **Mouse Hover Translation** कुछ वेबसाइटों पर काम नहीं करता है।
- सुधार किया गया: DeepLx अब अरबी का समर्थन करता है।
- सुधार किया गया: मूल भाषा की पहचान में सुधार किया गया। पहले, कई भाषाओं वाले पृष्ठों का अनुवाद नहीं हो सकता था, लेकिन अब उनका सही अनुवाद किया जाता है।
- सुधार किया गया: Twitter के लिए, बहु-पंक्ति सामग्री अनुवादों को डिफ़ॉल्ट रूप से लपेटा नहीं जाता है। लपेटना केवल तब होगा जब सामग्री 10 पंक्तियों या 1000 वर्णों से अधिक हो। लपेटना सेटिंग्स के माध्यम से सक्षम किया जा सकता है **Advanced Settings** -> **Enable automatic line wrapping for long paragraphs**।

## 1.12.8 (2025-01-03)

- ठीक किया गया: जहां iOS 18.3 सेटिंग्स पृष्ठ ठीक से प्रदर्शित नहीं हो सकता था।
...
- ठीक किया गया: जहां माउस होवर फ़ंक्शन कुछ स्थितियों में गलत अनुवाद सेवा लोड करता है।
- ठीक किया गया: जहां YouTube पर अस्थायी रूप से द्विभाषी उपशीर्षक सक्षम करना काम नहीं करता है।
- ठीक किया गया: अनुवाद सेवाओं को स्विच करने के बाद, "**Enhanced Input Box**" में अनुवाद सेवा अपडेट नहीं होती है।
...
- सुधार किया गया: बिना उपशीर्षक वाले वीडियो में अनुवाद आइकन प्रदर्शित होगा और अनुवाद क्यों संभव नहीं है इसका कारण प्रदान करेगा।
...
- सुधार किया गया: Twitter और Youtube पर बहु-पंक्ति द्विभाषी अनुवाद के प्रदर्शन को बढ़ाया गया।
- सुधार किया गया: द्विभाषी मोड में अनुवाद की गुणवत्ता में सुधार के लिए समृद्ध पाठ अनुवाद डिफ़ॉल्ट रूप से बंद कर दिया गया है।
...
- ठीक किया गया: जहां Facebook के केवल अनुवाद मोड में "see more" पर क्लिक करने के बाद सामग्री गायब हो जाती है।
- ~~सुधार किया गया: Twitter पर बहु-पंक्ति द्विभाषी अनुवाद के प्रदर्शन को बढ़ाया गया।~~
...
- सुधार किया गया: वेबपेजों पर एम्बेडेड iframes के भीतर इनपुट संवर्धन और माउस होवर कार्यक्षमता

## 1.10.2 (2024-10-11)

- जोड़ा गया: इमेज अनुवाद (बीटा संस्करण)
- जोड़ा गया: Forece Enable Mouse Support मोड (इस सुविधा को केवल तभी सक्षम करें जब टैबलेट डिवाइस पर माउस होवर फ़ंक्शन उपलब्ध न हो) **Settings** -> **Advanced Settings** -> **Forece Enable Mouse Support**
- जोड़ा गया: वीडियो सबटाइटल अनुवाद विफल होने पर त्रुटि संदेश प्रदर्शित करें
- ठीक किया गया: रिच टेक्स्ट अनुवाद समस्या [#2163](https://github.com/immersive-translate/immersive-translate/issues/2163)
- सुधार किया गया: PDF अनुवाद के दौरान अनुवाद बटन काम न करने की समस्याओं को संबोधित किया
- सुधार किया गया: अनुवादित सूत्रों की रेंडरिंग को बढ़ाया
...
- ठीक किया गया: macOS 15 पर Safari प्लगइन के साथ लॉगिन संगतता समस्या का समाधान किया
...
- अब आप इमर्सिव अनुवाद के फ्लोटिंग बॉल में वेबपेज के अनुवाद मुद्दों की जल्दी से रिपोर्ट कर सकते हैं। एक वेबपेज का अनुवाद करने के बाद, यदि कोई समस्या है, तो आप फ्लोटिंग बॉल के दाईं ओर [Feedback] बटन पर क्लिक कर सकते हैं, समस्या विवरण भर सकते हैं, और हम इसे जल्द से जल्द निपटाएंगे।
- Epub फाइलें अब रिच टेक्स्ट अनुवाद का समर्थन करती हैं (यानी, प्रत्येक पैराग्राफ के मूल पाठ के प्रारूप को संरक्षित करना, जैसे कि लिंक, बोल्ड, आदि)
...
- Claude अनुवाद अब तिब्बती का समर्थन करता है और Temperature पैरामीटर को कॉन्फ़िगर करने की अनुमति देता है
...
- मंगा अनुवाद के लिए उपयोगकर्ता प्रतिक्रिया बटन जोड़ा गया (मंगा का अनुवाद करने के बाद, फ्लोटिंग बॉल के दाईं ओर [Feedback] बटन पर क्लिक करें और अनुवाद गुणवत्ता पर प्रतिक्रिया दें)।

## 1.7.7

- YouTube पर स्वचालित रूप से उत्पन्न अंग्रेजी सबटाइटल के लिए AI बुद्धिमान वाक्य विभाजन एल्गोरिदम अपनाया गया [Pro Available]
...
- कस्टम AI विशेषज्ञों का समर्थन, प्रवेश [Settings]->[AI Expert] पृष्ठ के नीचे है।
...
- कॉमिक अनुवाद के लिए नई साइटों का समर्थन जोड़ा गया:
  - [Mangabuddy](https://mangabuddy.com/)
  - [Hitomi](https://hitomi.la)
  - [Yamibo](https://www.yamibo.com)
  - [Copymanga](https://www.copymanga.site/)
- YouTube द्विभाषी सबटाइटल अब बुद्धिमान वाक्य विभाजन का समर्थन करते हैं (बीटा) (केवल जब [Settings] - [Video Subtitles] में YouTube सबटाइटल के इमर्सिव अनुवाद को मैन्युअल रूप से सक्षम किया जाता है, और मूल वीडियो सबटाइटल स्वचालित रूप से उत्पन्न अंग्रेजी सबटाइटल होते हैं)
- अनुवाद सेवा Tencent [【Hunyuan Large Model】](https://immersivetranslate.com/docs/services/tencent-hunyuan/) जोड़ा गया

## 1.6.5

- लैटिन लिपि में भाषाओं के लिए कॉमिक अनुवाद के पाठ लेआउट मुद्दों को ठीक किया गया।
...
- "Translation Only" मोड में YouTube में सबटाइटल प्रदर्शित न होने की समस्या को ठीक किया गया।
- Mubi पर द्विभाषी सबटाइटल काम न करने की समस्या को ठीक किया गया।
- Adobe Acrobat प्लगइन के साथ खोले गए PDFs के साथ संगत।
- सभी उपयोगकर्ता इमर्सिव अनुवाद इंटरफ़ेस के बहुभाषी अनुवाद में [ऑनलाइन योगदान](https://weblate.immersivetranslate.com/projects/immersive-translate/extension/) कर सकते हैं।
...
- iOS Safari में पूर्ण स्क्रीन पर उपशीर्षकों के गायब होने की समस्या को ठीक किया गया
...
- YouTube पर कुछ पारंपरिक चीनी सबटाइटल सही ढंग से प्रदर्शित नहीं होने की समस्या को ठीक किया
- Safari पर Twitter सबटाइटल के डिस्प्ले समस्या को ठीक किया
- पृष्ठ के नीचे तत्काल अनुवाद के लिए शॉर्टकट को ठीक किया
...
- edx साइट पर अनुवादित सबटाइटल प्रदर्शित नहीं होने की समस्या को ठीक किया
...
- कुछ प्रो उपयोगकर्ता Chrome ब्राउज़र में सेटिंग्स को संशोधित नहीं कर सकते थे, इस समस्या को ठीक किया।
- iOS पर YouTube के फुलस्क्रीन मोड में द्विभाषी सबटाइटल डिस्प्ले का समर्थन किया।

## 1.2.0

- [LinkedIn](https://www.linkedin.com/) और [Viu](https://www.viu.com/) प्लेटफॉर्म पर वीडियो सबटाइटल अनुवाद के लिए समर्थन।
- अतिरिक्त प्लेटफार्मों के लिए अधिक वीडियो सबटाइटल त्वरित पहुंच जोड़ी गई।
...
- अनुकूलन: सेटिंग्स पृष्ठ, URL सूची इंटरैक्शन UI (स्पष्टता के लिए, चेकबॉक्स डिफ़ॉल्ट रूप से प्रदर्शित नहीं होते हैं)।
- अनुवाद-केवल मोड में अनुवाद फ़ॉन्ट सेट करने के लिए समर्थन।
- Netflix, Ted, Bloomberg, Udemy, Coursera पर वीडियो सबटाइटल सक्षम करने के लिए त्वरित पहुंच जोड़ी गई।
- ठीक किया गया: कुछ अनुवादित शैलियाँ (जैसे कि अंडरलाइन) Safari में प्रभावी नहीं थीं।
- ठीक किया गया: पृष्ठ अनुवाद के दौरान, माउस को होवर करने पर पुनः अनुवाद ट्रिगर नहीं होता था।

## 1.1.8

- चाइल्ड अनुवाद सेवा को मुख्य अनुवाद सेवा का पालन करने का विकल्प जोड़ा गया
- [Amazon Prime Video](https://www.primevideo.com) के लिए द्विभाषी सबटाइटल समर्थन
- Sci-Hub में एम्बेडेड PDF अनुवाद फ़ंक्शन का और अनुकूलन किया गया
- ऑनलाइन PDFs को सही ढंग से न खोलने की समस्या को ठीक किया
- Netflix पर द्विभाषी सबटाइटल के निरंतर प्लेबैक की समस्या को ठीक किया
...
- एक नया शॉर्टकट सेटिंग जोड़ा गया जो वीडियो सबटाइटल के लिए अंतर्निहित मशीन अनुवाद सबटाइटल का उपयोग करने के त्वरित टॉगल की अनुमति देता है
- Sci-Hub वेबसाइट पर, फ्लोटिंग बॉल पर क्लिक करने से वेबपेज में एम्बेडेड PDFs का अनुवाद होगा

## 1.1.6

- **मोबाइल पर विशिष्ट पैराग्राफ का अनुवाद करने के लिए समर्थन:** मोबाइल संस्करण अब निर्दिष्ट पैराग्राफ का अनुवाद करने का समर्थन करता है और इसमें विभिन्न शॉर्टकट ऑपरेशन जोड़े गए हैं, जिनमें बाएं स्वाइप, दाएं स्वाइप, डबल-टैपिंग, ट्रिपल-टैपिंग, और मल्टी-फिंगर टच जेस्चर शामिल हैं। ये डिफ़ॉल्ट रूप से सक्षम नहीं हैं और उपयोगकर्ता को सक्रिय रूप से सेटिंग्स पृष्ठ के तहत [माउस होवर] में ट्रिगरिंग जेस्चर का चयन करना होगा।
...
- **इमर्सिव अनुवाद अनुभव:** उपयोगकर्ता की आदतों के बेहतर अनुकूलन के लिए, हमने YouTube प्लेटफॉर्म पर फुल-स्क्रीन मोड में द्विभाषी सबटाइटल के लिए शॉर्टकट को बाईं ओर स्थानांतरित कर दिया है।
...
- **पॉपअप पैनल UI अपग्रेड:** नया डिज़ाइन उपयोगिता और समझ को सुधारने का लक्ष्य रखता है। इस अपडेट में शामिल हैं:
  ...
  - **मुख्य मेनू में नई विशेषताएं:**
    ...
    - **दस्तावेज़ अनुवाद प्रविष्टि:** "PDF/ePub/सबटाइटल फ़ाइलों" का अनुवाद करने के लिए प्रविष्टि को त्वरित पहुंच के लिए मुख्य मेनू में स्थानांतरित कर दिया गया है।
...
- **एकीकृत दस्तावेज़ अनुवाद प्रविष्टि:** अब, आप एकीकृत अपलोड प्रविष्टि के माध्यम से PDF, ePub, और सबटाइटल फ़ाइलों का अनुवाद कर सकते हैं। बस पॉपअप पैनल में [PDF/ePub] बटन पर क्लिक करें, [More] का चयन करने की आवश्यकता नहीं है।

- **5 वीडियो वेबसाइटों के लिए समर्थन जोड़ा गया:**
  - Youtube Music पर पॉडकास्ट के सबटाइटल का समर्थन।
...
- URL युक्त इनपुट फ़ील्ड का अनुवाद करते समय केवल सामग्री के कुछ हिस्सों का अनुवाद होने की समस्या को ठीक किया।
...
- YouTube के लिए द्विभाषी सबटाइटल शॉर्टकट की समस्या को ठीक किया जिसमें अत्यधिक लंबा अंग्रेजी टेक्स्ट था।
...
- **प्लगइन सेटिंग्स पृष्ठ UI अपडेट**:
  ...
  - "एडवांस्ड सेटिंग्स" में, एक नया विकल्प जोड़ा गया है जो एक पैराग्राफ का अनुवाद करने के लिए आवश्यक न्यूनतम वर्णों की संख्या को कॉन्फ़िगर करने की अनुमति देता है। डिफ़ॉल्ट रूप से यह 4 वर्ण है, लेकिन इसे अधिक (जैसे, 20) पर सेट किया जा सकता है, ताकि केवल लंबे पैराग्राफ का अनुवाद किया जाए।
...
- **YouTube द्विभाषी सबटाइटल**: YouTube वीडियो प्लेबैक विंडो में द्विभाषी सबटाइटल को सक्षम या छिपाने के लिए एक त्वरित पहुंच जोड़ी गई (इस सुविधा को बंद किया जा सकता है)।

- **Deepl भाषा समर्थन**: पुर्तगाली (ब्राज़ील) के लिए समर्थन जोड़ा गया।

- **नए उपयोगकर्ता गाइड**: जब नए उपयोगकर्ता पहली बार एक गैर-लक्षित भाषा में पृष्ठ खोलते हैं, तो एक फ्लोटिंग बॉल सहायता गाइड बबल प्रदर्शित होता है।

### अनुकूलन और सुधार

- **UI अनुकूलन**: पृष्ठ अनुवाद त्रुटि संकेतों के UI को फिर से डिज़ाइन किया गया ताकि उन्हें समझना आसान हो सके। जब कई त्रुटियाँ होती हैं, तो एक पॉप-अप सक्रिय रूप से उपयोगकर्ता को सूचित करेगा।

- **बग फिक्स**:

  - माउसओवर अनुवाद विफल होने की समस्या को ठीक किया जब पृष्ठ फोकस खो देता है।
  - इनपुट बॉक्स एन्हांसमेंट सुविधा में 3 से कम वर्णों का अनुवाद नहीं होने की समस्या को ठीक किया।
  - द्विभाषी Epubs के उत्पादन के दौरान कुछ निर्देशिकाओं का अनुवाद नहीं होने की समस्या को ठीक किया।

- **फ़ीचर हटाना**: द्विभाषी जानकारी एन्हांसमेंट सुविधा को हटा दिया गया (Google खोज पृष्ठों पर एक साथ अंग्रेजी खोज परिणाम प्रदर्शित करना)।
...
- अनुकूलित: जब माउस होवर का उपयोग करते हैं, तो पृष्ठ पर ध्यान खोने और फिर से ट्रिगर करने की समस्या अप्रभावी हो जाती है।
- फिक्स: OpenAI में प्रॉम्प्ट/मॉडल को संशोधित करने के बाद भी कैश मौजूद होने की समस्या।
...
- Tampermonkey स्क्रिप्ट के पुराने संस्करणों के लिए, अब सेटिंग पृष्ठ पर एक अपडेट प्रॉम्प्ट जोड़ा गया है।
...
- कुछ प्लग-इन्स के साथ संघर्ष की मरम्मत जो अनंत पृष्ठ पुनः लोडिंग का कारण बनती है।
- लंबे पैराग्राफ लाइन ब्रेक चालू करने के बाद कुछ पैराग्राफ का अनुवाद न होने की मरम्मत।
- [जब अस्थायी रूप से लंबे समय के लिए वेबपेज अनुवाद चालू किया जाता है, तो पैनल पर [हमेशा इस वेबसाइट का अनुवाद करें] क्लिक करने से हमेशा अनुवाद रद्द नहीं होता #1172](https://github.com/immersive-translate/immersive-translate/issues/1172) को ठीक किया गया।
...
- खोज संवर्धन (Google खोज के कुछ पृष्ठ द्विभाषी खोज परिणाम प्रदर्शित करते हैं) सुविधा अब डिफ़ॉल्ट रूप से सक्षम नहीं है और अगले रिलीज में हटा दी जाएगी।
...
- सफारी के तहत कुछ इनपुट बॉक्स संवर्धन समस्याओं को ठीक करें।
...
- पिछले संस्करण में जोड़े गए द्विभाषी साझाकरण (ताज़ा मोड) को द्विभाषी पृष्ठ स्नैपशॉट साझाकरण में संशोधित करें, ताकि साझा की गई सामग्री अधिक मूल हो, साथ ही व्यापक अनुकूलता हो।
...
- ऑनलाइन पीडीएफ होवरबॉल क्लिक अनुत्तरदायी की मरम्मत।
...
- कुछ प्लेटफार्मों की समस्या को हल किया गया जो यह पहचान नहीं सकते थे कि माउस समर्थित है या नहीं।
  - कुछ डेस्कटॉप ब्राउज़र हैं जो टचस्क्रीन और माउस दोनों का समर्थन करते हैं, और Immersive Translate तकनीकी रूप से यह पता लगाने में असमर्थ है कि क्या ऐसे प्लेटफार्म माउस का समर्थन करते हैं, इसलिए हमने [माउस होवर] सेटिंग में [फोर्स एनेबल माउस सपोर्ट] विकल्प जोड़ा है।
...
- पृष्ठ होवरबॉल क्लिक की झटकेदार समस्या को ठीक करें।
...
- माउस होवर समर्थन फिर से मूल पाठ दिखाने के लिए Ctrl दबाएं।
...
- स्थानीय txt फ़ाइलों का अनुवाद नहीं किया जा सकता है की समस्या को ठीक करें।

## 0.10.5

- यूट्यूब कभी-कभी होमपेज पर लौटने की समस्या को ठीक करें।
...
- उपशीर्षक फ़ाइलों के लिए OpenAI अनुवाद को संदर्भित करना अनुकूलित करें।
...
- readwise को हाइलाइट करने पर ऑटो-ट्रांसलेशन को ठीक करें
...
- कस्टम नियम अब डिफ़ॉल्ट अंतर्निहित नियमों के साथ विलय का समर्थन करते हैं, उदाहरण के लिए: `{"id": "youtube", "selectors.add":["#test"]}` का अर्थ है मौजूदा चयनकर्ताओं में `#test` जोड़ना, `selectors` का अर्थ है डिफ़ॉल्ट को ओवरराइड करना, `selectors.remove` का अर्थ है डिफ़ॉल्ट चयनकर्ताओं में से एक को हटाना, और `selectors.remove` का अर्थ है डिफ़ॉल्ट चयनकर्ताओं में से एक को हटाना। डिफ़ॉल्ट चयनकर्ताओं में से एक को हटाता है।
...
- अन्य संबंधित प्लगइन्स के साथ संघर्षों को रोकने के लिए Youtube उपशीर्षक अनुवाद को सक्षम/अक्षम करने का समर्थन करता है।
- Arigato Translator सेटिंग फ़ील्ड्स और शब्दावली id का समर्थन करता है
...
- यह निर्धारित करने के लिए अधिक स्मार्ट कि क्या यह एक नेविगेशन क्षेत्र है, और यदि ऐसा है, तो कोई अनुवाद नहीं किया जाता है
...
- जून में पहली रिलीज़, पिछले व्यक्तिगत उपडोमेन से माइग्रेट किया गया https://immersive-translate.owenyoung.com से नए डोमेन https://immersivetranslate.com पर
...
- वेब कोर पार्सिंग पुनर्गठन, जिसका अर्थ है:

  - सेकंड में बड़े पैमाने पर वेब पेज अनुवाद
...
- वेब कोर पार्सिंग को फिर से बनाया गया है, जिसका अर्थ है।
...
- हाइड्रेशन वाली वेबसाइटों के अनुवाद के बाद सफेद स्क्रीन समस्या को ठीक किया गया, जैसे कि Next.js

- माउस होवर शॉर्टकट बदलने की समस्या को ठीक किया गया, जिसके लिए प्रभावी होने के लिए पृष्ठ को रीफ्रेश करने की आवश्यकता थी
...
- Feat: PDF अनुवाद को पुनर्गठित करें, अब आप Immersive Translate के साथ अधिकांश PDF का अनुवाद कर सकते हैं
- Fix: संदर्भ मेनू अक्षम काम नहीं कर रहा [#428](https://github.com/immersive-translate/immersive-translate/issues/428)
...
- Fix: जब पृष्ठ को प्रारंभ करते समय postMessage कुछ साइटों को तोड़ता है, अब हम ऐसा केवल तभी करेंगे जब हम वास्तव में पृष्ठों का अनुवाद करेंगे
...
- संस्करण: अब से, हम हर महीने माइनर संस्करण संख्या बदलेंगे, उदाहरण के लिए, अब मार्च में, संस्करण 0.3.0 से शुरू होगा, अप्रैल में, संस्करण संख्या 0.3.0 से शुरू होगी, अगले अप्रैल में, संस्करण संख्या 1.4.0 होगी, और इसी तरह। ऐसा इसलिए है क्योंकि एक्सटेंशन के लिए अर्थ का पालन करना कोई मतलब नहीं है, लेकिन समय के नियमों के अनुसार संस्करण संख्याओं को मानकीकृत करना विकास को अद्यतन रखने के लिए प्रेरणा है, और उपयोगकर्ताओं के लिए समस्याओं को अधिक आसानी से ढूंढना है।
...
- PDF नमूना फ़ाइल ठीक करें
- फ़ायरफ़ॉक्स पीडीएफ स्थानीय फ़ाइल ठीक करें
- पीडीएफ शॉर्टकट ठीक करें

## 0.2.1

- ग्रीस मंकी शॉर्टकट प्रबंधक का समर्थन करें।
- मैच regex ठीक करें
- यूट्यूब टिप्पणियाँ ठीक करें।
- रेडिट मोबाइल कॉम्पैक्ट संस्करण ठीक करें
- पूर्णपाठ अनुवाद समस्या ठीक करें

## 0.2.0

- PDF दो कॉलम ठीक करें।
- क्रोम/एज स्टोर संस्करण बग ठीक करें।
- ठीक करें
...
- एज पर प्रकाशित करें
- पीडीएफ मार्जिन ठीक करें।
- नमूना पीडीएफ फ़ाइल बदलें

## 0.0.62

- पीडीएफ प्रारूप, इंडेंट ठीक करें।
- telegra.ph तत्व परिवर्तन को रोकें ठीक करें

## 0.0.61

- स्पैन तत्व बंद ठीक करें।
- प्रारंभिक ब्राउज़र के लिए अनुमति ठीक करें

## 0.0.60

- क्रोम पीडीएफ ठीक करें
...
- क्रोम टाइमआउट ठीक करें
- वाक्य विभाजन त्रुटि ठीक करें।

## 0.0.55

- कोई तत्व नहीं दिखाने की समस्या ठीक करें।
...
- विकल्प UI फ़ॉन्ट आकार ठीक करें

## 0.0.50

- ब्लॉक img का अनुवाद किया गया ठीक करें।

## 0.0.49

- फ़ायरफ़ॉक्स एक्सटेंशन ठीक करें

## 0.0.48

- क्रोम एक्सटेंशन ठीक करें
...
- टेनसेंट त्रुटि विभाजित करें ठीक करें।
- इनलाइन sup तत्व त्रुटि ठीक करें।
- ट्विटर के लिए बेहतर

## 0.0.43

- ट्वीट br ठीक करें
- वैश्विक अनुवाद ठीक करें।
...
- इनलाइन तत्व जांच ठीक करें
- डेवलपर डिबग लॉग विकल्प जोड़ें

## 0.0.39

- अनुवाद सेवा में mock2 शामिल है ठीक करें
...
- पॉपअप अनुवाद सेवा बदलने पर काम नहीं करता ठीक करें
- रेडिट मोबाइल पोस्ट सामग्री अनुवाद ठीक करें।
...
- यूट्यूब अगली पृष्ठ पर जाएं ठीक करें
- यूट्यूब खोज पृष्ठ का समर्थन करें।
- विकल्प उन्नत स्विच ठीक करें।
- img टैग ठीक करें, छिपा टैग
  [#5](https://github.com/immersive-translate/next-immersive-translate/issues/5)
- गूगल सर्च फोर्स रिफ्रेश ठीक करें
...
- तात्कालिक अनुवाद मोड सेट करने का समर्थन करें, ताकि आप वेब पृष्ठ को यथासंभव शीघ्रता से अनुवाद कर सकें।
...
- volc alpha उपयोगकर्ता स्क्रिप्ट कनेक्ट अनुमति ठीक करें।
- संस्करण क्लिक करने योग्य ठीक करें।

## 0.0.25

- selectorMatches का समर्थन करें, ताकि हम अब सभी manstondon का मिलान कर सकें।
- फ़ायरफ़ॉक्स उपयोगकर्ता स्क्रिप्ट त्रुटि ठीक करें।

## 0.0.23

- चीनी का पता लगाने के लिए बेहतर
- रेडिट innerText समस्या ठीक करें

## 0.0.22

- deeplx का समर्थन करें
- सेवा स्विच करते समय कई अनुवाद ठीक करें

## 0.0.21

- कुछ स्पैन टैग ब्लॉक तत्व हैं ठीक करें
