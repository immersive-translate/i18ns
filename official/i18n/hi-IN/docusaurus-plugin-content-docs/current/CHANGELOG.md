...
**Preview version** अधिक बार प्रकाशित होता है और इसमें कुछ प्रायोगिक विशेषताएं शामिल होती हैं। Release version की तुलना में, इसमें अधिक बग हो सकते हैं। इसे मुख्य रूप से निम्नलिखित पर जारी किया जाता है
...
- सुधार किया गया: द्विभाषी मोड में अनुवाद की गुणवत्ता में सुधार के लिए डिफ़ॉल्ट रूप से समृद्ध पाठ अनुवाद बंद कर दिया गया है।
...
- प्रो उपयोगकर्ताओं के मल्टी-डिवाइस सिंक समय को सिंक्रनाइज़ न करने की समस्या को ठीक किया गया
...
- कुछ Netflix वीडियो के लिए असामान्य उपशीर्षक प्रदर्शन की समस्या को ठीक किया गया [#1630](https://github.com/immersive-translate/immersive-translate/issues/1630)
...
- Youtube उपशीर्षकों के अनुवाद की गति को और अनुकूलित किया गया
...
- वेब पेज अनुवाद और वीडियो उपशीर्षक अनुवाद के लिए समर्थन, जैसे कि अरबी, हिब्रू आदि भाषाओं में, RTL (राइट-टू-लेफ्ट) डिस्प्ले मुद्दों को संबोधित करते हुए
...
- Safari पर Twitter उपशीर्षकों के डिस्प्ले मुद्दे को ठीक किया
...
- कुछ Pro उपयोगकर्ता Chrome ब्राउज़र में सेटिंग्स को संशोधित नहीं कर पाने की समस्या को ठीक किया।
...
- PDF पृष्ठों को खोलते समय मोबाइल प्लगइन के डिस्प्ले विसंगति समस्या को ठीक किया।
...
- URL युक्त इनपुट फ़ील्ड का अनुवाद करते समय केवल सामग्री के कुछ हिस्सों का अनुवाद करने की समस्या को ठीक किया।
...
- **नए उपयोगकर्ता गाइड**: जब नए उपयोगकर्ता पहली बार किसी गैर-लक्षित भाषा में पृष्ठ खोलते हैं, तो एक फ्लोटिंग बॉल सहायता गाइड बबल प्रदर्शित होता है।
...
- यूट्यूब उपशीर्षक का द्विभाषी उपशीर्षक प्लगइन के साथ संघर्ष को ठीक करें (जब यूट्यूब द्विभाषी प्लगइन का पता लगाया जाता है तो यूट्यूब उपशीर्षक अनुवाद सक्षम नहीं होता है ताकि संघर्ष से बचा जा सके)।
...
- केवल अनुवाद निर्यात गति अनुकूलन, यदि आप केवल अनुवाद निर्यात करने का विकल्प चुनते हैं, तो आप सीधे सिस्टम PDF प्रीव्यू को निर्यात करने के लिए कॉल कर सकते हैं, तेज़।
- Deeplx कई URLs का समर्थन करता है, बस उन्हें के साथ विभाजित करें।

## 0.9.2

- PDF अनुवाद उपकरण को ऑनलाइन संस्करण में माइग्रेट किया गया है: https://app.immersivetranslate.com/pdf/ , ताकि Grease Monkey और Safari PDF अनुवाद का उपयोग कर सकें, और समस्याओं को बेहतर तरीके से हल किया जा सके बिना समस्या को हल करने के लिए संस्करण जारी करने की आवश्यकता के।
...
- खोज एन्हांसमेंट का समर्थन करें, जब सक्षम किया गया हो, जब आप Google/Google News में चीनी में खोज करते हैं, तो दायां कॉलम स्वचालित रूप से संबंधित अंग्रेजी कीवर्ड के खोज परिणाम दिखाएगा, जो डिफ़ॉल्ट रूप से सक्षम है।
  - कारण: हमने पाया कि Google खोज में, चीनी कीवर्ड और अंग्रेजी कीवर्ड के लिए खोज परिणाम बहुत भिन्न हो सकते हैं, इमर्सिव ट्रांसलेटेड सर्च एन्हांसमेंट सक्षम होने पर, हम आपके लिए स्वचालित रूप से अंग्रेजी में समान कीवर्ड की खोज करते हैं और उन्हें दाईं ओर प्रदर्शित करते हैं। यदि आपको इस सुविधा की आवश्यकता नहीं है तो आप इसे अक्षम करने का विकल्प चुन सकते हैं।
...
- PDF फाइलें खोलते समय एक्सटेंशन पैनल के कोई अनुमतियाँ नहीं होने की समस्या को ठीक करें।
...
- PDF अनुवाद समर्थन खींचकर आकार बदलने और अनुवाद की सामग्री को संपादित करने के लिए
...
- एक्सटेंशन पैनल अब असमर्थित पृष्ठों को इंगित कर सकता है (जैसे कि कोई अनुमति नहीं और गैर-HTML पृष्ठ)
- अनुवाद में लोडिंग स्थिति दिखाने के लिए इनपुट बॉक्स एन्हांसमेंट
- अनुवादों में डिफ़ॉल्ट लोडिंग रंग अपडेट करें
- जब इनपुट बॉक्स को कोई उपसर्ग के साथ कॉन्फ़िगर किया जाता है, तो यह `ja Hello` जापानी में अनुवाद का समर्थन करता है और `English Hello` अंग्रेजी में अनुवाद का समर्थन करता है।
...
- Google Bard अनुकूलन
- इनपुट बॉक्स अनुवाद उपसर्गों के बिना पूरे टेक्स्ट बॉक्स का सीधा अनुवाद का समर्थन करता है।
...
- कार्यक्षमता काफी हद तक अपरिवर्तित है (अगले रिलीज़ में नई सुविधाएँ उपलब्ध होंगी!)
...
- परिवर्तन: लोडिंग आइकन रंग, काले से नीले, डार्क मोड वेब पृष्ठ के लिए अनुकूलन।
...
- ब्लॉक img का अनुवाद किया जा रहा है, इसे ठीक करें।
