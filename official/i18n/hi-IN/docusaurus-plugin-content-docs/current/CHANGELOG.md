...
- ठीक किया गया: एक समस्या जहां माउस और टच दोनों का समर्थन करने वाले उपकरणों पर होवर अनुवाद शॉर्टकट कुंजी काम नहीं करती थी।
...
- ठीक किया गया: "केवल अनुवाद" मोड के साथ रीडिंग प्लगइन्स जैसे Reader View का उपयोग करते समय संगतता समस्याएँ।
...
- सुधार किया गया: Greasemonkey और Safari के लिए भाषा पहचान क्षमताओं में सुधार किया गया है जिन पृष्ठों पर मामूली भाषाएँ हैं।
...
- सुधार किया गया: Twitter के लिए, बहु-पंक्ति सामग्री अनुवादों को डिफ़ॉल्ट रूप से लपेटा नहीं जाता है। लपेटना केवल तब होगा जब सामग्री 10 पंक्तियों या 1000 वर्णों से अधिक हो जाएगी। लपेटना सेटिंग्स के माध्यम से सक्षम किया जा सकता है **Advanced Settings** -> **Enable automatic line wrapping for long paragraphs**।

## 1.12.8 (2025-01-03)

- ठीक किया गया: समस्या जहां iOS 18.3 सेटिंग्स पृष्ठ ठीक से प्रदर्शित नहीं हो पाता।
...
- Google Meet अब लाइव मीटिंग्स के लिए द्विभाषी उपशीर्षकों का समर्थन करता है: अब, आप Google Meet मीटिंग्स में द्विभाषी उपशीर्षक सुविधा का आनंद ले सकते हैं। बस मीटिंग लिंक खोलें, immersive translation पैनल में द्विभाषी उपशीर्षक सक्रिय करें, और फिर इसे अनुभव करने के लिए पेज को रिफ्रेश करें।
...
- YouTube द्विभाषी उपशीर्षकों की स्थिति को समायोजित करने के बाद, सिस्टम नई स्थिति को स्वचालित रूप से याद रखेगा।
...
- अब आप इनपुट बॉक्स में टेक्स्ट का अनुवाद राइट-क्लिक के साथ कर सकते हैं: किसी भी वेबपेज पर इनपुट बॉक्स में किसी भी टेक्स्ट का चयन करें, राइट-क्लिक करके अनुवाद चुनें, और immersive translation स्वचालित रूप से चयनित टेक्स्ट को इनपुट बॉक्स की लक्ष्य भाषा में अनुवाद करेगा, जिससे इनपुट बॉक्स में मूल भाषा के टेक्स्ट को अन्य भाषाओं में जल्दी से अनुवाद करना सुविधाजनक हो जाता है।
- अब आप immersive translation के फ्लोटिंग बॉल में वेबपेज के अनुवाद मुद्दों की जल्दी से रिपोर्ट कर सकते हैं। एक वेबपेज का अनुवाद करने के बाद, यदि कोई समस्या है, तो आप फ्लोटिंग बॉल के दाईं ओर [Feedback] बटन पर क्लिक कर सकते हैं, समस्या विवरण भर सकते हैं, और हम इसे जल्द से जल्द निपटाएंगे।
...
- Microsoft Teams वेब संस्करण वीडियो मीटिंग्स में वास्तविक समय द्विभाषी उपशीर्षकों का समर्थन (Teams मीटिंग लिंक खोलें, immersive translation पैनल में द्विभाषी उपशीर्षक चालू करें, और फिर रिफ्रेश करें)
...
- Google, DeepL जैसी अनुवाद सेवाओं के लिए रिच टेक्स्ट अनुवाद के मुद्दों को ठीक किया गया (जैसे कि पृष्ठ सीधे `<button>` आदि प्रदर्शित करते हैं)
- YouTube वीडियो के लिए द्विभाषी शॉर्टकट को बंद न कर पाने की समस्या को ठीक किया गया।

## 1.7.8

- DeepL, Microsoft Translate, Google Translate, OpenAI, Claude, Gemini और अन्य अनुवाद सेवाएं अनुवाद के लिए मूल पाठ प्रारूप को बनाए रखने का समर्थन करती हैं (जैसे कि लिंक, बोल्ड, आदि)
...
- मंगा अनुवाद के लिए उपयोगकर्ता प्रतिक्रिया बटन जोड़ा गया (मंगा का अनुवाद करने के बाद, फ्लोटिंग बॉल के दाईं ओर [Feedback] बटन पर क्लिक करके अनुवाद गुणवत्ता पर प्रतिक्रिया दें)।
...
- AI विशेषज्ञ "Intelligent Selection" मोड का समर्थन करते हैं, जहां सिस्टम वर्तमान वेबसाइट के आधार पर सबसे उपयुक्त AI विशेषज्ञ का स्वचालित रूप से चयन करेगा (उदाहरण के लिए, The Verge और Hacker News के लिए प्रौद्योगिकी-संबंधित AI विशेषज्ञ स्वचालित रूप से चुने जाएंगे, जबकि Twitter के लिए अनुवाद वृद्धि स्वचालित रूप से चुनी जाएगी)।
...
- बड़े वेब पृष्ठों, ePub निर्माण, और उपशीर्षक फ़ाइलों के अनुवाद के प्रदर्शन को काफी अनुकूलित किया गया।
...
- चीन के भीतर से हाल के Microsoft अनुवाद सेवा अनुरोध अस्थिर रहे हैं; जब त्रुटियां होती हैं, तो सिस्टम स्वचालित रूप से वर्तमान में उपलब्ध अनुवाद सेवा का पता लगाता है, जिससे उपयोगकर्ता जल्दी से स्विच कर सकते हैं।
...
- कुछ Pro उपयोगकर्ता Chrome ब्राउज़र में सेटिंग्स को संशोधित नहीं कर पाने की समस्या को ठीक किया गया।
...
- एक नया शॉर्टकट सेटिंग समर्थन जोड़ा गया जो वीडियो उपशीर्षकों के लिए अंतर्निहित मशीन अनुवाद उपशीर्षकों का उपयोग करने के लिए त्वरित टॉगल की अनुमति देता है
- Sci-Hub वेबसाइट पर, फ्लोटिंग बॉल पर क्लिक करने से वेबपेज में एम्बेडेड PDFs का अनुवाद होगा

## 1.1.6

- **विशिष्ट पैराग्राफ का अनुवाद करने के लिए मोबाइल समर्थन:** मोबाइल संस्करण अब निर्दिष्ट पैराग्राफ का अनुवाद करने का समर्थन करता है और बाएं स्वाइप, दाएं स्वाइप, डबल-टैपिंग, ट्रिपल-टैपिंग, और मल्टी-फिंगर टच जेस्चर सहित विभिन्न शॉर्टकट ऑपरेशनों को जोड़ा गया है। ये डिफ़ॉल्ट रूप से सक्षम नहीं हैं और उपयोगकर्ता को [माउस होवर] के तहत सेटिंग्स पृष्ठ में ट्रिगरिंग जेस्चर को सक्रिय रूप से चुनने की आवश्यकता होती है।
...
- अनुकूलन: Epub और PDF का अनुवाद करते समय, यदि कुछ सामग्री का अनुवाद करने में विफल रहता है, तो अब पैनल पर बिना पूरे अनुवाद प्रक्रिया को पुनः आरंभ किए दूसरी अनुवाद सेवा पर स्विच करना संभव है (पिछला लॉजिक था कि तुरंत नई अनुवाद सेवा का उपयोग करके पूरी पुस्तक का पुनः अनुवाद किया जाए)। इसका मतलब है कि अनुवाद के बीच में, आप एक अलग अनुवाद सेवा पर स्विच कर सकते हैं और [सभी विफल पैराग्राफ को पुनः प्रयास करें] पर क्लिक कर सकते हैं, जिसके बाद सिस्टम नई सेवा का उपयोग करके अनुवाद जारी रखेगा।
...
- **शॉर्टकट कुंजी सेटिंग्स**: एक नया शीर्ष-स्तरीय मेनू "शॉर्टकट्स" और निम्नलिखित अनुकूलन योग्य शॉर्टकट कुंजी कार्य जोड़े गए:
  ...
  - वर्तमान इनपुट बॉक्स की सामग्री का अनुवाद करने के लिए कुंजियों के संयोजन को निर्दिष्ट करें, पिछले तरीके को पूरक करते हुए जल्दी से स्पेस बार को तीन बार दबाएं।
...
- **प्लगइन सेटिंग्स पृष्ठ UI अपडेट**:
  ...
  - "उन्नत सेटिंग्स" में, एक नया विकल्प जोड़ा गया है जो एक पैराग्राफ का अनुवाद करने के लिए आवश्यक न्यूनतम वर्णों की संख्या को कॉन्फ़िगर करने की अनुमति देता है। डिफ़ॉल्ट 4 वर्ण हैं, लेकिन इसे अधिक (जैसे, 20) सेट किया जा सकता है, ताकि केवल लंबे पैराग्राफ का अनुवाद किया जाएगा।
...
- **UI अनुकूलन**: पृष्ठ अनुवाद त्रुटि संकेतों के लिए UI को फिर से डिज़ाइन किया गया ताकि उन्हें समझना आसान हो सके। जब कई त्रुटियां होती हैं, तो एक पॉप-अप सक्रिय रूप से उपयोगकर्ता को संकेत देगा।
...
- कुछ प्लग-इन्स के साथ संघर्ष को ठीक किया जो अनंत पृष्ठ पुनः लोडिंग का कारण बनता है।
- लंबे पैराग्राफ लाइन ब्रेक चालू करने के बाद कुछ पैराग्राफ का अनुवाद न होने की समस्या को ठीक किया।
- [जब अस्थायी रूप से लंबे समय के लिए वेबपेज अनुवाद चालू किया जाता है, तो पैनल पर [हमेशा इस वेबसाइट का अनुवाद करें] पर क्लिक करने से हमेशा अनुवाद रद्द नहीं होता #1172](https://github.com/immersive-translate/immersive-translate/issues/1172) को ठीक किया।
...
- YouTube/Web of Science आदि के अनुवाद के टैब स्विच करते समय संवेदनशील न होने की समस्या को ठीक किया।
...
- जब आप पैनल में द्विभाषी सबटाइटल्स चालू करते हैं, तो यह पहले पृष्ठ को स्वचालित रूप से ताज़ा करेगा (द्विभाषी सबटाइटल्स को अधिक सटीक रूप से प्रदर्शित करने के लिए), और कुछ साइटों को अभी भी उपयोगकर्ताओं को साइट पर "CC" बटन पर मैन्युअल रूप से क्लिक करने की आवश्यकता होती है ताकि सबटाइटल्स चालू हो सकें।
...
- [अस्थायी रूप से वेब अनुवाद को एक अवधि के लिए चालू करना हमेशा अनुवाद रद्द नहीं करता #1172](https://github.com/immersive-translate/immersive-translate/issues/1172)
...
- Twitter इनपुट बॉक्स के अंत में इमोजी का अनुवाद न होने की समस्या को ठीक किया
...
- कुछ प्लेटफॉर्म्स पर माउस का समर्थन है या नहीं, यह पहचानने में समस्या को हल किया गया
  - कुछ डेस्कटॉप ब्राउज़र्स जो टचस्क्रीन और माउस दोनों का समर्थन करते हैं, और Immersive Translates तकनीकी रूप से यह पता लगाने में असमर्थ है कि ऐसे प्लेटफॉर्म्स माउस का समर्थन करते हैं या नहीं, इसलिए हमने [माउस होवर] सेटिंग में [माउस समर्थन को जबरन सक्षम करें] विकल्प जोड़ा है
...
- झटकेदार पृष्ठ होवरबॉल क्लिक को ठीक किया
...
- स्थानीय txt फाइलों का अनुवाद न होने की समस्या को ठीक करें
...
- यूट्यूब सबटाइटल्स का द्विभाषी सबटाइटल प्लगइन के साथ संघर्ष को ठीक करें (जब यूट्यूब द्विभाषी प्लगइन का पता लगाया जाता है तो यूट्यूब सबटाइटल अनुवाद सक्षम नहीं होता है ताकि संघर्ष से बचा जा सके)
...
- जब readwise हाइलाइट किया जाता है तो ऑटो-ट्रांसलेशन को ठीक करें
...
- Arigato अनुवादक सेटिंग फ़ील्ड और शब्दावली id का समर्थन करता है
...
- खोज संवर्धन का समर्थन करें, जब सक्षम किया जाता है, जब आप Google/Google समाचार में चीनी में खोज करते हैं, तो दाएं कॉलम में स्वचालित रूप से संबंधित अंग्रेजी कीवर्ड के खोज परिणाम दिखाए जाएंगे, जो डिफ़ॉल्ट रूप से सक्षम है।
  - कारण: हमने पाया कि Google खोज में, चीनी कीवर्ड और अंग्रेजी कीवर्ड के लिए खोज परिणाम बहुत भिन्न हो सकते हैं, इमर्सिव ट्रांसलेटेड सर्च संवर्धन सक्षम होने पर, हम आपके लिए स्वचालित रूप से अंग्रेजी में समान कीवर्ड की खोज करते हैं और उन्हें दाईं ओर प्रदर्शित करते हैं। यदि आपको इस सुविधा की आवश्यकता नहीं है तो आप इसे अक्षम कर सकते हैं।
...
- जब साइट को कभी अनुवाद न करने के लिए सेट किया जाता है तो इनपुट बॉक्स संवर्धन सक्षम नहीं होने की समस्या को ठीक करें।
...
- जब इनपुट बॉक्स को कोई उपसर्ग नहीं दिया गया हो, तो यह `ja Hello` का जापानी में अनुवाद और `English Hello` का अंग्रेजी में अनुवाद का समर्थन करता है।
...
- Google Bard अनुकूलन
- इनपुट बॉक्स अनुवाद पूरे टेक्स्ट बॉक्स का सीधे अनुवाद करने का समर्थन करता है बिना उपसर्गों के।
- OpenAI अनुवादों के मनमाने ढंग से अवधि जोड़ने की समस्या का अनुकूलन करें, (यदि मूल पाठ में कोई अवधि नहीं पाई जाती है, तो यदि openai एक अवधि लौटाता है, तो इसे हटा दें)
...
- जून में पहली रिलीज़, पिछले व्यक्तिगत उपडोमेन से स्थानांतरित https://immersive-translate.owenyoung.com से नए डोमेन https://immersivetranslate.com पर
...
- अनुकूलन: अनुवाद को ट्रिगर करने वाले पैराग्राफ में वर्णों की न्यूनतम संख्या को 4 वर्णों की न्यूनतम संख्या में संशोधित किया गया ताकि भ्रम को कम किया जा सके, जबकि साइट के नेविगेशन और अंत क्षेत्रों का अनुवाद करने से बचने के लिए अन्य सुविधाओं का उपयोग किया जा सके।
...
- केवल अनुवाद निर्यात करने के लिए उपशीर्षक अनुवाद समर्थन
- ठीक किया गया: कुछ तत्व माउस होवरिंग द्वारा पहचाने नहीं जा रहे थे
- ठीक किया गया: ट्वीट आंशिक पंक्ति विराम पहचाने नहीं जा रहे थे
- ठीक किया गया: ईबुक लेखन शैली काम नहीं कर रही थी

## 0.5.10

- ठीक किया गया: ट्वीट पंक्ति विराम पहचाने नहीं जा रहे थे
...
- समस्या को ठीक किया गया कि: वेबसाइट अनुवाद अवधि की अस्थायी सेटिंग प्रभावी नहीं हो रही थी।
...
- ठीक किया गया: OpenAI API काम नहीं कर रहा था।
...
- ठीक किया गया: Context Menu को अक्षम करना काम नहीं कर रहा था [#428](https://github.com/immersive-translate/immersive-translate/issues/428)
...
- ठीक किया गया: Context Menu कभी-कभी उपलब्ध नहीं हो सकता। [#273](https://github.com/immersive-translate/immersive-translate/issues/273)
...
- ठीक किया गया: Ebook Builder प्रगति 99% पर रुकी।
...
- संस्करण: अब से, हम हर महीने माइनर संस्करण संख्या बदलेंगे, उदाहरण के लिए, अब मार्च में, संस्करण 0.3.0 से शुरू होगा, अप्रैल में, संस्करण संख्या 0.3.0 से शुरू होगी, अगले अप्रैल में, संस्करण संख्या 1.4.0 होगी, और इसी तरह। यह इसलिए है क्योंकि एक्सटेंशन के लिए यह अर्थहीन है कि वे अर्थपूर्णता का पालन करें, लेकिन समय के नियमों के अनुसार संस्करण संख्याओं को मानकीकृत करना विकास को अद्यतन रखने के लिए प्रेरणा है, और उपयोगकर्ताओं के लिए समस्याओं को अधिक आसानी से ढूंढना है।
...
- ठीक किया गया: कुछ epub फ़ाइलें नहीं मिल सकती थीं।
...
- कोई तत्व नहीं दिखाने का प्रदर्शन ठीक करें।
...
- tencent त्रुटि को विभाजित करें।
