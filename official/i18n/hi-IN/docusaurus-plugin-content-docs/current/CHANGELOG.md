...
- Hulu सबटाइटल प्रदर्शन को अनुकूलित करें
...
- TED साइट पर सबटाइटल लोडिंग को अनुकूलित करें
- पुर्तगाली (ब्राज़ील) को प्लग-इन भाषा के रूप में समर्थन दिया गया है।
...
- AI अनुवाद सेवाओं के लिए [AI Expert] सेट करने का समर्थन, जो अनुवाद रणनीति को निर्दिष्ट करता है, वर्तमान में एक Beta सुविधा है, जिसे [Developer Settings](https://dash.immersivetranslate.com/#developer) में Beta सक्षम करने के बाद सक्षम किया जा सकता है, और [AI Expert] मेनू को रिफ्रेश करने के बाद देखा जा सकता है।
...
- Youtube उपशीर्षकों के अनुवाद की गति को काफी अनुकूलित किया गया, और चीनी और अंग्रेजी क्रम के बीच स्विच करने, फ़ॉन्ट रंग और आकार को अनुकूलित करने के लिए समर्थन जोड़ा गया
...
- पैनल स्विच केवल अनुवाद बटन को प्रदर्शित करने के लिए संशोधित किया गया है ताकि केवल वर्तमान पृष्ठ पर प्रभावी हो
...
- वेब पेज अनुवाद और वीडियो उपशीर्षक अनुवाद के लिए समर्थन, जैसे कि अरबी, हिब्रू आदि भाषाओं में, RTL (राइट-टू-लेफ्ट) डिस्प्ले समस्याओं का समाधान
...
- Safari पर Twitter उपशीर्षकों के डिस्प्ले समस्या को ठीक किया
...
- कुछ प्रो उपयोगकर्ताओं के लिए Chrome ब्राउज़र में सेटिंग्स को संशोधित न कर पाने की समस्या को ठीक किया।
...
- YouTube लाइव और [Mubi](https://mubi.com/) प्लेटफार्म के लिए उपशीर्षक अनुवाद समर्थन।
...
- **बग फिक्स**:
  ...
  - माउसओवर अनुवाद के विफल होने की समस्या को ठीक किया जब पृष्ठ फोकस खो देता है।
  - इनपुट बॉक्स वृद्धि सुविधा में 3 से कम वर्णों का अनुवाद न होने की समस्या को ठीक किया।
  - द्विभाषी Epubs के उत्पादन के दौरान कुछ निर्देशिकाओं का अनुवाद न होने की समस्या को ठीक किया।

- **विशेषता हटाना**: द्विभाषी जानकारी वृद्धि सुविधा को हटा दिया गया (Google खोज पृष्ठों पर एक साथ अंग्रेजी खोज परिणाम प्रदर्शित करना)।
...
- टैब स्विच करते समय YouTube/Web of Science आदि के अनुवाद संवेदनशील नहीं होने की समस्या को ठीक किया गया।
...
- [वीडियो उपशीर्षक फ़ंक्शन को स्थायी रूप से अक्षम करें] जोड़ा गया, यदि अन्य संघर्ष मुद्दे हैं और आप Immersive Translate के साथ द्विभाषी उपशीर्षक फ़ंक्शन को सक्षम नहीं करना चाहते हैं।
...
- उपयोगकर्ता के लॉगिन को लॉग आउट करके कैश को साफ करने की समस्या को ठीक किया गया।
...
- ब्राउज़र आइकन स्थिति परिवर्तन जोड़ें, जब एक वेब पेज का अनुवाद किया गया है, तो ब्राउज़र आइकन के निचले दाएं कोने में एक ✅ स्वचालित रूप से जोड़ा जाएगा।
...
- Safari सबटाइटल फाइलें पहचानी नहीं जा रही हैं
...
- जून में पहला रिलीज़, पिछले व्यक्तिगत उपडोमेन से माइग्रेट किया गया https://immersive-translate.owenyoung.com से नए डोमेन https://immersivetranslate.com पर
...
- फ़ीचर: स्प्लिट लाइन ट्रांसलेशन स्टाइल एकल पंक्ति अनुवादों के लिए एक वर्टिकल स्प्लिट लाइन जोड़ता है
- फिक्स: बहुत ही दुर्लभ मामलों में पैराग्राफ विभाजन।
- नए iOS उपयोगकर्ताओं के लिए एक शानदार पहली बार सेटअप ओरिएंटेशन पृष्ठ।

## 0.5.11

- केवल अनुवाद निर्यात के लिए उपशीर्षक अनुवाद समर्थन
- फिक्स: कुछ तत्व माउस होवरिंग द्वारा पहचाने नहीं जाते हैं
- फिक्स: ट्वीट आंशिक पंक्ति विराम पहचाने नहीं जाते
- फिक्स: ईबुक लेखन शैली काम नहीं कर रही

## 0.5.10

- फिक्स: ट्वीट पंक्ति विराम पहचाने नहीं जाते
- फिक्स: Reddit विवरण पृष्ठ कुछ पैराग्राफ लौटाता है जिन्हें अनुवादित नहीं किया जा सकता
...
- फिक्स: ईबुक ऑनलाइन पढ़ने की शैली काम नहीं कर रही
...
- फ़ीचर: नए उपयोगकर्ता के लिए नया गाइड पृष्ठ।
...
- फ़ीचर: नया क्लाइंट गाइड पृष्ठ जोड़ें
...
- फ़ीचर: माउस होवर पर वर्तमान पैराग्राफ का अनुवाद करें।
- फ़ीचर: PDF अनुवाद का पुनर्निर्माण, अब आप Immersive Translate के साथ अधिकांश PDFs का अनुवाद कर सकते हैं
- फिक्स: संदर्भ मेनू अक्षम काम नहीं कर रहा [#428](https://github.com/immersive-translate/immersive-translate/issues/428)
- फिक्स: [Mastondon](https://mastodon.social/) के लिए सामग्री सुरक्षा नीति से बचें
...
- फ़ीचर: अधिक स्थिर गुणवत्ता के लिए Bing Translate को Microsoft Translate में बदलें।
...
- फ़ीचर: तीसरे पक्ष को `toggleTranslatePage` कॉल करने के लिए दस्तावेज़ इवेंट भेजने की अनुमति दें
- फ़ीचर: iOS ऐप में एक्सटेंशन बटन और समुदाय लिंक सक्षम करें
...
- फ़ीचर: स्थानीय उपशीर्षक फ़ाइल (.srt,.ass, आदि) का अनुवाद समर्थन करें

## 0.3.17

- फ़ीचर: स्थानीय .txt फ़ाइल का अनुवाद समर्थन करें।
...
- फ़ीचर: अब हम कस्टम मार्कर अनुवाद थीम पृष्ठभूमि रंग को कस्टमाइज़ कर सकते हैं।
- फिक्स: जब पृष्ठ को प्रारंभ करते समय postMessage कुछ साइटों को तोड़ता है, अब हम ऐसा केवल तभी करेंगे जब हम वास्तव में पृष्ठों का अनुवाद करेंगे
...
- फ़ीचर: ईबुक बिल्डर के लिए अनुवाद प्रगति जोड़ें, और सफलता के बाद एक सुंदर कंफेटी।
- फ़ीचर: पुनः प्रयास बटन के लिए सभी विफल पैराग्राफ को पुनः प्रयास करें।
...
- फ़ीचर: OpenAI के लिए कस्टम API एंडपॉइंट जोड़ें
- फ़ीचर: `Advanced Settings` पर अस्थायी अनुवाद वेबसाइट समय विकल्प जोड़ें
...
- फ़ीचर: एक्सटेंशन के लिए स्थानीय html अनुवाद का समर्थन करें

## 0.3.2

- फिक्स: विकल्प फ़ॉर्म इनपुट कर्सर मूविंग।
- फ़ीचर: OpenAI डेवलप सेटिंग्स के लिए कस्टम apiUrl का समर्थन करता है।

## 0.3.1

- फ़ीचर: डार्क आइकन को पारदर्शिता में अपडेट करें।
...
- फ़ीचर: ईबुक रीडर और निर्माता का समर्थन करें

## 0.2.83

- फ़ीचर: पासवर्ड इनपुट फ़ॉर्म पासवर्ड दिखाने की अनुमति दें।
