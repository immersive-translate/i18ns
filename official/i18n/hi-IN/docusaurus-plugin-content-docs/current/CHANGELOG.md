...
- ठीक किया गया: "केवल अनुवाद" मोड के साथ रीडर व्यू जैसे पढ़ने के प्लगइन्स का उपयोग करते समय संगतता समस्याएं।
...
- ठीक किया गया: जहां iOS 18.3 सेटिंग्स पृष्ठ सही ढंग से प्रदर्शित नहीं हो सकता था।
...
- ~~सुधार किया गया: "**Enable Sidebar & Navbar Translation**" को कस्टमाइज़ करने का विकल्प जोड़ा गया "**Advanced Settings**" में।~~
- सुधार किया गया: "**Hover - immediately translate this paragraph**" मोड में छवियों का अनुवाद नहीं किया जाता है।
...
- सुधार किया गया: उन समस्याओं को संबोधित किया जहां PDF अनुवाद के दौरान अनुवाद बटन काम नहीं कर सकता था
...
- उन्नत सेटिंग्स में "गैर-अनुवाद योग्य शब्दों" के प्रबंधन को सुधार किया गया।

## 1.8.2

- अब आप इनपुट बॉक्स में टेक्स्ट का अनुवाद राइट-क्लिक के साथ कर सकते हैं: किसी भी वेबपेज पर इनपुट बॉक्स में किसी भी टेक्स्ट का चयन करें, अनुवाद चुनने के लिए राइट-क्लिक करें, और immersive translation स्वचालित रूप से चयनित टेक्स्ट को इनपुट बॉक्स की लक्ष्य भाषा में अनुवाद करेगा, जिससे इनपुट बॉक्स में मूल भाषा के टेक्स्ट को अन्य भाषाओं में जल्दी से अनुवाद करना सुविधाजनक हो जाता है।
- अब आप immersive translation के फ्लोटिंग बॉल में वेबपेजों के अनुवाद मुद्दों की जल्दी से रिपोर्ट कर सकते हैं। एक वेबपेज का अनुवाद करने के बाद, यदि कोई समस्या है, तो आप फ्लोटिंग बॉल के दाईं ओर [Feedback] बटन पर क्लिक कर सकते हैं, समस्या विवरण भर सकते हैं, और हम इसे जल्द से जल्द निपटाएंगे।
...
- Microsoft Teams वेब संस्करण वीडियो मीटिंग्स में रियल-टाइम द्विभाषी उपशीर्षकों का समर्थन (Teams मीटिंग लिंक खोलें, immersive translation पैनल में द्विभाषी उपशीर्षक चालू करें, और फिर रिफ्रेश करें)
...
- AI अनुवाद सेवाओं के लिए [AI Expert] सेट करने का समर्थन, जो अनुवाद रणनीति को निर्दिष्ट करता है, वर्तमान में एक Beta सुविधा है, जिसे Beta सक्षम करने के बाद [Developer Settings](https://dash.immersivetranslate.com/#developer) में सक्षम किया जा सकता है, और पृष्ठ को ताज़ा करने के बाद [AI Expert] मेनू देखा जा सकता है।
...
- कस्टम उपयोगकर्ता नियम विलय समस्या को ठीक किया गया
...
- YouTube एक विशेषता पेश करता है जो द्विभाषी उपशीर्षकों को अस्थायी रूप से सक्षम करता है
- YouTube द्विभाषी उपशीर्षकों के डाउनलोड का समर्थन करता है (केवल सदस्य)
- मोबाइल में इशारा नियंत्रण जोड़ें, [shortcut settings](https://dash.immersivetranslate.com/#shortcuts) के माध्यम से इनपुट को बढ़ाएं
...
- बाल अनुवाद सेवा को मुख्य अनुवाद सेवा का पालन करने का विकल्प जोड़ा गया
...
- **प्लगइन सेटिंग्स पृष्ठ UI अपडेट**:
  ...
  - "उन्नत सेटिंग्स" में, एक नया विकल्प जोड़ा गया है जो एक पैराग्राफ का अनुवाद करने के लिए आवश्यक न्यूनतम वर्णों की संख्या को कॉन्फ़िगर करने की अनुमति देता है। डिफ़ॉल्ट 4 वर्ण हैं, लेकिन इसे उच्चतर सेट किया जा सकता है (जैसे, 20), ताकि केवल लंबे पैराग्राफ का अनुवाद किया जाए।
...
- Twitter Space के लिए वास्तविक समय सबटाइटल अनुवाद का समर्थन किया।
...
- [जब लंबे समय के लिए वेबपेज अनुवाद को अस्थायी रूप से चालू किया जाता है, तो पैनल पर [हमेशा इस वेबसाइट का अनुवाद करें] पर क्लिक करने से हमेशा अनुवाद रद्द नहीं होता #1172](https://github.com/immersive-translate/immersive-translate/issues/1172) को ठीक किया।
...
- [Arxiv](https://arxiv.org/abs/1910.06709) पेपर्स साइट पर सभी पेपर्स के द्विभाषी संस्करणों तक त्वरित पहुंच प्रदान करता है।
...
- कुछ प्लेटफॉर्म्स पर माउस का समर्थन है या नहीं, यह पहचानने में असमर्थता की समस्या को हल किया
...
- OpenAI के प्रॉम्प्ट की लंबाई को 90 से घटाकर 40 कर दिया गया, और भी अधिक ट्रैफ़िक बचाया।
...
- होवरबॉल त्वरित अनुवाद बटन सेटअप का समर्थन (दोनों पीसी/मोबाइल समर्थन)
...
- जब readwise हाइलाइट किया जाता है तो स्वतः अनुवाद को ठीक करें
...
- हमें Apple द्वारा सूचित किया गया है कि OpenAI अनुवादों को अस्थायी रूप से iOS और macOS से हटा दिया गया है, और हम इसे चीन में फिर से लॉन्च करने की कोशिश कर रहे हैं।
...
- Arigato अनुवादक सेटिंग फ़ील्ड और शब्दावली id सेट करने का समर्थन करता है

## 0.7.2

- इनपुट बॉक्स संवर्धन: // उपसर्ग को छोड़ने की अनुमति देता है और 3 स्थानों के साथ पूरे इनपुट बॉक्स के अनुवाद को ट्रिगर करता है, या आप सेटिंग्स पृष्ठ में इस विकल्प को बंद कर सकते हैं।
...
- खोज संवर्धन का समर्थन करें, जब सक्षम किया जाता है, जब आप Google/Google समाचार में चीनी में खोज करते हैं, तो दाएं कॉलम में स्वचालित रूप से संबंधित अंग्रेजी कीवर्ड के खोज परिणाम दिखाए जाएंगे, जो डिफ़ॉल्ट रूप से सक्षम है।
  - कारण: हमने पाया कि Google खोज में, चीनी कीवर्ड और अंग्रेजी कीवर्ड के लिए खोज परिणाम बहुत भिन्न हो सकते हैं, इमर्सिव अनुवादित खोज संवर्धन सक्षम होने के साथ, हम आपके लिए स्वचालित रूप से अंग्रेजी में समान कीवर्ड की खोज करते हैं और उन्हें दाईं ओर प्रदर्शित करते हैं। यदि आपको सुविधा की आवश्यकता नहीं है तो आप इसे अक्षम करना चुन सकते हैं।
...
- समस्या को ठीक करें कि जब साइट को कभी अनुवाद न करने के लिए सेट किया गया हो तो इनपुट बॉक्स संवर्धन सक्षम नहीं होता है।
...
- PDF अनुवाद समर्थन खींचने के लिए आकार बदलने और अनुवाद की सामग्री को संपादित करने के लिए
...
- जून में पहली रिलीज़, पिछले व्यक्तिगत उपडोमेन से स्थानांतरितhttps://immersive-translate.owenyoung.comसे नए डोमेनhttps://immersivetranslate.com/
...
- ठीक करें: Github विवरण विस्तार के बाद अनुवाद नहीं हो रहा है।
...
- समस्या को ठीक किया गया कि: वेबसाइट अनुवाद की अस्थायी सेटिंग का समय प्रभावी नहीं हो रहा था।
...
- ठीक किया गया: Context Menu को अक्षम करना काम नहीं कर रहा [#428](https://github.com/immersive-translate/immersive-translate/issues/428)
...
- संस्करण: अब से, हम हर महीने माइनर संस्करण संख्या बदलेंगे, उदाहरण के लिए, अब मार्च में, संस्करण 0.3.0 से शुरू होगा, अप्रैल में, संस्करण संख्या 0.3.0 से शुरू होगी, अगले अप्रैल में, संस्करण संख्या 1.4.0 होगी, और इसी तरह। ऐसा इसलिए है क्योंकि एक्सटेंशन के लिए यह अर्थहीन है कि वे अर्थशास्त्र का पालन करें, लेकिन समय के नियमों के अनुसार संस्करण संख्याओं को मानकीकृत करना विकास को अद्यतन रखने के लिए प्रेरणा है, और उपयोगकर्ताओं के लिए समस्याओं को अधिक आसानी से ढूंढना।
...
- Feat: Add new theme Solid Border (नया थीम जोड़े, ठोस सीमा)
...
- जब कभी इस साइट का अनुवाद न करें सक्षम हो, पृष्ठ को पुनर्स्थापित करें
...
- केवल प्लेसहोल्डर तत्वों वाले अनुच्छेद का अनुवाद न करें, उदाहरण के लिए
