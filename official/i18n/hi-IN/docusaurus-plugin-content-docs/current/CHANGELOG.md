...
- ठीक किया गया: "अनुवाद पहले, मूल पाठ बाद में" मोड में होवर अनुवाद न होने की समस्या।
...
- ठीक किया गया: एक समस्या का समाधान किया गया जहां Gemini में मल्टी-सेगमेंट अनुवाद के दौरान कुछ सामग्री छूट गई थी।
...
- सुधार किया गया: Twitter के लिए, मल्टीलाइन सामग्री अनुवादों को डिफ़ॉल्ट रूप से न लपेटने के लिए सेट किया गया है। लपेटना केवल तभी होगा जब सामग्री 10 पंक्तियों या 1000 वर्णों से अधिक हो। लपेटना सेटिंग्स के माध्यम से सक्षम किया जा सकता है **Advanced Settings** -> **Enable automatic line wrapping for long paragraphs**।
...
- ठीक किया गया: समस्या जहां YouTube पर द्विभाषी उपशीर्षक को अस्थायी रूप से सक्षम करने से काम नहीं होता।
...
- Improved: PDF अनुवाद के दौरान अनुवाद बटन काम न करने की समस्याओं को संबोधित किया गया
...
- Tampermonkey स्क्रिप्ट SiliconCloud के अनुवाद मुद्दों को ठीक किया गया
...
- मोबाइल उपकरणों पर स्क्रॉल करते समय Reddit पृष्ठों का अनुवाद नहीं होने की समस्या को ठीक किया गया
...
- Safari प्लगइन संस्करण को अपग्रेड करने पर हमेशा स्थापना सफलता पृष्ठ को संकेत देने की समस्या को ठीक किया गया
...
- आप अब सेटिंग्स पृष्ठ -> [बेसिक सेटिंग्स] -> [अनुवाद शैली] में अनुवाद के लिए एक फ़ॉन्ट निर्दिष्ट कर सकते हैं
...
- **शॉर्टकट कुंजी सेटिंग्स**: एक नया शीर्ष-स्तरीय मेनू "शॉर्टकट्स" और निम्नलिखित अनुकूलन योग्य शॉर्टकट कुंजी कार्य जोड़े गए:
  ...
  - पृष्ठ पर माउस होवर पर "प्रत्यक्ष अनुवाद" को अस्थायी रूप से सक्षम करने के लिए कुंजियों के संयोजन को निर्दिष्ट करें। इसे फिर से दबाने पर यह फ़ंक्शन रद्द हो जाएगा।
...
- फिक्स: पहली स्थापना के बाद कुछ मशीनों पर डिफ़ॉल्ट लक्षित भाषा पहचान समस्या।
...
- अनुकूलित: माउस होवर का उपयोग करते समय, पृष्ठ पर ध्यान खोने और फिर से ट्रिगर करने पर प्रभावी नहीं होने की समस्या।
- फिक्स: OpenAI में प्रॉम्प्ट/मॉडल को संशोधित करने के बाद भी कैश मौजूद रहने की समस्या।

## 0.12.12

- अपडेट: पॉपअप पैनल को अनुकूलित किया गया, वर्तमान वेबसाइट के लिए कुछ विकल्पों को हटा दिया गया।
...
- फिक्स: Hacknews पर केवल सामग्री का हिस्सा गायब होने की समस्या को ठीक किया गया [#1264](https://github.com/immersive-translate/immersive-translate/issues/1264)।
...
- कुछ मामलों में जब वेबपृष्ठ को मध्य स्थिति में स्क्रॉल किया गया था, तब अनुवाद समय पर प्रतिक्रिया नहीं देने की समस्या को ठीक किया गया।
...
- लंबे पैराग्राफ लाइन ब्रेक चालू करने के बाद कुछ पैराग्राफ का अनुवाद नहीं होने की मरम्मत की गई।
...
- जब आप पैनल में द्विभाषी उपशीर्षक चालू करते हैं, तो यह पहले पृष्ठ को स्वचालित रूप से ताज़ा करेगा (द्विभाषी उपशीर्षक को अधिक सटीक रूप से प्रदर्शित करने के लिए), और कुछ साइटों को अभी भी उपयोगकर्ताओं को साइट पर "CC" बटन पर मैन्युअल रूप से क्लिक करने की आवश्यकता होती है उपशीर्षक चालू करने के लिए।
...
- [अस्थायी रूप से वेब अनुवाद को एक निश्चित समय के लिए चालू करना हमेशा अनुवाद रद्द नहीं करता #1172](https://github.com/immersive-translate/immersive-translate/issues/1172)
- पीडीएफ फ़ाइल प्रारंभिककरण मुद्दों को अनुकूलित करें।

## 0.12.3

- [स्थायी रूप से वीडियो उपशीर्षक अक्षम करें] सुविधा काम नहीं करने के लिए फिक्स [#1175](https://github.com/immersive-translate/immersive-translate/issues/1175)

## 0.12.2

- अधिक वीडियो प्लेटफार्मों के लिए द्विभाषी उपशीर्षक समर्थन प्रदान किया गया है, जो अब समर्थित हैं: [Youtube](https://www.youtube.com/), [Netflix](https://www.netflix.com), [Udemy](https://www.udemy.com/), [Khanacademy](https://www.khanacademy.org/), [Coursera](https://www.coursera.org/), [Vimeo](https://vimeo.com/), [Nebula](https://nebula.tv), [Bloomberg](https://www.bloomberg.com), [Bilibili](https://www.bilibili.com/), आदि। (ध्यान दें कि तकनीकी सीमाओं के कारण, कुछ वेबसाइटों को द्विभाषी उपशीर्षक चालू करने के बाद पहली बार पृष्ठ को ताज़ा करने की आवश्यकता होती है या द्विभाषी उपशीर्षक प्रदर्शित करने के लिए अनुवाद पूरा होने की प्रतीक्षा करने की आवश्यकता होती है)।
...
- ट्विटर इनपुट बॉक्स के अंत में इमोजी का अनुवाद नहीं हो पाने की समस्या को ठीक करें।
...
- उस समस्या को हल किया गया कि कुछ प्लेटफार्मों पर यह पहचान नहीं हो पाता था कि माउस समर्थित है या नहीं।
...
- Azure अनुवाद मुद्दों को ठीक करना।
...
- Youtube वीडियो के लिए द्विभाषी उपशीर्षकों के लिए पूर्ण समर्थन 🎉।
- लेख पृष्ठों के लिए, अब साइडबार सामग्री के बाकी हिस्सों से पहले मुख्य पाठ का अनुवाद किया जाएगा
- DeepL अनुवाद संदर्भ को अनुकूलित करें
- संदर्भ के लिए उपशीर्षक फ़ाइलों के OpenAI अनुवाद को अनुकूलित करें
...
- Grease Monkey आइकन प्रदर्शित न होने की समस्या को ठीक करें
...
- Windows ड्रॉपडाउन बॉक्स बाईं संरेखण
...
- जून में पहली रिलीज़, पिछले व्यक्तिगत उपडोमेन से स्थानांतरित किया गया https://immersive-translate.owenyoung.com से नए डोमेन https://immersivetranslate.com/
...
- TXT फ़ाइलों में पंक्ति विराम पहचान की समस्या का समाधान किया गया।
...
- समस्या का समाधान: [यह](https://edoras.sdsu.edu/~vinge/misc/singularity.html) जैसे शुद्ध TXT वेब पृष्ठ
...
- संस्करण: अब से, हम हर महीने माइनर संस्करण संख्या बदलेंगे, उदाहरण के लिए, अब मार्च में, संस्करण 0.3.0 से शुरू होगा, अप्रैल में, संस्करण संख्या 0.3.0 से शुरू होगी, अगले अप्रैल में, संस्करण संख्या 1.4.0 होगी, और इसी तरह। यह इसलिए है क्योंकि एक्सटेंशन के लिए semantics का पालन करना कोई मतलब नहीं है, लेकिन समय के नियमों के अनुसार संस्करण संख्याओं को मानकीकृत करना विकास को अद्यतन रखने के लिए प्रेरणा है, और उपयोगकर्ताओं के लिए समस्याओं को अधिक आसानी से ढूंढना है।
- विशेषता: फ़ायरफ़ॉक्स के लिए डार्क आइकन का समर्थन करें

## 0.2.86

- प्रति अनुरोध Open AI के साथ अधिकतम टेक्स्ट लंबाई विकल्प जोड़ें
- ठीक करें: ईबुक पहचानकर्ता डुप्लिकेट
- विशेषता: txt वेब पेज अनुवाद का समर्थन करें

## 0.2.85

- ठीक करें: कुछ epub फाइलें नहीं मिल सकती हैं।
...
- विशेषता: नया थीम ठोस बॉर्डर जोड़ें (新增新主题，实线边框)
...
- ठीक करें: फ़ायरफ़ॉक्स मोबाइल अनुवाद सेवा नेट समस्या सत्यापित करें।
...
- ठीक करें: PDF फाइल अनुवाद विफल, 0.2.60 से बग zh-CN से zh-TW के लिए deepl का समर्थन करने के लिए
...
- विशेषता: अनुवाद शीर्षक विकल्प का समर्थन करें
...
- प्रदर्शन: अनुरोधों को क्रमिक से समवर्ती में बदलें
...
- विशेषता: कस्टम अनुवाद पाठ रंग, बॉर्डर रंग का समर्थन करें।
...
- मास्क को फिर से टॉगल करने पर मास्क होवर को ठीक करें।
...
- अनुवाद प्लेसहोल्डर को बदलने को ठीक करें

## 0.2.39

- मास्क अनुवाद दिखाने के लिए शॉर्टकट का समर्थन करें
- डेवलपर पैनल पर बीटा विशेषता सक्षम करें
...
- बॉडी क्षेत्र के लिए साइड फुटर को ठीक करें
...
- जापानी rb, rt टैग को अनदेखा करने के लिए ठीक करें।
...
- जब इस साइट का अनुवाद कभी नहीं किया गया हो तो पृष्ठ को पुनर्स्थापित करें
