...
- जोड़ा गया: AI शब्दावली पुस्तकालय प्रबंधन
- जोड़ा गया: पीसी संस्करण में टेक्स्ट चयन अनुवाद सुविधा का समर्थन (non-userscript)
- जोड़ा गया: पीसी पर Youtube AI उपशीर्षक सक्षम करने का समर्थन (Pro सदस्य)
...
- ठीक किया गया: एक समस्या जहां होवर अनुवाद शॉर्टकट कुंजी उन उपकरणों पर काम नहीं करती थी जो माउस और टच दोनों का समर्थन करते हैं।
...
- ठीक किया गया: "अनुवाद पहले, मूल पाठ बाद में" मोड में होवर अनुवाद काम न करने की समस्या।
...
- ठीक किया गया: समस्या जहां PDF-Pro लंबी फाइलों का स्वचालित रूप से अनुवाद नहीं किया गया।
...
- ठीक किया गया: समस्या जहां **Mouse Hover Translation** समृद्ध पाठ का अनुवाद नहीं कर सका।
...
- ठीक किया गया: एक समस्या का समाधान किया गया जहां Gemini में बहु-खंड अनुवाद के दौरान कुछ सामग्री छूट गई थी।
...
- ठीक किया गया: समस्या जहां **Mouse Hover Translation** कुछ वेबसाइटों पर काम नहीं करता।
- सुधार किया गया: DeepLx अब अरबी का समर्थन करता है।
- सुधार किया गया: मूल भाषा की पहचान में सुधार किया गया। पहले, कई भाषाओं वाले पृष्ठों का अनुवाद नहीं हो सकता था, लेकिन अब उनका सही तरीके से अनुवाद किया जाता है।
- सुधार किया गया: Twitter के लिए, बहु-पंक्ति सामग्री अनुवादों को डिफ़ॉल्ट रूप से न लपेटने के लिए सेट किया गया है। लपेटना केवल तभी होगा जब सामग्री 10 पंक्तियों या 1000 वर्णों से अधिक हो। लपेटना सेटिंग्स के माध्यम से सक्षम किया जा सकता है **Advanced Settings** -> **Enable automatic line wrapping for long paragraphs**।
...
- ठीक किया गया: समस्या जहां YouTube पर द्विभाषी उपशीर्षक को अस्थायी रूप से सक्षम करना काम नहीं करता।
...
- सुधार किया गया: **x.com** पर अनुवाद करते समय, उपशीर्षक वाले वीडियो में स्वचालित रूप से द्विभाषी उपशीर्षक का अनुवाद होगा।
...
- सुधार किया गया: द्विभाषी मोड में अनुवाद गुणवत्ता में सुधार के लिए समृद्ध पाठ अनुवाद को डिफ़ॉल्ट रूप से बंद कर दिया गया है।
- ~~सुधार किया गया: "**Enable Sidebar & Navbar Translation**" को "**Advanced Settings**" में अनुकूलित करने का विकल्प जोड़ा गया।~~
- सुधार किया गया: "**Hover - तुरंत इस पैराग्राफ का अनुवाद करें**" मोड में छवियों का अनुवाद अब नहीं किया जाता है।
...
- ~~Improved: Twitter पर बहु-पंक्ति द्विभाषी अनुवादों का प्रदर्शन बेहतर किया गया।~~
- Improved: पैनल में अनुवाद सेवा ड्रॉपडाउन सूची का UI अपडेट किया गया।
...
- Fixed: विज्ञापन देखने के बाद YouTube पर उपशीर्षक समय के मुद्दों को समकालिक किया गया।
...
- Added: स्रोत भाषा और लक्ष्य भाषा समान होने पर चेतावनी प्रदर्शित करें
...
- Added: वीडियो उपशीर्षक अनुवाद विफल होने पर त्रुटि संदेश प्रदर्शित करें
...
- Google Meet अब लाइव मीटिंग्स के लिए द्विभाषी उपशीर्षक का समर्थन करता है: अब, आप Google Meet मीटिंग्स में द्विभाषी उपशीर्षक सुविधा का आनंद ले सकते हैं। बस मीटिंग लिंक खोलें, immersive translation पैनल में द्विभाषी उपशीर्षक सक्रिय करें, और फिर इसे अनुभव करने के लिए पृष्ठ को रिफ्रेश करें।
...
- Microsoft Teams वेब संस्करण वीडियो मीटिंग्स में रीयल-टाइम द्विभाषी उपशीर्षक का समर्थन (Teams मीटिंग लिंक खोलें, immersive translation पैनल में द्विभाषी उपशीर्षक चालू करें, और फिर रिफ्रेश करें)
...
- Youtube वेबसाइट प्रतिबंधों के कारण, Chrome Tampermonkey स्क्रिप्ट अब Youtube द्विभाषी उपशीर्षक का समर्थन नहीं करती है। कृपया [plugin version](https://immersivetranslate.com/) का उपयोग करें।
...
- राइट-क्लिक अनुवाद को "Translate to xx target language" में अनुकूलित करें
- तृतीय-पक्ष वेबसाइटों के लिए immersive [JS SDK](https://immersivetranslate.com/docs/js-sdk/) एकीकरण का समर्थन करें
- Hulu उपशीर्षक प्रदर्शन को अनुकूलित करें
- ZOOM वेब संस्करण मीटिंग उपशीर्षक अनुवाद का समर्थन करें

## 1.7.6

- AI विशेषज्ञों को अनुकूलित करने का समर्थन करें, प्रवेश [Settings]->[AI Expert] पृष्ठ के नीचे है।
...
- क्लाउड सिंक सेटिंग्स के कवरेज मुद्दों को अनुकूलित किया गया
...
- अरबी, हिब्रू आदि भाषाओं में वेब पेज अनुवाद और वीडियो उपशीर्षक अनुवाद का समर्थन, RTL (दाएं-से-बाएं) प्रदर्शन मुद्दों को संबोधित करते हुए
...
- कुछ प्रो उपयोगकर्ताओं के लिए Chrome ब्राउज़र में सेटिंग्स को संशोधित न कर पाने की समस्या को ठीक किया गया।
...
- विशिष्ट वेबसाइटों/भाषाओं के लिए केवल अनुवादित पाठ प्रदर्शित करने की सेटिंग का समर्थन।
...
- **मोबाइल पर विशिष्ट पैराग्राफ का अनुवाद करने के लिए समर्थन:** मोबाइल संस्करण अब निर्दिष्ट पैराग्राफ का अनुवाद करने का समर्थन करता है और इसमें विभिन्न शॉर्टकट ऑपरेशन जोड़े गए हैं, जिनमें बाएं स्वाइप करना, दाएं स्वाइप करना, डबल-टैप करना, ट्रिपल-टैप करना, और मल्टी-फिंगर टच जेस्चर शामिल हैं। ये डिफ़ॉल्ट रूप से सक्षम नहीं हैं और उपयोगकर्ता को सेटिंग्स पृष्ठ के [माउस होवर] के तहत ट्रिगरिंग जेस्चर को सक्रिय रूप से चुनने की आवश्यकता होती है।
...
- **शॉर्टकट कुंजी सेटिंग्स**: एक नया शीर्ष-स्तरीय मेनू "शॉर्टकट्स" और निम्नलिखित अनुकूलन योग्य शॉर्टकट कुंजी कार्य जोड़े गए:
  ...
  - वर्तमान इनपुट बॉक्स की सामग्री का अनुवाद करने के लिए कुंजियों के संयोजन को निर्दिष्ट करें, जो पहले के त्वरित रूप से स्पेस बार को तीन बार हिट करने के तरीके को पूरक करता है।
  - पृष्ठ पर माउस होवर पर "प्रत्यक्ष अनुवाद" को अस्थायी रूप से सक्षम करने के लिए कुंजियों के संयोजन को निर्दिष्ट करें। इसे फिर से दबाने पर यह कार्य रद्द हो जाएगा।
...
- **नई उपयोगकर्ता गाइड**: जब नए उपयोगकर्ता किसी गैर-लक्षित भाषा में पृष्ठ खोलते हैं, तो एक फ्लोटिंग बॉल सहायता गाइड बबल प्रदर्शित होती है।
...
- कुछ मामलों में जब वेबपृष्ठ को मध्य स्थिति में स्क्रॉल किया गया था, तब अनुवाद समय पर प्रतिक्रिया नहीं देता था, इस समस्या को ठीक किया गया।
...
- YouTube/Web of Science आदि के अनुवाद टैब स्विच करते समय संवेदनशील नहीं होते, इस समस्या को ठीक किया गया।
...
- [अस्थायी रूप से वेब अनुवाद को लंबे समय के लिए चालू करने से हमेशा अनुवाद रद्द नहीं होता #1172](https://github.com/immersive-translate/immersive-translate/issues/1172)
...
- ट्विटर इनपुट बॉक्स के अंत में इमोजी का अनुवाद नहीं हो सकता, इस समस्या को ठीक किया गया।
...
- कुछ प्लेटफार्मों पर माउस का समर्थन है या नहीं, इस समस्या को हल किया गया।
  - कुछ डेस्कटॉप ब्राउज़र हैं जो टचस्क्रीन और माउस दोनों का समर्थन करते हैं, और Immersive Translates तकनीकी रूप से यह पता लगाने में असमर्थ है कि ऐसे प्लेटफार्म माउस का समर्थन करते हैं या नहीं, इसलिए हमने [माउस होवर] सेटिंग में [माउस समर्थन को जबरन सक्षम करें] विकल्प जोड़ा है।
...
- DeepL Translation Contextualization को अनुकूलित करें
- उपशीर्षक फ़ाइलों के संदर्भ के लिए OpenAI अनुवाद को अनुकूलित करें
...
- PDF अनुवाद उपकरण को ऑनलाइन संस्करण में माइग्रेट किया गया है: https://app.immersivetranslate.com/pdf/ , ताकि Grease Monkey और Safari PDF अनुवाद का उपयोग कर सकें, और समस्याओं को बेहतर तरीके से हल किया जा सके बिना समस्या को हल करने के लिए संस्करण जारी किए।
...
- PDF अनुवाद के लिए अनुवाद शैली के त्वरित नियंत्रण के लिए नए विकल्पों के साथ (PDF फ़ाइलें बहुत अजीब होती हैं और इन विकल्पों को चालू करने से कुछ PDF फ़ाइलों के लिए उपयोगी हो सकता है जिनका स्वरूप गड़बड़ है)
...
- Arigato Translator सेटिंग फ़ील्ड और शब्दावली id का समर्थन करता है
...
- लक्ष्य भाषा चयन को अनुकूलित करें, अब यह केवल उन भाषाओं को दिखाएगा जो संबंधित अनुवाद सेवा द्वारा समर्थित हैं
- PDF अनुवाद अनुकूलन
...
- PDF अनुवाद अनुकूलन, अनुवाद क्षेत्र को अब संपादित/खींचा/हटाया जा सकता है
  - ऊपर बाईं ओर खींचें, ऊपर दाईं ओर हटाएं, नीचे दाईं ओर आकार बदलें
...
- समस्या का समाधान: कुछ कोड टैग सही ढंग से पहचाने नहीं गए थे।
...
- विशेषता: PDF अनुवाद का पुनर्निर्माण, अब आप Immersive Translate के साथ अधिकांश PDFs का अनुवाद कर सकते हैं
...
- समस्या का समाधान: जब init पृष्ठ कुछ साइटों को तोड़ता है, अब हम यह केवल तब करेंगे जब हम वास्तव में पृष्ठों का अनुवाद करते हैं
...
- संस्करण: अब से, हम हर महीने माइनर संस्करण संख्या बदलेंगे, उदाहरण के लिए, अब मार्च में, संस्करण 0.3.0 से शुरू होगा, अप्रैल में, संस्करण संख्या 0.3.0 से शुरू होगी, अप्रैल में, संस्करण संख्या 0.4.0 से शुरू होगी, अगले अप्रैल में, संस्करण संख्या 1.4.0 होगी, और इसी तरह। ऐसा इसलिए है क्योंकि एक्सटेंशन के लिए यह अर्थ नहीं रखता कि वे अर्थशास्त्र का पालन करें, लेकिन समय के नियमों के अनुसार संस्करण संख्याओं को मानकीकृत करना विकास को अद्यतन रखने के लिए प्रेरणा है, और उपयोगकर्ताओं के लिए समस्याओं को अधिक आसानी से ढूंढना।
- विशेषता: फ़ायरफ़ॉक्स के लिए डार्क आइकन का समर्थन करें

## 0.2.86

- Open AI के लिए प्रति अनुरोध अधिकतम टेक्स्ट लंबाई विकल्प जोड़ें
- फिक्स: ईबुक पहचानकर्ता डुप्लिकेट
- फीचर: txt वेब पेज अनुवाद का समर्थन

## 0.2.85

- फिक्स: कुछ epub फाइलें नहीं मिल सकतीं।

## 0.2.84

- फीचर: Ebook Reader और Maker का समर्थन

## 0.2.83

- फीचर: पासवर्ड इनपुट फॉर्म पासवर्ड दिखाने की अनुमति दें।

## 0.2.82

- फिक्स: कुछ साइट्स `span` का उपयोग स्टाइल के लिए करती हैं, इसलिए हम अनुवाद लक्ष्य रैपर के लिए `font` का उपयोग करते हैं
- फिक्स: OpenAI अधिकतम टोकन सीमा, अधिकतम वर्णों को 1500 से 1300 में बदलें।

## 0.2.81

- फिक्स: m.youtube.com
- फिक्स: विकल्प फॉर्म UI
- फिक्स: Open AI प्रॉम्प्ट
- फीचर: OpenAI के लिए कई कुंजियों का समर्थन, उन्हें `,` से विभाजित करें।

## 0.2.80

- फीचर: पॉपअप के लिए सक्षम/अक्षम मेनू जोड़ें -> अधिक
...
- फीचर: OpenAI CHATGPT 3.5 का समर्थन (OpenAI ChatGPT 3.5 इंटरफ़ेस का समर्थन करता है)
- फीचर: नया थीम ठोस बॉर्डर जोड़ें (新增新主题，实线边框)

## 0.2.77

- फिक्स: कई कोड टैग त्रुटि।[#178](https://github.com/immersive-translate/immersive-translate/issues/178)
...
- फीचर: विभिन्न अनुवाद सेवाओं के लिए कस्टम तात्कालिक अनुवाद पाठ गणना का समर्थन।

## 0.2.74

- फीचर: Tencent का समर्थन (अल्फा)
- फिक्स: openai अनुवाद
- फिक्स: अज्ञात टैग इनलाइन जांच

## 0.2.73

- फीचर: ग्रे अनुवाद थीम का समर्थन
- फिक्स: Github ट्रेंडिंग पेज

## 0.2.72

- फिक्स: फ़ायरफ़ॉक्स मोबाइल अनुवाद सेवा नेट समस्या सत्यापित करें।

## 0.2.71

- फिक्स: Open AI उपयोगकर्ता स्क्रिप्ट अनुमति

## 0.2.70

- फिक्स: Open AI प्लेसहोल्डर

## 0.2.69

- फीचर: अनुवाद सेवा के रूप में Open AI का समर्थन।
- फीचर: options.html पर अनुवाद सेवा सत्यापित करने का समर्थन
- फीचर: कस्टम मुख्य फ्रेम का समर्थन करें क्योंकि कुछ साइट मुख्य फ्रेम के रूप में बॉडी का उपयोग नहीं कर रही हैं

## 0.2.68

- Caiyun का समर्थन (अल्फा)
- अज्ञात ब्लॉक टैग ठीक करें

## 0.2.67

- फीचर: हमेशा अनुवाद भाषाओं के लिए `<all>` जोड़ें, इसलिए अब आप इसे लक्ष्य भाषा को छोड़कर सभी भाषाओं का अनुवाद करने के लिए उपयोग कर सकते हैं, और कभी भी अनुवाद भाषाओं का अनुवाद नहीं कर सकते
- फिक्स: कस्टम गूगल API कॉन्फ़िगर करने की अनुमति दें
- बेहतर: Deepl फ्री समर्थन
- फिक्स: उपयोगकर्ता स्क्रिप्ट और एक्सटेंशन के लिए उच्च मेमोरी उपयोग (opencc zh-CN से zh-TW को हटाकर, इसके बजाय Google अनुवाद के साथ)
- फिक्स: Relingo [#159] (https://github.com/immersive-translate/immersive-translate/issues/159)
- फिक्स: Azure अनुवाद सेटअप लेकिन फिर भी दिखाएं (सेटअप की आवश्यकता है)

## 0.2.66

- फिक्स: PDF फाइल अनुवाद विफल, 0.2.60 से बग zh-CN से zh-TW के लिए deepl का समर्थन करने के लिए
...
- फिक्स: openl अनुवाद सेवाओं का चयन करें
- फीचर: शीर्षक विकल्प का अनुवाद है का समर्थन करें

## 0.2.63

- फीचर: Azure अनुवाद सेवा का समर्थन करें
- फीचर: Papago अनुवाद सेवा का समर्थन करें
- फिक्स: मूल फ़ायरफ़ॉक्स एंड्रॉइड गूगल ड्राइव सिंक।
- फिक्स: पारदर्शिता को 0.4 से 0.618 में बदलें [#147] (https://github.com/immersive-translate/immersive-translate/pull/147)
- फिक्स: पॉपअप शॉर्टकट टिप्स
- प्रदर्शन: अनुरोधों को क्रमिक से समवर्ती बनाना
- जापानी गणना का पता लगाने के लिए बेहतर

## 0.2.62

- फीचर: waitForSelectors नियम जोड़ें, कुछ साइटों जैसे reddit को ठीक करने के लिए

## 0.2.61

- फिक्स: उपयोगकर्ता स्क्रिप्ट ग्रीसी फोर्क के लिए बहुत बड़ी है
- बेहतर: फ़ाइल आकार कम करें

## 0.2.60

- फीचर: Deepl के लिए zh-CN से zh-TW का समर्थन करें
- फीचर: Immersive Translate Deepl फीचर
- फीचर: कस्टम फ़ॉन्ट आकार ज़ूम का समर्थन करें
- फिक्स: स्टीम फोरम स्टाइल
- फिक्स: गतिशील तत्व उत्पन्न होने के बाद वैश्विक शैली नहीं बदली
- फिक्स: बहिष्करण प्राथमिकता को बढ़ावा दें
- UI: अबाउट पेज परिवर्तन
- फिक्स: कुछ गणितीय तत्व मूल रूप से बने रहें

## 0.2.59

- फिक्स: अज्ञात टैग ब्लॉक तत्व
- फिक्स: translate=no तत्व ओवरराइड
- फिक्स: कई \* के साथ URL मिलान

## 0.2.58

- फीचर: कस्टम अनुवाद पाठ रंग, बॉर्डर रंग का समर्थन करें।
...
- फीचर: डेवलपर बोर्ड पर इंजेक्टेड सीएसएस का समर्थन करें
- फीचर: authKey, appid appSecret ट्रिम करें
- बेहतर: नई टैब में सेटिंग पेज खोलें (लेकिन स्टे के लिए नहीं)

## 0.2.55

- deepl api charset को ठीक करने का प्रयास करें

## 0.2.54

- क्रोम स्टोर अस्वीकृति के लिए टैब अनुमति हटाएं
- पूरे पेज का अनुवाद करें, फुटर को अनदेखा किया गया
- अबाउट पेज पर नोट्स जोड़ें
- बिल्ट-इन कॉन्फ़िग से कस्टम URL का समर्थन करें

## 0.2.53

- फिक्स उपयोगकर्ता स्क्रिप्ट गूगल ड्राइव सिंक त्रुटि।
...
- फिक्स गूगल ऑथ क्रोम/फ़ायरफ़ॉक्स पर लॉगिन की आवश्यकता है
...
- फिक्स गूगल ड्राइव अपलोड समस्या (वास्तव में) [#81](https://github.com/immersive-translate/immersive-translate/issues/81)

## 0.2.49

- शॉर्टकट alt+d, alt+s को हटाएं क्योंकि वे मूल शॉर्टकट के साथ संघर्ष कर सकते हैं।
- फिक्स गूगल ड्राइव अपलोड समस्या [#81](https://github.com/immersive-translate/immersive-translate/issues/81)

## 0.2.48

- गति के लिए बेहतर, भाषा का पता लगाने के लिए minLength को 50 तक जोड़कर।
- फिक्स गूगल ड्राइव टोकन मान्य करें।
...
- फिक्स तत्व innerText अपरिभाषित है
- फिक्स caiyun अनुवाद अपरिभाषित स्रोत भाषा

## 0.2.44

- फिक्स उपयोगकर्ता स्क्रिप्ट टॉगल मास्क
- फिक्स टॉगल मास्क लॉजिक

## 0.2.43

- फिक्स उपयोगकर्ता स्क्रिप्ट टॉगल मास्क टच इवेंट के साथ।
- गति ठीक करें (नींद(300) को हटाकर)

## 0.2.42

- फिक्स मास्क होवर जब टॉगल मास्क फिर से।
- मोबाइल के लिए मास्क शॉर्टकट जोड़ें
- फिक्स उपयोगकर्ता स्क्रिप्ट क्लाउड सिंक समस्या
- उन्नत विकल्प पृष्ठ को बाएं मेनू में ले जाएं।
- अनुवाद सेवा के लिए पुनः प्रयास लॉजिक जोड़ें

## 0.2.41

- फिक्स उपयोगकर्ता स्क्रिप्ट niu अनुवाद
- फिक्स xhtml अनुवाद

## 0.2.40

- फिक्स बीटा फीचर शो
- नई टैब पेज पर पॉपअप सेटिंग पेज ठीक करें
...
- फिक्स getpocket.com
- बॉडी एरिया के लिए फिक्स साइड फुटर
...
- फिक्स फ़ायरफ़ॉक्स एंड्रॉइड ऐडऑन
...
- फिक्स स्टे.app उपयोगकर्ता स्क्रिप्ट ब्राउज़र API
- फिक्स स्टे.app विकल्प पृष्ठ
...
- फिक्स फ़ायरफ़ॉक्स ऑनलाइन पीडीएफ अनुवाद

## 0.2.20

- फिक्स मकाक अनुरोध समस्या
- फिक्स मार्क हाइलाइट लाइन ऊंचाई

## 0.2.19

- फिक्स टेनसेंट स्मार्ट जापानी
- फिक्स हाइकुओ वर्ल्ड ब्राउज़र

## 0.2.18

- फिक्स क्लाइंट URL परिवर्तन, अनुवाद स्थिति को स्वचालित रूप से बनाए रखें।
...
- exclude elements mark को ठीक करें
- deno type check को ठीक करें
- importmap हटाएं
- context menus अनुवाद को ठीक करें
...
- fulltext अनुवाद समस्या को ठीक करें
...
- तत्व मार्क को पुनर्गठित करें

## 0.0.54

- X वर्णों के लिए line break का समर्थन करें।

## 0.0.53

- sendMessage का उपयोग connect के बजाय करें, क्योंकि chrome 5 मिनट के बाद पोर्ट को डिस्कनेक्ट कर देगा
...
- कैश अनुरोध के लिए timeout जोड़ें

## 0.0.44

- tencent त्रुटि को विभाजित करें को ठीक करें।
- inline sup तत्व त्रुटि को ठीक करें।
...
- पॉपअप अनुवाद सेवा बदलने पर काम नहीं करने को ठीक करें
...
- तत्काल अनुवाद मोड सेट करने का समर्थन करें, ताकि आप वेब पृष्ठ को जितनी जल्दी हो सके अनुवाद कर सकें।
