...
- تمت الإضافة: دعم **ترجمة العناوين الفرعية** في الاجتماعات الفورية عبر "الكرة العائمة"، متاح على Zoom وGoogle Meet وMicrosoft Teams.
...
- تحسين: تحسين إدخال النص ووظيفة التحويم بالماوس داخل iframes المدمجة على صفحات الويب

## 1.10.2 (2024-10-11)

- تمت الإضافة: ترجمة الصور (نسخة تجريبية)
- تمت الإضافة: تفعيل وضع دعم الماوس بالقوة (قم بتفعيل هذه الميزة فقط إذا كانت وظيفة التحويم بالماوس غير متاحة على الأجهزة اللوحية) **الإعدادات** -> **الإعدادات المتقدمة** -> **تفعيل دعم الماوس بالقوة**
...
- بعد تعديل موضع الترجمات الثنائية على YouTube، سيتذكر النظام الموضع الجديد تلقائيًا.
...
- توفير المزيد من أوراق arXiv مع تحسين تخطيط الترجمة الثنائية
...
- تدعم ترجمات YouTube الثنائية الآن تقسيم الجمل الذكي (نسخة تجريبية) (فقط عند تفعيل الترجمة الغامرة لترجمات YouTube يدويًا في [الإعدادات] - [ترجمات الفيديو]، وتكون ترجمات الفيديو الأصلية ترجمات إنجليزية تلقائية)
- تمت الإضافة: خدمة الترجمة Tencent [【Hunyuan Large Model】](https://immersivetranslate.com/docs/services/tencent-hunyuan/)

## 1.6.5

- إصلاح مشاكل تخطيط النص في ترجمة القصص المصورة للغات التي تستخدم الحروف اللاتينية.
- المواقع الجديدة المدعومة لترجمة القصص المصورة:
...
- عند استخدام خبراء الذكاء الاصطناعي لـ "الاختيار الذكي"، يمكن تخصيص خبراء الذكاء الاصطناعي المختلفين لمواقع الويب المختلفة. يمكن ضبط ذلك في [الإعدادات] -> [خبراء الذكاء الاصطناعي] -> [أدخل أي خبير].
...
- قائمة نماذج AI المخصصة تدعم صيغة `-all`، والتي يمكن أن تحذف جميع النماذج المحددة مسبقًا.
...
- يدعم الخبراء AI وضع "الاختيار الذكي"، حيث سيقوم النظام تلقائيًا باختيار الخبير AI الأنسب بناءً على الموقع الحالي (على سبيل المثال، سيتم اختيار الخبراء AI المتعلقين بالتكنولوجيا تلقائيًا لـ The Verge و Hacker News، بينما سيتم اختيار تحسين الترجمة لتويتر تلقائيًا لتويتر).
...
- الآن تستوعب صفحة الإعدادات تعديلات على [أنماط ترجمات YouTube](https://dash.immersivetranslate.com/#subtitle).
...
- الآن تدعم خيارات "المزيد" في اللوحة [إدخال ترجمة النص](https://app.immersivetranslate.com/text/)
...
- الآن تعرض اللوحة الكشف التلقائي اللغة الأصلية.
...
- تحسين: تعيين اللغة الهدف تلقائيًا بناءً على لغة المتصفح.
...
- [تشغيل ترجمة الويب مؤقتًا لفترة طويلة لا يلغي الترجمة دائمًا #1172](https://github.com/immersive-translate/immersive-translate/issues/1172)
...
- تحسين سياق ترجمة ملفات الترجمة في OpenAI
...
- دعم نتائج الترجمة المحسنة للإدخال ctrl+z تراجع
...
- إصلاح مشكلة أنه عند فتح ملفات PDF، تظهر اللوحة الإضافية أنه لا توجد أذونات.
...
- إصلاح المشكلة التي: إعداد مدة ترجمة الموقع المؤقتة لا تأخذ مفعولها.
...
- إصلاح: مشكلة النافذة المنبثقة في علامة التبويب الجديدة لنظام macOS.
...
- إزالة: إزالة Papago، حيث [الخدمة معطلة](https://github.com/immersive-translate/immersive-translate/issues/310)
...
- إصلاح: postMessage عند كسر الصفحة init لبعض المواقع، الآن سنفعل ذلك فقط عندما نقوم بترجمة الصفحات حقًا
...
- إصلاح: عنصر الوسوم غير المعروفة
...
- إصلاح الترجمة المكررة لعناصر السطر مع عنصر الكود.
...
- إصلاح علامة BR
- التعامل مع علامات الكتل للقواعد
