...
- تمت الإضافة: يدعم متصفح Android الترجمة المجانية للصور.
...
- تحسين: تصفية النصوص القذرة في خدمة الترجمة deepl.
...
- تم الإصلاح: خطأ `401: Authentication Fails` في مفتاح API المخصص DeepSeek.
...
- تحسين: تدعم الآن Microsoft و Google و Tencent اللغة الكانتونية.
...
- تحسين: بالنسبة لـ Twitter، يتم تعيين ترجمات المحتوى متعدد الأسطر على عدم الالتفاف افتراضيًا. سيتم الالتفاف فقط عندما يتجاوز المحتوى 10 أسطر أو 1000 حرف. يمكن تمكين الالتفاف من خلال الإعدادات **Advanced Settings** -> **Enable automatic line wrapping for long paragraphs**.
...
- تم الإصلاح: مشكلة عدم عمل الترجمة الفورية الثنائية اللغة مؤقتًا على YouTube.
...
- تم الإصلاح: بعض الأخطاء في تأثير الترجمة متعددة الأسطر على Twitter.
- تم الإصلاح: مشاكل في ترجمة بعض الصيغ بسبب النصوص الغنية.
- تحسين: عند الترجمة على **x.com**، سيتم تلقائيًا ترجمة الترجمة الفورية الثنائية اللغة للفيديوهات مع الترجمة.
- تحسين: الفيديوهات بدون ترجمة ستعرض أيقونة الترجمة وتوفر سببًا لعدم إمكانية الترجمة.
...
- تم الإصلاح: مشكلة في ترجمة صور Twitter في متصفح Safari.
- تم الإصلاح: تصبح مفاتيح الاختصار غير فعالة عند تبديل ميزة "**Hover Translation**" تشغيلًا أو إيقافًا.
- تحسين: تحسين عرض الترجمة الفورية الثنائية اللغة متعددة الأسطر على Twitter و YouTube.
- تحسين: يتم إيقاف الترجمة النصية الغنية افتراضيًا في وضع الثنائية اللغة لتحسين جودة الترجمة.
...
- تم الإصلاح: مشكلة في ترجمة الصيغ بسبب "تحسين الترجمة في Twitter" في الإصدار 1.11.2.

## 1.11.2 (2024-11-13)

- تم الإصلاح: مشكلة اختفاء المحتوى بعد النقر على "عرض المزيد" في وضع الترجمة فقط في Facebook.
- ~~تحسين: تحسين عرض الترجمة الفورية الثنائية اللغة متعددة الأسطر على Twitter.~~
- تحسين: تحديث واجهة المستخدم لقائمة خدمات الترجمة المنسدلة في اللوحة.

## 1.11.1 (2024-11-05)

- تمت الإضافة: يدعم **Subtitles Translation** في الاجتماعات الفورية الآن التفعيل عبر "float ball"، متاح على Zoom و Google Meet و Microsoft Teams.
...
- تحسين: تحسين وظيفة تعزيز الإدخال والتحويم بالماوس داخل iframes المدمجة على صفحات الويب

## 1.10.2 (2024-10-11)

- أُضيف: ترجمة الصور (نسخة تجريبية)
- أُضيف: وضع تمكين دعم الفأرة بالقوة (قم بتمكين هذه الميزة فقط إذا كانت وظيفة تحويم الفأرة غير متوفرة على أجهزة التابلت) **الإعدادات** -> **الإعدادات المتقدمة** -> **تمكين دعم الفأرة بالقوة**
...
- [PDF Pro](https://app.immersivetranslate.com/pdf-pro/) يدعم نسخ الصيغ (انقر بزر الفأرة الأيمن على الصيغة لرؤية قائمة النسخ)
...
- أُضيف خيار "الإبلاغ عن مشاكل الترجمة في الصفحة الحالية" وخيار "تشغيل/إيقاف الكرة العائمة بسرعة" في المزيد من الخيارات في اللوحة.
...
- يمكنك الآن ترجمة النص في صناديق الإدخال بالنقر بزر الفأرة الأيمن: حدد أي نص في صندوق إدخال على صفحة ويب، انقر بزر الفأرة الأيمن لاختيار الترجمة، وستقوم الترجمة الغامرة بترجمة النص المحدد تلقائيًا إلى لغة الهدف لصندوق الإدخال، مما يجعل من السهل ترجمة النص الأصلي في صناديق الإدخال إلى لغات أخرى بسرعة.
...
- بسبب قيود موقع Youtube، لم يعد يدعم سكربت Tampermonkey في Chrome ترجمات YouTube الثنائية. يرجى استخدام [إصدار الإضافة](https://immersivetranslate.com/).
...
- بعد تحديد النص، ستتغير قائمة النقر بزر الفأرة الأيمن إلى [ترجمة النص]، انقر عليها للانتقال تلقائيًا إلى صفحة ترجمة النصوص الغامرة
...
- تحسين الترجمة بالنقر بزر الفأرة الأيمن إلى "ترجمة إلى لغة الهدف xx"
...
- إضافة دعم لمواقع جديدة في ترجمة القصص المصورة:
...
- أُضيفت خدمة الترجمة Tencent [【نموذج Hunyuan الكبير】](https://immersivetranslate.com/docs/services/tencent-hunyuan/)

## 1.6.5

- إصلاح مشاكل تخطيط النصوص لترجمات القصص المصورة للغات المكتوبة بالحروف اللاتينية.
...
- تم إجراء تحسينات لمعالجة المشكلة التي كانت تجعل الترجمات الثنائية اللغة الغامرة لا تظهر عندما يضبط المستخدمون لغة الترجمة إلى الصينية على موقع YouTube.
...
- تم تعديل وصف الاختصار للوحة المحمولة.
...
- **تجربة الترجمة الغامرة:** للتكيف بشكل أفضل مع عادات المستخدم، قمنا بنقل الاختصار للترجمات الثنائية في وضع ملء الشاشة على منصة YouTube إلى الجانب الأيسر.
...
- إضافة بوابة ترجمة سريعة لملفات PDF إلى الجانب الأيمن من موقع أوراق [Arxiv](https://arxiv.org/abs/1910.06709)، والتي تذهب إلى صفحة HTML نظيفة (مدعومة فقط من بعض الأوراق، حيث يتطلب ذلك من المؤلفين الأصليين تقديم الشيفرة المصدرية، لذا فإن حوالي 50% من الأوراق ستظهر هذه البوابة)
...
- إصلاح تعارض ترجمات Youtube مع إضافة الترجمة الثنائية (يتم تعطيل ترجمة ترجمات Youtube في Immersive Translate عند اكتشاف إضافة Youtube Dual لتجنب التعارض)
...
- إصلاح مشاكل أسماء الملفات عند إنشاء كتب Epub الإلكترونية
...
- تحسين Google Bard
- دعم ترجمة صندوق الإدخال لترجمة النص الكامل مباشرة بدون بادئات.
...
- تم إصلاح المشكلة التي تتطلب تعديل اختصار تحويم الفأرة تحديث الصفحة لتأخذ تأثيرًا
...
- تم إصلاح المشكلة التي تتطلب تغيير اختصار تحويم الفأرة تحديث الصفحة لتأخذ تأثيرًا
...
- إصلاح: مستمع مفتاح الاختصار لتحويم الفأرة.
...
- ميزة: دعم OpenAI لمفاتيح متعددة، استخدم `,` لفصلها.
...
- إصلاح حقن CSS iframe الديناميكي
...
- إصلاح بعض علامات span التي هي عنصر كتلة
