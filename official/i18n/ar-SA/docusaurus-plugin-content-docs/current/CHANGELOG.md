...
- تحسين: [ترجمة الصور المجانية] تدعم التنسيق للغات من اليمين إلى اليسار.
...
- تحسين: تحسين قدرات التعرف على اللغة لـ Greasemonkey وSafari على الصفحات ذات اللغات الثانوية.
- تحسين: الوصول إلى واجهة خدمة اختبار صفحة الإعدادات عبر الإنترنت.
- تحسين: تحسين تجربة المستخدم لميزة معاينة مقارنة السياق.
- تحسين: منطق الحكم بين وضع اللمس والماوس.

## 1.14.8 Release (2025-02-10)

- تم الإصلاح: مشكلة عدم الترجمة التلقائية للملفات الطويلة في PDF-Pro.
- تحسين: تدعم الآن Microsoft وGoogle وTencent اللغة الكانتونية.
- تحسين: تدعم الآن BBC العناوين الفرعية.

## 1.14.6 Preview (2025-02-08)

- تم الإصلاح: مشكلة عدم قدرة **Mouse Hover Translation** على ترجمة النصوص الغنية.
- تحسين: يدعم الآن إصدار Tampermonkey ترجمة العناوين الفرعية في YouTube.

## 1.14.4 Release (2025-02-07)

- تم الإصلاح: مشكلة اكتشاف اللغة غير الصحيحة في **Enhanced Input Box**.
- تم الإصلاح: مشكلة المطابقة الذكية لخبراء الذكاء الاصطناعي في خدمات الترجمة المخصصة.
...
- جديد: تتوفر الآن ترجمة الصور المجانية (مدعومة حاليًا فقط على إصدارات PC من متصفحات Chrome وEdge)، يمكن الوصول إليها عبر قائمة النقر بزر الماوس الأيمن.
- تم الإصلاح: معالجة مشكلة فقدان بعض المحتوى أثناء الترجمة متعددة الأجزاء في Gemini.
- تحسين: تحسين تحميل العناوين الفرعية في YouTube.
...
- تحسين: **ترجمة الصور** متوافقة الآن مع weibo.com (مدعومة فقط على Chrome وEdge).
...
- تحسين: يدعم الآن DeepLx اللغة العربية.
...
- تحسين: يدعم الآن Bing/Google اللغة البرتغالية (البرازيل).
...
- تم الإصلاح: مشكلة تحميل وظيفة التحويم بالماوس لخدمة الترجمة الخاطئة في ظل ظروف معينة.
...
- تحسين: عند الترجمة على **x.com**، سيتم تلقائيًا ترجمة العناوين الفرعية الثنائية للفيديوهات.
- تحسين: الفيديوهات بدون عناوين فرعية ستعرض أيقونة الترجمة وتوفر سببًا لعدم إمكانية الترجمة.

## 1.11.7 (2024-11-25)

- تمت الإضافة: يدعم الآن Bing/Google اللغة الخميرية (الكمبودية).
...
- تحسين: يتم إيقاف الترجمة النصية الغنية افتراضيًا في وضع الثنائية لتحسين جودة الترجمة.
...
- تمت الإضافة: يدعم الآن **ترجمة العناوين الفرعية** في الاجتماعات الحية التفعيل عبر "الكرة العائمة"، متاح على Zoom وGoogle Meet وMicrosoft Teams.
...
- تحسين: حل عرض العناوين الفرعية في Netflix

## 1.10.5 (2024-10-23)

- تمت الإضافة: عرض تحذير عند تطابق لغة المصدر واللغة الهدف
- تم الإصلاح: مشكلة ترجمة أحرف المسافات البيضاء في النص الغني [#2175](https://github.com/immersive-translate/immersive-translate/issues/2175)
- تحسين: تحسين وظيفة التحسين الإدخال والتحويم بالماوس داخل iframes المدمجة على صفحات الويب
...
- دعم تكوين الاستثناءات للغات والمواقع في وضع المقارنة الثنائية أو الترجمة فقط (قم بتكوينها في صفحة الإعدادات -> الإعدادات المتقدمة). على سبيل المثال: إذا كان وضع الترجمة الافتراضي لديك هو المقارنة الثنائية، ولكنك لا ترغب في أن تستخدم الصينية التقليدية أيضًا المقارنة الثنائية، فيمكنك إضافة الصينية التقليدية إلى لغات الاستثناء للمقارنة الثنائية، بحيث تستخدم الصينية التقليدية وضع الترجمة فقط للترجمة. وبالمثل، إذا كان وضع الترجمة الافتراضي لديك هو الترجمة فقط، ولكنك ترغب في أن تستخدم لغة أو موقع معين وضع المقارنة الثنائية، يمكنك أيضًا إضافة تلك اللغة أو الموقع إلى لغات الاستثناء.
- تم إصلاح مشكلة حيث تم ترجمة مربع الإدخال في واجهة الرسائل الخاصة في Tiktok بشكل غير صحيح
...
- تم إصلاح مشكلة عدم إمكانية إيقاف تشغيل اختصار الترجمة الثنائية لفيديوهات YouTube.
...
- تدعم ترجمات YouTube الثنائية الآن تقسيم الجمل الذكي (تجريبي) (فقط عند تمكين الترجمة الغامرة لترجمات YouTube يدويًا في [الإعدادات] - [ترجمات الفيديو]، والترجمات الأصلية للفيديو هي ترجمات إنجليزية تلقائية)
...
- تم إصلاح مشكلة عدم إمكانية اختيار خبراء الذكاء الاصطناعي في خدمات الذكاء الاصطناعي المخصصة.

## 1.6.4

- عند استخدام خبراء الذكاء الاصطناعي لـ "الاختيار الذكي"، يمكن تخصيص خبراء الذكاء الاصطناعي المختلفين لمواقع مختلفة. يمكن تعيين ذلك في [الإعدادات] -> [خبراء الذكاء الاصطناعي] -> [أدخل أي خبير].
...
- قائمة نماذج AI المخصصة تدعم صيغة `-all`، والتي يمكنها حذف جميع النماذج المسبقة.
...
- تم إصلاح المشكلة التي كانت تجعل Prompts المخصصة غير فعالة عند استخدامها بكثرة.
...
- تدعم خيارات اللوحة المزيد من [إدخال الترجمة النصية](https://app.immersivetranslate.com/text/)
...
- **تحسين ترجمة اليابانية:** تحسين إضافي لترجمة OpenAI اليابانية لتحسين الدقة والطلاقة.
...
- تحسين: عند استخدام تمرير الماوس، المشكلة حيث فقدان التركيز على الصفحة ثم إعادة التشغيل يصبح غير فعال.
- تم الإصلاح: المشكلة حيث لا يزال التخزين المؤقت موجودًا بعد تعديل الموجه/النموذج في OpenAI.
...
- تم الإصلاح: حل المشكلة حيث لم يتم ترجمة العناوين في صفحة قائمة jstor [#1268](https://github.com/immersive-translate/immersive-translate/issues/1268).
- تم الإصلاح: إصلاح المشكلة حيث اختفى جزء من المحتوى فقط على Hacknews [#1264](https://github.com/immersive-translate/immersive-translate/issues/1264).
...
- تم إصلاح المشكلة حيث لم تستجب الترجمات في الوقت المناسب عند التمرير إلى منتصف الصفحة في بعض الحالات.
- تم إصلاح الخطأ حيث تسبب تبديل الترجمات على بعض مواقع الفيديو في عرض الترجمة بشكل متكرر.
- تم إصلاح المشكلة حيث استمر تمرير الماوس في الترجمة دون الضغط على مفتاح الاختصار في بعض الحالات.
...
- تم الإصلاح [عند تشغيل ترجمة الويب مؤقتًا لفترة طويلة، النقر على اللوحة [ترجمة دائمًا هذا الموقع] لا يلغي الترجمة الدائمة #1172](https://github.com/immersive-translate/immersive-translate/issues/1172)

## 0.12.7

- إضافة ترجمات ثنائية لدعم منصات [TED](https://www.ted.com)، [Frontend Masters](https://frontendmasters.com/)، [edx](https://www.edx.org/)، [CodeWithChris](https://www.edx.org/)، [Skillshare](https://www.ted.com) https://learn.codewithchris.com/enrollments)، [Skillshare](https://www.skillshare.com/) منصات
...
- إصلاح مشكلة الترجمة في صندوق إدخال Reddit
...
- إصلاح الحالة حيث يتم ترجمة محتوى الإضافات الخارجية في بعض السيناريوهات
...
- تم حل المشكلة حيث لم تتمكن بعض المنصات من التعرف على ما إذا كان الماوس مدعومًا أم لا
...
- ميزة: إضافة `<all>` للغات التي تُترجم دائمًا، لذا يمكنك الآن استخدامها لترجمة جميع اللغات باستثناء اللغة المستهدفة، وعدم ترجمة اللغات
...
- إصلاح
  ...
  أرشيف Annas لم يتمكن المحتوى الرئيسي للصفحة من الترجمة
