...
- تم التحسين: أصبحت طلبات ترجمة الترجمة المرئية عبر الإنترنت خاضعة الآن لحد عدد الفقرات في خدمة الترجمة.
- تم التحسين: تحسين رسائل النوافذ المنبثقة لأخطاء 403 / Cloudflare.
- تمت الإضافة: إضافة مفتاح تبديل ذاكرة التخزين المؤقت للترجمة إلى المزيد من الميزات في النافذة المنبثقة.
- تمت الإضافة: إضافة مفاتيح تبديل مستقلة لكل موقع لترجمة الترجمة المرئية.
...
- تمت الإضافة: دعم ترجمة موقع القصص المصورة toptoon.com.
...
- تمت الإضافة: دعم خدمة الترجمة plamo.
- تم التحسين: تحسين علامات التخطيط للغات RTL في وضع الترجمة فقط.
- تم التحسين: تحسين مطابقة بعض صيغ الجمع للمصطلحات الإنجليزية لتقليل حالات تفويت المطابقات.
- تم الإصلاح: إصلاح مشكلة اهتزاز الترجمة النصية أثناء ترجمة التسميات التوضيحية في Teams.
- تم الإصلاح: إصلاح مشكلة عدم تمكن [ترجمة تحديد النص] من التقاط النص بشكل صحيح في سيناريوهات ShadowRoot.
