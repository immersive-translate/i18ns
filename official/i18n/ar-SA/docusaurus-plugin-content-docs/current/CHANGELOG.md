...
- تم الإصلاح: مشكلة في عدم عمل الترجمة عند التمرير في وضع "الترجمة أولاً، النص الأصلي يتبع".
...
- تمت الإضافة: عند انتماء النص المترجم والنص الأصلي إلى نفس نظام الكتابة، يتم عرض الترجمة باستخدام نمط متخصص.
...
- تمت الإضافة: عرض تحذير عندما تكون لغة المصدر ولغة الهدف متطابقتين
...
- تمت الإضافة: ترجمة الصور (نسخة Beta)
...
- تم التحسين: معالجة المشاكل التي قد لا تعمل فيها زر الترجمة أثناء ترجمة PDF
...
- دعم طلب header anthropic-dangerous-direct-browser-access لـ Claude Anthropic API
...
- تدعم ترجمات YouTube الثنائية الآن تقسيم الجمل الذكي (نسخة Beta) (فقط عند تمكين الترجمة الغامرة لترجمات YouTube يدويًا في [الإعدادات] - [ترجمات الفيديو]، وتكون ترجمات الفيديو الأصلية ترجمات إنجليزية تلقائية)
- تمت إضافة خدمة الترجمة Tencent [【Hunyuan Large Model】](https://immersivetranslate.com/docs/services/tencent-hunyuan/)

## 1.6.5

- إصلاح مشاكل تخطيط النص لترجمات الكوميك للغات ذات النص اللاتيني.
...
- عند استخدام خبراء الذكاء الاصطناعي لـ "الاختيار الذكي"، يمكن تخصيص خبراء الذكاء الاصطناعي المختلفين لمواقع مختلفة. يمكن ضبط ذلك في [الإعدادات] -> [خبراء الذكاء الاصطناعي] -> [أدخل أي خبير].
...
- دعم منصة النموذج الكبير Baidu Qianfan، ومنصة النموذج الكبير Alibaba Bailian، ومنصة النموذج الكبير DeepSeek.
...
- يدعم أعضاء Pro خدمات الترجمة Claude و Gemini (Beta) الجاهزة للاستخدام
...
- تم إصلاح المشكلة التي كانت تؤدي إلى تجاوز Prompt الخبير العام لـ Prompt الخبير AI المحدد [#1692](https://github.com/immersive-translate/immersive-translate/issues/1692)
...
- ترجمات Udemy الثنائية اللغة متوافقة مع العرض على الهاتف المحمول
...
- تعرض اللوحة الآن اللغة الأصلية في الكشف التلقائي.
- تم تعديل وصف الاختصار للوحة الهاتف المحمول.
...
- تم إصلاح مشكلة ترقية إصدار ملحق Safari دائمًا ما تطالب بصفحة نجاح التثبيت
...
- إضافة وصول سريع لترجمات الفيديو لمنصات إضافية.
...
- **دعم الجوال لترجمة الفقرات المحددة:** يدعم الإصدار المحمول الآن ترجمة الفقرات المحددة وأضيفت مجموعة متنوعة من العمليات المختصرة، بما في ذلك السحب لليسار، السحب لليمين، النقر المزدوج، النقر الثلاثي، وإيماءات اللمس المتعددة. هذه ليست مفعلة افتراضيًا وتتطلب من المستخدم اختيار الإيماءة المحفزة في صفحة الإعدادات تحت [تحريك الماوس].
...
- **إصلاحات الأخطاء**:
  ...
  - تم إصلاح مشكلة فشل ترجمة الماوس عند فقدان الصفحة للتركيز.
...
- تم إصلاح المشكلة التي استمرت فيها الترجمة عند تمرير الماوس دون الضغط على مفتاح الاختصار في بعض الحالات.
...
- إصلاح مشكلة النقر المتذبذب في لوحة الإجراءات العائمة لصفحة Firefox.
...
- عند تشغيل الترجمات الثنائية في اللوحة، سيتم تحديث الصفحة تلقائيًا أولاً (لعرض الترجمات الثنائية بدقة أكبر)، وبعض المواقع لا تزال تتطلب من المستخدمين النقر يدويًا على زر "CC" في الموقع لتشغيل الترجمات.
...
- تم توفير دعم الترجمة الثنائية للمزيد من منصات الفيديو، والتي تدعم الآن: [Youtube](https://www.youtube.com/)، [Netflix](https://www.netflix.com)، [Udemy](https://www.udemy.com/)، [Khanacademy] (https://www\.khanacademy.org/)، [Coursera] (https://www\.coursera.org/)، [Vimeo] (https://vimeo.com/)، [Nebula] (https://nebula.tv)، [Bloomberg](https://www.bloomberg.com)، [Bilibili](https://www.bilibili.com/)، إلخ. (يرجى ملاحظة أنه بسبب القيود التقنية، تحتاج بعض المواقع إلى تحديث الصفحة بعد تشغيل الترجمات الثنائية لأول مرة أو الانتظار حتى تكتمل الترجمة لعرض الترجمات الثنائية).
...
- تحسين سياق الترجمة لملفات الترجمة في OpenAI
...
- أخيرًا يدعم PDF تصدير النسخ الثنائية اللغة! يمكنك النقر على زر [حفظ] لتصدير ملف PDF مترجم ثنائي اللغة.
...
- دعم نتائج الترجمة المحسنة للإدخال ctrl+z للتراجع
...
- يمكن الآن للوحة الإضافات الإشارة إلى الصفحات غير المدعومة (مثل الصفحات التي لا تحتوي على أذونات والصفحات غير HTML)
...
- إصلاح مشكلة: عدم وجود صور في الكتب الإلكترونية الثنائية اللغة بعد التصدير
...
- إصلاح: عنصر Block Element للعلامات غير المعروفة
...
- تحسين السرعة، بإضافة minLength إلى 50 لاكتشاف اللغة.
...
- إصلاح ترجمة niu لـ userscript
- إصلاح ترجمة xhtml

## 0.2.40

- إصلاح عرض ميزة بيتا
- إصلاح إعدادات النوافذ المنبثقة في صفحة علامة تبويب جديدة
...
- تحسين واجهة المستخدم المنبثقة
- تحسين نصائح userscript السيئة
...
- إصلاح اختيار النوافذ المنبثقة لخدمة غير مكونة، الانتقال إلى صفحة الخيارات.
...
- دعم ترجمة shadowroot. على سبيل المثال:
  ...
  منطقة المحادثة.
- التحقق أيضًا من قاعدة المزامنة على النوافذ المنبثقة
...
- إصلاح تغيير خدمة الترجمة المنبثقة لا يعمل
