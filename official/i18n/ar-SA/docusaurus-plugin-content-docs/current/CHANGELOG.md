...
- تمت الإضافة: إدارة القاموس AI (يدعم فقط خدمات الترجمة AI)
...
- تم التحسين: الفيديوهات بدون ترجمات ستعرض أيقونة الترجمة وتوفر سبب عدم إمكانية الترجمة.
...
- تم نقل خيار العرض المقارن ثنائي اللغة/الترجمة فقط إلى الإعدادات العامة.
- بشكل افتراضي، سيتذكر النظام الوضع الذي تم تغييره بالنقر على الأيقونة في اللوحة للعرض المقارن ثنائي اللغة أو العرض الترجمة فقط. للتبديل مؤقتًا، انقر على "المزيد" -> "التبديل إلى العرض الترجمة فقط" في اللوحة.
- بشكل افتراضي، سيتم استخدام وضع الترجمة فقط عند الترجمة من الصينية المبسطة إلى الصينية التقليدية والعكس، بدلاً من وضع العرض المقارن ثنائي اللغة.
- تم إصلاح بعض الأخطاء.

## 1.9.1 (2024-09-03)

- دعم تكوين الاستثناءات للغات والمواقع في وضع العرض المقارن ثنائي اللغة أو الترجمة فقط (قم بالتكوين في صفحة الإعدادات -> الإعدادات المتقدمة). على سبيل المثال: إذا كان وضع الترجمة الافتراضي لديك هو العرض المقارن ثنائي اللغة، ولكنك لا ترغب في استخدام الصينية التقليدية أيضًا للعرض المقارن ثنائي اللغة، فيمكنك إضافة الصينية التقليدية إلى لغات الاستثناء للعرض المقارن ثنائي اللغة، بحيث تستخدم الصينية التقليدية وضع الترجمة فقط للترجمة. وبالمثل، إذا كان وضع الترجمة الافتراضي لديك هو الترجمة فقط، ولكنك ترغب في استخدام لغة أو موقع معين لوضع العرض المقارن ثنائي اللغة، يمكنك أيضًا إضافة تلك اللغة أو الموقع إلى لغات الاستثناء.
...
- يمكنك الآن ترجمة النص في صناديق الإدخال بالنقر الأيمن: حدد أي نص في صندوق إدخال على صفحة ويب، انقر بزر الماوس الأيمن لاختيار الترجمة، وستقوم الترجمة الغامرة بترجمة النص المحدد تلقائيًا إلى لغة الهدف لصندوق الإدخال، مما يجعل من السهل ترجمة النص الأصلي في صناديق الإدخال إلى لغات أخرى بسرعة.
...
- توفير المزيد من أوراق arXiv مع تحسين تخطيط الترجمة ثنائية اللغة
...
- الآن تدعم العناوين الفرعية ثنائية اللغة لـ YouTube تقسيم الجمل الذكي (نسخة تجريبية) (فقط عند تفعيل الترجمة الغامرة للعناوين الفرعية لـ YouTube يدويًا في [الإعدادات] - [العناوين الفرعية للفيديو]، والعناوين الفرعية للفيديو الأصلي هي عناوين فرعية إنجليزية تم إنشاؤها تلقائيًا)
- تمت الإضافة: خدمة الترجمة Tencent [【نموذج Hunyuan الكبير】](https://immersivetranslate.com/docs/services/tencent-hunyuan/)

## 1.6.5

- إصلاح مشاكل تنسيق النص في ترجمات القصص المصورة للغات ذات النصوص اللاتينية.
...
- تم إصلاح المشكلة التي لا تظهر فيها الترجمة في YouTube في وضع "الترجمة فقط".
...
- قائمة نماذج الذكاء الاصطناعي المخصصة تدعم صيغة `-all`، والتي يمكن أن تحذف جميع النماذج المسبقة.
...
- تم إصلاح المشكلة التي لم تتمكن فيها كرة الترجمة السريعة من الترجمة تحت iOS 18.
- تم إصلاح المشكلة التي كانت فيها المطالبات المخصصة غير فعالة عند استخدام الكثير منها.

## 1.6.1

- دعم منصة نموذج Baidu Qianfan الكبيرة، منصة نموذج Alibaba Bailian الكبيرة، منصة نموذج DeepSeek الكبيرة.
- تم إصلاح المشكلة التي كانت فيها تعديلات اللغة المستهدفة والإعدادات الأخرى في لوحة النوافذ المنبثقة تعيد التعيين عند النقر على كرة الترجمة.
...
- تم إصلاح المشكلة التي كانت فيها تغييرات المطالبة العامة للخبير تتجاوز المطالبة المحددة لخبير الذكاء الاصطناعي [#1692](https://github.com/immersive-translate/immersive-translate/issues/1692)
...
- دعم خدمات الترجمة بالذكاء الاصطناعي لتعيين [خبير الذكاء الاصطناعي] لتحديد استراتيجية الترجمة، حاليًا ميزة بيتا، والتي يمكن تمكينها في [إعدادات المطور](https://dash.immersivetranslate.com/#developer) بعد تمكين بيتا، ويمكن رؤية قائمة [خبير الذكاء الاصطناعي] بعد التحديث.
...
- تم إصلاح المشكلة التي لم يكن يمكن فيها تنزيل الترجمة الصينية في YouTube.
...
- تم إصلاح المشكلة التي كانت فيها YouTube Shorts بدون ترجمة تعرض دائمًا الترجمة من الفيديو السابق [#1655](https://github.com/immersive-translate/immersive-translate/issues/1655)
- تم إصلاح المشكلة التي كانت فيها الترجمة الثنائية في YouTube لا يمكن تعديلها لأعلى ولأسفل في وضع ملء الشاشة [#1654](https://github.com/immersive-translate/immersive-translate/issues/1654)
- دعم [VK Video](https://vk.com/video) للترجمة الثنائية
...
- تم إصلاح المشكلة التي كانت فيها التغييرات المتكررة للون الترجمة من خلال لوحة الألوان غير فعالة [#1628](https://github.com/immersive-translate/immersive-translate/issues/1628)
...
- الآن تستوعب صفحة الإعدادات تعديلات [أنماط الترجمة في YouTube](https://dash.immersivetranslate.com/#subtitle).
- تم إجراء تحسينات لمعالجة المشكلة التي لم تكن فيها الترجمة الثنائية الغامرة تظهر عندما يضبط المستخدمون لغة الترجمة إلى الصينية على موقع YouTube.
...
- تم إصلاح المشكلة التي كانت فيها الترجمة تفشل عند تبديل كلمات المطالبات المخصصة لـ OpenAI تحت زر الاختبار
- تم إصلاح مشكلة عدم عرض أيقونة اختصار الترجمة في YouTube
- تحسين التعرف على لغة الامتداد

## 1.4.6

- تم إصلاح المشكلة التي كانت فيها كلمات المطالبات المخصصة غير فعالة
- إضافة خيارات 50%، 150% لحجم خط الترجمة في YouTube

## 1.4.5

- تم إصلاح المشكلة التي كانت فيها تغييرات أنماط الترجمة في YouTube غير محفوظة
...
- تعديل مفتاح التبديل في اللوحة لعرض زر الترجمة فقط ليؤثر فقط على الصفحة الحالية
...
- تم إصلاح دعم تطبيق iOS الغامر لتشغيل YouTube في وضع ملء الشاشة.
...
- **تجربة ترجمة غامرة:** لتحسين التكيف مع عادات المستخدم، قمنا بنقل اختصار الترجمات الثنائية في وضع ملء الشاشة على منصة YouTube إلى الجانب الأيسر.
...
- **تحسين واجهة المستخدم**: إعادة تصميم واجهة المستخدم لمطالبات خطأ ترجمة الصفحة لتكون أسهل في الفهم. عندما تكون هناك العديد من الأخطاء، ستظهر نافذة منبثقة لتنبيه المستخدم بنشاط.
...
- تم الإصلاح: حل المشكلة التي لم يتم فيها ترجمة العناوين في صفحة قائمة jstor [#1268](https://github.com/immersive-translate/immersive-translate/issues/1268).
...
- عند تشغيل ترجمات ثنائية اللغة في اللوحة، سيتم تحديث الصفحة تلقائيًا أولاً (لعرض الترجمات الثنائية اللغة بدقة أكبر)، وبعض المواقع لا تزال تتطلب من المستخدمين النقر يدويًا على زر "CC" في الموقع لتشغيل الترجمات.
- تحسين Grease Monkey، اكتشاف لغة Safari
- يوفر وصول سريع إلى النسخ الثنائية اللغة لجميع الأوراق على موقع أوراق [Arxiv](https://arxiv.org/abs/1910.06709).
...
- إضافة بوابة ترجمة PDF سريعة إلى الجانب الأيمن من موقع أوراق [Arxiv](https://arxiv.org/abs/1910.06709)، والتي تذهب إلى صفحة HTML نظيفة (مدعومة فقط من قبل بعض الأوراق، حيث يتطلب ذلك من المؤلفين الأصليين تقديم الشيفرة المصدرية، لذا فإن حوالي 50% من الأوراق ستظهر هذه البوابة)
- يمكن الآن للصفحات PDF عبر الإنترنت بدون امتداد .pdf القفز مباشرة إلى صفحة ترجمة PDF بالنقر على الكرة العائمة في الصفحة.
...
- إصلاح مشكلة تعارض الترجمة الفرعية في يوتيوب مع إضافة الترجمة الثنائية (لا يتم تفعيل ترجمة الترجمة الفرعية في يوتيوب عند اكتشاف إضافة الترجمة الثنائية لتجنب التعارض)
...
- دعم مثالي لمقاطع فيديو يوتيوب مع ترجمات ثنائية 🎉.
...
- تحسين اكتشاف اللغة
- ميزات تجريبية: واجهة برمجة التطبيقات المخصصة (تمكين النسخة التجريبية في إعدادات المطور)
- دعم ترجمة AliCloud
- إصلاح بعض الأخطاء
...
- يدعم PDF أخيرًا تصدير النسخ الثنائية! يمكنك النقر على زر [حفظ] لتصدير ملف PDF مترجم ثنائي اللغة.
...
- يدعم تمكين/تعطيل ترجمة الترجمة الفرعية في يوتيوب لمنع التعارض مع الإضافات الأخرى ذات الصلة.
...
- تم إصلاح مشكلة الشاشة البيضاء بعد ترجمة المواقع مع hydration، مثل Next.js
...
- ميزة: إضافة موضوع جديد Solid Border (إضافة موضوع جديد، إطار خط صلب)
...
- إصلاح: مشكلة التحقق من خدمة الترجمة على شبكة فايرفوكس المحمول.
...
- إصلاح stay.app API للبرنامج النصي للمستخدم
