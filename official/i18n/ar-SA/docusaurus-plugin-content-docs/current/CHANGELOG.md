...
- تمت الإضافة: دعم **ترجمة العناوين الفرعية** في الاجتماعات الفورية الآن عبر "الكرة العائمة"، متاح على Zoom و Google Meet و Microsoft Teams.
...
- تم إصلاح: مشكلة في اختصارات **Enhanced input** التي لم تكن تعمل
- تم تحسين: تقليل حجم حزمة التثبيت
- تم تحسين: حل عرض ترجمات Netflix

## 1.10.5 (2024-10-23)

- تمت الإضافة: عرض تحذير عندما تكون لغة المصدر واللغة الهدف متطابقتين
- تم إصلاح: مشكلة ترجمة المسافات في النصوص الغنية [#2175](https://github.com/immersive-translate/immersive-translate/issues/2175)
- تم تحسين: تحسين الإدخال ووظيفة التحويم بالماوس داخل iframes المدمجة في صفحات الويب
...
- تم إصلاح: مشكلة ترجمة النصوص الغنية [#2163](https://github.com/immersive-translate/immersive-translate/issues/2163)
- تم تحسين: معالجة المشاكل التي قد تؤدي إلى عدم عمل زر الترجمة أثناء ترجمة PDF
- تم تحسين: تحسين عرض الصيغ المترجمة
- تم تحسين: قائمة اختيار اللغة

## 1.9.8 (2024-09-28)

- تمت الإضافة: خدمة الترجمة "Zhipu BigModel"
- تمت الإزالة: نموذج "SiliconCloud" qwen1.5-7B-chat (بسبب التوقف الرسمي)
- تم إصلاح: حل مشكلة التوافق مع تسجيل الدخول في إضافة Safari على macOS 15

## 1.9.7 (2024-09-20)

- دعم محسّن للإدخال في حقول Baidu وGmail وغيرها
- دعم لرأس طلب anthropic-dangerous-direct-browser-access لواجهة Claude Anthropic API
- دعم لتنزيل الترجمات من فيديوهات Hulu وBloomberg وDomestika
...
- تم إصلاح مشكلة في ترجمة صندوق الإدخال في واجهة الرسائل الخاصة في Tiktok بشكل غير صحيح
...
- يدعم Google Meet الآن الترجمات الثنائية للاجتماعات الحية: الآن، يمكنك الاستمتاع بميزة الترجمات الثنائية في اجتماعات Google Meet. ببساطة افتح رابط الاجتماع، فعّل الترجمات الثنائية في لوحة الترجمة الغامرة، ثم قم بتحديث الصفحة لتجربتها.
...
- تدعم ملفات Epub الآن ترجمة النصوص الغنية (أي الحفاظ على تنسيق النص الأصلي لكل فقرة، مثل الروابط، الخط العريض، إلخ.)
...
- تدعم خدمات الترجمة DeepL وMicrosoft Translate وGoogle Translate وOpenAI وClaude وGemini وغيرها الترجمة مع الاحتفاظ بتنسيق النص الأصلي (مثل الروابط، الخط العريض، إلخ.)
...
- تمت إضافة دعم لمواقع جديدة في ترجمة القصص المصورة:
...
- تمت إضافة دعم لمواقع جديدة لترجمة القصص المصورة:
  - [Mangabuddy](https://mangabuddy.com/)
  - [Hitomi](https://hitomi.la)
  - [Yamibo](https://www.yamibo.com)
  - [Copymanga](https://www.copymanga.site/)
- تدعم ترجمات YouTube الثنائية الآن تقسيم الجمل الذكي (نسخة Beta) (فقط عند تفعيل الترجمة الغامرة لترجمات YouTube يدويًا في [الإعدادات] - [ترجمات الفيديو]، وكانت ترجمات الفيديو الأصلية ترجمات إنجليزية تلقائية)
- تمت إضافة خدمة الترجمة Tencent [【Hunyuan Large Model】](https://immersivetranslate.com/docs/services/tencent-hunyuan/)

## 1.6.5

- إصلاح مشاكل تخطيط النص في ترجمات القصص المصورة للغات المكتوبة بالحروف اللاتينية.
...
- ميزة جديدة: ترجمة المانجا (Beta)، في مواقع المانجا المدعومة، سيظهر زر ترجمة المانجا أسفل كرة الترجمة العائمة السريعة لصفحة الويب. النقر عليه سيقوم بتفعيل ترجمة المانجا. هذه الميزة متاحة لأعضاء Pro (500 صفحة شهريًا، يمكن شراء حزم إضافية)، حاليًا تدعم المواقع التالية:
...
- دعم خدمات الترجمة بالذكاء الاصطناعي لتعيين [AI Expert] لتحديد استراتيجية الترجمة، حاليًا ميزة Beta، والتي يمكن تفعيلها في [إعدادات المطور](https://dash.immersivetranslate.com/#developer) بعد تفعيل Beta، ويمكن رؤية قائمة [AI Expert] بعد التحديث.
...
- دعم إعداد الترجمة الثنائية/الأصلية وعرض الترجمة في الترجمة للفيديو
...
- **تجربة الترجمة الغامرة:** لتكييف أفضل مع عادات المستخدم، قمنا بنقل اختصار الترجمات الثنائية في وضع الشاشة الكاملة على منصة يوتيوب إلى الجانب الأيسر.
...
- تم إصلاح المشكلة التي كانت تتسبب في فشل الترجمة عند تمرير الماوس عندما تفقد الصفحة التركيز.
- تم إصلاح المشكلة التي كانت تتسبب في عدم ترجمة أقل من 3 أحرف في ميزة تحسين صندوق الإدخال.
- تم إصلاح المشكلة التي كانت تتسبب في عدم ترجمة بعض الدلائل أثناء إنتاج Epubs ثنائية اللغة.
...
- تحسين: عند استخدام تمرير الماوس، تم حل المشكلة التي كانت تتسبب في فقدان التركيز على الصفحة ثم إعادة التشغيل تصبح غير فعالة.
- تم إصلاح: المشكلة التي كانت تتسبب في بقاء ذاكرة التخزين المؤقت بعد تعديل الموجه/النموذج في OpenAI.
...
- تم إصلاح: حل المشكلة التي كانت تتسبب في عدم ترجمة العناوين على صفحة قائمة jstor [#1268](https://github.com/immersive-translate/immersive-translate/issues/1268).
- تم إصلاح: تم إصلاح المشكلة التي كانت تتسبب في اختفاء جزء من المحتوى على Hacknews [#1264](https://github.com/immersive-translate/immersive-translate/issues/1264).

## 0.12.11

- تمت إضافة دعم الترجمة الثنائية اللغة لمنصات [HBO Max](https://play.max.com/)، [BBC](https://www.bbc.com/)، [Disney+](https://www.disneyplus.com)، [ARD Mediathek](https://www.ardmediathek.de/)، [ITV](https://www.itv.com/)، و [Domestika](https://www.domestika.org).

## 0.12.10

- تم إصلاح مشكلة التفويض لنطاق Gemini تحت سكربت Tampermonkey.
- دعم الترجمة الفورية للترجمات في Twitter Space.
- بالنسبة للإصدارات القديمة من سكربت Tampermonkey، تم الآن إضافة تنبيه تحديث في صفحة الإعدادات.

## 0.12.9

- تمت إضافة دعم لترجمة Gemini.
- تم إصلاح المشكلة التي كانت تتسبب في عدم استجابة الترجمات في الوقت المناسب عند التمرير إلى منتصف الصفحة في بعض الحالات.
- تم إصلاح الخطأ الذي كان يتسبب في تكرار عرض الترجمة عند تبديل الترجمات على بعض مواقع الفيديو.
- تم إصلاح المشكلة التي كانت تتسبب في استمرار الترجمة عند تمرير الماوس دون الضغط على مفتاح الاختصار في بعض الحالات.
- على macOS، تم تحسين اسم العرض لمفتاح الاختصار للوحة.

## 0.12.8

- إصلاح عدم عرض ترجمات الفيديو الأصلية عند تعيين "الموقع الحالي لا يترجم أبدًا".
- إصلاح التعارض مع بعض الإضافات التي تتسبب في إعادة تحميل الصفحة بلا نهاية.
...
- تمت إضافة ترجمات ثنائية اللغة لدعم منصات [TED](https://www.ted.com)، [Frontend Masters](https://frontendmasters.com/)، [edx](https://www.edx.org/)، [CodeWithChris](https://www.edx.org/)، [Skillshare](https://www.ted.com) https://learn.codewithchris.com/enrollments)، [Skillshare](https://www.skillshare.com/) Platforms
- الآن يتم إخفاء الكرة العائمة افتراضيًا عند تشغيل الفيديو بملء الشاشة.
- إصلاح مشكلة النقر المتذبذب للوحة العمل العائمة في صفحة Firefox.
...
- ميزة تحسين البحث (عرض نتائج البحث ثنائية اللغة في بعض صفحات بحث Google) الآن غير مفعلة افتراضيًا وسيتم إزالتها في الإصدار القادم.
...
- عند تشغيل الترجمة الثنائية اللغة في اللوحة، سيتم تحديث الصفحة تلقائيًا أولاً (لعرض الترجمات الثنائية اللغة بدقة أكبر)، وبعض المواقع لا تزال تتطلب من المستخدمين النقر يدويًا على زر "CC" في الموقع لتشغيل الترجمات.
...
- تم توفير دعم الترجمة الثنائية اللغة لمزيد من منصات الفيديو، والتي تدعم الآن: [Youtube](https://www.youtube.com/)، [Netflix](https://www.netflix.com)، [Udemy](https://www.udemy.com/)، [Khanacademy] (https://www\.khanacademy.org/)، [Coursera] (https://www\.coursera.org/)، [Vimeo] (https://vimeo.com/)، [Nebula] (https://nebula.tv)، [Bloomberg](https://www.bloomberg.com)، [Bilibili](https://www.bilibili.com/)، إلخ. (يرجى ملاحظة أنه بسبب القيود التقنية، تحتاج بعض المواقع إلى تحديث الصفحة بعد تشغيل الترجمات الثنائية اللغة لأول مرة أو الانتظار حتى تكتمل الترجمة لعرض الترجمات الثنائية اللغة). (يرجى ملاحظة أنه بسبب القيود التقنية، تحتاج بعض المواقع إلى تحديث الصفحة بعد فتح الترجمات الثنائية اللغة لأول مرة، أو تحتاج إلى الانتظار حتى تكتمل الترجمة لعرض الترجمات الثنائية اللغة)
...
- إضافة بوابة ترجمة سريعة لملفات PDF إلى الجانب الأيمن من موقع أوراق [Arxiv](https://arxiv.org/abs/1910.06709)، والتي تذهب إلى صفحة HTML نظيفة (مدعومة فقط من بعض الأوراق، حيث يتطلب الأمر من المؤلفين الأصليين تقديم الشيفرة المصدرية، لذا فإن حوالي 50% من الأوراق ستظهر هذه البوابة)
...
- تم حل المشكلة التي كانت تتسبب في عدم قدرة بعض المنصات على التعرف على ما إذا كان الماوس مدعومًا أم لا
...
- تقليل طول الموجهات في OpenAI من 90 إلى 40، مما يوفر المزيد من حركة المرور.
...
- إصلاح مشكلة التمرير التلقائي للقراءة عبر الإنترنت للكتب الإلكترونية epub
...
- واجهة المستخدم: استخدام نموذج تحديد بدلاً من مربع إدخال النص في حقل إعدادات OpenAI.
...
- إصلاح: postMessage عند كسر الصفحة الأولية لبعض المواقع، الآن سنفعل ذلك فقط عندما نترجم الصفحات حقًا
...
- Fix: استخدام ذاكرة عالية لـ userscripts والإضافات (عن طريق إزالة opencc zh-CN إلى zh-TW، بدلاً من ذلك مع Google translate)
...
- Fix: نمط منتدى Steam
- Fix: النمط العالمي لم يتغير بعد إنشاء العناصر الديناميكية
...
- Fix: عنصر Block Element للعلامات غير المعروفة
...
- دعم تمكين ميزة beta في لوحة المطور
...
- Fix: stay.app userscript API المتصفح
...
- Fix: علامة تسليط الضوء على ارتفاع السطر
...
- Fix: تغيير URL العميل، الاحتفاظ تلقائيًا بحالة الترجمة.
...
- إصلاح النسخة المدمجة للجوال من reddit
