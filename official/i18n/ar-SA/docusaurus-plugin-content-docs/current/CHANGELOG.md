...
- تمت إضافة دعم العناوين الفرعية الثنائية اللغة لمنصات [HBO Max](https://play.max.com/)، [BBC](https://www.bbc.com/)، [Disney+](https://www.disneyplus.com)، [ARD Mediathek](https://www.ardmediathek.de/)، [ITV](https://www.itv.com/)، و[Domestika](https://www.domestika.org).
...
- إصلاح مشكلة تعارض الترجمة في يوتيوب مع إضافة الترجمة المزدوجة (لا يتم تفعيل ترجمة الترجمة التفاعلية ليوتيوب عند اكتشاف إضافة الترجمة المزدوجة لتجنب التعارض)
...
- تحسين: تم تعديل الحد الأدنى لعدد الأحرف في الفقرة التي تثير الترجمة إلى 4 أحرف كحد أدنى لتقليل الالتباس، مع استخدام ميزات أخرى لتجنب ترجمة مناطق التنقل والنهاية في الموقع.
- إصلاح: تفاصيل Github لا تترجم بعد التوسيع.

## 0.5.14

- إصلاح المشكلة التي تصبح فيها الصور على بعض صفحات الويب: أكبر بعد النسخ
- إصلاح: قسم التعليقات في medium لا يترجم
- تم إصلاح المشكلة التي كانت فيها الصور على بعض الصفحات: تم نسخها بشكل غير صحيح
...
- إصلاح المشكلة التي: إعداد مؤقت لمدة ترجمة الموقع لا يسري.
...
- واجهة المستخدم: استخدام نموذج تحديد بدلاً من مربع إدخال نص لإعدادات OpenAI.
...
- أفضل: دعم Deepl Free
- إصلاح: استخدام ذاكرة عالية للبرامج النصية والإضافات (عن طريق إزالة opencc zh-CN إلى zh-TW، بدلاً من Google translate)
...
- إصلاح الترجمة الأساسية لملفات PDF
...
- إصلاح API متصفح البرنامج النصي للمستخدم stay.app
...
- إصلاح مسافة ارتفاع السطر في ملفات PDF
...
- دعم تخزين النتيجة مؤقتًا لـ `userscript`
