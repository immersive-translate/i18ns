...
- تمت الإضافة: يدعم متصفح Android الترجمة المجانية للصور. 【قيد الانتظار، يجب انتظار إصدار المتصفح】
- تمت الإضافة: يدعم Gemini اللغة البرتغالية (البرازيل).
- تمت الإضافة: خدمات الترجمة Grok, Ollama, Groq, Azure-OpenAI.
- تحسين: تحسين دقة التعرف التلقائي على لغة المحتوى المترجم.
- تحسين: [الترجمة المجانية للصور] تدعم التنسيق للغات من اليمين إلى اليسار.
- تحسين: التوافق مع النماذج مثل o1, o3 التي لا تدعم دور النظام (لن يتم تمرير معلمة دور النظام عندما يكون تكوين System Prompt فارغًا).
- تم الإصلاح: مشكلة ترجمة الترجمة الفورية في Google Meet و Microsoft Teams.
- تم الإصلاح: مشكلة الترجمة في Google مع أحرف الهروب.

## 1.14.16 Release (2025-02-21)

- تمت الإضافة: يدعم Deepseek, Gemini, Claude تبديل السياق.
- تم الإصلاح: تحديث الشروط لا يرسل طلب ترجمة جديد.
- تحسين: إضافة اللغة الهنغارية إلى لغة الواجهة.
- تحسين: جودة الترجمة في Google.
- تحسين: تنسيق الصور المجانية.

## 1.14.12 Release (2025-02-19)

- تحسين: إيقاف الترجمة فورًا يفرغ قائمة الانتظار للطلبات.
- تحسين: تصفية النصوص غير النظيفة في خدمة الترجمة deepl.
- تم الإصلاح: ترجمة الشريط الجانبي غير صالحة في الإعدادات المتقدمة.
- تم الإصلاح: مشكلة عرض الترجمة المخصصة في deepseek.
...
- جديد: يدعم عضوية Pro خدمة الترجمة DeepSeek (v3).
...
- تحسين: تدعم Microsoft و Google و Tencent الآن اللغة الكانتونية.
- تحسين: يدعم BBC الآن الترجمة الفورية.

## 1.14.6 Preview (2025-02-08)

- تم الإصلاح: مشكلة عدم قدرة **Mouse Hover Translation** على ترجمة النصوص الغنية.
- تحسين: يدعم إصدار Tampermonkey الآن ترجمة الترجمة الفورية في YouTube.

## 1.14.4 Release (2025-02-07)

- تم الإصلاح: مشكلة اكتشاف اللغة غير الصحيحة في **Enhanced Input Box**.
- تم الإصلاح: مشكلة المطابقة الذكية للخبراء في خدمات الترجمة المخصصة.
- تم الإصلاح: مشكلة فشل مزامنة Google Drive في بعض المتصفحات.
- تم الإصلاح: مشكلة ترجمة التعليقات المباشرة في YouTube.
- تم الإصلاح: مشكلة تداخل الترجمة الفورية في بعض مقاطع فيديو YouTube.
...
- تحسين: تحسين تحميل الترجمة الفورية في YouTube.
...
- تحسين: **ترجمة الصور** متوافقة الآن مع weibo.com (مدعومة فقط على Chrome و Edge).
...
- تحسين: التوافق مع نموذج التفكير Gemini 2.0.
...
- تم الإصلاح: مشكلة كسر الأسطر القسري للأرقام العشرية عند ترجمة النصوص الطويلة.
...
- تم الإصلاح: مشكلة تحميل خدمة الترجمة الخاطئة في وظيفة التحويم بالماوس تحت ظروف معينة.
- تم الإصلاح: مشكلة عدم عمل الترجمة الفورية ثنائية اللغة مؤقتًا على YouTube.
...
- تحسين: عند الترجمة على **x.com**، سيتم تلقائيًا ترجمة الترجمة الفورية ثنائية اللغة للفيديوهات التي تحتوي على ترجمة.
- تحسين: الفيديوهات التي لا تحتوي على ترجمة ستعرض أيقونة الترجمة وتوفر سببًا لعدم إمكانية الترجمة.
...
- تحسين: تحسين عرض الترجمة الفورية ثنائية اللغة متعددة الأسطر على تويتر ويوتيوب.
- تحسين: يتم إيقاف الترجمة النصية الغنية افتراضيًا في وضع ثنائي اللغة لتحسين جودة الترجمة.
...
- ~~تحسين: تحسين عرض الترجمة الفورية ثنائية اللغة متعددة الأسطر على تويتر.~~
- تحسين: تحديث واجهة قائمة خدمات الترجمة المنسدلة في اللوحة.

## 1.11.1 (2024-11-05)

- تمت الإضافة: يدعم **Subtitles Translation** في الاجتماعات الفورية الآن التفعيل عبر "الكرة العائمة"، متاح على Zoom و Google Meet و Microsoft Teams.
- تم الإصلاح: مشاكل توقيت الترجمة الفورية المتزامنة على YouTube بعد مشاهدة الإعلانات.
- تم الإصلاح: مشاكل العرض في قائمة الترجمة بالنقر بزر الماوس الأيمن في Safari على MacOS 15.
...
- تحسين: حل عرض الترجمة الفورية في Netflix

## 1.10.5 (2024-10-23)

- تمت الإضافة: عرض تحذير عندما تكون لغة المصدر واللغة الهدف هي نفسها
- تم الإصلاح: مشكلة ترجمة أحرف المسافات البيضاء في النصوص الغنية [#2175](https://github.com/immersive-translate/immersive-translate/issues/2175)
- تحسين: تحسين وظيفة التحسين والإدخال بالماوس داخل iframes المدمجة على صفحات الويب

## 1.10.2 (2024-10-11)

- تمت الإضافة: ترجمة الصور (نسخة تجريبية)
- تمت الإضافة: وضع تمكين دعم الماوس بالقوة (قم بتمكين هذه الميزة فقط إذا كانت وظيفة تحويم الماوس غير متوفرة على أجهزة التابلت) **الإعدادات** -> **الإعدادات المتقدمة** -> **تمكين دعم الماوس بالقوة**
- تمت الإضافة: عرض رسالة خطأ عند فشل ترجمة ترجمات الفيديو
- تم الإصلاح: مشكلة ترجمة النصوص الغنية [#2163](https://github.com/immersive-translate/immersive-translate/issues/2163)
- تم التحسين: معالجة المشكلات التي قد لا يعمل فيها زر الترجمة أثناء ترجمة PDF
...
- تم إصلاح مشكلة عدم تزامن خبراء الذكاء الاصطناعي المخصصين
...
- بعد ضبط موضع الترجمات الثنائية على YouTube، سيتذكر النظام الموضع الجديد تلقائيًا.
...
- بسبب قيود موقع Youtube، لم يعد يدعم سكربت Tampermonkey على Chrome ترجمات Youtube الثنائية. يرجى استخدام [إصدار الإضافة](https://immersivetranslate.com/).
...
- بعد تحديد النص، ستتغير قائمة النقر بزر الماوس الأيمن إلى [ترجمة النص]، انقر عليها للانتقال تلقائيًا إلى صفحة ترجمة النصوص الغامرة
...
- زر تغذية راجعة جديد لترجمة المانجا (بعد ترجمة مانجا، انقر على زر [التغذية الراجعة] على الجانب الأيمن من الكرة العائمة لتقديم ملاحظات حول جودة الترجمة).
...
- إضافة دعم لمواقع جديدة في ترجمة الكوميك:
...
- إضافة دعم لمواقع جديدة لترجمة الكوميك:
  - [Mangabuddy](https://mangabuddy.com/)
  - [Hitomi](https://hitomi.la)
  - [Yamibo](https://www.yamibo.com)
  - [Copymanga](https://www.copymanga.site/)
- تدعم ترجمات YouTube الثنائية الآن تقسيم الجمل الذكي (نسخة تجريبية) (فقط عند تمكين الترجمة الغامرة لترجمات YouTube يدويًا في [الإعدادات] - [ترجمات الفيديو]، وكانت ترجمات الفيديو الأصلية ترجمات إنجليزية تلقائية)
- تمت إضافة خدمة الترجمة Tencent [【نموذج Hunyuan الكبير】](https://immersivetranslate.com/docs/services/tencent-hunyuan/)
...
- تم إصلاح مشكلة اختصار الترجمات الثنائية لـ YouTube حيث كان النص الإنجليزي طويلًا جدًا.
...
- **إصلاحات الأخطاء**:
  ...
  - تم إصلاح المشكلة حيث كانت ترجمة تحريك الماوس تفشل عندما تفقد الصفحة التركيز.
...
- تم الإصلاح: المشكلة التي لا يزال فيها التخزين المؤقت موجودًا بعد تعديل النموذج/النموذج في OpenAI.
...
- تم الإصلاح: حل المشكلة التي لم تُترجم فيها العناوين في صفحة قائمة jstor [#1268](https://github.com/immersive-translate/immersive-translate/issues/1268).
- تم الإصلاح: إصلاح المشكلة التي اختفى فيها جزء من المحتوى فقط على Hacknews [#1264](https://github.com/immersive-translate/immersive-translate/issues/1264).
...
- كرة التمرير على الجوال تدعم الآن عملية الضغط الطويل، والضغط القصير للترجمة، والضغط الطويل لفتح اللوحة.
...
- يمكن الآن للصفحات الإلكترونية بدون امتداد .pdf الانتقال مباشرة إلى صفحة ترجمة PDF بالنقر على كرة التمرير في الصفحة.
...
- إضافة تنبيه تحديث للإصدارات المنخفضة من Grease Monkey
...
- دعم [تمكين عضوية Pro](/pricing)، مما يسمح للمستخدمين بالاستمتاع بترجمات Deepl و OpenAI وإعدادات المزامنة السحابية.
...
- أخيرًا يدعم PDF تصدير النسخ ثنائية اللغة! يمكنك النقر على زر [حفظ] لتصدير ملف PDF ثنائي اللغة المترجم.
...
- دعم تعزيز البحث، عند التمكين، عند البحث في Google/Google News باللغة الصينية، ستظهر العمود الأيمن تلقائيًا نتائج البحث عن الكلمات المفتاحية الإنجليزية المقابلة، وهو مفعل افتراضيًا.
  - السبب: وجدنا أنه في بحث Google، يمكن أن تكون نتائج البحث عن الكلمات المفتاحية الصينية والإنجليزية مختلفة جدًا، مع تمكين تعزيز البحث المترجم الغامر، نقوم تلقائيًا بالبحث عن نفس الكلمات المفتاحية باللغة الإنجليزية لك وعرضها على الجانب الأيمن. يمكنك اختيار تعطيله إذا لم تكن بحاجة إلى الميزة.
...
- إصلاح مشكلة عدم تمكين تعزيز صندوق الإدخال عندما يتم تعيين الموقع على عدم الترجمة أبدًا.
...
- تم إصلاح المشكلة التي تتطلب تعديل اختصار تحريك الفأرة تحديث الصفحة لتفعيلها
...
- تم إصلاح مشكلة الشاشة البيضاء بعد ترجمة المواقع التي تحتوي على ترطيب، مثل Next.js

- تم إصلاح المشكلة التي تتطلب تغيير اختصار تحريك الفأرة تحديث الصفحة لتفعيلها
...
- إصلاح: خطأ في وسم الكود المتعدد.[#178](https://github.com/immersive-translate/immersive-translate/issues/178)
...
- إصلاح: ترجمة openai
- إصلاح: التحقق من الوسوم غير المعروفة داخل السطر
...
- إصلاح: عنصر حظر الوسوم غير المعروفة
- إصلاح: عنصر translate=no يتجاوز
- إصلاح: تطابق URL مع عدة \*

## 0.2.58

- ميزة: دعم لون النص المترجم المخصص، لون الإطار.
...
- إصلاح التحقق من الوسوم غير المعروفة داخل السطر/الكتلة
...
- إعادة هيكلة موضع النافذة المنبثقة.
...
- دعم تعيين عدد النصوص الأولية x للترجمة فورًا.
