...
- تم الإصلاح: مشكلة حيث لم يعمل مفتاح الاختصار لترجمة التحويم على الأجهزة التي تدعم كل من الفأرة واللمس.
- تمت الإضافة: دعم لترجمة النموذج الكبير Youdao Ziyue.
...
- تم الإصلاح: مشاكل التوافق مع وضع "الترجمة فقط" عند استخدامه مع الإضافات مثل Reader View.
...
- تم الإصلاح: مشكلة ترجمة العناوين الفرعية في Google Meet و Microsoft Teams.
...
- تم التحسين: إضافة اللغة الهنغارية لواجهة المستخدم.
...
- تم التحسين: منطق الحكم في وضع اللمس والفأرة.

## 1.14.8 Release (2025-02-10)

- تم الإصلاح: مشكلة عدم ترجمة الملفات الطويلة في PDF-Pro تلقائيًا.
- تم التحسين: Microsoft و Google و Tencent يدعمون الآن الكانتونية.
...
- جديد: ترجمة الصور المجانية متاحة الآن (مدعومة حاليًا فقط على إصدارات PC من متصفحات Chrome و Edge)، يمكن الوصول إليها عبر قائمة النقر بزر الفأرة الأيمن.
...
- تم الإصلاح: مشكلة اختفاء المحتوى بعد النقر على "عرض المزيد" في وضع الترجمة فقط على فيسبوك.
...
- تمت الإضافة: دعم **Subtitles Translation** في الاجتماعات الحية الآن للتفعيل عبر "float ball"، متاح على Zoom و Google Meet و Microsoft Teams.
- تم الإصلاح: مشاكل توقيت العناوين الفرعية المتزامنة على YouTube بعد مشاهدة الإعلانات.
- تم الإصلاح: مشاكل عرض قائمة الترجمة بالنقر بزر الفأرة الأيمن في Safari على MacOS 15.
...
- تم الإصلاح: مشكلة ترجمة حروف المسافات في النصوص الغنية [#2175](https://github.com/immersive-translate/immersive-translate/issues/2175)
- تحسين: تحسين وظيفة تعزيز الإدخال وتحويم الماوس داخل iframes المدمجة على صفحات الويب

## 1.10.2 (2024-10-11)

- تمت الإضافة: ترجمة الصور (نسخة Beta)
- تمت الإضافة: وضع **Forece Enable Mouse Support** (قم بتمكين هذه الميزة فقط إذا كانت وظيفة تحويم الماوس غير متاحة على أجهزة التابلت) **Settings** -> **Advanced Settings** -> **Forece Enable Mouse Support**
...
- دعم ترويسة الطلب anthropic-dangerous-direct-browser-access لـ Claude Anthropic API
- دعم تنزيل الترجمات من فيديوهات Hulu وBloomberg وDomestika
- دعم DeepX لترجمة النصوص الغنية
...
- بشكل افتراضي، سيتذكر النظام الوضع الذي تم تغييره بالنقر على الأيقونة في اللوحة للمقارنة الثنائية أو عرض الترجمة فقط. للتبديل مؤقتًا، انقر على "More" -> "Switch to translation-only display" في اللوحة.
...
- تم الإصلاح: مشكلة في ترجمة القصص المصورة على Read Comic Online
- تم الإصلاح: مشكلة في [الإعدادات المتقدمة -> الحد الأدنى لعدد الأحرف المطلوبة لترجمة فقرة] التي لم تكن تعمل في بعض الحالات
...
- بعد تعديل موضع ترجمات YouTube الثنائية، سيتذكر النظام الموضع الجديد تلقائيًا.
...
- يمكنك الآن الإبلاغ بسرعة عن مشاكل الترجمة في صفحات الويب في الكرة العائمة للترجمة الغامرة. بعد ترجمة صفحة الويب، إذا كانت هناك أي مشاكل، يمكنك النقر على زر [Feedback] على الجانب الأيمن من الكرة العائمة، وملء وصف المشكلة، وسنتعامل معها في أقرب وقت ممكن.
- ملفات Epub تدعم الآن ترجمة النصوص الغنية (أي الحفاظ على تنسيق النص الأصلي لكل فقرة، مثل الروابط، الخط العريض، إلخ.)
- دعم الترجمات الثنائية في الوقت الحقيقي لاجتماعات الفيديو في إصدار الويب من Microsoft Teams (افتح رابط اجتماع Teams، فعّل الترجمات الثنائية في لوحة الترجمة الغامرة، ثم قم بتحديث الصفحة)
- تحسين الترجمات الثنائية للإصدار الإنجليزي من iQIYI (iq.com)
- توفير المزيد من الأوراق العلمية من arXiv بتخطيط ترجمة ثنائية محسن
...
- زر ملاحظات المستخدم الجديد لترجمة المانجا (بعد ترجمة مانجا، انقر على زر [Feedback] على الجانب الأيمن من الكرة العائمة لتقديم ملاحظات حول جودة الترجمة).

## 1.7.7

- اعتماد خوارزمية تقسيم الجمل الذكية للترجمات الإنجليزية التلقائية على YouTube [Pro Available]
...
- دعم تخصيص خبراء الذكاء الاصطناعي، المدخل في أسفل صفحة [Settings]->[AI Expert].
...
- تدعم ترجمات YouTube الثنائية الآن تقسيم الجمل الذكي (Beta) (فقط عند تمكين الترجمة الغامرة لترجمات YouTube يدويًا في [Settings] - [Video Subtitles]، وكانت ترجمات الفيديو الأصلية ترجمات إنجليزية تلقائية)
- تمت الإضافة: خدمة الترجمة Tencent [【Hunyuan Large Model】](https://immersivetranslate.com/docs/services/tencent-hunyuan/)

## 1.6.5

- إصلاح مشاكل تخطيط النصوص لترجمات القصص المصورة للغات ذات الحروف اللاتينية.
...
- ميزة جديدة: ترجمة المانجا (Beta)، في مواقع المانجا المدعومة، سيظهر زر ترجمة المانجا أسفل كرة الترجمة العائمة السريعة لصفحة الويب. النقر عليه سيفعل ترجمة المانجا. هذه الميزة متاحة لأعضاء Pro (500 صفحة شهريًا، يمكن شراء حزم إضافية)، حاليًا تدعم المواقع التالية:
...
- تم إصلاح المشكلة التي كانت تمنع تعديل الترجمة الثنائية في YouTube في وضع ملء الشاشة [#1654](https://github.com/immersive-translate/immersive-translate/issues/1654)
...
- تتسع صفحة الإعدادات الآن لتشمل تعديلات على [أنماط الترجمة في YouTube](https://dash.immersivetranslate.com/#subtitle).
...
- تم إصلاح المشكلة التي كانت تمنع حفظ تغييرات أنماط الترجمة في YouTube
- تم إصلاح اختفاء الترجمة في وضع ملء الشاشة على iOS Safari
- تحسين سرعة الترجمة للترجمة في YouTube بشكل أكبر
- تدعم المزيد من الخيارات في اللوحة الآن [إدخال الترجمة النصية](https://app.immersivetranslate.com/text/)
...
- يدعم منصة الترجمة للفيديو [University of Southampton](https://southampton.cloud.panopto.eu)
...
- دعم إعداد الترجمة للفيديو للعرض الثنائي/الأصلي والترجمة
...
- **دمج مدخل ترجمة المستندات:** الآن، يمكنك ترجمة ملفات PDF وePub والملفات الترجمة من خلال مدخل تحميل موحد. ببساطة انقر على زر [PDF/ePub] في اللوحة المنبثقة، لا حاجة لاختيار [المزيد] بعد الآن.
...
- تم إصلاح مشكلة اختصار الترجمات الثنائية ليوتيوب التي تحتوي على نص إنجليزي طويل جدًا.
...
- تم إصلاح المشكلة التي كانت تحدث عند فشل الترجمة عند تمرير الماوس عندما تفقد الصفحة التركيز.
...
- **إزالة الميزة**: تم إزالة ميزة تحسين المعلومات الثنائية اللغة (عرض نتائج البحث باللغة الإنجليزية على صفحات بحث Google في نفس الوقت).
...
- تحسين: عند استخدام تمرير الماوس، تم حل المشكلة التي كانت تحدث عندما تفقد الصفحة التركيز ثم تعيد التشغيل تصبح غير فعالة.
- تم إصلاح: المشكلة التي كانت تحدث عندما لا يزال الكاش موجودًا بعد تعديل الموجه/النموذج في OpenAI.
...
- إضافة: دعم الترجمة الثنائية اللغة لمنصة التعلم [ArtStation](https://www.artstation.com/learning) و [ZDF](https://www.zdf.de/).
...
- تم إصلاح: تم إصلاح المشكلة التي كانت تحدث عندما يختفي جزء من المحتوى فقط على Hacknews [#1264](https://github.com/immersive-translate/immersive-translate/issues/1264).

## 0.12.11

- تم إضافة دعم الترجمة الثنائية اللغة لمنصات [HBO Max](https://play.max.com/)، [BBC](https://www.bbc.com/)، [Disney+](https://www.disneyplus.com)، [ARD Mediathek](https://www.ardmediathek.de/)، [ITV](https://www.itv.com/)، و [Domestika](https://www.domestika.org).

## 0.12.10

- تم إصلاح مشكلة التفويض لنطاق Gemini تحت سكربت Tampermonkey.
- دعم الترجمة الفورية للترجمات في Twitter Space.
- بالنسبة للإصدارات القديمة من سكربت Tampermonkey، تم إضافة تنبيه تحديث الآن في صفحة الإعدادات.

## 0.12.9

- تم إضافة دعم لترجمة Gemini.
- تم إصلاح المشكلة التي كانت تحدث عندما لا تستجيب الترجمات في الوقت المناسب عند التمرير إلى منتصف الصفحة في بعض الحالات.
- تم إصلاح الخطأ الذي كان يحدث عندما يتسبب تبديل الترجمات على بعض مواقع الفيديو في عرض الترجمة بشكل متكرر.
- تم إصلاح المشكلة التي كانت تحدث عندما يمرر الماوس لمواصلة الترجمة دون الضغط على مفتاح الاختصار في بعض الحالات.
...
- تم إصلاح [عند تشغيل الترجمة المؤقتة لصفحة الويب لفترة طويلة، النقر على اللوحة [ترجمة دائمًا هذا الموقع] لا يلغي الترجمة الدائمة #1172](https://github.com/immersive-translate/immersive-translate/issues/1172)

## 0.12.7

- تم إضافة ترجمات ثنائية اللغة لدعم منصات [TED](https://www.ted.com)، [Frontend Masters](https://frontendmasters.com/)، [edx](https://www.edx.org/)، [CodeWithChris](https://www.edx.org/)، [Skillshare](https://www.ted.com) https://learn.codewithchris.com/enrollments)، [Skillshare](https://www.skillshare.com/) Platforms
- الآن يتم إخفاء الكرة العائمة افتراضيًا عندما يكون الفيديو في وضع الشاشة الكاملة.
- إصلاح مشكلة النقر المتذبذب في لوحة العمل العائمة لصفحة Firefox.
- دعم التعاون تحت موقع pubmed.ncbi.nlm.nih.gov وإضافة scholarscope
- إصلاح مشكلة اهتزاز صفحة الترجمة في صندوق إدخال Reddit

## 0.12.6

- إصلاح المشكلة التي كانت تحدث عندما لا تكون الترجمة في YouTube/Web of Science حساسة عند تبديل علامات التبويب.
...
- إصلاح مشكلة عدم عمل الترجمة عند إنشاء كتب إلكترونية Epub من خلال النقر على اللوحة

## 0.12.4

- عند تشغيل الترجمة الثنائية اللغة في اللوحة، سيتم تحديث الصفحة تلقائيًا أولاً (لعرض الترجمة الثنائية اللغة بدقة أكبر)، وبعض المواقع لا تزال تتطلب من المستخدمين النقر يدويًا على زر "CC" في الموقع لتشغيل الترجمة.
...
- تم توفير دعم الترجمة الثنائية اللغة لمزيد من منصات الفيديو، والتي تدعم الآن: [Youtube](https://www.youtube.com/)، [Netflix](https://www.netflix.com)، [Udemy](https://www.udemy.com/)، [Khanacademy] (https://www\.khanacademy.org/)، [Coursera] (https://www\.coursera.org/)، [Vimeo] (https://vimeo.com/)، [Nebula] (https://nebula.tv)، [Bloomberg](https://www.bloomberg.com)، [Bilibili](https://www.bilibili.com/)، إلخ. (يرجى ملاحظة أنه بسبب القيود التقنية، تحتاج بعض المواقع إلى تحديث الصفحة بعد تشغيل الترجمة الثنائية اللغة لأول مرة أو الانتظار حتى تكتمل الترجمة لعرض الترجمة الثنائية اللغة). (يرجى ملاحظة أنه بسبب القيود التقنية، تحتاج بعض المواقع إلى تحديث الصفحة بعد فتح الترجمة الثنائية اللغة لأول مرة، أو تحتاج إلى الانتظار حتى تكتمل الترجمة لعرض الترجمة الثنائية اللغة)
...
- إضافة بوابة ترجمة PDF سريعة إلى الجانب الأيمن من موقع أوراق [Arxiv](https://arxiv.org/abs/1910.06709)، والتي تذهب إلى صفحة HTML نظيفة (مدعومة فقط من بعض الأوراق، حيث يتطلب ذلك من المؤلفين الأصليين تقديم الشيفرة المصدرية، لذا فإن حوالي 50% من الأوراق ستظهر هذه البوابة)
- الآن يمكن للصفحات PDF عبر الإنترنت بدون امتداد .pdf الانتقال مباشرة إلى صفحة ترجمة PDF بالنقر على الكرة العائمة في الصفحة.
...
- تم حل المشكلة التي كانت تحدث عندما لا يمكن التعرف على بعض المنصات إذا كانت تدعم الماوس أم لا
...
- تحسين الموجه الصيني لـ OpenAI، الآن أقل عرضة للهلوسة!
- تقليل طول موجهات OpenAI من 90 إلى 40، مما يوفر المزيد من حركة المرور.
...
- تحسين الترجمة الثنائية اللغة في Youtube

## 0.10.6

- دعم ترجمة ترجمات Youtube فقط
- إضافة تنبيه تحديث إصدار منخفض لـ Grease Monkey
- إصلاح المشكلة التي كانت تحدث عندما لا يمكن ترجمة ملفات txt المحلية
...
- إصلاح مشكلة عدم ترجمة النص عند النقر على المزيد
...
- إصلاح مشكلة التمرير التلقائي للقراءة عبر الإنترنت للكتب الإلكترونية على الجوال
...
- عادت إصدارات iOS و macOS إلى متجر Apple Store Country
...
- تعطيل مؤقتًا وظيفة تصدير PDF في Safari بسبب قيود Safari على تنزيلات الإضافات (خطأ).
...
- تحسين ترجمة PDF، يمكن الآن تحرير/سحب/حذف منطقة الترجمة
  - السحب من أعلى اليسار، الحذف من أعلى اليمين، تغيير الحجم من أسفل اليمين
...
يمكن الآن لصندوق الإدخال الافتراضي للترجمة أن يتجاهل المسافة، أي يمكن ترجمة //Hello World أيضًا.
...
- ميزة: إضافة خط تقسيم عمودي لترجمات السطر الواحد في نمط الترجمة بخط تقسيم
...
- ميزة "عرض الترجمة فقط" قد وصلت! انقر على "المزيد" -> "التبديل لعرض الترجمات فقط".
...
- إصلاح: نافذة سياسة أمان المحتوى للامتداد، وجزئيًا لـ userscript.
...
- Fix: options form UI
- Fix: Open AI prompt
- Feat: دعم OpenAI multiple keys، استخدم `,` لفصلها.

## 0.2.80

- Feat: إضافة قائمة Enable/Disable للنافذة المنبثقة -> المزيد
...
- Feat: إضافة موضوع جديد Solid Border (新增新主题，实线边框)

## 0.2.77

- Fix: خطأ في وسم الكود المتعدد.[#178](https://github.com/immersive-translate/immersive-translate/issues/178)
...
- Fix: التحقق من الوسوم غير المعروفة
...
- Fix: مشكلة التحقق من خدمة الترجمة في firefox mobile.

## 0.2.71

- Fix: إذن Open AI userscript
...
- Feat: دعم الإطار الرئيسي المخصص لأن بعض المواقع لا تستخدم body كإطار رئيسي
...
- Feat: إضافة `<all>` للغات التي تترجم دائمًا، بحيث يمكنك الآن استخدامها لترجمة جميع اللغات باستثناء اللغة المستهدفة، وعدم ترجمة اللغات
- Fix: السماح بتكوين Google API مخصص
- Better: دعم Deepl Free
- Fix: استخدام الذاكرة العالي لـ userscripts والإضافات (عن طريق إزالة opencc zh-CN إلى zh-TW، بدلاً من Google translate)
...
- دعم طلب الخنق للإطارات المتعددة
...
- Feat: دعم Azure Translate Service
- Feat: دعم Papago Translate Service
- Fix: مزامنة Google Drive الأصلية لـ firefox android.
...
- Fix: userscript كبير جدًا لـ greasy fork
...
- Fix: نمط منتدى Steam
- Fix: النمط العالمي لم يتغير بعد توليد العناصر الديناميكية
...
- Fix: عنصر وسوم الكتل غير المعروفة
...
- Fix: التحقق من الوسوم غير المعروفة المضمنة/الكتل
...
- Fix: خطأ مزامنة Google Drive لـ userscript.
...
- CI: إرسال كود المصدر إلى firefox

## 0.2.51

- Fix: حاجة Google Auth لتسجيل الدخول على Chrome/Firefox
...
- Fix: userscript تبديل القناع
- Fix: منطق تبديل القناع

## 0.2.43

- Fix: userscript تبديل القناع مع حدث اللمس.
...
- Fix: مشكلة مزامنة السحابة لـ userscript
- نقل صفحة الخيارات المتقدمة إلى القائمة اليسرى.
- إضافة منطق إعادة المحاولة لخدمة الترجمة

## 0.2.41

- Fix: userscript ترجمة niu
- Fix: ترجمة xhtml

## 0.2.40

- Fix: عرض ميزة بيتا
- Fix: إعداد النافذة المنبثقة على صفحة علامة تبويب جديدة
...
- أفضل للواجهة المنبثقة ui المزيد
...
- Fix: stay.app userscript متصفح API
...
- Fix: ترجمة PDF عبر الإنترنت لـ firefox

## 0.2.20

- Fix: مشكلة طلب macaque
- Fix: تحديد خط الارتفاع
...
- Fix: safari globalThis.GM لا يعمل

## 0.2.13

- دعم سحب نافذة userscript المنبثقة
