...
- تمت الإضافة: يدعم مكون Safari الإضافي عمليات الشراء داخل التطبيق
...
- تم التحسين: يدعم الآن BBC العناوين الفرعية.

## 1.14.6 Preview (2025-02-08)

- تم الإصلاح: مشكلة عدم قدرة **Mouse Hover Translation** على ترجمة النصوص الغنية.
- تم التحسين: يدعم الآن إصدار Tampermonkey ترجمة العناوين الفرعية على YouTube.
...
- تم التحسين: يتم إيقاف الترجمة النصية الغنية افتراضيًا في وضع ثنائي اللغة لتحسين جودة الترجمة.
...
- تم إضافة: دعم **ترجمة العناوين الفرعية** في الاجتماعات الفورية عبر "الكرة العائمة"، متاح على Zoom وGoogle Meet وMicrosoft Teams.
- تم إصلاح: مشاكل توقيت العناوين الفرعية المتزامنة على يوتيوب بعد مشاهدة الإعلانات.
- تم إصلاح: مشاكل عرض قائمة الترجمة بالنقر بزر الماوس الأيمن في Safari على MacOS 15.
- تم إصلاح: مشاكل وظيفة التراجع Ctrl+Z في **الإدخال المحسن** على بعض المواقع.

## 1.10.6 (2024-10-25)

- تم إصلاح: مشكلة عدم تفعيل مفاتيح الاختصار في **الإدخال المحسن**
- تم تحسين: تقليل حجم حزمة التثبيت
- تم تحسين: حل عرض العناوين الفرعية على Netflix

## 1.10.5 (2024-10-23)

- تم إضافة: عرض تحذير عندما تكون لغة المصدر واللغة الهدف متطابقتين
- تم إصلاح: مشكلة ترجمة مسافات النص الغني [#2175](https://github.com/immersive-translate/immersive-translate/issues/2175)
- تم تحسين: تحسين الإدخال ووظيفة التحويم بالماوس داخل iframes المدمجة على صفحات الويب

## 1.10.2 (2024-10-11)

- تم إضافة: ترجمة الصور (نسخة تجريبية)
- تم إضافة: تفعيل وضع دعم الماوس بالقوة (قم بتفعيل هذه الميزة فقط إذا كانت وظيفة التحويم بالماوس غير متاحة على الأجهزة اللوحية) **الإعدادات** -> **الإعدادات المتقدمة** -> **تفعيل دعم الماوس بالقوة**
- تم إضافة: عرض رسالة خطأ عند فشل ترجمة العناوين الفرعية للفيديو
- تم إصلاح: مشكلة ترجمة النص الغني [#2163](https://github.com/immersive-translate/immersive-translate/issues/2163)
...
- تم إضافة: خدمة الترجمة "Zhipu BigModel"
- تم إزالة: نموذج "SiliconCloud" qwen1.5-7B-chat (بسبب التوقف الرسمي)
- تم إصلاح: حل مشكلة توافق تسجيل الدخول مع إضافة Safari على macOS 15

## 1.9.7 (2024-09-20)

- دعم الإدخال المحسن لـ Baidu وGmail وحقول الإدخال الأخرى
- دعم ترويسة طلب الوصول المباشر للمتصفح الخطير لـ Claude Anthropic API
...
- تم إصلاح مشكلة عرض العناوين الفرعية ثنائية اللغة لعدة فيديوهات على نفس صفحة تويتر
...
- دعم تكوين الاستثناءات للغات والمواقع في وضع المقارنة ثنائية اللغة أو الترجمة فقط (قم بتكوينها في صفحة الإعدادات -> الإعدادات المتقدمة). على سبيل المثال: إذا كان وضع الترجمة الافتراضي لديك هو المقارنة ثنائية اللغة، ولكنك لا ترغب في استخدام الصينية التقليدية أيضًا للمقارنة ثنائية اللغة، فيمكنك إضافة الصينية التقليدية إلى لغات الاستثناء للمقارنة ثنائية اللغة، بحيث تستخدم الصينية التقليدية وضع الترجمة فقط للترجمة. وبالمثل، إذا كان وضع الترجمة الافتراضي لديك هو الترجمة فقط، ولكنك ترغب في استخدام لغة أو موقع معين لوضع المقارنة ثنائية اللغة، يمكنك أيضًا إضافة تلك اللغة أو الموقع إلى لغات الاستثناء.
...
- تم إضافة خيار "الإبلاغ عن مشاكل الترجمة في الصفحة الحالية" وخيار "تشغيل/إيقاف الكرة العائمة بسرعة" في المزيد من الخيارات في اللوحة.
- بعد تعديل موضع العناوين الفرعية ثنائية اللغة على يوتيوب، سيتذكر النظام الموضع الجديد تلقائيًا.
...
- بسبب قيود موقع يوتيوب، لم يعد يدعم سكربت Tampermonkey على Chrome العناوين الفرعية ثنائية اللغة على يوتيوب. يرجى استخدام [إصدار الإضافة](https://immersivetranslate.com/).
...
- تم إصلاح مشكلة عدم القدرة على إيقاف تشغيل اختصار العناوين الفرعية ثنائية اللغة لفيديوهات يوتيوب.
...
- اعتماد خوارزمية تقسيم الجمل الذكية للترجمات التلقائية الإنجليزية على يوتيوب [متاح للمحترفين]
...
- تمكين نسخ العناوين الفرعية على يوتيوب
...
- العناوين الفرعية ثنائية اللغة على يوتيوب تدعم الآن تقسيم الجمل الذكي (نسخة تجريبية) (فقط عند تفعيل الترجمة الغامرة للعناوين الفرعية على يوتيوب يدويًا في [الإعدادات] - [العناوين الفرعية للفيديو]، والعناوين الفرعية للفيديو الأصلي هي عناوين فرعية إنجليزية تم إنشاؤها تلقائيًا)
- تم إضافة خدمة الترجمة Tencent [【نموذج Hunyuan الكبير】](https://immersivetranslate.com/docs/services/tencent-hunyuan/)

## 1.6.5

- إصلاح مشكلات تنسيق النص في ترجمات الكوميك للغات التي تستخدم الأبجدية اللاتينية.
...
- تحسين مشكلات تغطية إعدادات المزامنة السحابية
...
- دعم خدمات الترجمة بالذكاء الاصطناعي لتعيين [خبير الذكاء الاصطناعي] لتحديد استراتيجية الترجمة، حاليًا ميزة بيتا، والتي يمكن تفعيلها في [إعدادات المطور](https://dash.immersivetranslate.com/#developer) بعد تفعيل بيتا، ويمكن رؤية قائمة [خبير الذكاء الاصطناعي] بعد التحديث.
...
- دعم إعدادات التفعيل المستقلة لترجمة الفيديو الثنائية في YouTube (مفعلة افتراضيًا للمستخدمين الجدد)
...
- دعم إعداد عرض الترجمة لعنوان الفيديو بلغتين/الأصلية والترجمة
- دعم المسافة بين الصينية والإنجليزية في نتائج ترجمة OpenAI
- تعديل مفتاح اللوحة لعرض زر الترجمة فقط ليؤثر فقط على الصفحة الحالية

## 1.3.3

- تحسين مشكلة عرض الترجمة لعناوين الفيديو CC على تويتر.
- تمت إضافة دعم اللغة العربية لخدمة DeepL.
- خدمة الترجمة Colorful Clouds تدعم الآن الكورية، الإسبانية، الفرنسية، والروسية.
- تمت إضافة دعم لهجة شمال شرق الصين لخدمة OpenAI.
- الكشف التلقائي للوحة الآن يعرض اللغة الأصلية.
- تعديل وصف الاختصار للوحة الجوال.

## 1.3.2

- تم إصلاح المشكلة التي لم يكن يمكن فيها إغلاق لوحة التحكم على الأجهزة المحمولة

## 1.3.1

- دعم منصة ترجمة عناوين الفيديو [DeepLearning.ai](https://learn.deeplearning.ai)
- دعم ترجمة صفحات الويب وعناوين الفيديو بلغات مثل العربية، العبرية، إلخ، لمعالجة مشاكل العرض من اليمين إلى اليسار (RTL)
- تم إصلاح ترجمة Gemini إلى العبرية
- تم إصلاح مشكلة عدم عرض بعض العناوين الصينية التقليدية على YouTube بشكل صحيح
- تم إصلاح مشكلة عرض عناوين تويتر على Safari
- تم إصلاح الاختصار للترجمة الفورية إلى أسفل الصفحة

## 1.2.4

- تم إصلاح المشكلة التي لم يتم فيها استبدال العناصر النائبة بشكل صحيح في إنشاء ePub
- دعم ترجمة عناوين الفيديو [Unreal Sensei](https://www.unrealsenseiacademy.com/)
...
- تم إصلاح المشكلة التي لم يكن فيها تكوين لون النص يدعم معاينة RGBA [#1435](https://github.com/immersive-translate/immersive-translate/issues/1435)
- تم إصلاح المشكلة التي كانت تظهر فيها صفحة نجاح التثبيت دائمًا عند ترقية إصدار ملحق Safari
- أضافت Microsoft دعمًا للفيتنامية
- تم إصلاح المشكلة التي لم تظهر فيها العناوين المترجمة على موقع edx

## 1.2.2

- دعم ترجمة عناوين الفيديو لـ [pluto](https://pluto.tv/)، [STARZ](https://www.starz.com/)، [Paramount Plus](https://www.paramountplus.com/)، [Rotten Tomatoes](https://www.rottentomatoes.com/)، [Dailymotion](https://www.dailymotion.com/)، [FMovies](https://fmoviesz.to/)، [AniWatch](https://aniwatch.to/)، [iQIYI](https://www.iq.com/)، [Youku](https://www.youku.tv/)، [movie-web](https://movie-web.app/). كما يدعم ترجمة بعض الفيديوهات ذات العناوين CC على تويتر.
...
- دعم ترجمة عناوين الفيديو لـ [Kanopy](https://www.kanopy.com/)، [RachelsEnglishAcademy](https://www.rachelsenglishacademy.com/)، [Hulu](https://www.hulu.com/)، [Three.js Journey](https://threejs-journey.com/).
- تم إصلاح مشكلة عدم تمكن بعض المستخدمين المحترفين من تعديل الإعدادات في متصفح Chrome.
- دعم عرض العناوين الثنائية في وضع ملء الشاشة على YouTube على iOS.

## 1.2.0

- دعم ترجمة عناوين الفيديو على منصات [LinkedIn](https://www.linkedin.com/) و[Viu](https://www.viu.com/).
- إضافة وصول سريع لعناوين الفيديو لمزيد من المنصات.
...
- دعم ترجمة العناوين لـ YouTube Live ومنصة [Mubi](https://mubi.com/).
...
- إضافة وصول سريع لتمكين عناوين الفيديو على Netflix، Ted، Bloomberg، Udemy، Coursera.
...
- دعم العناوين الثنائية لـ [Amazon Prime Video](https://www.primevideo.com)
- تحسين إضافي لوظيفة ترجمة PDF المدمجة في Sci-Hub
- تم إصلاح مشكلة عدم فتح ملفات PDF عبر الإنترنت بشكل صحيح
- تم إصلاح مشكلة التشغيل المستمر للعناوين الثنائية على Netflix
...
- إضافة دعم لإعداد اختصار جديد يسمح بالتبديل السريع لما إذا كانت عناوين الفيديو تستخدم العناوين المترجمة الآلية المدمجة
- على موقع Sci-Hub، سيؤدي النقر على الكرة العائمة إلى ترجمة ملفات PDF المدمجة في صفحة الويب

## 1.1.6

- **دعم الجوال لترجمة الفقرات المحددة:** يدعم الإصدار المحمول الآن ترجمة الفقرات المحددة وقد أضاف مجموعة متنوعة من عمليات الاختصار، بما في ذلك السحب لليسار، السحب لليمين، النقر المزدوج، النقر الثلاثي، وإيماءات اللمس المتعددة الأصابع. هذه ليست مفعلة افتراضيًا وتتطلب من المستخدم اختيار الإيماءة المحفزة في صفحة الإعدادات تحت [تحريك الماوس].
...
- **تجربة الترجمة الغامرة:** لتكييف أفضل مع عادات المستخدم، قمنا بنقل اختصار العناوين الثنائية في وضع ملء الشاشة على منصة YouTube إلى الجانب الأيسر.

## 1.1.5

- تم إصلاح المشكلة التي لم يكن فيها للقائمة المنسدلة في الوضع الداكن على Windows لون.
...
- **ترقية واجهة المستخدم للوحة المنبثقة:** يهدف التصميم الجديد إلى تحسين سهولة الاستخدام والفهم. يتضمن هذا التحديث:
  ...
  - **ميزات جديدة في القائمة الرئيسية:**
    ...
    - **مدخل ترجمة المستندات:** تم نقل مدخل ترجمة "ملفات PDF/ePub/العناوين" إلى القائمة الرئيسية للوصول السريع.
...
- **دمج مدخل ترجمة المستندات:** الآن، يمكنك ترجمة ملفات PDF وePub وملفات العناوين من خلال مدخل تحميل موحد. ببساطة انقر على زر [PDF/ePub] في اللوحة المنبثقة، لا حاجة لاختيار [المزيد] بعد الآن.

- **إضافة دعم لـ 5 مواقع فيديو:**
  - دعم العناوين للبودكاست على Youtube Music.
...
- إصلاح: المشكلة التي لم يكن فيها تبديل خدمات الترجمة فعالًا عندما لم يتم ترجمة الصفحة بعد.
...
- تم إصلاح مشكلة اختصار العناوين الثنائية لـ YouTube التي كانت تحتوي على نص إنجليزي طويل جدًا.
...
- **تحديث واجهة المستخدم لصفحة إعدادات الملحق**:
  ...
  - إضافة دليل للمبتدئين، يغطي إعدادات الكرة العائمة، إعدادات عناوين الفيديو، وإعدادات تحريك الماوس.

- **عناوين YouTube الثنائية**: إضافة وصول سريع في نافذة تشغيل فيديو YouTube لتمكين أو إخفاء العناوين الثنائية (يمكن إيقاف تشغيل هذه الميزة).
...
- **تحسين واجهة المستخدم**: تم إعادة تصميم واجهة المستخدم لرسائل خطأ ترجمة الصفحة لتكون أسهل في الفهم. عندما تكون هناك العديد من الأخطاء، ستظهر نافذة منبثقة لتنبيه المستخدم.
...
- تم التحسين: عند استخدام تمرير الماوس، المشكلة التي تؤدي إلى فقدان التركيز على الصفحة ثم إعادة التشغيل تصبح غير فعالة.
- تم الإصلاح: المشكلة التي كانت تؤدي إلى بقاء ذاكرة التخزين المؤقت بعد تعديل النموذج/التوجيه في OpenAI.
...
- تم الإضافة: دعم العناوين الفرعية الثنائية اللغة لمنصة التعلم [ArtStation](https://www.artstation.com/learning) و [ZDF](https://www.zdf.de/).
...
- تم إصلاح الخطأ الذي كان يؤدي إلى عرض الترجمة بشكل متكرر عند تبديل العناوين الفرعية على بعض مواقع الفيديو.
...
- تحسين التوجيه الصيني لـ OpenAI، الآن أقل عرضة للهلوسة!
...
- إضافة تنبيه تحديث للإصدار المنخفض لـ Grease Monkey
...
- إصلاح مشكلة تعارض الترجمة في يوتيوب مع إضافة Dual subtitle (لا يتم تفعيل ترجمة Immersive Translate لليوتيوب عند اكتشاف إضافة Dual لتجنب التعارض)
- إضافة [تعطيل وظيفة الترجمة الدائمة للفيديو]، إذا كانت هناك مشاكل تعارض أخرى ولا ترغب في تفعيل وظيفة الترجمة الثنائية مع Immersive Translate.
- تحسين فواصل الترجمة
...
- إصلاحات لأخطاء الكتب الإلكترونية عبر الإنترنت
...
- تعطيل مؤقت لوظيفة تصدير PDF في Safari بسبب قيود Safari على تنزيل الإضافات (خطأ).
...
- إصلاح تصغير الصور المترجمة في Epub في بعض المتصفحات
...
- صفحة توجيه إعداد أولية رائعة لمستخدمي iOS الجدد.

## 0.5.11

- دعم ترجمة العناوين الفرعية لتصدير الترجمات فقط
- إصلاح: بعض العناصر لا يتم التعرف عليها عند تحويم الفأرة
- إصلاح: انقطاع جزئي في التغريدات لا يتم التعرف عليه
- إصلاح: نمط تأليف الكتب الإلكترونية لا يعمل

## 0.5.10

- إصلاح: انقطاع سطر التغريدات لا يتم التعرف عليه
...
- إصلاح انقطاع الفقرات في بعض الحالات في:
...
- تم إصلاح مشكلة التعرف على انقطاع السطر في ملفات TXT.
...
- تم إصلاح المشكلة مع التعرف على انقطاع السطر في ملفات TXT.
...
- ميزة: السماح لطرف ثالث بإرسال حدث مستند لاستدعاء `toggleTranslatePage`
...
- إصلاح: مشكلة حرف محدد في منشئ الكتب الإلكترونية، مثل مسار بعض الفصول هو `xxx' xxxx`.
...
- إصلاح: تبديل واجهة المستخدم لخدمات الترجمة لا يغير حالة الإدخال.
...
- إصلاح: تحريك مؤشر نموذج الخيارات.
...
- إصلاح: بعض المواقع تستخدم `span` للأساليب، لذا نستخدم `font` بدلاً من span لتغليف هدف الترجمة
...
- أفضل: دعم Deepl Free
- إصلاح: استخدام ذاكرة عالية للبرامج النصية والإضافات (عن طريق إزالة opencc zh-CN إلى zh-TW، بدلاً من ذلك مع Google translate)
...
- ميزة: دعم خدمة الترجمة Azure
- ميزة: دعم خدمة الترجمة Papago
...
- إصلاح: البرنامج النصي للمستخدم كبير جدًا بالنسبة لـ greasy fork
...
- إصلاح خطأ مزامنة Google Drive للبرنامج النصي للمستخدم.
...
- إصلاح تبديل قناع البرنامج النصي للمستخدم
- إصلاح منطق تبديل القناع

## 0.2.43

- إصلاح تبديل قناع البرنامج النصي للمستخدم مع حدث اللمس.
...
- إصلاح مشكلة مزامنة السحابة للبرنامج النصي للمستخدم
- نقل صفحة الخيارات المتقدمة إلى القائمة اليسرى.
- إضافة منطق إعادة المحاولة لخدمة الترجمة

## 0.2.41

- إصلاح ترجمة niu للبرنامج النصي للمستخدم
- إصلاح ترجمة xhtml
...
- أفضل لنصائح البرنامج النصي للمستخدم السيئة
...
- إضافة 3 مواضيع
- إضافة خدمة الترجمة Niu

## 0.2.32

- إصلاح الترجمة الأساسية لـ PDF
- إصلاح اختيار نافذة منبثقة لخدمة غير مكونة، انتقل إلى صفحة الخيارات.
- إصلاح البقاء على فتح الإعدادات.
- إصلاح سرعة اكتشاف اللغة المتعددة

## 0.2.31

- إصلاح حقن CSS في iframe الديناميكي
...
- إصلاح برنامج stay.app API للمتصفح
...
- إصلاح بناء البرنامج النصي للمستخدم
...
- إصلاح الذكاء الياباني الذكي من tencent
...
- إصلاح مشكلة عدم عمل `safari globalThis.GM`
...
- استعادة الصفحة عند تفعيل عدم ترجمة هذا الموقع
...
- إصلاح النسخة المدمجة من `reddit mobile`
...
- إضافة دعم لـ `reddit mobile`
- إصلاح المسافة البيضاء قبل بعض المقالات

## 0.0.46

- تنسيق معلومات `userscript meta`
...
- إصلاح ترجمة محتوى منشور `reddit mobile`.
...
- إصلاح تحديث إجباري لـ `Google Search`
...
- إصلاح خطأ `Firefox userscript`.

## 0.0.23

- تحسين اكتشاف اللغة الصينية
- إصلاح مشكلة `reddit innerText`
...
- دعم عدم ترجمة علامات `hash` مثل `#hash`، وعلامات `at` مثل `@xxx`، وعلامات `$tag`، مثل `$APPL`
- دعم عنصر الكتلة
