...
- تمت الإضافة: خدمات الترجمة OpenRouter
- تم الإصلاح: مشكلة عدم ترجمة بعض الفقرات أثناء ترجمة صفحات الويب
- تم الإصلاح: مشكلة دمج ترجمات Netflix
- التوافق: مشكلة عرض ترجمات يوتيوب في متصفح "360 Extreme Browser Pro" على Mac
- التحسين: تحديث نمط الكرة العائمة
...
- تم الإصلاح: مشكلة عدم عمل مفتاح اختصار الترجمة عند التمرير على الأجهزة التي تدعم كل من الماوس واللمس.
...
- تم الإصلاح: مشكلة عدم عمل الترجمة عند التمرير في وضع "الترجمة أولاً، يتبعها النص الأصلي".
- تم الإصلاح: مشاكل التوافق مع وضع "الترجمة فقط" عند استخدامه مع مكونات القراءة مثل Reader View.
- التحسين: تحسين جودة خدمة الترجمة AI للمحتوى الرئيسي.
- التحسين: تحسين دعم ترجمة الصور على بعض المواقع.
- التحسين: تحسين تنسيق النص المختلط بين الصينية والإنجليزية.
- التحسين: خدمة الترجمة Gemini تدعم تخصيص النظام (System Prompt).
- التحسين: تحسين سرعة userscript.
...
- تم الإصلاح: مشكلة ترجمة ترجمات Google Meet و Microsoft Teams.
- تم الإصلاح: مشكلة الترجمة في Google مع أحرف الهروب.
- التحسين: تحسين دقة التعرف التلقائي على لغة المحتوى المترجم.
- التحسين: [ترجمة الصور المجانية] تدعم التنسيق للغات من اليمين إلى اليسار.
- التحسين: التوافق مع النماذج مثل o1, o3 التي لا تدعم دور النظام (لن يتم تمرير معلمة دور النظام عندما يكون تكوين System Prompt فارغًا).
...
- التحسين: إضافة اللغة الهنغارية إلى لغة الواجهة.
- التحسين: جودة الترجمة في Google.
- التحسين: تنسيق الصور المجانية.

## 1.14.12 Release (2025-02-19)

- التحسين: إيقاف الترجمة فورًا يزيل قائمة الطلبات.
- التحسين: تصفية النصوص القذرة في خدمة الترجمة deepl.
- الإصلاح: ترجمة الشريط الجانبي غير صالحة في الإعدادات المتقدمة.
- الإصلاح: مشكلة عرض الترجمة المخصصة deepseek.

## 1.14.11 Release (2025-02-18)

- الإصلاح: خطأ `401: Authentication Fails` في مفتاح API المخصص لـ DeepSeek.

## 1.14.10 Release (2025-02-17)

- جديد: عضوية Pro تدعم خدمة الترجمة DeepSeek (v3).
- الإصلاح: حل مشكلة تجاوز حجم ملف تكوين المستخدم.
- التحسين: يمكن إغلاق عنصر قائمة النقر بزر الماوس الأيمن (يتم تشغيله في الإعدادات المتقدمة).
- التحسين: تحسين قدرات التعرف على اللغة لـ Greasemonkey و Safari على الصفحات ذات اللغات الثانوية.
- التحسين: الوصول إلى واجهة خدمة اختبار صفحة الإعدادات عبر الإنترنت.
- التحسين: تحسين تجربة المستخدم لميزة معاينة مقارنة السياق.
- التحسين: منطق الحكم على وضع اللمس والماوس.

## 1.14.8 Release (2025-02-10)

- تم الإصلاح: مشكلة عدم ترجمة ملفات PDF-Pro الطويلة تلقائيًا.
- التحسين: تدعم الآن Microsoft و Google و Tencent الكانتونية.
- التحسين: تدعم الآن BBC الترجمات.

## 1.14.6 Preview (2025-02-08)

- تم الإصلاح: مشكلة عدم قدرة **Mouse Hover Translation** على ترجمة النصوص الغنية.
- التحسين: يدعم الآن إصدار Tampermonkey ترجمة ترجمات يوتيوب.
...
- تم الإصلاح: مشكلة ترجمة تعليقات يوتيوب المباشرة.
- تم الإصلاح: مشكلة تداخل الترجمات في بعض مقاطع فيديو يوتيوب.
- التحسين: فشل في ترجمة المانجا على مواقع مثل shonenjumpplus في متصفح Safari.
...
- التحسين: تحسين تحميل ترجمات يوتيوب.
- جديد: تدعم الآن خدمة الترجمة AI اللغة النرويجية.

## 1.13.6 Preview (2025-01-17)

- التحسين: يمكن استخدام **AI Expert** مع **AI Context-Aware Translation**.
- التحسين: **ترجمة الصور** متوافقة الآن مع weibo.com (مدعومة فقط على Chrome و Edge).
- التحسين: عند تعيين لغة الواجهة إلى الإنجليزية، يتم تغيير اللغة الهدف الافتراضية لـ **Enhanced Input Box** إلى الصينية.
- التحسين: إضافة مدخل لمراجعة المتجر في خيارات **More** على اللوحة.

## 1.13.5 Release (2025-01-14)

- التحسين: التوافق مع نموذج التفكير Gemini 2.0.
- التحسين: يدعم النمط الغامق في وضع الترجمة فقط.

## 1.13.4 Preview (2025-01-13)

- تمت الإضافة: يمكن لأعضاء Pro الآن استخدام نموذج **Zhipu 4 Plus** مباشرة.
- التحسين: ترجمة Gemini.
...
- التحسين: يدعم الآن DeepLx اللغة العربية.
- التحسين: تحسين التعرف على اللغة الأصلية. سابقًا، قد لا يتم ترجمة الصفحات التي تحتوي على لغات متعددة، ولكن الآن يتم ترجمتها بشكل صحيح.
- التحسين: بالنسبة لتويتر، يتم تعيين ترجمات المحتوى متعدد الأسطر على عدم الالتفاف افتراضيًا. سيتم الالتفاف فقط عندما يتجاوز المحتوى 10 أسطر أو 1000 حرف. يمكن تمكين الالتفاف من خلال الإعدادات **الإعدادات المتقدمة** -> **تمكين الالتفاف التلقائي للفقرات الطويلة**.

## 1.12.8 (2025-01-03)

- الإصلاح: مشكلة عدم عرض صفحة الإعدادات في iOS 18.3 بشكل صحيح.
- الإصلاح: نقص الأسطر الفارغة عند ترجمة التغريدات.
- الإصلاح: مشكلة كسر الأرقام العشرية عند ترجمة النصوص الطويلة.

## 1.12.7 Release (2024-12-30)

- التحسين: يدعم الآن Bing/Google البرتغالية (البرازيل).
- التحسين: تحسين الأوصاف للغة واجهة المستخدم الصينية التقليدية.
- التحسين: تعديل التخطيط للغات من اليمين إلى اليسار في اللوحات وصفحات الإعدادات.

## 1.12.6 (2024-12-26)

- الإصلاح: مشكلة تحميل وظيفة التمرير بالماوس لخدمة الترجمة الخاطئة في ظل ظروف معينة.
- الإصلاح: مشكلة عدم عمل تمكين الترجمة الثنائية مؤقتًا على يوتيوب.
- الإصلاح: بعد تبديل خدمات الترجمة، لا يتم تحديث خدمة الترجمة في "**Enhanced Input Box**".
- الإصلاح: مفتاح "**YouTube Enable Bilingual**" في صفحة الإعدادات لا يعمل.
- التحسين: إزالة نموذج gemini-1.0-pro المتوقف.
...
- الإصلاح: بعض الأخطاء في تأثير الترجمة متعددة الأسطر على تويتر.
- الإصلاح: مشاكل في ترجمة بعض الصيغ بسبب النص الغني.
- التحسين: عند الترجمة على **x.com**، سيتم تلقائيًا ترجمة الترجمات الثنائية للفيديوهات.
- التحسين: الفيديوهات بدون ترجمات ستعرض أيقونة الترجمة وتوفر سببًا لعدم إمكانية الترجمة.
...
- التحسين: تحسين عرض الترجمة الثنائية متعددة الأسطر على تويتر ويوتيوب.
- التحسين: يتم إيقاف الترجمة النصية الغنية افتراضيًا في الوضع الثنائي لتحسين جودة الترجمة.
- ~~التحسين: إضافة خيار لتخصيص "**تمكين ترجمة الشريط الجانبي وشريط التنقل**" في "**الإعدادات المتقدمة**".~~
- التحسين: لم تعد الصور تُترجم في وضع "**Hover - ترجمة هذه الفقرة فورًا**".
...
- ~~تم التحسين: تحسين عرض الترجمات ثنائية اللغة متعددة الأسطر على Twitter.~~
...
- تم الإصلاح: مشكلة في مفاتيح الاختصار لـ **الإدخال المحسن** التي لا تعمل
...
- تم الإصلاح: مشكلة عرض العناوين الفرعية ثنائية اللغة لعدة فيديوهات على نفس صفحة Twitter
...
- بشكل افتراضي، سيتم استخدام وضع الترجمة فقط عند الترجمة من الصينية المبسطة إلى الصينية التقليدية والعكس، بدلاً من وضع المقارنة ثنائية اللغة.
- تم إصلاح بعض الأخطاء.

## 1.9.1 (2024-09-03)

- دعم تكوين الاستثناءات للغات والمواقع في وضع المقارنة ثنائية اللغة أو الترجمة فقط (قم بالتكوين في صفحة الإعدادات -> الإعدادات المتقدمة). على سبيل المثال: إذا كان وضع الترجمة الافتراضي لديك هو المقارنة ثنائية اللغة، ولكنك لا ترغب في استخدام الصينية التقليدية أيضًا للمقارنة ثنائية اللغة، فيمكنك إضافة الصينية التقليدية إلى لغات الاستثناء للمقارنة ثنائية اللغة، بحيث تستخدم الصينية التقليدية وضع الترجمة فقط للترجمة. وبالمثل، إذا كان وضع الترجمة الافتراضي لديك هو الترجمة فقط، ولكنك ترغب في استخدام لغة أو موقع معين لوضع المقارنة ثنائية اللغة، يمكنك أيضًا إضافة تلك اللغة أو الموقع إلى لغات الاستثناء.
...
- تمت الإضافة: خيار "الإبلاغ عن مشاكل الترجمة في صفحة الويب الحالية" وخيار "تشغيل/إيقاف الكرة العائمة بسرعة" في خيارات المزيد في اللوحة.
...
- دعم العناوين الفرعية ثنائية اللغة في اجتماعات الفيديو على إصدار الويب من Microsoft Teams (افتح رابط اجتماع Teams، فعّل العناوين الفرعية ثنائية اللغة في لوحة الترجمة الغامرة، ثم قم بتحديث الصفحة)
...
- بسبب قيود موقع Youtube، لم يعد يدعم سكربت Chrome Tampermonkey العناوين الفرعية ثنائية اللغة على Youtube. يرجى استخدام [إصدار الإضافة](https://immersivetranslate.com/).

## 1.8.1

- تم إصلاح مشاكل الترجمة مع سكربت Tampermonkey SiliconCloud
- الآن تدعم ترجمة Claude اللغة التبتية وتسمح بتكوين معلمة Temperature
...
- تم إصلاح مشكلة عدم القدرة على إيقاف تشغيل اختصار العناوين الفرعية ثنائية اللغة لفيديوهات YouTube.
...
- اعتماد خوارزمية تقسيم الجمل الذكية للترجمات التلقائية الإنجليزية على YouTube [متاح للمحترفين]
...
- دعم ترجمة العناوين الفرعية لاجتماعات ZOOM على إصدار الويب
...
- الآن تدعم العناوين الفرعية ثنائية اللغة على YouTube تقسيم الجمل الذكي (نسخة تجريبية) (فقط عند تفعيل الترجمة الغامرة للعناوين الفرعية على YouTube يدويًا في [الإعدادات] - [العناوين الفرعية للفيديو]، والعناوين الفرعية للفيديو الأصلي هي عناوين فرعية إنجليزية تم إنشاؤها تلقائيًا)
...
- ميزة جديدة: دعم الترجمة بالذكاء الاصطناعي لنموذج Doubao الكبير (https://www.volcengine.com/product/doubao)
...
- يمكن لخدمات الترجمة بالذكاء الاصطناعي الآن تخصيص قائمة النماذج، مثل [OpenAI]، النظام يحتوي فقط على بعض النماذج الأكثر استخدامًا بشكل مدمج. بالنقر على قائمة النماذج المنسدلة، العنصر الأخير الذي تراه هو [تعيين المزيد من النماذج]، بعد التعيين، سيتم تذكره تلقائيًا لراحة المستخدمين في اختبار النماذج المخصصة المختلفة.
...
- الآن تدعم المزيد من الخيارات في اللوحة [إدخال الترجمة النصية](https://app.immersivetranslate.com/text/)
...
- تحسين مشكلة عرض الترجمة في ترجمات الفيديو على تويتر.
...
- دعم عرض الترجمة الثنائية في وضع ملء الشاشة على YouTube على iOS.
...
- **تجربة الترجمة الغامرة:** لتحسين التكيف مع عادات المستخدم، قمنا بنقل اختصار الترجمة الثنائية في وضع ملء الشاشة على منصة YouTube إلى الجانب الأيسر.
...
- تم إصلاح مشكلة اختصار الترجمة الثنائية لـ YouTube الذي يحتوي على نص إنجليزي طويل جدًا.
...
- **تحسين واجهة المستخدم**: إعادة تصميم واجهة المستخدم لمطالبات أخطاء ترجمة الصفحة لجعلها أسهل في الفهم. عندما تكون هناك العديد من الأخطاء، ستظهر نافذة منبثقة لتنبيه المستخدم بنشاط.
...
- تم التحسين: عند استخدام تمرير الماوس، المشكلة التي تصبح فيها فقدان التركيز على الصفحة ثم إعادة التحفيز غير فعالة.
...
- تم التحسين: تحسين عملية دمج الترجمة اليدوية.
- تم التحسين: ضبط اللغة المستهدفة تلقائيًا بناءً على لغة المتصفح.
- تم الإضافة: دعم الترجمة الثنائية اللغة لمنصة التعلم [ArtStation](https://www.artstation.com/learning) و [ZDF](https://www.zdf.de/).
...
- تم إضافة دعم الترجمة الثنائية اللغة لـ [HBO Max](https://play.max.com/)، [BBC](https://www.bbc.com/)، [Disney+](https://www.disneyplus.com)، [ARD Mediathek](https://www.ardmediathek.de/)، [ITV](https://www.itv.com/)، و [Domestika](https://www.domestika.org) المنصات.
...
- تم إضافة ترجمات ثنائية اللغة لدعم [TED](https://www.ted.com)، [Frontend Masters](https://frontendmasters.com/)، [edx](https://www.edx.org/)، [CodeWithChris](https://www.edx.org/)، [Skillshare](https://www.ted.com) المنصات. https://learn.codewithchris.com/enrollments)، [Skillshare](https://www.skillshare.com/) المنصات
...
- الكرة العائمة على الجوال تدعم الآن عملية الضغط الطويل، الضغط القصير للترجمة، الضغط الطويل لفتح اللوحة.
...
- عند تشغيل ترجمات ثنائية اللغة في اللوحة، سيتم تحديث الصفحة تلقائيًا أولاً (لعرض الترجمات الثنائية اللغة بدقة أكبر)، وبعض المواقع لا تزال تتطلب من المستخدمين النقر يدويًا على زر "CC" على الموقع لتشغيل الترجمات.
- تحسين Grease Monkey، كشف لغة Safari
...
- تحسين ترجمات يوتيوب الثنائية اللغة

## 0.10.6

- دعم ترجمات يوتيوب للترجمات فقط
...
- إصلاح مشكلة تعارض الترجمة في يوتيوب مع إضافة الترجمة المزدوجة (لا يتم تفعيل ترجمة الترجمة الغامرة ليوتيوب عند اكتشاف إضافة الترجمة المزدوجة لتجنب التعارض)
- إضافة [تعطيل وظيفة الترجمة الفيديو بشكل دائم]، إذا كانت هناك مشاكل تعارض أخرى ولا ترغب في تفعيل وظيفة الترجمة الثنائية مع الترجمة الغامرة.
- تحسين فواصل الترجمة
...
- صفحة توجيه إعداد أولي رائعة لمستخدمي iOS الجدد.

## 0.5.11

- دعم ترجمة العناوين الفرعية لتصدير الترجمات فقط
- إصلاح: بعض العناصر لا يتم التعرف عليها عند تحويم الماوس
- إصلاح: انقطاعات جزئية في التغريدات لا يتم التعرف عليها
- إصلاح: نمط تأليف الكتب الإلكترونية لا يعمل

## 0.5.10

- إصلاح: انقطاعات التغريدات لا يتم التعرف عليها
...
- إصلاح انقطاعات الفقرات في بعض الحالات في:
...
- تم إصلاح المشكلة التي تتطلب تعديل اختصار تحويم الماوس تحديث الصفحة لتأخذ مفعولها

- تم إصلاح مشكلة التعرف على انقطاعات السطر في ملفات TXT.
...
- تم إصلاح المشكلة التي تتطلب تغيير اختصار تحويم الماوس تحديث الصفحة لتأخذ مفعولها

- تم إصلاح المشكلة مع التعرف على انقطاعات السطر في ملفات TXT.
...
- إصلاح ترجمة caiyun لمصدر اللغة غير معرف
...
- إصلاح علامة تسليط الضوء على الخط
...
- إصلاح المسافة البيضاء في بعض المقالات
...
- إصلاح علامة `BR`
- التعامل مع علامات الكتلة وفقًا للقواعد
