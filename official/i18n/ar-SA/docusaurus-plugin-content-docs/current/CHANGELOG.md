...
- تم الإصلاح: مشكلة في خدمة الترجمة AI حيث كانت تخرج الصينية المبسطة بشكل غير صحيح عند ترجمة الصينية التقليدية.
...
- تم التحسين: خدمة الترجمة Gemini تدعم تخصيص System Prompt.
...
- تم التحسين: الوصول إلى واجهة اختبار خدمة صفحة الإعدادات عبر الإنترنت.
...
- تم التحسين: بالنسبة لتويتر، يتم ضبط ترجمات المحتوى متعدد الأسطر على عدم الالتفاف افتراضيًا. سيتم الالتفاف فقط عندما يتجاوز المحتوى 10 أسطر أو 1000 حرف. يمكن تمكين الالتفاف من خلال الإعدادات **Advanced Settings** -> **Enable automatic line wrapping for long paragraphs**.
...
- تم الإصلاح: اختصارات المفاتيح تصبح غير فعالة عند تبديل ميزة "**Hover Translation**" تشغيلًا أو إيقافًا.
...
- ~~تم التحسين: تحسين عرض الترجمات الثنائية متعددة الأسطر على تويتر.~~
- تم التحسين: تحديث واجهة قائمة خدمات الترجمة المنسدلة في اللوحة.

## 1.11.1 (2024-11-05)

- تمت الإضافة: ترجمة العناوين الفرعية في الاجتماعات في الوقت الفعلي تدعم الآن التفعيل عبر "float ball"، متاحة على Zoom وGoogle Meet وMicrosoft Teams.
...
- تم الإصلاح: مشكلة عدم تشغيل اختصارات المفاتيح في **Enhanced input**.
- تم التحسين: تقليل حجم حزمة التثبيت.
- تم التحسين: حل عرض العناوين الفرعية في Netflix.

## 1.10.5 (2024-10-23)

- أُضيف: عرض تحذير عندما تكون لغة المصدر ولغة الهدف متطابقتين
...
- أُضيف: ترجمة الصور (نسخة Beta)
- أُضيف: وضع تمكين دعم الماوس بالقوة (قم بتمكين هذه الميزة فقط إذا كانت وظيفة التحويم بالماوس غير متاحة على أجهزة التابلت) **الإعدادات** -> **الإعدادات المتقدمة** -> **تمكين دعم الماوس بالقوة**
- أُضيف: عرض رسالة خطأ عند فشل ترجمة ترجمات الفيديو
...
- أُزيل: نموذج "SiliconCloud" qwen1.5-7B-chat (بسبب التوقف الرسمي)
...
- تم الإصلاح: مشكلة عدم تزامن خبراء AI المخصصين
...
- تم الإصلاح: مشكلة ترجمة صندوق الإدخال في واجهة الرسائل الخاصة في Tiktok بشكل غير صحيح
...
- أُضيف خيار "الإبلاغ عن مشاكل الترجمة للصفحة الحالية" وخيار "تشغيل/إيقاف الكرة العائمة بسرعة" في خيارات المزيد في اللوحة.
- بعد ضبط موضع ترجمات YouTube الثنائية، سيتذكر النظام الموضع الجديد تلقائيًا.
...
- يمكنك الآن الإبلاغ بسرعة عن مشاكل الترجمة للصفحات في الكرة العائمة للترجمة الغامرة. بعد ترجمة صفحة، إذا كانت هناك أي مشاكل، يمكنك النقر على زر [التغذية الراجعة] على الجانب الأيمن من الكرة العائمة، وملء وصف المشكلة، وسنتعامل معها في أقرب وقت ممكن.
...
- دعم ترجمة ترجمات اجتماعات ZOOM إصدار الويب
...
- أُضيف دعم لمواقع جديدة في ترجمة الكوميك:
...
- أُضيف دعم لمواقع جديدة لترجمة الكوميك:
  - [Mangabuddy](https://mangabuddy.com/)
  - [Hitomi](https://hitomi.la)
  - [Yamibo](https://www.yamibo.com)
  - [Copymanga](https://www.copymanga.site/)
- ترجمات YouTube الثنائية تدعم الآن تقسيم الجمل الذكي (Beta) (فقط عند تمكين الترجمة الغامرة لترجمات YouTube يدويًا في [الإعدادات] - [ترجمات الفيديو]، والترجمات الأصلية للفيديو هي ترجمات إنجليزية تلقائية)
...
- ميزة جديدة: دعم وضع المقارنة الثنائية اللغة مع الترجمة أولاً والنص الأصلي بعد ذلك، يمكن تفعيله في صفحة الإعدادات -> الإعدادات المتقدمة.
...
- دعم خدمات الترجمة AI لتعيين [AI Expert] لتحديد استراتيجية الترجمة، حاليًا ميزة Beta، يمكن تفعيلها في [إعدادات المطور](https://dash.immersivetranslate.com/#developer) بعد تفعيل Beta، ويمكن رؤية قائمة [AI Expert] بعد التحديث.
...
- إضافة زر إعادة تعيين لنمط ترجمات YouTube، والذي يمكنه بسرعة استعادة النمط الافتراضي.
...
- يدعم التحكم في نمط ترجمات YouTube حواف النمط
...
- خيارات "المزيد" في اللوحة تدعم الآن [إدخال ترجمة النص](https://app.immersivetranslate.com/text/)
...
- منصة ترجمات الفيديو تدعم [جامعة ساوثهامبتون](https://southampton.cloud.panopto.eu)
...
- تم إصلاح المشكلة التي كانت تمنع إغلاق لوحة التحكم على الأجهزة المحمولة
...
- **دليل المستخدم الجديد**: عند فتح المستخدمين الجدد لأول مرة صفحة بلغة غير مستهدفة، يتم عرض فقاعة دليل مساعدة الكرة العائمة.
...
- **إصلاحات الأخطاء**:
  ...
  - تم إصلاح مشكلة فشل ترجمة تحريك الماوس عندما تفقد الصفحة التركيز.
  - تم إصلاح مشكلة عدم ترجمة أقل من 3 أحرف في ميزة تحسين مربع الإدخال.
...
- تم إصلاح: مشكلة في دمج ترجمة الفقرات الطويلة في OpenAI في بعض الحالات. [#1276](https://github.com/immersive-translate/immersive-translate/issues/1276)
...
- تحسين: تحسين عملية دمج الترجمة اليدوية للعناوين الفرعية.
- تحسين: ضبط اللغة الهدف تلقائيًا بناءً على لغة المتصفح.
- إضافة: دعم العناوين الفرعية الثنائية لمنصة التعلم [ArtStation](https://www.artstation.com/learning) و [ZDF](https://www.zdf.de/).
...
- إضافة دعم العناوين الفرعية الثنائية لمنصات [HBO Max](https://play.max.com/)، [BBC](https://www.bbc.com/)، [Disney+](https://www.disneyplus.com)، [ARD Mediathek](https://www.ardmediathek.de/)، [ITV](https://www.itv.com/)، و [Domestika](https://www.domestika.org).
...
- إصلاح عدم عرض العناوين الفرعية للفيديو الأصلي عند تعيين "الموقع الحالي لا يُترجم أبدًا".
...
- إضافة العناوين الفرعية الثنائية لدعم منصات [TED](https://www.ted.com)، [Frontend Masters](https://frontendmasters.com/)، [edx](https://www.edx.org/)، [CodeWithChris](https://www.edx.org/)، [Skillshare](https://www.ted.com) https://learn.codewithchris.com/enrollments)، [Skillshare](https://www.skillshare.com/) Platforms
- يتم الآن إخفاء كرة التمرير افتراضيًا عند تشغيل الفيديو بملء الشاشة.
...
- الآن تدعم كرة التمرير على الجوال عملية الضغط الطويل، والضغط القصير للترجمة، والضغط الطويل لفتح اللوحة.
- الآن سيتم ترجمة جدول المحتويات عند ترجمة الكتب الإلكترونية الثنائية.
...
- عند تشغيل العناوين الفرعية الثنائية في اللوحة، سيتم تحديث الصفحة تلقائيًا أولاً (لعرض العناوين الفرعية الثنائية بدقة أكبر)، وبعض المواقع لا تزال تتطلب من المستخدمين النقر يدويًا على زر "CC" في الموقع لتشغيل العناوين الفرعية.
...
- إصلاح [ميزة تعطيل العناوين الفرعية للفيديو بشكل دائم] التي لا تعمل [#1175](https://github.com/immersive-translate/immersive-translate/issues/1175)

## 0.12.2

- يتم توفير دعم العناوين الفرعية الثنائية لمزيد من منصات الفيديو، والتي يتم دعمها الآن: [Youtube](https://www.youtube.com/)، [Netflix](https://www.netflix.com)، [Udemy](https://www.udemy.com/)، [Khanacademy] (https://www\.khanacademy.org/)، [Coursera] (https://www\.coursera.org/)، [Vimeo] (https://vimeo.com/)، [Nebula] (https://nebula.tv)، [Bloomberg](https://www.bloomberg.com)، [Bilibili](https://www.bilibili.com/)، إلخ. (يرجى ملاحظة أنه بسبب القيود التقنية، تحتاج بعض المواقع إلى تحديث الصفحة بعد تشغيل العناوين الفرعية الثنائية لأول مرة أو الانتظار حتى تكتمل الترجمة لعرض العناوين الفرعية الثنائية).
...
- إضافة بوابة ترجمة سريعة لملفات PDF إلى الجانب الأيمن من موقع أوراق [Arxiv](https://arxiv.org/abs/1910.06709)، والتي تذهب إلى صفحة HTML نظيفة (مدعومة فقط من بعض الأوراق، حيث يتطلب ذلك من المؤلفين الأصليين تقديم الشيفرة المصدرية، لذا سيظهر هذا البوابة في حوالي 50% من الأوراق)
...
- إصلاح عدم استجابة النقر على كرة التمرير في ملفات PDF عبر الإنترنت
...
- إصلاح النقرات المتذبذبة على كرة التمرير في الصفحة
...
- تحسين العناوين الفرعية الثنائية لـ Youtube
...
- إصلاح تعارض العناوين الفرعية لـ Youtube مع إضافة العناوين الفرعية الثنائية (لا يتم تمكين ترجمة العناوين الفرعية لـ Youtube عند اكتشاف إضافة العناوين الفرعية الثنائية لـ Youtube لتجنب التعارض)
- إضافة [تعطيل دائم لوظيفة العناوين الفرعية للفيديو]، إذا كانت هناك مشاكل تعارض أخرى ولا ترغب في تمكين وظيفة العناوين الفرعية الثنائية مع Immersive Translate.
- تحسين فواصل العناوين الفرعية
...
- دعم مثالي لمقاطع فيديو Youtube مع عناوين فرعية ثنائية 🎉.
- بالنسبة لصفحات المقالات، سيتم الآن ترجمة النص الأساسي أولاً قبل بقية محتوى الشريط الجانبي
- تحسين سياق الترجمة لـ DeepL
- تحسين ترجمة OpenAI لملفات العناوين الفرعية للسياق
...
- تعطيل مؤقت لوظيفة تصدير PDF في Safari بسبب قيود Safari على تنزيل المكونات الإضافية (خطأ).
- إصلاح بعض المشاكل الأخرى

## 0.7.10

- ترقية واجهة المستخدم للوحة أيقونة المتصفح المنبثقة، مع تصميم أكثر قليلاً ～
- إصلاح مشكلة عدم ترجمة بعض المقاطع اليابانية.

## 0.7.9

- دعم PDF أخيرًا لتصدير النسخ ثنائية اللغة! يمكنك النقر على زر [حفظ] لتصدير ملف PDF ثنائي اللغة المترجم.
...
- التكيف مع نمط نظام Safari، تغيير أيقونة الامتداد في Safari إلى مخطط شفاف.
...
- دعم تمكين/تعطيل ترجمة ترجمات Youtube لمنع التعارض مع المكونات الإضافية الأخرى ذات الصلة.
...
- إصلاح مشكلة عند فتح ملفات PDF، تظهر اللوحة الامتدادية أنه لا توجد أذونات.
...
- تحديد أذكى إذا كانت منطقة تنقل، وإذا كان الأمر كذلك، لا يتم الترجمة
...
- مشاكل عدم التعرف على ملفات الترجمة المصاحبة في safari

## 0.6.3

يمكن الآن للغة الافتراضية لترجمة صندوق الإدخال حذف المسافة، أي يمكن ترجمة //Hello World أيضًا.
...
- إصلاح المشكلة التي: إعداد مدة ترجمة الموقع المؤقت لا يسري.
...
- تم إصلاح المشكلة التي تتطلب تعديل اختصار تحريك الفأرة تحديث الصفحة لتسري
...
- تم إصلاح المشكلة التي تتطلب تغيير اختصار تحريك الفأرة تحديث الصفحة لتسري
...
- إصلاح: فقدان النافذة المنبثقة لمستخدمي Firefox Userscript.
...
- إصلاح: مشكلة الأحرف الخاصة في منشئ الكتب الإلكترونية، مثل بعض مسارات الفصول هي `xxx' xxxx`.
- واجهة المستخدم: طي الخيارات المخصصة لـ openai افتراضيًا.
...
- إصلاح: postMessage عند كسر الصفحة الأولية لبعض المواقع، الآن سنقوم بذلك فقط عندما نقوم بترجمة الصفحات حقًا
...
- ميزة: إضافة خيارات وقت ترجمة الموقع المؤقت في `الإعدادات المتقدمة`
...
- إصلاح: تحريك المؤشر في نموذج خيارات الإدخال.
...
- ميزة: إضافة `<all>` للغات الترجمة الدائمة، بحيث يمكنك الآن استخدامها لترجمة جميع اللغات باستثناء اللغة المستهدفة، وعدم ترجمة اللغات
- إصلاح: السماح بتكوين Google API مخصص
- تحسين: دعم Deepl Free
...
- إصلاح الترجمة المكررة للعناصر داخل السطر مع عنصر الكود.
...
- تحسين: فتح صفحة الإعدادات في علامة تبويب جديدة (ولكن ليس لـ Stay)
...
- إصلاح علامة ارتفاع الخط المميز

## 0.2.19

- إصلاح tencent smart اليابانية
...
- دعم إخفاء أيقونة النافذة المنبثقة لـ userscript.
...
- إصلاح
  ...
  أرشيف Annas لا يمكن ترجمة المحتوى الرئيسي للصفحة

## 0.2.10

- إصلاح مسافة ارتفاع سطر PDF
...
- إصلاح إصدار reddit المحمول المدمج
