...
يمكنك إضافة الإعداد المتقدم التالي من [إعدادات المطور](https://dash.immersivetranslate.com/#developer) -> `Edit Full User Config`:

### وضع الترجمة المجانية بالذكاء الاصطناعي

أصبحت الإضافة تدعم خدمة ترجمة مجانية مجمعة بالذكاء الاصطناعي. عند تفعيل هذا الوضع، سيتم إعطاء الأولوية لمسار الترجمة المجانية المجمعة بالذكاء الاصطناعي.

القيود الحالية:
- لا يدعم قاموس مصطلحات AI حالياً
- لا يدعم مطالبات AI المخصصة حالياً

لإيقاف هذا الوضع والرجوع إلى الإصدار السابق من الترجمة المجانية غير المجمعة بالذكاء الاصطناعي، أضف:
