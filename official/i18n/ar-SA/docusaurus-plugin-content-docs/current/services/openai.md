...
- بعد التسجيل لحساب OpenAI، افتح [مفتاح APمفتاح(https://platform.openai.com/account/api-keys) لالرسميةح API سري
...
3. خطأ 429، يعني أن حد التردد لـ openai قد تجاوز، يُنصح بتقليل الحد الأقصى لعدد الطلبات في الثانية، خاصةً عند ترجمة الكتب الإلكترونية، حتى لو كانت نسخة مدفوعة، تحتاج إلى تقليل الحد الأقصى لعدد الطلباdeploymentsة، وضبطه على 5 طلبات في الثانية لجعله أكثر استقرارًا.
