...
بالقدر الذي يكون فيه ذلك ممكنًا تقنيًا ومطلوبًا بموجب القانون، يحق لك أن تطلب الحصول على المعلومات الشخصية التي زودتنا بها بصيغة منظمة وشائعة الاستخدام وقابلة للقراءة آليًا، أو، حيثما كان ذلك ممكنًا بالنسبة لك، نقلها إلى مقدم خدمة آخر.
...
من أجل تحسين جودة الخدمة وتجربة المستخدم، قد نقوم بتحليل المعلومات المستندة إلى استخدامك للخدمة وتكوين معلومات وسم تعكس عادات الاستخدام العامة أو التفضيلات. يعتمد هذا النوع من التحليل بشكل أساسي على معلومات مثل استخدام الوظائف وسلوك التشغيل وأنماط التفاعل أثناء استخدامك للخدمة، ويُعالج بطريقة تصنيفية أو إحصائية. ولتقليل التأثير على معلوماتك الشخصية، يتم إنشاء هذه الأوسمة ومعالجتها محليًا على جهازك، ولا نقوم بجمع أو تخزين عناوين المواقع المحددة التي تزورها أو محتوى التصفح التفصيلي.

وعلى هذا الأساس، قد نربط معلومات الوسم ذات الصلة بحسابك أو معرّف جهازك لفهم أنماط استخدام المستخدمين بشكل عام، وتحسين وظائف المنتج وتجربة الخدمة، وتحسين عرض المحتوى وتصميم الوظائف، وتقديم منتجات أو خدمات تلبي احتياجات المستخدمين بصورة أفضل حيثما كان ذلك مناسبًا.

لن نتخذ قرارات تُحدث آثارًا قانونية جوهرية عليك أو آثارًا مهمة مماثلة اعتمادًا فقط على المعالجة الآلية من دون تدخل بشري. وإذا فرضت القوانين ذات الصلة في ولايات قضائية مختلفة متطلبات إضافية على المعالجة الآلية أو اتخاذ القرار الخوارزمي، فسنلتزم بها وفقًا للقانون.

وبناءً على ذلك، لا يخضع هذا الخدمة حاليًا لقواعد خاصة باتخاذ القرار الآلي. كما أن التحليل ومعالجة الأوسمة القائمين على الاستخدام المذكورين أعلاه لن يُحدثا عليك آثارًا قانونية جوهرية أو آثارًا مهمة مماثلة، ولن نعالج معلوماتك الشخصية بوسائل آلية فقط بطريقة قد تضر بحقوقك أو مصالحك الشخصية.

إذا أدخلنا في المستقبل، في سيناريوهات محددة، اتخاذ قرارات آلية قد يكون لها تأثير كبير عليك أو أساليب إضافية لتحليل البيانات ومعالجتها، فسنقدم لك المعلومات اللازمة وفقًا للقانون، وسنحصل على موافقتك حيثما كان ذلك مطلوبًا بموجب القانون المعمول به.
...
"ملف تعريف الارتباط" هو جزء صغير من البيانات يُنشئه خادم الويب ويُخزَّن على جهاز المستخدم.

### ما هي ملفات تعريف الارتباط التي نستخدمها؟

نستخدم ملفات تعريف ارتباط مؤقتة (session) وملفات تعريف ارتباط دائمة (persistent). تُحذف ملفات تعريف الارتباط المؤقتة عند إغلاق المتصفح، بينما تبقى ملفات تعريف الارتباط الدائمة على جهازك وقد تُفعَّل عند زيارتك التالية لموقعنا، ويمكنك أيضًا حذفها يدويًا. وبوجه عام، لا تتسبب ملفات تعريف الارتباط الدائمة في إتلاف جهازك أو برامجك أو ملفاتك.

### كيفية إدارة ملفات تعريف الارتباط؟

يمكنك رفض جميع ملفات تعريف الارتباط أو بعضها من خلال ضبط إعدادات المتصفح. وللحصول على التعليمات، يُرجى الرجوع إلى دليل المتصفح الذي تستخدمه. ومع ذلك، إذا قمت بحظر جميع ملفات تعريف الارتباط (بما في ذلك الملفات الضرورية للغاية)، فقد لا تتمكن من الوصول إلى موقعنا أو إلى بعض محتوياته.
