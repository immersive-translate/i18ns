...
## ¿Cómo no muestro el texto original?
...
## Configuración de estilo de subtítulos de Youtube
...
<!-- > Si usas [Stay](https://apps.apple.com/cn/app/stay-safari%E6%B5%8F%E8%A7%88%E5%99%A8%E4%BC%B4%E4%BE%A3/id1591620171) en Safari, busca el Script de Optimización de Immersive Translate para descargarlo directamente desde la tienda de Stay (optimizado específicamente para Stay) -->
...
## Problema de bloqueo de la interfaz de Google Translate
...
¿Tocar lejos? Se muestra el mensaje de error para el número "Unsupported trans_type". Puedes seleccionar el idioma para ser detectado automáticamente mediante el idioma especificado.
...
## La activación de la traducción no surte efecto
...
- Si este sitio es utilizado por muchas personas
  ...
  - Llámalo en el grupo y se adaptará más tarde

## La mejora del cuadro de entrada no surte efecto

- Página de inicio del navegador Búsqueda de Google

El cuadro de búsqueda de Google debe estar en la URL de la página web de [Google](https://www.google.com/) y no puede usarse en la página de inicio del navegador, en los lugares en blanco de la barra de direcciones

## Registro de depuración de retroalimentación
...
<p>
Tampermonkeys requiere que todas las solicitudes del script necesiten declarar permisos al principio del script, por ejemplo: `@connect api.google.com`, por lo que si necesitas añadir un nuevo nombre de dominio que no sea el predeterminado, por favor decláralo al principio del Tampermonkey modelado según el otro nombre de dominio.
</p>
</details>