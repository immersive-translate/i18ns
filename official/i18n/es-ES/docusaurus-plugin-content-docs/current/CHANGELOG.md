...
- Añadido: Servicios de traducción OpenRouter
- Corregido: Problema donde algunos párrafos no se traducían durante la traducción de páginas web
- Corregido: Problema de fusión de subtítulos de Netflix
- Compatible: Problema de visualización de subtítulos de YouTube en Mac "360 Extreme Browser Pro"
...
- Añadido: Soporte para el modelo grande de traducción de Youdao Ziyue.
...
- Mejorado: Para Twitter, las traducciones de contenido multilínea están configuradas para no ajustarse por defecto. El ajuste ocurrirá solo cuando el contenido exceda las 10 líneas o 1000 caracteres. El ajuste se puede habilitar a través de configuraciones **Configuraciones Avanzadas** -> **Habilitar ajuste automático de línea para párrafos largos**.
...
- Corregido: el problema de los números decimales siendo forzados a romperse en líneas al traducir textos largos.
...
- Corregido: Problema con la traducción de fórmulas causado por la "Twitter Translation Improvement" en la versión 1.11.2.
...
- Añadido: Modo de Soporte de Ratón Forzado (Habilitar esta función solo si la función de desplazamiento del ratón no está disponible en dispositivos tablet) **Configuración** -> **Configuración Avanzada** -> **Forzar Habilitación de Soporte de Ratón**.
...
- Mejorado: Solucionados problemas donde el botón de traducción podría no funcionar durante la traducción de PDF.
...
- Soporte de entrada mejorado para Baidu, Gmail y otros campos de entrada.
...
- Corregido el problema con la sincronización de expertos AI personalizados.
...
- Añadida traducción de gran modelo Zero-One-Thing, que se puede usar completando la API Key después de registrarse en la plataforma Zero-One-Thing.
...
- Adopte el algoritmo de división de oraciones inteligente AI para subtítulos en inglés autogenerados en YouTube [Pro Disponible].
- Optimización de la traducción de clic derecho a "Traducir a xx idioma de destino".
...
- Los subtítulos bilingües de YouTube ahora admiten la división inteligente de oraciones (Beta) (Solo cuando se habilita manualmente la traducción inmersiva de subtítulos de YouTube en [Configuración] - [Subtítulos de Video], y los subtítulos originales del video son subtítulos en inglés autogenerados).
...
- Soporte de ratón para presionar Ctrl nuevamente para mostrar el texto original
...
- Optimización de traducción de caja de entrada, ¡ahora funciona sin problemas en Bard!
...
- Mejora de caja de entrada para mostrar el estado de Cargando en traducción
...
- Solución: Algunos sitios usan `span` para estilos, así que usamos `font` en lugar de span para el contenedor de traducción
...
- Solución: Open AI para párrafo con espacio
...
- Función: Añadir regla de waitForSelectors, para solucionar algunos sitios como reddit
...
- Solución duplicada de traducción para elementos en línea con elemento de código.
...
- Intentar solucionar charset de api de deepl
...
- solucionar marca de bloque

## 0.2.45

- Solución de innerText de elemento indefinido
- Solución de idioma fuente indefinido en traducción de caiyun

## 0.2.44

- Solución de alternar máscara en userscript
- Solución de lógica de alternar máscara

## 0.2.43

- Solución de alternar máscara en userscript con evento táctil.
- Solución de velocidad (eliminando sleep(300))

## 0.2.42

- Solución de máscara al pasar el ratón cuando se alterna la máscara de nuevo.
...
- Solución de traducción de niu en userscript
...
- Solución de permanecer abierta la configuración.
- Solución de velocidad de detección de múltiples idiomas

## 0.2.31

- Solución de inyección de css en iframe dinámico
...
- Solución de traducción de pdf en línea en firefox

## 0.2.20

- Solución de problema de solicitud de macaco
- Solución de línea de resaltado de marca

## 0.2.19

- Solución de japonés inteligente de tencent
- Solución de navegador mundial de haikuo
...
- aumentar versión para prueba ci
...
- Arreglar que el cambio de servicio de traducción en el popup no funcione
...
- Arreglar que youtube vaya a la siguiente página
