...
Este registro de cambios se actualiza según el progreso del desarrollo. La fecha después de la versión es la fecha de fusión del código, no la fecha de Release en las tiendas de aplicaciones (el tiempo de revisión varía después de la presentación en cada tienda de aplicaciones, algunas pueden tardar hasta una semana en revisar). Actualmente, estamos avanzando con dos versiones.
...
- Optimizado: El servicio de traducción Gemini admite el aviso del sistema personalizado (System Prompt).
...
- Mejorado: Mejora de la funcionalidad de entrada y desplazamiento del ratón dentro de iframes incrustados en páginas web

## 1.10.2 (2024-10-11)

- Añadido: Traducción de imágenes (versión Beta)
- Añadido: Modo Forece Enable Mouse Support (Habilite esta función solo si la función de desplazamiento del ratón no está disponible en dispositivos tablet) **Settings** -> **Advanced Settings** -> **Forece Enable Mouse Support**
...
- Por defecto, el sistema recordará el modo activado al hacer clic en el icono en el panel para comparación bilingüe o solo traducción. Para cambiar temporalmente, haga clic en "More" -> "Switch to translation-only display" en el panel.
...
- Corregido un problema donde [Advanced Settings -> Minimum number of characters required for translating a paragraph] no surtía efecto en algunos casos
...
- La traducción de Claude ahora soporta tibetano y permite la configuración del parámetro Temperature
...
- Después de seleccionar el texto, el menú de clic derecho cambiará a [Translate the text], al hacer clic en el cual puede saltar automáticamente a la página de Traducción de Texto de Traducción Inmersiva
...
- Adoptar algoritmo de división de oraciones inteligente AI para subtítulos en inglés autogenerados en YouTube [Pro Available]
- Optimizar la traducción de clic derecho a "Translate to xx target language"
...
- Soporte para personalizar expertos AI, la entrada está en la parte inferior de la página de [Settings]->[AI Expert].
...
- Los subtítulos bilingües de YouTube ahora soportan división inteligente de oraciones (Beta) (Solo cuando se habilita manualmente la traducción inmersiva de subtítulos de YouTube en [Settings] - [Video Subtitles], y los subtítulos originales del video son subtítulos en inglés autogenerados)
...
- Soporte para la plataforma de modelo grande Baidu Qianfan, la plataforma de modelo grande Alibaba Bailian, la plataforma de modelo grande DeepSeek.
...
- Los subtítulos de video admiten configuración para la visualización bilingüe/original y de traducción
...
- **Optimización de la Interfaz de Usuario**: Rediseñada la interfaz de usuario para los mensajes de error de traducción de página para hacerlos más fáciles de entender. Cuando hay muchos errores, un pop-up activamente avisará al usuario.
...
- Corregido el problema de clics temblorosos del panel de acción de hoverball de la página de Firefox.
...
- Corregido el problema de creación de Epub al hacer clic en las traducciones del panel que no funcionan
...
- Reparado clic no responde en hoverball de pdf en línea
...
- Corregido clics temblorosos de hoverball en la página
...
- Arreglo de Necesidad de Autenticación de Google en Chrome/Firefox
...
- Arreglar la distancia de altura de línea en pdf
