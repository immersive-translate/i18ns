...
- Corregido: Las actualizaciones de términos no envían nuevas solicitudes de traducción.
...
- Mejorado: La pausa de traducción borra inmediatamente la cola de solicitudes.
...
- Nuevo: La membresía Pro admite el servicio de traducción DeepSeek (v3).
...
- Mejorado: Añadida una entrada de revisión de la tienda en las opciones de **Más** en el panel.
...
- Añadido: **AI Context-Aware Translation** puede mejorar la precisión de la traducción de contenido profesional. (Disponible solo para miembros Pro, compatible exclusivamente con modelos de OpenAI) **Opciones** -> **General** -> **Habilitar AI Context-Aware Translation**
...
- Corregido un problema donde [Configuración Avanzada -> Número mínimo de caracteres requeridos para traducir un párrafo] no surtía efecto en algunos casos
...
- Optimizar la carga de subtítulos en el sitio TED
...
- Soporte para servicios de traducción AI para configurar [AI Expert] para especificar la estrategia de traducción, actualmente una función Beta, que se puede habilitar en [Configuraciones de Desarrollador](https://dash.immersivetranslate.com/#developer) después de habilitar Beta, y el menú [AI Expert] se puede ver después de actualizar.
...
- El servicio OpenAI ha agregado soporte para el dialecto chino del noreste.
...
- Solucionado el problema de la traducción de Gemini al hebreo
...
- **Actualización de la Interfaz de Usuario del Panel Emergente:** El nuevo diseño tiene como objetivo mejorar la usabilidad y comprensión. Esta actualización incluye:
  ...
  - **Nuevas características en el menú principal:**
    ...
    - **Configuraciones de traducción de video:** La entrada para las configuraciones de "Traducción de Video" también se ha colocado en el menú principal para ajustes rápidos.
...
- **Optimización de la Interfaz de Usuario**: Rediseñada la interfaz de usuario para los mensajes de error de traducción de página para hacerlos más fáciles de entender. Cuando hay muchos errores, aparecerá una ventana emergente para avisar al usuario.
...
- Optimizado: Al usar el desplazamiento del ratón, el problema donde se pierde el enfoque en la página y luego se vuelve a activar se vuelve ineficaz.
...
- Corregido [Cuando se activa temporalmente la traducción de la página web durante un tiempo prolongado, hacer clic en el panel [Siempre traducir este sitio web] no cancela la traducción siempre #1172](https://github.com/immersive-translate/immersive-translate/issues/1172)
...
- La función de Mejora de Búsqueda (algunas páginas de Google Search muestran resultados de búsqueda bilingües) ahora no está habilitada por defecto y se eliminará en el próximo Release.

## 0.12.5

- Corregir la creación de eBooks Epub desde el panel haciendo clic en traducciones que no funcionan
...
- Corrección para la función [deshabilitar permanentemente subtítulos de video] que no funciona [#1175](https://github.com/immersive-translate/immersive-translate/issues/1175)
...
- Tamaño del archivo zip del complemento significativamente optimizado, reducido a la mitad en comparación con el original, descarga y actualización más rápida.
...
- Las páginas PDF en línea sin extensión .pdf ahora pueden saltar directamente a la página de traducción de PDF haciendo clic en la bola flotante en la página.
...
- Ahora puedes generar un enlace público a la página bilingüe traducida para Immersive Translate.
  - [Haga clic](/docs/share/) en el Icono de Compartir de Immersive Translate para generarlo con un solo clic.
...
- Soporte de desplazamiento del ratón presionar Ctrl nuevamente para mostrar el texto original
...
- Corregir conflicto de subtítulos de Youtube con el complemento de subtítulos duales (Immersive Translate de la traducción de subtítulos de Youtube no está habilitado cuando se detecta el complemento dual de Youtube para evitar conflictos)
- Añadido [Función de Deshabilitar Permanentemente Subtítulos de Video], si hay otros problemas de conflicto y no deseas habilitar la función de subtítulos bilingües con Immersive Translate.
...
- Funciones Beta: API personalizada (Beta habilitada en configuraciones de desarrollador)
...
- Optimizar la selección de idioma de destino, ahora solo mostrará los idiomas admitidos por el servicio de traducción correspondiente
- Optimización de traducción de PDF
...
- Optimizar: el número mínimo de caracteres en un párrafo que activa la traducción se modificó a un mínimo de 4 caracteres para reducir la confusión, mientras se utilizan otras características para evitar traducir las áreas de navegación y final del sitio.
...
- Solucionar el problema de que las imágenes en algunas páginas de: se copian incorrectamente

## 0.5.12

- Feature: El estilo de traducción de línea dividida agrega una línea divisoria vertical para traducciones de una sola línea.
- Fix: Casos muy raros de división de párrafos.
...
- Fix: Algunos elementos no son reconocidos al pasar el ratón.
- Fix: Los saltos de línea parciales en tweets no son reconocidos.
- Fix: El estilo de autoría de eBooks no funciona.

## 0.5.10

- Fix: Los saltos de línea en tweets no son reconocidos.
- Fix: La página de detalles de Reddit devuelve algunos párrafos que no se pueden traducir.
...
- Fix: Tampermonkey Toggle solo muestra traducciones.
- Fix: Problema de estilo de lectura en línea de eBooks.
...
- Fix: Problema de ventana emergente de nueva pestaña en macOS.
- Feat: Nueva página de guía para nuevos usuarios.

## 0.5.5

- Fix: Problema de área de pasar el ratón.
...
- Fix: Oyente de tecla de acceso rápido al pasar el ratón.
- Fix: Traducción de documentos PDF.
- Feat: Agregar nueva página de guía para clientes.

## 0.5.2

- Fix: Configuración de atajos de pasar el ratón en userscript.

## 0.5.1

- Fix: OpenAI API no funciona.

## 0.5.0

- Feat: Traducir el párrafo actual al pasar el ratón.
- Feat: Reestructurar la traducción de PDF, ahora puedes traducir la mayoría de los PDFs con Immersive Translate.
- Fix: Desactivar el menú contextual no funciona [#428](https://github.com/immersive-translate/immersive-translate/issues/428).
- Fix: Evitar la Política de Seguridad de Contenidos para [Mastondon](https://mastodon.social/).

## 0.4.11

- Fix: Permiso de userscript (solo para userscript).

## 0.4.8

- Feat: Bing Translate a Microsoft Translate para una calidad más estable.
...
- Fix: Falta de ventana emergente de Userscript en Firefox.

## 0.4.6

- Feat: Permitir que terceros envíen eventos de documentos para llamar a `toggleTranslatePage`.
- Feat: La aplicación iOS agrega botón de habilitar extensión y enlace a comunidades.
- UI: El modelo de campo de configuración de OpenAI usa selección en lugar de cuadro de entrada de texto.

## 0.4.5

- Fix: Problema de extensión de safari en iOS 15.0.
- Fix: Atajos de extensión de safari en macOS.
- Fix: Ventana emergente de política de seguridad de contenido para la extensión, y parcialmente para userscript.

## 0.4.4

- Chore: Eliminar console.log.

## 0.4.3

- Fix: Detección de espacios en blanco en etiquetas sup, sub.
- Feat: Soporte para ChatGPT Plus Website como Servicio de Traducción, esta es una función beta, por lo que puedes acceder a ella habilitando la Función Beta en la configuración de desarrollador. Esto es muy lento, porque chatgpt solo puede enviar una solicitud a la vez. Asegúrate de tener una cuenta de ChatGPT Plus, porque hay más limitaciones en la cuenta gratuita, y no estoy seguro si esto representa un riesgo para tu cuenta, ten cuidado de usarlo.

## 0.4.1

- Fix: El menú contextual de Firefox desaparece después de reiniciar.
- Soporte para Azure openai.

## 0.4.0

- Feat: Soporte para traducir archivo de subtítulos local (.srt, .ass, etc.).

## 0.3.17

- Feat: Soporte para traducir archivo .txt local.
- Fix: El menú contextual puede no estar disponible a veces. [#273](https://github.com/immersive-translate/immersive-translate/issues/273).

## 0.3.16

- Fix: mantener &nbsp; como espacio en blanco.
...
- Fix: color de fondo de selección de pdf.
- Fix: detección de espacios en blanco.

## 0.3.13

- Fix: problema de caracteres específicos del constructor de eBooks, como algunas rutas de capítulos son `xxx' xxxx`.
- UI: plegar opciones personalizadas de openai por defecto.
- UI: agregar estado de exportación para exportación de epub.
- Fix: mensaje predeterminado de Gpt4.

## 0.3.12

- Feat: Ahora podemos personalizar el color de fondo del tema de traducción de Marker.
- Fix: postMessage cuando la página de inicio rompía algunos sitios, ahora solo lo haremos cuando realmente traduzcamos páginas.
- Fix: problema de progreso de eBook.
- Fix: mejor para dividir párrafos largos, 1.5 mil millones, 25.5%, Sr. no se considerará como un límite.

## 0.3.11

- Fix: color de texto en modo oscuro del lector de eBooks.
- Fix: mensaje de openAI.

## 0.3.10

- Mejor: detectar contenedor japonés/coreano.
- Fix: Progreso del Constructor de eBooks detenido al 99%.

## 0.3.9

- Fix: El estado de entrada de servicios de traducción de interruptor de UI de Opciones no cambió.

## 0.3.8

- UI: color de carga más transparente.
- Fix: Detectar idioma de eBook.
- Feat: Agregar progreso de traducción para el constructor de eBooks, y un hermoso confeti después del éxito.
- Feat: Agregar reintento de todos los párrafos fallidos para el botón de reintento.
- Fix: Manejo de errores de Deepl.

## 0.3.7

- Fix: el lector de eBooks no puede cargar imágenes en Chrome.

## 0.3.6

- UI: mejor para hacer la interfaz de página de eBooks.

## 0.3.5

- Fix: exportación de eBooks en userscript.
- Feat: agregar punto final de API personalizado para OpenAI.
- Feat: agregar opciones de tiempo de traducción temporal del sitio web en `Configuración Avanzada`.
...
- Fix: creador de eBooks para Kindle.
- Cambio: color del icono de carga, de negro a azul, para adaptarse a la página web en modo oscuro.
- Feat: Soporte para traducción de html local para extensión.

## 0.3.2

- Fix: Movimiento del cursor de entrada del formulario de opciones.
- Feat: OpenAI soporta apiUrl personalizado para configuración de desarrollo.

## 0.3.1

- Feat: actualizar icono oscuro a transparencia.
- Fix: Orden incorrecto para párrafo largo.
...
- Feat: Soporte para icono oscuro para firefox.

## 0.2.86

- Agregar opción de longitud máxima de texto por solicitud con Open AI.
- Fix: identificador de eBook duplicado.
- Feat: Soporte para traducción de página web txt.

## 0.2.85

- Fix: algunos archivos epub no se pueden encontrar.

## 0.2.84

- Feat: Soporte para Lector y Creador de eBooks.

## 0.2.83

- Feat: Permitir que el formulario de entrada de contraseña muestre la contraseña.

## 0.2.82

- Fix: Algunos sitios usan `span` para estilos, por lo que usamos `font` en lugar de span para el contenedor de destino de traducción.
- Fix: Límite máximo de tokens de OpenAI, cambiar caracteres máximos de 1500 a 1300.
...
- Soporte para limitar solicitudes para múltiples marcos
...
- Arreglar: sincronización nativa de google drive en firefox android.
...
- Arreglar alternar máscara en userscript
- Arreglar lógica de alternar máscara

## 0.2.43

- Arreglar alternar máscara en userscript con evento táctil.
...
- Arreglar traducción de pdf en línea en firefox

## 0.2.20

- Arreglar problema de solicitud de macaco
- Arreglar marca de línea de resaltado
...
- La tecla de acceso rápido predeterminada para alternar la traducción ha sido cambiada a `alt+A`, porque
