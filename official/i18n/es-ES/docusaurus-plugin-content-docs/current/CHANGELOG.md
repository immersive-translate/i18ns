...
- Añadido: El navegador de Android admite la traducción de imágenes gratuita. 【Pendiente, necesita esperar el Release del navegador】
...
- Mejorado: Filtra texto sucio en el servicio de traducción de deepl.
- Corregido: Traducción de la barra lateral inválida en configuraciones avanzadas.
- Corregido: Problema de visualización de traducción personalizada de deepseek.
...
- Nuevo: La traducción de imágenes gratuita ahora está disponible (actualmente solo compatible en las versiones de PC de los navegadores Chrome y Edge), accesible a través del menú de clic derecho.
...
- Nuevo: El servicio de traducción de IA ahora admite noruego.
...
- Mejorado: Se añadió una entrada de revisión de la tienda en las opciones **More** en el panel.
...
- Mejorado: Para Twitter, las traducciones de contenido de varias líneas están configuradas para no ajustarse por defecto. El ajuste solo ocurrirá cuando el contenido exceda las 10 líneas o los 1000 caracteres. El ajuste se puede habilitar a través de configuraciones **Advanced Settings** -> **Enable automatic line wrapping for long paragraphs**.
...
- Corregido: Problema donde la función de desplazamiento del ratón carga el servicio de traducción incorrecto bajo ciertas condiciones.
...
- Mejorado: Mejora de la funcionalidad de mejora de entrada y desplazamiento del ratón dentro de iframes incrustados en páginas web.

## 1.10.2 (2024-10-11)

- Añadido: Traducción de imágenes (versión Beta)
- Añadido: Modo de habilitación forzada del soporte para ratón (Habilite esta función solo si la función de desplazamiento del ratón no está disponible en dispositivos tablet) **Configuración** -> **Configuración avanzada** -> **Habilitación forzada del soporte para ratón**
...
- Corregido: Resuelto problema de compatibilidad de inicio de sesión con el plugin Safari en macOS 15

## 1.9.7 (2024-09-20)

- Mejorado soporte de entrada para Baidu, Gmail y otros campos de entrada
...
- Corregido un problema donde los cómics en Read Comic Online no podían ser traducidos
...
- Corregir los problemas de diseño de texto de las traducciones de cómics para idiomas en el alfabeto latino.
...
- Compatible con PDFs abiertos con el plugin Adobe Acrobat.
...
- **Eliminación de Características**: Eliminada la función de mejora de información bilingüe (mostrar resultados de búsqueda en inglés en las páginas de búsqueda de Google).
...
- Reparar clic no responsivo de la bola flotante en línea de pdf
...
- Optimizar: El número mínimo de caracteres en un párrafo que activa la traducción se modificó a un mínimo de 4 caracteres para reducir la confusión, mientras se usan otras características para evitar traducir las áreas de navegación y final del sitio.
...
- Solución: postMessage cuando la página de inicio rompía algunos sitios, ahora solo lo haremos cuando realmente traduzcamos páginas
...
- Función: Soporte para marco principal personalizado porque algunos sitios no usan body como el marco principal
...
- Arreglar Necesidad de Autenticación de Google en Chrome/Firefox
...
- Mejor para la velocidad, añadiendo minLength a 50 para detectar idioma.
...
- Soportar administrador de atajos de Grease Monkey.
...
- Cambiar interfaz de usuario de popup, para un uso más fácil
...
- Soportar salto de línea para X caracteres.
...
- No traducir el párrafo que solo tiene elementos de marcadores de posición, por
...
- Soportar resultado de caché para userscript
- Añadir interfaz de opciones
- Soportar detectar más contenedores de contenido
...
- Soportar página de búsqueda de Youtube.
...
- Soportar resultado de tabla de Google
...
- Soportar establecer modo de traducción inmediata, para que puedas dejar que la página web se traduzca
  lo más rápido posible.
- Soportar establecer el área de la página que necesita traducirse, para que puedas traducir más área.
- Soportar establecer la primera cantidad de texto x para traducir inmediatamente.
- Arreglar traducción duplicada al cambiar traducción
- Mejor interfaz de usuario de popup

## 0.0.33

- Soportar más idiomas, zh-TW, en
...
- Soportar traducir toda la página
- Soportar traducir página inmediatamente
...
- Soportar selectorMatches, para que podamos coincidir con todo manstondon ahora.
...
- Soportar deeplx
- Arreglar traducción múltiple al cambiar servicio
...
- Soportar no traducir etiquetas hash como #hash, etiquetas at como @xxx, $tag, como $APPL
- Soportar elemento de bloque

## 0.0.18

- Soportar deepl, bing, baidu, youdao, volc, openl, caiyun.
...
- Soportar interfaz de usuario básica de popup

## 0.0.4.6

- Soportar verificar nueva versión

## 0.0.3

- Soportar archivos locales

## 0.0.2

- Soportar elementos dinámicos
- Soportar traducción visible