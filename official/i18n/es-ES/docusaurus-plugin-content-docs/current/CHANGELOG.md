...
- Corregido: se corrigió un problema por el que el menú desplegable tipo cápsula de la traducción en cuadros de entrada podía desbordarse por la parte inferior en WhatsApp.
- Añadido: los servicios de API personalizados ahora completan automáticamente las rutas de interfaz de OpenAI / Anthropic según la Base URL.
- Mejorado: se mejoró la entrada de traducción de documentos en el popup para mayor visibilidad y facilidad de uso.

## 1.30.1 Release (2026-06-04)

- Mejorado: la traducción en cuadros de entrada ahora permite volver a traducir después de cambiar el idioma de destino.

## 1.29.9 Preview (2026-05-27)

- Mejorado: se mejoró la experiencia de traducción de texto en la barra lateral.
- Mejorado: las solicitudes de traducción de subtítulos en línea ahora se controlan mediante el límite de párrafos del servicio de traducción.
- Mejorado: se mejoraron los mensajes de los diálogos de error 403 / Cloudflare.
- Añadido: se añadió un interruptor de caché de traducción a Más funciones en el popup.
- Añadido: se añadieron interruptores independientes por sitio para la traducción de subtítulos.

## 1.29.6 Release (2026-05-20)

- Mejorado: se mejoró la transcripción fonética y la salida de traducción de la [traducción por selección de texto] en escenarios con idiomas menos comunes.
- Corregido: se corrigió un problema por el que los expertos de IA personalizados de miembros podían sobrescribirse durante la sincronización.
- Añadido: se añadió soporte para traducir el sitio de cómics toptoon.com.
...
- Corregido: se corrigió un problema por el que la barra lateral no se podía abrir en Atlas Browser.

## 1.29.1 Release (2026-05-07)

- Añadido: compatibilidad con el servicio de traducción plamo.
- Mejorado: se mejoraron las marcas de maquetación para idiomas RTL en el modo Solo traducción.
- Mejorado: se mejoró la coincidencia de algunas formas plurales de términos en inglés para reducir omisiones en la detección de términos.
- Corregido: se corrigió el problema de vibración de los subtítulos al traducir subtítulos de Teams.
- Corregido: se corrigió un problema por el que [Traducción por selección] no podía obtener correctamente el texto en escenarios con ShadowRoot.
