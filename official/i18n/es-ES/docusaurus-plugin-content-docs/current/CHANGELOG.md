...
- Añadido: **AI Context-Aware Translation** puede mejorar la precisión de la traducción de contenido profesional. (Disponible solo para miembros Pro, soportado exclusivamente por modelos de OpenAI) **Options** -> **General** -> **Enable AI Context-Aware Translation**
...
- Añadido: La **Traducción de Subtítulos** en reuniones en tiempo real ahora soporta activación a través de "bola flotante", disponible en Zoom, Google Meet y Microsoft Teams.
...
- Añadido: Modo de habilitación forzada de soporte para mouse (Habilite esta función solo si la función de desplazamiento del mouse no está disponible en dispositivos tablet) **Configuración** -> **Configuración Avanzada** -> **Habilitación Forzada de Soporte para Mouse**
...
- El servicio de traducción de Nubes Coloridas ahora admite coreano, español, francés y ruso.
...
- **Optimización de la Traducción Japonesa:** Optimización adicional de la traducción japonesa de OpenAI para mejorar la precisión y fluidez.
...
- Corregir el problema de clics temblorosos del panel de acción de hoverball de la página de Firefox.
...
- Tamaño del zip del complemento significativamente optimizado, reducido a la mitad en comparación con el original, descarga y actualización más rápidas.
...
- Las páginas PDF en línea sin extensión .pdf ahora pueden saltar directamente a la página de traducción de PDF haciendo clic en el hoverball en la página.
...
- Corregir clics temblorosos de hoverball en la página
...
- Corrección: Algunos sitios usan `span` para estilos, por lo que usamos `font` en lugar de span para el contenedor de traducción
...
- restaurar la página cuando la opción de nunca traducir este sitio está habilitada
...
- Arreglar la expresión regular de coincidencia
