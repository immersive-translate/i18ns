...
- Añadido: Función de traducción de selección de texto
...
- Corregido: Problema de mejora de la caja de entrada de Midjourney repitiendo el texto original.
...
- Mejorado: El elemento del menú contextual se puede cerrar (operado en configuraciones avanzadas).
- Mejorado: Mejoradas las capacidades de reconocimiento de idioma para Greasemonkey y Safari en páginas con idiomas menores.
- Mejorado: Acceso a la interfaz de servicio de prueba de la página de configuraciones en línea.
...
- Nuevo: La traducción de imágenes gratuita ahora está disponible (actualmente solo compatible en versiones de PC de los navegadores Chrome y Edge), accesible a través del menú contextual.
...
- Añadido: **AI Context-Aware Translation** puede mejorar la precisión de la traducción de contenido profesional. (Disponible solo para miembros Pro, compatible exclusivamente con modelos OpenAI) **Options** -> **Grneral** -> **Enable AI Context-Aware Translation**
...
- Debido a las restricciones del sitio web de YouTube, el script de Tampermonkey para Chrome ya no admite subtítulos bilingües de YouTube. Por favor, use la [versión del complemento](https://immersivetranslate.com/).
...
- Solucionada la desaparición de subtítulos en pantalla completa en iOS Safari
...
- Cuando activas los subtítulos bilingües en el panel, primero refrescará la página automáticamente (para mostrar subtítulos bilingües más precisamente), y algunos sitios aún requieren que los usuarios hagan clic manualmente en el botón "CC" en el sitio para activar los subtítulos.
...
- Solucionar el borrado de la caché al cerrar la sesión del usuario.
...
- Soporte para la Traducción de AliCloud
- Solucionar algunos errores

## 0.8.0

- Sistemas de Usuarios Soportados
...
- La funcionalidad es en gran medida la misma (¡nuevas características estarán disponibles en el próximo Release!)
...
- Solucionar: saltos de línea parciales de tweets no reconocidos
- Solucionar: estilo de autoría de eBook no funciona

## 0.5.10

- Solucionar: saltos de línea de tweets no reconocidos
...
- Solucionar: detección de espacios en blanco de etiquetas sup, sub.
...
- Solución: alto uso de memoria para userscripts y extensión (eliminando opencc zh-CN a zh-TW, en su lugar con Google translate)
...
- Solución: fallo en la traducción de archivos PDF, error desde 0.2.60 por soporte de deepl de zh-CN a zh-TW
...
- Solución: elegir servicios de traducción de openl
...
- Solución: cambiar transparencia de 0.4 a 0.618 [#147] (https://github.com/immersive-translate/immersive-translate/pull/147)
- Solución: consejos de atajos en el popup
...
- Solución: promover prioridad de exclusión
...
- Solución de traducción duplicada para elementos en línea con elemento de código.
- Solución de verificación de etiquetas desconocidas en línea/bloque
...
- Solución de traducción de toda la página, el pie de página se ignora
- Añadir notas a la página sobre
- Soporte para url personalizada desde Configuración incorporada

## 0.2.53

- Solución de error de sincronización de google drive en userscript.
...
- Solución de necesidad de inicio de sesión de Google Auth en Chrome/Firefox
...
- Solución de problema de carga de google drive (realmente) [#81](https://github.com/immersive-translate/immersive-translate/issues/81)

## 0.2.49

- Eliminar atajos alt+d, alt+s porque pueden entrar en conflicto con atajos nativos.
- Solución de problema de carga de google drive [#81](https://github.com/immersive-translate/immersive-translate/issues/81)

## 0.2.48

- Mejor para velocidad, añadiendo minLength a 50 para detección de idioma.
- Solución de validación de token de Google Drive.

## 0.2.47

- Solución de api de deepl

## 0.2.46

- solución de marca de bloque

## 0.2.45

- Solución de innerText de elemento es indefinido
- Solución de traducción de caiyun idioma fuente indefinido

## 0.2.44

- Solución de alternar máscara de userscript
- Solución de lógica de alternar máscara

## 0.2.43

- Solución de alternar máscara de userscript con evento táctil.
- Solución de velocidad (eliminando sleep(300))

## 0.2.42

- Solución de hover de máscara al alternar máscara de nuevo.
- Añadir atajos de máscara para móvil
- Solución de problema de sincronización en la nube de userscript
- Mover página de opción avanzada al menú de la izquierda.
- Añadir lógica de reintento al servicio de traducción

## 0.2.41

- Solución de traducción de niu de userscript
- Solución de traducción de xhtml

## 0.2.40

- Solución de mostrar característica beta
- Solución de página de configuración de popup en nueva pestaña
- Solución de reemplazo de marcador de posición de traducción
...
- Solución de atajos en extensión móvil

## 0.2.38

- Soporte para tema de carga
- Solución de getpocket.com
- Solución de pie de página para área de cuerpo
- Solución de icono de importación/exportación

## 0.2.37

- Solución de marca de exclusión de marco
...
- Solución de ignorar etiqueta rb, rt en japonés.
- Mejor para UI de popup más
- Mejor para consejos de userscript malos
- Añadir contribución a la página sobre
- Solución de volc translate para detección automática de idioma

## 0.2.34

- Solución de velocidad de múltiples idiomas
...
- Solución de traducción básica de PDF
- Solución de selección de popup de un servicio no configurado, ir a la página de opciones.
- Solución de mantener abierta la configuración.
- Solución de velocidad de detección de múltiples idiomas

## 0.2.31

- Solución de inyección de css de iframe dinámico
...
- Solución de traducción de Facebook
...
- Soporte para traducción de iframe en línea. (Solo para extensión, no disponible para
  userscript)
- Solución de traducción de múltiples idiomas

## 0.2.26

- Solución de addon de firefox android
...
- Solución de API de navegador de userscript de stay.app
- Solución de página de opciones de stay.app

## 0.2.23

- Solución de traducción de página de múltiples idiomas

## 0.2.22

- Solución de compilación de userscript

## 0.2.21

- Solución de traducción de pdf en línea de firefox

## 0.2.20

- Solución de problema de solicitud de macaco
- Solución de altura de línea de resaltado de marca

## 0.2.19

- Solución de japonés inteligente de tencent
- Solución de navegador mundial haikuo

## 0.2.18

- Solución de cambio de url de cliente, auto mantener el estado de traducción.
...
- Solución de problema de rebote táctil
