...
- Añadido: Gestión de glosarios de AI (solo soporta servicios de traducción AI)
...
- Corregido: Un problema donde la tecla de acceso rápido para traducción al pasar el ratón no funcionaba en dispositivos que soportan tanto ratón como táctil.
- Añadido: Soporte para el modelo de traducción grande de Youdao Ziyue.
...
- Optimizado: Mejorado el soporte para traducción de imágenes en ciertos sitios web.
...
- Corregido: Error `401: Authentication Fails` de clave API personalizada de DeepSeek.
...
- Nuevo: La traducción de imágenes gratuita ahora está disponible (actualmente soportada solo en versiones para PC de los navegadores Chrome y Edge), accesible a través del menú de clic derecho.
...
- Mejorado: Para Twitter, las traducciones de contenido de varias líneas están configuradas para no ajustarse por defecto. El ajuste solo ocurrirá cuando el contenido exceda las 10 líneas o 1000 caracteres. El ajuste se puede habilitar a través de configuraciones **Advanced Settings** -> **Enable automatic line wrapping for long paragraphs**.
...
- Añadido: **AI Context-Aware Translation** puede mejorar la precisión de la traducción de contenido profesional. (Disponible solo para miembros Pro, soportado exclusivamente por modelos OpenAI) **Options** -> **Grneral** -> **Enable AI Context-Aware Translation**
...
- Mejorado: Solución para la visualización de subtítulos en Netflix.
...
- Mejorado: Mejora en la funcionalidad de mejora de entrada y desplazamiento del ratón dentro de iframes incrustados en páginas web.
...
- Añadida la opción de "Reportar problemas de traducción de la página web actual" y la opción de "Encender/apagar rápidamente la bola flotante" en más opciones del panel.
...
- Optimización de la lógica de caché del plugin, ahora limpiando automáticamente los datos de caché que tienen más de 30 días.
...
- Añadido traducción de gran modelo Zero-One-Thing, que se puede usar llenando la clave API después de registrarse en la plataforma Zero-One-Thing.
...
- Soporte para personalizar expertos en IA, la entrada está en la parte inferior de la página [Configuración]->[Experto en IA].
...
- Mejora en la velocidad de traducción de manga.
...
- Mejora en la velocidad de traducción para traducciones de cómics.
...
- Los miembros Pro soportan servicios de traducción de Claude y Gemini listos para usar (Beta)
...
- Optimizada la cobertura de configuración de sincronización en la nube
...
- Añadidas opciones de 50%, 150% para el tamaño de fuente de los subtítulos de YouTube
...
- Soporte para el servicio de traducción de Claude
...
- El servicio de traducción de Gemini está oculto por defecto, se puede habilitar en la configuración de desarrollador para mostrar la beta de este servicio de traducción
...
- **Actualización de la Interfaz de Usuario del Panel Emergente:** El nuevo diseño busca mejorar la usabilidad y comprensión. Esta actualización incluye:
...
- **Eliminación de Funciones**: Eliminada la función de mejora de información bilingüe (mostrar resultados de búsqueda en inglés en las páginas de búsqueda de Google simultáneamente).
...
- Optimización significativa del tamaño del archivo zip del complemento, reducido a la mitad en comparación con el original, descarga y actualización más rápida.
...
- Modificar el modo de compartir bilingüe (modo de actualización) añadido en la última versión a compartir instantáneas de página bilingüe, para que el contenido compartido sea más original, así como una mayor adaptabilidad.
...
- Se añadió [Desactivar permanentemente la función de subtítulos de video], si hay otros problemas de conflicto y no deseas habilitar la función de subtítulos bilingües con Immersive Translate.
...
- Solucionar el problema de que al hacer clic en más texto en ins no se traduce
...
- La herramienta de traducción de PDF se ha migrado a la versión en línea: https://app.immersivetranslate.com/pdf/ , para que Grease Monkey y Safari puedan usar la traducción de PDF, y los problemas se puedan iterar mejor sin necesidad de emitir una versión para resolver el problema.
...
- Mejora del cuadro de entrada para mostrar el estado de Cargando en la traducción
...
- Función: Traducir Bing a Microsoft Translate para una calidad más estable.
...
- Solucionar: el estado de entrada de servicios de traducción de interruptor de UI de opciones no cambia.
...
- Solución: Algunos sitios usan `span` para estilos, así que usamos `font` en lugar de span para el contenedor de destino de la traducción
- Solución: límite máximo de tokens de OpenAI, cambiar caracteres máximos de 1500 a 1300.

## 0.2.81

- Solución: m.youtube.com
- Solución: opciones de formulario UI
- Solución: Open AI prompt
...
- Solución: Conflicto de Mensaje de DingTalk

## 0.2.79

- Solución: Open AI para párrafo de espacio
...
- Solución: error de múltiples etiquetas de código.[#178](https://github.com/immersive-translate/immersive-translate/issues/178)
...
- Solución: traducción de openai
- Solución: verificación de etiquetas desconocidas en línea

## 0.2.73

- Función: Soporte para Tema de Traducción Gris
- Solución: Página de Tendencias de Github

## 0.2.72

- Solución: problema de red de verificación del servicio de traducción en firefox móvil.

## 0.2.71

- Solución: permiso de userscript de Open AI

## 0.2.70

- Solución: marcador de posición de Open AI
...
- Solución: etiquetas de bloque desconocidas
...
- Solución: Permitir configurar API de Google personalizada
- Mejor: Soporte gratuito de Deepl
- Solución: alto uso de memoria para userscripts y extensiones (eliminando opencc zh-CN a zh-TW, en su lugar con Google translate)
- Solución: Relingo [#159] (https://github.com/immersive-translate/immersive-translate/issues/159)
- Solución: configuración de traducción de Azure pero aún muestra (necesita configuración)

## 0.2.66

- Solución: fallo en la traducción de archivos PDF, error desde 0.2.60 por soportar deepl de zh-CN a zh-TW
...
- Solución: elegir servicios de traducción openl
...
- Solución: sincronización nativa de google drive en firefox android.
- Solución: cambiar la transparencia de 0.4 a 0.618 [#147] (https://github.com/immersive-translate/immersive-translate/pull/147)
- Solución: consejos de atajos de popup
...
- Solución: userscript es demasiado grande para greasy fork
...
- Solución: estilo del foro de Steam
- Solución: estilo global no cambiado después de generar elementos dinámicos
- Solución: promover la prioridad de exclusión
- UI: cambio de página sobre
- Solución: algunos elementos matemáticos permanecen originales

## 0.2.59

- Solución: Elemento de Bloque de Etiquetas Desconocidas
- Solución: elemento translate=no anula
- Solución: coincidencia de url con múltiples \*
...
- Solución: traducción duplicada para elementos en línea con elemento de código.
- Solución: verificación de etiquetas desconocidas en línea/bloque
...
- Solución: traducir toda la página, el pie de página se ignora
- Añadir notas a la página sobre
- Soporte para url personalizada desde Configuración incorporada

## 0.2.53

- Solución: error de sincronización de google drive en userscript.
...
- Solución: Google Auth necesita inicio de sesión en Chrome/Firefox
...
- Solución: problema de carga de google drive (realmente) [#81](https://github.com/immersive-translate/immersive-translate/issues/81)

## 0.2.49

- Eliminar atajos alt+d, alt+s porque pueden entrar en conflicto con atajos nativos.
- Solución: problema de carga de google drive [#81](https://github.com/immersive-translate/immersive-translate/issues/81)

## 0.2.48

- Mejor para la velocidad, añadiendo minLength a 50 para la detección de idioma.
- Solución: validar token de Google Drive.

## 0.2.47

- Solución: API de deepl

## 0.2.46

- solución: marcar bloque

## 0.2.45

- Solución: innerText del elemento es indefinido
- Solución: traducción de caiyun idioma fuente indefinido

## 0.2.44

- Solución: alternar máscara de userscript
- Solución: lógica de alternar máscara

## 0.2.43

- Solución: alternar máscara de userscript con evento táctil.
- Solución: velocidad (eliminando sleep(300))

## 0.2.42

- Solución: pasar el ratón sobre la máscara cuando se alterna la máscara de nuevo.
- Añadir atajos de máscara para móvil
- Solución: problema de sincronización en la nube de userscript
- Mover la página de opciones avanzadas al menú de la izquierda.
- Añadir lógica de reintento al servicio de traducción

## 0.2.41

- Solución: traducción de niu de userscript
- Solución: traducción de xhtml

## 0.2.40

- Solución: mostrar característica beta
- Solución: página de configuración de popup en nueva pestaña
- Solución: reemplazo de marcador de posición de traducción
...
- Solución: atajos en extensión móvil

## 0.2.38

- Soporte para tema de carga
- Solución: getpocket.com
- Solución: pie de página lateral para el área del cuerpo
- Solución: icono de importación/exportación

## 0.2.37

- Solución: marcar exclusión de marco
...
- Solución: ignorar etiqueta rb, rt japonesa.
- Mejor para popup ui más
- Mejor para consejos de userscript malos
- Añadir contribución a la página sobre
- Solución: volc traducir para detectar idioma automáticamente

## 0.2.34

- Solución: velocidad de múltiples idiomas
...
- Solución: traducción básica de PDF
- Solución: seleccionar un servicio no configurado en el popup, ir a la página de opciones.
- Solución: mantener abierta la configuración.
- Solución: velocidad de detección de múltiples idiomas

## 0.2.31

- Solución: inyección de css en iframe dinámico
...
- Solución: traducción de Facebook
...
- Soporte para traducción de iframe en línea. (Solo para extensión, no disponible para
  userscript)
- Solución: traducción de múltiples idiomas

## 0.2.26

- Solución: addon de firefox android
...
- Solución: API del navegador de userscript de stay.app
- Solución: página de opciones de stay.app

## 0.2.23

- Solución: traducción de página de múltiples idiomas

## 0.2.22

- Solución: construcción de userscript

## 0.2.21

- Solución: traducción de pdf en línea de firefox

## 0.2.20

- Solución: problema de solicitud de macaco
- Solución: marcar línea de resaltado de altura

## 0.2.19

- Solución: japonés inteligente de tencent
- Solución: navegador mundial haikuo

## 0.2.18

- Solución: cambio de url del cliente, permanecer automáticamente en el estado de traducción.
- Eliminar contenedor lateral como contenedor de traducción.
- Refactorizar posición de popup.

## 0.2.17

- Cambiar resaltado a marcar
...
- Solución: problema de rebote táctil
...
- La tecla de acceso rápido predeterminada para activar/desactivar la traducción ha sido cambiada a `alt+A`, porque
...
- Arreglar que algunas etiquetas span son elementos de bloque
