...
- Corregido: Problema de mejora del cuadro de entrada de Midjourney que repetía el texto original.
...
- Añadido: **AI Context-Aware Translation** puede mejorar la precisión de la traducción de contenido profesional. (Disponible solo para miembros Pro, soportado exclusivamente por modelos OpenAI) **Opciones** -> **General** -> **Habilitar AI Context-Aware Translation**
...
- Fixed: Problema donde el contenido desaparece después de hacer clic en "ver más" en el modo solo traducción de Facebook.
...
- Fixed: Problemas de sincronización de tiempo de subtítulos en YouTube después de ver anuncios.
- Fixed: Problemas de visualización con el menú de traducción al hacer clic derecho en Safari en MacOS 15.
- Fixed: Problemas con la funcionalidad de deshacer Ctrl+Z en la **Entrada mejorada** en ciertos sitios web.

## 1.10.6 (2024-10-25)

- Fixed: Problema con las teclas de acceso rápido de **Entrada mejorada** que no se activan.
...
- Fixed: Problema de traducción de caracteres de espacio en blanco en texto enriquecido [#2175](https://github.com/immersive-translate/immersive-translate/issues/2175).
...
- Fixed: Problema de traducción de texto enriquecido [#2163](https://github.com/immersive-translate/immersive-translate/issues/2163).
...
- Fixed: Resuelto problema de compatibilidad de inicio de sesión con el complemento Safari en macOS 15.
...
- Fixed: Problema con la sincronización de expertos AI personalizados.
...
- Fixed: Problema de visualización de subtítulos bilingües para múltiples videos en la misma página de Twitter.
- Fixed: Algunos errores.

## 1.9.3 (2024-09-05)

- La opción de comparación bilingüe/solo traducción se ha movido a la configuración general.
...
- Fixed: Problema donde el cuadro de entrada en la interfaz de mensaje privado de Tiktok se traducía incorrectamente.
- Fixed: Problema donde los cómics en Read Comic Online no se podían traducir.
- Fixed: Problema donde [Configuración Avanzada -> Número mínimo de caracteres requeridos para traducir un párrafo] no surtía efecto en algunos casos.
...
- Mejora en el manejo de "palabras no traducibles" en la configuración avanzada.
...
- Fixed: Problemas de traducción con el script de Tampermonkey SiliconCloud.
...
- Fixed: Problemas con la traducción de texto enriquecido para servicios de traducción como Google, DeepL (por ejemplo, páginas que muestran directamente `<button>` etc.).
- Fixed: Problema donde el atajo bilingüe para videos de YouTube no se podía desactivar.
...
- Adopción de algoritmo de división de oraciones inteligente AI para subtítulos en inglés autogenerados en YouTube [Pro Disponible].
- Optimización de la traducción al hacer clic derecho a "Traducir a xx idioma de destino".
...
- Soporte para personalizar expertos AI, la entrada está en la parte inferior de la página de [Configuración]->[Experto AI].
...
- Fixed: Fallo en la traducción de cómics en el navegador Firefox.
...
- Solucionar los problemas de diseño del texto de las traducciones de cómics para idiomas en el alfabeto latino.
...
- Nueva función: La traducción de IA admite [modelo grande Doubao](https://www.volcengine.com/product/doubao)
...
- Solucionado el tiempo de sincronización de múltiples dispositivos de usuarios Pro que no se sincronizaba
- Optimizada la cobertura de configuraciones de sincronización en la nube
- Optimizadas las palabras de prompt para servicios de traducción de IA
...
- Agregadas opciones de 50%, 150% para el tamaño de fuente de subtítulos de YouTube
...
- Optimizado los multi-prompts de OpenAI, admitiendo formato YAML, lo que mejora la flexibilidad y facilidad de uso de la configuración
...
- Solucionado el problema donde al actualizar la versión del plugin Safari siempre se mostraba la página de éxito de instalación.
...
- Optimizado los mensajes emergentes de error, los mensajes emergentes de error de problemas de red detectan automáticamente servicios de traducción gratuitos válidos.
...
- Soporte para visualización de subtítulos bilingües en modo de pantalla completa de YouTube en iOS.

## 1.2.0

- Soporte para traducción de subtítulos de video en plataformas [LinkedIn](https://www.linkedin.com/) y [Viu](https://www.viu.com/).
- Añadido más accesos rápidos a subtítulos de video para plataformas adicionales.
...
- Optimizado la interfaz de usuario de los mensajes emergentes de error.

## 1.1.9

- Soporte para traducción de subtítulos en YouTube Live y la plataforma [Mubi](https://mubi.com/).
- Optimización: Página de configuraciones, interfaz de usuario de la lista de URL (para evitar ambigüedades, las casillas de verificación no se muestran por defecto).
...
- Optimización adicional de la función de traducción de PDF incrustados en Sci-Hub.
- Solucionado un problema con la apertura incorrecta de PDFs en línea.
...
- Optimizada la sensibilidad de detección del ratón al pasar sobre Ctrl para evitar confundir `Ctrl+C` como `Ctrl`.
...
- **Guía para Nuevos Usuarios**: Cuando los nuevos usuarios abren una página en un idioma no objetivo, se muestra una burbuja de ayuda flotante.
...
- **Eliminación de Función**: Eliminada la función de mejora de información bilingüe (mostrando resultados de búsqueda en inglés en páginas de búsqueda de Google simultáneamente).
...
- Optimizado: Al usar el ratón, el problema donde perder el foco en la página y luego volver a activar se vuelve ineficaz.
...
- Corregir la creación de Epubs al hacer clic en las traducciones del panel que no funcionan

## 0.12.4

- Cuando activas los subtítulos bilingües en el panel, primero refrescará la página automáticamente (para mostrar subtítulos bilingües con más precisión), y algunos sitios aún requieren que los usuarios hagan clic manualmente en el botón "CC" en el sitio para activar los subtítulos.
...
- Soporte de ratón para presionar Ctrl nuevamente para mostrar texto original
...
- Solucionar el conflicto de subtítulos de Youtube con el plugin de subtítulos Dual (la traducción de subtítulos de Youtube de Immersive Translate no se habilita cuando se detecta el plugin Dual de Youtube para evitar conflictos)
...
- Solucionado el problema de limpiar la caché al cerrar la sesión del usuario.
...
- La herramienta de traducción de PDF se ha migrado a la versión en línea: https://app.immersivetranslate.com/pdf/ , para que Grease Monkey y Safari puedan usar la traducción de PDF, y los problemas se puedan iterar mejor sin la necesidad de emitir una versión para resolver el problema.
...
- Solución de problemas de desplazamiento automático en la lectura en línea de epub en móviles
...
- El servicio de traducción de la caja de entrada se puede configurar por separado
...
- Hemos sido notificados por Apple de que las Traducciones de OpenAI han sido eliminadas temporalmente de iOS y macOS, y estamos intentando relanzarlas en China.

## 0.7.11- 0.7.14

- Solución: problema de Traducción de Gmail en Todas las Regiones
...
- Soporte de Resultados de Traducción Mejorados en la Entrada ctrl+z Deshacer
...
- Mejora de la Caja de Entrada: permite omitir el prefijo // y activar la traducción de toda la caja de entrada con 3 espacios, o puedes desactivar esta opción en la página de configuración.
...
- Optimizar la selección del idioma de destino, ahora solo mostrará los idiomas admitidos por el servicio de traducción correspondiente
- Optimización de la Traducción de PDF
...
- Optimización de la traducción de PDF, el área de traducción ahora se puede editar/arrastrar/eliminar
...
- La Traducción de la Caja de Entrada admite la traducción directa de todo el cuadro de texto sin prefijos.
...
La mejora más emocionante de la caja de entrada está aquí:
...
- Solucionar: estilo de creación de eBooks no funciona
...
- Solucionar: problema de estilo de lectura en línea de eBooks no funciona
...
- Solucionar: problema de caracteres específicos del creador de eBooks, como algunas rutas de capítulos son `xxx' xxxx`.
- UI: plegar opciones personalizadas de openai por defecto.
- UI: Agregar estado de exportación para exportación de epub.
- Solucionar: Gpt4 prompt predeterminado
...
- Solucionar: mejor para dividir párrafos largos, 1.5 billion, 25.5%, Mr. no se considerarán como un límite

## 0.3.11

- Solucionar: color de texto en modo oscuro del lector de eBooks
- Solucionar: openAI prompt

## 0.3.10

- Mejor: detectar contenedor japonés/coreano.
- Solucionar: Progreso del creador de eBooks detenido al 99%.
...
- Función: Agregar progreso de traducción para el creador de eBooks, y un hermoso confeti después del éxito.
...
- UI: mejor para hacer la interfaz de página de eBook
...
- Arreglo: identificador de ebook duplicado
- Función: Soporte para traducción de páginas web en formato txt

## 0.2.85

- Arreglo: algunos archivos epub no se pueden encontrar.
...
- Arreglo: Algunos sitios usan `span` para estilos, así que usamos `font` en lugar de span para el contenedor de destino de la traducción
- Arreglo: límite de tokens máximos de OpenAI, cambiar caracteres máximos de 1500 a 1300.
...
- Arreglo: Conflicto de Mensaje de DingTalk
...
- Arreglo de etiquetas de bloque desconocidas

## 0.2.67

- Función: Añadir `<all>` para traducir siempre idiomas, ahora puedes usarlo para traducir todos los idiomas excepto el idioma de destino, y nunca traducir idiomas
...
- Arreglo: traducción de archivo PDF fallida, error desde 0.2.60 para soportar deepl de zh-CN a zh-TW
...
- Arreglo de traducción de niu de userscript
...
- Arreglo de construcción de userscript
...
- Arreglo de línea de altura de resaltado de marca
...
- Soporte para usar tres dedos en dispositivos táctiles para activar/desactivar la traducción de páginas
...
- Arreglar
  ...
  El contenido principal de la página de Annas archive no se podía traducir
...
- Arreglar la versión compacta móvil de reddit
...
- Publicar en Edge
- arreglar el margen de pdf.
- Cambiar archivo de muestra pdf

## 0.0.62

- Arreglar formato de pdf, sangría.
- Arreglar telegra.ph para evitar el cambio de elemento
...
- refactorizar la marca de elementos
...
- Arreglar tamaño del icono de userscript.
...
- Añadir tema punteado, thinDashed
