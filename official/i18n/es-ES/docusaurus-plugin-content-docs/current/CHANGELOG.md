...
- Añadido: El navegador Android admite traducción de imágenes gratuita.
...
- Nuevo: La traducción de imágenes gratuita ahora está disponible (actualmente solo se admite en las versiones de PC de los navegadores Chrome y Edge), accesible a través del menú del clic derecho.
- Corregido: Se abordó un problema donde se omitía algún contenido durante la traducción de múltiples segmentos en Gemini.
...
- Mejorado: **Image Translation** ahora es compatible con weibo.com (solo se admite en Chrome y Edge).
...
- Mejorado: Se añadió una entrada de revisión de la tienda en las opciones de **Más** en el panel.
...
- Mejorado: Mejora de la entrada y la funcionalidad de pasar el ratón dentro de iframes incrustados en páginas web.
...
- Soporte para configurar excepciones para idiomas y sitios web en modo de contraste bilingüe o solo traducción (configurar en la página de Configuración -> Configuración avanzada). Por ejemplo: Si su modo de traducción predeterminado es contraste bilingüe, pero no desea que el chino tradicional también use contraste bilingüe, entonces puede agregar chino tradicional a los idiomas de excepción para contraste bilingüe, de modo que el chino tradicional usará el modo de solo traducción para la traducción. De manera similar, si su modo de traducción predeterminado es solo traducción, pero desea que un cierto idioma o sitio web use el modo de contraste bilingüe, también puede agregar ese idioma o sitio web a los idiomas de excepción.
...
- Corregido el problema de subtítulos bilingües que no funcionan en Mubi.
...
- Móvil agrega control de gestos, mejorando la entrada a través de [configuración de atajos](https://dash.immersivetranslate.com/#shortcuts)
...
- **Guía para Nuevos Usuarios**: Cuando los nuevos usuarios abren por primera vez una página en un idioma no objetivo, se muestra una burbuja de ayuda de bola flotante.
...
- Corregir problemas de nombre de archivo con la creación de libros electrónicos Epub

## 0.8.8

- Soporte de pdf para ajustes de espaciado de líneas y palabras para volver a reconocer párrafos
- Corrección del problema de desplazamiento automático en la lectura en línea de epub en móviles

## 0.8.7

- Soporte de pdf para descargas de traducción solamente
- Corregir problema de inicio de sesión de Google en safari
...
- Corregir: problema de traducir todas las regiones en Gmail
...
- Corregir problemas de traducción con https://claude.ai/
...
- Corregir icono de Grease Monkey que no se muestra
...
- Corregir epub que no traduce algunos libros

## 0.6.18

- Corregir problema de desbordamiento de ancho de Popup en Safari.
...
- Corregir el problema de que la mejora del cuadro de entrada no está habilitada cuando el sitio está configurado para nunca traducir.
...
- Corregir el problema de traducción repetida al pasar el ratón
- Soporte de traducción de PDF para arrastrar para cambiar el tamaño y editar el contenido de la traducción

## 0.6.12

- Corregir que las imágenes de traducción de Epub se hagan más pequeñas en algunos navegadores
- Optimización de traducción de cuadro de entrada, ahora funciona sin problemas en Bard!

## 0.6.10

- Modelo predeterminado de OpenAI cambiado a la versión 0613
- Corregir algunos estilos de cuadro de entrada
...
- Problemas con archivos de subtítulos de safari que no se reconocen
...
- Corregir el problema de que: los eBooks bilingües no tienen imágenes después de exportar

## 0.5.16

- Corregir: problema de traducción de openai en chino tradicional
...
- Corregir: detalles de Github que no se traducen después de expandir.

## 0.5.14

- Corregir el problema de que las imágenes en algunas páginas web de: se vuelven más grandes después de copiar
- Corregir: sección de comentarios de medium que no se traduce
- Corregido el problema de que las imágenes en algunas páginas de: se copiaron incorrectamente
...
- Característica: Soporte para icono oscuro en firefox
...
- Arreglar: Conflicto de Mensajes de DingTalk
...
- Arreglar algunos span tag es elemento de bloque
