...
- Añadido: Soporte para la traducción de modelo grande de Youdao Ziyue.
...
- Nuevo: La traducción de imágenes gratuita ahora está disponible (actualmente solo compatible en versiones de PC de los navegadores Chrome y Edge), accesible a través del menú del botón derecho.
...
- Añadido: Cuando el texto traducido y el texto original pertenecen al mismo sistema de escritura, mostrar la traducción usando un estilo especializado.
...
- Añadido: La **Traducción de Subtítulos** en tiempo real ahora admite activación a través de "float ball", disponible en Zoom, Google Meet y Microsoft Teams.
...
- Soporte para configurar excepciones para idiomas y sitios web en modo de contraste bilingüe o solo traducción (configurar en la página de Configuración -> Configuración Avanzada). Por ejemplo: Si su modo de traducción predeterminado es contraste bilingüe, pero no desea que el Chino Tradicional también use contraste bilingüe, entonces puede agregar el Chino Tradicional a los idiomas de excepción para contraste bilingüe, de modo que el Chino Tradicional use el modo de solo traducción para la traducción. De manera similar, si su modo de traducción predeterminado es solo traducción, pero desea que un cierto idioma o sitio web use el modo de contraste bilingüe, también puede agregar ese idioma o sitio web a los idiomas de excepción.
...
- Añadida la opción de "Reportar problemas de traducción de la página web actual" y la opción de "Encender/apagar rápidamente el flotador" en más opciones del panel.
...
- Ahora puede reportar rápidamente problemas de traducción de páginas web en el flotador de traducción inmersiva. Después de traducir una página web, si hay algún problema, puede hacer clic en el botón [Feedback] en el lado derecho del flotador, llenar la descripción del problema, y lo resolveremos lo antes posible.
...
- Nuevo botón de retroalimentación de usuario para traducción de manga (después de traducir un manga, haga clic en el botón [Feedback] en el lado derecho del flotador para dar retroalimentación sobre la calidad de la traducción).
...
- Sitios compatibles para traducción de cómics
...
- Nuevos sitios compatibles para traducción de cómics:
...
- Se solucionaron algunas páginas que faltaban traducciones con DeepL
- Se solucionó el tiempo de sincronización multidispositivo de usuarios Pro que no se sincronizaba
- Se optimizaron los problemas de cobertura de configuración de sincronización en la nube
...
- Soporte de traducción bilingüe para Google Docs
...
- Optimizado el problema de visualización de la traducción de subtítulos de video de Twitter CC.
...
- Optimizado el control de frecuencia de las solicitudes del servicio de traducción.
...
- Soporte para la traducción de subtítulos de video para [Kanopy](https://www.kanopy.com/), [RachelsEnglishAcademy](https://www.rachelsenglishacademy.com/), [Hulu](https://www.hulu.com/), [Three.js Journey](https://threejs-journey.com/).
...
- Soporte para la traducción de subtítulos en YouTube Live y la plataforma [Mubi](https://mubi.com/).
...
- **Solucionada la Traducción de Chino Clásico:** Solucionada la funcionalidad de traducción de chino clásico de Microsoft y OpenAI.
- **Optimización de la Traducción Japonesa:** Optimizada aún más la traducción japonesa de OpenAI para mejorar la precisión y fluidez.
...
- Soporte para la traducción de dominios para Baidu Translate.
...
- Reparar clic no responde en la bola flotante de pdf en línea
...
- Ignorar el idioma de nunca traducir al pasar el ratón
...
- Solucionar los saltos de párrafo en algunos casos en:
- Solucionar: Tampermonkey Toggle solo muestra traducciones
- Solucionar: problema de estilo de lectura en línea de eBook que no funciona
...
- Arreglo: openl elegir servicios de traducción
...
- Soporte para establecer la primera x cantidad de texto para traducir inmediatamente.
