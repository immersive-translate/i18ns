...
- Añadido: Gestión de biblioteca de terminología AI
- Añadido: La versión para PC admite la función de traducción de selección de texto (no userscript)
- Añadido: Soporte para habilitar subtítulos AI de Youtube en PC (miembros Pro)
- Añadido: El plugin de Safari admite compras dentro de la aplicación
...
- Corregido: Un problema donde la tecla de acceso rápido de traducción al pasar el ratón no funcionaba en dispositivos que admiten tanto ratón como táctil.
...
- Optimizado: El servicio de traducción Gemini admite aviso de sistema personalizado (System Prompt).
- Optimizado: Mejorada la velocidad del userscript.

## 1.15.2 Release (2025-03-02)

- Añadido: Gemini admite portugués (Brasil).
- Añadido: Servicios de traducción Grok, Ollama, Groq, Azure-OpenAI.
...
- Optimizado: [Traducción de imágenes gratuita] admite formato para idiomas de derecha a izquierda.
- Optimizado: Compatible con modelos como o1, o3 que no admiten rol de sistema (el parámetro de rol de sistema no se pasará cuando la configuración de System Prompt esté vacía).

## 1.14.16 Release (2025-02-21)

- Añadido: Deepseek, Gemini, Claude admiten cambio de contexto.
...
- Mejorado: Pausar la traducción borra inmediatamente la cola de solicitudes.
...
- Corregido: Resuelto problema de archivo de configuración de usuario que excede el límite de tamaño.
- Mejorado: El elemento del menú del botón derecho puede cerrarse (operado en configuraciones avanzadas).
...
- Mejorado: La versión de Tampermonkey ahora admite traducción de subtítulos de YouTube.
...
- Nuevo: La traducción de imágenes gratuita ahora está disponible (actualmente solo compatible en versiones para PC de los navegadores Chrome y Edge), accesible a través del menú del botón derecho.
...
- Mejorado: **Traducción de Imágenes** ahora es compatible con weibo.com (solo compatible en Chrome y Edge).
...
- Mejorado: Admite estilo en negrita en modo solo traducción.
...
- Mejorado: Para Twitter, las traducciones de contenido de varias líneas están configuradas para no ajustarse por defecto. El ajuste solo ocurrirá cuando el contenido exceda las 10 líneas o 1000 caracteres. El ajuste se puede habilitar a través de configuraciones **Configuraciones Avanzadas** -> **Habilitar ajuste automático de línea para párrafos largos**.
...
- Corregido: el problema de los números decimales siendo forzadamente cortados al traducir textos largos.
...
- Añadido: **AI Context-Aware Translation** puede mejorar la precisión de la traducción de contenido profesional. (Disponible solo para miembros Pro, soportado exclusivamente por modelos de OpenAI) **Opciones** -> **General** -> **Habilitar AI Context-Aware Translation**
...
- Mejorado: Las imágenes ya no se traducen en el modo "**Hover - traducir inmediatamente este párrafo**".
...
- Añadido: La **Traducción de Subtítulos** en reuniones en tiempo real ahora admite activación a través de "bola flotante", disponible en Zoom, Google Meet y Microsoft Teams.
...
- Mejorado: Reducción del tamaño del paquete de instalación.
- Mejorado: Solución de visualización de subtítulos en Netflix.
...
- Soporte para configurar excepciones para idiomas y sitios web en modo de contraste bilingüe o solo traducción (configurar en la página de Configuración -> Configuración Avanzada). Por ejemplo: Si su modo de traducción predeterminado es contraste bilingüe, pero no desea que el chino tradicional también use contraste bilingüe, entonces puede agregar chino tradicional a los idiomas de excepción para contraste bilingüe, de modo que el chino tradicional use el modo solo traducción para la traducción. De manera similar, si su modo de traducción predeterminado es solo traducción, pero desea que un cierto idioma o sitio web use el modo de contraste bilingüe, también puede agregar ese idioma o sitio web a los idiomas de excepción.
...
- Optimización del rendimiento de traducción de texto enriquecido.

## 1.8.3

- Google Meet ahora admite subtítulos bilingües para reuniones en vivo: Ahora, puede disfrutar de la función de subtítulos bilingües en reuniones de Google Meet. Simplemente abra el enlace de la reunión, active los subtítulos bilingües en el panel de traducción inmersiva y luego actualice la página para experimentarlo.
...
- Optimización de la lógica de caché del complemento, ahora limpiando automáticamente los datos de caché que tienen más de 30 días.
- Optimización de bloques de código dentro de párrafos para una restauración más precisa del texto original.
- Mejora en el manejo de "palabras no traducibles" en configuraciones avanzadas.

## 1.8.2

- Ahora puede traducir texto en cuadros de entrada con el clic derecho: Seleccione cualquier texto en un cuadro de entrada en una página web, haga clic derecho para elegir traducir, y la traducción inmersiva traducirá automáticamente el texto seleccionado al idioma de destino del cuadro de entrada, facilitando la traducción rápida de texto en idioma nativo en cuadros de entrada a otros idiomas.
...
- Optimización de subtítulos bilingües para la versión en inglés de iQIYI (iq.com).
...
- Optimización de la detección para traducciones de artículos de arXiv.
...
- Añadido traducción de gran modelo Zero-One-Thing, que se puede usar completando la clave API después de registrarse en la plataforma Zero-One-Thing.
...
- Optimizar la traducción al hacer clic derecho a "Traducir a xx idioma de destino".
- Soporte para la integración del [JS SDK](https://immersivetranslate.com/docs/js-sdk/) inmersivo para sitios web de terceros.
- Optimización de la visualización de subtítulos de Hulu.
- Soporte para traducción de subtítulos de reuniones de la versión web de ZOOM.

## 1.7.6

- Soporte para personalizar expertos de IA, la entrada está en la parte inferior de la página [Configuración]->[Experto en IA].
- Optimización de la carga de subtítulos en el sitio de TED.
...
- Optimización de la visualización de subtítulos en algunos sitios de video.
- Mejora de la velocidad de traducción de manga.
...
- Mejora de la velocidad de traducción para traducciones de cómics.
...
- Nueva función: Soporte para modo de comparación bilingüe con traducción primero y texto original después, que se puede habilitar en la página de configuración -> configuraciones avanzadas.
...
- Solucionado el problema donde la bola flotante de atajo no podía traducir en iOS 18.
...
- Solucionado el problema donde modificar el idioma de destino y otras configuraciones en el panel emergente se restablecía al hacer clic en la bola flotante de traducción.
...
- Optimizado los problemas de cobertura de configuración de sincronización en la nube
- Optimizado las palabras de prompt para los servicios de traducción de IA
...
- Optimizado la inconsistencia en el diseño de las traducciones en algunos casos.
...
- Optimizado la copia de la interfaz en chino tradicional.
...
- Soporte para [VK Video](https://vk.com/video) subtítulos bilingües
...
- Optimizado los mensajes de error para traducir subtítulos bilingües locales

## 1.4.11

- Compatible con la traducción del cuadro de entrada de la página de Bing Copilot
- El control de estilo de subtítulos de YouTube soporta estilo de borde
...
- Se ha introducido un nuevo atajo para traducción temporal llamado Claude, que se puede configurar en la [página de Configuración de Atajos](https://dash.immersivetranslate.com/#shortcuts).
...
- Optimizado el reconocimiento de idioma de la extensión
...
- El servicio de traducción Gemini está oculto por defecto, se puede habilitar en configuraciones de desarrollador para mostrar la beta de este servicio de traducción

## 1.3.4

## 1.3.3

- Optimizado el problema de visualización de traducciones en los subtítulos de video de Twitter CC.
...
- Soporte para la plataforma de subtítulos de video [DeepLearning.ai](https://learn.deeplearning.ai)
...
- Optimizadas las ventanas emergentes de error, las ventanas emergentes de error de problemas de red detectan automáticamente servicios de traducción gratuitos válidos.
...
- Optimizada la interfaz de usuario de las ventanas emergentes de error.
...
- **Entrada de traducción de documentos integrada:** Ahora, puedes traducir archivos PDF, ePub y de subtítulos a través de una entrada de carga unificada. Simplemente haz clic en el botón [PDF/ePub] en el panel emergente, ya no es necesario seleccionar [Más].
...
- **Optimización de UI**: Rediseñada la UI para los mensajes de error de traducción de página para hacerlos más comprensibles. Cuando hay muchos errores, un pop-up avisará activamente al usuario.
...
- **Eliminación de Funciones**: Eliminada la función de mejora de información bilingüe (mostrando resultados de búsqueda en inglés en páginas de búsqueda de Google simultáneamente).
...
- Corrección: Problema de reconocimiento del idioma objetivo predeterminado en algunas máquinas después de la primera instalación.
- Optimización: El orden predeterminado de los títulos de las páginas web se cambió a [Chino - Inglés].
...
- Corregido: El problema donde la caché aún existe después de modificar el aviso/modelo en OpenAI.
...
- Corregido [Cuando se activa temporalmente la traducción de páginas web durante mucho tiempo, al hacer clic en el panel [Siempre traducir este sitio web] no se cancela la traducción siempre #1172](https://github.com/immersive-translate/immersive-translate/issues/1172)
...
- Corregir la creación de Epub al hacer clic en las traducciones del panel que no funcionan
...
- Proporciona acceso rápido a versiones bilingües de todos los artículos en el sitio de artículos [Arxiv](https://arxiv.org/abs/1910.06709).
...
- Resuelto el problema de que algunas plataformas no podían reconocer si el ratón era compatible o no
  - Hay algunos navegadores de escritorio que soportan tanto pantalla táctil como ratón, y Immersive Translates no puede detectar técnicamente si tales plataformas soportan ratón, por lo que hemos añadido la opción [Forzar Habilitar Soporte de Ratón] en la configuración de [Pasar el Ratón]
...
- Optimizado el Aviso en Chino para OpenAI, ¡ahora menos propenso a alucinaciones!
- Reducida la longitud de los avisos de OpenAI de 90 a 40, ahorrando aún más tráfico.

## 0.11.0

- Corregir clics temblorosos de bola flotante en la página
...
- Soporte de pasar el ratón para presionar Ctrl nuevamente para mostrar el texto original
...
- Soporte de resultados de traducción de soporte mejorado de entrada ctrl+z Deshacer
...
- Soporte de mejora de búsqueda, cuando está habilitado, cuando buscas en Google/Google News en chino, la columna derecha mostrará automáticamente los resultados de búsqueda de palabras clave en inglés correspondientes, que está habilitado por defecto.
...
- Solucionar el problema de que la mejora del cuadro de entrada no se habilita cuando el sitio está configurado para nunca traducir.
...
- Optimización de la traducción del cuadro de entrada, ¡ahora funciona sin problemas en Bard!
...
- Arreglar: problema de traducción de openai en chino tradicional

## 0.5.15

- Optimizar: El número mínimo de caracteres en un párrafo que desencadena la traducción se modificó a un mínimo de 4 caracteres para reducir la confusión, mientras se utilizan otras características para evitar traducir las áreas de navegación y final del sitio.
- Arreglar: detalles de Github no se traducen después de expandir.

## 0.5.14

- Arreglar el problema de que las imágenes en algunas páginas web de: se agrandan después de copiar
- Arreglar: sección de comentarios de medium no se traduce
- Arreglar el problema de que las imágenes en algunas páginas de: se copiaron incorrectamente
...
- Arreglar: Casos muy raros de división de párrafos.
...
- Arreglar: Algunos elementos no son reconocidos al pasar el ratón
- Arreglar: saltos de línea parciales en tweets no reconocidos
- Arreglar: estilo de autoría de eBook no funciona

## 0.5.10

- Arreglar: saltos de línea en tweets no reconocidos
- Arreglar: página de detalles de Reddit devuelve algunos párrafos que no se pueden traducir
- Arreglar un problema con: donde algunas de las etiquetas de código no se reconocían correctamente.

## 0.5.9

- Arreglar saltos de párrafo en algunos casos en:
- Arreglar: Tampermonkey Toggle solo muestra traducciones
- Arreglar: problema de estilo de lectura en línea de eBook no funciona

## 0.5.8

- Arreglar el problema de que: la configuración temporal de la duración de la traducción del sitio web no surte efecto.
...
- Arreglar el problema de pantalla blanca después de la traducción de sitios web con hidratación como Next.js.

  - Por ejemplo: https://webpack.js.org/

- Arreglar el problema de que modificar el atajo de pasar el ratón necesitaba actualizar la página para surtir efecto

- Arreglar un problema con el reconocimiento de saltos de línea en archivos TXT.
...
- Arreglar el problema de pantalla blanca después de traducir sitios web con hidratación, como Next.js

- Arreglar el problema donde cambiar el atajo de pasar el ratón requería una actualización de la página para surtir efecto

- Arreglar el problema con el reconocimiento de saltos de línea en archivos TXT.

## 0.5.6

- Arreglar: problema de ventana emergente de nueva pestaña en macOS.
- Función: Nueva página de guía para nuevos usuarios.

## 0.5.5

- Arreglar: problema de área de pasar el ratón.

## 0.5.4

- Arreglar: Página Spa duplicada

## 0.5.3

- Arreglar: oyente de tecla de acceso rápido de pasar el ratón.
- Arreglar: traducir documento PDF
- Función: Agregar nueva página de guía para clientes

## 0.5.2

- Arreglar: configuración de atajos de pasar el ratón en userscript

## 0.5.1

- Arreglar: OpenAI API no funciona.
...
- Arreglar: Desactivar el menú contextual no funciona [#428](https://github.com/immersive-translate/immersive-translate/issues/428)
- Arreglar: Evitar la política de seguridad de contenido para [Mastondon](https://mastodon.social/)

## 0.4.11

- Arreglar: permiso de userscript (solo para userscript).

## 0.4.8

- Función: Traducir de Bing a Microsoft Translate para una calidad más estable.
- Arreglar: Página web de texto puro como [esta](https://edoras.sdsu.edu/~vinge/misc/singularity.html)
- Rendimiento: Excluir algunas páginas de publicidad secundaria en el sitio web, y el rendimiento ha mejorado un poco

## 0.4.7

- Arreglar: Falta de ventana emergente de Userscript en Firefox.
...
- Arreglar: problema de extensión de safari en iOS 15.0.
- Arreglar: atajos de extensión de safari en macOS
- Arreglar: política de seguridad de contenido emergente para extensión, y parcialmente para userscript.
...
- Arreglar: detección de espacios en blanco en etiquetas sup, sub.
...
- Arreglar: el menú contextual de Firefox desaparece después de reiniciar.
...
- Arreglar: El menú contextual puede no estar disponible a veces. [#273](https://github.com/immersive-translate/immersive-translate/issues/273)

## 0.3.16

- Arreglar: mantener &nbsp; como espacio en blanco.
...
- Arreglar: color de fondo de selección de pdf
- Arreglar: detección de espacios en blanco

## 0.3.13

- Arreglar: problema de caracteres específicos del constructor de ebooks, como algunas rutas de capítulos son `xxx' xxxx`.
- UI: plegar opciones personalizadas de openai por defecto.
- UI: Agregar estado de exportación para exportación de epub.
- Arreglar: mensaje predeterminado de Gpt4

## 0.3.12

- Función: Ahora podemos personalizar el color de fondo del tema de traducción de marcador.
- Arreglar: postMessage cuando la página de inicio rompía algunos sitios, ahora solo lo haremos cuando realmente traduzcamos páginas
- Arreglar: problema de progreso de ebook.
- Arreglar: mejor para dividir párrafos largos, 1.5 mil millones, 25.5%, Sr. no se considerará como un límite

## 0.3.11

- Arreglar: color de texto en modo oscuro del lector de ebooks
- Arreglar: mensaje de openAI

## 0.3.10

- Mejor: detectar contenedor japonés/coreano.
- Arreglar: Progreso del constructor de ebooks detenido al 99%.

## 0.3.9

- Arreglar: el estado de entrada de servicios de traducción de interruptor de UI de opciones no cambió.

## 0.3.8

- UI: color de carga más transparente
- Arreglar: Detectar idioma de ebook.
...
- Arreglar: Manejo de errores de Deepl

## 0.3.7

- Arreglar: el lector de ebooks no puede cargar imágenes en Chrome.
...
- Arreglar: exportación de ebook de userscript
...
- Arreglar: creador de ebooks para Kindle
...
- Arreglar: movimiento del cursor de entrada del formulario de opciones.
...
- Arreglar: Orden incorrecto para párrafo largo
...
- Corregir: identificador de ebook duplicado
- Característica: Soporte para traducción de páginas web en formato txt

## 0.2.85

- Corregir: algunos archivos epub no se pueden encontrar.
...
- Corregir: Algunos sitios usan `span` para estilos, así que usamos `font` en lugar de span para el contenedor de destino de la traducción
- Corregir: límite de tokens máximos de OpenAI, cambiar caracteres máximos de 1500 a 1300.

## 0.2.81

- Corregir: m.youtube.com
- Corregir: opciones de formulario UI
- Corregir: Open AI prompt
- Característica: Soporte para múltiples claves de OpenAI, usar `,` para separarlas.

## 0.2.80

- Característica: Añadir Menú de Activar/Desactivar para el popup -> más
- Corregir: Conflicto de Mensajes de DingTalk

## 0.2.79

- Corregir: Open AI para párrafo con espacio

## 0.2.78

- Característica: soporte para OpenAI CHATGPT 3.5 (soporta la interfaz de OpenAI ChatGPT 3.5)
- Característica: Añadir nuevo tema Solid Border (nuevo tema, borde sólido)

## 0.2.77

- Corregir: error de múltiples etiquetas de código.[#178](https://github.com/immersive-translate/immersive-translate/issues/178)
...
- Característica: Soporte para contar texto de traducción inmediata personalizada para diferentes servicios de traducción.

## 0.2.74

- Característica: Soporte para Tencent (alpha)
- Corregir: traducción de openai
- Corregir: verificación de etiquetas desconocidas en línea

## 0.2.73

- Característica: Soporte para Tema de Traducción Gris
- Corregir: Página de Tendencias de Github

## 0.2.72

- Corregir: problema de red de verificación del servicio de traducción en firefox móvil.

## 0.2.71

- Corregir: permiso de userscript de Open AI

## 0.2.70

- Corregir: marcador de posición de Open AI
...
- Característica: Soporte para marco principal personalizado porque algunos sitios no usan body como marco principal

## 0.2.68

- Soporte para Caiyun (Alpha)
- Corregir etiquetas de bloque desconocidas

## 0.2.67

- Característica: Añadir `<all>` para traducir siempre idiomas, ahora puedes usarlo para traducir todos los idiomas excepto el idioma de destino, y nunca traducir idiomas
- Corregir: Permitir configurar API de google personalizada
- Mejor: Soporte gratuito de Deepl
- Corregir: alto uso de memoria para userscripts y extensión (eliminando opencc zh-CN a zh-TW, en su lugar con Google translate)
- Corregir: Relingo [#159] (https://github.com/immersive-translate/immersive-translate/issues/159)
- Corregir: configuración de traducción de Azure pero aún muestra (necesita configuración)

## 0.2.66

- Corregir: traducción de archivo PDF fallida, error desde 0.2.60 por soportar deepl de zh-CN a zh-TW
...
- Corregir: elegir servicios de traducción de openl
- Característica: Soporte para opción de traducir título

## 0.2.63

- Característica: Soporte para Servicio de Traducción de Azure
- Característica: Soporte para Servicio de Traducción de Papago
- Corregir: sincronización de google drive en android nativo de firefox.
- Corregir: cambiar transparencia de 0.4 a 0.618 [#147] (https://github.com/immersive-translate/immersive-translate/pull/147)
- Corregir: consejos de atajos en el popup
- Rendimiento: solicitudes de serie a concurrencia
- Mejor para detectar conteo de japonés

## 0.2.62

- Característica: Añadir regla de waitForSelectors, para corregir algunos sitios como reddit

## 0.2.61

- Corregir: userscript es demasiado grande para greasy fork
- Mejor: reducir tamaño de archivo

## 0.2.60

- Característica: Soporte para zh-CN a zh-TW para Deepl
- Característica: Función de Deepl de Immersive Translate
- Característica: Soporte para zoom de tamaño de fuente personalizado
- Corregir: estilo del foro de Steam
- Corregir: estilo global no cambiado después de generar elementos dinámicos
- Corregir: promover prioridad de exclusión
- UI: cambio de página sobre
- Corregir: algunos elementos matemáticos permanecen originales

## 0.2.59

- Corregir: Elemento de Bloque de Etiquetas Desconocidas
- Corregir: elemento translate=no anula
- Corregir: coincidencia de url con múltiples \*

## 0.2.58

- Característica: Soporte para color de texto de traducción personalizado, color de borde.
...
- Corregir traducción duplicada para elementos en línea con elemento de código.
- Corregir verificación de etiquetas desconocidas en línea/bloque
- Característica: soporte para css inyectado en el tablero de desarrolladores
- Característica: recortar authKey, appid appSecret
- Mejor: abrir página de configuración en nueva pestaña (pero no para Stay)

## 0.2.55

- Intentar corregir charset de api de deepl

## 0.2.54

- Eliminar permiso de pestañas para rechazo de tienda de chrome
- Corregir traducir toda la página, el pie de página se ignora
- Añadir notas a la página sobre
- Soporte para url personalizada desde Configuración incorporada

## 0.2.53

- Corregir error de sincronización de google drive en userscript.
...
- Corregir Necesidad de Autenticación de Google en Chrome/Firefox
...
- Corregir problema de carga de google drive (realmente) [#81](https://github.com/immersive-translate/immersive-translate/issues/81)

## 0.2.49

- Eliminar atajos alt+d, alt+s porque pueden entrar en conflicto con atajos nativos.
- Corregir problema de carga de google drive [#81](https://github.com/immersive-translate/immersive-translate/issues/81)

## 0.2.48

- Mejor para velocidad, añadiendo minLength a 50 para detección de idioma.
- Corregir validación de token de Google Drive.

## 0.2.47

- Corregir api de deepl
...
- Corregir innerText de elemento es indefinido
- Corregir idioma fuente indefinido en traducción de caiyun

## 0.2.44

- Corregir alternar máscara de userscript
- Corregir lógica de alternar máscara

## 0.2.43

- Corregir alternar máscara de userscript con evento táctil.
- Corregir velocidad (eliminando sleep(300))

## 0.2.42

- Corregir hover de máscara al alternar máscara de nuevo.
- Añadir atajos de máscara para móvil
- Corregir problema de sincronización en la nube de userscript
- Mover página de opción avanzada al menú de la izquierda.
- Añadir lógica de reintento al servicio de traducción

## 0.2.41

- Corregir traducción de niu en userscript
- Corregir traducción de xhtml

## 0.2.40

- Corregir mostrar característica beta
- Corregir página de configuración de popup en nueva pestaña
- Corregir reemplazo de marcador de posición de traducción

## 0.2.39

- Soporte para atajos para mostrar traducción de máscara
- Soporte para habilitar característica beta en panel de desarrollador
- Corregir atajos en extensión móvil

## 0.2.38

- Soporte para tema de carga
- Corregir getpocket.com
- Corregir pie de página para área de cuerpo
- Corregir icono de importación/exportación

## 0.2.37

- Corregir marca de exclusión de marco
...
- Corregir ignorar etiquetas rb, rt en japonés.
- Mejor para UI de popup más
- Mejor para consejos de userscript malos
- Añadir contribución a la página sobre
- Corregir volc translate para detección automática de idioma

## 0.2.34

- Corregir velocidad de múltiples idiomas
...
- Corregir traducción básica de PDF
- Corregir selección de popup de un servicio no configurado, ir a la página de opciones.
- Corregir permanecer abierta la configuración.
- Corregir velocidad de detección de múltiples idiomas

## 0.2.31

- Corregir inyección de css en iframe dinámico
...
- Corregir traducción de Facebook
...
- Soporte para traducción de iframe en línea. (Solo para extensión, no disponible para
  userscript)
- Corregir traducción de múltiples idiomas

## 0.2.26

- Corregir addon de firefox android
...
- Corregir API de navegador de userscript de stay.app
- Corregir página de opciones de stay.app

## 0.2.23

- Corregir traducción de página de múltiples idiomas

## 0.2.22

- Corregir compilación de userscript

## 0.2.21

- Corregir traducción de pdf en línea de firefox

## 0.2.20

- Corregir problema de solicitud de macaco
- Corregir marca de línea de resaltado

## 0.2.19

- Corregir japonés inteligente de tencent
- Corregir navegador de mundo haikuo

## 0.2.18

- Corregir cambio de url de cliente, auto mantener el estado de traducción.
...
- Corregir problema de rebote táctil
...
- Arreglar cambio de elemento de prevención en telegra.ph
