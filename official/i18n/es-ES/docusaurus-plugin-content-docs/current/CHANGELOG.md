...
- Optimizado: El servicio de traducción Gemini soporta un aviso del sistema personalizado (System Prompt).
...
- Optimizado: [Traducción de imágenes gratuita] soporta el formato para idiomas de derecha a izquierda.
- Optimizado: Compatible con modelos como o1, o3 que no soportan el rol del sistema (el parámetro del rol del sistema no se pasará cuando la configuración del System Prompt esté vacía).

## 1.14.16 Release (2025-02-21)

- Añadido: Deepseek, Gemini, Claude soportan el cambio de contexto.
...
- Corregido: Resuelto el problema del archivo de configuración del usuario que excede el límite de tamaño.
...
- Mejorado: Acceso a la interfaz de prueba del servicio de la página de configuraciones en línea.
...
- Nuevo: La traducción de imágenes gratuita ahora está disponible (actualmente solo soportada en las versiones de PC de los navegadores Chrome y Edge), accesible a través del menú del clic derecho.
...
- Mejorado: Añadida una entrada de revisión de la tienda en las opciones **More** en el panel.

## 1.13.5 Release (2025-01-14)

- Mejorado: Compatible con el modelo de pensamiento Gemini 2.0.
- Mejorado: Soporta estilo en negrita en el modo solo traducción.
...
- Añadido: La **Subtitles Translation** en reuniones en tiempo real ahora soporta activación a través de "float ball", disponible en Zoom, Google Meet y Microsoft Teams.
...
- Por defecto, el sistema recordará el modo alternado al hacer clic en el icono en el panel para comparación bilingüe o solo traducción. Para cambiar temporalmente, haga clic en "Más" -> "Cambiar a solo traducción" en el panel.
...
- Los subtítulos bilingües de YouTube ahora soportan división inteligente de oraciones (Beta) (Solo cuando se habilita manualmente la traducción inmersiva de subtítulos de YouTube en [Configuración] - [Subtítulos de Video], y los subtítulos originales del video son subtítulos en inglés autogenerados)
...
- Se solucionó el problema de sincronización de tiempo en múltiples dispositivos para usuarios Pro
...
- Se optimizaron las palabras de prompt de OpenAI multi-prompt, admitiendo formato YAML, lo que mejora la flexibilidad y facilidad de uso de la configuración
...
- Optimización de las ventanas emergentes de error, las ventanas emergentes de error de problemas de red detectan automáticamente servicios de traducción gratuitos válidos.
...
- Optimización: Página de configuración, interfaz de usuario de la lista de URL (para evitar ambigüedades, las casillas de verificación no se muestran por defecto).
...
- **Entrada de traducción de documentos integrada:** Ahora, puedes traducir archivos PDF, ePub y subtítulos a través de una entrada de carga unificada. Simplemente haz clic en el botón [PDF/ePub] en el panel emergente, no es necesario seleccionar [Más] más.
...
- **Actualización de la Interfaz de Usuario de la Página de Configuración del Plugin**:

  - En "Configuración Avanzada", se ha añadido una nueva opción para permitir a los usuarios especificar ciertas palabras (por ejemplo, "LLM") para ser excluidas de la traducción.
...
- **Optimización de la Interfaz de Usuario**: Rediseñada la interfaz de usuario para los mensajes de error de traducción de página para hacerlos más fáciles de entender. Cuando hay muchos errores, aparecerá una ventana emergente para alertar al usuario.
...
- **Eliminación de Características**: Eliminada la función de mejora de información bilingüe (mostrando resultados de búsqueda en inglés en las páginas de búsqueda de Google simultáneamente).

### Otras Actualizaciones

- **openAI Configuration Update**: Ahora admite configurar el número de configuraciones por segundo en decimales, como 0.5, lo que significa 1 solicitud cada 2 segundos.

## 0.12.14

- Solución: El problema de reconocimiento del idioma de destino predeterminado en algunas máquinas después de la primera instalación.
...
- Solucionado: El problema donde la caché aún existe después de modificar el prompt/modelo en OpenAI.
...
- Solucionado: Resuelto el problema donde los títulos en la página de lista de jstor no se traducían [#1268](https://github.com/immersive-translate/immersive-translate/issues/1268).
- Solucionado: Arreglado el problema donde solo parte del contenido desaparecía en Hacknews [#1264](https://github.com/immersive-translate/immersive-translate/issues/1264).
...
- Solucionado el problema de autorización del dominio Gemini bajo el script de Tampermonkey.
...
- Solucionado el problema donde las traducciones no respondían a tiempo cuando la página web se desplazaba a la posición media en algunos casos.
- Solucionado el error donde el cambio de subtítulos en algunos sitios web de video causaba que la traducción se mostrara repetidamente.
- Solucionado el problema donde el ratón se desplazaba para continuar traduciendo sin mantener presionada la tecla de acceso rápido en algunos casos.
...
- Solucionado [Cuando se activa temporalmente la traducción de la página web durante un tiempo prolongado, al hacer clic en el panel [Siempre traducir este sitio web] no se cancela la traducción siempre #1172](https://github.com/immersive-translate/immersive-translate/issues/1172)
...
- Solucionar el problema de clics temblorosos del panel de acción de la bola flotante de la página de Firefox.
- Soporte para colaboración bajo el sitio pubmed.ncbi.nlm.nih.gov y el complemento scholarscope
- Solucionar el problema de temblor de la página de traducción del cuadro de entrada de reddit

## 0.12.6

- Solucionar el problema de que la traducción de YouTube/Web of Science, etc. no es sensible al cambiar de pestañas.
...
- Solucionar el problema de que al crear eBooks desde el panel, las traducciones no funcionan
...
- [Solucionar problema de visualización del Modo de Aprendizaje #1180](https://github.com/immersive-translate/immersive-translate/issues/1180)
...
- Solución para la función [desactivar permanentemente subtítulos de video] que no funciona [#1175](https://github.com/immersive-translate/immersive-translate/issues/1175)
...
- Solucionar problemas de descarga extendida de PDF
...
- Solucionar algunos problemas de mejora del cuadro de entrada en Safari
...
- Solucionar emoji al final del cuadro de entrada de Twitter que no se puede traducir
- Solucionar la situación donde el contenido de complementos de terceros se traduce en algunos escenarios
...
- Optimizar experiencia, solucionar algunos errores
...
- Solucionar clics temblorosos de la bola flotante de la página
- Solucionar problemas de traducción de Azure
...
- Solucionar traducción de archivos txt

## 0.10.7

- Soporte de desplazamiento del ratón presionando Ctrl nuevamente para mostrar el texto original
- Desplazamiento del ratón Ignorar Nunca Traducir Idioma
...
- Solucionar el problema de que los archivos txt locales no se pueden traducir

## 0.10.5

- Solucionar que Youtube ocasionalmente regrese a la página de inicio

## 0.10.4

- Solucionar conflicto de subtítulos de Youtube con el complemento de subtítulos duales (Immersive Translate de traducción de subtítulos de Youtube no está habilitado cuando se detecta el complemento dual de Youtube para evitar conflictos)
...
- Solucionar problema de traducción de clave de autenticación personalizada de DeppL
...
- Optimizar la contextualización de la traducción de archivos de subtítulos de OpenAI
...
- Corregido el borrado de la caché al cerrar la sesión del usuario.
...
- Optimizar la detección de mejoras de entrada para reducir toques falsos
...
- Optimización de la velocidad de exportación de traducción solo en PDF, si eliges exportar solo la traducción, puedes llamar directamente a la vista previa de PDF del sistema para exportar, más rápido.
...
- Permite establecer el intervalo entre los disparadores de combinación de mejoras de entrada
...
- Corregir algunos otros problemas
...
- ¡Finalmente, PDF admite la exportación de versiones bilingües! Puedes hacer clic en el botón [Guardar] para exportar el archivo PDF bilingüe traducido.
...
- Optimizar la selección de idioma objetivo, ahora solo mostrará los idiomas admitidos por el servicio de traducción correspondiente
- Optimización de traducción de PDF
...
La mejora de cuadro de entrada más emocionante está aquí:
...
- Solución: los saltos de línea parciales en tweets no son reconocidos
- Solución: el estilo de creación de eBooks no funciona

## 0.5.10

- Solución: los saltos de línea en tweets no son reconocidos
...
- Soluciona los saltos de párrafo en algunos casos en:
- Solución: Tampermonkey Toggle solo muestra traducciones
- Solución: problema de estilo de lectura en línea de eBooks

## 0.5.8

- Soluciona el problema de que: la configuración temporal de la duración de la traducción del sitio web no surte efecto.

## 0.5.7

- ¡Super actualización!

- ¡La función de Mostrar Solo Traducciones está aquí! Haz clic en [Más] -> [Cambiar para mostrar solo traducciones].

  - Soporte para atajos personalizados, configurados en configuración de interfaz -> Configuración de atajos

- Optimización del problema de limitación de frecuencia de solicitudes de OpenAI
...
- Soluciona el problema de pantalla blanca después de la traducción de sitios web con hidratación como Next.js.
...
- Solución: problema de ventana emergente de nueva pestaña en macOS.
- Función: Nueva página de guía para nuevos usuarios.

## 0.5.5

- Solución: problema de área de pasar el ratón.

## 0.5.4

- Solución: Página Spa duplicada

## 0.5.3

- Solución: oyente de tecla de acceso rápido al pasar el ratón.
- Solución: traducir documento PDF
- Función: Añadir nueva página de guía para clientes

## 0.5.2

- Solución: configuración de atajos de pasar el ratón en userscript

## 0.5.1

- Solución: OpenAI API no funciona.
...
- Solución: Desactivar el menú contextual no funciona [#428](https://github.com/immersive-translate/immersive-translate/issues/428)
- Solución: Evitar la Política de Seguridad de Contenidos para [Mastondon](https://mastodon.social/)

## 0.4.11

- Solución: permiso de userscript (solo para userscript).

## 0.4.8

- Función: Traducir de Bing Translate a Microsoft Translate para una calidad más estable.
- Solución: Página web TXT pura como [esta](https://edoras.sdsu.edu/~vinge/misc/singularity.html)
- Rendimiento: Excluir algunas páginas de publicidad secundaria en el sitio web, y el rendimiento ha mejorado un poco

## 0.4.7

- Solución: Falta de ventana emergente de Userscript en Firefox.
...
- Solución: problema de extensión de safari en iOS 15.0.
- Solución: atajos de extensión de safari en macOS
- Solución: política de seguridad de contenido emergente para extensión, y parcialmente para userscript.
...
- Solución: detección de espacios en blanco en etiquetas sup, sub.
- Función: soporte para ChatGPT Plus Website como Servicio de Traducción, Esta es una función beta, por lo que puedes acceder a ella habilitando la Función Beta en la configuración de desarrollador. Esto es muy lento, porque chatgpt solo puede enviar una solicitud a la vez. Asegúrate de tener una Cuenta Plus de ChatGPT, porque hay más limitaciones en la Cuenta Gratuita, y no estoy seguro si esto trae riesgo para tu cuenta, ten cuidado de Asegúrate de tener una Cuenta Plus de ChatGPT, porque hay más limitaciones en la Cuenta Gratuita, y no estoy seguro si esto trae riesgo para tu cuenta, ten cuidado al usarlo.

## 0.4.1

- Solución: el menú contextual de Firefox desaparece después de reiniciar.
...
- Solución: El menú contextual puede no estar disponible a veces. [#273](https://github.com/immersive-translate/immersive-translate/issues/273)

## 0.3.16

- Solución: mantener &nbsp; como espacio en blanco.
...
- Solución: color de fondo de selección de pdf
- Solución: detección de espacios en blanco

## 0.3.13

- Solución: problema de caracteres específicos del constructor de eBooks, como algunas rutas de capítulos son `xxx' xxxx`.
- UI: plegar opciones personalizadas de openai por defecto.
- UI: Añadir estado de exportación para exportación de epub.
- Solución: mensaje predeterminado de Gpt4

## 0.3.12

- Función: Ahora podemos personalizar el color de fondo del tema de traducción de Marcador.
- Solución: postMessage cuando la página de inicio rompía algunos sitios, ahora haremos esto solo cuando realmente traduzcamos páginas
- Solución: problema de progreso de eBook.
- Solución: mejor para dividir párrafos largos, 1.5 mil millones, 25.5%, Sr. no se considerará como un límite

## 0.3.11

- Solución: color de texto en modo oscuro del lector de eBooks
- Solución: mensaje de openAI

## 0.3.10

- Mejor: detectar contenedor japonés/coreano.
- Solución: Progreso del Constructor de eBooks detenido al 99%.

## 0.3.9

- Solución: el estado de entrada de servicios de traducción de interruptor de UI de Opciones no cambió.

## 0.3.8

- UI: color de carga más transparente
- Solución: Detectar idioma de eBook.
- Función: Añadir progreso de traducción para el constructor de eBooks, y un hermoso confeti después del éxito.
- Función: Añadir reintento de todos los párrafos fallidos para el botón de reintento.
- Solución: Manejo de errores de Deepl

## 0.3.7

- Solución: el lector de eBooks no puede cargar imágenes en Chrome.
...
- Solución: exportación de eBooks en userscript
...
- Solución: creador de eBooks para Kindle
...
- Solución: movimiento del cursor de entrada del formulario de Opciones.
...
- Solución: Orden incorrecto para párrafo largo
...
- Función: Soporte para icono oscuro en firefox
...
- Solución: Algunos sitios usan `span` para estilos, por lo que usamos `font` en lugar de span para el contenedor de objetivo de traducción
...
- Arreglar: fallo en la traducción de archivos PDF, error de la versión 0.2.60 por soportar deepl de zh-CN a zh-TW
...
- Arreglar: sincronización de google drive en firefox android nativo.
...
- Rendimiento: solicitudes de serial a concurrencia
...
- Arreglar Necesidad de Inicio de Sesión de Google Auth en Chrome/Firefox
...
- Arreglar ignorar etiquetas rb, rt en japonés.
...
- Arreglar permanecer abierta la configuración.
...
- Arreglar stay.app API de navegador de userscript
...
- Arreglar compilación de userscript
...
- Arreglar altura de línea de resaltado de marca

## 0.2.19

- Arreglar japonés inteligente de tencent
- Arreglar navegador mundial haikuo
...
- Arreglar que safari globalThis.GM no funciona
