...
- Nueva función: La traducción de IA admite [modelo grande de Doubao](https://www.volcengine.com/product/doubao)
...
- Soporta la plataforma de modelo grande de Baidu Qianfan, la plataforma de modelo grande de Alibaba Bailian, la plataforma de modelo grande de DeepSeek.
...
- Se solucionó el error de sincronización de múltiples dispositivos en Pro.

## 1.5.4

- Los miembros Pro admiten servicios de traducción de Claude y Gemini listos para usar (Beta)
...
- Optimización: Página de configuración, interfaz de usuario de lista de URL (para evitar ambigüedades, las casillas de verificación no se muestran por defecto).
...
- La bola flotante en móvil ahora soporta operación de pulsación larga, pulsación corta para traducir, pulsación larga para abrir el panel.
...
- Solucionar el problema de que Youtube ocasionalmente regresa a la página de inicio
...
- Solucionar la traducción automática cuando se resalta readwise

## 0.9.6

- Solucionar el problema de limpiar la caché al cerrar sesión del usuario.

## 0.9.5

- Solucionar errores de libros electrónicos en línea
...
- Solucionar el problema de desplazamiento automático en la lectura móvil en línea de epub
...
- Característica: Añadir nuevo tema Borde Sólido (新增新主题，实线边框)
...
- Característica: Añadir `<all>` para traducir siempre idiomas, ahora puedes usarlo para traducir todos los idiomas excepto el idioma objetivo, y nunca traducir idiomas
...
- Característica: Añadir regla de waitForSelectors, para solucionar algunos sitios como reddit
...
- Solución de marca de línea de resaltado
