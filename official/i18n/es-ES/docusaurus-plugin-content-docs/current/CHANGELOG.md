...
Este registro de cambios se actualiza de acuerdo con el progreso del desarrollo. La fecha después de la versión es la fecha de fusión del código, no la fecha de lanzamiento en las tiendas de aplicaciones (el tiempo de revisión varía después de la presentación en cada tienda de aplicaciones, algunas pueden tardar hasta una semana en revisar). Actualmente, estamos avanzando con dos versiones.
...
- Corregido: Un problema donde la tecla de acceso rápido para la traducción al pasar el ratón no funcionaba en dispositivos que admiten tanto ratón como táctil.
...
- Mejorado: Lógica de juicio del modo táctil y ratón.
...
- Corregido: Problema de coincidencia inteligente de expertos en AI en servicios de traducción personalizados.
...
- Corregido: el problema de los números decimales que se rompen en líneas al traducir textos largos.
...
- Mejorado: Mejorada la visualización de la traducción bilingüe de múltiples líneas en Twitter y Youtube.
...
- Mejorado: Actualizada la interfaz de usuario de la lista desplegable del servicio de traducción en el panel.
...
- Corregido: Problema con las teclas de acceso rápido de **Enhanced input** que no se activaban
- Mejorado: Reducir el tamaño del paquete de instalación
- Mejorado: Solución para la visualización de subtítulos de Netflix
...
- Mejorado: Funcionalidad de mejora de entrada y desplazamiento del ratón dentro de iframes incrustados en páginas web

## 1.10.2 (2024-10-11)

- Añadido: Traducción de imágenes (versión Beta)
- Añadido: Modo Forzar Habilitar Soporte de Ratón (Habilite esta función solo si la función de desplazamiento del ratón no está disponible en dispositivos tablet) **Configuración** -> **Configuración Avanzada** -> **Forzar Habilitar Soporte de Ratón**
...
- Soporte mejorado de entrada para Baidu, Gmail y otros campos de entrada
...
- Soporte para configurar excepciones para idiomas y sitios web en modo de contraste bilingüe o solo traducción (configurar en la página de Configuración -> Configuración Avanzada). Por ejemplo: Si su modo de traducción predeterminado es contraste bilingüe, pero no desea que el chino tradicional también use contraste bilingüe, entonces puede agregar el chino tradicional a los idiomas de excepción para contraste bilingüe, por lo que el chino tradicional usará el modo solo traducción para la traducción. De manera similar, si su modo de traducción predeterminado es solo traducción, pero desea que un cierto idioma o sitio web use el modo de contraste bilingüe, también puede agregar ese idioma o sitio web a los idiomas de excepción.
...
- El servicio de traducción DeepL ahora oficialmente soporta el chino tradicional como idioma de destino (anteriormente, traducir al chino tradicional con DeepL implicaba un proceso de conversión adicional de chino simplificado a chino tradicional de terceros).
...
- Se solucionó el problema donde modificar el idioma de destino y otras configuraciones en el panel emergente se restablecían al hacer clic en la bola flotante de traducción.
...
- Se optimizó significativamente el rendimiento de la traducción de grandes páginas web, creación de ePub y archivos de subtítulos.
...
- Se solucionó el reconocimiento de idiomas japonés y coreano
...
- Se solucionó el tiempo de sincronización multidispositivo de usuarios Pro que no se sincronizaba
- Se optimizó la cobertura de configuración de sincronización en la nube
- Se optimizaron las palabras de prompt para servicios de traducción de IA
...
- El control de estilo de subtítulos de YouTube admite estilo de borde
...
- Se agregaron opciones de 50%, 150% para el tamaño de fuente de subtítulos de YouTube
...
- Se optimizaron los multi-prompts de OpenAI, admitiendo formato YAML, lo que mejora la flexibilidad y facilidad de uso de la configuración
- Se optimizó significativamente la velocidad de traducción de subtítulos de YouTube, y se agregó soporte para cambiar entre orden chino e inglés, personalizar color y tamaño de fuente, etc.
...
- Los subtítulos de video admiten configuración para visualización bilingüe/original y traducción
...
- Solucionado el problema por el cual el panel de control no se podía cerrar en dispositivos móviles.
...
- Optimizado la interfaz de usuario emergente de error.
...
- **Optimización de la Interfaz de Usuario**: Rediseñada la interfaz de usuario para los mensajes de error de traducción de página para hacerlos más fáciles de entender. Cuando hay muchos errores, un mensaje emergente avisará activamente al usuario.
...
- Corregido: Solucionado el problema donde los títulos en la página de lista de jstor no se traducían [#1268](https://github.com/immersive-translate/immersive-translate/issues/1268).
...
- Reparado que los subtítulos originales del video no se muestran cuando "El sitio actual está configurado para nunca traducir".
...
- Corregido el problema de clics temblorosos del panel de acción de la bola flotante de la página de Firefox.
...
- Corregido el problema de creación de Epub al hacer clic en las traducciones del panel que no funcionaban

## 0.12.4

- Cuando activas los subtítulos bilingües en el panel, primero actualizará la página automáticamente (para mostrar subtítulos bilingües con más precisión), y algunos sitios aún requieren que los usuarios hagan clic manualmente en el botón "CC" en el sitio para activar los subtítulos.
...
- Corrección para la función [desactivar permanentemente subtítulos de video] que no funcionaba [#1175](https://github.com/immersive-translate/immersive-translate/issues/1175)
...
- Añadido 11 nuevos idiomas de interfaz para el complemento y el sitio web oficial, ahora los idiomas de interfaz soportados alcanzan 14, incluyendo Chino Simplificado, Chino Tradicional, Inglés, Japonés, Coreano, Ruso, Español, Portugués, Hindi, Italiano, Alemán, Francés, Árabe y Persa.
...
- Reparado clic no responsivo de la bola flotante en pdf en línea
...
- Solucionado el problema de que algunas plataformas no podían reconocer si el ratón era compatible o no
...
- Corregido clics temblorosos de la bola flotante de la página
...
- Corregido conflicto de subtítulos de Youtube con el complemento de subtítulos duales (Immersive Translate de traducción de subtítulos de Youtube no está habilitado cuando se detecta el complemento dual de Youtube para evitar conflictos)
...
- Solucionar el problema de traducción de la clave de autenticación personalizada de DeepL
...
- Traducción de la caja de entrada: muestra un recordatorio emergente cuando se usa por primera vez, y el usuario puede elegir desactivarlo esta vez o permanentemente para evitar toques accidentales.
...
- Funciones Beta: API personalizada (Beta habilitada en la configuración de desarrollador)
...
- Solucionar: problema de traducir todas las regiones en Gmail
...
- Solucionar el problema de que la mejora de la caja de entrada no está habilitada cuando el sitio está configurado para nunca traducir.
...
- Solucionar algunos estilos de la caja de entrada
...
- Cuando la caja de entrada está configurada sin prefijo, admite la traducción de `ja Hello` al japonés y `English Hello` al inglés.
...
- Optimizar: El número mínimo de caracteres en un párrafo que activa la traducción se modificó a un mínimo de 4 caracteres para reducir la confusión, mientras se usan otras características para evitar traducir las áreas de navegación y finalización del sitio.
- Solucionar: detalles de Github que no se traducen después de expandir.

## 0.5.14

- Arreglar el problema de que las imágenes en algunas páginas web de: se agrandan después de copiar
- Arreglar: la sección de comentarios de medium no se traduce
...
- Arreglar: los saltos de línea parciales de tweets no se reconocen
- Arreglar: el estilo de autoría de eBook no funciona

## 0.5.10

- Arreglar: los saltos de línea de tweets no se reconocen
- Arreglar: la página de detalles de Reddit devuelve algunos párrafos que no se pueden traducir
- Solucionado un problema con: donde algunas de las etiquetas de código no se reconocían correctamente.

## 0.5.9

- Arreglar los saltos de párrafo en algunos casos en:
...
- Arreglar: página web TXT pura como [esta](https://edoras.sdsu.edu/~vinge/misc/singularity.html)
...
- Arreglar: política de seguridad de contenido emergente para extensión, y en parte para userscript.
...
- Arreglar: el menú contextual de Firefox desapareció después de reiniciar.
...
- Arreglar: postMessage cuando la página de inicio rompía algunos sitios, ahora solo haremos esto cuando realmente traduzcamos páginas
...
- Arreglar: identificador de ebook duplicado
- Función: Soporte para traducción de página web txt

## 0.2.85

- Arreglar: algunos archivos epub no se pueden encontrar.

## 0.2.84

- Función: Soporte para lector y creador de ebooks
...
- Arreglo: Conflicto de Mensajes de DingTalk
...
- Arreglo: Fallo en la traducción de archivos PDF, error desde 0.2.60 por soporte de deepl de zh-CN a zh-TW
...
- Arreglo: openl elige servicios de traducción
...
- Arreglo de máscara de alternancia de userscript
- Arreglo de lógica de máscara de alternancia

## 0.2.43

- Arreglo de máscara de alternancia de userscript con evento táctil.
- Arreglo de velocidad (eliminando sleep(300))

## 0.2.42

- Arreglo de máscara de hover cuando se alterna la máscara de nuevo.
...
- Arreglo de característica beta mostrar
...
- Arreglo de volc traducir para detectar idioma automáticamente
...
- Arreglo de permanecer abierta la configuración.
...
- Arreglo de safari globalThis.GM no funciona
...
- Arreglar cambio de servicio de traducción en el popup que no funciona
