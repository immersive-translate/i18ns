...
La **Release version** es la versión estable oficial, disponible en las principales tiendas de aplicaciones como [Chrome](https://chromewebstore.google.com/detail/bpoadfkcbjbfhfodiogcnhhhpibjhbnh), [Edge](https://microsoftedge.microsoft.com/addons/detail/amkbmndfnliijdhojkpoglbnaaahippg), [Firefox](https://addons.mozilla.org/firefox/addon/immersive-translate/), [Apple](https://apps.apple.com/app/id6447957425), etc.

La **Preview version** se publica con más frecuencia e incluye algunas características experimentales. En comparación con la versión Release, puede contener más errores. Se publica principalmente en
...
- Nuevo: La traducción de imágenes gratuita ahora está disponible (actualmente solo soportada en las versiones de PC de los navegadores Chrome y Edge), accesible a través del menú de clic derecho.
...
- Añadida la opción de "Informar problemas de traducción de la página web actual" y la opción de "Encender/apagar rápidamente la bola flotante" en las más opciones del panel.
...
- Soporte de plataforma de subtítulos de video [DeepLearning.ai](https://learn.deeplearning.ai)
...
- Solucionado el problema de traducción de Gemini al hebreo
...
- Optimizada la interfaz de usuario de la ventana emergente de error.

## 1.1.9

- Soporte de traducción de subtítulos para YouTube Live y la plataforma [Mubi](https://mubi.com/).
- Optimización: Página de configuración, interfaz de usuario de interacción de lista de URL (para evitar ambigüedades, las casillas de verificación no se muestran por defecto).
...
- **Guía para Nuevos Usuarios**: Cuando los nuevos usuarios abren por primera vez una página en un idioma que no es el objetivo, se muestra una burbuja de ayuda de bola flotante.

### Optimización y Correcciones

- **Optimización de la Interfaz de Usuario**:

  - Optimizada la interfaz de usuario de la ventana emergente de error para mejorar la usabilidad y comprensión.
...
- **Eliminación de Funciones**: Eliminada la función de mejora de información bilingüe (mostrar resultados de búsqueda en inglés en páginas de búsqueda de Google simultáneamente).
...
- Optimización de la velocidad de exportación de traducción solo para PDF, si elige exportar solo la traducción, puede llamar directamente a la vista previa de PDF del sistema para exportar, más rápido.
...
- ¡Finalmente, PDF admite la exportación de versiones bilingües! Puede hacer clic en el botón [Guardar] para exportar el archivo PDF bilingüe traducido.
- Las reglas personalizadas ahora admiten la fusión con las reglas integradas predeterminadas, por ejemplo: `{"id": "youtube", "selectors.add":["#test"]}` significa agregar un `#test` a los selectores existentes, `selectors` significa sobrescribir el predeterminado, `selectors.remove` significa eliminar uno de los selectores predeterminados, y `selectors.remove` significa eliminar uno de los selectores predeterminados.
...
- Habilitar automáticamente la traducción de sitios web en inglés de uso frecuente para nuevos usuarios
...
- Optimizar la selección de idioma de destino, ahora solo mostrará los idiomas compatibles con el servicio de traducción correspondiente
- Optimización de traducción de PDF
...
- Soporte de chino tradicional y chino simplificado
...
- Corrección: oyente de tecla de acceso rápido al pasar el ratón.
...
- Corrección: Evitar la Política de Seguridad de Contenidos para [Mastondon](https://mastodon.social/)
...
- Característica: Traducir de Bing Translate a Microsoft Translate para una calidad más estable.
...
- Característica: soporte para ChatGPT Plus Website como Servicio de Traducción, Esta es una característica beta, por lo que puedes acceder a ella habilitando la Característica Beta en la configuración de desarrollador. Esto es muy lento, porque chatgpt solo puede enviar una solicitud a la vez. Asegúrate de tener una Cuenta Plus de ChatGPT, porque hay más limitaciones en la Cuenta Gratuita, y no estoy seguro si esto representa un riesgo para tu cuenta, ten cuidado de Asegúrate de tener una Cuenta Plus de ChatGPT, porque hay más limitaciones en la Cuenta Gratuita, y no estoy seguro si esto representa un riesgo para tu cuenta, ten cuidado al usarlo.
...
- Característica: Agregar botón de reintentar todos los párrafos fallidos.
...
- Arreglar permanecer abierto en configuraciones.
...
- Arreglar cambio de url de cliente, auto mantener el estado de traducción.
