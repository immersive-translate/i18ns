...
- Añadido: Soporte para configurar el número de pantallas a pre-traducir al navegar por la página actual.
...
- Optimizado: El servicio de traducción Gemini soporta un aviso de sistema personalizado (System Prompt).
...
- El servicio de traducción DeepL ahora oficialmente soporta Chino Tradicional como idioma de destino (anteriormente, traducir al Chino Tradicional con DeepL implicaba un proceso adicional de conversión de Chino Simplificado a Chino Tradicional de terceros).
...
- Corregido un problema donde los servicios de IA personalizados no podían seleccionar expertos de IA.

## 1.6.4

- Cuando se utilizan expertos de IA para "Selección Inteligente", se pueden personalizar diferentes expertos de IA para diferentes sitios web. Esto se puede configurar en [Configuración] -> [Expertos de IA] -> [Ingresar cualquier experto].
...
- Soporte para agregar servicios de traducción AI personalizados compatibles con OpenAI, accesible en la parte inferior de la página [Configuraciones]->[Servicios de Traducción].
...
- Se optimizó la cobertura de configuraciones de sincronización en la nube
...
- La página de configuraciones ahora acomoda ajustes para [estilos de subtítulos de YouTube](https://dash.immersivetranslate.com/#subtitle).
...
- **Correcciones de Errores**:
  ...
  - Solucionado el problema donde la traducción al pasar el ratón fallaba cuando la página perdía el enfoque.
...
- Resuelto el problema de que algunas plataformas no podían reconocer si el ratón era compatible o no
  - Hay algunos navegadores de escritorio que admiten tanto pantalla táctil como ratón, y Immersive Translate no puede detectar técnicamente si tales plataformas admiten ratón, por lo que hemos añadido la opción [Forzar Habilitar Soporte de Ratón] en la configuración de [Desplazamiento del Ratón]
...
- Ignorar el idioma de nunca traducir en el desplazamiento del ratón
...
- Corregir conflicto de subtítulos de Youtube con el complemento de subtítulos duales (la traducción de subtítulos de Youtube de Immersive Translate no está habilitada cuando se detecta el complemento dual de Youtube para evitar conflictos)
...
- Corrección: problema de caracteres específicos del constructor de eBooks, como algunas rutas de capítulos son `xxx' xxxx`.
...
- Corrección: Progreso del Constructor de eBooks detenido al 99%.
...
- Característica: Agregar progreso de traducción para el constructor de eBooks, y un hermoso confeti después del éxito.
...
- Característica: Soporte para traducir html local para extensión
...
- Corrección: Algunos sitios usan `span` para estilos, por lo que usamos `font` en lugar de span para el contenedor de destino de traducción
...
- Característica: Añadir nuevo tema Solid Border (新增新主题，实线边框)
...
- Característica: Soporte para marco principal personalizado ya que algunos sitios no usan el cuerpo como marco principal
...
- Característica: Añadir `<all>` para siempre traducir idiomas, ahora puedes usarlo para traducir todos los idiomas excepto el idioma objetivo, y nunca traducir idiomas
...
- Característica: Añadir regla de waitForSelectors, para arreglar algunos sitios como reddit
...
- Característica: Función de Traducción Inmersiva de Deepl
...
- Arreglar: elemento translate=no anula
...
- Característica: soporte para css inyectado en la placa de desarrollador
...
- Arreglar hover de máscara al alternar máscara de nuevo.
...
- Arreglar volc traducir para detectar idioma automáticamente
...
- Soporte para traducir iframe, como correo de QQ, tweet embebido.
...
- Arreglar que globalThis.GM de safari no funciona
