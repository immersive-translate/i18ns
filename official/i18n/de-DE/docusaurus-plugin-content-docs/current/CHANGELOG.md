...
- Hinzugefügt: Verwaltung der AI-Terminologiebibliothek
...
- Behoben: Synchronisationsfehler von Google Drive in einigen Browsern.
...
- Behoben: Problem mit der Formelausgabe, verursacht durch die "Twitter Translation Improvement" in Version 1.11.2.
...
- Behoben: Problem mit der Synchronisierung benutzerdefinierter AI-Experten
...
- Behoben: Problem, bei dem die [Erweiterte Einstellungen -> Mindestanzahl von Zeichen, die für die Übersetzung eines Absatzes erforderlich sind] in einigen Fällen nicht wirksam wurde
...
- Nach dem Anpassen der Position von YouTube zweisprachigen Untertiteln merkt sich das System automatisch die neue Position.
- Optimierte Cache-Logik des Plugins, jetzt wird automatisch Cache-Daten gelöscht, die älter als 30 Tage sind.
...
- Unterstützung für Echtzeit-zweisprachige Untertitel in Microsoft Teams Webversion Video-Meetings (Öffnen Sie den Teams-Meeting-Link, schalten Sie zweisprachige Untertitel im immersiven Übersetzungspanel ein und aktualisieren Sie dann)
...
- Neue Benutzer-Feedback-Schaltfläche für Manga-Übersetzung (nach der Übersetzung eines Mangas klicken Sie auf die [Feedback]-Schaltfläche auf der rechten Seite des schwebenden Balls, um Feedback zur Übersetzungsqualität zu geben).

## 1.7.7

- Verwendung eines AI-intelligenten Satzteilungsalgorithmus für automatisch generierte englische Untertitel auf YouTube [Pro Verfügbar]
...
- Unterstützung für die Anpassung von AI-Experten, der Eingang befindet sich am unteren Rand der [Settings]->[AI Expert] Seite.
...
- YouTube zweisprachige Untertitel unterstützen jetzt intelligentes Satzteilen (Beta) (Nur wenn die immersive Übersetzung von YouTube-Untertiteln manuell in [Settings] - [Video Subtitles] aktiviert wird und die Originalvideo-Untertitel automatisch generierte englische Untertitel sind)
- Hinzugefügt: Übersetzungsdienst Tencent [【Hunyuan Large Model】](https://immersivetranslate.com/docs/services/tencent-hunyuan/)

## 1.6.5

- Behebung von Textlayout-Problemen bei Comic-Übersetzungen für Sprachen im lateinischen Schriftsystem.
...
- Wenn AI-Experten für die "Intelligente Auswahl" verwendet werden, können verschiedene AI-Experten für verschiedene Websites angepasst werden. Dies kann in [Einstellungen] -> [AI-Experten] -> [Beliebigen Experten eingeben] festgelegt werden.
...
- Behebung einiger Seiten, die mit DeepL keine Übersetzungen hatten
...
- Optimierte das Anzeigeproblem der Übersetzung von Twitter CC-Videountertiteln.
...
- Unterstützung der Videountertitelplattform [DeepLearning.ai](https://learn.deeplearning.ai)
- Unterstützung für Webseitenübersetzung und Videountertitelübersetzung in Sprachen wie Arabisch, Hebräisch usw., um RTL (Rechts-nach-Links) Anzeigeprobleme zu beheben.
...
- Behebung der Tastenkombination für die sofortige Übersetzung am Ende der Seite.

## 1.2.4

- Behebung des Problems, dass Platzhalter bei der Erstellung von ePub nicht richtig ersetzt wurden.
- Unterstützung der Videountertitelübersetzung [Unreal Sensei](https://www.unrealsenseiacademy.com/).
...
- Unterstützung der Videountertitelübersetzung für [Kanopy](https://www.kanopy.com/), [RachelsEnglishAcademy](https://www.rachelsenglishacademy.com/), [Hulu](https://www.hulu.com/), [Three.js Journey](https://threejs-journey.com/).
...
- Unterstützung der Videountertitelübersetzung auf [LinkedIn](https://www.linkedin.com/) und [Viu](https://www.viu.com/) Plattformen.
- Hinzufügen von mehr Videountertitel-Schnellzugriffen für zusätzliche Plattformen.
...
- Hinzufügen von Schnellzugriffen zum Aktivieren von Videountertiteln auf Netflix, Ted, Bloomberg, Udemy, Coursera.
...
- Hinzufügen einer Unterstützung für eine neue Tastenkombinationseinstellung, die ein schnelles Umschalten ermöglicht, ob Videountertitel die integrierten maschinellen Übersetzungsuntertitel verwenden.
- Auf der Sci-Hub-Website wird durch Klicken auf den schwebenden Ball das in die Webseite eingebettete PDF übersetzt.

## 1.1.6

- **Mobile Unterstützung für die Übersetzung bestimmter Absätze:** Die mobile Version unterstützt jetzt die Übersetzung bestimmter Absätze und hat eine Vielzahl von Schnellzugriffsoperationen hinzugefügt, darunter Wischen nach links, Wischen nach rechts, Doppeltippen, Dreifachtippen und Mehrfinger-Touch-Gesten. Diese sind standardmäßig nicht aktiviert und erfordern, dass der Benutzer aktiv die auslösende Geste auf der Einstellungsseite unter [Maus-Hover] auswählt.
...
- **Immersive Übersetzungserfahrung:** Um sich besser an Benutzergewohnheiten anzupassen, haben wir die Tastenkombination für zweisprachige Untertitel im Vollbildmodus auf der YouTube-Plattform auf die linke Seite verschoben.
...
- **Popup-Panel-UI-Upgrade:** Das neue Design zielt darauf ab, die Benutzerfreundlichkeit und Verständlichkeit zu verbessern. Dieses Update umfasst:
  ...
  - **Neue Funktionen im Hauptmenü:**
    ...
    - **Dokumentenübersetzungseintrag:** Der Eintrag für die Übersetzung von "PDF/ePub/Untertiteldateien" wurde ins Hauptmenü verschoben, um einen schnellen Zugriff zu ermöglichen.
    - **Videountertiteleinstellungen:** Der Eintrag für "Videountertitel" Einstellungen wurde ebenfalls ins Hauptmenü verschoben, um schnelle Anpassungen zu ermöglichen.
...
- Optimierung des Übersetzungseffekts von GPT-Gesprächen.
...
- **Tastenkombinationseinstellungen**: Hinzufügen eines neuen Top-Level-Menüs "Tastenkombinationen" und der folgenden anpassbaren Tastenkombinationsfunktionen:
  ...
  - Hinzufügen spezieller Tastenkombinationen für 6 Übersetzungsdienste (wie DeepL, OpenAI, Google, Microsoft, Gemini, Tencent Interactive Translation), um einen temporären Wechsel zwischen Übersetzungsdiensten zu erleichtern.
...
- **Plugin-Einstellungsseite UI-Update**:
  ...
  - Hinzufügen eines Tutorials für Anfänger, das schwebende Ball-Einstellungen, Videountertitel-Einstellungen und Maus-Hover-Einstellungen abdeckt.

- **YouTube Zweisprachige Untertitel**: Hinzufügen eines Schnellzugriffs im YouTube-Videowiedergabefenster, um zweisprachige Untertitel zu aktivieren oder auszublenden (diese Funktion kann deaktiviert werden).
...
- Fix: Das Problem der Erkennung der Standardsprache auf einigen Maschinen nach der ersten Installation wurde behoben.
...
- Behoben: Das Problem, bei dem der Cache nach der Änderung des Prompts/Modells in OpenAI weiterhin vorhanden ist.
...
- Auf macOS wurde der Anzeigename der Panel-Verknüpfung optimiert.
...
- Die im letzten Version hinzugefügte zweisprachige Freigabe (Aktualisierungsmodus) wurde in zweisprachige Seiten-Snapshot-Freigabe geändert, sodass der geteilte Inhalt originaler ist und eine breitere Anpassungsfähigkeit hat.
...
- Behebt das Safari Google-Login-Problem
...
- Reparatur des Problems, dass beim Öffnen von PDF-Dateien das Erweiterungspanel anzeigt, dass keine Berechtigungen vorhanden sind.
...
- Erste Veröffentlichung im Juni, migriert von der vorherigen persönlichen Subdomainhttps://immersive-translate.owenyoung.com zur neuen Domain https://immersivetranslate.com/
...
- Optimieren: Die Mindestanzahl von Zeichen in einem Absatz, die die Übersetzung auslöst, wurde auf mindestens 4 Zeichen geändert, um Verwirrung zu reduzieren, während andere Funktionen verwendet werden, um die Navigation und Endbereiche der Website nicht zu übersetzen.
...
- Beheben Sie das Problem, dass Bilder auf einigen Seiten falsch kopiert wurden
...
- Beheben Sie ein Problem, bei dem einige der Code-Tags nicht korrekt erkannt wurden.
...
- Beheben Sie das Problem, dass die temporäre Einstellung der Übersetzungsdauer der Website nicht wirksam wird.

## 0.5.7

- Super-Update!

- Die Funktion "Nur Übersetzungen anzeigen" ist da! Klicken Sie auf [Mehr] -> [Wechseln, um nur Übersetzungen anzuzeigen].
...
- Optimieren Sie das Problem der OpenAI-Anforderungsfrequenzbegrenzung
...
- Beheben Sie das Weißbildproblem nach der Übersetzung von Websites mit Hydration wie Next.js.

  - Zum Beispiel: https://webpack.js.org/

- Beheben Sie das Problem, dass die Änderung der Maus-Hover-Tastenkombination eine Seitenaktualisierung erforderte, um wirksam zu werden

- Beheben Sie ein Problem mit der Zeilenumbrucherkennung in TXT-Dateien.

- Viele Updates!

- Die Funktion "Nur Übersetzung anzeigen" ist da! Klicken Sie auf "Mehr" -> "Wechseln, um nur Übersetzungen anzuzeigen".
...
- Optimiert für das Problem der OpenAI-Anforderungsratenbegrenzung
...
- Beheben Sie das Problem mit der Erkennung von Zeilenumbrüchen in TXT-Dateien.
...
- Chore: Entfernen Sie console.log
...
- Fix: Behalten Sie &nbsp; als Leerzeichen.
...
- UI: OpenAI-Benutzerdefinierte Optionen standardmäßig ausklappen.
...
- Fix: postMessage beim Initialisieren der Seite brach einige Seiten, jetzt machen wir dies nur, wenn wir wirklich Seiten übersetzen
- Fix: eBook-Fortschrittsproblem.
- Fix: Besser für das Aufteilen langer Absätze, 1,5 Milliarden, 25,5%, Mr. wird nicht als Grenze betrachtet
...
- Besser: Erkennen von japanischen/koreanischen Containern.
...
- Fix: Erkennen der eBook-Sprache.
...
- Fix: E-Book-Identifier dupliziert
...
- Fix: Erlauben Sie die Konfiguration des benutzerdefinierten Google API
...
- Fix: Azure-Übersetzungseinrichtung, aber immer noch angezeigt (Einrichtung erforderlich)

## 0.2.66

- Fix: PDF-Datei Übersetzung fehlgeschlagen, Fehler ab 0.2.60 für die Unterstützung von deepl von zh-CN zu zh-TW

## 0.2.65

- Unterstützung für Drosselungsanfragen für mehrere Frames
- Seitentitel nicht übersetzen, wenn im iframe
...
- Feat: Regel waitForSelectors hinzufügen, um einige Seiten wie Reddit zu reparieren
...
- Ersetzen Sie Links zum Übersetzungsdienst
...
- Fix Maskenhover bei erneutem Umschalten der Maske.
...
- Wiederholungslogik für den Übersetzungsdienst hinzufügen
...
- Fix getpocket.com
- Fix Aside-Fußzeile für den Body-Bereich
...
- Fix Japanisch rb, rt Tag ignorieren.
...
- Fix bleibt offene Einstellungen.
...
- Fix Markierung Hervorhebung Zeilenhöhe
...
- Entfernen Sie den Aside-Container als Übersetzungscontainer.
...
- Behebt
  ...
  Problem mit der Übereinstimmung von Dateipfaden
...
- Fängt Verbindungsfehler bei Nachrichten für Popups ab.
...
- Behebt Berechtigungen für frühe Browser
...
- Behebt Optionen UI Schriftgröße

## 0.0.50

- Behebt Block-Img-Übersetzung.
...
- Behebt pre white space für einige Artikel
...
- Fügt Timeout für Cache-Anfragen hinzu

## 0.0.44

- Behebt Fehler bei der Trennung von Tencent.
- Behebt Fehler bei Inline-Sup-Elementen.
- Besser für Twitter
...
- Behebt BR-Tag
- Behandelt Block-Tags nach Regeln
...
- Unterstützung für Cache-Ergebnisse für Userscript
...
- Behebt Userscript-Icon-Größe.
- Aktiviert alle Seiten zur Erkennung der Absatzsprache.
...
- Behebt Google-Suche erzwungene Aktualisierung
  [#4](https://github.com/immersive-translate/next-immersive-translate/issues/4)
- Unterstützung für Tabellenergebnisse von Google
...
- Die Standard-Hotkey zum Umschalten der Übersetzung wurde auf `alt+A` geändert, da es der bequemste Schlüssel zum Tippen ist.

### Andere

- Unterstützung für sofortigen Übersetzungsmodus, sodass Sie die Webseite so schnell wie möglich übersetzen lassen können.
- Unterstützung für die Festlegung des Seitenbereichs, der übersetzt werden muss, sodass Sie mehr Bereiche übersetzen können.
- Unterstützung für die Festlegung der ersten x Textanzahl zur sofortigen Übersetzung.
...
- Besser für das gestrichelte Thema

## 0.0.29

- Behebt Absatzgültigkeit.
...
- Unterstützung für selectorMatches, sodass wir jetzt alle manstondon abgleichen können.
...
- Unterstützung für die Überprüfung neuer Versionen
