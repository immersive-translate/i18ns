...
- Verbessert: Übersetzungspause löscht sofort die Anforderungswarteschlange.
...
- Problem mit der Synchronisierung benutzerdefinierter KI-Experten behoben
...
- Zweisprachige YouTube-Untertitel unterstützen jetzt intelligentes Satzteilen (Beta) (Nur wenn die immersive Übersetzung von YouTube-Untertiteln manuell in [Einstellungen] - [Video-Untertitel] aktiviert wird und die Original-Video-Untertitel automatisch generierte englische Untertitel sind)
- Hinzugefügt: Übersetzungsdienst Tencent [【Hunyuan Large Model】](https://immersivetranslate.com/docs/services/tencent-hunyuan/)

## 1.6.5

- Beheben Sie die Textlayout-Probleme von Comic-Übersetzungen für Sprachen im lateinischen Schriftsystem.
...
- In Video-Zweisprachigen Untertiteln, wenn die Zielsprache Vereinfachtes Chinesisch und der Originaltext Traditionelles Chinesisch ist, wird der Originaltext automatisch in Vereinfachtes Chinesisch umgewandelt und umgekehrt.
...
- Behebung der Erkennung von Japanisch und Koreanisch
...
- Behebung des Problems, dass chinesische Untertitel in YouTube nicht heruntergeladen werden konnten.
...
- Verbesserungen wurden vorgenommen, um das Problem zu beheben, dass immersive zweisprachige Untertitel nicht angezeigt wurden, wenn Benutzer die Untertitelsprache auf Chinesisch auf der YouTube-Website eingestellt haben.
...
- Unterstützung für zweisprachige Übersetzung für Google Docs
...
- Unterstützung für die Übersetzung von Webseiten und Video-Untertiteln in Sprachen wie Arabisch, Hebräisch usw., um Probleme mit der RTL-Anzeige (Rechts-nach-Links) zu beheben
...
- Behebung der Verknüpfung für die sofortige Übersetzung am unteren Rand der Seite
...
- Unterstützung für die Übersetzung von Video-Untertiteln auf den Plattformen [LinkedIn](https://www.linkedin.com/) und [Viu](https://www.viu.com/).
...
- **Mobile Unterstützung für die Übersetzung spezifischer Absätze:** Die mobile Version unterstützt jetzt die Übersetzung angegebener Absätze und hat eine Vielzahl von Schnellzugriffsoperationen hinzugefügt, darunter Wischen nach links, Wischen nach rechts, Doppeltippen, Dreifachtippen und Mehrfinger-Touch-Gesten. Diese sind standardmäßig nicht aktiviert und erfordern, dass der Benutzer aktiv die auslösende Geste auf der Einstellungsseite unter [Mausüberfahren] auswählt.
...
- Behebung des Ausrichtungsproblems mit der Option "Mehr", die auf Windows nicht linksbündig war.
...
- **Integrierter Dokumentenübersetzungseintrag:** Jetzt können Sie PDF-, ePub- und Untertitel-Dateien über einen einheitlichen Upload-Eintrag übersetzen. Klicken Sie einfach auf die [PDF/ePub]-Schaltfläche im Popup-Panel, es ist nicht mehr nötig, [Mehr] auszuwählen.
...
- Behebung des Problems, bei dem Eingabefelder mit URLs nur teilweise übersetzt wurden.
...
- **Plugin-Einstellungsseite UI-Update**:
  ...
  - In "Erweiterte Einstellungen" wurde eine neue Option hinzugefügt, um die Mindestanzahl von Zeichen zu konfigurieren, die erforderlich sind, um einen Absatz zu übersetzen. Der Standardwert ist 4 Zeichen, kann jedoch höher eingestellt werden.
  - In "Erweiterte Einstellungen" wurde eine neue Option hinzugefügt, um die Mindestanzahl von Zeichen zu konfigurieren, die erforderlich sind, um einen Absatz zu übersetzen. Der Standardwert ist 4 Zeichen, kann jedoch höher eingestellt werden.
  - In "Erweiterte Einstellungen" wurde eine neue Option hinzugefügt, um die Mindestanzahl von Zeichen zu konfigurieren, die erforderlich sind, um einen Absatz zu übersetzen. Der Standardwert ist 4 Zeichen, kann jedoch höher eingestellt werden.
  - In "Erweiterte Einstellungen" wurde eine neue Option hinzugefügt, um die Mindestanzahl von Zeichen zu konfigurieren, die erforderlich sind, um einen Absatz zu übersetzen. Der Standardwert ist 4 Zeichen, kann jedoch höher eingestellt werden.
  - In "Erweiterte Einstellungen" wurde eine neue Option hinzugefügt, um die Mindestanzahl von Zeichen zu konfigurieren, die erforderlich sind, um einen Absatz zu übersetzen. Der Standardwert ist 4 Zeichen, kann jedoch höher eingestellt werden.
...
- **UI-Optimierung**:
  ...
  - Optimierung der Benutzeroberfläche des Popup-Panels, um die Benutzerfreundlichkeit und Verständlichkeit zu verbessern. Dieses Update umfasst:
...
- **Fehlerbehebungen**:
  ...
  - Behebung des Problems, bei dem die Übersetzung bei Mausüberfahren fehlschlug, wenn die Seite den Fokus verlor.
...
- **Funktion entfernt**: Entfernung der zweisprachigen Informationsverbesserungsfunktion (gleichzeitige Anzeige von englischen Suchergebnissen auf Google-Suchseiten).
...
- Optimiert: Bei Verwendung von Maus-Hover wird das Problem behoben, dass der Fokus auf der Seite verloren geht und dann das erneute Auslösen unwirksam wird.
...
- Optimiert: Verbesserung des Prozesses zum Zusammenführen von manuellen Untertiteln.
...
- Reparatur des Konflikts mit einigen Plug-ins, die zu unendlichem Seitenumblättern führen.
- Reparatur der Nicht-Übersetzung einiger Absätze nach dem Einschalten von langen Absatzumbrüchen.
- Behoben [Wenn das temporäre Einschalten der Webseitenübersetzung für eine lange Zeit das Panel [Immer diese Website übersetzen] nicht abbricht #1172](https://github.com/immersive-translate/immersive-translate/issues/1172)
...
- [Temporäres Einschalten der Webseitenübersetzung für eine Länge von Zeit bricht nicht Immer Übersetzen ab #1172](https://github.com/immersive-translate/immersive-translate/issues/1172)
...
- Ändern des zweisprachigen Teilens (Aktualisierungsmodus), das in der letzten Version hinzugefügt wurde, in zweisprachiges Seiten-Snapshot-Teilen, sodass der geteilte Inhalt originaler ist und eine breitere Anpassungsfähigkeit hat.
...
- Behebung des Problems, dass das Klicken auf die Startseite von Youtube gelegentlich zurückkehrt
...
- Für Artikelseiten wird jetzt der Haupttext zuerst übersetzt, bevor der Rest des Seitenleisteninhalts übersetzt wird
- Optimierung der Unterbrechung von Untertiteln
...
- Feat: Übersetzen des aktuellen Absatzes beim Maus-Hover.
...
- Version: Ab jetzt werden wir die Nebenversion einmal im Monat ändern, zum Beispiel jetzt im März, wird die Version von 0.3.0 beginnen, im April wird die Versionsnummer von 0.3.0 beginnen, im April wird die Versionsnummer von 0.4.0 beginnen, im nächsten April wird die Versionsnummer 1.4.0 sein, und so weiter. Dies liegt daran, dass es keinen Sinn macht, dass Erweiterungen der Semantik folgen, aber die Standardisierung der Versionsnummern nach den Gesetzen der Zeit ist Motivation für die Entwicklung, um kontinuierlich zu aktualisieren, und für Benutzer, um Probleme leichter zu finden.
