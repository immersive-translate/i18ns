...
- Verbessert: Online-Einstellungsseite testet den Zugriff auf den Dienstschnittstellen.
...
- Behoben: Problem mit der Übersetzung von Formeln, verursacht durch die "Twitter Translation Improvement" in Version 1.11.2.
...
- Behoben: Probleme mit der Rückgängig-Funktion Ctrl+Z in der **Enhanced input** auf bestimmten Websites.
...
- Verbessert: Netflix Untertitelanzeige-Lösung
...
- Hinzugefügt: Option "Übersetzungsprobleme der aktuellen Webseite melden" und die Option "Schnell das schwebende Ball ein-/ausschalten" in den weiteren Optionen des Panels.
...
- Nach der Auswahl des Textes ändert sich das Rechtsklick-Menü zu [Übersetze den Text], klicken Sie darauf, um automatisch zur Immersive Translation Text Translation-Seite zu springen
...
- Unterstützung für die Anpassung von AI-Experten, der Zugang befindet sich am unteren Rand der Seite [Einstellungen]->[AI Expert].
...
- Verbesserte Geschwindigkeit der Manga-Übersetzung

## 1.7.2

- Behoben: Fehler bei der Comic-Übersetzung im Firefox-Browser.
...
- Wenn AI-Experten für die "Intelligente Auswahl" verwendet werden, können verschiedene AI-Experten für verschiedene Websites angepasst werden. Dies kann unter [Einstellungen] -> [AI-Experten] -> [Beliebigen Experten eingeben] eingestellt werden.
- Behebung des Problems, bei dem Untertitel im "Nur Übersetzung"-Modus auf YouTube nicht angezeigt werden.
- Behebung des Problems, bei dem zweisprachige Untertitel auf Mubi nicht funktionierten.
...
- Behebung des Problems, bei dem der Schwebeball-Shortcut unter iOS 18 nicht übersetzen konnte.
- Behebung des Problems, bei dem benutzerdefinierte Prompts unwirksam waren, wenn zu viele verwendet wurden.
...
- Behebung des Problems, bei dem das Ändern der Zielsprache und anderer Einstellungen im Popup-Panel beim Klicken auf den Übersetzungs-Schwebeball zurückgesetzt wurde.
...
- Deutlich optimierte Leistung bei der Übersetzung großer Webseiten, ePub-Erstellung und Untertiteldateien.
...
- Behebung des Problems, bei dem Reddit-Seiten auf mobilen Geräten beim Scrollen nicht übersetzt wurden
...
- AI-Übersetzungsdienste können jetzt die Modellauswahl anpassen, wie z.B. [OpenAI], das System hat nur einige der am häufigsten verwendeten Modelle eingebaut. Beim Klicken auf die Modellauswahlliste ist der letzte Punkt, den Sie sehen, [Weitere Modelle festlegen], nach der Einstellung wird es automatisch gespeichert, um den Benutzern das Testen verschiedener benutzerdefinierter Modelle zu erleichtern.
...
- Behebung des Problems, bei dem chinesische Untertitel auf YouTube nicht heruntergeladen werden konnten.
...
- Behebung des Problems, bei dem YouTube Shorts ohne Untertitel immer Untertitel aus dem vorherigen Video anzeigen [#1655](https://github.com/immersive-translate/immersive-translate/issues/1655)
- Behebung des Problems, bei dem YouTube zweisprachige Untertitel im Vollbildmodus nicht nach oben und unten angepasst werden können [#1654](https://github.com/immersive-translate/immersive-translate/issues/1654)
...
- Behebung des Problems, bei dem häufige Änderungen der Übersetzungsfarbe über die Farbpalette unwirksam waren [#1628](https://github.com/immersive-translate/immersive-translate/issues/1628)

## 1.4.9

- Übersetzungsdienste sind jetzt unter einem separaten Tab deutlich organisiert, was einen umfassenden Überblick über alle verfügbaren Übersetzungsdienste ermöglicht. Darüber hinaus haben Benutzer die Flexibilität, anzupassen, welche Übersetzungsdienste angezeigt werden. Standardmäßig wird nur eine begrenzte Auswahl an Übersetzungsdiensten angezeigt, aber Benutzer können ihre Anzeigepräferenzen im Abschnitt [Weitere Dienste](https://dash.immersivetranslate.com/#services) anpassen.
...
- Verbesserungen wurden vorgenommen, um das Problem zu beheben, bei dem immersive zweisprachige Untertitel nicht angezeigt wurden, wenn Benutzer die Untertitelsprache auf der YouTube-Website auf Chinesisch einstellten.
...
- YouTube führt eine Funktion ein, um vorübergehend zweisprachige Untertitel zu aktivieren
...
- Behebung des Problems, bei dem die Übersetzung fehlschlug, wenn OpenAI benutzerdefinierte Prompt-Wörter unter der Testschaltfläche gewechselt wurden
- Behebung des Problems, bei dem das YouTube-Untertitel-Shortcut-Symbol nicht angezeigt wurde
- Optimierung der Spracherkennung der Erweiterung

## 1.4.6

- Behebung des Problems, bei dem benutzerdefinierte Prompt-Wörter unwirksam waren
- Hinzufügen von 50%, 150% Optionen für die Schriftgröße der YouTube-Untertitel

## 1.4.5

- Behebung des Problems, bei dem Änderungen an den YouTube-Untertitelstilen nicht gespeichert wurden
...
- Unterstützung der Übersetzung von Eingabe-Tag-Knoten.
...
- Hinzufügen von Schnellzugriffen zum Aktivieren von Video-Untertiteln auf Netflix, Ted, Bloomberg, Udemy, Coursera.
...
- **Mobile Unterstützung für die Übersetzung bestimmter Absätze:** Die mobile Version unterstützt jetzt die Übersetzung bestimmter Absätze und hat eine Vielzahl von Tastenkombinationen hinzugefügt, darunter Wischen nach links, Wischen nach rechts, Doppeltippen, Dreifachtippen und Mehrfingergesten. Diese sind standardmäßig nicht aktiviert und erfordern, dass der Benutzer aktiv die auslösende Geste auf der Einstellungsseite unter [Maus-Hover] auswählt.
...
- **Popup-Panel-UI-Upgrade:** Das neue Design zielt darauf ab, die Benutzerfreundlichkeit und Verständlichkeit zu verbessern. Dieses Update umfasst:
  ...
  - **Neue Funktionen im Hauptmenü:**
    - **Zweisprachiger/Übersetzungs-Only-Modus-Schalter:** Sie können jetzt direkt im Hauptmenü zwischen "Zweisprachiger Übersetzungsmodus" und "Übersetzungs-Only-Modus" wechseln, links neben dem Übersetzungsknopf.
...
- **Hinzufügen der Unterstützung für 5 Video-Websites:**
  - Unterstützung für Untertitel von Podcasts auf Youtube Music.
  - Hinzufügen der Unterstützung für die iview.abc.net.au Website.
  - Hinzufügen der Unterstützung für die www.nma.art Website.
  - Hinzufügen der Unterstützung für die creativecloud.adobe.com Website.
  - Hinzufügen der Unterstützung für die www.masterclass.com Website.
...
- Hinzufügen eines Übersetzungs-Only-Modus auf der Einstellungsseite.
...
- **Deepl Sprachunterstützung**: Hinzufügen der Unterstützung für Portugiesisch (Brasilien).
...
- Behoben: Das Problem, dass nur ein Teil des Inhalts auf Hacknews verschwand, wurde behoben [#1264](https://github.com/immersive-translate/immersive-translate/issues/1264).
...
- Das Problem wurde behoben, bei dem Übersetzungen in einigen Fällen nicht rechtzeitig reagierten, wenn die Webseite in die mittlere Position gescrollt wurde.
- Der Fehler wurde behoben, bei dem das Umschalten von Untertiteln auf einigen Video-Websites dazu führte, dass die Übersetzung wiederholt angezeigt wurde.
- Das Problem wurde behoben, bei dem die Maus in einigen Fällen weiter übersetzte, ohne die Tastenkombination gedrückt zu halten.
...
- Reparatur des Konflikts mit einigen Plug-ins, die unendliches Seitenumblättern verursachen.
...
- 11 neue Schnittstellensprachen für das Plugin und die offizielle Website hinzugefügt, jetzt werden 14 unterstützte Schnittstellensprachen erreicht, darunter Chinesisch vereinfacht, Chinesisch traditionell, Englisch, Japanisch, Koreanisch, Russisch, Spanisch, Portugiesisch, Hindi, Italienisch, Deutsch, Französisch, Arabisch und Persisch.
...
- Behebung von Emoji am Ende des Twitter-Eingabefelds, das nicht übersetzt werden kann
...
- Eingabefeldübersetzung: zeigt eine Popup-Erinnerung an, wenn es zum ersten Mal verwendet wird, und der Benutzer kann wählen, ob er es diesmal oder dauerhaft deaktivieren möchte, um versehentliche Berührungen zu vermeiden.
...
- Ermöglicht das Festlegen des Intervalls zwischen den Auslösern der Eingabeverstärkungskombination
...
- Eingabeverstärkung unterstützt Übersetzungsergebnisse ctrl+z Rückgängig
...
- Eingabefeldverstärkung: ermöglicht das Weglassen des Präfixes // und das Auslösen der Übersetzung des gesamten Eingabefelds mit 3 Leerzeichen, oder Sie können diese Option auf der Einstellungsseite deaktivieren.
...
- Behebt das Problem, dass epub einige Bücher nicht übersetzt

## 0.6.18

- Behebt das Problem mit der Überbreite des Safari-Popup-Fensters.
...
- PDF-Übersetzungsoptimierung
- Anpassung für die Good Reads-Website, Amazon und South China Morning Post-Website
...
- Behebt das Problem, dass die Eingabefeldverstärkung nicht aktiviert ist, wenn die Website auf "nie übersetzen" eingestellt ist.
...
- Eingabefeldverstärkung zeigt den Ladezustand in der Übersetzung an
...
Die aufregendste Eingabefeldverstärkung ist da:
...
- Feat: Neue Kundenguideseite hinzufügen

## 0.5.2

- Fix: Benutzerskript-Maus-Hover-Tastenkombinationseinstellungen
...
- Fix: Benutzerskript-Berechtigung (nur für Benutzerskript).
...
- Leistung: Schließen Sie einige untergeordnete Werbeseiten auf der Website aus, und die Leistung hat sich ein wenig verbessert

## 0.4.7

- Fix: Firefox-Benutzerskript-Popup fehlt.

## 0.4.6

- Feat: Erlauben Sie Drittanbietern, Dokumentereignisse zu senden, um `toggleTranslatePage` aufzurufen
- Feat: iOS-App fügt Erweiterungsschaltfläche und Community-Link hinzu
...
- Fix: Content Security Policy-Popup für Erweiterung und teilweise für Benutzerskript.
...
- UI: OpenAI-Benutzerdefinierte Optionen standardmäßig ausblenden.
...
- Fix: Benutzerskript-eBook-Export
...
- Fix: E-Book-Identifikator dupliziert
...
- Fix: OpenAI maximale Token-Grenze, Änderung der maximalen Zeichen von 1500 auf 1300.

## 0.2.81

- Fix: m.youtube.com
- Fix: Optionen Formular UI
- Fix: Open AI Eingabeaufforderung
...
- Tabs-Berechtigung für Chrome Store Ablehnung entfernen
...
- Verwenden Sie das neueste esbuild
...
- Übersetzungsdienst-Links ersetzen
...
- Behebt telegra.ph, um Elementänderungen zu verhindern

## 0.0.61

- Behebt das Schließen von span-Elementen.
...
- Ändert Popup-UI, um die Nutzung zu erleichtern
...
- Behebt die Anzeige von Elementen mit display none.
...
- Behebt, dass block img übersetzt wird.
...
- Ermöglicht allen Websites die Erkennung der Absatzsprache.

## 0.0.35

- Behebt YouTube, um zur nächsten Seite zu gelangen
- Unterstützung für YouTube-Suchseite.
- Behebt erweiterten Schalter der Optionen.
- Behebt img-Tag, verstecktes Tag
  [#5](https://github.com/immersive-translate/next-immersive-translate/issues/5)
- Behebt Google-Suche, um zu erzwingen, dass die Seite aktualisiert wird
...
- Unterstützung für das Festlegen des Seitenbereichs, der übersetzt werden muss, sodass Sie mehr Bereiche übersetzen können.
- Unterstützung für das Festlegen der ersten x Textanzahl, die sofort übersetzt werden soll.
...
- Fügt dist js-Datei zum öffentlichen Repository hinzu
...
- Behebt volc alpha userscript connect Berechtigung.
...
- Besser für die Erkennung von Chinesisch
...
- Behebt, dass einige span-Tags Blockelemente sind
