...
- Hinzugefügt: Android-Browser unterstützt kostenlose Bildübersetzung.
...
- Verbessert: Übersetzungspause leert sofort die Anfrageliste.
...
- Hinzugefügt: Warnung anzeigen, wenn die Quellsprache und die Zielsprache identisch sind.
...
- Behoben: Probleme mit der Rich-Text-Übersetzung für Übersetzungsdienste wie Google, DeepL (z.B. Seiten, die direkt `<button>` anzeigen, etc.)
...
- Behebung der nicht synchronisierten Multi-Geräte-Synchronisationszeit für Pro-Nutzer
...
- **Mobile Unterstützung für die Übersetzung spezifischer Absätze:** Die mobile Version unterstützt jetzt die Übersetzung angegebener Absätze und hat eine Vielzahl von Schnellzugriffsoperationen hinzugefügt, darunter Wischen nach links, Wischen nach rechts, Doppeltippen, Dreifachtippen und Mehrfinger-Touch-Gesten. Diese sind standardmäßig nicht aktiviert und erfordern, dass der Benutzer aktiv die auslösende Geste auf der Einstellungsseite unter [Maus-Hover] auswählt.
...
- Optimierung: Die Standardreihenfolge der Webseitentitel wurde in [Chinesisch - Englisch] geändert.
...
- Behoben: Das Problem, dass die Maus in einigen Fällen weiter übersetzte, ohne die Tastenkombination gedrückt zu halten.
...
- ChatGPT standardmäßig im mobilen Modell, was schneller ist!
...
- Feat: Erlauben Sie Passwort-Eingabeformular, Passwort anzuzeigen.
...
- Stelle Seite wieder her, wenn "Diese Seite nie übersetzen" aktiviert ist
...
- Verwende sendMessage anstelle von connect, da Chrome den Port nach
  5 Minuten trennt
...
- Behebe pre-Leerzeichen für einige Artikel
...
- Unterstütze Festlegung des Seitenbereichs, der übersetzt werden muss, sodass mehr Bereiche übersetzt werden können.
