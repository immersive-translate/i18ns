...
- Besser: Japanischen/koreanischen Container erkennen.
...
- Behebung: Userscript-Toggle-Maske mit Touch-Event.
...
- Hinzufügen von Wiederholungslogik zum Übersetzungsdienst

## 0.2.41

- Behebung: Userscript Niu-Übersetzung
- Behebung: XHTML-Übersetzung

## 0.2.40

- Behebung: Beta-Funktion anzeigen
- Behebung: Popup-Einstellungsseite auf neuer Tab-Seite
- Behebung: Übersetzungsplatzhalter ersetzen

## 0.2.39

- Unterstützung von Shortcuts für die Anzeige der Maskenübersetzung
- Unterstützung der Aktivierung von Beta-Funktionen im Entwicklerpanel
- Behebung von Shortcuts in der mobilen Erweiterung

## 0.2.38

- Unterstützung des Lade-Themas
- Behebung: getpocket.com
- Behebung: Nebenfußzeile für den Body-Bereich
- Behebung: Import/Export-Symbol

## 0.2.37

- Behebung: Frame-Ausschlussmarkierung

## 0.2.36

- Unterstützung der Synchronisierung mit Google Drive

## 0.2.35

- Behebung: Japanische rb-, rt-Tags ignorieren.
- Besser für Popup-UI mehr
- Besser für schlechte Userscript-Tipps
- Beitrag zur Über-Seite hinzufügen
- Behebung: Volc-Übersetzung für automatische Spracherkennung

## 0.2.34

- Behebung: Mehrsprachige Geschwindigkeit

## 0.2.33

- Unterstützung des vertikalen Schreibmodus, wie Japanisch.
- Hinzufügen von 3 Themen
- Hinzufügen des Niu-Übersetzungsdienstes

## 0.2.32

- Behebung: Grundlegende PDF-Übersetzung
- Behebung: Popup wählt einen nicht konfigurierten Dienst aus, geht zur Optionsseite.
- Behebung: Einstellungen bleiben geöffnet.
- Behebung: Mehrsprachige Erkennungsgeschwindigkeit

## 0.2.31

- Behebung: Dynamisches iframe CSS-Injekt

## 0.2.30

- Unterstützung der Userscript-Inline-iframe-Übersetzung.
- Unterstützung der Shadowroot-Übersetzung. Zum Beispiel:
...
- Behebung: Facebook-Übersetzung
- Unterstützung der Anzeige der Kontextmenüoption.
...
- Unterstützung der Inline-iframe-Übersetzung. (Nur für Erweiterung, nicht verfügbar für
  Userscript)
- Behebung: Mehrsprachige Übersetzung

## 0.2.26

- Behebung: Firefox Android Addon
- Erweiterte Einstellungen für Übersetzungsneuzeilen hinzufügen

## 0.2.25

- Unterstützung der iframe-Übersetzung, wie QQ-Mail, eingebetteter Tweet.

## 0.2.24

- Temporäre Übersetzungsseite für eine Weile hinzufügen
- Behebung: stay.app Userscript-Browser-API
- Behebung: stay.app Optionsseite

## 0.2.23

- Behebung: Mehrsprachige Seitenübersetzung

## 0.2.22

- Behebung: Userscript-Build

## 0.2.21

- Behebung: Firefox Online-PDF-Übersetzung

## 0.2.20

- Behebung: Macaque-Anforderungsproblem
- Behebung: Markieren Sie die hervorgehobene Zeilenhöhe

## 0.2.19

- Behebung: Tencent Smart Japanisch
- Behebung: Haikuo World Browser

## 0.2.18

- Behebung: Client-URL-Änderung, automatisches Beibehalten des Übersetzungsstatus.
...
- Hinzufügen des Hervorhebung-Übersetzungsthemas
...
- Behebt Google-Suche, um die Seite zu aktualisieren
