...
- Behoben [Wenn die Webseitenübersetzung vorübergehend für lange Zeit aktiviert ist, wird durch Klicken auf das Panel [Diese Website immer übersetzen] die immerwährende Übersetzung nicht aufgehoben #1172](https://github.com/immersive-translate/immersive-translate/issues/1172)

## 0.12.7

- Zweisprachige Untertitel hinzugefügt, um die Plattformen [TED](https://www.ted.com), [Frontend Masters](https://frontendmasters.com/), [edx](https://www.edx.org/), [CodeWithChris](https://www.edx.org/), [Skillshare](https://www.ted.com) zu unterstützen. https://learn.codewithchris.com/enrollments), [Skillshare](https://www.skillshare.com/) Plattformen
...
- Bietet schnellen Zugriff auf zweisprachige Versionen aller Arbeiten auf der [Arxiv](https://arxiv.org/abs/1910.06709) Paper-Seite.
...
- [Fehlerbehebung bei der Anzeige des Lernmodus #1180](https://github.com/immersive-translate/immersive-translate/issues/1180)
- [Vorübergehendes Einschalten der Webübersetzung für eine bestimmte Zeit hebt Nicht immer übersetzen nicht auf #1172](https://github.com/immersive-translate/immersive-translate/issues/1172)
- Optimierung von PDF-Datei-Initialisierungsproblemen

## 0.12.3

- Fehlerbehebung für die Funktion [Video-Untertitel dauerhaft deaktivieren] funktioniert nicht [#1175](https://github.com/immersive-translate/immersive-translate/issues/1175)

## 0.12.2

- Unterstützung für zweisprachige Untertitel für weitere Videoplattformen, die nun unterstützt werden: [Youtube](https://www.youtube.com/), [Netflix](https://www.netflix.com), [Udemy](https://www.udemy.com/), [Khanacademy](https://www.khanacademy.org/), [Coursera](https://www.coursera.org/), [Vimeo](https://vimeo.com/), [Nebula](https://nebula.tv), [Bloomberg](https://www.bloomberg.com), [Bilibili](https://www.bilibili.com/), usw. (Beachten Sie, dass aufgrund technischer Einschränkungen einige Websites die Seite nach dem ersten Aktivieren der zweisprachigen Untertitel neu laden müssen oder warten müssen, bis die Übersetzung abgeschlossen ist, um die zweisprachigen Untertitel anzuzeigen).
...
- Ein Schnellübersetzungsportal für PDFs wurde auf der rechten Seite der [Arxiv](https://arxiv.org/abs/1910.06709) Paper-Website hinzugefügt, das zu einer sauberen HTML-Seite führt (nur bei einigen Papieren unterstützt, da dies die Einreichung des Quellcodes durch die ursprünglichen Autoren erfordert, daher wird dieses Portal bei etwa 50% der Papiere angezeigt)
...
- Unterstützt [Pro-Mitgliedschaft aktivieren](/pricing), die es Benutzern ermöglicht, Deepl- und OpenAI-Übersetzungen sowie Cloud-Synchronisationseinstellungen zu genießen.
...
- Benutzerdefinierte Regeln unterstützen jetzt die Zusammenführung mit den standardmäßigen integrierten Regeln, z.B.: `{"id": "youtube", "selectors.add":["#test"]}` bedeutet das Hinzufügen eines `#test` zu den vorhandenen Selektoren, `selectors` bedeutet das Überschreiben des Standards, `selectors.remove` bedeutet das Löschen eines der Standardselektoren, und `selectors.remove` bedeutet das Löschen eines der Standardselektoren, und `selectors.remove` bedeutet das Löschen eines der Standardselektoren. entfernt einen der Standardselektoren.
- Safari-Symbol aktualisiert, ein bisschen größer.
...
- Änderung der Standardeinstellungen: Aufgrund des Feedbacks einer großen Anzahl von Nutzern, dass sie das Übersetzungstool nach der Installation nicht verwenden werden, besteht ihre Erwartung an das Übersetzungstool darin, dass es englische Webseiten nach der Installation automatisch übersetzt. Daher wird ab dieser Version für chinesische Nutzer die Option, englische Seiten standardmäßig zu übersetzen, aktiviert (wenn der Nutzer eine vorherige Einstellung der Sprache hatte, die immer übersetzt wird, dann wird diese beibehalten, und die Änderung modifiziert nur die anfänglichen Einstellungen der Erweiterung). Wenn sie abgebrochen werden muss, kann sie leicht im [Popup-Panel oder Einstellungsseite](/docs/faq/#%E5%A6%82%E4%BD%95%E5%85%B3%E9%97%AD%E8%87%AA%E5%8A%A8%E7%BF%BB%E8%AF%91) abgebrochen werden.
...
- Wenn das Eingabefeld ohne Präfix konfiguriert ist, unterstützt es die Übersetzung `ja Hallo` ins Japanische und `Englisch Hallo` ins Englische.
...
- Fix: Deaktivierung des Kontextmenüs funktioniert nicht [#428](https://github.com/immersive-translate/immersive-translate/issues/428)
- Fix: Umgehung der Content Security Policy für [Mastodon](https://mastodon.social/)
...
- Feat: Drittanbietern erlauben, das Dokumentenereignis zu senden, um `toggleTranslatePage` aufzurufen
- Feat: iOS-App fügt Schaltfläche zum Aktivieren der Erweiterung und Links zu Communities hinzu
...
- Fix: Kontextmenü ist manchmal nicht verfügbar. [#273](https://github.com/immersive-translate/immersive-translate/issues/273)

## 0.3.16

- Fix: Behalte &nbsp; als Leerzeichen.
- Entfernen: Papago wird entfernt, da [der Dienst eingestellt ist](https://github.com/immersive-translate/immersive-translate/issues/310)
...
- Korrektur: Spezifisches Zeichenproblem beim Ebook-Builder, wie einige Kapitelpfade `xxx' xxxx`.
...
- Funktion: Temporäre Übersetzungswebsite-Zeitoptionen in `Erweiterte Einstellungen` hinzufügen
...
- Fix: Einige Seiten verwenden `span` für Stile, daher verwenden wir `font` anstelle von span als Wrapper für das Übersetzungsziel
- Fix: OpenAI Maximal-Token-Limit, Änderung der maximalen Zeichen von 1500 auf 1300.
...
- Feat: Unterstützung für mehrere OpenAI-Schlüssel, verwenden Sie `,` um sie zu trennen.
...
- Funktion: Hinzufügen von `<all>` für immer Sprachen übersetzen, sodass Sie es jetzt verwenden können, um alle Sprachen außer der Zielsprache zu übersetzen, und niemals Sprachen übersetzen.
- Fix: Konfiguration der benutzerdefinierten Google API erlauben.
...
- Behebung des Problems beim Hochladen auf Google Drive (wirklich) [#81](https://github.com/immersive-translate/immersive-translate/issues/81)

## 0.2.49

- Entfernen der Shortcuts Alt+D, Alt+S, da sie mit nativen Shortcuts in Konflikt stehen könnten.
- Behebung des Problems beim Hochladen auf Google Drive [#81](https://github.com/immersive-translate/immersive-translate/issues/81)
...
- Unterstützung für Inline-iFrame-Übersetzung. (Nur für die Erweiterung, nicht verfügbar für
  Userscript)
...
- Fehler behoben
  ...
  Problem mit Datei-URL-Übereinstimmung
...
- Fehler behoben
  ...
  Mehrfaches Erstellen des Kontexts
...
- Keine Übersetzung des Absatzes, der nur Platzhalterelemente enthält, zum
...
- Behebung der Schriftgröße in den Optionen der Benutzeroberfläche
...
- Fehlerbehebung bei speziellen Wikipedia-Zeichen
...
- Die Standard-Hotkey-Kombination zum Umschalten der Übersetzung wurde zu `alt+A` geändert, da
  dies die am einfachsten zu tippende Taste ist.
...
- Fehler behoben: Lokale Datei nach dem Speichern übersetzen. Behoben
