...
- Fixed: Problem mit der Rich Text-Übersetzung [#2163](https://github.com/immersive-translate/immersive-translate/issues/2163)
...
- Unterstützung für den Request-Header anthropic-dangerous-direct-browser-access für Claude Anthropic API
...
- Fixed: Problem mit der Synchronisierung benutzerdefinierter AI-Experten
...
- Fixed: Problem, bei dem die [Erweiterte Einstellungen -> Mindestanzahl von Zeichen, die für die Übersetzung eines Absatzes erforderlich sind] in einigen Fällen nicht wirksam wurde
...
- Unterstützung für benutzerdefinierte AI-Experten, der Zugang befindet sich am unteren Rand der Seite [Settings]->[AI Expert].
...
- Behebung der proportionalen Skalierung der Schriftgröße, wenn YouTube im Vollbildmodus ist [#1681](https://github.com/immersive-translate/immersive-translate/issues/1681)
...
- AI-Übersetzungsdienste können jetzt die Modellauswahl anpassen, wie z.B. [OpenAI], das System hat nur einige der am häufigsten verwendeten Modelle eingebaut. Durch Klicken auf die Modell-Dropdown-Liste ist der letzte Punkt, den Sie sehen, [Mehr Modelle festlegen], nach der Einstellung wird es automatisch gespeichert, um den Benutzern das Testen verschiedener benutzerdefinierter Modelle zu erleichtern.
...
- Behebung des Problems des nicht übersetzten Meldungsdialogfelds beim Öffnen der Reddit-Seite
...
- Behebung des Problems, dass Platzhalter bei der Erstellung von ePub nicht korrekt ersetzt wurden
...
- **Mobile Unterstützung für die Übersetzung bestimmter Absätze:** Die mobile Version unterstützt jetzt die Übersetzung bestimmter Absätze und hat eine Vielzahl von Schnellzugriffsoperationen hinzugefügt, einschließlich Wischen nach links, Wischen nach rechts, Doppeltippen, Dreifachtippen und Mehrfinger-Touch-Gesten. Diese sind standardmäßig nicht aktiviert und erfordern, dass der Benutzer aktiv die auslösende Geste auf der Einstellungsseite unter [Maus-Hover] auswählt.
...
- **Immersive Übersetzungserfahrung:** Um sich besser an Benutzergewohnheiten anzupassen, haben wir die Tastenkombination für zweisprachige Untertitel im Vollbildmodus auf der YouTube-Plattform nach links verschoben.
...
- Optimiert: Bei Verwendung des Maus-Hovers wurde das Problem behoben, bei dem das erneute Auslösen nach dem Verlust des Fokus auf der Seite unwirksam wurde.
- Behoben: Das Problem, bei dem der Cache nach der Änderung des Prompts/Modells in OpenAI weiterhin vorhanden war.
...
- Optimiert: Die Zielsprache wird jetzt automatisch basierend auf der Browsersprache festgelegt.
...
- Das Problem, bei dem die Maus ohne Drücken der Tastenkombination weiter übersetzte, wurde in einigen Fällen behoben.
...
- 11 neue Schnittstellensprachen für das Plugin und die offizielle Website hinzugefügt, jetzt werden 14 unterstützte Schnittstellensprachen unterstützt, darunter Chinesisch vereinfacht, Chinesisch traditionell, Englisch, Japanisch, Koreanisch, Russisch, Spanisch, Portugiesisch, Hindi, Italienisch, Deutsch, Französisch, Arabisch und Persisch.
- Die im letzten Release hinzugefügte zweisprachige Freigabe (Aktualisierungsmodus) wurde in die zweisprachige Seiten-Snapshot-Freigabe geändert, sodass der geteilte Inhalt originaler ist und eine breitere Anpassungsfähigkeit bietet.
...
- Behebung des Konflikts zwischen Youtube-Untertiteln und dem Dual Subtitle Plugin (Immersive Translate der Youtube-Untertitelübersetzung wird nicht aktiviert, wenn das Youtube Dual Plugin erkannt wird, um Konflikte zu vermeiden)
...
- Behebung des Übersetzungsproblems mit dem Custom DeppL Auth Key

## 0.10.3

- Perfekte Unterstützung für Youtube-Videos mit zweisprachigen Untertiteln 🎉.
- Bei Artikelseiten wird jetzt zuerst der Haupttext übersetzt, bevor der restliche Inhalt der Seitenleiste übersetzt wird.
...
- Beta-Funktionen: Custom API (Beta in den Entwicklereinstellungen aktiviert)
...
- Behebung: Gmail Translate All Regions Problem
...
- ChatGPT standardmäßig im mobilen Modell, das schneller ist!
...
- Behebung: postMessage beim Initialisieren der Seite brach einige Seiten, jetzt machen wir dies nur, wenn wir wirklich Seiten übersetzen
...
- Funktion: OpenAI unterstützt benutzerdefiniertes apiUrl für Entwicklereinstellungen.
...
- Fix: Userscript Google Drive-Synchronisierungsfehler.
...
- Fix: Userscript-Cloud-Synchronisierungsproblem
...
- Fix: Japanische rb, rt-Tag-Ignore.
...
- Entfernen Sie nicht standardmäßige Übereinstimmungen für Userscript
...
- Refaktorieren Sie die Popup-Position.

## 0.2.17

- Ändern Sie die Hervorhebung in Markierung
...
- Behebung des Problems, dass `globalThis.GM` in Safari nicht funktioniert
...
- Bessere Unterstützung für Inoreader
...
- Behebung des Zeilenabstands in PDFs

## 0.2.9

- Behebung der Markierung von auszuschließenden Elementen
- Behebung der Deno-Typprüfung
- Entfernen der Importmap
- Behebung der Übersetzung von Kontextmenüs
- Wiederherstellung der Seite, wenn "Diese Seite nie übersetzen" aktiviert ist
- Hinzufügen einer Beschreibung zum Hinzufügen von URLs

## 0.2.8

- Erkennung der Sprache des User-Agents für die Benutzeroberflächensprache
- Behebung eines Zeilenumbruchsfehlers
...
- Erhöhung der Version für CI-Tests

## 0.2.4

- Abfangen von Nachrichtenverbindungsfehlern für Popups
...
- Behebung von PDF-Beispieldateien
...
- Behebung der Berechtigungen für frühe Browser
...
- Bearbeitung der Beschreibung des Übersetzungsthemas

## 0.0.57

- Änderung der Popup-Benutzeroberfläche für einfachere Nutzung
...
- Keine Übersetzung von Absätzen, die nur Platzhalterelemente enthalten, z.B. [Beispiel](https://github.com/nank1ro/solidart), die erste Zeile
- Bessere Erkennung von Kindelementen

## 0.0.51

- Behebung von Cache-Problemen
...
- Behebung der Schriftgröße in der Options-Benutzeroberfläche
...
- Behebung von Leerzeichen vor Artikeln
...
- Unterstützung von Cache-Ergebnissen für Userscripts
- Hinzufügen einer Options-Benutzeroberfläche
...
- Bessere Popup-Benutzeroberfläche
...
- Behebung der Übersetzung lokaler Dateien nach dem Speichern. Behebung von
...
- Mehr Konfigurations-Benutzeroberfläche
...
- Hinzufügen von gestrichelten, Papierthemen
- Behebung der Erkennung von Überschriften
...
- Behebung der `volc alpha userscript`-Verbindungsberechtigung
- Behebung der Klickbarkeit der Version

## 0.0.25

- Unterstützung von `selectorMatches`, sodass wir jetzt alle `manstondon`-Elemente abgleichen können
- Behebung von Firefox-Userscript-Fehlern

## 0.0.23

- Bessere Erkennung von Chinesisch
- Behebung des `innerText`-Problems bei Reddit

## 0.0.22

- Unterstützung von `deeplx`
- Behebung mehrfacher Übersetzungen beim Wechseln des Dienstes

## 0.0.21

- Behebung, dass einige `span`-Tags Blockelemente sind

## 0.0.20

- Unterstützung der Nichtübersetzung von Hashtags wie `#hash`, At-Tags wie `@xxx`, `$tag`, wie `$APPL`
...
- Unterstützung von Userscripts

## 0.0.4.8

- Behebung der Reihenfolge des Codes
- Unterstützung der grundlegenden Popup-Benutzeroberfläche
