...
- Behoben: Problem, bei dem Inhalte verschwinden, nachdem man in Facebooks Nur-Übersetzungsmodus auf "mehr sehen" klickt.
...
- Hinzugefügt: Forece Enable Mouse Support-Modus (Aktivieren Sie diese Funktion nur, wenn die Mouse Hover-Funktion auf Tablet-Geräten nicht verfügbar ist) **Einstellungen** -> **Erweiterte Einstellungen** -> **Forece Enable Mouse Support**
...
- **Neuer Benutzerleitfaden**: Wenn neue Benutzer zum ersten Mal eine Seite in einer Nicht-Zielsprache öffnen, wird eine schwebende Ball-Hilfeanleitung angezeigt.
...
- Behebung des Übersetzungsseiten-Ruckelproblems des Reddit-Eingabefelds
...
- Hinzufügen eines Grease Monkey-Niedrigversion-Update-Alarms
...
- Untertitelübersetzungsunterstützung nur für den Export von Übersetzungen
...
- Fix: OpenAI maximale Token-Grenze, ändern Sie die maximale Zeichenanzahl von 1500 auf 1300.
...
- Unterstütze Festlegung des Seitenbereichs, der übersetzt werden muss, sodass Sie mehr Bereiche übersetzen können.
