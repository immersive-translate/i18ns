...
- Behoben: Problem mit Google-Übersetzung bei Escape-Zeichen.
...
- Verbessert: Online-Einstellungsseite testet den Zugriff auf die Dienstschnittstelle.
...
- Hinzugefügt: Unvollständige ePub-Dateien können nach dem erneuten Import von dort weiter übersetzt werden, wo sie aufgehört haben.
...
- Fixed: Problem, bei dem der Inhalt verschwindet, nachdem man im Übersetzungsmodus von Facebook auf "mehr anzeigen" klickt.
- ~~Verbessert: Verbesserte Anzeige von mehrzeiligen zweisprachigen Übersetzungen auf Twitter.~~
- Verbessert: Aktualisierte die Benutzeroberfläche der Dropdown-Liste des Übersetzungsdienstes im Panel.
...
- Fixed: Synchronisierte Untertitel-Zeitprobleme auf YouTube nach dem Ansehen von Werbung.
- Fixed: Anzeigeprobleme mit dem Rechtsklick-Übersetzungsmenü in Safari auf MacOS 15.
- Fixed: Probleme mit der Rückgängig-Funktionalität von Ctrl+Z im **Enhanced input** auf bestimmten Websites.

## 1.10.6 (2024-10-25)

- Fixed: Problem mit **Enhanced input**-Tastenkombinationen, die nicht ausgelöst werden
...
- Fixed: Problem mit der Übersetzung von Leerzeichen in Rich Text [#2175](https://github.com/immersive-translate/immersive-translate/issues/2175)
...
- Hinzugefügt: Modus "Forece Enable Mouse Support" (Aktivieren Sie diese Funktion nur, wenn die Maus-Hover-Funktion auf Tablet-Geräten nicht verfügbar ist) **Settings** -> **Advanced Settings** -> **Forece Enable Mouse Support**
- Hinzugefügt: Anzeige einer Fehlermeldung, wenn die Video-Untertitelübersetzung fehlschlägt
- Fixed: Problem mit der Übersetzung von Rich Text [#2163](https://github.com/immersive-translate/immersive-translate/issues/2163)
...
- Fixed: Kompatibilitätsproblem mit dem Safari-Plugin auf macOS 15 behoben
...
- Fixed: Problem mit der Synchronisierung von benutzerdefinierten AI-Experten
...
- Fixed: Problem mit der Anzeige von zweisprachigen Untertiteln für mehrere Videos auf derselben Twitter-Seite
- Fixed: Einige Bugs behoben

## 1.9.3 (2024-09-05)

- Die Option für zweisprachigen Vergleich/Übersetzung-Only-Anzeige wurde in die allgemeinen Einstellungen verschoben.
- Standardmäßig merkt sich das System den Modus, der durch Klicken auf das Symbol im Panel für zweisprachigen Vergleich oder Übersetzung-Only-Anzeige umgeschaltet wurde. Um vorübergehend zu wechseln, klicken Sie auf "Mehr" -> "Wechseln zu Übersetzung-Only-Anzeige" im Panel.
- Standardmäßig wird die Übersetzung von Vereinfachtem Chinesisch in Traditionelles Chinesisch und umgekehrt den Übersetzung-Only-Modus verwenden, anstatt den zweisprachigen Vergleichsmodus.
- Fixed: Einige Bugs behoben.
...
- Fixed: Problem, bei dem das Eingabefeld in der Tiktok-Privatnachrichtenoberfläche falsch übersetzt wurde
- Fixed: Problem, bei dem Comics auf Read Comic Online nicht übersetzt werden konnten
- Fixed: Problem, bei dem die [Erweiterte Einstellungen -> Mindestanzahl von Zeichen, die für die Übersetzung eines Absatzes erforderlich sind] in einigen Fällen nicht wirksam war
...
- Hinzugefügt: Option "Übersetzungsprobleme der aktuellen Webseite melden" und die Option "Schwebeball schnell ein-/ausschalten" in den weiteren Optionen des Panels.
...
- Optimierte Cache-Logik des Plugins, jetzt wird der Cache automatisch gelöscht, der älter als 30 Tage ist.
...
- Fixed: Übersetzungsprobleme mit dem Tampermonkey-Skript SiliconCloud
...
- Tastenkombinationseinstellungen erlauben jetzt die Zuweisung einzigartiger Tastenkombinationen für jeden Übersetzungsdienst
- Optimierte Erkennung für arXiv-Papierübersetzungen

## 1.7.9

- Fixed: Probleme mit der Rich Text Übersetzung für Übersetzungsdienste wie Google, DeepL (z.B. Seiten, die direkt `<button>` etc. anzeigen)
- Fixed: Problem, bei dem die zweisprachige Tastenkombination für YouTube-Videos nicht ausgeschaltet werden konnte.
...
- Verwendung eines AI-intelligenten Satztrennungsalgorithmus für automatisch generierte englische Untertitel auf YouTube [Pro Verfügbar]
...
- Unterstützung für benutzerdefinierte AI-Experten, der Zugang befindet sich am unteren Rand der [Settings]->[AI Expert] Seite.
...
- Fixed: Comic-Übersetzungsfehler im Firefox-Browser.
...
- YouTube zweisprachige Untertitel unterstützen jetzt intelligentes Satztrennen (Beta) (Nur wenn die immersive Übersetzung von YouTube-Untertiteln manuell in [Settings] - [Video Subtitles] aktiviert wird und die Originalvideo-Untertitel automatisch generierte englische Untertitel sind)
- Hinzugefügt: Übersetzungsdienst Tencent [【Hunyuan Large Model】](https://immersivetranslate.com/docs/services/tencent-hunyuan/)

- Behebung von Layoutproblemen bei Comic-Übersetzungen für Sprachen im lateinischen Schriftsystem.
...
- Neue Funktion: AI-Übersetzung unterstützt [Doubao großes Modell](https://www.volcengine.com/product/doubao)
...
- Unterstützung für Baidu Qianfan großes Modell Plattform, Alibaba Bailian großes Modell Plattform, DeepSeek großes Modell Plattform.
- Behebung des Problems, dass das Ändern der Zielsprache und anderer Einstellungen im Popup-Panel beim Klicken auf den Übersetzungsschwebeball zurückgesetzt wurde.
...
- Unterstützung für AI-Übersetzungsdienste, um [AI-Experte] festzulegen, um die Übersetzungsstrategie zu spezifizieren, derzeit eine Beta-Funktion, die in [Entwicklereinstellungen](https://dash.immersivetranslate.com/#developer) nach Aktivierung von Beta aktiviert werden kann, und das [AI-Experte] Menü kann nach dem Aktualisieren gesehen werden.
- AI-Übersetzungsdienste können jetzt die Modellauswahl anpassen, wie z.B. [OpenAI], das System hat nur einige der am häufigsten verwendeten Modelle eingebaut. Durch Klicken auf die Modellauswahlliste ist der letzte Punkt, den Sie sehen, [Mehr Modelle festlegen], nach der Einstellung wird es automatisch gespeichert, um den Benutzern das Testen verschiedener benutzerdefinierter Modelle zu erleichtern.
...
- Optimierung der traditionellen chinesischen Schnittstellenkopie.
...
- Behebung des Problems der Zusammenführung benutzerdefinierter Benutzerrichtlinien
...
- Deutliche Optimierung der Übersetzungsgeschwindigkeit von YouTube-Untertiteln und Unterstützung für den Wechsel zwischen chinesischer und englischer Reihenfolge, Anpassung der Schriftfarbe und -größe usw.
...
- Panel-Schalter zur Anzeige nur des Übersetzungsbuttons, der nur auf der aktuellen Seite wirksam ist
...
- Behebung des Shortcuts für die sofortige Übersetzung am Ende der Seite

## 1.2.4

- Behebung des Problems, dass Platzhalter bei der Erstellung von ePub nicht richtig ersetzt wurden
- Unterstützung für Video-Untertitel-Übersetzung [Unreal Sensei](https://www.unrealsenseiacademy.com/)
...
- Unterstützung für Video-Untertitel-Übersetzung für [pluto](https://pluto.tv/), [STARZ](https://www.starz.com/), [Paramount Plus](https://www.paramountplus.com/), [Rotten Tomatoes](https://www.rottentomatoes.com/), [Dailymotion](https://www.dailymotion.com/), [FMovies](https://fmoviesz.to/), [AniWatch](https://aniwatch.to/), [iQIYI](https://www.iq.com/), [Youku](https://www.youku.tv/), [movie-web](https://movie-web.app/). Unterstützt auch die Übersetzung einiger CC-Untertitel-Videos auf Twitter.
- Optimierung von Fehler-Popups, Netzwerkproblem-Fehler-Popups erkennen automatisch gültige kostenlose Übersetzungsdienste.
...
- Unterstützung für Video-Untertitel-Übersetzung für [Kanopy](https://www.kanopy.com/), [RachelsEnglishAcademy](https://www.rachelsenglishacademy.com/), [Hulu](https://www.hulu.com/), [Three.js Journey](https://threejs-journey.com/).
...
- Unterstützung für Video-Untertitel-Übersetzung auf [LinkedIn](https://www.linkedin.com/) und [Viu](https://www.viu.com/) Plattformen.
...
- Hinzufügen einer Option, dass der untergeordnete Übersetzungsdienst dem Hauptübersetzungsdienst folgt
...
- Hinzufügen einer Shortcut-Konfiguration für [Übersetze angegebenen Absatz] im schwebenden Ball-Panel auf mobilen Geräten
...
- Hinzufügen der Unterstützung für eine neue Shortcut-Einstellung, die ein schnelles Umschalten ermöglicht, ob Video-Untertitel die integrierten maschinellen Übersetzungsuntertitel verwenden
- Auf der Sci-Hub-Website wird durch Klicken auf den schwebenden Ball PDFs übersetzt, die in die Webseite eingebettet sind

## 1.1.6

- **Mobile Unterstützung für die Übersetzung bestimmter Absätze:** Die mobile Version unterstützt jetzt die Übersetzung bestimmter Absätze und hat eine Vielzahl von Shortcut-Operationen hinzugefügt, darunter Wischen nach links, Wischen nach rechts, Doppeltippen, Dreifachtippen und Mehrfinger-Touch-Gesten. Diese sind standardmäßig nicht aktiviert und erfordern, dass der Benutzer aktiv die auslösende Geste auf der Einstellungsseite unter [Maus-Hover] auswählt.
...
- **Immersive Übersetzungserfahrung:** Um sich besser an Benutzergewohnheiten anzupassen, haben wir den Shortcut für zweisprachige Untertitel im Vollbildmodus auf der YouTube-Plattform auf die linke Seite verschoben.
...
- **Popup-Panel-UI-Upgrade:** Das neue Design zielt darauf ab, die Benutzerfreundlichkeit und Verständlichkeit zu verbessern. Dieses Update umfasst:
  ...
  - **Neue Funktionen im Hauptmenü:**
    - **Zweisprachiger/Übersetzungs-nur-Modus-Schalter:** Sie können jetzt direkt im Hauptmenü zwischen "Zweisprachiger Übersetzungsmodus" und "Übersetzungs-nur-Modus" wechseln, links neben dem Übersetzungsbutton.
...
- **Integrierter Dokumentenübersetzungseintrag:** Jetzt können Sie PDF-, ePub- und Untertitel-Dateien über einen einheitlichen Upload-Eintrag übersetzen. Klicken Sie einfach auf den [PDF/ePub] Button im Popup-Panel, ohne [Mehr] auswählen zu müssen.
...
- Hinzufügen einer Erinnerungsfunktion beim Umschalten der Übersetzungsmodi mit Shortcuts.
...
- Behebung des Problems des zweisprachigen Untertitel-Shortcuts für YouTube mit zu langem englischen Text.

## 1.1.0

### Neue Funktionen

- **Shortcut-Tasten-Einstellungen**: Hinzufügen eines neuen Top-Level-Menüs "Shortcuts" und der folgenden anpassbaren Shortcut-Tasten-Funktionen:

  - Bestimmen Sie eine Tastenkombination, um den Inhalt des aktuellen Eingabefelds zu übersetzen, als Ergänzung zur vorherigen Methode, dreimal schnell die Leertaste zu drücken.
  - Bestimmen Sie eine Tastenkombination, um "direkte Übersetzung bei Maus-Hover" auf der Seite vorübergehend zu aktivieren. Durch erneutes Drücken wird diese Funktion aufgehoben.
  - Hinzufügen spezieller Shortcut-Tasten für 6 Übersetzungsdienste (wie DeepL, OpenAI, Google, Microsoft, Gemini, Tencent Interactive Translation), um den temporären Wechsel zwischen Übersetzungsdiensten zu erleichtern.
...
- Optimiert: Der Prozess des Zusammenführens manueller Untertitel wurde verbessert.
...
- Zweisprachige Untertitel hinzugefügt, um [TED](https://www.ted.com), [Frontend Masters](https://frontendmasters.com/), [edx](https://www.edx.org/), [CodeWithChris](https://www.edx.org/), [Skillshare](https://www.ted.com) Plattformen zu unterstützen. https://learn.codewithchris.com/enrollments), [Skillshare](https://www.skillshare.com/) Plattformen
- Die Hoverball ist jetzt standardmäßig ausgeblendet, wenn das Video im Vollbildmodus ist.
...
- Ein schnelles Übersetzungs-PDF-Portal wurde auf der rechten Seite der [Arxiv](https://arxiv.org/abs/1910.06709) Papierseite hinzugefügt, das zu einer sauberen HTML-Seite führt (nur von einigen Papieren unterstützt, da es erfordert, dass die ursprünglichen Autoren den Quellcode einreichen, sodass ungefähr 50% der Papiere dieses Portal anzeigen)
- Online-PDF-Seiten ohne .pdf-Erweiterung können jetzt direkt zur PDF-Übersetzungsseite springen, indem Sie auf die Hoverball auf der Seite klicken.
...
- Die im letzten Release hinzugefügte zweisprachige Freigabe (Aktualisierungsmodus) wurde in die zweisprachige Seiten-Snapshot-Freigabe geändert, sodass der geteilte Inhalt originaler ist und eine breitere Anpassungsfähigkeit aufweist.
...
- Behebt, dass YouTube gelegentlich zur Startseite zurückkehrt
...
- Das PDF-Übersetzungstool wird auf die Online-Version migriert: https://app.immersivetranslate.com/pdf/ , sodass Grease Monkey und Safari die PDF-Übersetzung verwenden können, und Probleme können besser iteriert werden, ohne dass eine Version veröffentlicht werden muss, um das Problem zu lösen.
...
- Behebt: Gmail Übersetzen aller Regionen Problem
...
- Behebt, dass das Grease Monkey-Symbol nicht angezeigt wird
...
- Behebt das Problem mit dem Überlauf der Popup-Breite in Safari.
...
- Behebt das Problem, dass die Eingabebox-Verbesserung nicht aktiviert ist, wenn die Website auf "nie übersetzen" eingestellt ist.
...
- Windows-Dropdown-Box-Linksausrichtung
...
- Behebt einige Eingabebox-Stile
...
Die Standardsprache für die Eingabebox-Übersetzung kann jetzt den Leerraum weglassen, d.h. //Hello World kann ebenfalls übersetzt werden.
...
- Beheben Sie das Problem, dass zweisprachige eBooks nach dem Export keine Bilder haben
...
- Optimierung: Die Mindestanzahl von Zeichen in einem Absatz, die eine Übersetzung auslöst, wurde auf mindestens 4 Zeichen geändert, um Verwirrung zu reduzieren, während andere Funktionen verwendet werden, um die Navigation und Endbereiche der Website nicht zu übersetzen.
- Behebung: Github-Details werden nach dem Erweitern nicht übersetzt.

## 0.5.14

- Beheben Sie das Problem, dass Bilder auf einigen Webseiten nach dem Kopieren größer werden
...
- Optimierung des OpenAI-Anforderungsfrequenzbegrenzungsproblems
...
- Optimiert für das OpenAI-Anforderungsratenlimitproblem
...
- Funktion: Neue Anleitung für neue Benutzer.

## 0.5.5

- Behebung: Maus-Hover-Bereichsproblem.
...
- Funktion: Neue Kundenseite hinzufügen
...
- Funktion: Übersetzen Sie den aktuellen Absatz, wenn die Maus darüber schwebt.
...
- Behebung: Vermeiden Sie Content Security Policy für [Mastondon](https://mastodon.social/)
...
- Funktion: Erlauben Sie Drittanbietern, Dokumentereignisse zu senden, um `toggleTranslatePage` aufzurufen
- Funktion: iOS-App fügt Erweiterungsschaltfläche und Community-Links hinzu
...
- Behebung: Kontextmenü ist manchmal nicht verfügbar. [#273](https://github.com/immersive-translate/immersive-translate/issues/273)

## 0.3.16

- Behebung: &nbsp; als Leerzeichen beibehalten.
...
- Behebung: Options-UI-Schalter Übersetzungsdiensteingabestatus nicht geändert.
...
- Funktion: Temporäre Übersetzungszeitoptionen auf der Website in den `Erweiterten Einstellungen` hinzufügen
...
- Füge eine maximale Textlängenoption pro Anfrage mit Open AI hinzu
- Fix: ebook identifier dupliziert
- Feat: Unterstützung für die Übersetzung von txt-Webseiten
...
- Feat: Unterstützung für Ebook Reader und Maker

## 0.2.83

- Feat: Erlaube Passwort-Eingabeformular, das Passwort anzuzeigen.

## 0.2.82

- Fix: Einige Seiten verwenden `span` für Stile, daher verwenden wir `font` anstelle von span für den Übersetzungsziel-Wrapper
- Fix: OpenAI max tokens limit, ändere max chars von 1500 auf 1300.
...
- Fix: Open AI prompt
- Feat: Unterstützung für mehrere OpenAI-Schlüssel, trenne sie mit `,`.
...
- Fix: Open AI für Leerzeichen-Absatz
...
- Fix: Mehrfacher Code-Tag-Fehler.[#178](https://github.com/immersive-translate/immersive-translate/issues/178)
...
- Feat: Füge `<all>` für immer zu übersetzende Sprachen hinzu, sodass du jetzt alle Sprachen außer der Zielsprache übersetzen und nie zu übersetzende Sprachen verwenden kannst
- Fix: Erlaube die Konfiguration benutzerdefinierter Google API
- Besser: Deepl Free Unterstützung
- Fix: Hoher Speicherverbrauch für Userscripts und Erweiterung (durch Entfernen von opencc zh-CN zu zh-TW, stattdessen mit Google Translate)
...
- Übersetze den Seitentitel nicht, wenn er sich im iframe befindet
...
- Feat: Unterstützung für Azure Translate Service
- Feat: Unterstützung für Papago Translate Service
- Fix: native Firefox Android Google Drive Sync.
- Fix: Ändere Transparenz von 0.4 auf 0.618 [#147] (https://github.com/immersive-translate/immersive-translate/pull/147)
- Fix: Popup-Shortcuts-Tipps
- Performance: Serielle zu gleichzeitigen Anfragen
- Besser für die Erkennung japanischer Zählung

## 0.2.62

- Feat: Füge waitForSelectors Regel hinzu, um einige Seiten wie Reddit zu reparieren
...
- Fix: translate=no Element überschreibt
...
- Versuche, das Deepl API-Zeichensatzproblem zu beheben

## 0.2.54

- Entferne Tabs-Berechtigung für Chrome Store Ablehnung
- Fix Übersetzung der gesamten Seite, Fußzeile wird ignoriert
- Notizen zur Über-Seite hinzufügen
- Unterstützung für benutzerdefinierte URL aus eingebauter Konfiguration

## 0.2.53

- Fix Userscript Google Drive Sync-Fehler.

## 0.2.52

### Code

- Verwende die neueste esbuild
- Verwende die neueste Deno-Version
- CI: Quellcode an Firefox übermitteln

## 0.2.51

- Fix Google Auth benötigt Login auf Chrome/Firefox
- Ersetze Links des Übersetzungsdienstes
...
- Entferne Shortcuts alt+d, alt+s, da sie möglicherweise mit nativen Shortcuts in Konflikt stehen.
...
- Fix Google Drive Token-Validierung.
...
- Fix Userscript Toggle-Maske
- Fix Toggle-Masken-Logik

## 0.2.43

- Fix Userscript Toggle-Maske mit Touch-Event.
- Fix Geschwindigkeit (durch Entfernen von sleep(300))

## 0.2.42

- Fix Maskenhover, wenn die Maske erneut umgeschaltet wird.
- Füge Masken-Shortcuts für Mobilgeräte hinzu
- Fix Userscript Cloud-Sync-Problem
- Verschiebe erweiterte Optionsseite ins linke Menü.
- Füge Wiederholungslogik für den Übersetzungsdienst hinzu
...
- Fix getpocket.com
- Fix aside Fußzeile für Body-Bereich
...
- Unterstützung für die Synchronisierung mit Google Drive
...
- Unterstützung für Shadowroot-Übersetzung. Zum Beispiel:
  ...
  Gesprächsbereich.
- Überprüfe auch die Synchronisierungsregel im Popup
...
- Entferne nicht standardmäßige Übereinstimmung für Userscript

## 0.2.27

- Unterstützung für Inline-iframe-Übersetzung. (Nur für Erweiterung, nicht verfügbar für
  Userscript)
- Fix Mehrsprachigkeit Übersetzung

## 0.2.26

- Fix Firefox Android Addon
- Füge erweiterte Einstellungen für Übersetzungsneuzeile hinzu
...
- Füge temporäre Übersetzungsseite für eine Weile hinzu
- Fix stay.app Userscript Browser-API
- Fix stay.app Optionsseite

## 0.2.23

- Fix Mehrsprachigkeit Seitenübersetzung
...
- Fix Markierung Highlight Zeilenhöhe
...
- Fix Client-URL-Änderung, automatische Beibehaltung des Übersetzungsstatus.
- Entferne aside Container als Übersetzungscontainer.
- Refactor Popup-Position.

## 0.2.17

- Ändere Highlight zu Markierung
- Füge Highlight-Übersetzungsthema hinzu
...
- Behebt das Problem, dass safari globalThis.GM nicht funktioniert

## 0.2.13

- Unterstützung für das Ziehen von Userscript-Popups
- Unterstützung für das Auslösen des Umschaltens von Übersetzungsseiten mit drei Fingern auf Touch-Geräten
...
- Behebt den Abstand der Zeilenhöhe in PDFs

## 0.2.9

- Behebt das Markieren von auszuschließenden Elementen
- Behebt deno type check
- Entfernt importmap
- Behebt die Übersetzung von Kontextmenüs
- Stellt die Seite wieder her, wenn "Diese Seite nie übersetzen" aktiviert ist
- Fügt eine Beschreibung für das Hinzufügen von URLs hinzu

## 0.2.8

- Erkennt die Sprache des Benutzeragenten für die Schnittstellensprache
- Behebt einen Zeilenumbruchfehler.

## 0.2.7

- Behebt grease monkey request
...
- Erhöht die Version für CI-Test

## 0.2.4

- Fängt Verbindungsfehler für Popup-Nachrichten ab.
...
- Behebt PDF-Beispieldatei
- Behebt Firefox PDF lokale Datei
- Behebt PDF-Verknüpfungen

## 0.2.1

- Unterstützung für Grease Monkey Shortcuts-Manager.
- Behebt regex-Übereinstimmung
- Behebt YouTube-Kommentare.
- Behebt Reddit mobile kompakte Version
- Behebt Volltext-Übersetzungsproblem

## 0.2.0

- Behebt PDF-Zweispalten.
- Behebt Chrome/Edge Store Versionsfehler.
- Behebt
...
- Behebt PDF-Rand.
- Ändert PDF-Beispieldatei

## 0.0.62

- Behebt PDF-Format, Einrückung.
- Behebt telegra.ph Elementänderung verhindern

## 0.0.61

- Behebt schließendes span-Element.
- Behebt Berechtigung für frühe Browser
...
- Bearbeitet die Beschreibung des Übersetzungsthemas

## 0.0.57

- Ändert Popup-UI, für einfachere Nutzung

## 0.0.56

- Behebt Chrome-Timeout
- Behebt Fehler bei der Satztrennung.

## 0.0.55

- Behebt Anzeige von "none" Elementen.
- Refaktoriert Elementmarkierung

## 0.0.54

- Unterstützung für Zeilenumbruch für X Zeichen.

## 0.0.53

- Verwendet sendMessage anstelle von connect, da Chrome den Port nach 5 Minuten trennt
- Besser für die Erkennung von Textcontainern

## 0.0.52

- Übersetzt nicht den Absatz, der nur Platzhalterelemente enthält, zum
  [Beispiel](https://github.com/nank1ro/solidart), die erste Zeile.
- Besser für die Erkennung von Kindelementen.

## 0.0.51

- Behebt Cache-Problem
...
- Behebt Schriftgröße der Optionen-UI

## 0.0.50

- Behebt Übersetzung von block img.

## 0.0.49

- Behebt Firefox-Erweiterung

## 0.0.48

- Behebt Chrome-Erweiterung

## 0.0.47

- Umschreiben von Nachrichten mit Hintergrund, verwendet connect anstelle von sendMessage
- Fügt Unterstützung für Reddit mobile hinzu
- Behebt vor weißen Raum für einige Artikel

## 0.0.46

- Formatiert Userscript-Metainformationen

## 0.0.45

- Userscript verwendet eine Datei.
- Fügt Timeout für Cache-Anfrage hinzu

## 0.0.44

- Behebt Fehler bei der Trennung von Tencent.
- Behebt Fehler bei Inline-Sup-Element.
- Besser für Twitter

## 0.0.43

- Behebt Tweet br
- Behebt globale Übersetzung.

## 0.0.42

- Behebt BR-Tag
- Behandelt Block-Tags zu Regeln

## 0.0.41

- Behebt Überprüfung von Inline-Elementen
- Fügt Entwickler-Debug-Log-Option hinzu

## 0.0.39

- Behebt Übersetzungsdienst enthält mock2

## 0.0.38

- Unterstützung für Cache-Ergebnis für Userscript
- Fügt Optionen-UI hinzu
- Unterstützung für die Erkennung weiterer Inhaltscontainer

## 0.0.37

- Behebt Änderung des Popup-Übersetzungsdienstes funktioniert nicht
- Behebt Übersetzung von Reddit mobile Post-Inhalten.

## 0.0.36

- Behebt Wikipedia-Sonderzeichen
  [#6](https://github.com/immersive-translate/next-immersive-translate/issues/6)
- Behebt Größe des Userscript-Icons.
- Ermöglicht allen Seiten die Erkennung der Absatzsprache.

## 0.0.35

- Behebt YouTube zum nächsten Seite gehen
- Unterstützung für YouTube-Suchseite.
- Behebt erweiterte Schalteroptionen.
- Behebt img-Tag, verstecktes Tag
  [#5](https://github.com/immersive-translate/next-immersive-translate/issues/5)
- Behebt Google-Suche erzwungenes Aktualisieren
...
- Unterstützung für sofortigen Übersetzungsmodus, damit Sie die Webseite so schnell wie möglich übersetzen können.
...
- Behebt doppelte Übersetzung bei Änderung der Übersetzung
- Besseres Popup-UI
...
- Behebt Übersetzung lokaler Dateien nach dem Speichern. Behebt
  [#1](https://github.com/immersive-translate/next-immersive-translate/issues/1)
- Fügt dist js-Datei zum öffentlichen Repo hinzu

## 0.0.31

- Unterstützung für die Übersetzung der gesamten Seite
- Unterstützung für sofortige Übersetzung der Seite
- Mehr Konfigurations-UI
- Reflektiert das Thema
- Fügt neues Icon hinzu
- Fügt neues Übersetzungsthema dashedBorder hinzu
...
- Behebt gültigen Absatz.
- Fügt gepunktetes, dünn gestricheltes Thema hinzu
- Besser für gestricheltes, hervorgehobenes Thema

## 0.0.28

- Behebt Unterstreichung
- Fügt gestricheltes, Papier-Thema hinzu
- Behebt erkannte Kopfzeile

## 0.0.27

- Unterstützung für translationTheme

## 0.0.26

- Behebt volc alpha Userscript-Verbindungsberechtigung.
- Behebt klickbare Version.

## 0.0.25

- Unterstützung für selectorMatches, damit wir jetzt alle manstondon abgleichen können.
- Behebt Firefox Userscript-Fehler.

## 0.0.23

- Besser für chinesische Erkennung
- Behebt Reddit innerText-Problem

## 0.0.22

- Unterstützung für deeplx
- Behebt mehrfache Übersetzung beim Wechseln des Dienstes

## 0.0.21

- Behebt einige span-Tags sind Blockelemente
...
- Behebt Code-Reihenfolge.
- Unterstützung für grundlegendes Popup-UI

## 0.0.4.6

- Unterstützung für Überprüfung neuer Versionen
