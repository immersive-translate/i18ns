...
- Behoben: Ein Problem mit der Hover-Übersetzung im Modus "Übersetzung zuerst, Originaltext folgt".
...
- Optimiert: Gemini-Übersetzungsdienst unterstützt benutzerdefinierte Systemaufforderungen (System Prompt).
...
- Behoben: Ein Problem behoben, bei dem einige Inhalte während der Mehrsegmentübersetzung in Gemini übersehen wurden.
...
- Hinzugefügt: Echtzeit-Meeting **Subtitles Translation** unterstützt jetzt die Aktivierung über "Schwebeball", verfügbar auf Zoom, Google Meet und Microsoft Teams.
...
- Verbessert: Verbesserung der Darstellung übersetzter Formeln
...
- Epub-Dateien unterstützen jetzt die Rich-Text-Übersetzung (d.h. das Beibehalten des Formats des Originaltextes jedes Absatzes, wie Links, Fett, etc.)
...
- Nach der Auswahl des Textes ändert sich das Rechtsklick-Menü zu [Text übersetzen], klicken Sie darauf, um automatisch zur Immersive Translation Text Translation-Seite zu springen
...
- Neue Benutzer-Feedback-Schaltfläche für Manga-Übersetzung (nach der Übersetzung eines Mangas klicken Sie auf die [Feedback]-Schaltfläche auf der rechten Seite des Schwebeballs, um Feedback zur Übersetzungsqualität zu geben).
...
- Unterstützung für benutzerdefinierte AI-Experten, der Eingang befindet sich unten auf der Seite [Einstellungen]->[AI-Experte].
...
- YouTube-Zweisprachige Untertitel unterstützen jetzt intelligentes Satztrennen (Beta) (Nur wenn die immersive Übersetzung von YouTube-Untertiteln manuell in [Einstellungen] - [Video-Untertitel] aktiviert wird und die Original-Video-Untertitel automatisch generierte englische Untertitel sind)
...
- Das Problem, dass Untertitel im "Translation Only"-Modus auf YouTube nicht angezeigt werden, wurde behoben.
- Das Problem, dass zweisprachige Untertitel auf Mubi nicht funktionierten, wurde behoben.
...
- Das Problem, dass der Schwebeball-Shortcut unter iOS 18 nicht übersetzen konnte, wurde behoben.
- Das Problem, dass benutzerdefinierte Prompts bei zu vielen nicht wirksam waren, wurde behoben.

## 1.6.1

- Unterstützt Baidu Qianfan large model platform, Alibaba Bailian large model platform, DeepSeek large model platform.
- Das Problem, dass das Ändern der Zielsprache und anderer Einstellungen im Popup-Panel beim Klicken auf den Übersetzungs-Schwebeball zurückgesetzt wurde, wurde behoben.
...
- Ein Problem wurde behoben, bei dem zweisprachige Untertitel auf der Domestika-Videoplattform in Safari nicht funktionierten.

## 1.5.6

- Die Leistung beim Übersetzen großer Webseiten, der Erstellung von ePub und Untertiteldateien wurde erheblich optimiert.
- Der Fehler der Multi-Device-Synchronisation in Pro wurde behoben.
...
- Probleme mit Wortgrenzen beim Umbruch langer Absätze wurden behoben [#86](https://github.com/immersive-translate/immersive-translate/issues/86)
- Die Erkennung von japanischen und koreanischen Sprachen wurde behoben
- Das Problem, dass Reddit-Seiten auf mobilen Geräten beim Scrollen nicht übersetzt wurden, wurde behoben
- Einige Seiten, die mit DeepL fehlende Übersetzungen hatten, wurden behoben
- Die Multi-Device-Synchronisationszeit von Pro-Nutzern wurde nicht synchronisiert
- Optimierte Abdeckungsprobleme der Cloud-Synchronisationseinstellungen
- Optimierte Prompt-Wörter für AI-Übersetzungsdienste

## 1.5.2

- Das Problem, dass Änderungen am allgemeinen Experten-Prompt den angegebenen AI-Experten-Prompt überschrieben, wurde behoben [#1692](https://github.com/immersive-translate/immersive-translate/issues/1692)
...
- Der Fehler, der von Gemini zurückgegeben wurde, wurde behoben
- Der Schwebeball wird beim Drucken der Seite ausgeblendet
- Die Schriftgröße wird nicht proportional skaliert, wenn YouTube im Vollbildmodus ist [#1681](https://github.com/immersive-translate/immersive-translate/issues/1681)
...
- Die Inkonsistenz im Layout von Übersetzungen in einigen Fällen wurde optimiert.
- Ein Zurücksetzen-Knopf für den YouTube-Untertitelstil wurde hinzugefügt, der schnell auf den Standardstil zurückgesetzt werden kann.
- Das Problem, dass chinesische Untertitel auf YouTube nicht heruntergeladen werden konnten, wurde behoben.
- Die traditionelle chinesische Benutzeroberfläche wurde optimiert.

## 1.4.12

- Das Problem des nicht übersetzten Nachrichten-Dialogfelds beim Öffnen der Reddit-Seite wurde behoben
- Eine temporäre Funktion wurde hinzugefügt, um die Übersetzungsbearbeitung im "Mehr"-Eintrag des Panels zu aktivieren
- Das Problem, dass YouTube Shorts ohne Untertitel immer Untertitel aus dem vorherigen Video anzeigen, wurde behoben [#1655](https://github.com/immersive-translate/immersive-translate/issues/1655)
- Das Problem, dass YouTube zweisprachige Untertitel im Vollbildmodus nicht nach oben und unten angepasst werden können, wurde behoben [#1654](https://github.com/immersive-translate/immersive-translate/issues/1654)
...
- Optimierte Fehlermeldungen für die Übersetzung lokaler zweisprachiger Untertitel

## 1.4.11

- Kompatibel mit der Übersetzung des Eingabefelds auf der Bing Copilot-Seite
- Die YouTube-Untertitelstilsteuerung unterstützt Randstile
- Unterstützung für die Auswahl des Standardübersetzungsdienstes auf der Seite Einstellungen -> Übersetzungsdienst
- Platzhalterersetzung für OpenAI SystemPrompt behoben
...
- Das Problem, dass häufige Änderungen der Übersetzungsfarbe über die Farbpalette nicht wirksam waren, wurde behoben [#1628](https://github.com/immersive-translate/immersive-translate/issues/1628)
...
- Das Problem, dass die Übersetzung fehlschlug, wenn OpenAI benutzerdefinierte Prompt-Wörter unter dem Testknopf gewechselt wurden, wurde behoben
- Das Problem, dass das YouTube-Untertitel-Shortcut-Symbol nicht angezeigt wurde, wurde behoben
- Die Spracherkennung der Erweiterung wurde optimiert

## 1.4.6

- Das Problem, dass benutzerdefinierte Prompt-Wörter nicht wirksam waren, wurde behoben
- Optionen für 50%, 150% für die Schriftgröße der YouTube-Untertitel hinzugefügt

## 1.4.5

- Das Problem, dass Änderungen an den YouTube-Untertitelstilen nicht gespeichert wurden, wurde behoben
- Das Verschwinden von Untertiteln im Vollbildmodus auf iOS Safari wurde behoben
- Die Übersetzungsgeschwindigkeit der YouTube-Untertitel wurde weiter optimiert
...
- Optimierte OpenAI-Multi-Prompt-Wörter, die YAML-Format unterstützen, was die Flexibilität und Benutzerfreundlichkeit der Konfiguration verbessert
- Die Übersetzungsgeschwindigkeit der YouTube-Untertitel wurde erheblich optimiert, und es wurde Unterstützung für das Umschalten zwischen chinesischer und englischer Reihenfolge, Anpassung der Schriftfarbe und -größe usw. hinzugefügt
...
- Der Gemini-Übersetzungsdienst ist standardmäßig ausgeblendet, kann in den Entwicklereinstellungen aktiviert werden, um die Beta dieses Übersetzungsdienstes anzuzeigen
...
- Der Panel-Schalter zur Anzeige nur des Übersetzungsknopfes wurde so geändert, dass er nur auf der aktuellen Seite wirksam ist
...
- Unterstützung für die Übersetzung von Webseiten und Video-Untertiteln in Sprachen wie Arabisch, Hebräisch usw., um RTL (Right-To-Left) Anzeigeprobleme zu beheben.
...
- Behoben: Während der Seitenübersetzung wurde das Problem behoben, dass das Bewegen der Maus nicht zur erneuten Übersetzung führte.
...
- **Mobile Unterstützung für die Übersetzung spezifischer Absätze:** Die mobile Version unterstützt jetzt die Übersetzung angegebener Absätze und hat eine Vielzahl von Verknüpfungsoperationen hinzugefügt, darunter Wischen nach links, Wischen nach rechts, Doppeltippen, Dreifachtippen und Multi-Finger-Touch-Gesten. Diese sind standardmäßig nicht aktiviert und erfordern, dass der Benutzer aktiv die auslösende Geste auf der Einstellungsseite unter [Maus-Hover] auswählt.
...
- **Neuer Benutzerleitfaden**: Wenn neue Benutzer zum ersten Mal eine Seite in einer Nicht-Zielsprache öffnen, wird eine schwebende Ball-Hilfe-Bubble angezeigt.

### Optimierung und Fehlerbehebungen

- **UI-Optimierung**: Die UI für Seitenübersetzungsfehlerhinweise wurde neu gestaltet, um sie verständlicher zu machen. Wenn viele Fehler auftreten, wird ein Popup den Benutzer aktiv darauf hinweisen.
...
- Optimierung: Verbesserung des Prozesses der Zusammenführung manueller Untertitel.
...
- Behebung des ruckelnden Klickproblems des Firefox-Seiten-Hoverball-Aktionspanels.
...
- Behebung des Problems, dass das Klicken auf den Hoverball bei Online-PDFs nicht reagiert
...
- Behebung von ruckelnden Seiten-Hoverball-Klicks
...
- Hinzufügen der [Funktion zum dauerhaften Deaktivieren von Video-Untertiteln], wenn es andere Konfliktprobleme gibt und Sie die zweisprachige Untertitelfunktion mit Immersive Translate nicht aktivieren möchten.
...
- PDF-Übersetzung mit neuen Optionen zur schnellen Steuerung des Übersetzungsstils (PDF-Dateien sind sehr seltsam und das Aktivieren dieser Optionen kann für einige PDF-Dateien mit chaotischem Format nützlich sein)
...
- Unterstützung der Suchverbesserung, wenn aktiviert, wenn Sie in Google/Google News auf Chinesisch suchen, wird die rechte Spalte automatisch die Suchergebnisse der entsprechenden englischen Schlüsselwörter anzeigen, die standardmäßig aktiviert sind.
...
- Eine großartige Ersteinrichtungsseite für neue iOS-Nutzer.
...
- Die Funktion "Nur Übersetzungen anzeigen" ist da! Klicken Sie auf [Mehr] -> [Wechseln zu nur Übersetzungen anzeigen].
  ...
  - Unterstützung für benutzerdefinierte Tastenkombinationen, die in den Schnittstelleneinstellungen -> Tastenkombinationen festgelegt werden
...
- Funktion: Übersetzen des aktuellen Absatzes beim Überfahren mit der Maus.
...
- Funktion: Dritten erlauben, Dokumentereignisse zu senden, um `toggleTranslatePage` aufzurufen
...
- Behebung: eBook-Builder-Fortschritt bei 99% gestoppt.
...
- Behebung
  ...
  Problem mit der Dateipfadübereinstimmung
...
- Behebung von Tencent-Fehlern bei der Trennung
...
- Behebung der Userscript-Icon-Größe
...
- Unterstützung des sofortigen Übersetzungsmodus, damit die Webseite so schnell wie möglich übersetzt wird.
- Unterstützung der Festlegung des Seitenbereichs, der übersetzt werden muss, damit mehr Bereiche übersetzt werden können.
...
- Behebung der klickbaren Version

## 0.0.25

- Unterstützung von selectorMatches, sodass wir jetzt alle Mastodon-Instanzen abgleichen können
