...
- Hinzugefügt: 11 neue Schnittstellensprachen für das Plugin und die offizielle Website, jetzt erreichen die unterstützten Schnittstellensprachen 14, darunter Chinesisch vereinfacht, Chinesisch traditionell, Englisch, Japanisch, Koreanisch, Russisch, Spanisch, Portugiesisch, Hindi, Italienisch, Deutsch, Französisch, Arabisch und Persisch.
- Ändern der zweisprachigen Freigabe (Aktualisierungsmodus), die in der letzten Version hinzugefügt wurde, in zweisprachige Seiten-Snapshot-Freigabe, sodass der geteilte Inhalt originaler ist und eine breitere Anpassungsfähigkeit hat.
...
- Behebung: Youtube kehrt gelegentlich zur Startseite zurück
...
- Das PDF-Übersetzungstool wird auf die Online-Version migriert: https://app.immersivetranslate.com/pdf/ , sodass Grease Monkey und Safari PDF-Übersetzung verwenden können und Probleme besser iteriert werden können, ohne eine Version herausgeben zu müssen, um das Problem zu lösen.
...
- Behebt das Problem, dass: temporäre Einstellung der Übersetzungsdauer der Website nicht wirksam wird.
...
- Feat: Neue Kundeneinführungsseite hinzufügen
...
- Feat: OpenAI unterstützt benutzerdefiniertes apiUrl für Entwicklereinstellungen.
...
- Fix: OpenAI maximale Token-Limit, ändern Sie maximale Zeichen von 1500 auf 1300.
