...
- Optimiert: Optimierung der Formatierung von gemischtem Chinesisch und Englisch.
...
- Behoben: Problem, bei dem die **Mouse Hover Translation** keinen Rich-Text übersetzen konnte.
- Verbessert: Die Tampermonkey-Version unterstützt jetzt die YouTube-Untertitelübersetzung.
...
- Behoben: Das Problem, bei dem die **Mouse Hover Translation** auf einigen Websites nicht funktioniert.
...
- Behoben: Das Problem, dass Dezimalzahlen beim Übersetzen langer Texte zwangsweise umbrochen werden.
...
- ~~Verbessert: Die Option zur Anpassung der "**Enable Sidebar & Navbar Translation**" in "**Advanced Settings**" wurde hinzugefügt.~~
...
- Hinzugefügt: Modus zur erzwungenen Aktivierung der Mausunterstützung (Aktivieren Sie diese Funktion nur, wenn die Maus-Hover-Funktion auf Tablet-Geräten nicht verfügbar ist) **Einstellungen** -> **Erweiterte Einstellungen** -> **Erzwungene Aktivierung der Mausunterstützung**
...
- Standardmäßig wird bei der Übersetzung von Vereinfachtem Chinesisch ins Traditionelle Chinesisch und umgekehrt der Übersetzung-Only-Modus verwendet, anstatt des zweisprachigen Vergleichsmodus.
- Einige Fehler behoben.
...
- Behoben: Problem, bei dem die [Erweiterten Einstellungen -> Mindestanzahl von Zeichen, die für die Übersetzung eines Absatzes erforderlich sind] in einigen Fällen nicht wirksam wurde
...
- Nach der Auswahl des Textes ändert sich das Rechtsklickmenü zu [Text übersetzen], klicken Sie darauf, um automatisch zur Immersive Translation Textübersetzungsseite zu springen
...
- Das Problem behoben, bei dem Untertitel im "Translation Only"-Modus auf YouTube nicht angezeigt werden.
- Das Problem mit nicht funktionierenden zweisprachigen Untertiteln auf Mubi behoben.
...
- Neue Funktion: Manga-Übersetzung (Beta), auf unterstützten Manga-Websites erscheint ein Manga-Übersetzungsknopf unter dem schwebenden Schnellübersetzungsball der Webseite. Durch Klicken darauf wird die Manga-Übersetzung aktiviert. Diese Funktion ist für Pro-Mitglieder verfügbar (500 Seiten pro Monat, zusätzliche Pakete können erworben werden), derzeit werden die folgenden Seiten unterstützt:
...
- Neue Funktion: KI-Übersetzung unterstützt [Doubao large model](https://www.volcengine.com/product/doubao)
...
- Benutzerdefinierte KI-Modellliste unterstützt `-all` Syntax, die alle voreingestellten Modelle löschen kann.
...
- Das Problem behoben, bei dem die schwebende Ballverknüpfung unter iOS 18 nicht übersetzen konnte.
- Das Problem behoben, bei dem benutzerdefinierte Prompts unwirksam waren, wenn zu viele verwendet wurden.

## 1.6.1

- Unterstützt Baidu Qianfan große Modellplattform, Alibaba Bailian große Modellplattform, DeepSeek große Modellplattform.
- Das Problem behoben, bei dem das Ändern der Zielsprache und anderer Einstellungen im Popup-Panel beim Klicken auf den Übersetzungsball zurückgesetzt wurde.

## 1.5.8

- KI-Experten unterstützen den "Intelligent Selection"-Modus, bei dem das System automatisch den am besten geeigneten KI-Experten basierend auf der aktuellen Website auswählt (zum Beispiel werden technologiebezogene KI-Experten automatisch für The Verge und Hacker News ausgewählt, während die Twitter-Übersetzungsverbesserung automatisch für Twitter ausgewählt wird).

## 1.5.7

- Unterstützung für das Hinzufügen benutzerdefinierter KI-Übersetzungsdienste, die mit OpenAI kompatibel sind, zugänglich am unteren Rand der Seite [Einstellungen]->[Übersetzungsdienste].
- Ein Problem behoben, bei dem zweisprachige Untertitel auf der Domestika-Videoplattform in Safari nicht funktionierten.

## 1.5.6

- Die Leistung beim Übersetzen großer Webseiten, der Erstellung von ePub und Untertiteldateien erheblich optimiert.
- Den Fehler der Multi-Geräte-Synchronisation in Pro behoben.
...
- Probleme mit Wortgrenzen beim Umbruch langer Absätze behoben [#86](https://github.com/immersive-translate/immersive-translate/issues/86)
- Erkennung von japanischen und koreanischen Sprachen behoben
- Problem behoben, bei dem Reddit-Seiten auf mobilen Geräten beim Scrollen nicht übersetzt wurden
- Einige Seiten, die mit DeepL fehlende Übersetzungen hatten, behoben
- Pro-Benutzer Multi-Geräte-Synchronisationszeit nicht synchronisiert behoben
- Optimierte Abdeckungsprobleme der Cloud-Synchronisationseinstellungen
- Optimierte Prompt-Wörter für KI-Übersetzungsdienste

## 1.5.2

- Das Problem behoben, bei dem Änderungen am allgemeinen Experten-Prompt den angegebenen KI-Experten-Prompt überschrieben [#1692](https://github.com/immersive-translate/immersive-translate/issues/1692)
- KI-Benutzerdefinierter Modellname unterstützt erweiterte Syntax, verwenden Sie +, um ein Modell hinzuzufügen, verwenden Sie -, um ein Modell auszublenden, und verwenden Sie model_name=display_name, um den Anzeigenamen des Modells anzupassen, z.B.: +gpt-3.5-turbo,-gpt-4,gpt-4-turbo=gpt-4-super
- Den von Gemini zurückgegebenen Fehler behoben
- Den schwebenden Ball beim Drucken der Seite ausblenden
- Die Schriftgröße nicht proportional skaliert, wenn YouTube im Vollbildmodus ist, behoben [#1681](https://github.com/immersive-translate/immersive-translate/issues/1681)

## 1.5.1

- Unterstützung für KI-Übersetzungsdienste, um [AI Expert] festzulegen, um die Übersetzungsstrategie zu spezifizieren, derzeit eine Beta-Funktion, die in [Entwicklereinstellungen](https://dash.immersivetranslate.com/#developer) nach Aktivierung von Beta aktiviert werden kann, und das [AI Expert] Menü kann nach dem Aktualisieren gesehen werden.
- KI-Übersetzungsdienste können jetzt die Modellauswahl anpassen, wie z.B. [OpenAI], das System hat nur einige der am häufigsten verwendeten Modelle eingebaut. Beim Klicken auf die Modellauswahlliste ist der letzte Punkt, den Sie sehen, [Set More Models], nach dem Einstellen wird es automatisch gespeichert, um den Benutzern das Testen verschiedener benutzerdefinierter Modelle zu erleichtern.
- Die Inkonsistenz im Layout von Übersetzungen in einigen Fällen optimiert.
- Eine Zurücksetzen-Schaltfläche für den YouTube-Untertitelstil hinzugefügt, die schnell auf den Standardstil zurückgesetzt werden kann.
- Das Problem behoben, bei dem chinesische Untertitel auf YouTube nicht heruntergeladen werden konnten.
- Die traditionelle chinesische Benutzeroberfläche optimiert.

## 1.4.12

- Das Problem des nicht übersetzten Nachrichten-Dialogfelds beim Öffnen der Reddit-Seite behoben
- Eine temporäre Funktion hinzugefügt, um die Übersetzungsbearbeitung im "Mehr"-Eintrag des Panels zu aktivieren
- Das Problem behoben, bei dem YouTube Shorts ohne Untertitel immer Untertitel aus dem vorherigen Video anzeigen [#1655](https://github.com/immersive-translate/immersive-translate/issues/1655)
- Das Problem behoben, bei dem YouTube zweisprachige Untertitel im Vollbildmodus nicht nach oben und unten angepasst werden können [#1654](https://github.com/immersive-translate/immersive-translate/issues/1654)
...
- Optimierte Fehlermeldungen für das Übersetzen lokaler zweisprachiger Untertitel
...
- OpenAI SystemPrompt Platzhalterersetzung behoben
- Problem mit der Zusammenführung benutzerdefinierter Benutzerrichtlinien behoben
- Abnormale Untertiteldarstellung für einige Netflix-Videos behoben [#1630](https://github.com/immersive-translate/immersive-translate/issues/1630)
- Das Problem behoben, bei dem häufige Änderungen der Übersetzungsfarbe über die Farbpalette unwirksam waren [#1628](https://github.com/immersive-translate/immersive-translate/issues/1628)
...
- Mobile fügt Gestensteuerung hinzu, verbessert die Eingabe über [Verknüpfungseinstellungen](https://dash.immersivetranslate.com/#shortcuts)
- Unterstützung für zweisprachige Übersetzung in Google Docs

## 1.4.7

- Das Problem behoben, bei dem die Übersetzung fehlschlug, wenn OpenAI benutzerdefinierte Prompt-Wörter unter der Testschaltfläche gewechselt wurden
- Das Problem behoben, bei dem das YouTube-Untertitel-Verknüpfungssymbol nicht angezeigt wurde
- Die Spracherkennung der Erweiterung optimiert

## 1.4.6

- Das Problem behoben, bei dem benutzerdefinierte Prompt-Wörter unwirksam waren
- Optionen für 50%, 150% für die Schriftgröße der YouTube-Untertitel hinzugefügt

## 1.4.5

- Das Problem behoben, bei dem Änderungen an den YouTube-Untertitelstilen nicht gespeichert wurden
- Das Verschwinden von Untertiteln im Vollbildmodus auf iOS Safari behoben
- Die Übersetzungsgeschwindigkeit von YouTube-Untertiteln weiter optimiert
...
- Optimierte OpenAI Multi-Prompt-Wörter, unterstützt YAML-Format, was die Flexibilität und Benutzerfreundlichkeit der Konfiguration verbessert
- Die Übersetzungsgeschwindigkeit von YouTube-Untertiteln erheblich optimiert und Unterstützung für das Umschalten zwischen chinesischer und englischer Reihenfolge, Anpassung der Schriftfarbe und -größe usw. hinzugefügt
...
- Panel-Schalter zur Anzeige nur des Übersetzungsknopfs geändert, um nur auf der aktuellen Seite wirksam zu sein

## 1.3.3

- Optimierte das Anzeigeproblem der Twitter-CC-Videountertitel.
- Der DeepL-Dienst hat Unterstützung für Arabisch hinzugefügt.
- Der Colorful Clouds Übersetzungsdienst unterstützt jetzt Koreanisch, Spanisch, Französisch und Russisch.
...
- **Deepl Sprachunterstützung**: Hinzugefügt: Unterstützung für Portugiesisch (Brasilien).
...
- **openAI Konfigurations-Update**: Unterstützt jetzt die Einstellung der Anzahl der Konfigurationen pro Sekunde in Dezimalzahlen, wie z.B. 0,5, was 1 Anfrage alle 2 Sekunden bedeutet.
...
- Behebung, dass die Original-Video-Untertitel nicht angezeigt werden, wenn "Aktuelle Seite nie übersetzen" eingestellt ist.
- Behebung des Konflikts mit einigen Plug-ins, die zu unendlichem Seiten-Reload führten.
- Behebung der Nicht-Übersetzung einiger Absätze nach Aktivierung von Zeilenumbrüchen bei langen Absätzen.
- Behebung [Wenn die Webseitentranslation vorübergehend für eine lange Zeit aktiviert ist, wird durch Klicken auf das Panel [Immer diese Website übersetzen] die immerwährende Übersetzung nicht aufgehoben #1172](https://github.com/immersive-translate/immersive-translate/issues/1172)
...
- [Vorübergehendes Aktivieren der Webseitentranslation für eine bestimmte Zeit hebt die immerwährende Übersetzung nicht auf #1172](https://github.com/immersive-translate/immersive-translate/issues/1172)
...
- Änderung des zweisprachigen Teilens (Aktualisierungsmodus), das in der letzten Version hinzugefügt wurde, zu zweisprachigem Seitensnapshot-Teilen, sodass der geteilte Inhalt originaler ist und eine breitere Anpassungsfähigkeit hat.
...
- Lösung des Problems, dass einige Plattformen nicht erkennen konnten, ob die Maus unterstützt wird oder nicht
  - Es gibt einige Desktop-Browser, die sowohl Touchscreen als auch Maus unterstützen, und Immersive Translates kann technisch nicht erkennen, ob solche Plattformen die Maus unterstützen, daher haben wir die Option [Mausunterstützung erzwingen] in den [Mouse Hover] Einstellungen hinzugefügt
...
- Unterstützung für die Einrichtung von Hoverball-Schnellübersetzungsschaltflächen (sowohl PC- als auch Mobilunterstützung)
...
- Die Funktion "Nur Übersetzungen anzeigen" ist da! Klicken Sie auf [Mehr] -> [Umschalten, um nur Übersetzungen anzuzeigen].
  ...
  - Unterstützung benutzerdefinierter Tastenkombinationen, die in den Schnittstelleneinstellungen -> Tastenkombinationen festgelegt werden
...
- Feature: Erlauben, dass Drittanbieter-Dokumentereignisse senden, um `toggleTranslatePage` aufzurufen
...
- Feature: Wir können jetzt das Hintergrundfarbthema der Marker-Übersetzung anpassen.
...
- Fix: Firefox Mobile Überprüfungsübersetzungsdienst-Netzproblem.
...
- Fix dynamisches iframe CSS-Injektion
...
- Hervorhebung Übersetzungsthema hinzufügen
...
- Unterstützung für Drei-Finger auf Touch-Geräten, um Seitenübersetzung umzuschalten
...
- Behebung der Berechtigung für die Verbindung von volc alpha Userscript
