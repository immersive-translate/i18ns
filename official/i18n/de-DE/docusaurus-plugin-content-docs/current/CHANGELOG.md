...
- Behoben: Ein Problem behoben, bei dem das Kapsel-Dropdown der Eingabefeld-Übersetzung in WhatsApp unten überlaufen konnte.
- Hinzugefügt: Benutzerdefinierte API-Dienste vervollständigen jetzt automatisch OpenAI- / Anthropic-Endpunktpfade anhand der Base URL.
- Verbessert: Einstieg zur Dokumentübersetzung im Popup verbessert, für bessere Sichtbarkeit und Nutzbarkeit.
...
- Behoben: Ein Problem behoben, bei dem benutzerdefinierte KI-Experten von Mitgliedern während der Synchronisierung überschrieben werden konnten.
- Hinzugefügt: Unterstützung für die Übersetzung der Comic-Website toptoon.com hinzugefügt.
...
- Hinzugefügt: Unterstützung für den Übersetzungsdienst plamo.
- Verbessert: Layout-Markierungen für RTL-Sprachen im Nur-Übersetzung-Modus verbessert.
...
- Behoben: Ein Problem mit zitternden Untertiteln bei der Teams-Untertitelübersetzung behoben.
- Behoben: Ein Problem behoben, durch das [Textauswahl-Übersetzung] in ShadowRoot-Szenarien Text nicht korrekt erfassen konnte.
