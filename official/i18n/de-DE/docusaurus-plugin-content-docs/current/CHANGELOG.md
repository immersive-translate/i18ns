...
- Behoben: Problem, bei dem Inhalte verschwinden, nachdem man auf "mehr sehen" im Nur-Übersetzungsmodus von Facebook klickt.
...
- Unterstützte Seiten für Manga-Übersetzung
...
- Behoben: Manga-Übersetzungsfehler im Firefox-Browser.

## 1.7.1

- Verbesserte Übersetzungsgeschwindigkeit für Manga-Übersetzungen
- Unterstützung für neue Seiten in Manga-Übersetzungen hinzugefügt:
...
- Unterstützung für neue Seiten für Manga-Übersetzung hinzugefügt:
...
- Behebung von Textlayoutproblemen bei Manga-Übersetzungen für Sprachen im lateinischen Schriftsystem.
- Neue unterstützte Seiten für Manga-Übersetzung:
...
- Behoben: [Wenn die Webseitentranslation vorübergehend für eine lange Zeit eingeschaltet wird, wird durch Klicken auf das Panel [Immer diese Website übersetzen] die immerwährende Übersetzung nicht aufgehoben #1172](https://github.com/immersive-translate/immersive-translate/issues/1172)
...
- [Vorübergehendes Einschalten der Webseitentranslation für eine bestimmte Zeit hebt die immerwährende Übersetzung nicht auf #1172](https://github.com/immersive-translate/immersive-translate/issues/1172)
...
- Änderung der zweisprachigen Freigabe (Aktualisierungsmodus), die in der letzten Version hinzugefügt wurde, zur zweisprachigen Seiten-Snapshot-Freigabe, sodass der geteilte Inhalt originaler ist und eine breitere Anpassungsfähigkeit aufweist.
...
- Das Problem, dass einige Plattformen nicht erkennen konnten, ob die Maus unterstützt wird, wurde gelöst
  - Es gibt einige Desktop-Browser, die sowohl Touchscreen als auch Maus unterstützen, und Immersive Translate kann technisch nicht erkennen, ob solche Plattformen die Maus unterstützen, daher haben wir die Option [Mausunterstützung erzwingen] in den [Maus-Hover]-Einstellungen hinzugefügt
...
- Hinzugefügt: [Funktion zum dauerhaften Deaktivieren von Video-Untertiteln], falls es andere Konfliktprobleme gibt und Sie die zweisprachige Untertitelfunktion mit Immersive Translate nicht aktivieren möchten.
...
- Unterstützung für Untertitelübersetzung nur für den Export von Übersetzungen
...
- Fix: postMessage beim Initialisieren der Seite hat einige Seiten unterbrochen, jetzt machen wir dies nur, wenn wir wirklich Seiten übersetzen
- Fix: eBook-Fortschrittsproblem.
- Fix: Besser für das Aufteilen langer Absätze, 1,5 Milliarden, 25,5%, Herr wird nicht als Grenze betrachtet
...
- Fix: OpenAI maximale Token-Grenze, maximale Zeichen von 1500 auf 1300 ändern.
