...
- Hinzugefügt: Dynamische Vorübersetzung von Inhalten beim Durchsuchen von Seiten.
...
- Behoben: Übersetzungsproblem bei Untertiteln in Google Meet und Microsoft Teams.
...
- Verbessert: Verbesserung der Spracherkennungsfähigkeiten für Greasemonkey und Safari auf Seiten mit weniger verbreiteten Sprachen.
- Verbessert: Online-Einstellungsseite Testdienstschnittstellenzugriff.
- Verbessert: Verbesserung der Benutzererfahrung der Kontextvergleichsvorschau-Funktion.
...
- Hinzugefügt: Modus "Forece Enable Mouse Support" (Aktivieren Sie diese Funktion nur, wenn die Mouse-Hover-Funktion auf Tablet-Geräten nicht verfügbar ist) **Einstellungen** -> **Erweiterte Einstellungen** -> **Forece Enable Mouse Support**
- Hinzugefügt: Anzeige einer Fehlermeldung, wenn die Video-Untertitelübersetzung fehlschlägt
- Behoben: Problem bei der Übersetzung von Rich Text [#2163](https://github.com/immersive-translate/immersive-translate/issues/2163)
...
- Behoben: Kompatibilitätsproblem beim Login mit Safari-Plugin auf macOS 15
...
- Behoben: Problem mit der Synchronisation benutzerdefinierter AI-Experten
...
- Epub-Dateien unterstützen jetzt Rich Text Übersetzung (d.h. das Format des Originaltextes jedes Absatzes, wie Links, Fett, etc., wird beibehalten)
...
- Wenn AI-Experten für die "Intelligente Auswahl" verwendet werden, können verschiedene AI-Experten für verschiedene Websites angepasst werden. Dies kann in [Einstellungen] -> [AI-Experten] -> [Beliebigen Experten eingeben] eingestellt werden.
- Behoben: Problem, bei dem Untertitel in YouTube im "Übersetzung-Only"-Modus nicht angezeigt werden.
...
- Der bunte Wolken-Übersetzungsdienst unterstützt jetzt Koreanisch, Spanisch, Französisch und Russisch.
...
- Kürzliche Anfragen an den Microsoft-Übersetzungsdienst aus China waren instabil; bei Fehlern erkennt das System automatisch den aktuell verfügbaren Übersetzungsdienst, sodass Benutzer schnell wechseln können.
...
- Unterstützung für die Übersetzung von Untertiteln für YouTube Live und die [Mubi](https://mubi.com/) Plattform.
...
- **Mobile Unterstützung für die Übersetzung spezifischer Absätze:** Die mobile Version unterstützt jetzt die Übersetzung angegebener Absätze und hat eine Vielzahl von Schnellzugriffsoperationen hinzugefügt, darunter Wischen nach links, Wischen nach rechts, Doppeltippen, Dreifachtippen und Multi-Finger-Touch-Gesten. Diese sind standardmäßig nicht aktiviert und erfordern, dass der Benutzer aktiv die auslösende Geste auf der Einstellungsseite unter [Maus-Hover] auswählt.
...
- **Tastenkombinationseinstellungen**: Hinzufügen eines neuen Top-Level-Menüs "Verknüpfungen" und der folgenden anpassbaren Tastenkombinationsfunktionen:
...
- **Fehlerbehebungen**:
  ...
  - Behebung des Problems, bei dem die Übersetzung bei Maus-Hover fehlschlug, wenn die Seite den Fokus verlor.
  - Behebung des Problems, bei dem weniger als 3 Zeichen im Eingabefeld-Enhancement-Feature nicht übersetzt wurden.
  - Behebung des Problems, bei dem einige Verzeichnisse bei der Erstellung von zweisprachigen Epubs nicht übersetzt wurden.

- **Feature-Entfernung**: Entfernung des zweisprachigen Informations-Enhancement-Features (gleichzeitige Anzeige von englischen Suchergebnissen auf Google-Suchseiten).
...
- Behoben: [Wenn die Webseitentranslation vorübergehend für eine lange Zeit eingeschaltet wird, wird durch Klicken auf das Panel [Immer diese Website übersetzen] die immer Übersetzung nicht aufgehoben #1172](https://github.com/immersive-translate/immersive-translate/issues/1172)
...
- [Vorübergehendes Einschalten der Webseitentranslation für eine bestimmte Zeit hebt die immer Übersetzung nicht auf #1172](https://github.com/immersive-translate/immersive-translate/issues/1172)
...
- Verkürzung der Länge der OpenAI-Prompts von 90 auf 40, was noch mehr Traffic spart.
...
- Behebung des automatischen Scrollens beim Online-Lesen von Epub auf Mobilgeräten
...
- Web-Kern-Parsing-Refactoring, was bedeutet:
  ...
  - Ultra-niedriger Speicherverbrauch für komplexe Webseiten
...
- Feat: Erlauben Sie die Passwort-Eingabeformular, das Passwort anzuzeigen.
...
- Feat: Add new theme Solid Border (neues Thema hinzugefügt, durchgehender Rahmen)
...
- Feat: Support custom main frame cause some site is not using body as the main frame
...
- Fix: high memory use for userscripts and extension (by removing opencc zh-CN to zh-TW, instead with Google translate)
...
- Performance: serial to concurrency requests
...
- Fix: some math element stay original

## 0.2.59

- Fix: Unknown tags Block Element
- Fix: translate=no element override
...
- Support custom url from built-in Config
...
- Support enable beta feature at developer panel
...
- Support inline iframe translation. (Only for extension, not available for
  userscript)
...
- Support iframe translate, like QQ mail, embedded tweet.
...
- Fix mark highlight line height
...
- Add highlight translation theme
...
- Support Userscript Popup Dragging
- Support Three Fingers on Touch device to trigger toggle translate pages
