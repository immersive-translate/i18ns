...
- Hinzugefügt: OpenRouter-Übersetzungsdienste
- Behoben: Problem, bei dem einige Absätze bei der Webseitenübersetzung nicht übersetzt wurden
- Behoben: Problem mit der Zusammenführung von Netflix-Untertiteln
- Kompatibel: Mac "360 Extreme Browser Pro" YouTube-Untertitelanzeigeproblem
...
- Optimiert: Optimierte Formatierung von gemischtem Chinesisch und Englisch.
...
- Behoben: Problem mit der Formelumsetzung, verursacht durch die "Twitter Translation Improvement" in Version 1.11.2.
...
- Behoben: Probleme mit der Rückgängig-Funktion Ctrl+Z im **Enhanced input** auf bestimmten Websites.
...
- Hinzugefügt: Forece Enable Mouse Support Modus (Aktivieren Sie diese Funktion nur, wenn die Maus-Hover-Funktion auf Tablet-Geräten nicht verfügbar ist) **Settings** -> **Advanced Settings** -> **Forece Enable Mouse Support**
...
- DeepL Übersetzungsdienst unterstützt jetzt offiziell Traditionelles Chinesisch als Zielsprache (zuvor erforderte das Übersetzen ins Traditionelle Chinesisch mit DeepL einen zusätzlichen Drittanbieterprozess zur Umwandlung von Vereinfachtem in Traditionelles Chinesisch).
...
- Mehr arXiv-Papiere mit optimiertem zweisprachigen Übersetzungslayout bereitgestellt
...
- Übernahme eines AI-intelligenten Satztrennungsalgorithmus für automatisch generierte englische Untertitel auf YouTube [Pro Verfügbar]
...
- Unterstützung für AI-Übersetzungsdienste, um [AI-Experten] festzulegen, um die Übersetzungsstrategie zu spezifizieren, derzeit eine Beta-Funktion, die in [Entwicklereinstellungen](https://dash.immersivetranslate.com/#developer) nach Aktivierung von Beta aktiviert werden kann, und das [AI-Experten] Menü kann nach dem Aktualisieren gesehen werden.
...
- Unterstützung für Video-Untertitel mit Einstellung für zweisprachige/Original- und Übersetzungsanzeige
...
- Optimierung des Anzeigeproblems von Twitter CC-Video-Untertiteln.
...
- Behebung des Problems, dass das Kontrollpanel auf mobilen Geräten nicht geschlossen werden konnte.
...
- **Popup-Panel-UI-Upgrade:** Das neue Design zielt darauf ab, die Benutzerfreundlichkeit und Verständlichkeit zu verbessern. Dieses Update umfasst:
  ...
  - **Neue Funktionen im Hauptmenü:**
    - **Zweisprachiger/Übersetzungs-nur-Modus-Schalter:** Sie können jetzt direkt im Hauptmenü zwischen "Zweisprachiger Übersetzungsmodus" und "Nur-Übersetzungsmodus" wechseln, links neben dem Übersetzungsbutton.
    - **Dokumentenübersetzungseintrag:** Der Eintrag für die Übersetzung von "PDF/ePub/Untertitel-Dateien" wurde ins Hauptmenü für den schnellen Zugriff verschoben.
...
- Behebung des Problems, dass der Shortcut für zweisprachige Untertitel auf YouTube zu lange englische Texte hatte.

## 1.1.0

### Neue Funktionen

- **Shortcut-Tasteneinstellungen**: Hinzufügen eines neuen Top-Level-Menüs "Shortcuts" und der folgenden anpassbaren Shortcut-Tastenfunktionen:
...
- **Neuer Benutzerleitfaden**: Wenn neue Benutzer eine Seite in einer nicht-zielsprachigen Sprache öffnen, wird eine schwebende Hilfe-Blase angezeigt.

### Optimierung und Fehlerbehebungen

- **UI-Optimierung**: Das UI für Übersetzungsfehlerhinweise wurde neu gestaltet, um es verständlicher zu machen. Bei vielen Fehlern wird ein Popup den Benutzer aktiv darauf hinweisen.
...
- **Feature-Entfernung**: Die zweisprachige Informationsverbesserungsfunktion (gleichzeitige Anzeige von englischen Suchergebnissen auf Google-Suchseiten) wurde entfernt.
...
- Unterstützung für die Echtzeit-Untertitelübersetzung für Twitter Space.
...
- Reparatur der Original-Video-Untertitel, die nicht angezeigt werden, wenn "Aktuelle Seite nie übersetzen" eingestellt ist.
- Reparatur des Konflikts mit einigen Plugins, die ein unendliches Zurückkehren der Seite verursachen.
...
- Zweisprachige Untertitel wurden hinzugefügt, um [TED](https://www.ted.com), [Frontend Masters](https://frontendmasters.com/), [edx](https://www.edx.org/), [CodeWithChris](https://www.edx.org/), [Skillshare](https://www.ted.com) Plattformen zu unterstützen. https://learn.codewithchris.com/enrollments), [Skillshare](https://www.skillshare.com/) Plattformen
...
- Die Suchverbesserung (einige Seiten von Google Search zeigen zweisprachige Suchergebnisse an) ist jetzt standardmäßig nicht aktiviert und wird in der nächsten Version entfernt.
...
- Behebung für [dauerhaftes Deaktivieren von Video-Untertiteln] Funktion, die nicht funktioniert [#1175](https://github.com/immersive-translate/immersive-translate/issues/1175)
...
- Das Problem wurde gelöst, dass einige Plattformen nicht erkennen konnten, ob die Maus unterstützt wird oder nicht
...
- Behebt: Gmail Translate All Regions Problem
...
- Behebt das Problem, dass die Eingabefeldverbesserung nicht aktiviert ist, wenn die Website auf "nie übersetzen" eingestellt ist.
...
- Intelligenter, um festzustellen, ob es sich um einen Navigationsbereich handelt, und wenn ja, wird keine Übersetzung durchgeführt
...
- Eingabefeldverbesserung zeigt den Ladezustand in der Übersetzung an
- Aktualisierung der Standardladefarben in Übersetzungen
- Wenn das Eingabefeld ohne Präfix konfiguriert ist, unterstützt es die Übersetzung `ja Hello` ins Japanische und `English Hello` ins Englische.
...
- Behebung des Problems, dass die temporäre Einstellung der Website-Übersetzungsdauer nicht wirksam wird.
...
- Optimierung des OpenAI-Anfragefrequenzbegrenzungsproblems
...
- Behebung: Maus-über-Bereich-Problem.
...
- Funktion: Neue Kundenleitfaden-Seite hinzufügen
...
- Fix: Markieren Sie die Zeilenhöhe hervor
...
- Unterstützung für Zeilenumbrüche für X Zeichen.
...
- Behebt, dass das Ändern des Popup-Übersetzungsdienstes nicht funktioniert
...
- Behebt Google-Suche, erzwingt Aktualisierung
...
- Behebt doppelte Übersetzungen beim Ändern der Übersetzung
- Besseres Popup-UI
...
- Behebt mehrfache Übersetzungen beim Wechseln des Dienstes
