...
- Verbessert: Verbesserung der Darstellung von übersetzten Formeln
...
- Behebung des Ausrichtungsproblems, bei dem die Option "Mehr" nicht linksbündig auf Windows war.
...
- **Verknüpfungseinstellungen**: Hinzufügen eines neuen Top-Level-Menüs "Verknüpfungen" und der folgenden anpassbaren Verknüpfungsfunktionen:
  ...
  - Hinzufügen dedizierter Verknüpfungstasten für 6 Übersetzungsdienste (wie DeepL, OpenAI, Google, Microsoft, Gemini, Tencent Interactive Translation), um den temporären Wechsel zwischen Übersetzungsdiensten zu erleichtern.
...
- **Funktionsentfernung**: Entfernung der zweisprachigen Informationsverbesserungsfunktion (gleichzeitige Anzeige von englischen Suchergebnissen auf Google-Suchseiten).
...
- Behoben: Das Problem, dass die Maus in einigen Fällen ohne Drücken der Tastenkombination weiter übersetzte.
...
- Ändern der zweisprachigen Freigabe (Aktualisierungsmodus), die in der letzten Version hinzugefügt wurde, in zweisprachige Seiten-Snapshot-Freigabe, sodass der geteilte Inhalt originaler ist und eine breitere Anpassungsfähigkeit aufweist.
...
- Maximaltextlängenoption für jede Anfrage mit OpenAI hinzufügen
...
- Fix: Open AI für Leerzeichen im Absatz
...
- Fix: Firefox Mobile Überprüfung des Übersetzungsdienst-Netzwerkproblems.
...
- Umschreiben von Nachrichten mit Hintergrund, verwende connect anstelle von sendMessage
