...
- Hinzugefügt: Textauswahl-Übersetzungsfunktion
...
- Hinzugefügt: Unterstützung für Youdao Ziyue Großmodellübersetzung.
...
- Behoben: Problem mit der Google-Übersetzung von Escape-Zeichen.
...
- Aufgrund von Einschränkungen der YouTube-Website unterstützt das Chrome Tampermonkey-Skript keine YouTube zweisprachigen Untertitel mehr. Bitte verwenden Sie die [Plugin-Version](https://immersivetranslate.com/).
...
- Unterstützung für die Anpassung von AI-Experten, der Eingang befindet sich unten auf der Seite [Settings]->[AI Expert].
...
- Behebung der Tastenkombination für die sofortige Übersetzung am unteren Rand der Seite
...
- Unterstützung für die Einstellung der Übersetzungs-Schriftart im Übersetzungsmodus.
...
- **Mobile Unterstützung für die Übersetzung bestimmter Absätze:** Die mobile Version unterstützt jetzt die Übersetzung bestimmter Absätze und hat eine Vielzahl von Tastenkombinationen hinzugefügt, darunter Wischen nach links, Wischen nach rechts, Doppeltippen, Dreifachtippen und Mehrfinger-Touch-Gesten. Diese sind standardmäßig nicht aktiviert und erfordern, dass der Benutzer aktiv die auslösende Geste auf der Einstellungsseite unter [Maus-Hover] auswählt.
...
- Hinzufügen eines Übersetzungs-nur-Modus auf der Einstellungsseite.
...
- Behoben: Das Problem, bei dem nur ein Teil des Inhalts auf Hacknews verschwand [#1264](https://github.com/immersive-translate/immersive-translate/issues/1264).
...
- Das Problem wurde behoben, bei dem die Maus in einigen Fällen ohne Drücken der Tastenkombination weiter übersetzte.
...
- Reparatur des Konflikts mit einigen Plug-ins, die unendliches Seiten-Reload verursachen.
...
- Ändern der zweisprachigen Freigabe (Aktualisierungsmodus), die in der letzten Version hinzugefügt wurde, zur zweisprachigen Seiten-Snapshot-Freigabe, sodass der geteilte Inhalt originaler ist und eine breitere Anpassungsfähigkeit hat.
...
Die Standardsprache für die Eingabefeldübersetzung kann jetzt das Leerzeichen weglassen, d.h. //Hello World kann ebenfalls übersetzt werden.
...
- Beheben Sie das Problem mit dem weißen Bildschirm nach der Übersetzung von Websites mit Hydration wie Next.js.
...
- Beheben Sie ein Problem mit der Erkennung von Zeilenumbrüchen in TXT-Dateien.
...
- Fix: OpenAI maximale Token-Grenze, ändere maximale Zeichen von 1500 auf 1300.
...
- Fix: Firefox Mobile Überprüfung des Übersetzungsdienst-Netzwerks.
...
- Übersetze den Seitentitel nicht, wenn er in einem iframe ist
...
- Fix: Ändere die Transparenz von 0.4 auf 0.618 [#147] (https://github.com/immersive-translate/immersive-translate/pull/147)
- Fix: Popup-Shortcuts-Tipps
- Leistung: Serielle zu gleichzeitigen Anfragen
- Besser für die Erkennung japanischer Zählungen

## 0.2.62

- Feat: Füge waitForSelectors Regel hinzu, um einige Seiten wie Reddit zu beheben
...
- Fix: Übersetze die ganze Seite, Fußzeile wird ignoriert
- Füge Notizen zur Über-Seite hinzu
...
- Füge Beitrag zur Über-Seite hinzu
...
- Refaktor Popup-Position.

## 0.2.17

- Ändere Hervorhebung zu Markierung
- Füge Hervorhebung Übersetzungsthema hinzu
...
- Ändert das Popup-UI, um die Nutzung zu erleichtern
...
- Behebt die Übersetzung von block img.
...
- Unterstützung für sofortigen Übersetzungsmodus, damit die Webseite so schnell wie möglich übersetzt wird.
- Unterstützung für die Festlegung des Seitenbereichs, der übersetzt werden muss, damit mehr Bereiche übersetzt werden können.
...
- Behebt mehrfache Übersetzung beim Wechsel des Dienstes
