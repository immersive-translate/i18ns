...
- Hinzugefügt: Android-Browser unterstützt kostenlose Bildübersetzung. 【Ausstehend, muss auf Browser-Veröffentlichung warten】
- Hinzugefügt: Gemini unterstützt Portugiesisch (Brasilien).
- Hinzugefügt: Grok, Ollama, Groq, Azure-OpenAI Übersetzungsdienste.
...
- Behoben: Synchronisationsfehler von Google Drive auf einigen Browsern.
...
- Neu: Kostenlose Bildübersetzung ist jetzt verfügbar (derzeit nur auf PC-Versionen von Chrome und Edge-Browsern unterstützt), zugänglich über das Rechtsklick-Menü.
- Behoben: Ein Problem behoben, bei dem während der Mehrsegmentübersetzung in Gemini einige Inhalte ausgelassen wurden.
...
- Verbessert: Netflix Untertiteldarstellungslösung

## 1.10.5 (2024-10-23)

- Hinzugefügt: Warnung anzeigen, wenn die Quellsprache und die Zielsprache gleich sind
- Behoben: Problem mit der Übersetzung von Leerzeichen im Rich-Text [#2175](https://github.com/immersive-translate/immersive-translate/issues/2175)
...
- Problem mit der Synchronisation benutzerdefinierter AI-Experten behoben
...
- Problem behoben, bei dem das Eingabefeld in der Tiktok-Privatnachrichtenoberfläche falsch übersetzt wurde
...
- Der DeepL-Übersetzungsdienst unterstützt jetzt offiziell Traditionelles Chinesisch als Zielsprache (zuvor war die Übersetzung ins Traditionelle Chinesisch mit DeepL mit einem zusätzlichen Drittanbieterprozess zur Umwandlung von Vereinfachtem in Traditionelles Chinesisch verbunden).
...
- Epub-Dateien unterstützen jetzt Rich-Text-Übersetzung (d.h. das Format des Originaltextes jedes Absatzes wird beibehalten, wie z.B. Links, Fett, etc.)
...
- Probleme mit der Rich-Text-Übersetzung für Übersetzungsdienste wie Google, DeepL (z.B. Seiten, die direkt `<button>` anzeigen, etc.) behoben
...
- Übernahme des AI-intelligenten Satzteilungsalgorithmus für automatisch generierte englische Untertitel auf YouTube [Pro Verfügbar]
...
- Problem behoben, bei dem benutzerdefinierte AI-Dienste keine AI-Experten auswählen konnten.

## 1.6.4

- Wenn AI-Experten für "Intelligente Auswahl" verwendet werden, können verschiedene AI-Experten für verschiedene Websites angepasst werden. Dies kann in [Einstellungen] -> [AI-Experten] -> [Beliebigen Experten eingeben] eingestellt werden.
...
- In zweisprachigen Video-Untertiteln wird der Originaltext automatisch in vereinfachtes Chinesisch umgewandelt, wenn die Zielsprache vereinfachtes Chinesisch und der Originaltext traditionelles Chinesisch ist, und umgekehrt.
...
- Unterstützung für die Übersetzung von Video-Untertiteln [Unreal Sensei](https://www.unrealsenseiacademy.com/)
...
- Unterstützung für die Übersetzung von Video-Untertiteln für [Kanopy](https://www.kanopy.com/), [RachelsEnglishAcademy](https://www.rachelsenglishacademy.com/), [Hulu](https://www.hulu.com/), [Three.js Journey](https://threejs-journey.com/).
...
- Unterstützung für die Übersetzung von Video-Untertiteln auf [LinkedIn](https://www.linkedin.com/) und [Viu](https://www.viu.com/) Plattformen.
...
- Optimierung der Empfindlichkeit der Erkennung von Maus-Hover über Ctrl, um zu vermeiden, dass `Ctrl+C` als `Ctrl` missverstanden wird
...
- Behebung des Ausrichtungsproblems mit der "Mehr"-Option, die nicht linksbündig auf Windows war.
...
- Behebung: Das Problem, bei dem das Umschalten von Übersetzungsdiensten nicht wirksam wurde, wenn die Seite noch nicht übersetzt wurde.
...
- **UI-Optimierung**: Neugestaltung der UI für Seitenübersetzungsfehlerhinweise, um sie verständlicher zu machen. Wenn viele Fehler auftreten, wird ein Popup den Benutzer aktiv darauf hinweisen.
...
- Unterstützung für YouTube-Untertitel nur für Übersetzungen
...
- Das PDF-Übersetzungstool wird auf die Online-Version migriert: https://app.immersivetranslate.com/pdf/ , sodass Grease Monkey und Safari PDF-Übersetzung verwenden können, und Probleme können besser iteriert werden, ohne eine Version herausgeben zu müssen, um das Problem zu lösen.
...
- Behebung: Gmail-Übersetzung aller Regionen
...
- Hinzufügen des Statuswechsels des Browser-Icons, wenn eine Webseite übersetzt wurde, wird automatisch ein ✅ in der unteren rechten Ecke des Browser-Icons hinzugefügt.
...
- Intelligenteres Bestimmen, ob es sich um einen Navigationsbereich handelt, und wenn ja, wird keine Übersetzung durchgeführt
...
- Behebt ein Problem mit der Zeilenumbrucherkennung in TXT-Dateien.

- Viele Updates!

- Die Funktion "Nur Übersetzung anzeigen" ist angekommen! Klicken Sie auf "Mehr" -> "Wechseln zu Nur Übersetzungen anzeigen".
...
- Web-Kern-Parsing wurde neu aufgebaut, was bedeutet.
...
- Feat: Übersetze den aktuellen Absatz, wenn die Maus darüber schwebt.
...
- Fix: Vermeiden der Content Security Policy für [Mastondon](https://mastodon.social/)
...
- Fix: postMessage beim Initialisieren der Seite brach einige Seiten, jetzt tun wir dies nur, wenn wir wirklich Seiten übersetzen
...
- Version: Ab jetzt werden wir die Nebenversion einmal im Monat ändern, zum Beispiel jetzt im März, wird die Version von 0.3.0 beginnen, im April wird die Versionsnummer von 0.3.0 beginnen, im April wird die Versionsnummer von 0.4.0 beginnen, im nächsten April wird die Versionsnummer 1.4.0 sein, und so weiter. Dies liegt daran, dass es keinen Sinn macht, dass Erweiterungen Semantik folgen, aber die Standardisierung von Versionsnummern nach den Gesetzen der Zeit ist Motivation für die Entwicklung, um kontinuierlich zu aktualisieren, und für Benutzer, um Probleme leichter zu finden.
...
- Feat: Erlauben Sie das Anzeigen des Passworts im Passwort-Eingabeformular.
...
- Fix: Unbekannte Tags Block-Element
...
- Shortcuts alt+d, alt+s entfernen, da sie möglicherweise mit nativen Shortcuts in Konflikt stehen.
- Fix: Google Drive Upload-Problem [#81](https://github.com/immersive-translate/immersive-translate/issues/81)

## 0.2.48

- Besser für Geschwindigkeit, indem minLength auf 50 für Spracherkennung gesetzt wird.
...
- Unterstützung für Aktivierung der Beta-Funktion im Entwicklerpanel
...
- Nicht standardmäßige Übereinstimmung für Userscript entfernen
...
- Fix: Markieren Sie die Zeilenhöhe hervorheben
...
- Unterstützung für Drei-Finger auf Touch-Gerät, um Seitenübersetzung umzuschalten
...
- Unterstütze sofortige Übersetzung der Seite
