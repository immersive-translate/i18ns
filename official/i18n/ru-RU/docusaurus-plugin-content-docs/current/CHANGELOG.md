...
- Добавлено: Сервисы перевода Grok, Ollama, Groq, Azure-OpenAI.
...
- Исправлено: Проблема с интеллектуальным сопоставлением AI экспертов в пользовательских сервисах перевода.
...
- Добавлено: Режим принудительной поддержки мыши (включайте эту функцию только если функция наведения мыши недоступна на планшетах) **Settings** -> **Advanced Settings** -> **Forece Enable Mouse Support**
...
- Теперь вы можете быстро сообщать о проблемах перевода веб-страниц в плавающем шаре immersive translation. После перевода веб-страницы, если есть какие-либо проблемы, вы можете нажать кнопку [Feedback] справа от плавающего шара, заполнить описание проблемы, и мы решим ее как можно скорее.
...
- Исправлена проблема непереведенного диалогового окна сообщений при открытии страницы Reddit
...
- Были внесены улучшения для решения проблемы, когда погружающиеся двуязычные субтитры не отображались, когда пользователи устанавливали язык субтитров на китайский на сайте YouTube.
...
- Сервис перевода Gemini скрыт по умолчанию, его можно включить в настройках разработчика для показа бета-версии этого сервиса перевода
...
- **Оптимизация UI**: Переработан интерфейс для сообщений об ошибках перевода страниц, чтобы сделать их более понятными. При большом количестве ошибок всплывающее окно активно уведомляет пользователя.
...
- Исправлена проблема с не переводом текста при нажатии на ins
...
- Исправлена проблема с не переводом некоторых японских отрывков.
...
- Исправлено: избегание политики безопасности контента для [Mastondon](https://mastodon.social/)
...
- Исправлено: переключение UI параметров перевода сервисов ввода состояния не изменено.
...
- Исправлено: проблема с сетью сервиса перевода на мобильном Firefox.
...
- Изменить интерфейс popup, для более удобного использования
