...
- Улучшено: Улучшение ввода и функции наведения мыши в встроенных iframes на веб-страницах.
...
- По умолчанию, перевод с упрощенного китайского на традиционный китайский и наоборот будет использовать режим только перевода, а не двуязычного сравнения.
- Исправлены некоторые ошибки.
...
- Обеспечивает быстрый доступ к двуязычным версиям всех статей на сайте [Arxiv](https://arxiv.org/abs/1910.06709).
- [Поддержка hoverball, настроенного на фиксацию слева #1168](https://github.com/immersive-translate/immersive-translate/issues/1168)
...
- Онлайн-страницы PDF без расширения .pdf теперь могут перейти непосредственно на страницу перевода PDF, нажав на hoverball на странице.
...
- Для страниц статей теперь сначала будет переведен основной текст, а затем остальное содержимое боковой панели
...
- Оптимизировано для проблемы с ограничением скорости запросов OpenAI
...
- Fix: состояние ввода переключения служб перевода в Options UI не изменилось.
...
- Исправление: переключение маски userscript с событием касания.
...
- Исправление игнорирования тегов rb, rt на японском.
...
- Поддержка перевода inline iframe userscript.
...
- Исправление неработающего globalThis.GM на safari
...
- Исправить пустую страницу Wikipedia
