...
- Добавлено: Управление AI глоссарием (поддерживаются только AI translation services)
- Добавлено: Версия для ПК поддерживает функцию перевода выделенного текста (не userscript)
- Добавлено: Поддержка включения AI субтитров на Youtube для ПК (Pro members)
...
- Оптимизировано: Увеличена скорость работы userscript.
...
- Исправлено: Ошибка `401: Authentication Fails` для пользовательского API Key в DeepSeek.

## 1.14.10 Release (2025-02-17)

- Новое: Pro membership поддерживает DeepSeek (v3) translation service.
...
- Исправлено: Проблема интеллектуального сопоставления AI экспертов в пользовательских translation services.
- Исправлено: Проблема с синхронизацией Google Drive на некоторых браузерах.
...
- Добавлено: Pro members теперь могут напрямую использовать модель **Zhipu 4 Plus**.
...
- Исправлено: Проблема, когда функция наведения мыши загружает неправильный translation service при определенных условиях.
- Исправлено: Проблема, когда временное включение двуязычных субтитров на YouTube не работает.
- Исправлено: После переключения translation services, translation service в "**Enhanced Input Box**" не обновляется.
...
- Добавлено: **AI Context-Aware Translation** может улучшить точность перевода профессионального контента. (Доступно только для Pro members, поддерживается исключительно моделями OpenAI) **Options** -> **Grneral** -> **Enable AI Context-Aware Translation**
...
- Исправлена проблема с отображением двуязычных субтитров для нескольких видео на одной странице Twitter
...
- Сервис перевода DeepL теперь официально поддерживает традиционный китайский как целевой язык (ранее перевод на традиционный китайский с DeepL включал дополнительный процесс конверсии с упрощенного на традиционный китайский через сторонние сервисы).
...
- Исправлена проблема, когда двуязычный ярлык для видео на YouTube не мог быть отключен.
...
- Поддержка перевода субтитров для веб-версии ZOOM
...
- Двуязычные субтитры на YouTube теперь поддерживают интеллектуальное разделение предложений (бета) (только при ручном включении immersive translation субтитров на YouTube в [Settings] - [Video Subtitles], и оригинальные субтитры видео являются автоматически сгенерированными английскими субтитрами)
...
- Исправлена проблема, из-за которой двуязычные субтитры не работали на видео платформе Domestika в Safari.
...
- Исправлена проблема, из-за которой изменения в общем экспертном prompt переопределяли указанный AI экспертный prompt [#1692](https://github.com/immersive-translate/immersive-translate/issues/1692)
...
- Поддержка AI переводческих сервисов для установки [AI Expert] для указания стратегии перевода, в настоящее время это Beta функция, которую можно включить в [Developer Settings](https://dash.immersivetranslate.com/#developer) после включения Beta, и меню [AI Expert] будет видно после обновления.
...
- Исправлена проблема, из-за которой двуязычные субтитры на YouTube не могли быть отрегулированы вверх и вниз в полноэкранном режиме [#1654](https://github.com/immersive-translate/immersive-translate/issues/1654)
...
- Исправлена проблема, из-за которой перевод не удавался при переключении пользовательских prompt слов OpenAI под тестовой кнопкой
- Исправлена проблема, из-за которой значок ярлыка субтитров на YouTube не отображался
- Оптимизировано распознавание языка расширения

## 1.4.6

- Исправлена проблема, из-за которой пользовательские prompt слова были неэффективны
- Добавлены опции 50%, 150% для размера шрифта субтитров на Youtube

## 1.4.5

- Исправлена проблема, из-за которой изменения стилей субтитров на Youtube не сохранялись
...
- Значительно оптимизирована скорость перевода субтитров на Youtube, добавлена поддержка переключения порядка китайского и английского языков, настройки цвета и размера шрифта и т.д.
...
- **Обновление пользовательского интерфейса страницы настроек плагина**:
  ...
  - В "Расширенных настройках" добавлена новая опция для настройки минимального количества символов, необходимых для перевода абзаца. По умолчанию это 4 символа, но можно установить большее значение (например, 20), чтобы переводились только более длинные абзацы.
...
- **Оптимизация UI**: Переработан интерфейс для сообщений об ошибках перевода страницы, чтобы сделать их более понятными. При большом количестве ошибок всплывающее окно активно уведомляет пользователя.
...
- **Удаление функции**: Удалена функция улучшения двуязычной информации (одновременное отображение результатов поиска на английском на страницах поиска Google).
...
- Когда вы включаете двуязычные субтитры на панели, сначала страница автоматически обновляется (чтобы более точно отображать двуязычные субтитры), и некоторые сайты все еще требуют, чтобы пользователи вручную нажимали кнопку "CC" на сайте, чтобы включить субтитры.
...
- Исправление проблем с расширенной загрузкой PDF
...
- Исправление эмодзи в конце поля ввода Twitter, которые не могут быть переведены
- Исправление ситуации, когда контент сторонних плагинов переводится в некоторых сценариях
- Исправление онлайн pdf шарик наведения клика не отвечает
...
- Решена проблема, когда некоторые платформы не могли распознать, поддерживается ли мышь
  - Некоторые настольные браузеры поддерживают как сенсорный экран, так и мышь, и Immersive Translates технически не может определить, поддерживает ли такая платформа мышь, поэтому мы добавили опцию [Принудительно включить поддержку мыши] в настройке [Наведение мыши]
...
- Исправление дрожащих кликов на шарике наведения страницы
- Исправление проблем с переводом Azure

## 0.10.9

- Исправление некоторых незначительных проблем
...
- Добавление предупреждения о низкой версии Grease Monkey
- Исправление проблемы, когда локальные txt файлы не могут быть переведены
...
- Исправлен конфликт субтитров Youtube с плагином Dual subtitle (перевод субтитров Youtube с помощью Immersive Translate не включается, когда обнаружен плагин Youtube Dual, чтобы избежать конфликта)
- Добавлена функция [Постоянное отключение функции субтитров видео], если есть другие конфликтующие проблемы и вы не хотите включать функцию двуязычных субтитров с Immersive Translate.
...
- Исправлена проблема, когда текст "нажмите больше" не переводился
...
- Исправлена автоматическая переводка, когда выделен readwise

## 0.9.6

- Исправлено очищение кэша путем выхода из системы пользователя.
...
- Мы были уведомлены Apple, что переводы OpenAI временно удалены из iOS и macOS, и мы пытаемся перезапустить их в Китае.
...
- Увеличение масштабирования мелкого шрифта PDF на Chrome и Safari
...
- Выравнивание выпадающего списка Windows влево
...
- Исправлено: переключатель UI опций переводческих сервисов не изменял состояние ввода.
...
- Исправлено: проверка неизвестных тегов в строке
...
- Исправлено: проблема с проверкой сетевого сервиса перевода на мобильном Firefox.
...
- Исправлено: заполнитель Open AI
...
- Исправлено: неизвестные блочные теги
...
- Исправлено: неизвестные теги блочных элементов
...
- Исправлено дублирование перевода для встроенных элементов с элементом кода.
- Исправлено: проверка неизвестных тегов в строке/блоке
...
- Исправлено: замена заполнителя перевода
...
- Добавить вклад в страницу о программе
...
- Поддержка перевода встроенного iframe в userscript.
...
- Поддержка перевода встроенного iframe. (Только для расширения, недоступно для
  userscript)
...
- Поддержка переключения перевода страниц с помощью трех пальцев на сенсорных устройствах
- Поддержка скрытия иконки всплывающего окна userscript.
...
- Определение языка интерфейса по языку user agent
...
- Обработать ошибку соединения сообщения для всплывающего окна.
...
- Исправить сочетания клавиш в PDF
...
- Исправить отображение элемента с display none.
...
- Использовать sendMessage вместо connect, так как Chrome отключает порт через
  5 минут
- Улучшение для обнаружения текстовых контейнеров
...
- Улучшение для обнаружения дочерних элементов.

## 0.0.51

- Исправить проблему кэширования
...
- Добавить поддержку мобильной версии Reddit
...
- Исправить ошибку элемента sup inline.
...
- Исправить тег BR
- Обработать блочные теги по правилам
...
- Исправить перевод содержимого постов в мобильной версии Reddit.
...
- Включить все сайты для определения языка абзаца.
...
- Исправить принудительное обновление поиска в Google
...
- Исправить пустые страницы в Википедии
...
- Исправить обнаружение заголовков
...
- Исправить проблему с innerText в Reddit
