...
- Добавлено: Управление AI глоссарием (поддерживается только AI переводческими сервисами)
- Добавлено: Версия для ПК поддерживает функцию перевода выделенного текста (не пользовательский скрипт)
- Добавлено: Поддержка включения AI субтитров на Youtube для ПК (Pro пользователи)
...
- Исправлено: Проблема, когда AI переводческий сервис неправильно выводил упрощенный китайский при переводе традиционного китайского.
- Исправлено: Проблема с переводом при наведении, не работающим в режиме "Перевод сначала, оригинальный текст следует".
...
- Оптимизировано: Улучшено качество AI переводческого сервиса для основного контента.
...
- Добавлено: Grok, Ollama, Groq, Azure-OpenAI переводческие сервисы.
...
- Исправлено: Проблема с превышением размера файла конфигурации пользователя.
...
- Исправлено: Проблема интеллектуального сопоставления AI экспертов в пользовательских переводческих сервисах.
...
- Новое: Бесплатный перевод изображений теперь доступен (в настоящее время поддерживается только в версиях для ПК браузеров Chrome и Edge), доступен через контекстное меню.
...
- Новое: AI переводческий сервис теперь поддерживает норвежский.
...
- Исправлено: Проблема, когда функция наведения мыши загружает неправильный переводческий сервис при определенных условиях.
- Исправлено: Проблема, когда временное включение двуязычных субтитров на YouTube не работает.
- Исправлено: После переключения переводческих сервисов, переводческий сервис в "**Enhanced Input Box**" не обновляется.
...
- Исправлено: Проблема, когда контент исчезает после нажатия "see more" в режиме только перевода Facebook.
...
- Добавлено: Перевод субтитров в реальном времени теперь поддерживает активацию через "плавающий шар", доступно в Zoom, Google Meet и Microsoft Teams.
...
- Исправлено: Проблемы с функцией отмены Ctrl+Z в **Enhanced input** на некоторых веб-сайтах.
...
- Добавлено: Отображение сообщения об ошибке, когда перевод субтитров видео не удается
...
- По умолчанию система будет запоминать режим, переключенный нажатием на значок в панели для двуязычного сравнения или только перевода. Чтобы временно переключиться, нажмите "More" -> "Switch to translation-only display" в панели.
...
- Исправлена проблема, когда [Advanced Settings -> Minimum number of characters required for translating a paragraph] не срабатывала в некоторых случаях

## 1.8.4 (2024-08-30)

- Служба перевода DeepL теперь официально поддерживает традиционный китайский как целевой язык (ранее перевод на традиционный китайский с DeepL включал дополнительный процесс конверсии с упрощенного на традиционный китайский).
...
- Настройки горячих клавиш теперь позволяют назначать уникальные сочетания клавиш для любой службы перевода
...
- DeepL, Microsoft Translate, Google Translate, OpenAI, Claude, Gemini и другие службы перевода поддерживают перевод с сохранением оригинального форматирования текста (например, ссылки, жирный шрифт и т.д.)
...
- Двуязычные субтитры YouTube теперь поддерживают интеллектуальное разбиение предложений (бета) (Только при ручном включении immersive перевода субтитров YouTube в [Settings] - [Video Subtitles], и оригинальные субтитры видео являются автоматически сгенерированными английскими субтитрами)
...
- Когда AI-эксперты используются для "Intelligent Selection", можно настроить различных AI-экспертов для разных веб-сайтов. Это можно установить в [Settings] -> [AI Experts] -> [Enter any expert].
...
- Исправлена проблема, из-за которой перевод не удавался при переключении пользовательских слов подсказки OpenAI под кнопкой теста
...
- Исправлена проблема, из-за которой пользовательские слова подсказки были неэффективны
...
- Недавние запросы на перевод от Microsoft из Китая были нестабильными; при возникновении ошибок система автоматически обнаруживает доступный в данный момент сервис перевода, позволяя пользователям быстро переключаться.
...
- Добавлены дополнительные быстрые доступы к субтитрам видео для дополнительных платформ.
...
- Добавлена конфигурация ярлыков для [Перевод указанного абзаца] в плавающей панели на мобильных устройствах
...
- На сайте Sci-Hub нажатие на плавающий шар переводит PDF, встроенные в веб-страницу
...
- **Оптимизация перевода на японский язык:** Дальнейшая оптимизация перевода OpenAI на японский язык для улучшения точности и плавности.
...
- Оптимизация: Скорректирован размер шрифта сообщений об ошибках перевода для улучшения читаемости.

## 1.1.1

- Исправлена проблема с ярлыком двуязычных субтитров для YouTube, содержащим слишком длинный текст на английском языке.
...
- **Оптимизация интерфейса**: Переработан интерфейс для сообщений об ошибках перевода страницы, чтобы они были более понятными. При большом количестве ошибок всплывающее окно активно уведомляет пользователя.
...
- Исправлено: Проблема с сшивкой длинных абзацев в переводе OpenAI в некоторых случаях. [#1276](https://github.com/immersive-translate/immersive-translate/issues/1276)
...
- Плавающий шарик теперь скрыт по умолчанию, когда видео на полном экране.
- Исправлена проблема с дрожащим кликом панели действий плавающего шарика на странице Firefox.
...
- Исправлена проблема, что перевод YouTube/Web of Science и т.д. не чувствителен при переключении вкладок.
- Плавающий шарик на мобильных устройствах теперь поддерживает длительное нажатие, короткое нажатие для перевода, длительное нажатие для открытия панели.
...
- [Поддержка плавающего шарика, настроенного на фиксацию слева #1168](https://github.com/immersive-translate/immersive-translate/issues/1168)
...
- Онлайн-страницы PDF без расширения .pdf теперь могут переходить непосредственно на страницу перевода PDF, нажав на плавающий шарик на странице.
...
- Изменено двуязычное совместное использование (режим обновления), добавленное в последней версии, на совместное использование снимков двуязычных страниц, чтобы общий контент был более оригинальным, а также более широкая адаптируемость.
...
- Исправлено отсутствие реакции на нажатие плавающего шарика на онлайн pdf
...
- Исправлены дрожащие клики плавающего шарика на странице
...
- Поддержка настройки кнопок быстрого перевода плавающего шарика (поддержка как для ПК, так и для мобильных устройств)
...
- Поддержка перевода субтитров на Youtube только
- Добавлено предупреждение о низкой версии Grease Monkey
- Исправлена проблема, что локальные txt файлы не могут быть переведены

## 0.10.5

- Исправлена проблема, когда YouTube иногда возвращается на главную страницу

## 0.10.4

- Исправлен конфликт субтитров YouTube с плагином Dual subtitle (перевод субтитров YouTube с помощью Immersive Translate не включается при обнаружении плагина YouTube Dual, чтобы избежать конфликта)
- Добавлена функция [Постоянное отключение субтитров видео], если возникают другие конфликтующие проблемы и вы не хотите включать функцию двуязычных субтитров с Immersive Translate.
...
- Для страниц статей текст основного содержимого теперь будет переведен в первую очередь перед остальным содержимым боковой панели
...
- Оптимизация скорости экспорта только перевода PDF, если вы выбираете экспорт только перевода, вы можете напрямую вызвать системный предварительный просмотр PDF для экспорта, быстрее.
- Deeplx поддерживает несколько URL, просто разделите их с помощью .

## 0.9.2

- Инструмент перевода PDF перенесен в онлайн-версию: https://app.immersivetranslate.com/pdf/, чтобы Grease Monkey и Safari могли использовать перевод PDF, и проблемы могут быть лучше итеративно решены без необходимости выпуска версии для решения проблемы.
...
- Сервис перевода при наведении мыши можно настроить отдельно
...
- Мы были уведомлены Apple, что OpenAI Translations временно удалены из iOS и macOS, и мы пытаемся повторно запустить их в Китае.
...
- Исправление проблемы переполнения ширины всплывающего окна Safari.
...
- Исправление проблемы уменьшения изображений при переводе Epub в некоторых браузерах
...
- Исправлена проблема, из-за которой изображения на некоторых веб-страницах: увеличиваются после копирования
...
- Исправлено: стиль онлайн-чтения электронных книг не работает

## 0.5.8

- Исправлена проблема, из-за которой: временная настройка продолжительности перевода сайта не вступает в силу.
...
- Поддерживаются все переводы сайтов ShadowRoot.
...
- Исправлено: обход Content Security Policy для [Mastondon](https://mastodon.social/)
...
- Исправлено: всплывающее окно Userscript Firefox отсутствует.
...
- UI: поле настроек OpenAI использует выбор вместо текстового поля ввода.
...
- Хоре: удаление console.log

## 0.4.3

- Исправлено: обнаружение пробелов в тегах sup, sub.
- Функция: поддержка ChatGPT Plus Website в качестве службы перевода, это бета-функция, поэтому вы можете получить к ней доступ, включив бета-функцию в настройках разработчика. Это очень медленно, потому что chatgpt может отправлять только один запрос за раз. Убедитесь, что у вас есть учетная запись ChatGPT Plus, потому что на бесплатной учетной записи больше ограничений, и я не уверен, несет ли это риск для вашей учетной записи, будьте осторожны, чтобы убедиться, что у вас есть учетная запись ChatGPT Plus, потому что на бесплатной учетной записи больше ограничений, и я не уверен, несет ли это риск для вашей учетной записи, будьте осторожны при использовании.
...
- Исправлено: переключатель UI параметров переводческих служб не изменял состояние ввода.
...
- Исправлено: перемещение курсора ввода формы параметров.
...
- Функция: Разрешить форму ввода пароля показывать пароль.

## 0.2.82

- Исправление: Некоторые сайты используют `span` для стилей, поэтому мы используем `font` вместо span для обертки цели перевода
- Исправление: Ограничение на максимальное количество токенов OpenAI, изменение максимального количества символов с 1500 до 1300.

## 0.2.81

- Исправление: m.youtube.com
- Исправление: UI формы опций
...
- Исправление: разрешение userscript Open AI

## 0.2.70

- Исправление: placeholder Open AI
...
- Исправление: Настройка перевода Azure, но все равно показывается (нужна настройка)
...
- Исправление: изменение прозрачности с 0.4 до 0.618 [#147] (https://github.com/immersive-translate/immersive-translate/pull/147)
- Исправление: подсказки для ярлыков всплывающего окна
- Производительность: последовательные запросы к cocurrency
- Улучшение для обнаружения японского языка
...
- Исправление: продвижение исключения приоритета
...
- Удаление ярлыков alt+d, alt+s, так как они могут конфликтовать с нативными ярлыками.
...
- Исправление переключения маски userscript с помощью сенсорного события.
- Исправление скорости (удаление sleep(300))

## 0.2.42

- Исправление наведения на маску при повторном переключении маски.
- Добавление ярлыков для маски для мобильных устройств
- Исправление проблемы с облачной синхронизацией userscript
...
- Исправление настройки всплывающей страницы на новой вкладке
- Исправление замены placeholder перевода

## 0.2.39

- Поддержка ярлыков для отображения перевода маски
...
- Исправление всплывающего выбора не настроенного сервиса, переход на страницу опций.
...
- Поддержка перевода shadowroot. Например:
  ...
  Область разговора.
- также проверка правила синхронизации на всплывающем окне
...
- Исправление высоты линии выделения метки
...
- Исправление проблемы с отскоком при касании

## 0.2.14

- Исправить проблему с globalThis.GM в Safari

## 0.2.13

- Поддержка перетаскивания Userscript Popup
- Поддержка переключения страниц перевода с помощью трех пальцев на сенсорных устройствах
- Поддержка скрытия иконки userscript popup.
...
- Исправить
  ...
  Основной контент страницы Annas archive не мог быть переведен

## 0.2.10

- Исправить расстояние между строками в pdf
...
- Определение языка user agent для интерфейса
- Исправить ошибку переноса строк.
...
- поймать ошибку соединения сообщения для popup.
...
- Исправить разрешение для ранних браузеров

## 0.0.60

- Исправить Chrome PDF
...
- Изменить интерфейс popup, для более легкого использования

## 0.0.56

- Исправить тайм-аут chrome
...
- использовать sendMessage вместо connect, так как chrome отключает порт через
  5 минут
- лучше для обнаружения текстовых контейнеров
...
- добавить тайм-аут для запроса кеша
...
- Поддержка кеширования результата для userscript
- Добавить интерфейс опций
- Поддержка обнаружения большего количества контейнеров контента

## 0.0.37

- Исправить изменение службы перевода popup не работает
...
- Исправить переход на следующую страницу youtube
...
- Исправить ошибку userscript Firefox.
...
- Исправить некоторые теги span, которые являются блочными элементами
...
- Поддержка базового интерфейса popup
