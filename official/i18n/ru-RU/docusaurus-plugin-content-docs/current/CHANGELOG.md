...
- Исправлено: Проблема, когда горячая клавиша перевода при наведении не работала на устройствах, поддерживающих как мышь, так и сенсорный ввод.
...
- Оптимизировано: [Бесплатный перевод изображений] поддерживает форматирование для языков с написанием справа налево.
...
- Исправлено: Решена проблема, когда некоторый контент пропускался при многофрагментном переводе в Gemini.
...
- Улучшено: Регулировка макета для языков с написанием справа налево в панелях и на страницах настроек.

## 1.12.6 (2024-12-26)

- Исправлено: Проблема, когда функция наведения мыши загружала неправильную переводческую службу при определенных условиях.
...
- Исправлено: Некоторые ошибки в многострочном переводе на Twitter.
...
- Исправлено: Горячие клавиши становятся неэффективными при переключении функции "**Hover Translation**".
...
- Исправлено: Проблема с сочетаниями клавиш для **Enhanced input**, которые не срабатывали
...
- Улучшено: Функциональность улучшенного ввода и наведения мыши в встроенных iframes на веб-страницах
...
- Теперь вы можете быстро сообщать о проблемах с переводом веб-страниц в плавающем шаре immersive translation. После перевода веб-страницы, если есть какие-либо проблемы, вы можете нажать кнопку [Обратная связь] на правой стороне плавающего шара, заполнить описание проблемы, и мы решим ее как можно скорее.
...
- Поддержка двуязычных субтитров в режиме реального времени в видеовстречах веб-версии Microsoft Teams (откройте ссылку на встречу Teams, включите двуязычные субтитры в панели immersive translation, а затем обновите)
...
- Настройки горячих клавиш теперь позволяют назначать уникальные сочетания клавиш для любого сервиса перевода
...
- Поддержка перевода субтитров в веб-версии встреч ZOOM
...
- Двуязычные субтитры YouTube теперь поддерживают интеллектуальное разбиение предложений (бета) (только при ручном включении immersive translation субтитров YouTube в [Настройки] - [Видео субтитры], и оригинальные субтитры видео - автоматически сгенерированные английские субтитры)
...
- Исправлена проблема, когда двуязычные субтитры YouTube не могли быть перемещены вверх и вниз в полноэкранном режиме [#1654](https://github.com/immersive-translate/immersive-translate/issues/1654)
...
- Исправлена проблема с ярлыком двуязычных субтитров для YouTube, где текст на английском языке был слишком длинным.
...
- Исправлена проблема, когда эмодзи в конце поля ввода Twitter не переводились
...
- Оптимизирован китайский Prompt для OpenAI, теперь менее склонен к галлюцинациям!
...
- Поддержка перевода субтитров на Youtube
- Добавлено предупреждение о низкой версии Grease Monkey
- Исправлена проблема, когда локальные txt файлы не могли быть переведены
...
- Исправлена проблема входа в Google в Safari
...
- Исправлено: стиль авторинга eBook не работает
...
- Исправлено: лучше для разбиения длинного абзаца, 1.5 миллиарда, 25.5%, Mr. не будут считаться границей
...
- Исправлено: переключатель UI опций перевода сервисов не изменял состояние ввода.
...
- Исправлено: перемещение курсора ввода формы опций.
...
- Исправлено: интерфейс формы параметров
...
- Исправлено: высокое использование памяти для userscripts и расширений (удаление opencc zh-CN на zh-TW, вместо этого с Google translate)
- Исправлено: Relingo [#159] (https://github.com/immersive-translate/immersive-translate/issues/159)
- Исправлено: настройка перевода Azure, но все равно отображается (нужна настройка)

## 0.2.66

- Исправлено: ошибка перевода PDF-файлов, ошибка из 0.2.60 для поддержки deepl с zh-CN на zh-TW
...
- Новая функция: Поддержка сервиса перевода Azure
- Новая функция: Поддержка сервиса перевода Papago
...
- Исправлено: советы по горячим клавишам во всплывающем окне
...
- Исправлено: ошибка синхронизации Google Drive в userscript.
...
- Исправлено: необходимость входа в Google Auth на Chrome/Firefox
...
- Улучшено для скорости, добавлением minLength до 50 для определения языка.
...
- Исправлено: не определен исходный язык перевода caiyun
...
- Исправлено: переключение маски в userscript с помощью сенсорного события.
- Исправлено: скорость (удалением sleep(300))
...
- Исправлено: проблема с облачной синхронизацией в userscript
- Перемещение страницы расширенных опций в левое меню.
- Добавлена логика повторной попытки для сервиса перевода

## 0.2.41

- Исправлено: перевод niu в userscript
...
- Исправлено: замена placeholder перевода
...
- Исправлено: игнорирование японских тегов rb, rt.
- Улучшено для интерфейса всплывающего окна
- Улучшено для плохих советов userscript
...
- Исправлено: дополнение для Android в Firefox
...
- Добавить временный перевод сайта на некоторое время
- Исправлено: API браузера userscript stay.app
...
- Исправлено: онлайн перевод PDF в Firefox

## 0.2.20

- Исправлено: проблема с запросом macaque
- Исправлено: выделение линии высоты

## 0.2.19

- Исправлено: умный японский от Tencent
...
- Исправлено: проблема с отскоком при касании

## 0.2.14

- Исправлено: globalThis.GM не работает в Safari
...
- Исправление специального символа Wikipedia
...
- Исправление пустого пространства Wikipedia
