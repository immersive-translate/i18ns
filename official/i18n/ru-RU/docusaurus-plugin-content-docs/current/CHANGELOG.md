...
- Исправлено: исправлена проблема, из-за которой капсульное выпадающее меню перевода в полях ввода могло выходить за нижнюю границу в WhatsApp.
- Добавлено: пользовательские API-сервисы теперь автоматически дополняют пути интерфейсов OpenAI / Anthropic на основе Base URL.
- Улучшено: улучшен вход в перевод документов во всплывающем окне, чтобы сделать его заметнее и удобнее.
...
- Улучшено: улучшены сообщения диалогов ошибок 403 / Cloudflare.
- Добавлено: добавлен переключатель кэша перевода в раздел «Дополнительные функции» во всплывающем окне.
- Добавлено: добавлены отдельные переключатели по сайтам для перевода субтитров.

## 1.29.6 Release (2026-05-20)

- Улучшено: улучшено отображение фонетической транскрипции и результата перевода для [перевода по выделению текста] в сценариях с менее распространенными языками.
- Исправлено: исправлена проблема, из-за которой пользовательские AI-эксперты участников могли быть перезаписаны при синхронизации.
- Добавлено: добавлена поддержка перевода сайта комиксов toptoon.com.
...
- Исправлено: исправлена проблема, из-за которой боковая панель не открывалась в Atlas Browser.

## 1.29.1 Release (2026-05-07)

- Добавлено: поддержка сервиса перевода plamo.
- Улучшено: улучшены маркеры верстки для RTL-языков в режиме «Только перевод».
- Улучшено: улучшено сопоставление некоторых форм множественного числа английских терминов, что уменьшает пропуски терминов.
- Исправлено: исправлено дрожание субтитров при переводе субтитров Teams.
- Исправлено: исправлена проблема, из-за которой [Перевод по выделению] не мог корректно получить текст в сценариях с ShadowRoot.
...
- Добавлено: Профессиональные пользователи теперь могут напрямую использовать модель **zhipu 4.5**.
...
- Исправлена проблема, когда изменения в общей подсказке эксперта перекрывали указанную подсказку AI эксперта [#1692](https://github.com/immersive-translate/immersive-translate/issues/1692)
...
- В панели больше опций теперь поддерживает [вход для перевода текста](https://app.immersivetranslate.com/text/)
...
- Исправление
  ...
  Архив Annas Основное содержание страницы не может быть переведено
...
- Поддержка установки режима немедленного перевода, чтобы страница переводилась
  как можно быстрее.
- Поддержка установки области страницы, которую нужно перевести, чтобы можно было
