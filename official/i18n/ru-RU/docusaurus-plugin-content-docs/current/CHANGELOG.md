...
- Оптимизировано: Gemini translation service поддерживает пользовательский системный prompt (System Prompt).
...
- Исправлено: Проблема с переводом Google с escape-символами.
...
- Новое: Премиум-членство поддерживает DeepSeek (v3) translation service.
...
- Исправлено: Решена проблема, когда часть контента пропускалась при многофрагментном переводе в Gemini.
...
- Добавлено: Премиум-пользователи теперь могут напрямую использовать модель **Zhipu 4 Plus**.
...
- Улучшено: Регулировка макета для языков, читаемых справа налево, на панелях и страницах настроек.
...
- Добавлено: **AI Context-Aware Translation** может улучшить точность перевода профессионального контента. (Доступно только для премиум-пользователей, поддерживается исключительно моделями OpenAI) **Options** -> **Grneral** -> **Enable AI Context-Aware Translation**
...
- Улучшено: Обновлен пользовательский интерфейс выпадающего списка служб перевода на панели.
...
- Сервис перевода DeepL теперь официально поддерживает традиционный китайский как целевой язык (ранее перевод на традиционный китайский с DeepL включал дополнительный процесс конверсии с упрощенного на традиционный китайский с помощью сторонних средств).
- Оптимизирована производительность перевода rich text.

## 1.8.3

- Google Meet теперь поддерживает двуязычные субтитры для живых встреч: теперь вы можете наслаждаться функцией двуязычных субтитров на встречах Google Meet. Просто откройте ссылку на встречу, активируйте двуязычные субтитры в панели погружающего перевода и обновите страницу, чтобы испытать это.
...
- Теперь вы можете переводить текст в полях ввода с помощью правого клика: выберите любой текст в поле ввода на веб-странице, щелкните правой кнопкой мыши, чтобы выбрать перевод, и погружающий перевод автоматически переведет выбранный текст на целевой язык поля ввода, что удобно для быстрого перевода текста на родном языке в поля ввода на другие языки.
- Теперь вы можете быстро сообщать о проблемах с переводом веб-страниц в плавающем шаре погружающего перевода. После перевода веб-страницы, если есть какие-либо проблемы, вы можете нажать кнопку [Обратная связь] справа от плавающего шара, заполнить описание проблемы, и мы решим ее как можно скорее.
...
- Поддержка двуязычных субтитров в реальном времени в видеовстречах веб-версии Microsoft Teams (откройте ссылку на встречу Teams, включите двуязычные субтитры в панели погружающего перевода и обновите)
...
- После выбора текста, контекстное меню изменится на [Перевести текст], нажав на которое вы можете автоматически перейти на страницу перевода текста погружающего перевода
...
- Двуязычные субтитры YouTube теперь поддерживают интеллектуальное разбиение предложений (бета) (только при ручном включении погружающего перевода субтитров YouTube в [Настройки] - [Видео субтитры], и оригинальные субтитры видео автоматически сгенерированы на английском языке)
...
- Когда AI эксперты используются для "Интеллектуального выбора", на странице настроек AI эксперта отображаются подсказки, используемые экспертом.
...
- В разделе "больше опций" панели теперь поддерживается [ввод текста для перевода](https://app.immersivetranslate.com/text/)
...
- Исправлена проблема, из-за которой некоторые пользователи Pro не могли изменить настройки в браузере Chrome.
...
- Добавлена поддержка новой настройки ярлыков, позволяющей быстро переключать использование встроенных субтитров машинного перевода для видео
...
- **Оптимизация пользовательского интерфейса**: Переработан пользовательский интерфейс для подсказок об ошибках перевода страницы, чтобы сделать их более понятными. Когда ошибок много, всплывающее окно активно подскажет пользователю.

- **Исправления ошибок**:

  - Исправлена проблема, из-за которой перевод при наведении мыши не срабатывал, когда страница теряла фокус.
  - Исправлена проблема, из-за которой менее 3 символов в функции улучшения поля ввода не переводились.
...
- Добавление отображения страницы без разрешения PDF
...
- Feat: OpenAI поддерживает пользовательский apiUrl для настроек разработчика.
...
- Исправление дополнения для Android в Firefox
...
- Исправление: globalThis.GM не работает в Safari
