...
- Оптимизировано: Служба перевода Gemini поддерживает пользовательский системный запрос (System Prompt).
...
- Добавлено: Режим Forece Enable Mouse Support (включайте эту функцию только если функция наведения мыши недоступна на планшетных устройствах) **Настройки** -> **Расширенные настройки** -> **Forece Enable Mouse Support**
...
- Двуязычные субтитры YouTube теперь поддерживают интеллектуальное разбиение предложений (бета) (только при ручном включении immersive translation субтитров YouTube в [Настройки] - [Видео субтитры], и оригинальные субтитры видео автоматически сгенерированы на английском языке)
...
- Исправлена поддержка полноэкранного воспроизведения YouTube в приложении для iOS.
...
- **Исправление перевода классического китайского:** Исправлена функциональность перевода классического китайского языка от Microsoft и OpenAI.
...
- **Настройки горячих клавиш**: Добавлено новое верхнеуровневое меню "Ярлыки" и следующие настраиваемые функции горячих клавиш:
  ...
  - Назначьте комбинацию клавиш для перевода содержимого текущего поля ввода, дополняя предыдущий метод быстрого нажатия пробела трижды.
...
- Добавлено предупреждение о низкой версии обновления Grease Monkey.
...
- Идеальная поддержка видео YouTube с двуязычными субтитрами 🎉.
...
- Оптимизация перевода PDF, теперь область перевода можно редактировать/перетаскивать/удалять
  - Перетаскивание влево сверху, удаление справа сверху, изменение размера снизу справа
...
- Исправление проблемы уменьшения изображений в Epub в некоторых браузерах
...
- Оптимизация: минимальное количество символов в абзаце, вызывающее перевод, было изменено на минимум 4 символа для уменьшения путаницы, при этом используя другие функции для избежания перевода навигационных и конечных областей сайта.
...
- Fix: Чистая веб-страница TXT, как [эта](https://edoras.sdsu.edu/~vinge/misc/singularity.html)
...
- Исправление: переключение маски userscript
- Исправление логики переключения маски

## 0.2.43

- Исправление: переключение маски userscript с помощью сенсорного события.
...
- Исправление: перевод niu userscript
...
- Исправление stay.app userscript browser API
