...
- Добавлено: Поддержка настройки количества экранов для предварительного перевода при просмотре текущей страницы.
...
- Добавлено: Grok, Ollama, Groq, Azure-OpenAI переводческая служба.
...
- Оптимизировано: [Бесплатный перевод изображений] поддерживает форматирование для языков, читаемых справа налево.
...
- Улучшено: Регулировка макета для языков, читаемых справа налево, в панелях и на страницах настроек.
...
- Улучшено: Обновлен пользовательский интерфейс выпадающего списка переводческих служб на панели.

## 1.11.1 (2024-11-05)

- Добавлено: Перевод **Subtitles Translation** в реальном времени теперь поддерживает активацию через "плавающий шар", доступно на Zoom, Google Meet и Microsoft Teams.
...
- Сервис перевода DeepL теперь официально поддерживает традиционный китайский как целевой язык (ранее перевод на традиционный китайский с помощью DeepL включал дополнительный процесс преобразования с упрощенного на традиционный китайский с помощью сторонних средств).
...
- Теперь вы можете переводить текст в полях ввода с помощью правой кнопки мыши: выберите любой текст в поле ввода на веб-странице, щелкните правой кнопкой мыши, чтобы выбрать перевод, и погружающий перевод автоматически переведет выбранный текст на целевой язык поля ввода, что удобно для быстрого перевода текста на родном языке в полях ввода на другие языки.
- Теперь вы можете быстро сообщать о проблемах перевода веб-страниц в плавающем шаре погружающего перевода. После перевода веб-страницы, если есть какие-либо проблемы, вы можете нажать кнопку [Обратная связь] справа от плавающего шара, заполнить описание проблемы, и мы решим ее как можно скорее.
...
- Новая кнопка обратной связи для перевода манги (после перевода манги нажмите кнопку [Обратная связь] справа от плавающего шара, чтобы оставить отзыв о качестве перевода).

## 1.7.7

- Применен AI интеллектуальный алгоритм разделения предложений для автоматически сгенерированных английских субтитров на YouTube [Pro Доступно]
- Оптимизирован перевод по правой кнопке мыши на "Перевести на xx целевой язык"
- Поддержка интеграции погружающего [JS SDK](https://immersivetranslate.com/docs/js-sdk/) для сторонних веб-сайтов
...
- Двуязычные субтитры YouTube теперь поддерживают интеллектуальное разделение предложений (бета) (только при ручном включении погружающего перевода субтитров YouTube в [Настройки] - [Видео субтитры], и оригинальные субтитры видео автоматически сгенерированы на английском языке)
...
- Все пользователи могут [внести вклад онлайн](https://weblate.immersivetranslate.com/projects/immersive-translate/extension/) в многоязычный перевод интерфейса погружающего перевода.
...
- Страница настроек теперь поддерживает настройки [стилей субтитров YouTube](https://dash.immersivetranslate.com/#subtitle).
...
- Исправлена проблема, когда настройка цвета текста не поддерживала RGBA preview [#1435](https://github.com/immersive-translate/immersive-translate/issues/1435)
...
- **Иммерсивный опыт перевода:** Чтобы лучше адаптироваться к привычкам пользователей, мы переместили ярлык для двуязычных субтитров в полноэкранном режиме на платформе YouTube в левую часть.
...
- **Обновление пользовательского интерфейса страницы настроек плагина**:
  ...
  - В "Расширенных настройках" добавлена новая опция, позволяющая пользователям указывать определенные слова (например, "LLM"), которые следует исключить из перевода.
...
- Исправлено: Проблема с распознаванием языка по умолчанию на некоторых машинах после первой установки.
...
- Исправление проблем с именами файлов при создании Epub ebook
...
- Обновление UI панели значков браузера Popup, немного больше дизайна ～
...
- Пользовательские правила теперь поддерживают слияние с встроенными правилами по умолчанию, например: `{"id": "youtube", "selectors.add":["#test"]}` означает добавление `#test` к существующим селекторам, `selectors` означает переопределение по умолчанию, `selectors.remove` означает удаление одного из селекторов по умолчанию.
...
- Исправление проблемы с переполнением ширины Popup в Safari.
...
- Исправление проблемы: двуязычные eBooks не имеют изображений после экспорта
...
- Исправлены разрывы абзацев в некоторых случаях:
...
- Исправлена проблема, когда для изменения горячей клавиши наведения мыши требовалось обновление страницы
...
- Feat: Новая страница руководства для новых пользователей.
...
- Feat: Добавить новую страницу руководства для клиентов
...
- UI: по умолчанию свернуть пользовательские опции openai.
...
- Fix: перемещение курсора ввода в форме опций.
- Feat: OpenAI поддержка пользовательского apiUrl для настроек разработчика.

## 0.3.1

- Feat: обновить темный значок до прозрачности.
- Fix: Неправильный порядок для длинного абзаца

## 0.3.0

- Версия: С этого момента мы будем менять номер минорной версии раз в месяц, например, сейчас в марте версия начнется с 0.3.0, в апреле номер версии начнется с 0.3.0, в апреле номер версии начнется с 0.4.0, в следующем апреле номер версии будет 1.4.0 и так далее. Это потому, что не имеет смысла для расширений следовать семантике, но стандартизация номеров версий в соответствии с законами времени является мотивацией для разработки, чтобы продолжать обновляться, и для пользователей, чтобы легче находить проблемы.
...
- Feat: Разрешить ввод пароля в форме для отображения пароля.
...
- Новая функция: Добавить `<all>` для всегда переводимых языков, теперь вы можете использовать это для перевода всех языков, кроме целевого языка, и никогда не переводимых языков
...
- Исправление: выбор переводческих сервисов openl
...
- Исправление переключения маски userscript
- Исправление логики переключения маски

## 0.2.43

- Исправление переключения маски userscript с событием касания.
- Исправление скорости (удаление sleep(300))

## 0.2.42

- Исправление наведения маски при повторном переключении маски.
- Добавление горячих клавиш для маски на мобильных устройствах
- Исправление проблемы синхронизации облака userscript
...
- Исправление userscript API браузера stay.app
...
- Изменить интерфейс всплывающего окна для более легкого использования
...
- Исправить отображение элемента none.
...
- использовать sendMessage вместо connect, так как chrome отключит порт через
  5 минут
...
- Исправить перевод изображения блока.
...
- переписывание сообщения с фоном, использовать connect вместо sendMessage
...
- Исправить проверку элемента inline
- Добавить опцию журнала отладки разработчика
...
- Исправить изменение службы перевода всплывающего окна не работает
- Исправить перевод содержимого мобильного поста reddit.

## 0.0.36

- Исправить специальный символ Wikipedia
...
- Поддержка установки режима немедленного перевода, чтобы вы могли перевести веб-страницу
  как можно быстрее.
- Поддержка установки области страницы, которую нужно перевести, чтобы вы могли перевести больше областей.
- Поддержка установки первого количества текста x для немедленного перевода.
...
- Исправить разрешение на подключение пользователей volc alpha.
