...
- Добавлено: Функция перевода выделенного текста
...
- Улучшено: Улучшена функциональность улучшенного ввода и наведения мыши в встроенных iframes на веб-страницах
...
- Поддержка улучшенного ввода для Baidu, Gmail и других полей ввода
...
- Теперь вы можете быстро сообщать о проблемах с переводом веб-страниц в плавающем шаре погружающего перевода. После перевода веб-страницы, если есть какие-либо проблемы, вы можете нажать кнопку [Feedback] справа от плавающего шара, заполнить описание проблемы, и мы решим ее как можно скорее.
...
- Двуязычные субтитры YouTube теперь поддерживают интеллектуальное разбиение предложений (бета) (только при ручном включении погружающего перевода субтитров YouTube в [Settings] - [Video Subtitles], и оригинальные субтитры видео автоматически сгенерированы на английском языке)
...
- Исправлена проблема, из-за которой пользовательские Prompts были неэффективны при использовании слишком большого их количества.
...
- Исправлена проблема, из-за которой перевод не удавался при переключении пользовательских prompt слов OpenAI под кнопкой теста
...
- В панели больше опций теперь поддерживается [вход для перевода текста](https://app.immersivetranslate.com/text/)
...
- **Исправлен перевод классического китайского языка:** Исправлена функциональность перевода классического китайского языка в Microsoft и OpenAI.
- **Оптимизация перевода на японский язык:** Дальнейшая оптимизация перевода на японский язык в OpenAI для улучшения точности и плавности.
...
- Исправлено: Проблема, из-за которой переключение сервисов перевода не вступало в силу, когда страница еще не была переведена.
...
- Исправлены проблемы с загрузкой расширенного PDF
...
- Поддержка наведения мыши, повторное нажатие Ctrl для отображения оригинального текста
...
- Исправлено: переключатель UI параметров перевода сервисов ввода состояния не изменился.
...
- Исправление: форма параметров UI
- Исправление: запрос Open AI
...
- Исправление: настройка перевода Azure, но все равно отображается (нужна настройка)
...
- Исправление: синхронизация Google Drive на родном firefox android.
...
- Исправление дублирования перевода для встроенных элементов с элементом кода.
- Исправление проверки неизвестных тегов в строке/блоке
...
- Исправление проблемы загрузки Google Drive (действительно) [#81](https://github.com/immersive-translate/immersive-translate/issues/81)

## 0.2.49

- Удаление ярлыков alt+d, alt+s, так как они могут конфликтовать с родными ярлыками.
- Исправление проблемы загрузки Google Drive [#81](https://github.com/immersive-translate/immersive-translate/issues/81)
...
- Исправление переключения маски userscript с сенсорным событием.
...
- Исправление бокового нижнего колонтитула для области тела
...
- Улучшение всплывающего интерфейса
...
- Исправление выбора всплывающего окна не настроенного сервиса, переход на страницу опций.
...
- Удаление бокового контейнера в качестве контейнера перевода.
...
- Исправить исключение элементов mark
...
- Исправить ошибку версии Chrome/Edge Store.
- Исправить
...
- Исправить перевод содержимого поста мобильного reddit.
