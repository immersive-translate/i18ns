...
- Исправлено: Проблема с переводом при наведении, не работающая в режиме "Сначала перевод, затем оригинальный текст".
...
- Оптимизировано: Увеличена скорость пользовательского скрипта.
...
- Новое: Теперь доступен бесплатный перевод изображений (в настоящее время поддерживается только в версиях браузеров Chrome и Edge для ПК), доступный через контекстное меню.
- Исправлено: Решена проблема, когда некоторый контент пропускался во время многосегментного перевода в Gemini.
...
- Добавлено: Профессиональные члены теперь могут напрямую использовать модель **Zhipu 4 Plus**.
...
- Добавлено: **AI Context-Aware Translation** может улучшить точность перевода профессионального контента. (Доступно только для профессиональных членов, поддерживается исключительно моделями OpenAI) **Options** -> **Grneral** -> **Enable AI Context-Aware Translation**
...
- Добавлено: Перевод **Subtitles Translation** в реальном времени теперь поддерживает активацию через "плавающий шар", доступный на Zoom, Google Meet и Microsoft Teams.
...
- Исправлено: Проблема с горячими клавишами **Enhanced input**, не срабатывающими.
...
- Исправлено: Проблема перевода пробельных символов в формате rich text [#2175](https://github.com/immersive-translate/immersive-translate/issues/2175)
- Улучшено: Улучшение ввода и функциональности наведения мыши в встроенных iframes на веб-страницах

## 1.10.2 (2024-10-11)

- Добавлено: Перевод изображений (бета-версия)
- Добавлено: Режим принудительного включения поддержки мыши (включайте эту функцию только если функция наведения мыши недоступна на планшетных устройствах) **Настройки** -> **Расширенные настройки** -> **Forece Enable Mouse Support**
- Добавлено: Отображение сообщения об ошибке при неудаче перевода субтитров видео
- Исправлено: Проблема перевода rich text [#2163](https://github.com/immersive-translate/immersive-translate/issues/2163)
...
- Удалено: Модель "SiliconCloud" qwen1.5-7B-chat (в связи с официальным прекращением поддержки)
- Исправлено: Решена проблема совместимости входа с плагином Safari на macOS 15

## 1.9.7 (2024-09-20)

- Улучшена поддержка ввода для Baidu, Gmail и других полей ввода
- Поддержка заголовка запроса anthropic-dangerous-direct-browser-access для Claude Anthropic API
- Поддержка загрузки субтитров с Hulu, Bloomberg и Domestika видео
...
- Исправлена проблема, когда [Расширенные настройки -> Минимальное количество символов, необходимых для перевода абзаца] не действовали в некоторых случаях

## 1.8.4 (2024-08-30)

- Сервис перевода DeepL теперь официально поддерживает традиционный китайский как целевой язык (ранее перевод на традиционный китайский с помощью DeepL включал дополнительный процесс преобразования с упрощенного на традиционный китайский).
...
- Добавлена опция "Сообщить о проблемах перевода текущей веб-страницы" и опция "Быстро включить/выключить плавающий шар" в дополнительных опциях панели.
- После регулировки положения двуязычных субтитров на YouTube система автоматически запомнит новое положение.
- Оптимизирована логика кэширования плагина, теперь автоматически очищая данные кэша, которым более 30 дней.
...
- Теперь вы можете быстро сообщать о проблемах перевода веб-страниц в плавающем шаре immersive translation. После перевода веб-страницы, если есть какие-либо проблемы, вы можете нажать кнопку [Обратная связь] на правой стороне плавающего шара, заполнить описание проблемы, и мы решим ее как можно скорее.
...
- Предоставлено больше статей arXiv с оптимизированной двуязычной компоновкой перевода
...
- Исправлены проблемы перевода со скриптом Tampermonkey SiliconCloud
...
- После выбора текста, контекстное меню изменится на [Перевести текст], нажав на которое вы можете автоматически перейти на страницу перевода текста Immersive Translation
...
- Новая кнопка обратной связи для перевода манги (после перевода манги нажмите кнопку [Обратная связь] на правой стороне плавающего шара, чтобы оставить отзыв о качестве перевода).
...
- Поддержка настройки пользовательских AI экспертов, вход находится внизу страницы [Настройки]->[AI Expert].
...
- Двуязычные субтитры YouTube теперь поддерживают интеллектуальное разбиение предложений (бета) (только при ручном включении immersive translation субтитров YouTube в [Настройки] - [Видео субтитры], и оригинальные субтитры видео являются автоматически сгенерированными английскими субтитрами)
...
- Когда AI эксперты используются для "Интеллектуального выбора", разные AI эксперты могут быть настроены для разных веб-сайтов. Это можно настроить в [Настройки] -> [AI Experts] -> [Введите любого эксперта].
...
- Новая функция: AI translation поддерживает [Doubao large model](https://www.volcengine.com/product/doubao)
- Новая функция: Поддержка режима двуязычного сравнения с переводом в первую очередь и оригинальным текстом после, который можно включить на странице настроек -> расширенные настройки.
...
- Двуязычные субтитры на YouTube поддерживают настройки шрифта и веса шрифта
...
- Исправлена проблема, когда изменения в общем экспертном prompt переопределяли указанный AI экспертный prompt [#1692](https://github.com/immersive-translate/immersive-translate/issues/1692)
...
- Исправлено несоразмерное масштабирование размера шрифта, когда YouTube находится в полноэкранном режиме [#1681](https://github.com/immersive-translate/immersive-translate/issues/1681)
...
- Добавлена кнопка сброса стиля субтитров на Youtube, которая может быстро восстановить стиль по умолчанию.
...
- Исправлена проблема, когда двуязычные субтитры на YouTube не могли быть отрегулированы вверх и вниз в полноэкранном режиме [#1654](https://github.com/immersive-translate/immersive-translate/issues/1654)
- Поддержка двуязычных субтитров для [VK Video](https://vk.com/video)
- Поддержка независимых настроек активации для двуязычных субтитров видео на YouTube (включено по умолчанию для новых пользователей)
...
- Контроль стиля субтитров на YouTube поддерживает стилизацию краев
...
- Исправлена проблема слияния пользовательских правил
...
- Страница настроек теперь поддерживает корректировки [стилей субтитров на YouTube](https://dash.immersivetranslate.com/#subtitle).
...
- Исправлена проблема, когда перевод не удавался при переключении пользовательских prompt слов OpenAI под тестовой кнопкой
- Исправлена проблема, когда значок ярлыка субтитров на YouTube не отображался
- Оптимизировано распознавание языка расширения

## 1.4.6

- Исправлена проблема, когда пользовательские prompt слова были неэффективны
- Добавлены опции 50%, 150% для размера шрифта субтитров на Youtube

## 1.4.5

- Исправлена проблема, когда изменения стилей субтитров на Youtube не сохранялись
...
- Значительно оптимизирована скорость перевода субтитров на Youtube, добавлена поддержка переключения между китайским и английским порядком, настройки цвета и размера шрифта и т.д.
...
- Переводческий сервис Gemini скрыт по умолчанию, его можно включить в настройках разработчика для отображения бета-версии этого переводческого сервиса
...
- Поддержка платформы для субтитров видео [DeepLearning.ai](https://learn.deeplearning.ai)
- Поддержка перевода веб-страниц и субтитров видео на такие языки, как арабский, иврит и др., с учетом проблем отображения RTL (справа налево)
...
- Исправлена поддержка полноэкранного воспроизведения YouTube в приложении immersive iOS.
...
- Добавлена поддержка новой настройки ярлыков, позволяющей быстро переключать, используют ли субтитры видео встроенные субтитры машинного перевода
- На сайте Sci-Hub нажатие на плавающий шар переведет PDF, встроенные в веб-страницу

## 1.1.6

- **Поддержка перевода конкретных абзацев на мобильных устройствах:** Мобильная версия теперь поддерживает перевод указанных абзацев и добавила различные ярлыки, включая смахивание влево, смахивание вправо, двойное нажатие, тройное нажатие и жесты с несколькими пальцами. Эти функции не включены по умолчанию и требуют, чтобы пользователь активно выбрал жест срабатывания на странице настроек в разделе [Наведение мыши].
- **Обновление версии по умолчанию для Gemini:** Версия по умолчанию теперь `v1beta`.
- **Исправление перевода классического китайского языка:** Исправлена функциональность перевода классического китайского языка Microsoft и OpenAI.
- **Оптимизация японского перевода:** Дальнейшая оптимизация японского перевода OpenAI для улучшения точности и беглости.
- **Иммерсивный переводческий опыт:** Чтобы лучше адаптироваться к пользовательским привычкам, мы переместили ярлык для двуязычных субтитров в полноэкранном режиме на платформе YouTube в левую часть.
...
- **Интегрированный вход для перевода документов:** Теперь вы можете переводить PDF, ePub и файлы субтитров через единый вход для загрузки. Просто нажмите кнопку [PDF/ePub] на панели всплывающего окна, больше не нужно выбирать [Еще].
...
- **Настройки горячих клавиш**: Добавлено новое верхнеуровневое меню "Горячие клавиши" и следующие настраиваемые функции горячих клавиш:
...
- **Руководство для новых пользователей**: Когда новые пользователи впервые открывают страницу на нецелевом языке, отображается пузырь помощи с плавающим шаром.

### Оптимизация и исправления

- **Оптимизация пользовательского интерфейса**: Переработан пользовательский интерфейс для сообщений об ошибках перевода страницы, чтобы сделать их более понятными. Когда ошибок много, всплывающее окно активно уведомляет пользователя.
...
- **openAI Configuration Update**: Теперь поддерживает установку количества конфигураций в секунду в десятичных дробях, например, 0.5, что означает 1 запрос каждые 2 секунды.
...
- Исправлено: Проблема с сшивкой длинных абзацев в OpenAI в некоторых случаях. [#1276](https://github.com/immersive-translate/immersive-translate/issues/1276)
...
- Исправлено: Проблема, когда кэш все еще существует после изменения запроса/модели в OpenAI.
...
- Исправлена проблема дрожания при нажатии на панель действий шарика наведения на странице Firefox.
...
- Когда вы включаете двуязычные субтитры на панели, сначала страница автоматически обновляется (чтобы более точно отображать двуязычные субтитры), и на некоторых сайтах пользователям все еще нужно вручную нажать кнопку "CC" на сайте, чтобы включить субтитры.
- Оптимизация Grease Monkey, обнаружение языка Safari.
- Предоставляет быстрый доступ к двуязычным версиям всех статей на сайте [Arxiv](https://arxiv.org/abs/1910.06709).
...
- Онлайн-страницы PDF без расширения .pdf теперь могут напрямую переходить на страницу перевода PDF, нажав на шарик наведения на странице.
...
- Изменено двуязычное совместное использование (режим обновления), добавленное в последней версии, на совместное использование снимков двуязычных страниц, чтобы общий контент был более оригинальным, а также более широкая адаптивность.
...
- Исправлено отсутствие реакции при нажатии на шарик наведения онлайн PDF.
...
- Решена проблема, когда некоторые платформы не могли распознать, поддерживается ли мышь.
  - Некоторые настольные браузеры поддерживают как сенсорный экран, так и мышь, и Immersive Translate технически не может определить, поддерживает ли такая платформа мышь, поэтому мы добавили опцию [Принудительно включить поддержку мыши] в настройках [Наведение мыши].
...
- Уменьшена длина запросов OpenAI с 90 до 40, что экономит еще больше трафика.

## 0.11.0

- Исправлены дрожащие клики на шарике наведения страницы.
...
- Исправлен конфликт субтитров YouTube с плагином Dual subtitle (перевод субтитров YouTube в Immersive Translate не включен, когда обнаружен плагин Dual subtitle YouTube, чтобы избежать конфликта).
...
- Увеличение приоритета перевода тела для оптимизации опыта перевода
- Исправлена проблема, когда при нажатии на ins больше текста не переводилось
...
- Исправление автоматического перевода при выделении readwise
...
- Оптимизация обнаружения улучшения ввода для уменьшения ложных касаний
...
- Оптимизация скорости экспорта только перевода PDF, если вы выберете экспорт только перевода, вы можете напрямую вызвать системный PDF-просмотр для экспорта, быстрее.
- Deeplx поддерживает несколько URL, просто разделите их с помощью .

## 0.9.2

- Инструмент перевода PDF перенесен в онлайн-версию: https://app.immersivetranslate.com/pdf/ , чтобы Grease Monkey и Safari могли использовать перевод PDF, и проблемы можно было бы лучше итеративно решать без необходимости выпуска версии для решения проблемы.
...
- Поддержка PDF для загрузки только перевода
...
- Бета-функции: Пользовательский API (включен в настройках разработчика)
...
- Перевод PDF с новыми опциями для быстрого контроля стиля перевода (PDF файлы очень странные, и включение этих опций может быть полезно для некоторых PDF файлов с беспорядочным форматированием)
- Версии для iOS и macOS снова в Apple Store Country Store
...
- Исправление: проблема перевода всех регионов Gmail
...
- Наконец-то PDF поддерживает экспорт двуязычных версий! Вы можете нажать кнопку [Сохранить], чтобы экспортировать переведенный двуязычный PDF файл.
...
- Добавление изменения статуса значка браузера, когда веб-страница была переведена, в нижнем правом углу значка браузера автоматически добавляется ✅.
...
- Поддержка перевода результатов улучшенного ввода ctrl+z Отмена
...
- Поддержка улучшения поиска, когда включено, при поиске в Google/Google News на китайском языке, в правой колонке автоматически отображаются результаты поиска соответствующих английских ключевых слов, что включено по умолчанию.
  - Причина: Мы обнаружили, что в поиске Google результаты поиска для китайских и английских ключевых слов могут сильно различаться, с включенным улучшением перевода поиска, мы автоматически ищем те же ключевые слова на английском языке для вас и отображаем их справа. Вы можете отключить его, если не нуждаетесь в этой функции.
...
- Выравнивание выпадающего окна Windows по левому краю
- Поддержка традиционного китайского и упрощенного китайского

## 0.6.13

- Исправление проблемы повторного перевода при наведении мыши
- Поддержка перевода PDF с перетаскиванием для изменения размера и редактирования содержимого перевода
...
Язык по умолчанию для перевода в поле ввода теперь может опустить пробел, т.е. //Hello World также может быть переведено.
...
- Исправление проблемы, когда изображения на некоторых веб-страницах: становятся больше после копирования
- Исправление: раздел комментариев medium не переводится
- Исправление проблемы, когда изображения на некоторых страницах: копируются неправильно

## 0.5.12

- Feature: Стиль перевода с разделительной линией добавляет вертикальную разделительную линию для переводов одной строки
- Fix: Очень редкие случаи разбиения абзацев.
- Отличная страница ориентации для первого запуска для новых пользователей iOS.

## 0.5.11

- Поддержка перевода субтитров только для экспорта переводов
- Fix: Некоторые элементы не распознаются при наведении мыши
- Fix: частичные разрывы строк в твитах не распознаются
- Fix: стиль создания eBook не работает

## 0.5.10

- Fix: разрывы строк в твитах не распознаются
- Fix: страница деталей Reddit возвращает некоторые абзацы, которые не могут быть переведены
- Исправлена проблема: некоторые теги Code не распознавались правильно.

## 0.5.9

- Исправлены разрывы абзацев в некоторых случаях на:
- Fix: Tampermonkey Toggle показывает только переводы
- Fix: проблема с работой стиля онлайн-чтения eBook
...
- Fix: проблема с новым всплывающим окном вкладки в macOS.
- Feat: Новая страница руководства для нового пользователя.

## 0.5.5

- Fix: проблема с областью наведения мыши.

## 0.5.4

- Fix: дублирование страницы Spa

## 0.5.3

- Fix: слушатель горячих клавиш наведения мыши.
- Fix: перевод PDF-документа
- Feat: Добавить новую страницу руководства для клиента

## 0.5.2

- Fix: настройки горячих клавиш наведения мыши в userscript

## 0.5.1

- Fix: OpenAI API не работает.

## 0.5.0

- Feat: Перевод текущего абзаца при наведении мыши.
- Feat: Рефакторинг перевода PDF, теперь вы можете переводить большинство PDF с Immersive Translate
- Fix: Отключение контекстного меню не работает [#428](https://github.com/immersive-translate/immersive-translate/issues/428)
- Fix: Избегайте Content Security Policy для [Mastondon](https://mastodon.social/)

## 0.4.11

- Fix: разрешение userscript (только для userscript).

## 0.4.8

- Feat: Bing Translate на Microsoft Translate для более стабильного качества.
- Fix: Чистая TXT веб-страница, как [эта](https://edoras.sdsu.edu/~vinge/misc/singularity.html)
- Производительность: Исключение некоторых дочерних рекламных страниц на сайте, и производительность немного улучшилась

## 0.4.7

- Fix: отсутствует всплывающее окно Userscript в Firefox.

## 0.4.6

- Feat: Разрешить сторонним отправлять событие документа для вызова `toggleTranslatePage`
- Feat: iOS приложение добавляет кнопку включения расширения и ссылку на сообщества
- UI: Модель поля настроек OpenAI использует выбор вместо текстового поля ввода.

## 0.4.5

- Fix: проблема с расширением safari в iOS 15.0.
- Fix: горячие клавиши расширения safari в macOS
- Fix: всплывающее окно политики безопасности контента для расширения и частично для userscript.

## 0.4.4

- Chore: Удалить console.log

## 0.4.3

- Fix: обнаружение пробелов в тегах sup, sub.
- Feat: поддержка ChatGPT Plus Website в качестве службы перевода, это бета-функция, поэтому вы можете получить к ней доступ, включив Beta Feature в настройках разработчика. Это очень медленно, потому что chatgpt может отправлять только один запрос за раз. Убедитесь, что у вас есть ChatGPT Plus Account, потому что на бесплатном аккаунте больше ограничений, и я не уверен, несет ли это риск для вашего аккаунта, будьте осторожны, чтобы убедиться, что у вас есть ChatGPT Plus Account, потому что на бесплатном аккаунте больше ограничений, и я не уверен, несет ли это риск для вашего аккаунта, будьте осторожны при использовании.

## 0.4.1

- Fix: контекстное меню firefox исчезает после перезапуска.
- Поддержка Azure openai

## 0.4.0

- Feat: Поддержка перевода локального файла субтитров (.srt,.ass и т.д.)

## 0.3.17

- Feat: Поддержка перевода локального .txt файла.
- Fix: Контекстное меню может быть недоступно иногда. [#273](https://github.com/immersive-translate/immersive-translate/issues/273)

## 0.3.16

- Fix: сохранить &nbsp; как пробел.
- Удалить: Удалить Papago, так как [сервис не работает](https://github.com/immersive-translate/immersive-translate/issues/310)
...
- Зависимость: Обновить pdf.js до последней версии
- Fix: цвет фона выделения pdf
- Fix: обнаружение пробелов

## 0.3.13

- Fix: проблема с определенными символами в конструкторе eBook, например, некоторые пути к главам `xxx' xxxx`.
- UI: свернуть пользовательские опции openai по умолчанию.
- UI: Добавить статус экспорта для экспорта epub.
- Fix: Gpt4 стандартный запрос

## 0.3.12

- Feat: Теперь мы можем настраивать цвет фона темы перевода маркера.
- Fix: postMessage при инициализации страницы ломает некоторые сайты, теперь мы будем делать это только тогда, когда действительно переводим страницы
- Fix: проблема с прогрессом eBook.
- Fix: лучше для разбиения длинного абзаца, 1.5 миллиарда, 25.5%, Mr. не будут считаться границей

## 0.3.11

- Fix: цвет текста в темном режиме eBook reader
- Fix: openAI запрос

## 0.3.10

- Лучше: обнаружение контейнера на японском/корейском языке.
- Fix: Прогресс создания eBook остановился на 99%.

## 0.3.9

- Fix: состояние ввода переключения служб перевода в UI Options не изменилось.

## 0.3.8

- UI: цвет загрузки более прозрачный
- Fix: Обнаружение языка eBook.
- Feat: Добавить прогресс перевода для конструктора eBook и красивый конфетти после успеха.
- Feat: Добавить повтор всех неудачных абзацев для кнопки повторного запроса.
- Fix: Обработка ошибок Deepl

## 0.3.7

- Fix: eBook reader не может загружать изображения в Chrome.
...
- Fix: экспорт eBook в userscript
- Feat: добавить пользовательскую конечную точку API для OpenAI
- Feat: добавить временные параметры времени перевода сайта в "Расширенные настройки"
...
- Fix: конструктор eBook для Kindle
- Изменение: цвет значка загрузки, с черного на синий, для адаптации к темной теме веб-страницы.
- Feat: Поддержка локального html перевода для расширения

## 0.3.2

- Fix: перемещение курсора ввода в форме Options.
- Feat: OpenAI поддержка пользовательского apiUrl для настроек разработчика.

## 0.3.1

- Feat: обновить темный значок на прозрачность.
- Fix: Неправильный порядок для длинного абзаца
...
- Feat: Поддержка темного значка для firefox

## 0.2.86

- Добавить опцию максимальной длины текста для каждого запроса с Open AI
- Fix: дублирование идентификатора eBook
- Feat: Поддержка перевода txt веб-страниц

## 0.2.85

- Fix: некоторые файлы epub не могут быть найдены.

## 0.2.84

- Feat: Поддержка eBook Reader и Maker

## 0.2.83

- Feat: Разрешить форму ввода пароля показывать пароль.

## 0.2.82

- Fix: Некоторые сайты используют `span` для стилей, поэтому мы используем `font` вместо span для обертки цели перевода
- Fix: Ограничение максимальных токенов OpenAI, изменение максимальных символов с 1500 до 1300.

## 0.2.81

- Исправление: m.youtube.com
- Исправление: options form UI
...
- Исправление: высокое использование памяти для userscripts и расширений (удаление opencc zh-CN в zh-TW, вместо этого с Google translate)
- Исправление: Relingo [#159] (https://github.com/immersive-translate/immersive-translate/issues/159)
- Исправление: настройка Azure translate, но все еще отображается (требуется настройка)
...
- Исправление: советы по горячим клавишам во всплывающем окне
...
- Новая функция: Поддержка zh-CN в zh-TW для Deepl
...
- Исправление: соответствие URL с несколькими \*
...
- Попытка исправить кодировку deepl api
...
- Исправление ошибки синхронизации userscript google drive.
...
- Исправление проблемы загрузки в google drive (действительно) [#81](https://github.com/immersive-translate/immersive-translate/issues/81)

## 0.2.49

- Удаление горячих клавиш alt+d, alt+s, так как они могут конфликтовать с родными горячими клавишами.
- Исправление проблемы загрузки в google drive [#81](https://github.com/immersive-translate/immersive-translate/issues/81)
...
- Исправление: caiyun перевод не определен исходный язык

## 0.2.44

- Исправление: userscript переключение маски
- Исправление логики переключения маски

## 0.2.43

- Исправление: userscript переключение маски с событием касания.
- Исправление скорости (удаление sleep(300))

## 0.2.42

- Исправление: маска при наведении при повторном переключении маски.
- Добавление горячих клавиш для маски на мобильных устройствах
- Исправление проблемы синхронизации userscript с облаком
- Перемещение страницы расширенных опций в левое меню.
- Добавление логики повторной попытки к сервису перевода

## 0.2.41

- Исправление: userscript niu перевод
- Исправление: xhtml перевод

## 0.2.40

- Исправление: отображение бета-функции
- Исправление: страница настроек всплывающего окна на новой вкладке
- Исправление: замена placeholder перевода

## 0.2.39

- Поддержка горячих клавиш для отображения маски перевода
...
- Исправление aside footer для области body
...
- Поддержка userscript inline перевода в iframe.
...
- Поддержка inline перевода в iframe. (Только для расширения, недоступно для
  userscript)
...
- Поддержка перевода в iframe, как QQ mail, встроенный твит.
...
- Исправление онлайн перевода pdf на firefox
...
- Исправить отметку исключенных элементов
- Исправить проверку типов deno
- удалить importmap
- Исправить перевод контекстных меню
- восстановить страницу, когда включена опция "никогда не переводить этот сайт"
- Добавить описание для добавления URL

## 0.2.8

- Определение языка пользовательского агента для интерфейса
- Исправить ошибку переноса строки.

## 0.2.7

- Исправить запрос grease monkey

## 0.2.6

- Исправить
  [#30](https://github.com/immersive-translate/immersive-translate/issues/30),
  проблему сопоставления URL файла

## 0.2.5

- увеличить версию для теста ci

## 0.2.4

- поймать ошибку соединения сообщения для всплывающего окна.
...
- Исправить PDF образец файла
- Исправить локальный файл pdf в Firefox
- Исправить сочетания клавиш pdf

## 0.2.1

- Поддержка менеджера сочетаний клавиш Grease Monkey.
- Исправить регулярное выражение сопоставления
- Исправить комментарии на youtube.
- Исправить мобильную компактную версию reddit
- Исправить проблему перевода полного текста

## 0.2.0

- Исправить PDF с двумя колонками.
- Исправить ошибку версии в Chrome/Edge Store.
- Исправить
  [#21](https://github.com/immersive-translate/immersive-translate/issues/21)

## 0.1.2

- Опубликовать в дополнении Firefox
- Опубликовать в Edge
- исправить отступы pdf.
- Изменить образец файла pdf

## 0.0.62

- Исправить формат pdf, отступы.
- Исправить изменение элемента telegra.ph

## 0.0.61

- Исправить закрытие элемента span.
- Исправить разрешения для ранних браузеров

## 0.0.60

- Исправить PDF в Chrome
...
- Редактировать описание темы перевода

## 0.0.57

- Изменить интерфейс всплывающего окна для более удобного использования

## 0.0.56

- Исправить тайм-аут в chrome
- Исправить ошибку разделения предложения.

## 0.0.55

- Исправить отображение элемента с none.
- рефакторинг отметки элемента
...
- использовать sendMessage вместо connect, так как chrome отключает порт через
  5 минут
- лучше для обнаружения контейнеров текста

## 0.0.52

- Не переводить абзац, который содержит только элементы-заполнители, например,
  [пример](https://github.com/nank1ro/solidart), первая строка.
- Лучше для обнаружения дочерних элементов.

## 0.0.51

- Исправить проблему кэша
...
- Исправить размер шрифта в интерфейсе опций

## 0.0.50

- Исправить перевод блоков img.

## 0.0.49

- Исправить расширение firefox

## 0.0.48

- Исправить расширение chrome

## 0.0.47

- переписать сообщение с фоном, использовать connect вместо sendMessage
- добавить поддержку мобильного reddit
- исправить предварительный пробел для некоторых статей

## 0.0.46

- Форматировать метаинформацию userscript

## 0.0.45

- userscript использовать один файл.
- добавить тайм-аут для запроса кэша

## 0.0.44

- Исправить ошибку разделения tencent.
- Исправить ошибку элемента inline sup.
- Лучше для twitter

## 0.0.43

- Исправить tweet br
- Исправить глобальный перевод.

## 0.0.42

- Исправить тег BR
- обрабатывать блочные теги по правилам

## 0.0.41

- Исправить проверку inline элемента
- Добавить опцию журнала отладки для разработчиков

## 0.0.39

- Исправить переводческую службу, содержащую mock2

## 0.0.38

- Поддержка кэширования результата для userscript
- Добавить интерфейс опций
- Поддержка обнаружения большего количества контейнеров контента

## 0.0.37

- Исправить изменение службы перевода во всплывающем окне
- Исправить перевод содержимого мобильного поста reddit.

## 0.0.36

- Исправить специальные символы Wikipedia
  [#6](https://github.com/immersive-translate/next-immersive-translate/issues/6)
- Исправить размер значка userscript.
- включить все сайты для обнаружения языка абзаца.

## 0.0.35

- Исправить переход на следующую страницу на youtube
- Поддержка страницы поиска на Youtube.
- Исправить переключатель расширенных опций.
- Исправить тег img, скрытый тег
  [#5](https://github.com/immersive-translate/next-immersive-translate/issues/5)
- Исправить принудительное обновление поиска Google
  [#4](https://github.com/immersive-translate/next-immersive-translate/issues/4)
- Поддержка табличного результата Google
  [#3](https://github.com/immersive-translate/next-immersive-translate/issues/3)
- Исправить пустоту Wikipedia
...
- Поддержка установки режима немедленного перевода, чтобы вы могли переводить веб-страницу
  как можно быстрее.
- Поддержка установки области страницы, которую нужно перевести, чтобы вы могли перевести больше областей.
- Поддержка установки первого x количества текста для немедленного перевода.
- Исправить дублирование перевода при изменении перевода
...
- Исправить перевод локального файла после сохранения. Исправлено
  [#1](https://github.com/immersive-translate/next-immersive-translate/issues/1)
- Добавить dist js файл в публичный репозиторий

## 0.0.31

- Поддержка перевода всей страницы
- Поддержка немедленного перевода страницы
- Больше конфигураций интерфейса
- Отражение темы
- Добавить новый значок
- Добавить новую тему перевода dashedBorder

## 0.0.30

- Улучшение для темы с пунктиром

## 0.0.29

- Исправить допустимость абзаца.
- Добавить темы dotted, thinDashed
- Улучшение для тем с пунктиром и выделением

## 0.0.28

- Исправить подчеркивание
- Добавить темы dashed, paper
- Исправить обнаружение заголовка
...
- Исправить разрешение на подключение volc alpha userscript.
- Исправить кликабельность версии.

## 0.0.25

- Поддержка selectorMatches, чтобы мы могли теперь сопоставлять все manstondon.
- Исправить ошибку userscript в Firefox.

## 0.0.23

- Улучшение для обнаружения китайского языка
- Исправить проблему innerText в reddit

## 0.0.22

- Поддержка deeplx
- Исправить множественный перевод при переключении службы

## 0.0.21

- Исправить некоторые теги span, являющиеся блочными элементами
