...
- Добавлено: Браузер Android поддерживает бесплатный перевод изображений.
...
- Улучшено: Форматирование бесплатных изображений.
...
- Добавлено: Режим принудительного включения поддержки мыши (включайте эту функцию только в случае недоступности функции наведения мыши на планшетных устройствах) **Настройки** -> **Расширенные настройки** -> **Принудительное включение поддержки мыши**
- Добавлено: Отображение сообщения об ошибке при неудаче перевода субтитров видео
- Исправлено: Проблема с переводом форматированного текста [#2163](https://github.com/immersive-translate/immersive-translate/issues/2163)
- Улучшено: Решены проблемы, когда кнопка перевода могла не работать при переводе PDF
- Улучшено: Улучшена визуализация переведенных формул
...
- Теперь вы можете быстро сообщать о проблемах с переводом веб-страниц в плавающем шаре погружающего перевода. После перевода веб-страницы, если есть какие-либо проблемы, вы можете нажать кнопку [Обратная связь] на правой стороне плавающего шара, заполнить описание проблемы, и мы решим ее как можно скорее.
...
- В настройках горячих клавиш теперь можно назначать уникальные горячие клавиши для любого сервиса перевода
- Оптимизировано обнаружение переводов статей arXiv

## 1.7.9

- Исправлены проблемы с переводом форматированного текста для сервисов перевода, таких как Google, DeepL (например, страницы, напрямую отображающие `<button>` и т.д.)
...
- После выбора текста, контекстное меню изменится на [Перевести текст], нажав на которое вы автоматически перейдете на страницу перевода текста погружающего перевода
- Новый бесплатный сервис перевода для больших моделей: SiliconCloud, доступен для всех пользователей.
...
- Поддержка настройки пользовательских AI экспертов, вход находится внизу страницы [Настройки]->[AI Эксперт].
...
- Двуязычные субтитры на YouTube теперь поддерживают интеллектуальное разделение предложений (бета) (только при ручном включении погружающего перевода субтитров YouTube в [Настройки] - [Видео субтитры], и оригинальные субтитры видео являются автоматически сгенерированными английскими субтитрами)
...
- Новая функция: перевод манги (Beta), на поддерживаемых сайтах манги кнопка перевода манги появится под плавающим шаром быстрого перевода на веб-странице. Нажатие на нее активирует перевод манги. Эта функция доступна для Pro участников (500 страниц в месяц, можно приобрести дополнительные пакеты), в настоящее время поддерживаются следующие сайты:
...
- Поддержка AI переводческих сервисов для установки [AI Expert] для указания стратегии перевода, в настоящее время это функция Beta, которую можно включить в [Настройки разработчика](https://dash.immersivetranslate.com/#developer) после включения Beta, и меню [AI Expert] будет видно после обновления.
...
- Переводческий сервис Gemini скрыт по умолчанию, его можно включить в настройках разработчика для показа бета-версии этого переводческого сервиса

## 1.3.4

- Поддержка бесплатного переводческого сервиса Yandex
- Оптимизированы prompt слова Gemini
- Поддержка настройки видео субтитров для двуязычного/оригинального и перевода
...
- Недавние запросы к службе перевода Microsoft из Китая были нестабильны; при возникновении ошибок система автоматически обнаруживает доступную в данный момент службу перевода, позволяя пользователям быстро переключаться.
...
- Добавлена поддержка новой настройки ярлыков, позволяющей быстро переключать использование встроенных машинных переводов субтитров для видео
...
- **Оптимизация японского перевода:** Дальнейшая оптимизация японского перевода OpenAI для повышения точности и плавности.
- **Иммерсивный опыт перевода:** Для лучшей адаптации к пользовательским привычкам мы переместили ярлык для двуязычных субтитров в полноэкранном режиме на платформе YouTube в левую часть.
...
- Добавлено: Поддержка двуязычных субтитров для учебной платформы [ArtStation](https://www.artstation.com/learning) и [ZDF](https://www.zdf.de/).
...
- Исправлено: оригинальные субтитры видео не отображаются, когда "Текущий сайт настроен на никогда не переводить".
- Исправлено: конфликт с некоторыми плагинами, вызывающий бесконечное повторное открытие страницы.
...
- Исправлена проблема с дрожанием при нажатии на панель действий шарика наведения на странице Firefox.
- Поддержка сотрудничества на сайте pubmed.ncbi.nlm.nih.gov и плагине scholarscope.
- Исправлена проблема с дрожанием страницы перевода в поле ввода Reddit.
...
- Оптимизация проблем с инициализацией PDF-файлов.
...
- Исправлено: эмодзи в конце поля ввода Twitter не переводятся.
- Исправлено: ситуация, когда контент сторонних плагинов переводится в некоторых сценариях.
- Исправлено: онлайн-клик по шарикам наведения PDF не реагирует.
...
- Исправлено: дрожание кликов по шарикам наведения на странице.
...
- Поддержка настройки кнопок быстрого перевода шариков наведения (поддержка как для ПК, так и для мобильных устройств).
- Оптимизация определения языка Grease Monkey.
- Исправление перевода файлов txt.
...
- Исправлена проблема, когда локальные файлы txt не могут быть переведены.

## 0.10.5

- Исправлено: YouTube иногда возвращается на главную страницу.

## 0.10.4

- Исправлено: конфликт субтитров YouTube с плагином Dual subtitle (перевод субтитров YouTube в Immersive Translate не включен, когда обнаружен плагин YouTube Dual, чтобы избежать конфликта).
...
- Исправлено: проблема с переводом пользовательского ключа аутентификации DeppL.
...
- Мы были уведомлены Apple, что OpenAI Translations временно удален из iOS и macOS, и мы пытаемся перезапустить его в Китае.
...
- Оптимизация проблемы ограничения скорости запросов OpenAI
...
- Улучшение для плохих подсказок userscript
...
- Поддержка установки режима немедленного перевода, чтобы веб-страница могла переводиться
  как можно быстрее.
