...
- Добавлено: Поддержка перевода с использованием большой модели Youdao Ziyue.
...
- Исправлено: После переключения переводческих сервисов сервис перевода в "**Enhanced Input Box**" не обновляется.
...
- Улучшено: Обновлен интерфейс выпадающего списка сервиса перевода в панели.
...
- Исправлено: Проблема с переводом пробельных символов в формате rich text [#2175](https://github.com/immersive-translate/immersive-translate/issues/2175)
...
- По умолчанию система будет запоминать режим, переключенный нажатием на иконку в панели для двуязычного сравнения или только перевода. Для временного переключения нажмите "More" -> "Switch to translation-only display" в панели.
...
- Исправлена проблема, когда [Advanced Settings -> Минимальное количество символов, необходимых для перевода абзаца] не срабатывало в некоторых случаях

## 1.8.4 (2024-08-30)

- Сервис перевода DeepL теперь официально поддерживает традиционный китайский как целевой язык (ранее перевод на традиционный китайский с помощью DeepL включал дополнительный процесс конверсии с упрощенного на традиционный китайский через сторонний сервис).
- Оптимизирована производительность перевода rich text.

## 1.8.3

- Google Meet теперь поддерживает двуязычные субтитры для живых встреч: теперь вы можете наслаждаться функцией двуязычных субтитров на встречах Google Meet. Просто откройте ссылку на встречу, активируйте двуязычные субтитры в панели immersive translation, а затем обновите страницу, чтобы воспользоваться этой функцией.
...
- Теперь вы можете переводить текст в полях ввода с помощью правого клика: выберите любой текст в поле ввода на веб-странице, кликните правой кнопкой мыши, чтобы выбрать перевод, и immersive translation автоматически переведет выбранный текст на целевой язык поля ввода, что удобно для быстрого перевода текста на родном языке в полях ввода на другие языки.
- Теперь вы можете быстро сообщать о проблемах с переводом веб-страниц в плавающем шаре immersive translation. После перевода веб-страницы, если возникают какие-либо проблемы, вы можете нажать кнопку [Feedback] справа от плавающего шара, заполнить описание проблемы, и мы решим ее как можно скорее.
...
- После выбора текста, меню правого клика изменится на [Перевести текст], кликнув на которое, вы можете автоматически перейти на страницу перевода текста Immersive Translation
...
- Двуязычные субтитры YouTube теперь поддерживают интеллектуальное разбиение предложений (бета) (только при ручном включении immersive translation субтитров YouTube в [Settings] - [Video Subtitles], и оригинальные субтитры видео автоматически сгенерированы на английском языке)
...
- Добавлена кнопка сброса для стиля субтитров на Youtube, которая может быстро восстановить стиль по умолчанию.
...
- Поддержка независимых настроек активации для двуязычных субтитров на YouTube (по умолчанию включено для новых пользователей)
- Оптимизированы сообщения об ошибках для перевода локальных двуязычных субтитров

## 1.4.11

- Совместимость с переводом в поле ввода на странице Bing Copilot
...
- Страница настроек теперь позволяет настраивать [стили субтитров на YouTube](https://dash.immersivetranslate.com/#subtitle).
...
- Исправлена проблема, когда перевод не удавался при переключении пользовательских prompt слов OpenAI под кнопкой теста
...
- В сервисе DeepL добавлена поддержка арабского языка.
- Сервис перевода Colorful Clouds теперь поддерживает корейский, испанский, французский и русский языки.
- В сервисе OpenAI добавлена поддержка северо-восточного китайского диалекта.
...
- Исправлена проблема отображения субтитров в Twitter на Safari.
...
- **Оптимизация перевода на японский:** Дальнейшая оптимизация перевода на японский в OpenAI для улучшения точности и плавности.
...
- Исправлена проблема с ярлыком двуязычных субтитров для YouTube, когда текст на английском языке был слишком длинным.
...
- Исправлена проблема дрожащего нажатия на панель действий шарика наведения страницы Firefox.
...
- Исправлена проблема с возвратом на главную страницу Youtube
...
- Исправлена проблема с не переводом текста при нажатии на "показать больше" в ins
...
- Исправление проблемы с автопрокруткой при онлайн-чтении epub на мобильных устройствах
...
- Исправлена проблема, что некоторые японские отрывки не переводятся.
...
- Поддержка улучшения поиска, при включении, когда вы ищете в Google/Google News на китайском языке, в правой колонке автоматически будут отображаться результаты поиска соответствующих английских ключевых слов, что включено по умолчанию.
...
- Исправление проблемы с не переводом некоторых книг в epub
...
- Исправление уменьшения изображений перевода Epub в некоторых браузерах
...
- Проблемы с нераспознаванием файлов субтитров в Safari
...
- Исправлена проблема, из-за которой двуязычные электронные книги не содержат изображения после экспорта
...
- Исправлена проблема, из-за которой изображения на некоторых веб-страницах: становятся больше после копирования
- Исправлено: раздел комментариев medium не переводится
- Исправлена проблема, из-за которой изображения на некоторых страницах: были скопированы неправильно
...
- Исправлена проблема с: где некоторые теги кода не распознавались правильно.
...
- Функция "Показать только переводы" здесь! Нажмите [More] -> [Switch to show translations only].

  - Поддержка настраиваемых ярлыков, настройка в интерфейсе -> Настройки ярлыков
...
- Поддерживаются все переводы веб-сайта ShadowRoot.
...
- Исправлена проблема, из-за которой изменение ярлыка наведения мыши требовало обновления страницы для вступления в силу

- Исправлена проблема с распознаванием разрывов строк в TXT-файлах.

- Много обновлений!

- Функция "Показать только переводы" прибыла! Нажмите "More" -> "Switch to Show Translations Only".

  - Поддержка настраиваемых ярлыков, которые можно настроить в "Настройки интерфейса" -> "Настройки ярлыков"
...
- Исправлено: настройки ярлыков наведения мыши для userscript
...
- Исправлено: всплывающее окно Firefox Userscript отсутствует.
...
- Исправлено: ярлыки расширения safari macOS
...
- Исправлено: переключение UI параметров ввода состояния службы перевода не изменилось.
...
- Изменение: цвет значка загрузки, с черного на синий, для адаптации к темной веб-странице.
...
- Исправлено: форма параметров UI
...
- Исправлено: проблема с сетью проверки сервиса перевода на firefox mobile.
...
- Попробуйте исправить кодировку api deepl
...
- Добавить заметки на страницу о
...
- Использовать последнюю версию esbuild
- Использовать последнюю версию deno
- CI: отправить исходный код в Firefox

## 0.2.51

- Исправлено: Google Auth требует входа в Chrome/Firefox
- Заменить ссылки на сервисы перевода
- Улучшено для разрешений.
- удалить минификацию.

## 0.2.50

- Исправлено: проблема с загрузкой Google Drive (действительно) [#81](https://github.com/immersive-translate/immersive-translate/issues/81)

## 0.2.49

- Удалить ярлыки alt+d, alt+s, так как они могут конфликтовать с родными ярлыками.
- Исправлено: проблема с загрузкой Google Drive [#81](https://github.com/immersive-translate/immersive-translate/issues/81)

## 0.2.48

- Улучшено для скорости, добавив minLength до 50 для обнаружения языка.
...
- исправить блокировку метки

## 0.2.45

- Исправлено: innerText элемента не определен
- Исправлено: caiyun перевод не определен исходный язык

## 0.2.44

- Исправлено: переключение маски userscript
- Исправлено: логика переключения маски

## 0.2.43

- Исправлено: переключение маски userscript с сенсорным событием.
- Исправлено: скорость (удалив sleep(300))

## 0.2.42

- Исправлено: наведение на маску при повторном переключении маски.
- Добавить ярлыки маски для мобильных устройств
- Исправлено: проблема с облачной синхронизацией userscript
- Переместить страницу расширенных опций в левое меню.
- Добавить логику повторной попытки к сервису перевода
...
- Поддержка ярлыков для показа маски перевода
- Поддержка включения бета-функции на панели разработчика
- Исправлено: ярлыки в мобильном расширении
...
- Исправлено: импорт/экспорт иконки

## 0.2.37

- Исправлено: исключение метки фрейма
...
- Улучшено для всплывающего UI больше
- Улучшено для плохих подсказок userscript
- Добавить вклад в страницу о
- Исправлено: volc перевод для автоматического определения языка
...
- Добавить 3 темы
- Добавить сервис перевода Niu

## 0.2.32

- Исправлено: базовый перевод PDF
- Исправлено: выбор всплывающего окна не настроенного сервиса, переход на страницу опций.
- Исправлено: оставаться открытыми настройками.
- Исправлено: скорость обнаружения нескольких языков
...
- Поддержка перевода shadowroot. Например:
  ...
  Область разговора.
- также проверить правило синхронизации на всплывающем окне

## 0.2.29

- Исправлено: перевод Facebook
- Поддержка показа опции контекстного меню.

## 0.2.28

- Удалить нестандартное совпадение для userscript
...
- Добавить расширенные настройки для перевода новой строки
...
- Исправлено: stay.app userscript API браузера
- Исправлено: stay.app страница опций
...
- Удалить aside контейнер как контейнер перевода.
- Рефакторинг позиции всплывающего окна.

## 0.2.17

- Изменить выделение на метку
- Добавить тему перевода с выделением
...
- Исправить ошибку разрыва строки.
...
- Исправить перевод изображения в блоке.

## 0.0.49

- Исправить расширение для firefox
...
- Исправить изменение службы перевода в popup не работает
- Исправить перевод содержимого поста на мобильном reddit.
