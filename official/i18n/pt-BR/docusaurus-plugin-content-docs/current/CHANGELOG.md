...
- Corrigido: Problemas de compatibilidade com o modo "Somente Tradução" quando usado com plugins de leitura como Reader View.
...
- Adicionado: A **Tradução de Legendas** em tempo real agora suporta ativação via "float ball", disponível no Zoom, Google Meet e Microsoft Teams.
...
- Controle de estilo de legenda do YouTube suporta estilo de borda
...
- Melhorias foram feitas para resolver o problema em que legendas bilíngues imersivas não eram exibidas quando os usuários definiam o idioma da legenda como chinês no site do YouTube.
...
- Corrigido o problema do ícone de atalho de legenda do YouTube não exibido
...
- Suporte para configurar a fonte da tradução no modo apenas tradução.
...
- [Suporte a hoverball configurado para ser fixado à esquerda #1168](https://github.com/immersive-translate/immersive-translate/issues/1168)
...
- Otimizando Julgamento de Idioma do Grease Monkey
...
- Suporta [Habilitar Assinatura Pro](/pricing), que permite aos usuários desfrutar de traduções do Deepl e OpenAI e configurações de sincronização na nuvem.
...
- Suporte a Resultados de Tradução com Suporte a Entrada Aprimorada ctrl+z Desfazer
...
- Corrigir o problema de que as imagens em algumas páginas da web de: ficam maiores após a cópia
...
- O recurso Mostrar Apenas Traduções está aqui! Clique em [Mais] -> [Alternar para mostrar apenas traduções].
...
- Alterar: Cor do ícone de carregamento, de preto para azul, para adaptar a página da web em modo escuro.
...
- Fix: Open AI para parágrafo de espaço
...
- Feat: Suporte ao Tema de Tradução Cinza
...
- Fix: permissão de userscript Open AI
...
- Feat: Suporte a verificação do serviço de tradução em options.html
- Feat: Suporte a quadro principal personalizado, pois alguns sites não usam body como quadro principal
...
- Fix: Permitir configuração de API do Google personalizada
...
- Fix: configuração de tradução Azure, mas ainda mostra (necessário configurar)

## 0.2.66

- Fix: tradução de arquivo PDF falhou, Bug da versão 0.2.60 para suportar deepl de zh-CN para zh-TW
...
- Feat: Suporte à opção de traduzir título
...
- Feat: Recurso Immersive Translate Deepl
...
- Fix: Elemento de Bloco de Tags Desconhecidas
...
- Fix Google Auth precisa de login no Chrome/Firefox
...
- Fix ignorar tag japonesa rb, rt.
...
- Fix seleção de serviço não configurado no popup, ir para a página de opções.
...
- Fix tradução de pdf online no firefox

## 0.2.20

- Fix problema de requisição macaque
- Fix marca de linha de destaque

## 0.2.19

- Fix japonês inteligente tencent
...
- Fix problema de bounce ao tocar
...
- Suporte a Três Dedos em dispositivo de toque para acionar alternar páginas de tradução
