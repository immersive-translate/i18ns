...
- Suporte a entrada aprimorada para Baidu, Gmail e outros campos de entrada
...
- Google Meet agora suporta legendas bilíngues para reuniões ao vivo: Agora, você pode desfrutar do recurso de legendas bilíngues em reuniões do Google Meet. Basta abrir o link da reunião, ativar as legendas bilíngues no painel de tradução imersiva e, em seguida, atualizar a página para experimentar.
...
- Suporte à integração imersiva [JS SDK](https://immersivetranslate.com/docs/js-sdk/) para sites de terceiros
...
- Corrigidos os problemas de layout de texto das traduções de quadrinhos para idiomas no script latino.
...
- Corrigir problema de tradução repetida ao passar o mouse
...
- Corrigir tradução de toda a página, rodapé é ignorado
