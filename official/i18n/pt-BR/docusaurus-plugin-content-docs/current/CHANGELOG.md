...
- Suporte para configurar a fonte de tradução no modo somente tradução.
...
- **Otimização de UI**: Redesenhada a interface de avisos de erro de tradução de página para torná-los mais fáceis de entender. Quando há muitos erros, um pop-up irá ativamente avisar o usuário.
...
- Recurso: Suporte a verificação do serviço de tradução em options.html
...
- Suporte a definição do primeiro x número de textos para traduzir imediatamente.
