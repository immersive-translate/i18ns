...
- Adicionado: Suporte para ativar legendas AI no Youtube para PC (membros Pro)
...
- Corrigido: Problema de números decimais sendo forçadamente quebrados ao traduzir textos longos.
...
- Otimizada cópia da interface em Chinês Tradicional.
...
- Suporte para o serviço de tradução gratuita do Yandex
- Palavras de prompt do Gemini otimizadas
...
- Alteração no painel para exibir apenas o botão de tradução, modificada para afetar apenas a página atual
...
- Tradução de Caixa de Entrada suporta tradução direta de todo o texto sem prefixos.
