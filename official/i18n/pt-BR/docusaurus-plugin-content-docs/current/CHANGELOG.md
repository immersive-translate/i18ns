...
- Melhorado: Atualizada a interface do usuário da lista suspensa do serviço de tradução no painel.
...
- Otimizadas palavras de prompt múltiplas do OpenAI, suportando formato YAML, o que melhora a flexibilidade e facilidade de uso da configuração
...
- Reparar clique não responsivo da bola flutuante em pdf online
...
- Corrigir cliques trêmulos da bola flutuante da página
...
- Otimizar a seleção de idioma alvo, agora mostrará apenas os idiomas suportados pelo serviço de tradução correspondente
- Otimização de Tradução de PDF
...
- Recurso: Adicionar `<all>` para sempre traduzir idiomas, então agora você pode usá-lo para traduzir todos os idiomas, exceto o idioma de destino, e nunca traduzir idiomas
...
- Corrigir hover da máscara ao alternar a máscara novamente.
...
- Suporte para tradução de iframe, como QQ mail, tweet embutido.

## 0.2.24

- Adicionar site de tradução temporária por um tempo
- Corrigir stay.app API do navegador do userscript
...
- Suporte para definir área da página que precisa ser traduzida. para que você possa traduzir mais área.
...
- Corrigir alguns tags span são elementos de bloco
