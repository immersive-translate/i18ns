...
- Corrigido: Problema resolvido de arquivo de configuração do usuário excedendo o limite de tamanho.
...
- Corrigido: Problema abordado onde algum conteúdo era perdido durante a tradução de múltiplos segmentos no Gemini.
...
- Melhorado: Aprimoramento de entrada e funcionalidade de passar o mouse sobre iframes incorporados em páginas da web
...
- Adicionado um botão de reset para o estilo de legenda do Youtube, que pode rapidamente restaurar ao estilo padrão.
...
- Serviço OpenAI adicionou suporte para dialeto do Nordeste Chinês.
...
- Correção: postMessage ao iniciar a página quebrou alguns sites, agora faremos isso apenas quando realmente traduzirmos páginas
...
- Recurso: Recurso Deepl de Tradução Imersiva
...
- Correção de configuração de página de popup em nova aba
