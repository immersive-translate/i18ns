...
- Adicionado: Navegador Android suporta tradução de imagem gratuita.
...
- Otimizado: Compatível com modelos como o1, o3 que não suportam system role (o parâmetro de system role não será passado quando a configuração de System Prompt estiver vazia).
...
- Corrigido: Erro `401: Authentication Fails` na chave de API personalizada do DeepSeek.
...
- Melhorado: Item de menu de clique com o botão direito pode ser fechado (operado nas configurações avançadas).
...
- Corrigido: Problema onde **Mouse Hover Translation** não podia traduzir rich text.
- Melhorado: Versão Tampermonkey agora suporta tradução de legendas do YouTube.

## 1.14.4 Release (2025-02-07)

- Corrigido: Problema com detecção incorreta de idioma na **Enhanced Input Box**.
...
- Novo: Tradução de imagem gratuita agora está disponível (atualmente suportada apenas nas versões para PC dos navegadores Chrome e Edge), acessível via menu de clique com o botão direito.
- Corrigido: Abordado um problema onde algum conteúdo era perdido durante a tradução de múltiplos segmentos no Gemini.
...
- Melhorado: **Image Translation** agora é compatível com weibo.com (suportado apenas no Chrome e Edge).
- Melhorado: Quando o idioma da interface está definido para Inglês, o idioma alvo padrão para **Enhanced Input Box** é alterado para Chinês.
- Melhorado: Adicionada uma entrada de revisão da loja nas opções **More** no painel.

## 1.13.5 Release (2025-01-14)

- Melhorado: Compatível com o modelo de pensamento Gemini 2.0.
- Melhorado: Suporta estilo em negrito no modo de tradução apenas.
...
- Corrigido: Problema onde **Mouse Hover Translation** não funciona em alguns sites.
...
- Corrigido: Após trocar serviços de tradução, o serviço de tradução na "**Enhanced Input Box**" não atualiza.
...
- Adicionado: **AI Context-Aware Translation** pode melhorar a precisão da tradução de conteúdo profissional. (Disponível apenas para membros Pro, suportado exclusivamente por modelos OpenAI) **Options** -> **Grneral** -> **Enable AI Context-Aware Translation**
- Corrigido: Alguns bugs no efeito de tradução multilinha no Twitter.
- Corrigido: Problemas com a tradução de certas fórmulas devido a rich text.
...
- Melhorado: Tradução de rich text é desativada por padrão no modo bilíngue para melhorar a qualidade da tradução.
- ~~Melhorado: Adicionada a opção de personalizar a "**Enable Sidebar & Navbar Translation**" em "**Advanced Settings**".~~
- Melhorado: Imagens não são mais traduzidas no modo "**Hover - immediately translate this paragraph**".
...
- Adicionado: Tradução de **Subtitles Translation** em reuniões em tempo real agora suporta ativação via "float ball", disponível no Zoom, Google Meet e Microsoft Teams.
- Corrigido: Problemas de sincronização de tempo de legendas no YouTube após assistir anúncios.
- Corrigido: Problemas de exibição com o menu de tradução de clique com o botão direito no Safari no MacOS 15.
- Corrigido: Problemas com a funcionalidade de desfazer Ctrl+Z no **Enhanced input** em certos sites.

## 1.10.6 (2024-10-25)

- Corrigido: Problema com teclas de atalho do **Enhanced input** não sendo acionadas.
...
- Corrigido: Problema de tradução de caracteres de espaço em rich text [#2175](https://github.com/immersive-translate/immersive-translate/issues/2175).
...
- Adicionado: Modo Forçar Habilitar Suporte ao Mouse (Ative este recurso apenas se a função de passar o mouse não estiver disponível em dispositivos tablet) **Configurações** -> **Configurações Avançadas** -> **Forçar Habilitar Suporte ao Mouse**
...
- Melhorado: Aprimorado o renderização de fórmulas traduzidas
...
- Suporte aprimorado para entrada em campos do Baidu, Gmail e outros
...
- A opção para comparação bilíngue/exibição apenas de tradução foi movida para configurações gerais.
...
- Corrigido um problema onde [Configurações Avançadas -> Número mínimo de caracteres necessários para traduzir um parágrafo] não surtia efeito em alguns casos

## 1.8.4 (2024-08-30)

- O serviço de tradução DeepL agora oficialmente suporta Chinês Tradicional como idioma alvo (anteriormente, traduzir para Chinês Tradicional com DeepL envolvia um processo adicional de conversão de Chinês Simplificado para Chinês Tradicional de terceiros).
...
- Devido a restrições do site do YouTube, o script do Tampermonkey para Chrome não suporta mais legendas bilíngues do YouTube. Por favor, use a [versão do plugin](https://immersivetranslate.com/).
...
- Adicionada tradução de grande modelo Zero-One-Thing, que pode ser usada preenchendo a Chave API após se registrar na plataforma Zero-One-Thing.
...
- Adotar algoritmo de divisão de sentenças inteligente por IA para legendas em inglês geradas automaticamente no YouTube [Pro Disponível]
- Otimizar a tradução de clique direito para "Traduzir para xx idioma alvo"
...
- As legendas bilíngues do YouTube agora suportam divisão inteligente de sentenças (Beta) (Apenas quando ativar manualmente a tradução imersiva de legendas do YouTube em [Configurações] - [Legendas de Vídeo], e as legendas originais do vídeo são legendas em inglês geradas automaticamente)
...
- Novo recurso: Tradução de mangá (Beta), em sites de mangá suportados, um botão de tradução de mangá aparecerá abaixo da bola flutuante de tradução rápida da página. Clicar nele ativará a tradução de mangá. Este recurso está disponível para membros Pro (500 páginas por mês, pacotes adicionais podem ser adquiridos), atualmente suportando os seguintes sites:
...
- Novo recurso: Tradução AI suporta [modelo grande Doubao](https://www.volcengine.com/product/doubao)
...
- Adicionado um recurso temporário para habilitar edição de tradução na entrada "Mais" do painel
...
- Otimizado prompts multi OpenAI, suportando formato YAML, que melhora a flexibilidade e facilidade de uso da configuração
...
- Suporte para tradução de páginas da web e legendas de vídeo em idiomas como árabe, hebraico, etc., abordando problemas de exibição RTL (Right-To-Left)
...
- Corrigido o problema onde configurar a cor do texto não suportava a pré-visualização RGBA [#1435](https://github.com/immersive-translate/immersive-translate/issues/1435)
- Corrigido o problema onde atualizar a versão do plugin Safari sempre exibia a página de sucesso de instalação
...
- Corrigido um problema onde alguns usuários Pro não podiam modificar configurações no navegador Chrome.
...
- Suporte para configurar sites/idiomas específicos para exibir apenas o texto traduzido.
- Corrigido um problema onde a página de configurações continuava mostrando carregamento em alguns casos no Safari.
...
- Suporte para configurar a fonte de tradução no modo apenas tradução.
...
- **Otimização de UI**: Redesenhada a interface do usuário para avisos de erro de tradução de página para torná-los mais fáceis de entender. Quando há muitos erros, um pop-up irá ativamente avisar o usuário.

- **Correções de Bugs**:

  - Corrigido o problema onde a tradução ao passar o mouse falhava quando a página perdia o foco.
  - Corrigido o problema onde menos de 3 caracteres na função de aprimoramento de caixa de entrada não eram traduzidos.
  - Corrigido o problema onde alguns diretórios não eram traduzidos durante a produção de Epubs bilíngues.

- **Remoção de Recursos**: Removida a função de aprimoramento de informações bilíngues (exibindo resultados de pesquisa em inglês nas páginas de pesquisa do Google simultaneamente).

### Outras Atualizações

- **openAI Configuration Update**: Agora suporta a configuração do número de configurações por segundo em decimais, como 0.5, significando 1 solicitação a cada 2 segundos.
...
- Corrigido o problema em que as traduções não respondiam a tempo quando a página da web era rolada para a posição do meio em alguns casos.
...
- Suporte para colaboração no site pubmed.ncbi.nlm.nih.gov e no plugin scholarscope.
...
- Otimizar a detecção de idioma no Grease Monkey e no Safari.
...
- Modificar o compartilhamento bilíngue (modo de atualização) adicionado na última versão para compartilhamento de instantâneos de página bilíngue, para que o conteúdo compartilhado seja mais original, bem como maior adaptabilidade.
...
- O modelo padrão para traduções do OpenAI é: GPT3.5-turbo-1106.
- Otimizado o Prompt em Chinês para o OpenAI, agora menos propenso a alucinações!
- Reduzido o comprimento dos prompts do OpenAI de 90 para 40, economizando ainda mais tráfego.

## 0.11.0

- Corrigir cliques trêmulos no hoverball da página.
...
- Corrigir conflito de legendas do Youtube com plugin de legendas duplas (tradução de legendas do Youtube do Immersive Translate não é ativada quando o plugin de legendas duplas do Youtube é detectado para evitar conflito).
...
- Otimização da velocidade de exportação de tradução apenas em PDF, se você escolher exportar apenas a tradução, pode chamar diretamente a visualização de PDF do sistema para exportar, mais rápido.
...
- Recursos Beta: API Personalizada (Beta habilitado nas configurações do desenvolvedor)
...
- A funcionalidade é amplamente inalterada (novos recursos estarão disponíveis no próximo lançamento!)
...
- Recurso: O estilo de tradução de linha dividida adiciona uma linha de divisão vertical para traduções de linha única
- Correção: Casos muito raros de divisão de parágrafos.
- Uma ótima página de orientação para configuração inicial para novos usuários de iOS.
...
- Correção: Estilo de autoria de eBook não funcionando
...
- Correção: Tampermonkey Toggle mostra apenas traduções
- Correção: Problema de estilo de leitura online de eBook não funcionando

## 0.5.8

- Corrige o problema de que: configuração temporária da duração da tradução do site não tem efeito.
...
- Correção: Detecção de espaço em branco em tags sup, sub.
...
- Recurso: Adicionar botão de tentar novamente todos os parágrafos falhados.
...
- Corrigir: opções do formulário UI
- Corrigir: Open AI prompt
- Recurso: Suporte a múltiplas chaves OpenAI, use `,` para separá-las.
...
- Recurso: suporte OpenAI CHATGPT 3.5 (suporta interface OpenAI ChatGPT 3.5)
...
- Recurso: Suporte a contagem de texto de tradução imediata personalizada para diferentes serviços de tradução.

## 0.2.74

- Recurso: Suporte Tencent (alpha)
...
- Corrigir: problema de rede do serviço de tradução de verificação móvel do firefox.
...
- Recurso: Suporte Open AI como serviço de tradução.
- Recurso: Suporte para verificar o serviço de tradução em options.html
- Recurso: Suporte a quadro principal personalizado, pois alguns sites não usam o corpo como quadro principal
...
- Recurso: Adicionar `<all>` para sempre traduzir idiomas, agora você pode usá-lo para traduzir todos os idiomas, exceto o idioma de destino, e nunca traduzir idiomas
...
- Corrigir: configuração de tradução Azure, mas ainda mostra (precisa de configuração)
...
- Suporte a solicitação de limitação para múltiplos quadros
- Não traduzir o título da página quando em iframe

## 0.2.64

- Corrigir: escolha de serviços de tradução openl
- Recurso: Suporte à opção de tradução de título

## 0.2.63

- Recurso: Suporte ao Serviço de Tradução Azure
- Recurso: Suporte ao Serviço de Tradução Papago
- Corrigir: sincronização do google drive nativa do firefox android.
- Corrigir: alterar a transparência de 0.4 para 0.618 [#147] (https://github.com/immersive-translate/immersive-translate/pull/147)
- Corrigir: dicas de atalhos do popup
- Desempenho: solicitações de serial para concorrência
- Melhor para detectar contagem japonesa
...
- Recurso: Suporte zh-CN para zh-TW para Deepl
...
- Suporte a ativação de recurso beta no painel do desenvolvedor
...
- Suporte a tradução de iframe, como email QQ, tweet embutido.
...
- Corrigir tradução de pdf online do firefox
...
- Corrigir arquivo local pdf do Firefox
...
- Corrigir mudança de elemento preventivo do telegra.ph
...
- Suporte a modo de tradução imediata, para que você possa deixar a página da web traduzir
  o mais rápido possível.
- Suporte a definição de área da página que precisa ser traduzida. para que você possa traduzir mais área.
- Suporte a definição da contagem de texto dos primeiros x para traduzir imediatamente.
...
- Suporte a tradução de toda a página
- Suporte a tradução imediata da página
...
- Suporte a não traduzir hashtags como #hash, tags de menção como @xxx, $tag, como $APPL
