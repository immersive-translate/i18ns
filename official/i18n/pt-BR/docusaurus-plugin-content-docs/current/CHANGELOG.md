...
- Corrigido: corrigido um problema em que o menu suspenso em formato de cápsula da tradução em caixas de entrada podia transbordar na parte inferior no WhatsApp.
- Adicionado: os serviços de API personalizados agora completam automaticamente os caminhos de interface OpenAI / Anthropic com base na Base URL.
- Melhorado: melhorada a entrada de tradução de documentos no popup, aumentando a visibilidade e a facilidade de uso.

## 1.30.1 Release (2026-06-04)

- Melhorado: a tradução em caixas de entrada agora permite retraduzir após trocar o idioma de destino.

## 1.29.9 Preview (2026-05-27)

- Melhorado: melhorada a experiência de tradução de texto na barra lateral.
- Melhorado: as solicitações de tradução de legendas online agora são controladas pelo limite de parágrafos do serviço de tradução.
- Melhorado: melhoradas as mensagens das caixas de diálogo de erro 403 / Cloudflare.
- Adicionado: adicionado um botão de alternância do cache de tradução em Mais recursos no popup.
- Adicionado: adicionados botões de alternância independentes por site para tradução de legendas.

## 1.29.6 Release (2026-05-20)

- Melhorado: melhorada a transcrição fonética e a saída da tradução da [tradução por seleção de texto] em cenários com idiomas menos comuns.
- Corrigido: corrigido um problema em que especialistas de IA personalizados de membros podiam ser sobrescritos durante a sincronização.
- Adicionado: adicionado suporte para traduzir o site de quadrinhos toptoon.com.
...
- Corrigido: corrigido um problema em que a [tradução por seleção de texto] não funcionava no Reddit.
- Corrigido: corrigido um problema em que a barra lateral não podia ser aberta no Atlas Browser.

## 1.29.1 Release (2026-05-07)

- Adicionado: suporte ao serviço de tradução plamo.
- Melhorado: marcadores de layout para idiomas RTL no modo Somente tradução.
- Melhorado: melhor correspondência para algumas formas plurais de termos em inglês, reduzindo falhas na detecção de terminologia.
- Corrigido: problema de tremulação das legendas durante a tradução de legendas do Teams.
- Corrigido: problema em que [Tradução por seleção] não conseguia capturar corretamente o texto em cenários com ShadowRoot.
