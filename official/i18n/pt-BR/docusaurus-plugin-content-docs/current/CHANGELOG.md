...
Este registro de alterações é atualizado de acordo com o progresso do desenvolvimento. A data após a versão é a data de mesclagem do código, não a data de lançamento nas lojas de aplicativos (o tempo de revisão varia após a submissão para cada loja de aplicativos, com algumas levando até uma semana para revisão). Atualmente, estamos avançando duas versões.
...
- Corrigido: Abordado um problema onde algum conteúdo era perdido durante a tradução em múltiplos segmentos no Gemini.
...
- As legendas bilíngues do YouTube agora suportam divisão inteligente de sentenças (Beta) (Apenas quando ativar manualmente a tradução imersiva de legendas do YouTube em [Configurações] - [Legendas de Vídeo], e as legendas originais do vídeo são legendas automáticas em inglês)
...
- Novo recurso: Tradução por AI suporta [Doubao large model](https://www.volcengine.com/product/doubao)
...
- Fix: Ouvinte de tecla de atalho de passar o mouse.
...
- Fix: Limite máximo de tokens do OpenAI, alterar caracteres máximos de 1500
- Fix: Detecção de espaço em branco
...
- Recurso: Adicionar Menu Ativar/Desativar para popup -> mais
...
- Usar a versão mais recente do esbuild
- Usar a versão mais recente do deno
- CI: enviar código-fonte para firefox

## 0.2.51

- Corrigir Google Auth Necessita de Login no Chrome/Firefox
