...
- Tradução da Caixa de Entrada suporta tradução direta de todo o texto sem prefixos.
...
- Fix: problema de rede do serviço de tradução de verificação móvel do firefox.
...
- Feat: Adicionar `<all>` para sempre traduzir idiomas, então agora você pode usá-lo para traduzir todos os idiomas, exceto o idioma de destino, e nunca traduzir idiomas
...
- Fix página de configuração de popup em nova aba
...
- Suporte para tradução de iframe, como email QQ, tweet incorporado.
...
- Fix safari globalThis.GM não funcionando
