...
- Adicionado: Recurso de tradução de seleção de texto
- Adicionado: Gerenciamento de biblioteca de terminologia AI
- Adicionado: Suporte para ativar legendas AI no Youtube no PC (membros Pro)
- Adicionado: Plugin Safari suporta compras dentro do aplicativo
- Corrigido: Problema onde alguns parágrafos não eram traduzidos durante a tradução de páginas da web
...
- Otimizado OpenAI multi-prompt words, suportando formato YAML, que melhora a flexibilidade e facilidade de uso da configuração
...
- Corrigir a criação de Epubs clicando no painel de traduções que não funcionam
...
- Otimizado o Prompt Chinês para o OpenAI, agora menos propenso a alucinações!
...
- Digite: // Hello World na caixa de entrada em qualquer página da web, então clique três vezes na barra de espaço para traduzir o parágrafo para o inglês
- Você também pode especificar a tradução para um determinado idioma: /ja Hello World, então clique três vezes na barra de espaço para traduzir o parágrafo para o japonês
...
- Correção: problema de rede do serviço de tradução de verificação no firefox mobile.
...
- Corrigir YouTube para ir para a próxima página
