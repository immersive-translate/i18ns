...
沉浸式翻譯擴展支持很多翻譯服務，其中部分翻譯服務需要你申請對應服務的 API 密鑰才能使用，我從網絡上整理了以下服務的申請教程，如果有遺漏或者沒有及時更新的地方，歡迎點擊右上角編輯這些頁面。## 申請教程

1. [Deepl](./services/deepL.md)
2. [火山引擎](./services/volcano.md)
3. [騰訊翻譯君](./services/tencent.md)
4. [百度翻譯](./services/baidu.md)
5. [彩雲小譯](./services/caiyun.md)
6. [OpenL](https://docs.openl.club/#/)
7. [有道翻譯](./services/youdao.md)
8. [小牛翻譯](https://niutrans.com/documents/contents/beginning_guide/6)
