...
- 修復：鼠標懸停功能在特定情況下會加載錯誤翻譯服務的問題。
- 修復：YouTube臨時啟用雙語字幕不生效的問題。
- 修復：切換翻譯服務後，【**輸入框增強**】的翻譯服務沒有更新的問題。
- 修復：設定頁中【**YouTube自動開啟雙語字幕**】開關失效的問題。
- 優化：移除廢棄的 gemini-1.0-pro 模型。

## 1.12.4 (2024-12-13)

- 新增：AI智能上下文翻譯，在一些專業內容上可以使翻譯更準確。（僅限Pro會員使用，僅OpenAI模型支持。）【設定】->【基本設定】->【啟用AI智能上下文翻譯】
- 修復：推特多行翻譯效果下的部分 bug。
- 修復：富文本導致部分公式翻譯的問題。
