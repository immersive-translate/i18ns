...
We may analyze information based on your use of the Service to improve service quality and user experience, and generate tag information reflecting general usage habits or preferences. This analysis is mainly based on information such as feature usage, operational behavior, and interaction patterns during your use of the Service, and is processed in a categorized or statistical manner. To reduce the impact on your personal information, the generation and processing of such tags are completed locally on your device, and we do not collect or store the specific website addresses you visit or detailed browsing content.

On this basis, we may associate relevant tag information with your account or device identifier to understand overall user behavior, optimize product functions and service experience, improve content presentation and feature design, and, where appropriate, provide products or services that better meet user needs.

We will not make decisions that produce significant legal effects or similarly significant effects on you based solely on automated processing without human involvement. If applicable laws in different jurisdictions impose additional requirements on automated processing or algorithmic decision-making, we will comply with them accordingly.

Accordingly, the Service is not currently subject to special rules on automated decision-making. The above analysis and tag processing based on usage will not produce significant legal effects or similarly significant effects on you, and we will not process your personal information solely by automated means in a way that may adversely affect your personal rights and interests.

If, in the future, we introduce automated decision-making that may have a significant impact on you, or further data analysis and processing methods, in specific scenarios, we will provide the necessary information as required by law and obtain your consent where required by applicable law.
...
We use session cookies and persistent cookies. Session cookies are deleted when you close your browser, whereas persistent cookies remain on your device, are activated when you next visit our website, and may also be deleted manually. In general, persistent cookies do not damage your device, programs, or files.

### How to manage cookies?

You may refuse all or some cookies by adjusting your browser settings. For instructions, please refer to your browser’s guidance. However, if you block all cookies (including strictly necessary cookies), you may be unable to access our website or certain content.
...
- Adequacy decisions adopted by the European Commission and adequacy regulations issued by the UK Information Commissioner’s Office (ICO), confirming that the data protection level of the relevant jurisdictions is adequate. You may obtain further information from the European Commission at:
...
- Standard Contractual Clauses approved by EU Implementing Decision (EU) 2021/914 of 4 June 2021 (available at:
	[https://eur-lex.europa.eu/legal-content/EN/TXT/HTML/?uri=CELEX:32021D0914](https://eur-lex.europa.eu/legal-content/EN/TXT/HTML/?uri=CELEX:32021D0914)), or standard data protection clauses approved by the UK ICO (available at:
