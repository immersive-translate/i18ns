...
- Corrigé : Un problème où le service de traduction AI produisait incorrectement du chinois simplifié lors de la traduction du chinois traditionnel.
...
- Par défaut, le système se souviendra du mode basculé en cliquant sur l'icône dans le panneau pour la comparaison bilingue ou l'affichage de traduction uniquement. Pour basculer temporairement, cliquez sur "Plus" -> "Passer à l'affichage de traduction uniquement" dans le panneau.
- Par défaut, la traduction du chinois simplifié au chinois traditionnel et vice versa utilisera le mode de traduction uniquement, plutôt que le mode de comparaison bilingue.
- Corrigé certains bugs.
...
- Vous pouvez maintenant traduire du texte dans les boîtes de saisie avec un clic droit : Sélectionnez n'importe quel texte dans une boîte de saisie sur une page web, cliquez avec le bouton droit pour choisir de traduire, et la traduction immersive traduira automatiquement le texte sélectionné dans la langue cible de la boîte de saisie, ce qui permet de traduire rapidement le texte en langue maternelle dans les boîtes de saisie vers d'autres langues.
...
- Lorsque des experts AI sont utilisés pour la "Sélection intelligente", différents experts AI peuvent être personnalisés pour différents sites web. Cela peut être configuré dans [Paramètres] -> [Experts AI] -> [Entrer n'importe quel expert].
...
- Le commutateur du panneau pour n'afficher que le bouton de traduction modifié pour n'avoir d'effet que sur la page actuelle

## 1.3.3

- Optimisation du problème d'affichage de la traduction des sous-titres vidéo CC de Twitter.
...
- **Mise à jour de l'interface utilisateur de la page des paramètres du plugin** :
  ...
  - Ajout d'un tutoriel pour débutants, couvrant les paramètres de la boule flottante, les paramètres des sous-titres vidéo et les paramètres de survol de la souris.
...
- **Optimisation de l'interface utilisateur** : Refonte de l'interface utilisateur des messages d'erreur de traduction de page pour les rendre plus compréhensibles. Lorsqu'il y a de nombreuses erreurs, un pop-up avertira activement l'utilisateur.
...
- Résolution du problème que certaines plateformes ne pouvaient pas reconnaître si la souris était prise en charge ou non
  - Il y a certains navigateurs de bureau qui prennent en charge à la fois l'écran tactile et la souris, et Immersive Translates est techniquement incapable de détecter si ces plateformes prennent en charge la souris, nous avons donc ajouté l'option [Forcer l'activation du support de la souris] dans le paramètre [Survol de la souris]
...
- Résultats de traduction de support amélioré de l'entrée ctrl+z Annuler
- Prise en charge de la traduction en mode lecture de document Flying Book
...
- Arigato Translator prend en charge la configuration des champs et de l'identifiant de la terminologie
...
- Fonctionnalité : Nous pouvons maintenant personnaliser la couleur de fond du thème de traduction de marqueur.
...
- UI : meilleure pour faire l'UI de la page d'eBook
...
- Fonctionnalité : support OpenAI CHATGPT 3.5 (supporte l'interface OpenAI ChatGPT 3.5)
...
- Fonctionnalité : support CSS injecté sur le tableau de bord des développeurs
...
- Correction du basculement du masque du userscript avec l'événement tactile.
...
- Correction de la page de réglage du popup sur la nouvelle page d'onglet
...
- Correction de la distance de hauteur de ligne de PDF
...
- Ajouter les thèmes dotted, thinDashed
- Mieux pour les thèmes en pointillés, surlignés
...
- Corriger le problème innerText de reddit
...
- Supporter ne pas traduire les hashtags comme #hash, les tags at comme @xxx, $tag, comme $APPL
