...
- Optimisé : Compatible avec des modèles comme o1, o3 qui ne prennent pas en charge le rôle système (le paramètre de rôle système ne sera pas transmis lorsque la configuration de l'invite système est vide).
...
- Corrigé : La mise à jour des termes n'envoie pas de nouvelle demande de traduction.
...
- Ajouté : Permettre aux fichiers ePub incomplets de continuer à être traduits là où ils se sont arrêtés lors de la réimportation.
...
- Amélioré : Les images ne sont plus traduites en mode "**Hover - traduire immédiatement ce paragraphe**".
...
- Corrigé : Problème avec les raccourcis clavier **Enhanced input** ne se déclenchant pas.
...
- Amélioré : Amélioration de l'amélioration de l'entrée et de la fonctionnalité de survol de la souris dans les iframes intégrées sur les pages web.
...
- Les sous-titres vidéo prennent en charge le réglage de l'affichage bilingue/original et traduction
...
- Correction du problème d'alignement avec l'option "Plus" qui n'était pas alignée à gauche sur Windows.
...
- **Mise à niveau de l'interface utilisateur du panneau contextuel :** Le nouveau design vise à améliorer l'utilisabilité et la compréhension. Cette mise à jour inclut :
  ...
  - **Nouvelles fonctionnalités dans le menu principal :**
    ...
    - **Entrée de traduction de documents :** L'entrée pour traduire les fichiers "PDF/ePub/sous-titres" a été déplacée vers le menu principal pour un accès rapide.
...
- **Entrée de traduction de documents intégrée :** Vous pouvez maintenant traduire des fichiers PDF, ePub et de sous-titres via une entrée de téléchargement unifiée. Il suffit de cliquer sur le bouton [PDF/ePub] dans le panneau contextuel, plus besoin de sélectionner [Plus].
...
- **Nouveau guide utilisateur** : Lorsque de nouveaux utilisateurs ouvrent pour la première fois une page dans une langue non cible, une bulle d'aide de la boule flottante est affichée.

### Optimisation et corrections

- **Optimisation de l'interface utilisateur** : Refonte de l'interface utilisateur des messages d'erreur de traduction de page pour les rendre plus compréhensibles. Lorsqu'il y a de nombreuses erreurs, une fenêtre contextuelle invitera activement l'utilisateur.
...
- Optimisation : Lors de l'utilisation du survol de la souris, le problème où la perte de focus sur la page et le re-déclenchement devient inefficace.
...
- Ajouter un changement de statut de l'icône du navigateur, lorsqu'une page web a été traduite, un ✅ sera ajouté automatiquement dans le coin inférieur droit de l'icône du navigateur.
...
- Support de la traduction des résultats avec ctrl+z Annuler dans l'amélioration de l'entrée
...
- Correction de plusieurs problèmes
- La page de configuration prend en charge la suppression en masse des URL sélectionnées.
...
- Support du chinois traditionnel et simplifié
...
- Corriger : les détails de Github ne se traduisent pas après l'expansion.

## 0.5.14

- Corriger le problème que les images sur certaines pages web de : deviennent plus grandes après la copie
- Corriger : la section des commentaires de medium ne se traduit pas
- Corriger le problème que les images sur certaines pages de : ont été copiées incorrectement
...
- Une excellente page d'orientation pour la première configuration pour les nouveaux utilisateurs d'iOS.
...
- Fonctionnalité : Ajouter une progression de traduction pour le constructeur d'eBook, et une belle confettis après le succès.
...
- Correction : Limite de jetons max OpenAI, changer les caractères max de 1500 à 1300.
...
- Correction de la traduction caiyun source language indéfinie
...
- le userscript utilise un fichier.
...
- Corriger la traduction du contenu des posts mobiles reddit.
...
- Supporter la définition de la zone de la page à traduire. pour que vous puissiez traduire plus de zones.
...
- Ajouter les thèmes en pointillés, en papier
