...
- Correction : Les termes mis à jour n'envoient pas de nouvelle demande de traduction.
- Amélioration : La langue de l'interface ajoute le hongrois.
- Amélioration : Qualité de traduction Google améliorée.
- Amélioration : Formatage d'image gratuit amélioré.
...
- Amélioration : Accès à l'interface de test du service de la page de paramètres en ligne.
- Amélioration : Amélioration de l'expérience utilisateur de la fonctionnalité d'aperçu de comparaison de contexte.
- Amélioration : Logique de jugement du mode tactile et souris améliorée.
...
- Amélioration : Ajout d'une entrée de révision du magasin dans les options **Plus** sur le panneau.
...
- ~~Amélioration : Ajout de l'option pour personnaliser la "**Traduction de la barre latérale et de la barre de navigation**" dans les "**Paramètres avancés**".~~
...
- Corrigé : Problème avec les raccourcis clavier de **Enhanced input** qui ne se déclenchent pas
...
- Ajouté : Mode Forece Enable Mouse Support (Activez cette fonctionnalité uniquement si la fonction de survol de la souris n'est pas disponible sur les appareils tablette) **Settings** -> **Advanced Settings** -> **Forece Enable Mouse Support**
...
- Corrigé un problème où le [Advanced Settings -> Minimum number of characters required for translating a paragraph] ne prenait pas effet dans certains cas
...
- Vous pouvez maintenant traduire du texte dans les boîtes de saisie avec un clic droit : Sélectionnez n'importe quel texte dans une boîte de saisie sur une page web, cliquez avec le bouton droit pour choisir traduire, et la traduction immersive traduira automatiquement le texte sélectionné dans la langue cible de la boîte de saisie, ce qui permet de traduire rapidement le texte en langue native dans les boîtes de saisie vers d'autres langues.
...
- La traduction Claude prend désormais en charge le tibétain et permet la configuration du paramètre Temperature
...
- Après avoir sélectionné le texte, le menu contextuel changera en [Translate the text], en cliquant dessus, vous pouvez automatiquement accéder à la page de traduction de texte immersive
...
- Optimisation de la traduction par clic droit en "Translate to xx target language"
...
- Support de la personnalisation des experts AI, l'entrée se trouve en bas de la page [Settings]->[AI Expert].
...
- [Activation temporaire de la traduction web pour une durée ne désactive pas Toujours Traduire #1172](https://github.com/immersive-translate/immersive-translate/issues/1172)
...
- Deeplx supporte plusieurs URL, il suffit de les séparer par .
...
- Supporte [Enable Pro Membership](/pricing), ce qui permet aux utilisateurs de profiter des traductions Deepl et OpenAI et des paramètres de synchronisation cloud.
...
- Support de la traduction des résultats de support amélioré de l'entrée ctrl+z Annuler
...
- Lorsque la boîte de saisie est configurée sans préfixe, elle supporte la traduction `ja Hello` en japonais et `English Hello` en anglais.
...
- La traduction de la boîte de saisie supporte la traduction directe de l'ensemble de la boîte de texte sans préfixes.
...
- Correction : menu contextuel Firefox disparu après redémarrage.
...
- Correction : problème de caractère spécifique du créateur d'eBook, comme certains chemins de chapitre sont `xxx' xxxx`.
...
- Correction : Progression du créateur d'eBook arrêtée à 99 %.
...
- Fonctionnalité : Ajouter une progression de traduction pour le créateur d'eBook, et une belle confettis après succès.
...
- UI : meilleure pour faire l'interface de page d'eBook
...
- Correction : créateur d'eBook pour Kindle
...
- Feat : Supporter Open AI comme service de traduction.
...
- Fix : style global non modifié après la génération d'éléments dynamiques
...
- Feat : couper authKey, appid appSecret
...
- Supprimer l'autorisation des onglets pour le rejet du Chrome Store
...
- Fix affichage des fonctionnalités bêta
- Fix page de paramètres popup sur la nouvelle page d'onglet
- Fix remplacement du placeholder de traduction
...
- Supporter la traduction d'iframe en ligne pour userscript.
...
- Supporter la traduction d'iframe, comme QQ mail, tweet intégré.
...
- Fix traduction PDF en ligne Firefox

## 0.2.20

- Fix problème de requête macaque
- Fix marquage de ligne de surlignage
...
- Fix changement d'URL client, rester automatiquement l'état de traduction.
...
- Correction de l'affichage des éléments "display none"
