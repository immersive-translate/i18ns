...
- Corrigé : Quelques bugs dans l'effet de traduction multiligne sur Twitter.
...
- **Nouveau guide de l'utilisateur** : Lorsque de nouveaux utilisateurs ouvrent pour la première fois une page dans une langue non cible, une bulle d'aide de la boule flottante est affichée.
...
- La fonction d'amélioration de la recherche (certaines pages de recherche Google affichent des résultats de recherche bilingues) n'est désormais pas activée par défaut et sera supprimée dans la prochaine version.
...
- [Activation temporaire de la traduction web pendant une période de temps ne désactive pas Toujours Traduire #1172](https://github.com/immersive-translate/immersive-translate/issues/1172)
...
- Correction : l'état d'entrée des services de traduction de l'UI Options ne change pas.
...
- Fonctionnalité : Ajouter un nouveau thème Solid Border (新增新主题，实线边框)
...
- Correction : échec de la traduction de fichier PDF, bug de la version 0.2.60 pour supporter deepl de zh-CN à zh-TW
...
- Supporter le mode d'écriture verticale, comme le japonais.
- Ajouter 3 thèmes
...
- Supprimer le conteneur latéral en tant que conteneur de traduction.
...
- Corriger la traduction du fichier local après l'enregistrement. Corrigé
