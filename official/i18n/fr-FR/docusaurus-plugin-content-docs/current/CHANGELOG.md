...
- Ajouté : Le navigateur Android prend en charge la traduction d'images gratuite.
...
- Corrigé : Problème de traduction de formules causé par l'"Amélioration de la traduction Twitter" dans la version 1.11.2.
...
- Amélioré : Mise à jour de l'interface utilisateur de la liste déroulante des services de traduction dans le panneau.

## 1.11.1 (2024-11-05)

- Ajouté : La **Traduction des sous-titres** en temps réel prend désormais en charge l'activation via la "balle flottante", disponible sur Zoom, Google Meet et Microsoft Teams.
...
- En raison des restrictions du site YouTube, le script Tampermonkey pour Chrome ne prend plus en charge les sous-titres bilingues de YouTube. Veuillez utiliser la [version plugin](https://immersivetranslate.com/).
...
- Correction du problème où la traduction échouait lors du changement des mots de prompt personnalisés OpenAI sous le bouton de test
...
- Optimisation des multi-prompts OpenAI, prenant en charge le format YAML, ce qui améliore la flexibilité et la facilité d'utilisation de la configuration
...
- Le commutateur du panneau pour n'afficher que le bouton de traduction modifié pour n'affecter que la page actuelle
...
- Support de l'affichage des sous-titres bilingues en mode plein écran de YouTube sur iOS.
...
- **Nouveau guide de l'utilisateur** : Lorsque de nouveaux utilisateurs ouvrent pour la première fois une page dans une langue non cible, une bulle d'aide de la balle flottante est affichée.

### Optimisation et corrections

- **Optimisation de l'interface utilisateur** : Refonte de l'interface utilisateur pour les messages d'erreur de traduction de page pour les rendre plus compréhensibles. Lorsqu'il y a de nombreuses erreurs, une fenêtre contextuelle invitera activement l'utilisateur.
...
- Ajout de sous-titres bilingues pour les plateformes [TED](https://www.ted.com), [Frontend Masters](https://frontendmasters.com/), [edx](https://www.edx.org/), [CodeWithChris](https://www.edx.org/), [Skillshare](https://www.ted.com) https://learn.codewithchris.com/enrollments), [Skillshare](https://www.skillshare.com/) Platforms
...
- Amélioration de la boîte de saisie pour afficher le statut de chargement en traduction
...
- Correction : Popup userscript manquant sur Firefox.
...
- Version : À partir de maintenant, nous changerons le numéro de version mineure une fois par mois, par exemple, maintenant en mars, la version commencera à partir de 0.3.0, en avril, le numéro de version commencera à partir de 0.3.0, en avril, le numéro de version commencera à partir de 0.4.0, l'année prochaine en avril, le numéro de version sera 1.4.0, et ainsi de suite. Cela est dû au fait qu'il n'a pas de sens pour les extensions de suivre Cela est dû au fait qu'il n'a pas de sens pour les extensions de suivre les sémantiques, mais la standardisation des numéros de version selon les lois du temps est une motivation pour le développement de continuer à se mettre à jour, et pour les utilisateurs de trouver plus facilement des problèmes.
...
- Correction : Limite maximale de tokens OpenAI, changer les caractères max de 1500 à 1300.
...
- Corriger l'image de bloc traduite.
