...
- Fixed: Problèmes de traduction en texte enrichi pour les services de traduction tels que Google, DeepL (par exemple, les pages affichant directement `<button>` etc.)
...
- Correction : Pendant la traduction de la page, le problème où le survol de la souris ne déclenchait pas la retraduction.
...
- Ajout du support de la traduction Gemini.
...
- Correction [Lors de l'activation temporaire de la traduction de page web pendant une longue période, cliquer sur le panneau [Toujours traduire ce site web] ne désactive pas la traduction toujours #1172](https://github.com/immersive-translate/immersive-translate/issues/1172)
...
- Correction de la création d'Epub en cliquant sur les traductions du panneau ne fonctionnant pas
...
- [Activation temporaire de la traduction web pendant une durée ne désactive pas Toujours Traduire #1172](https://github.com/immersive-translate/immersive-translate/issues/1172)
...
- Support de la configuration des boutons de traduction rapide de la bulle de survol (support PC/mobile)
...
- Correction du problème de fonctionnement de safari globalThis.GM
