...
- Correction : Un problème où le service de traduction AI sortait incorrectement du chinois simplifié lors de la traduction du chinois traditionnel.
...
- Optimisation : Amélioration du support de la traduction d'images sur certains sites web.
...
- Correction : Mise à jour des termes ne pas envoyer de nouvelle demande de traduction.
...
- Amélioration : Filtre le texte sale dans le service de traduction deepl.
...
- Amélioration : BBC prend désormais en charge les sous-titres.
...
- Correction : Échec de la synchronisation Google Drive sur certains navigateurs.
- Correction : Problème de traduction des commentaires en direct sur YouTube.
- Correction : Problème de superposition des sous-titres dans certaines vidéos YouTube.
...
- Amélioration : Amélioration des descriptions pour la langue de l'interface utilisateur en chinois traditionnel.
...
- Ajout : Permettre aux fichiers ePub incomplets de continuer à être traduits à partir de l'endroit où ils se sont arrêtés lors de la réimportation.
...
- Correction : Problème où le contenu disparaît après avoir cliqué sur "voir plus" en mode traduction uniquement sur Facebook.
...
- Ajout : La **traduction des sous-titres** en temps réel prend désormais en charge l'activation via "balle flottante", disponible sur Zoom, Google Meet et Microsoft Teams.
- Correction : Problèmes de synchronisation des sous-titres sur YouTube après avoir regardé des publicités.
- Correction : Problèmes d'affichage avec le menu de traduction par clic droit dans Safari sur MacOS 15.
- Correction : Problèmes avec la fonctionnalité d'annulation Ctrl+Z dans la **saisie améliorée** sur certains sites web.

## 1.10.6 (2024-10-25)

- Fixed: Problème avec les raccourcis clavier **Enhanced input** qui ne se déclenchent pas
...
- Added: Mode Forece Enable Mouse Support (Activez cette fonctionnalité uniquement si la fonction de survol de la souris n'est pas disponible sur les appareils tablette) **Settings** -> **Advanced Settings** -> **Forece Enable Mouse Support**
...
- Correction du problème de synchronisation des experts AI personnalisés
...
- Par défaut, le système se souviendra du mode basculé en cliquant sur l'icône dans le panneau pour l'affichage de comparaison bilingue ou de traduction uniquement. Pour basculer temporairement, cliquez sur "More" -> "Switch to translation-only display" dans le panneau.
...
- Correction d'un problème où le [Advanced Settings -> Minimum number of characters required for translating a paragraph] ne prenait pas effet dans certains cas
...
- Correction des problèmes de traduction en texte enrichi pour les services de traduction tels que Google, DeepL (par exemple, les pages affichant directement `<button>` etc.)
...
- Prise en charge de la personnalisation des experts AI, l'entrée se trouve en bas de la page [Settings]->[AI Expert].
...
- Ajout de la prise en charge de nouveaux sites dans la traduction de bandes dessinées :
...
- Les sous-titres bilingues de YouTube prennent désormais en charge le découpage intelligent des phrases (Beta) (Uniquement lors de l'activation manuelle de la traduction immersive des sous-titres YouTube dans [Settings] - [Video Subtitles], et les sous-titres vidéo originaux sont des sous-titres anglais auto-générés)
...
- Les experts en IA prennent en charge le mode "Sélection Intelligente", où le système sélectionnera automatiquement l'expert en IA le plus adapté en fonction du site web actuel (par exemple, des experts en IA liés à la technologie seront automatiquement sélectionnés pour The Verge et Hacker News, tandis que l'amélioration de la traduction Twitter sera automatiquement sélectionnée pour Twitter).
...
- Ajout de l'affichage de la page sans permission pour les PDF
...
- Correction : Détails de Github non traduits après expansion.
...
- Correction : le style d'auteur d'eBook ne fonctionne pas
...
- Correction : Éviter la Content Security Policy pour [Mastondon](https://mastodon.social/)
...
- Correction : l'état d'entrée des services de traduction de commutateur UI Options ne change pas.

## 0.3.8

- UI : couleur de chargement plus transparente
- Correction : Détecter la langue de l'eBook.
- Fonctionnalité : Ajouter la progression de la traduction pour le constructeur d'eBook, et une belle confettis après succès.
...
- UI : mieux pour faire l'interface de page d'eBook
...
- Fonctionnalité : Supporte le nombre de textes de traduction immédiate personnalisée pour différents services de traduction.

## 0.2.74

- Fonctionnalité : Supporte Tencent (alpha)
- Correction : traduction openai
- Correction : vérification des balises inconnues en ligne

## 0.2.73

- Fonctionnalité : Supporte le thème de traduction gris
...
- Fonctionnalité : Supporte Open AI en tant que service de traduction.
- Fonctionnalité : Supporte la vérification du service de traduction sur options.html
- Fonctionnalité : Supporte le cadre principal personnalisé car certains sites n'utilisent pas le corps comme cadre principal

## 0.2.68

- Supporte Caiyun (Alpha)
- Correction : balises de bloc inconnues
...
- Amélioration : Support Deepl Free
- Correction : utilisation élevée de la mémoire pour les userscripts et extensions (en supprimant opencc zh-CN vers zh-TW, remplacé par Google translate)
...
- Supporte la limitation des requêtes pour plusieurs cadres
- Ne pas traduire le titre de la page lorsqu'il est dans un iframe

## 0.2.64

- Correction : choix des services de traduction openl
- Fonctionnalité : Supporte l'option de traduction du titre

## 0.2.63

- Fonctionnalité : Supporte le service de traduction Azure
- Fonctionnalité : Supporte le service de traduction Papago
...
- Fonctionnalité : Supporte zh-CN à zh-TW pour Deepl
- Fonctionnalité : Fonctionnalité Immersive Translate Deepl
- Fonctionnalité : Supporte le zoom de la taille de police personnalisée
...
- Fonctionnalité : Supporte la couleur de texte de traduction personnalisée, couleur de bordure.
...
- Fonctionnalité : coupe authKey, appid appSecret
...
- Supporte l'URL personnalisée à partir de la configuration intégrée
...
- Supporte les raccourcis pour afficher la traduction du masque
- Supporte l'activation des fonctionnalités bêta dans le panneau de développement
- Correction des raccourcis dans l'extension mobile

## 0.2.38

- Supporte le thème de chargement
...
- Supporte la synchronisation avec Google Drive
...
- Supporte le mode d'écriture vertical, comme le japonais.
- Ajout de 3 thèmes
...
- Supporte la traduction d'iframe en ligne pour les userscripts.
- Supporte la traduction de shadowroot. Par exemple :
  https://www\.foxnews.com/politics/minnesota-senate-passes-abortion-bill-opponents-call-most-extreme-nation
  Zone de conversation.
- vérifie également la règle de synchronisation sur le popup

## 0.2.29

- Correction de la traduction Facebook
- Supporte l'affichage de l'option du menu contextuel.
...
- Supporte la traduction d'iframe en ligne. (Seulement pour l'extension, non disponible pour
  userscript)
...
- Ajout de paramètres avancés pour la traduction de nouvelle ligne

## 0.2.25

- Supporte la traduction d'iframe, comme le courrier QQ, tweet intégré.

## 0.2.24

- Ajout d'un site de traduction temporaire pour un moment
- Correction de l'API du navigateur userscript stay.app
- Correction de la page des options de stay.app

## 0.2.23

- Correction de la traduction de page de plusieurs langues
...
- Correction de la traduction de PDF en ligne sur Firefox
...
- Correction du changement d'URL client, reste automatiquement l'état de traduction.
- Suppression du conteneur latéral en tant que conteneur de traduction.
- Réorganisation de la position du popup.

## 0.2.17

- Changement de surlignage à marque
...
- Supporte le glissement du popup Userscript
- Supporte trois doigts sur l'appareil tactile pour déclencher le basculement des pages de traduction
- Supporte la dissimulation de l'icône du popup userscript.
...
- Correction de la taille de police de l'interface utilisateur des options
...
- Correction du blanc de Wikipédia
...
- Correction du problème d'innerText sur Reddit
