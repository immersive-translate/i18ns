...
- Ajouté : Prise en charge du paramétrage du nombre d'écrans à pré-traduire lors de la navigation sur la page actuelle.
...
- Amélioré : Amélioration de l'expérience utilisateur de la fonctionnalité de prévisualisation de comparaison de contexte.
...
- Amélioré : Amélioration de la reconnaissance de la langue originale. Auparavant, les pages contenant plusieurs langues pouvaient ne pas être traduites, mais maintenant elles sont traduites correctement.
...
- Corrigé un problème où les services AI personnalisés ne pouvaient pas sélectionner des experts AI.

## 1.6.4

- Lorsque des experts AI sont utilisés pour la "sélection intelligente", l'entrée se trouve en bas de la page [Paramètres]->[Expert AI].
- Optimisation du chargement des sous-titres sur le site TED
- Le portugais (Brésil) est pris en charge comme langue de plugin.
- Sites pris en charge pour la traduction de bandes dessinées
  - [Antbyw](https://www.antbyw.com)
  - [Zerobywzz](https://www.zerobywzz.com)
  - [动漫之家](https://www.idmzj.com)
...
- Le service de traduction Gemini est masqué par défaut, peut être activé dans les paramètres du développeur pour afficher la version bêta de ce service de traduction

## 1.3.4

- Prise en charge du service de traduction gratuit Yandex
- Optimisation des mots d'invite Gemini
- Les sous-titres vidéo prennent en charge le réglage de l'affichage bilingue/original et de la traduction
- Prise en charge de l'espace entre le chinois et l'anglais dans les résultats de traduction OpenAI
- Commutateur de panneau pour afficher uniquement le bouton de traduction modifié pour n'avoir d'effet que sur la page actuelle
...
- Les récentes requêtes de service de traduction de Microsoft depuis la Chine ont été instables ; en cas d'erreurs, le système détecte automatiquement le service de traduction actuellement disponible, permettant aux utilisateurs de basculer rapidement.
...
- **Mise à jour de l'interface utilisateur de la page des paramètres du plugin** :
  ...
  - Ajout d'un tutoriel pour les débutants, couvrant les paramètres de la balle flottante, les paramètres de survol de la souris et les paramètres de traduction.
...
- **Support linguistique de Deepl** : Ajout du support pour le portugais (Brésil).
...
- **Optimisation de l'interface utilisateur** :
  ...
  - Optimisation de l'interface utilisateur du panneau contextuel pour améliorer l'utilisabilité et la compréhension. Cette mise à jour inclut :
...
- **Optimisation et corrections** :
  ...
  - Correction du problème où certains répertoires n'étaient pas traduits lors de la production de fichiers Epub bilingues.
...
- Ajout d'un portail de traduction rapide PDF sur le côté droit du site de papiers [Arxiv](https://arxiv.org/abs/1910.06709), qui mène à une page HTML propre (seulement pris en charge par certains papiers, car cela nécessite que les auteurs originaux soumettent le code source, donc environ 50% des papiers afficheront ce portail)
...
- Support de la traduction en mode lecture de document Flying Book
...
- Une excellente page d'orientation pour la première configuration des nouveaux utilisateurs iOS.
...
- Correction : Détection des espaces blancs pour les balises sup, sub.
...
- Correction : détection des espaces blancs
