...
- Ajouté : La **traduction des sous-titres** en temps réel peut désormais être activée via la "boule flottante", disponible sur Zoom, Google Meet et Microsoft Teams.
...
- Amélioré : Résolution des problèmes où le bouton de traduction pouvait ne pas fonctionner lors de la traduction de PDF
...
- L'option pour l'affichage comparatif bilingue/traduction uniquement a été déplacée vers les paramètres généraux.
- Par défaut, le système se souviendra du mode basculé en cliquant sur l'icône dans le panneau pour l'affichage comparatif bilingue ou la traduction uniquement. Pour basculer temporairement, cliquez sur "Plus" -> "Passer à l'affichage de traduction uniquement" dans le panneau.
...
- Après avoir sélectionné le texte, le menu clic droit changera en [Traduire le texte], en cliquant dessus vous pouvez automatiquement sauter à la page de traduction de texte immersive
...
- Correction du problème où les sous-titres ne s'affichaient pas sur YouTube en mode "Translation Only".
- Correction du problème des sous-titres bilingues ne fonctionnant pas sur Mubi.
- Compatible avec les PDFs ouverts avec le plugin Adobe Acrobat.
...
- Un nouveau raccourci a été introduit pour la traduction temporaire nommée Claude, qui peut être configurée dans la [page des Paramètres de Raccourci](https://dash.immersivetranslate.com/#shortcuts).
...
- Ajusté la description des raccourcis pour le panneau mobile.
...
- Correction de la création d'Epubs à partir du panneau en cliquant sur les traductions qui ne fonctionnent pas
...
- Modification du partage bilingue (mode de rafraîchissement) ajouté dans la dernière version en partage de capture d'écran de page bilingue, afin que le contenu partagé soit plus original, ainsi qu'une adaptabilité plus large.
...
- Fonctionnalité : Ajouter une progression de traduction pour le constructeur d'eBook, et un beau confetti après succès.
...
- Correction : déplacement du curseur de saisie du formulaire Options.
...
- Correction : placeholder Open AI
...
- Meilleur pour détecter le nombre de caractères japonais
...
- Fonctionnalité : Supporte la couleur de texte de traduction personnalisée, la couleur de la bordure.
...
- Supporte l'activation des fonctionnalités bêta au panneau de développement
...
- Supporte la traduction de l'iframe en ligne du userscript.
- Supporte la traduction shadowroot. Par exemple :
...
- Supporte la traduction de l'iframe en ligne. (Seulement pour l'extension, non disponible pour
  userscript)
...
- Correction de la marge des PDF
...
- Correction de la traduction des fichiers locaux après enregistrement. Correction de
...
- Plus d'options de configuration de l'interface utilisateur
- Réflexion du thème
...
- Correction de la cliquabilité de la version
