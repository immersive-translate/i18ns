...
- [la version bêta dans le magasin Firefox](https://addons.mozilla.org/firefox/addon/immersive-translate-beta/)
...
- Corrigé : Un problème avec la traduction au survol qui ne fonctionnait pas en mode "Traduction d'abord, texte original ensuite".
...
- Amélioré : Formatage gratuit des images.
...
- Corrigé : Le problème où la **Traduction au survol de la souris** ne fonctionne pas sur certains sites web.
...
- Corrigé : le problème où la page des paramètres iOS 18.3 ne s'affiche pas correctement.
...
- Corrigé : Les raccourcis clavier devenant inefficaces lors de l'activation ou de la désactivation de la fonctionnalité "**Traduction au survol**".
...
- ~~Amélioré : Ajout de l'option de personnalisation de la "**Traduction de la barre latérale et de la barre de navigation**" dans les "**Paramètres avancés**".~~
...
- Corrigé : Problèmes avec la fonctionnalité d'annulation Ctrl+Z dans la **saisie améliorée** sur certains sites web.

## 1.10.6 (2024-10-25)

- Corrigé : Problème avec les raccourcis de **saisie améliorée** ne se déclenchant pas.
...
- Ajouté : Mode Forcer l'activation du support de la souris (Activez cette fonctionnalité uniquement si la fonction de survol de la souris n'est pas disponible sur les appareils tablettes) **Paramètres** -> **Paramètres avancés** -> **Forcer l'activation du support de la souris**
...
- Ajout de l'option "Signaler les problèmes de traduction de la page actuelle" et de l'option "Activer/désactiver rapidement la boule flottante" dans les options supplémentaires du panneau.
...
- Vous pouvez maintenant traduire le texte dans les boîtes de saisie avec un clic droit : Sélectionnez n'importe quel texte dans une boîte de saisie sur une page web, cliquez avec le bouton droit pour choisir traduire, et la traduction immersive traduira automatiquement le texte sélectionné dans la langue cible de la boîte de saisie, ce qui permet de traduire rapidement le texte en langue maternelle dans les boîtes de saisie vers d'autres langues.
...
- La page de détails des experts AI affiche les invites utilisées par l'expert
...
- Adoption de l'algorithme de découpage de phrases intelligent AI pour les sous-titres anglais générés automatiquement sur YouTube [Pro Disponible]
...
- Correction : Lors de la traduction de la page, le survol de la souris ne déclenchait pas la retraduction.
...
- **Mise à niveau de l'interface utilisateur du panneau contextuel :** Le nouveau design vise à améliorer l'utilisabilité et la compréhension. Cette mise à jour inclut :
  ...
  - **Nouvelles fonctionnalités dans le menu principal :**
    ...
    - **Entrée de traduction de documents :** L'entrée pour traduire des fichiers "PDF/ePub/sous-titres" a été déplacée vers le menu principal pour un accès rapide.
...
- **Entrée de traduction de documents intégrée :** Désormais, vous pouvez traduire des fichiers PDF, ePub et de sous-titres via une entrée de téléchargement unifiée. Il suffit de cliquer sur le bouton [PDF/ePub] dans le panneau contextuel, plus besoin de sélectionner [Plus].
...
- Ajout d'une fonction de rappel lors du changement de modes de traduction avec des raccourcis.
...
- **Paramètres de raccourci clavier** : Ajout d'un nouveau menu de niveau supérieur "Raccourcis" et des fonctions de raccourci clavier personnalisables suivantes :
  ...
  - Ajout de touches de raccourci dédiées pour 6 services de traduction (tels que DeepL, OpenAI, Google, Microsoft, Gemini, Tencent Interactive Translation) pour faciliter le basculement temporaire entre les services de traduction.
...
- **Nouveau guide utilisateur** : Lorsque de nouveaux utilisateurs ouvrent pour la première fois une page dans une langue non cible, une bulle d'aide de la balle flottante est affichée.
...
- **Mise à jour de la configuration openAI** : Prend désormais en charge la définition du nombre de configurations par seconde en décimales, comme 0.5, ce qui signifie 1 requête toutes les 2 secondes.
...
- Correction [Lors de l'activation temporaire de la traduction de page web pendant une longue période, cliquer sur le panneau [Toujours traduire ce site web] ne désactive pas la traduction permanente #1172](https://github.com/immersive-translate/immersive-translate/issues/1172)
...
- Correction du problème que la traduction de YouTube/Web of Science etc. n'est pas sensible lors du changement d'onglets.
...
- La traduction de livres électroniques bilingues traduira désormais également la table des matières.
...
- Correction de la création d'eBooks Epub à partir du panneau en cliquant sur les traductions ne fonctionnant pas
...
- [Prise en charge de la hoverball configurée pour être fixée à gauche #1168](https://github.com/immersive-translate/immersive-translate/issues/1168)
...
- [L'activation temporaire de la traduction web pendant une période de temps ne désactive pas Toujours Traduire #1172](https://github.com/immersive-translate/immersive-translate/issues/1172)
...
- Résolution du problème que certaines plateformes ne pouvaient pas reconnaître si la souris était prise en charge ou non
  - Il existe certains navigateurs de bureau qui prennent en charge à la fois l'écran tactile et la souris, et Immersive Translates est techniquement incapable de détecter si ces plateformes prennent en charge la souris, nous avons donc ajouté l'option [Forcer l'activation de la prise en charge de la souris] dans le paramètre [Survol de la souris]
...
- Ajout d'une alerte de mise à jour de version basse pour Grease Monkey
...
- Correction du conflit de sous-titres Youtube avec le plugin de sous-titres doubles (Immersive Translate de la traduction des sous-titres Youtube n'est pas activé lorsque le plugin Youtube Dual est détecté pour éviter les conflits)
...
- Optimiser la détection de l'amélioration de l'entrée pour réduire les faux contacts
...
- Ajouter un changement d'état de l'icône du navigateur, lorsqu'une page web a été traduite, un ✅ sera automatiquement ajouté en bas à droite de l'icône du navigateur.
...
- Résultats de traduction de support d'amélioration d'entrée ctrl+z Annuler
...
- Corriger le problème de débordement de largeur du Popup Safari.
...
- Correction d'un problème : certains tags de code n'étaient pas reconnus correctement.
...
- Correction du problème : le réglage temporaire de la durée de traduction du site web n'a pas d'effet.
...
- UI : meilleure interface pour la page d'eBook
...
- Correction : utilisation élevée de la mémoire pour les userscripts et les extensions (en supprimant opencc zh-CN vers zh-TW, remplacé par Google translate)
...
- Fonctionnalité : Supporter la couleur de texte de traduction personnalisée, couleur de bordure.
...
- Correction de la traduction caiyun avec langue source indéfinie
...
- Amélioration de l'interface utilisateur du popup
- Amélioration des conseils pour les mauvais userscripts
...
- Correction de l'injection CSS dans l'iframe dynamique

## 0.2.30

- Supporter la traduction en ligne de l'iframe du userscript.
...
- Supporter la traduction en ligne de l'iframe. (Seulement pour l'extension, non disponible pour
  le userscript)
...
- Supporter la traduction d'iframe, comme le courrier QQ, le tweet intégré.
...
- Correction de l'absence de fonctionnement de safari globalThis.GM

## 0.2.13

- Supporter le glissement du popup du userscript
- Supporter trois doigts sur l'appareil tactile pour déclencher le basculement des pages de traduction
- Supporter la dissimulation de l'icône du popup du userscript.
...
- Supporter le résultat de cache pour le userscript
...
- activer tous les sites pour détecter la langue des paragraphes.
...
- Supporter le mode de traduction immédiate, pour que vous puissiez laisser la page web se traduire
  aussi rapidement que possible.
- Supporter la définition de la zone de page à traduire. pour que vous puissiez traduire plus de zones.
...
- Ajouter les thèmes en pointillés, en tirets fins
- Mieux pour les thèmes en pointillés, en surbrillance

## 0.0.28

- Corriger le soulignement
- Ajouter les thèmes en pointillés, papier
...
- Supporter selectorMatches, pour que nous puissions maintenant correspondre à tous les manstondon.
...
- Corriger certains tags span qui sont des éléments de bloc

## 0.0.20

- Supporter de ne pas traduire les hashtags comme #hash, les tags at comme @xxx, $tag, comme $APPL
...
- Supporter la vérification de nouvelle version
