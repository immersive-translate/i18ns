...
- Ajouté : Support pour définir le nombre d'écrans à pré-traduire lors de la navigation sur la page actuelle.
...
- Optimisé : Amélioration du support pour la traduction d'images sur certains sites web.
...
- Les services de traduction AI peuvent désormais personnaliser la liste des modèles, tels que [OpenAI], le système n'a que quelques-uns des modèles les plus couramment utilisés intégrés. En cliquant sur la liste déroulante des modèles, le dernier élément que vous voyez est [Set More Models], après réglage, il sera automatiquement mémorisé pour la commodité des utilisateurs testant différents modèles personnalisés.
...
- Les services de traduction sont désormais distinctement organisés sous un onglet séparé, permettant une vue d'ensemble complète de tous les services de traduction disponibles. De plus, les utilisateurs ont la flexibilité de personnaliser les services de traduction affichés. Par défaut, seule une sélection limitée de services de traduction est affichée, mais les utilisateurs peuvent adapter leurs préférences d'affichage dans la section [More Services](https://dash.immersivetranslate.com/#services).
...
- [Prise en charge de la bulle de survol configurée pour être fixée à gauche #1168](https://github.com/immersive-translate/immersive-translate/issues/1168)
...
- Correction pour la fonction [désactiver définitivement les sous-titres vidéo] ne fonctionnant pas [#1175](https://github.com/immersive-translate/immersive-translate/issues/1175)
...
- Les pages PDF en ligne sans extension .pdf peuvent désormais passer directement à la page de traduction PDF en cliquant sur la bulle de survol sur la page.
...
- Résolution du problème que certaines plateformes ne pouvaient pas reconnaître si la souris était prise en charge ou non
  - Il y a certains navigateurs de bureau qui prennent en charge à la fois l'écran tactile et la souris, et Immersive Translates est techniquement incapable de détecter si ces plateformes prennent en charge la souris, nous avons donc ajouté l'option [Forcer l'activation de la prise en charge de la souris] dans le paramètre [Survol de la souris]
...
- Ignorer la langue "Ne jamais traduire" lors du survol de la souris
...
- Correction de Youtube retournant occasionnellement à la page d'accueil
...
- Corriger le problème de texte non traduit lors du clic sur plus de texte
...
- Ajouter le changement de statut de l'icône du navigateur, lorsqu'une page web a été traduite, un ✅ sera ajouté automatiquement en bas à droite de l'icône du navigateur.
...
- Optimisation de la traduction de la boîte de saisie, fonctionne maintenant en douceur dans Bard !
...
- Tapez : // Hello World dans la boîte de saisie sur n'importe quelle page, puis triple-cliquez sur la barre d'espace pour traduire le paragraphe.
- Vous pouvez également spécifier une langue de traduction : /ja Hello World, puis triple-cliquez sur la barre d'espace pour traduire le paragraphe en japonais
...
- Les fonctionnalités sont en grande partie inchangées (de nouvelles fonctionnalités seront disponibles prochainement)
...
- Correction : l'état d'entrée des services de traduction de commutation de l'UI des options n'a pas changé.
...
- Correction : Certains sites utilisent `span` pour les styles, nous utilisons donc `font` au lieu de span pour l'encapsulation de la cible de traduction
- Correction : Limite maximale de jetons OpenAI, changer les caractères max de 1500 à 1300
...
- Meilleur pour détecter le nombre japonais
...
- Correction de la traduction de base de PDF
