...
- Corrigé : Un problème où le service de traduction AI sortait incorrectement du chinois simplifié lors de la traduction du chinois traditionnel.
- Corrigé : Un problème avec la traduction au survol ne fonctionnant pas en mode "Traduction d'abord, texte original ensuite".
...
- Ajouté : Grok, Ollama, Groq, Azure-OpenAI service de traduction.
...
- Optimisé : Compatible avec des modèles comme o1, o3 qui ne prennent pas en charge le rôle système (le paramètre de rôle système ne sera pas passé lorsque la configuration de l'invite système est vide).
...
- Amélioré : Accès à l'interface de test de la page de paramètres en ligne.
...
- Corrigé : Problème où **Mouse Hover Translation** ne pouvait pas traduire le texte enrichi.
...
- Corrigé : Problème de détection incorrecte de la langue dans **Enhanced Input Box**.
- Corrigé : Problème de correspondance intelligente des experts AI dans les services de traduction personnalisés.
- Corrigé : Échec de la synchronisation Google Drive sur certains navigateurs.
...
- Amélioré : **Image Translation** est désormais compatible avec weibo.com (pris en charge uniquement sur Chrome et Edge).
- Amélioré : Lorsque la langue de l'interface est définie sur l'anglais, la langue cible par défaut pour **Enhanced Input Box** est changée en chinois.
- Amélioré : Ajout d'une entrée de révision de magasin dans les options **More** sur le panneau.
...
- Corrigé : Le problème où **Mouse Hover Translation** ne fonctionne pas sur certains sites web.
...
- Corrigé : le problème des nombres décimaux étant forcés de se casser en ligne lors de la traduction de longs textes.
...
- Corrigé : Après avoir changé de services de traduction, le service de traduction dans "**Enhanced Input Box**" ne se met pas à jour.
...
- Ajouté : **AI Context-Aware Translation** peut améliorer la précision de la traduction de contenu professionnel. (Disponible uniquement pour les membres Pro, pris en charge exclusivement par les modèles OpenAI) **Options** -> **Grneral** -> **Enable AI Context-Aware Translation**
...
- Corrigé : Les raccourcis clavier devenant inefficaces lors de l'activation ou de la désactivation de la fonctionnalité "**Hover Translation**".
...
- ~~Amélioré : Ajout de l'option pour personnaliser la "**Enable Sidebar & Navbar Translation**" dans "**Advanced Settings**".~~
- Amélioré : Les images ne sont plus traduites en mode "**Hover - immediately translate this paragraph**".
...
- Ajouté : La **Subtitles Translation** en temps réel prend désormais en charge l'activation via "float ball", disponible sur Zoom, Google Meet et Microsoft Teams.
...
- Corrigé : Problèmes avec la fonctionnalité d'annulation Ctrl+Z dans **Enhanced input** sur certains sites web.

## 1.10.6 (2024-10-25)

- Corrigé : Problème avec les raccourcis **Enhanced input** ne se déclenchant pas.
...
- Ajouté : Mode Forece Enable Mouse Support (Activez cette fonctionnalité uniquement si la fonction de survol de la souris n'est pas disponible sur les appareils tablette) **Paramètres** -> **Paramètres avancés** -> **Forece Enable Mouse Support**
...
- Amélioration du support d'entrée pour Baidu, Gmail et d'autres champs de saisie
- Support pour l'en-tête de requête anthropic-dangerous-direct-browser-access pour l'API Claude Anthropic
- Support pour le téléchargement de sous-titres des vidéos Hulu, Bloomberg et Domestika
...
- Le service de traduction DeepL prend désormais officiellement en charge le chinois traditionnel comme langue cible (auparavant, la traduction en chinois traditionnel avec DeepL impliquait un processus de conversion supplémentaire de chinois simplifié à chinois traditionnel par un tiers).
...
- Ajout de l'option "Signaler des problèmes de traduction de la page actuelle" et de l'option "Activer/désactiver rapidement la boule flottante" dans les options supplémentaires du panneau.
...
- Vous pouvez maintenant traduire du texte dans les boîtes de saisie avec un clic droit : Sélectionnez n'importe quel texte dans une boîte de saisie sur une page web, cliquez avec le bouton droit pour choisir traduire, et la traduction immersive traduira automatiquement le texte sélectionné dans la langue cible de la boîte de saisie, ce qui permet de traduire rapidement le texte en langue maternelle dans les boîtes de saisie vers d'autres langues.
...
- En raison des restrictions du site YouTube, le script Chrome Tampermonkey ne prend plus en charge les sous-titres bilingues de YouTube. Veuillez utiliser la [version du plugin](https://immersivetranslate.com/).
...
- Corrigé le problème où les sous-titres ne s'affichent pas sur YouTube en mode "Traduction uniquement".
- Corrigé le problème des sous-titres bilingues ne fonctionnant pas sur Mubi.
...
- Dans les sous-titres bilingues vidéo, lorsque la langue cible est le chinois simplifié et que le texte original est en chinois traditionnel, le texte original sera automatiquement converti en chinois simplifié, et vice versa.
...
- Optimisation des mots d'invite pour les services de traduction AI

## 1.5.2

- Correction du problème où les modifications de l'invite d'expert général remplaçaient l'invite d'expert AI spécifiée [#1692](https://github.com/immersive-translate/immersive-translate/issues/1692)
- Le nom de modèle AI personnalisé prend en charge la syntaxe avancée, utilisez + pour ajouter un modèle, utilisez - pour masquer un modèle, et utilisez model_name=display_name pour personnaliser le nom d'affichage du modèle, par exemple : +gpt-3.5-turbo,-gpt-4,gpt-4-turbo=gpt-4-super
...
- Prise en charge des services de traduction AI pour définir [AI Expert] afin de spécifier la stratégie de traduction, actuellement une fonctionnalité Beta, qui peut être activée dans [Paramètres développeur](https://dash.immersivetranslate.com/#developer) après avoir activé Beta, et le menu [AI Expert] peut être vu après actualisation.
...
- Prise en charge des paramètres d'activation indépendants pour les sous-titres bilingues vidéo YouTube (activé par défaut pour les nouveaux utilisateurs)
...
- Les services de traduction sont désormais distinctement organisés sous un onglet séparé, permettant une vue d'ensemble complète de tous les services de traduction disponibles. De plus, les utilisateurs ont la flexibilité de personnaliser les services de traduction affichés. Par défaut, seule une sélection limitée de services de traduction est affichée, mais les utilisateurs peuvent adapter leurs préférences d'affichage dans la section [Plus de services](https://dash.immersivetranslate.com/#services).
...
- Le commutateur de panneau pour n'afficher que le bouton de traduction modifié pour n'affecter que la page actuelle
...
- Correction du support de l'application iOS immersive pour la lecture en plein écran sur YouTube.
...
- Optimisation : Page des paramètres, interaction de l'interface utilisateur de la liste des URL (pour éviter toute ambiguïté, les cases à cocher ne sont pas affichées par défaut).
...
- Correction : Lors de la traduction de pages, le survol de la souris ne déclenchait pas la retraduction.
...
- Correction du problème où la traduction des champs de saisie contenant des URL ne traduisait que des parties du contenu.

## 1.1.2

- Correction : Le problème où le changement de services de traduction ne prenait pas effet lorsque la page n'avait pas encore été traduite.
...
- **Paramètres de raccourcis clavier** : Ajout d'un nouveau menu de niveau supérieur "Raccourcis" et des fonctions de raccourcis clavier personnalisables suivantes :
  ...
  - Désigner une combinaison de touches pour traduire le contenu de la boîte de saisie actuelle, en complément de la méthode précédente consistant à appuyer rapidement trois fois sur la barre d'espace.
  ...
  - Ajout de raccourcis clavier dédiés pour 6 services de traduction (tels que DeepL, OpenAI, Google, Microsoft, Gemini, Tencent Interactive Translation) pour faciliter le changement temporaire entre les services de traduction.
...
- **Mise à jour de la configuration openAI** : Prend désormais en charge le réglage du nombre de configurations par seconde en décimales, comme 0.5, ce qui signifie 1 requête toutes les 2 secondes.
...
- Optimisation : Lors de l'utilisation du survol de la souris, le problème où la perte de focus sur la page et le re-déclenchement deviennent inefficaces.
...
- Ajout de sous-titres bilingues pour prendre en charge les plateformes [TED](https://www.ted.com), [Frontend Masters](https://frontendmasters.com/), [edx](https://www.edx.org/), [CodeWithChris](https://www.edx.org/), [Skillshare](https://www.ted.com) plateformes. https://learn.codewithchris.com/enrollments), [Skillshare](https://www.skillshare.com/) plateformes
...
- La fonction d'amélioration de la recherche (certaines pages de Google Search affichent des résultats de recherche bilingues) n'est désormais pas activée par défaut et sera supprimée dans la prochaine version.
...
- Fournit un accès rapide aux versions bilingues de tous les articles sur le site des articles [Arxiv](https://arxiv.org/abs/1910.06709).
...
- Ajout d'un portail de traduction rapide PDF sur le côté droit du site des articles [Arxiv](https://arxiv.org/abs/1910.06709), qui mène à une page HTML propre (seulement pris en charge par certains articles, car cela nécessite que les auteurs originaux soumettent le code source, donc environ 50% des articles afficheront ce portail)
- Les pages PDF en ligne sans extension .pdf peuvent désormais passer directement à la page de traduction PDF en cliquant sur la hoverball sur la page.
...
- Résolution du problème où certaines plateformes ne pouvaient pas reconnaître si la souris était prise en charge ou non
  - Il existe certains navigateurs de bureau qui prennent en charge à la fois l'écran tactile et la souris, et Immersive Translates est techniquement incapable de détecter si ces plateformes prennent en charge la souris, nous avons donc ajouté l'option [Forcer l'activation du support de la souris] dans le paramètre [Survol de la souris]
...
- Correction des clics saccadés de la hoverball de la page
...
- Correction du conflit de sous-titres Youtube avec le plugin de sous-titres doubles (la traduction des sous-titres Youtube d'Immersive Translate n'est pas activée lorsque le plugin Youtube Dual est détecté pour éviter les conflits)
...
- Correction du problème de traduction de la clé d'authentification DeppL personnalisée

## 0.10.3

- Prise en charge parfaite des vidéos Youtube avec sous-titres bilingues 🎉.
...
- Optimisation de la contextualisation de la traduction des fichiers de sous-titres OpenAI

## 0.10.1

- Augmenter la priorité de la traduction du corps pour optimiser l'expérience de traduction
- Corriger le problème de texte non traduit lors du clic sur plus dans ins

## 0.9.8

- Optimiser l'expérience, corriger certains bugs

## 0.9.7

- Corriger la traduction automatique lorsque readwise est surligné
...
- Optimiser la détection de l'amélioration de l'entrée pour réduire les fausses touches
- Traduction de livres électroniques et de sous-titres en ligne

## 0.9.3

- Traduction de la boîte de saisie : affiche un rappel contextuel lors de la première utilisation, et l'utilisateur peut choisir de le désactiver cette fois-ci ou de manière permanente pour éviter les touches accidentelles.
...
- Corriger les problèmes de nom de fichier lors de la création d'un ebook Epub

## 0.8.8

- Le pdf prend en charge les ajustements de l'espacement des lignes et des mots pour re-reconnaître les paragraphes
- Correction du problème de défilement automatique lors de la lecture en ligne d'epub sur mobile

## 0.8.7

- Le pdf prend en charge uniquement les téléchargements de traduction
- Corriger le problème de connexion Google sur safari
...
- Prise en charge de la traduction AliCloud
...
- Désactiver temporairement la fonction d'exportation PDF de Safari en raison de la restriction de Safari sur les téléchargements de plug-ins (bug).
- Corriger d'autres problèmes

## 0.7.10

- Mise à niveau de l'UI du panneau d'icônes du navigateur contextuel, un peu plus de design ～
- Corrige le problème que certains passages japonais ne sont pas traduits.
...
- Ajouter un changement de statut de l'icône du navigateur, lorsqu'une page web a été traduite, un ✅ sera automatiquement ajouté en bas à droite de l'icône du navigateur.
- Activer automatiquement la traduction des sites web anglais fréquemment utilisés pour les nouveaux utilisateurs
- Corriger les problèmes de traduction avec https://claude.ai/

## 0.7.6

- Résultats de traduction de support d'amélioration de l'entrée ctrl+z Annuler
- Prise en charge de la traduction en mode de lecture de document Flying Book
- Adaptation https://pi.ai/talk

## 0.7.5

- Corriger l'icône Grease Monkey qui ne s'affiche pas
...
- Prise en charge de l'amélioration de la recherche, lorsqu'elle est activée, lorsque vous effectuez une recherche sur Google/Google News en chinois, la colonne de droite affichera automatiquement les résultats de recherche des mots-clés anglais correspondants, ce qui est activé par défaut.
...
- Modifier les paramètres par défaut : En raison d'un grand nombre de retours d'utilisateurs indiquant qu'ils n'utiliseront pas l'outil de traduction après l'installation, leur attente de l'outil de traduction est qu'il traduise automatiquement les pages web anglaises après l'installation, donc à partir de cette version, pour les utilisateurs chinois, l'option de traduction des pages anglaises par défaut a été activée (si l'utilisateur a déjà défini une langue qui sera toujours traduite, alors elle sera respectée, et le changement ne modifie que les paramètres initiaux de l'extension), et elle doit être annulée, elle peut être facilement annulée dans [Panneau contextuel ou page des paramètres](/docs/faq/#%E5%A6%82%E4%BD%95%E5%85%B3%E9%97%AD%E8%87%AA%E5%8A%A8%E7%BF%BB%E8%AF%91)

## 0.6.19

- Corriger les bugs PDF
- Corriger le bug du web of science
- Adaptation feeder.com
- Corriger le problème de non-traduction de certains livres epub

## 0.6.18

- Corriger le problème de débordement de la largeur du Popup Safari.
...
- Ajouter l'affichage de la page sans permission PDF
...
- Réparer le problème que lors de l'ouverture de fichiers PDF, le panneau d'extension indique qu'il n'y a pas de permissions.
- Corriger le problème que l'amélioration de la boîte de saisie n'est pas activée lorsque le site est configuré pour ne jamais traduire.
...
- Corriger le problème de traduction répétée au survol de la souris
- La traduction PDF prend en charge le glisser pour changer la taille et éditer le contenu de la traduction

## 0.6.12

- Corrige les images de traduction Epub qui deviennent plus petites dans certains navigateurs
...
- Corriger certains styles de boîte de saisie
...
- Corriger les attaques possibles par injection XSS
...
- Corriger le problème que : les eBooks bilingues n'ont pas d'images après l'exportation

## 0.5.16

- Corriger : problème de traduction openai en chinois traditionnel

## 0.5.15

- Optimiser : Le nombre minimum de caractères dans un paragraphe qui déclenche la traduction a été modifié à un minimum de 4 caractères pour réduire la confusion, tout en utilisant d'autres fonctionnalités pour éviter de traduire les zones de navigation et de fin du site.
- Corriger : les détails de Github ne se traduisant pas après expansion.

## 0.5.14

- Corriger le problème que les images sur certaines pages web de : deviennent plus grandes après copie
- Corriger : la section des commentaires de medium ne se traduisant pas
- Corriger le problème que les images sur certaines pages de : étaient copiées incorrectement

## 0.5.12

- Fonctionnalité : Le style de traduction avec ligne de séparation ajoute une ligne de séparation verticale pour les traductions sur une seule ligne
...
- Support de traduction de sous-titres pour l'exportation de traductions uniquement
...
- Correction d'un problème : où certaines balises de code n'étaient pas reconnues correctement.
...
- Réécriture de l'analyse du noyau web, ce qui signifie :
  ...
  - Traduction de pages web à grande échelle en quelques secondes
    - Par exemple, : https://pve.proxmox.com/pve-docs/pve-admin-guide.html, qui prenait 30 secondes auparavant, est maintenant retournée en quelques secondes.
...
- Correction du problème selon lequel la modification du raccourci de survol de la souris nécessitait un rafraîchissement de la page pour prendre effet
...
- Correction : problème de popup de nouvel onglet macOS.
...
- Fonctionnalité : L'application iOS ajoute un bouton d'activation d'extension et un lien vers les communautés
...
- UI : Ajouter le statut d'exportation pour l'exportation epub.
...
- Correction : l'état d'entrée des services de traduction de commutation de l'UI Options ne change pas.
...
- UI : mieux pour faire l'UI de la page d'eBook
...
- Correction : Certains sites utilisent `span` pour les styles, donc nous utilisons `font` au lieu de span pour l'enveloppe de cible de traduction
...
- Correction : options form UI
- Correction : Open AI prompt
- Fonctionnalité : Supporter plusieurs clés OpenAI, utilisez `,` pour les séparer.
...
- Fonctionnalité : Supporter le thème de traduction gris
- Correction : Page Trending de Github

## 0.2.72

- Correction : problème de réseau de vérification du service de traduction sur mobile firefox.
...
- Correction : utilisation élevée de la mémoire pour les userscripts et les extensions (en supprimant opencc zh-CN vers zh-TW, à la place avec Google translate)
...
- Correction : échec de la traduction de fichier PDF, bug de la version 0.2.60 pour le support de deepl de zh-CN à zh-TW
...
- Correction : choisir les services de traduction openl
...
- Correction : changement de transparence de 0.4 à 0.618 [#147] (https://github.com/immersive-translate/immersive-translate/pull/147)
- Correction : conseils de raccourcis du popup
- Performance : requêtes en série à concurrence
- Meilleur pour détecter le nombre de japonais
...
- Fonctionnalité : Fonctionnalité Immersive Translate Deepl
...
- Correction : promouvoir la priorité d'exclusion
...
- Fonctionnalité : supporte le CSS injecté sur le tableau de bord des développeurs
- Fonctionnalité : couper authKey, appid appSecret
- Amélioration : ouvrir la page des paramètres dans un nouvel onglet (mais pas pour Stay)
...
- Remplacer les liens du service de traduction
...
- Correction de l'innerText de l'élément est indéfini
...
- Supporter l'activation des fonctionnalités bêta dans le panneau de développement
...
- Correction de l'icône d'importation/exportation
...
- Supporter la traduction de l'iframe en ligne du userscript.
...
- Supprimer la correspondance non standard pour le userscript

## 0.2.27

- Supporter la traduction de l'iframe en ligne. (Seulement pour l'extension, non disponible pour
  userscript)
...
- Supporter la traduction de l'iframe, comme le courrier QQ, le tweet intégré.
...
- Correction de la traduction de la page de plusieurs langues
...
- Changer le surlignage en marquage
...
- Correction de la distance de hauteur de ligne du PDF

## 0.2.9

- Corriger les éléments d'exclusion de balisage
- Corriger le contrôle de type deno
- supprimer importmap
- Corriger la traduction des menus contextuels
- restaurer la page lorsque "ne jamais traduire ce site" est activé
- Ajouter une description pour ajouter une URL

## 0.2.8

- Détecter la langue de l'agent utilisateur pour la langue de l'interface
- Corriger le bug de saut de ligne.

## 0.2.7

- Corriger la requête grease monkey
...
- augmenter la version pour le test ci

## 0.2.4

- capturer l'erreur de connexion de message pour le popup.

## 0.2.3

- Corriger
  [#26](https://github.com/immersive-translate/immersive-translate/issues/26)
  créer le contexte plusieurs fois

## 0.2.2

- Corriger le fichier d'exemple PDF
- Corriger le fichier local pdf Firefox
- Corriger les raccourcis pdf

## 0.2.1

- Supporter le gestionnaire de raccourcis Grease Monkey.
- Corriger la correspondance regex
- Corriger les commentaires youtube.
- Corriger la version compacte mobile de reddit
- Corriger le problème de traduction en texte intégral

## 0.2.0

- Corriger le PDF à deux colonnes.
- Corriger le bug de la version Chrome/Edge Store.
- Corriger
  [#21](https://github.com/immersive-translate/immersive-translate/issues/21)

## 0.1.2

- Publier sur l'addon Firefox
- Publier sur Edge
- corriger la marge pdf.
- Changer le fichier pdf d'exemple

## 0.0.62

- Corriger le format pdf, l'indentation.
- Corriger telegra.ph pour empêcher le changement d'élément

## 0.0.61

- Corriger la fermeture de l'élément span.
- Corriger la permission pour les navigateurs précoces

## 0.0.60

- Corriger le PDF Chrome
...
- Modifier la description du thème de traduction

## 0.0.57

- Changer l'interface utilisateur du popup, pour une utilisation plus facile

## 0.0.56

- Corriger le timeout chrome
- Corriger l'erreur de séparation de phrase.

## 0.0.55

- Corriger l'affichage de l'élément none.
- refactoriser le marquage des éléments

## 0.0.54

- Supporter le saut de ligne pour X caractères.

## 0.0.53

- utiliser sendMessage au lieu de connect, car chrome déconnectera le port après
  5 minutes
- mieux pour détecter les conteneurs de texte

## 0.0.52

- Ne pas traduire le paragraphe qui n'a que des éléments de placeholder, par
  [exemple](https://github.com/nank1ro/solidart), la première ligne.
- Mieux pour détecter les éléments enfants.
...
- Corriger la taille de la police de l'interface utilisateur des options

## 0.0.50

- Corriger la traduction de l'image de bloc.

## 0.0.49

- Corriger l'extension firefox

## 0.0.48

- Corriger l'extension chrome

## 0.0.47

- réécrire le message avec l'arrière-plan, utiliser connect au lieu de sendMessage
- ajouter le support mobile reddit
- corriger l'espace blanc pré pour certains articles

## 0.0.46

- Formater les informations méta du userscript

## 0.0.45

- userscript utilise un fichier.
- ajouter un timeout pour la requête de cache

## 0.0.44

- Corriger l'erreur de séparation tencent.
- Corriger l'erreur de l'élément sup en ligne.
- Mieux pour twitter

## 0.0.43

- Corriger le tweet br
- Corriger la traduction globale.

## 0.0.42

- Corriger la balise BR
- traiter les balises de bloc selon les règles

## 0.0.41

- Corriger la vérification des éléments en ligne
- Ajouter une option de journal de débogage pour les développeurs

## 0.0.39

- Corriger le service de traduction contenant mock2

## 0.0.38

- Supporter le résultat de cache pour userscript
- Ajouter l'interface utilisateur des options
- Supporter la détection de plus de conteneurs de contenu

## 0.0.37

- Corriger le changement de service de traduction du popup qui ne fonctionne pas
- Corriger la traduction du contenu des publications mobiles reddit.

## 0.0.36

- Corriger le caractère spécial de Wikipedia
  [#6](https://github.com/immersive-translate/next-immersive-translate/issues/6)
- Corriger la taille de l'icône du userscript.
- activer tous les sites pour détecter la langue du paragraphe.

## 0.0.35

- Corriger youtube pour passer à la page suivante
- Supporter la page de recherche Youtube.
- Corriger l'interrupteur avancé des options.
- Corriger la balise img, la balise cachée
  [#5](https://github.com/immersive-translate/next-immersive-translate/issues/5)
- Corriger le rafraîchissement forcé de la recherche Google
  [#4](https://github.com/immersive-translate/next-immersive-translate/issues/4)
- Supporter le résultat de tableau de Google
  [#3](https://github.com/immersive-translate/next-immersive-translate/issues/3)
- Corriger le blanc de Wikipedia
...
- Supporter le mode de traduction immédiate, afin que vous puissiez laisser la page web se traduire
  aussi rapidement que possible.
- Supporter la définition de la zone de page à traduire. afin que vous puissiez traduire plus de zones.
- Supporter la définition du premier nombre de textes x à traduire immédiatement.
- Corriger la traduction en double lors du changement de traduction
- Meilleure interface utilisateur du popup

## 0.0.33

- Supporter plus de langues, zh-TW, en

## 0.0.32

- Corriger la traduction du fichier local après enregistrement. Corrigé
  [#1](https://github.com/immersive-translate/next-immersive-translate/issues/1)
- Ajouter le fichier dist js au dépôt public

## 0.0.31

- Supporter la traduction de la page entière
- Supporter la traduction immédiate de la page
- Plus d'interface utilisateur de configuration
- Refléter le thème
- Ajouter une nouvelle icône
- Ajouter un nouveau thème de traduction dashedBorder
...
- Corriger la validité du paragraphe.
- Ajouter des thèmes en pointillés, en tirets fins
- Mieux pour les thèmes en pointillés, en surbrillance

## 0.0.28

- Corriger le soulignement
- Ajouter des thèmes en pointillés, en papier
- Corriger la détection de l'en-tête

## 0.0.27

- Supporter translationTheme

## 0.0.26

- Corriger la permission de connexion du userscript volc alpha.
- Corriger la version cliquable.

## 0.0.25

- Supporter selectorMatches, afin que nous puissions maintenant correspondre à tous les manstondon.
- Corriger l'erreur du userscript Firefox.

## 0.0.23

- Mieux pour la détection du chinois
- Corriger le problème d'innerText de reddit

## 0.0.22

- Supporter deeplx
- Corriger la traduction multiple lors du changement de service

## 0.0.21

- Corriger certaines balises span qui sont des éléments de bloc

## 0.0.20

- Supporter ne pas traduire les hashtags comme #hash, les balises at comme @xxx, $tag, comme $APPL
- Supporter l'élément de bloc

## 0.0.18

- Supporter deepl, bing, baidu, youdao, volc, openl, caiyun.

## 0.0.13

- Supporter userscript

## 0.0.4.8

- Corriger l'ordre du code.
- Supporter l'interface utilisateur de base du popup

## 0.0.4.6

- Supporter la vérification de la nouvelle version

## 0.0.3

- Supporter les fichiers locaux

## 0.0.2

- Supporter les éléments dynamiques
- Supporter la traduction visible