...
- Ajouté : Prise en charge de l'activation des sous-titres AI de Youtube sur PC (membres Pro)
...
- Corrigé : Un problème où le raccourci de traduction au survol ne fonctionnait pas sur les appareils prenant en charge à la fois la souris et le tactile.
- Ajouté : Prise en charge de la traduction du grand modèle Youdao Ziyue.
...
- Corrigé : Un problème avec la traduction au survol ne fonctionnant pas en mode "Traduction d'abord, texte original suit".
...
- Amélioré : Ajout d'une entrée de révision du magasin dans les options **Plus** sur le panneau.
...
- Corrigé : Les raccourcis devenant inefficaces lors de l'activation ou de la désactivation de la fonctionnalité "**Traduction au survol**".
...
- Fixed: Problème de traduction de formule causé par l'amélioration de la traduction Twitter dans la version 1.11.2.

## 1.11.2 (2024-11-13)

- Fixed: Problème où le contenu disparaît après avoir cliqué sur "voir plus" dans le mode de traduction uniquement de Facebook.
- ~~Improved: Amélioration de l'affichage des traductions bilingues multiligne sur Twitter.~~
- Improved: Mise à jour de l'interface utilisateur de la liste déroulante du service de traduction dans le panneau.

## 1.11.1 (2024-11-05)

- Added: La **traduction des sous-titres** en temps réel des réunions peut désormais être activée via la "balle flottante", disponible sur Zoom, Google Meet et Microsoft Teams.
- Fixed: Problèmes de synchronisation des sous-titres sur YouTube après avoir regardé des publicités.
- Fixed: Problèmes d'affichage avec le menu de traduction par clic droit dans Safari sur MacOS 15.
- Fixed: Problèmes avec la fonctionnalité d'annulation Ctrl+Z dans l'**Enhanced input** sur certains sites web.

## 1.10.6 (2024-10-25)

- Fixed: Problème avec les raccourcis clavier de l'**Enhanced input** qui ne se déclenchent pas
- Improved: Réduction de la taille du package d'installation
- Improved: Solution d'affichage des sous-titres Netflix

## 1.10.5 (2024-10-23)

- Added: Afficher un avertissement lorsque la langue source et la langue cible sont identiques
- Fixed: Problème de traduction des caractères d'espacement dans le texte enrichi [#2175](https://github.com/immersive-translate/immersive-translate/issues/2175)
- Improved: Amélioration de l'entrée et de la fonctionnalité de survol de la souris dans les iframes intégrées sur les pages web

## 1.10.2 (2024-10-11)

- Added: Traduction d'image (version Beta)
- Added: Mode Forcer l'activation du support de la souris (Activez cette fonctionnalité uniquement si la fonction de survol de la souris n'est pas disponible sur les appareils tablette) **Paramètres** -> **Paramètres avancés** -> **Forcer l'activation du support de la souris**
- Added: Afficher un message d'erreur lorsque la traduction des sous-titres vidéo échoue
- Fixed: Problème de traduction de texte enrichi [#2163](https://github.com/immersive-translate/immersive-translate/issues/2163)
- Improved: Résolution des problèmes où le bouton de traduction pourrait ne pas fonctionner lors de la traduction de PDF
- Improved: Amélioration du rendu des formules traduites
- Improved: Liste de sélection des langues

## 1.9.8 (2024-09-28)

- Added: Service de traduction "Zhipu BigModel"
- Removed: Modèle "SiliconCloud" qwen1.5-7B-chat (en raison de l'arrêt officiel)
- Fixed: Résolution du problème de compatibilité de connexion avec le plugin Safari sur macOS 15
...
- Fixed: Problème de synchronisation des experts AI personnalisés
...
- Fixed: Problème d'affichage des sous-titres bilingues pour plusieurs vidéos sur la même page Twitter
- Fixed: Quelques bugs
...
- Fixed: Problème où la boîte de saisie dans l'interface de message privé de Tiktok était mal traduite
- Fixed: Problème où les bandes dessinées sur Read Comic Online ne pouvaient pas être traduites
- Fixed: Problème où le [Paramètres avancés -> Nombre minimum de caractères requis pour traduire un paragraphe] ne prenait pas effet dans certains cas
...
- Google Meet prend désormais en charge les sous-titres bilingues pour les réunions en direct : Vous pouvez désormais profiter de la fonctionnalité de sous-titres bilingues dans les réunions Google Meet. Ouvrez simplement le lien de la réunion, activez les sous-titres bilingues dans le panneau de traduction immersive, puis actualisez la page pour en faire l'expérience.
...
- Fixed: Problèmes de traduction avec le script Tampermonkey SiliconCloud
...
- Fixed: Problèmes de traduction de texte enrichi pour les services de traduction tels que Google, DeepL (par exemple, pages affichant directement `<button>` etc.)
- Fixed: Problème où le raccourci bilingue pour les vidéos YouTube ne pouvait pas être désactivé.

## 1.7.8

- DeepL, Microsoft Translate, Google Translate, OpenAI, Claude, Gemini et d'autres services de traduction prennent en charge la traduction pour conserver le formatage du texte original (par exemple, liens, gras, etc.)
...
- Fixed: Échec de la traduction de bandes dessinées dans le navigateur Firefox.
...
- Mots-clés optimisés pour Gemini
...
- Optimisation des pop-ups d'erreur, les pop-ups d'erreur de problème de réseau détectent automatiquement les services de traduction gratuits valides.
...
- **Guide pour les Nouveaux Utilisateurs** : Lorsque de nouveaux utilisateurs ouvrent une page dans une langue non cible, une bulle d'aide flottante est affichée.

### Optimisation et Corrections

- **Optimisation de l'UI** : Refonte de l'UI pour les messages d'erreur de traduction de page afin de les rendre plus compréhensibles. Lorsqu'il y a de nombreuses erreurs, une fenêtre pop-up avertira activement l'utilisateur.
...
- **Mise à Jour de la Configuration openAI** : Supporte désormais le réglage du nombre de configurations par seconde en décimales, comme 0.5, signifiant 1 requête toutes les 2 secondes.
...
- Correction : Le problème où le cache existait toujours après modification de l'invite/modèle dans OpenAI.

## 0.12.12

- Mise à jour : Optimisation du panneau pop-up, suppression de certaines options pour le site actuel.
- Optimisation : Amélioration du processus de fusion des sous-titres manuels.
- Optimisation : Réglage automatique de la langue cible en fonction de la langue du navigateur.
...
- La bulle de survol est maintenant cachée par défaut lorsque la vidéo est en plein écran.
...
- La bulle de survol sur mobile supporte maintenant l'opération de pression longue, pression courte pour traduire, pression longue pour ouvrir le panneau.
- La traduction des ebooks bilingues traduira désormais également la table des matières.
- La fonctionnalité d'Amélioration de la Recherche (certaines pages de Google Search affichent des résultats de recherche bilingues) n'est maintenant pas activée par défaut et sera supprimée dans la prochaine version.
...
- Ajout d'un portail de traduction rapide PDF sur le côté droit du site des articles [Arxiv](https://arxiv.org/abs/1910.06709), qui mène à une page HTML propre (seulement supportée par certains articles, car elle nécessite que les auteurs originaux soumettent le code source, donc environ 50% des articles afficheront ce portail)
...
- Résolution du problème que certaines plateformes ne pouvaient pas reconnaître si la souris était supportée ou non
  - Il y a certains navigateurs de bureau qui supportent à la fois l'écran tactile et la souris, et Immersive Translates est techniquement incapable de détecter si de telles plateformes supportent la souris, donc nous avons ajouté l'option [Forcer l'activation du support de la souris] dans le paramètre [Survol de la souris]
...
- Ajout du changement de statut de l'icône du navigateur, lorsqu'une page web a été traduite, un ✅ sera ajouté automatiquement en bas à droite de l'icône du navigateur.
...
La langue par défaut pour la traduction de la boîte de saisie peut maintenant omettre l'espace, c'est-à-dire //Hello World peut être traduit également.
...
- Correction : la page de détails de Reddit renvoie certains paragraphes qui ne peuvent pas être traduits
...
- UI : permettre la réinitialisation d'Open AI aux paramètres par défaut
...
- Correction : meilleure division des longs paragraphes, 1,5 milliard, 25,5%, M. ne sera pas considéré comme une limite
...
- Meilleur : détection du conteneur japonais/coréen.
...
- Correction : Détection de la langue des livres électroniques.
- Fonctionnalité : Ajouter la progression de la traduction pour le constructeur de livres électroniques, et un beau confetti après le succès.
- Fonctionnalité : Ajouter un bouton de réessai pour tous les paragraphes échoués.
- Correction : Gestion des erreurs de Deepl
...
- UI : meilleure interface pour la page de livres électroniques

## 0.3.5

- Correction : exportation de livres électroniques pour userscript
...
- Correction : ordre incorrect pour les longs paragraphes
...
- Correction du basculement du masque pour userscript
- Correction de la logique de basculement du masque

## 0.2.43

- Correction du basculement du masque pour userscript avec événement tactile.
...
- Support de la traduction d'iframe en ligne pour userscript.
...
- Correction de la construction de userscript
...
- Correction du bug de la version du Chrome/Edge Store.
- Correction
...
- Support de la définition du nombre de premiers x textes à traduire immédiatement.
...
- Correction du problème d'innerText de Reddit
