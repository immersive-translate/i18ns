...
- Ajouté : Prise en charge de l'activation des sous-titres AI sur Youtube pour la version PC (membres Pro)
...
- Fourniture de plus de papiers arXiv avec une mise en page de traduction bilingue optimisée
...
- Optimisation de la détection pour les traductions de papiers arXiv
...
- Ajout de la traduction de grand modèle Zero-One-Thing, qui peut être utilisée en remplissant la clé API après l'enregistrement sur la plateforme Zero-One-Thing.
...
- **Paramètres des raccourcis clavier :** Ajout d'un nouveau menu de niveau supérieur "Raccourcis" et des fonctions de raccourci clavier personnalisables suivantes :
...
- La bulle de survol sur mobile prend désormais en charge l'opération de pression longue, une pression courte pour traduire, une pression longue pour ouvrir le panneau.
...
- Correction du problème de traduction avec la clé d'authentification personnalisée DeppL
...
- Correction : Mauvais ordre pour les longs paragraphes
...
- Fonctionnalité : Support du zoom de la taille de police personnalisée
...
- Support de l'activation des fonctionnalités bêta au panneau de développement
...
- Correction du bug de la version Store de Chrome/Edge.
- Correction de
...
- Correction de l'espace blanc `pre` pour certains articles
...
- Support du mode de traduction immédiate, pour que la page web se traduise aussi rapidement que possible.
- Support de la définition de la zone de la page à traduire, pour traduire plus de zones.
...
- Ajout des thèmes en pointillés, en tirets fins
- Amélioration pour les thèmes en pointillés, en surbrillance
...
- Support de `selectorMatches`, pour correspondre à tous les `manstondon` maintenant.
- Correction de l'erreur du userscript Firefox.

## 0.0.23

- Amélioration pour la détection du chinois
- Correction du problème `innerText` sur Reddit
...
- Correction de certains éléments `span` qui sont des éléments de bloc

## 0.0.20

- Support de la non-traduction des hashtags comme #hash, des tags @ comme @xxx, des tags $ comme $APPL
