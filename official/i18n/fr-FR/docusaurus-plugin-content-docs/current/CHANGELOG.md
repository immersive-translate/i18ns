...
- Ajouté : Le navigateur Android prend en charge la traduction d'images gratuite. 【En attente, besoin d'attendre la Release du navigateur】
...
- Optimisé : [Traduction d'images gratuite] prend en charge le formatage pour les langues de droite à gauche.
- Optimisé : Compatible avec les modèles comme o1, o3 qui ne prennent pas en charge le rôle système (le paramètre de rôle système ne sera pas transmis lorsque la configuration de l'invite système est vide).
...
- Corrigé : Problème de sous-titres qui se chevauchent dans certaines vidéos YouTube.
...
- Nouveau : La traduction d'images gratuite est désormais disponible (actuellement prise en charge uniquement sur les versions PC des navigateurs Chrome et Edge), accessible via le menu contextuel.
...
- Amélioré : **Expert AI** peut être utilisé avec **Traduction contextuelle AI**.
- Amélioré : **Traduction d'images** est désormais compatible avec weibo.com (pris en charge uniquement sur Chrome et Edge).
...
- Corrigé : Le commutateur "**YouTube Activer Bilingue**" dans la page des paramètres ne fonctionne pas.
- Amélioré : Suppression du modèle gemini-1.0-pro obsolète.

## 1.12.4 (2024-12-13)

- Ajouté : **Traduction contextuelle AI** peut améliorer la précision de la traduction de contenu professionnel. (Disponible uniquement pour les membres Pro, pris en charge exclusivement par les modèles OpenAI) **Options** -> **Général** -> **Activer la traduction contextuelle AI**
...
- Amélioré : Amélioration de la saisie et de la fonctionnalité de survol de la souris dans les iframes intégrées sur les pages web.
...
- Le commutateur de panneau pour n'afficher que le bouton de traduction modifié pour n'avoir d'effet que sur la page actuelle
...
- Ajout de sous-titres bilingues pour les plateformes [TED](https://www.ted.com), [Frontend Masters](https://frontendmasters.com/), [edx](https://www.edx.org/), [CodeWithChris](https://www.edx.org/), [Skillshare](https://www.ted.com) platforms. https://learn.codewithchris.com/enrollments), [Skillshare](https://www.skillshare.com/) Platforms
...
- Prise en charge du survol de la souris, appuyez à nouveau sur Ctrl pour afficher le texte original
...
- Corriger le problème de débordement de largeur de la fenêtre contextuelle Safari.
...
- Support de traduction de sous-titres pour l'exportation uniquement
...
- Correction : l'état d'entrée des services de traduction de commutation de l'UI Options n'a pas changé.

## 0.3.8

- UI : couleur de chargement plus transparente
- Correction : Détecter la langue de l'eBook.
- Fonctionnalité : Ajouter une progression de traduction pour le constructeur d'eBook, et un beau confetti après le succès.
...
- Correction du basculement du masque pour le userscript
- Correction de la logique de basculement du masque

## 0.2.43

- Correction du basculement du masque pour le userscript avec événement tactile.
...
- Correction du problème de synchronisation cloud pour le userscript
- Déplacer la page des options avancées vers le menu de gauche.
- Ajouter une logique de réessai au service de traduction

## 0.2.41

- Correction de la traduction niu pour le userscript
...
- Correction de la vitesse pour plusieurs langues
...
- Correction de l'injection CSS pour iframe dynamique

## 0.2.30

- Supporter la traduction d'iframe en ligne pour le userscript.
- Supporter la traduction de shadowroot. Par exemple :
...
- Correction de l'API du navigateur pour le userscript stay.app
...
- Supporter le glissement du popup pour le userscript
- Supporter trois doigts sur l'appareil tactile pour déclencher le basculement des pages de traduction
- Supporter la dissimulation de l'icône du popup pour le userscript.
...
- Correction de la distance de hauteur de ligne pour les PDF

## 0.2.9

- Corriger les éléments d'exclusion de marque
...
- refactoriser la marque d'élément
...
- Corriger la vérification de l'élément en ligne
