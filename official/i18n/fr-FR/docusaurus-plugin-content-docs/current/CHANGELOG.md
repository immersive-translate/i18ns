...
- Corrigé : Les raccourcis deviennent inefficaces lors de l'activation ou de la désactivation de la fonctionnalité "**Traduction au survol**".
...
- ~~Amélioré : Amélioration de l'affichage des traductions bilingues sur plusieurs lignes sur Twitter.~~
...
- Nouvelle fonctionnalité : traduction de mangas (Beta), sur les sites de mangas pris en charge, un bouton de traduction de mangas apparaîtra sous la bulle flottante de traduction rapide de la page web. En cliquant dessus, la traduction de mangas sera activée. Cette fonctionnalité est disponible pour les membres Pro (500 pages par mois, des packs supplémentaires peuvent être achetés), actuellement prise en charge sur les sites suivants :
...
- Nouvelle fonctionnalité : prise en charge du mode de comparaison bilingue avec traduction d'abord et texte original ensuite, qui peut être activé dans la page des paramètres -> paramètres avancés.
...
- Correction des problèmes de délimitation des mots lors du retour à la ligne de longs paragraphes [#86](https://github.com/immersive-translate/immersive-translate/issues/86)
...
- Mots d'invite optimisés pour Gemini
...
- Correction : Pendant la traduction de la page, le survol de la souris ne déclenchait pas la retraduction.
...
- Vous pouvez désormais spécifier une police pour la traduction dans la page des paramètres -> [Paramètres de base] -> [Style de traduction]
...
- **Mise à jour de la version par défaut de Gemini :** La version par défaut est désormais `v1beta`.
...
- **Mise à niveau de l'interface utilisateur du panneau contextuel :** Le nouveau design vise à améliorer l'utilisabilité et la compréhension. Cette mise à jour inclut :
  ...
  - **Nouvelles fonctionnalités dans le menu principal :**
    - **Commutateur de mode bilingue/traduction uniquement :** Vous pouvez désormais basculer entre le "Mode de traduction bilingue" et le "Mode de traduction uniquement" directement dans le menu principal, situé à gauche du bouton de traduction.
...
- **Ajout de support pour 5 sites web vidéo :**
  - Support des sous-titres de podcasts sur Youtube Music.
...
- Optimisation : Lors de l'utilisation du survol de la souris, le problème de perte de focus sur la page puis de re-déclenchement devient inefficace.
- Correction : Le problème où le cache existe toujours après modification de l'invite/modèle dans OpenAI.

## 0.12.12

- Mise à jour : Optimisation du panneau pop-up, suppression de certaines options pour le site web actuel.
...
- Pour les anciennes versions du script Tampermonkey, une alerte de mise à jour a maintenant été ajoutée à la page des paramètres.
...
- Correction du problème de clic saccadé de l'action du panneau de bulle de survol de page Firefox.
...
- La fonctionnalité d'amélioration de la recherche (certaines pages de recherche Google affichent des résultats de recherche bilingues) n'est désormais pas activée par défaut et sera supprimée dans la prochaine Release.
...
- Correction des clics saccadés de la bulle de survol de page
...
- Fonctionnalités Bêta : API personnalisée (Bêta activée dans les paramètres développeur)
...
- Support de la traduction des résultats de l'amélioration de l'entrée ctrl+z Annuler
...
- Résoudre le problème que : le réglage temporaire de la durée de traduction du site web ne prend pas effet.
...
- Fonctionnalité : Ajouter la progression de la traduction pour le constructeur d'ebook, et une belle confetti après succès.
...
- Fonctionnalité : ajouter des options de temps de traduction temporaire du site web dans les `Paramètres avancés`
...
- Correction : ordre incorrect pour long paragraphe
...
- Fonctionnalité : Support de la traduction de pages web en format txt
...
- Fonctionnalité : Support du comptage de texte de traduction immédiate personnalisée pour différents services de traduction.
...
- Meilleur pour la détection du comptage japonais
...
- Fonctionnalité : suppression des espaces authKey, appid appSecret
...
- Correction : icône d'importation/exportation

## 0.2.37

- Correction : marque d'exclusion de cadre
...
- Correction : vitesse de traduction de plusieurs langues
...
- Support de la traduction d'iframe en ligne pour les userscripts.
...
- Correction : construction du userscript
...
- Correction : marquer la ligne de surbrillance

## 0.2.19

- Correction : japonais intelligent de Tencent
- Correction : navigateur haikuo world
...
- Changement de la surbrillance en marque
...
- Correction
  ...
  problème de correspondance des URL de fichier
