...
- ~~Amélioré : Ajout de l'option de personnaliser la "**traduction de la barre latérale et de la barre de navigation**" dans les "**Paramètres avancés**".~~
...
- Optimisation : Page des paramètres, interaction de la liste des URL (pour éviter toute ambiguïté, les cases à cocher ne sont pas affichées par défaut).
...
- **Mise à jour de l'interface utilisateur de la page des paramètres du plugin** :
  ...
  - Ajout d'un tutoriel pour débutants, couvrant les paramètres de la balle flottante, les paramètres des sous-titres vidéo et les paramètres de survol de la souris.
...
- Corriger : les détails de Github ne se traduisant pas après l'expansion.
...
- Correction : Cas très rares de fractionnement de paragraphes.
...
- Correction : Popup manquant pour Userscript sur Firefox.
...
- Fonctionnalité : Support OpenAI multiple keys, utilisez `,` pour les séparer.
...
- Correction : Open AI pour paragraphe avec espace
...
- Correction de la traduction caiyun source language indéfini
...
- Supporter la définition de la zone de la page à traduire. afin que vous puissiez traduire plus de zones.
...
- Ajouter les thèmes en tirets, en papier
...
- Supporter ne pas traduire les hashtags comme #hash, les tags comme @xxx, $tag, comme $APPL
