...
- Ajouté : Prise en charge sur PC pour activer les sous-titres AI de Youtube (membres Pro)
...
- Corrigé : Après avoir changé de service de traduction, le service de traduction dans "**Enhanced Input Box**" ne se met pas à jour.
...
- Corrigé : Les raccourcis deviennent inefficaces lors de l'activation ou de la désactivation de la fonctionnalité "**Hover Translation**".
...
- Fixed: Problème où le contenu disparaît après avoir cliqué sur "voir plus" dans le mode traduction uniquement de Facebook.
...
- Fixed: Problème de traduction des caractères d'espacement en texte enrichi [#2175](https://github.com/immersive-translate/immersive-translate/issues/2175)
...
- Fixed: Problème de traduction en texte enrichi [#2163](https://github.com/immersive-translate/immersive-translate/issues/2163)
...
- Par défaut, la traduction du chinois simplifié vers le chinois traditionnel et vice versa utilisera le mode traduction uniquement, plutôt que le mode comparaison bilingue.
- Fixed: Quelques bugs.

## 1.9.1 (2024-09-03)

- Support pour configurer des exceptions pour les langues et les sites web en mode contraste bilingue ou traduction uniquement (configurer dans la page Paramètres -> Paramètres avancés). Par exemple : Si votre mode de traduction par défaut est le contraste bilingue, mais que vous ne souhaitez pas que le chinois traditionnel utilise également le contraste bilingue, vous pouvez ajouter le chinois traditionnel aux langues d'exception pour le contraste bilingue, de sorte que le chinois traditionnel utilisera le mode traduction uniquement pour la traduction. De même, si votre mode de traduction par défaut est la traduction uniquement, mais que vous souhaitez qu'une certaine langue ou un site web utilise le mode contraste bilingue, vous pouvez également ajouter cette langue ou ce site web aux langues d'exception.
...
- Fixed: Problèmes de traduction en texte enrichi pour les services de traduction tels que Google, DeepL (par exemple, pages affichant directement `<button>` etc.)
...
- Après avoir sélectionné le texte, le menu clic droit changera en [Traduire le texte], en cliquant dessus, vous pouvez automatiquement accéder à la page de traduction de texte Immersive Translation
...
- Correction de l'erreur renvoyée par Gemini
...
- Optimisation des multi-invites OpenAI, prenant en charge le format YAML, ce qui améliore la flexibilité et la facilité d'utilisation de la configuration
- Optimisation significative de la vitesse de traduction des sous-titres YouTube, et ajout de la prise en charge du changement d'ordre entre le chinois et l'anglais, de la personnalisation de la couleur et de la taille de la police, etc.
- La plateforme de sous-titres vidéo prend en charge [l'Université de Southampton](https://southampton.cloud.panopto.eu)
- Les sous-titres bilingues Udemy sont compatibles avec l'affichage mobile
...
- Support de la traduction de pages web et de sous-titres vidéo dans des langues telles que l'arabe, l'hébreu, etc., traitant les problèmes d'affichage RTL (de droite à gauche)
...
- Correction du problème de clic saccadé de l'action du panneau de la bulle de survol de la page Firefox.
...
- Résolution du problème que certaines plateformes ne pouvaient pas reconnaître si la souris était prise en charge ou non
  - Il y a certains navigateurs de bureau qui prennent en charge à la fois l'écran tactile et la souris, et Immersive Translates est techniquement incapable de détecter si de telles plateformes prennent en charge la souris, donc nous avons ajouté l'option [Forcer l'activation du support de la souris] dans le paramètre [Survol de la souris]
...
- Support du survol de la souris appuyez à nouveau sur Ctrl pour afficher le texte original
...
- Réécriture de l'analyse du noyau web, ce qui signifie :
  ...
  - Traduction à grande échelle de pages web en quelques secondes
...
- Dépendance : Mise à jour de pdf.js vers la dernière version
...
- Correction : Détection de la langue de l'ebook.
...
- Correction : innerText de l'élément est indéfini
- Correction : langue source indéfinie pour la traduction caiyun

## 0.2.44

- Correction : bascule du masque userscript
- Correction : logique de bascule du masque

## 0.2.43

- Correction : bascule du masque userscript avec événement tactile.
- Correction de la vitesse (en supprimant sleep(300))

## 0.2.42

- Correction : survol du masque lors de la bascule du masque à nouveau.
- Ajouter des raccourcis de masque pour mobile
- Correction : problème de synchronisation cloud userscript
- Déplacer la page des options avancées vers le menu de gauche.
- Ajouter une logique de réessai au service de traduction

## 0.2.41

- Correction : traduction niu userscript
- Correction : traduction xhtml

## 0.2.40

- Correction : affichage de la fonctionnalité bêta
- Correction : page de réglage du popup sur la nouvelle page d'onglet
- Correction : remplacement de l'espace réservé de traduction

## 0.2.39

- Support des raccourcis pour afficher la traduction du masque
- Support de l'activation de la fonctionnalité bêta sur le panneau de développement
- Correction : raccourcis dans l'extension mobile

## 0.2.38

- Support du thème de chargement
- Correction : getpocket.com
- Correction : pied de page pour la zone du corps
- Correction : icône d'import/export

## 0.2.37

- Correction : marquage d'exclusion de cadre
...
- Correction : balise japonaise rb, rt ignorée.
...
- Correction : traduction volc pour la détection automatique de la langue

## 0.2.34

- Correction : vitesse de plusieurs langues
...
- Correction : traduction de base de PDF
- Correction : sélection du popup d'un service non configuré, aller à la page des options.
- Correction : rester ouvert les paramètres.
- Correction : vitesse de détection de plusieurs langues

## 0.2.31

- Correction : injection css d'iframe dynamique
...
- Correction : traduction Facebook
- Support de l'option de menu contextuel d'affichage.
...
- Support de la traduction d'iframe en ligne. (Seulement pour l'extension, non disponible pour
  userscript)
- Correction : traduction de plusieurs langues

## 0.2.26

- Correction : addon Firefox Android
- Ajouter des paramètres avancés pour la nouvelle ligne de traduction

## 0.2.25

- Support de la traduction d'iframe, comme QQ mail, tweet intégré.

## 0.2.24

- Ajouter un site de traduction temporaire pour un moment
- Correction : API du navigateur userscript stay.app
- Correction : page des options stay.app

## 0.2.23

- Correction : traduction de page en plusieurs langues

## 0.2.22

- Correction : construction de userscript

## 0.2.21

- Correction : traduction de PDF en ligne sur Firefox

## 0.2.20

- Correction : problème de requête macaque
- Correction : marquage de la ligne de surbrillance

## 0.2.19

- Correction : japonais intelligent de Tencent
- Correction : navigateur mondial haikuo

## 0.2.18

- Correction : changement d'url client, rester automatiquement dans l'état de traduction.
- Suppression du conteneur latéral en tant que conteneur de traduction.
- Refactorisation de la position du popup.
...
- Correction : problème de rebond tactile
...
- Correction de l'erreur de séparation de phrase.
...
- Ajout des thèmes en pointillés, thinDashed
