...
- Adicionado: Suporte para ativar legendas AI no Youtube na versão PC (membros Pro)
...
- Novo botão de feedback do utilizador para tradução de mangá (após traduzir um mangá, clique no botão [Feedback] no lado direito da bola de hover para dar feedback sobre a qualidade da tradução).
...
- Corrigir problemas de layout de texto nas traduções de banda desenhada para idiomas no script latino.
...
- Corrigido o problema onde as legendas não são exibidas no YouTube no modo "Apenas Tradução".
...
- Lista de modelos de IA personalizados suporta a sintaxe `-all`, que pode excluir todos os modelos predefinidos.
...
- **Atualização de Configuração do openAI**: Agora suporta definir o número de configurações por segundo em decimais, como 0.5, significando 1 pedido a cada 2 segundos.
