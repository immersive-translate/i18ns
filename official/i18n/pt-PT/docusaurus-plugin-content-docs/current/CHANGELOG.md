...
- Melhorado: Atualizada a interface da lista suspensa do serviço de tradução no painel.
...
- Corrigir os problemas de layout de texto das traduções de banda desenhada para idiomas no alfabeto latino.
...
- Nova funcionalidade: Tradução de IA suporta [modelo grande Doubao](https://www.volcengine.com/product/doubao)
...
- **Otimização da UI**: Redesenho da UI para os avisos de erro de tradução de página para torná-los mais fáceis de entender. Quando há muitos erros, um pop-up irá alertar ativamente o utilizador.
