...
- Otimizado: Compatível com modelos como o1, o3 que não suportam o papel do sistema (o parâmetro do papel do sistema não será passado quando a configuração do System Prompt estiver vazia).
...
- Novo: Tradução de imagem gratuita agora está disponível (atualmente suportada apenas nas versões para PC dos navegadores Chrome e Edge), acessível através do menu de clique direito.
...
- Melhorado: **Especialista em IA** pode ser usado com **Tradução Contextual de IA**.
...
- Adicionado: **Tradução Contextual de IA** pode melhorar a precisão da tradução de conteúdo profissional. (Disponível apenas para membros Pro, suportado exclusivamente por modelos OpenAI) **Opções** -> **Geral** -> **Ativar Tradução Contextual de IA**
...
- Corrigido: Teclas de atalho tornando-se ineficazes ao alternar a funcionalidade "**Tradução ao Passar o Mouse**".
...
- Adicionado: Exibir um aviso quando o idioma de origem e o idioma alvo são os mesmos.
...
- O serviço de tradução DeepL agora suporta oficialmente o Chinês Tradicional como idioma alvo (anteriormente, traduzir para Chinês Tradicional com DeepL envolvia um processo adicional de conversão de Chinês Simplificado para Chinês Tradicional de terceiros).
...
- Fornecido mais artigos arXiv com layout de tradução bilíngue otimizado
...
- Otimizada a detecção para traduções de artigos arXiv
...
- A lista de modelos AI personalizados suporta a sintaxe `-all`, que pode eliminar todos os modelos predefinidos.
...
- Otimizar o desempenho de tradução para grandes arquivos em PDF-Pro
...
- Corrigir conflito de legendas do Youtube com plugin de legendas duplas (Tradução de legendas do Youtube do Immersive Translate não é ativada quando o plugin Dual do Youtube é detectado para evitar conflito).
...
- Tradução da Caixa de Entrada: exibe um lembrete pop-up quando é usado pela primeira vez, e o utilizador pode escolher desativá-lo desta vez ou permanentemente para evitar toques acidentais.
- Otimização da velocidade de exportação apenas de tradução em PDF, se escolher exportar apenas a tradução, pode chamar diretamente a pré-visualização de PDF do sistema para exportar, mais rápido.
...
- Suporte a Melhoria de Pesquisa, quando ativado, quando pesquisa no Google/Google News em chinês, a coluna da direita mostrará automaticamente os resultados de pesquisa das palavras-chave correspondentes em inglês, que está ativado por padrão.
  - Razão: Descobrimos que na pesquisa do Google, os resultados de pesquisa para palavras-chave em chinês e palavras-chave em inglês podem ser muito diferentes, com a Melhoria de Pesquisa Traduzida Imersiva ativada, pesquisamos automaticamente as mesmas palavras-chave em inglês para si e exibimos no lado direito. Pode escolher desativá-lo se não precisar da funcionalidade.
...
- Melhoria da caixa de entrada para mostrar o status de Carregamento na tradução
...
- Reestruturação da análise do núcleo da web, o que significa:
  ...
  - Tradução de páginas web em grande escala em segundos
    - Por exemplo,: https://pve.proxmox.com/pve-docs/pve-admin-guide.html, que antes levava 30 segundos, agora é traduzida em segundos.
...
- Corrigir problema de rebote de toque
