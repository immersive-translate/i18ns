...
- Corrigido o problema em que modificar o idioma alvo e outras configurações no painel popup seria redefinido ao clicar na bola flutuante de tradução.
...
- Otimizados prompts multi-palavras do OpenAI, suportando formato YAML, o que melhora a flexibilidade e facilidade de uso da configuração
...
- Traduzir ebooks bilíngues agora traduzirá o índice também.
...
- Resolvido o problema de que algumas plataformas não conseguiam reconhecer se o mouse era suportado ou não
  - Existem alguns navegadores de desktop que suportam tanto touchscreen quanto mouse, e o Immersive Translates é tecnicamente incapaz de detectar se tais plataformas suportam mouse, então adicionamos a opção [Forçar Ativar Suporte ao Mouse] na configuração [Mouse Hover]
...
- Suporta [Habilitar Membro Pro](/pricing), que permite aos usuários desfrutar de traduções Deepl e OpenAI e configurações de sincronização em nuvem.
...
- Otimizar a limitação de frequência de pedidos do OpenAI
...
- Otimizado para o problema de limite de taxa de pedidos do OpenAI
...
- Melhor para interface popup mais
...
- Corrigir erro de versão da Chrome/Edge Store.
- Corrigir
