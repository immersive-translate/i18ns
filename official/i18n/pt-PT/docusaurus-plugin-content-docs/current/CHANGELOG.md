...
- Melhorado: Acesso à interface de teste do serviço da página de configurações online.
- Melhorado: Melhorada a experiência do usuário da funcionalidade de pré-visualização de comparação de contexto.
...
- Novo: Tradução de imagem gratuita agora está disponível (atualmente suportada apenas em versões PC dos navegadores Chrome e Edge), acessível via menu de clique direito.
...
- Corrigidos problemas de layout de texto nas traduções de banda desenhada para idiomas em script latino.
...
- Nova funcionalidade: Tradução de manga (Beta), em sites de manga suportados, um botão de tradução de manga aparecerá abaixo da bola flutuante de tradução rápida da página. Clicando nele ativará a tradução de manga. Esta funcionalidade está disponível para membros Pro (500 páginas por mês, pacotes adicionais podem ser comprados), atualmente suportando os seguintes sites:
...
- **Otimização da UI**: Redesenhou-se a UI para os avisos de erro de tradução de página para torná-los mais fáceis de entender. Quando há muitos erros, um pop-up irá avisar ativamente o utilizador.
...
- Corrigir problema de tradução com a chave de autenticação personalizada do DeppL
...
- Corrigir: problema de caractere específico do construtor de ebook, como algum caminho de capítulo é `xxx' xxxx`.
...
- Corrigir: tradução de ficheiro PDF falhou, Bug da versão 0.2.60 para suportar deepl de zh-CN para zh-TW

## 0.2.65

- Suporte para pedido de limitação para múltiplos frames
- Não traduzir título da página quando em iframe

## 0.2.64

- Corrigir: escolha de serviços de tradução openl
- Funcionalidade: Suporte para opção de tradução de título
...
- Melhor: reduzir tamanho do ficheiro

## 0.2.60

- Funcionalidade: Suporte para zh-CN para zh-TW para Deepl
- Funcionalidade: Funcionalidade Deepl do Immersive Translate
...
- Remover permissão de abas para rejeição da loja chrome
...
- aumentar a versão para teste ci
...
- Alterar interface do popup, para facilitar o uso
...
- Corrigir tamanho da fonte da interface de opções
...
- Adicionar interface de opções
- Suporte para detectar mais contêineres de conteúdo

## 0.0.37

- Corrigir alteração de serviço de tradução do popup não funcionar
...
- Suporte para definir o modo de tradução imediata, para que você possa deixar a página da web traduzir
...
- Mais interface de configuração
- Refletir o tema
...
- Corrigir permissão de conexão do userscript do volc alpha.
...
- Suporte para interface básica do popup
