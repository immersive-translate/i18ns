...
- Adicionado: Funcionalidade de tradução de seleção de texto
- Adicionado: Gestão da biblioteca de terminologia AI
- Adicionado: Suporte para ativar legendas AI no Youtube em PC (membros Pro)
...
- Melhorado: Atualizado o estilo da bola flutuante
...
- Adicionado: Deepseek, Gemini, Claude suportam mudança de contexto.
...
- Corrigido: Resolvido problema de arquivo de configuração do utilizador exceder o limite de tamanho.
...
- Melhorado: Experiência do utilizador melhorada da funcionalidade de pré-visualização de comparação de contexto.
- Melhorado: Lógica de julgamento do modo de toque e rato.
...
- Corrigido: Problema com deteção incorreta de idioma na **Caixa de Entrada Melhorada**.
...
- Melhorado: Falha na tradução de manga em sites como shonenjumpplus no navegador Safari.
...
- Melhorado: Quando o idioma da interface está definido para Inglês, o idioma alvo padrão para a **Caixa de Entrada Melhorada** é alterado para Chinês.
...
- Corrigido: o problema de números decimais serem forçadamente quebrados em linha ao traduzir textos longos.
...
- Corrigido: Após mudar serviços de tradução, o serviço de tradução na "**Caixa de Entrada Melhorada**" não atualiza.
...
- Melhorado: Exibição melhorada de tradução bilíngue multilinha no Twitter e Youtube.
- Melhorado: Tradução de texto rico é desligada por padrão no modo bilíngue para melhorar a qualidade da tradução.
...
- Adicionado: Exibir um aviso quando a língua de origem e a língua alvo são as mesmas
...
- Otimizada a lógica de cache do plugin, agora limpando automaticamente dados de cache que têm mais de 30 dias.
...
- DeepL, Microsoft Translate, Google Translate, OpenAI, Claude, Gemini e outros serviços de tradução suportam tradução para reter o formato original do texto (por exemplo, links, negrito, etc.)
- Após selecionar o texto, o menu de clique direito mudará para [Traduzir o texto], clicando no qual você pode automaticamente pular para a página de Tradução de Texto Imersiva
- Novo serviço de tradução gratuito para grandes modelos: SiliconCloud, disponível para todos os utilizadores.
...
- Novo botão de feedback do utilizador para tradução de mangá (após traduzir um mangá, clique no botão [Feedback] no lado direito da bola flutuante para dar feedback sobre a qualidade da tradução).

## 1.7.7

- Adotado algoritmo de divisão de frases inteligente por IA para legendas automáticas em inglês no YouTube [Pro Disponível]
- Otimizar a tradução do clique direito para "Traduzir para xx idioma alvo"
...
- Legendas bilíngues do YouTube agora suportam divisão inteligente de frases (Beta) (Apenas quando ativar manualmente a tradução imersiva de legendas do YouTube em [Configurações] - [Legendas de Vídeo], e as legendas originais do vídeo são legendas automáticas em inglês)
...
- Nova funcionalidade: Suporte para modo de comparação bilíngue com tradução primeiro e texto original em seguida, que pode ser ativado na página de configurações -> configurações avançadas.
...
- Otimizadas palavras de prompt para serviços de tradução de IA
...
- Suporte à plataforma de legendas de vídeo [DeepLearning.ai](https://learn.deeplearning.ai)
- Suporte para tradução de páginas web e legendas de vídeo em idiomas como árabe, hebraico, etc., abordando problemas de exibição RTL (da direita para a esquerda).
...
- Suporte à tradução de legendas de vídeo [Unreal Sensei](https://www.unrealsenseiacademy.com/).
...
- **Otimização da Tradução Japonesa:** Otimização adicional da tradução japonesa do OpenAI para melhorar a precisão e fluência.
...
- Adicionado um modo de tradução apenas na página de configurações.
...
- **Otimização da UI**: Redesenhada a UI para os avisos de erro de tradução de página para torná-los mais fáceis de entender. Quando há muitos erros, um pop-up irá alertar ativamente o utilizador.
...
- [Suporte de bola flutuante configurado para ser fixado à esquerda #1168](https://github.com/immersive-translate/immersive-translate/issues/1168)
...
- Páginas PDF online sem extensão .pdf agora podem saltar diretamente para a página de tradução de PDF clicando na bola flutuante na página.
...
- Resolvido o problema de que algumas plataformas não conseguiam reconhecer se o mouse era suportado ou não
  - Existem alguns navegadores de desktop que suportam tanto touchscreen quanto mouse, e o Immersive Translates tecnicamente não consegue detectar se tais plataformas suportam mouse, então adicionamos a opção [Forçar Ativar Suporte a Mouse] na configuração [Mouse Hover]
...
- Suporte para configurar botões de tradução rápida da bola flutuante (suporte para PC/móvel)
...
- Corrigir conflito de legendas do Youtube com o plugin de legendas duplas (a tradução de legendas do Youtube do Immersive Translate não é ativada quando o plugin de legendas duplas do Youtube é detectado para evitar conflitos)
- Adicionado [Desativar Permanentemente a Função de Legendas de Vídeo], caso haja outros problemas de conflito e você não queira ativar a função de legendas bilíngues com o Immersive Translate.
- Otimizar quebras de legendas

## 0.10.3

- Corrigir problema de tradução com chave de autenticação personalizada do DeepL
...
- Otimização da velocidade de exportação de tradução apenas para PDF, se você escolher exportar apenas a tradução, pode chamar diretamente a pré-visualização do PDF do sistema para exportar, mais rápido.
...
- Funcionalidades Beta: API Personalizada (Beta ativado nas configurações do desenvolvedor)
...
- Suporta [Habilitar Pro Membership](/pricing), que permite aos usuários desfrutar de traduções Deepl e OpenAI e configurações de sincronização em nuvem.
...
- Suporte a Aprimoramento de Pesquisa, quando ativado, quando você pesquisa no Google/Google News em chinês, a coluna da direita mostrará automaticamente os resultados da pesquisa de palavras-chave correspondentes em inglês, que está ativado por padrão.
...
- Otimizar: O número mínimo de caracteres num parágrafo que desencadeia a tradução foi modificado para um mínimo de 4 caracteres para reduzir a confusão, enquanto se utilizam outras funcionalidades para evitar traduzir as áreas de navegação e fim do site.
- Corrigir: detalhes do Github não traduzidos após a expansão.

## 0.5.14

- Corrigir o problema de que as imagens em algumas páginas web: ficam maiores após a cópia
- Corrigir: secção de comentários do medium não traduzida
- Corrigir o problema de que as imagens em algumas páginas: foram copiadas incorretamente
...
- Uma excelente página de orientação de configuração inicial para novos utilizadores de iOS.
...
- Otimizar problema de limitação de frequência de pedidos OpenAI

- ChatGPT por padrão para o modelo móvel, que é mais rápido!
...
- Todas as traduções do site ShadowRoot são suportadas.
  ...
  - Por exemplo, a secção de comentários de: https://news.yahoo.com/gma/virginia-mom-facing-charges-6-190600893.html

- Corrigir o problema de tela branca após a tradução de sites com hidratação, como Next.js.

  - Por exemplo: https://webpack.js.org/

- Corrigir o problema de que modificar o atalho de passar o rato precisava de atualizar a página para ter efeito
...
- Otimizado para o problema de limite de taxa de pedidos OpenAI
...
- Corrigir o problema em que mudar o atalho de passar o rato exigia uma atualização da página para ter efeito

- Corrigir o problema com o reconhecimento de quebras de linha em arquivos TXT.

## 0.5.6

- Corrigir: problema de popup de nova aba no macOS.
- Funcionalidade: Nova página de guia para novos utilizadores.

## 0.5.5

- Corrigir: problema de área de passar o rato.
...
- Corrigir: ouvinte de tecla de atalho de passar o rato.
- Corrigir: tradução de documento PDF
- Funcionalidade: Adicionar nova página de guia do cliente

## 0.5.2

- Corrigir: configurações de atalhos de passar o rato do userscript

## 0.5.1

- Corrigir: API OpenAI não funciona.

## 0.5.0

- Funcionalidade: Traduzir o parágrafo atual ao passar o rato.
- Funcionalidade: Refatorar tradução de PDF, agora pode traduzir a maioria dos PDFs com Immersive Translate
...
- Corrigir: popup de Userscript do Firefox ausente.

## 0.4.6

- Funcionalidade: Permitir que terceiros enviem evento de documento para chamar `toggleTranslatePage`
- Funcionalidade: app iOS adiciona botão de ativar extensão e link de comunidades
- UI: modelo de campo de configurações OpenAI usa seleção em vez de caixa de entrada de texto.

## 0.4.5

- Corrigir: problema de extensão safari no iOS 15.0.
- Corrigir: atalhos de extensão safari no macOS
- Corrigir: popup de política de segurança de conteúdo para extensão, e parcialmente para userscript.
...
- Remover: Remover Papago, pois [o serviço está inativo](https://github.com/immersive-translate/immersive-translate/issues/310)
...
- Adicionar opção de comprimento máximo de texto por pedido com Open AI
- Corrigir: identificador de ebook duplicado
- Funcionalidade: Suporte para tradução de página web em txt
...
- Funcionalidade: Permitir que o Formulário de entrada de palavra-passe mostre a palavra-passe.

## 0.2.82

- Corrigir: Alguns sites usam `span` para estilos, por isso usamos `font` em vez de span para o wrapper de tradução alvo
- Corrigir: Limite máximo de tokens do OpenAI, alterar caracteres máximos de 1500 para 1300.

## 0.2.81

- Corrigir: m.youtube.com
- Corrigir: UI do formulário de opções
- Corrigir: prompt do Open AI
- Funcionalidade: Suporte para múltiplas chaves OpenAI, use `,` para separá-las.
...
- Funcionalidade: suporte para OpenAI CHATGPT 3.5 (suporta interface OpenAI ChatGPT 3.5)
...
- Funcionalidade: Suporte para Tencent (alpha)
- Corrigir: tradução openai
- Corrigir: verificação de tags desconhecidas inline

## 0.2.73

- Funcionalidade: Suporte para Tema de Tradução Cinza
- Corrigir: Página de Tendências do Github

## 0.2.72

- Corrigir: problema de rede de verificação de serviço de tradução no firefox mobile.
...
- Funcionalidade: Suporte para Open AI como serviço de tradução.
- Funcionalidade: Suporte para verificar serviço de tradução em options.html
- Funcionalidade: Suporte para frame principal personalizado, pois alguns sites não usam body como frame principal
...
- Corrigir: configuração de tradução do Azure, mas ainda mostra (necessário configurar)
...
- Suporte para limitar pedidos para múltiplos frames
...
- Desempenho: pedidos em série para concorrência
- Melhor para detecção de contagem de japonês
...
- Funcionalidade: Suporte para zh-CN para zh-TW para Deepl
- Funcionalidade: Recurso de Tradução Imersiva Deepl
...
- Suporte para URL personalizado a partir da Configuração embutida
...
- Suporte para ativar recurso beta no painel de desenvolvedor
...
- Corrigir ignorar tag rb, rt em japonês.
...
- Corrigir problema de salto de toque
...
- Suporte para usar três dedos em dispositivos de toque para acionar a alternância de tradução de páginas
...
- Corrigir a distância entre linhas em pdf
...
- Corrigir pedido do grease monkey
...
- Corrigir mudança de elemento preventivo em telegra.ph
...
- Corrigir tradução de imagem de bloco.
...
- Corrigir tradução duplicada ao mudar de tradução
- Melhor UI do popup
...
- Corrigir validade do parágrafo.
