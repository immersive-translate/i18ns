...
- Corrigido: Problema com a detecção incorreta de idioma na **Caixa de Entrada Aprimorada**.
...
- Otimizada a cobertura de configurações de sincronização em nuvem
...
- Otimização significativa da velocidade de tradução de legendas do Youtube, e adicionado suporte para alternar entre ordem Chinês e Inglês, personalizar cor e tamanho da fonte, etc.
...
- Otimizada a interface de usuário do pop-up de erro.
...
- **Atualização da Interface da Página de Configurações do Plugin**:
  ...
  - Em "Configurações Avançadas", uma nova opção foi adicionada para permitir que os utilizadores especifiquem certas palavras (por exemplo, "LLM") para serem excluídas da tradução.
...
- **Otimização da Interface de Usuário**: Redesenhada a interface de usuário para avisos de erro de tradução de página para torná-los mais fáceis de entender. Quando há muitos erros, um pop-up irá ativamente avisar o utilizador.
...
- Suporte a ajustes de espaçamento de linha e espaçamento de palavras em pdf para re-reconhecer parágrafos
...
- Otimizado para o problema de limite de taxa de solicitações do OpenAI
...
- Feat: Suporte à verificação do serviço de tradução em options.html
- Feat: Suporte a frame principal personalizado, pois alguns sites não usam body como frame principal
...
- Feat: suporte a css injetado no painel de desenvolvedor
...
- Suporte a tradução de iframe, como QQ mail, tweet embutido.
...
- Corrigir mudança de URL do cliente, auto manter o estado de tradução.
...
- Adicionar opção de log de debug para desenvolvedores
