...
- Adicionado: Grok, Ollama, Groq, Azure-OpenAI serviço de tradução.
...
- Melhorado: Lógica de julgamento do modo toque e mouse.
...
- Corrigido: Após mudar serviços de tradução, o serviço de tradução na "**Enhanced Input Box**" não atualiza.
...
- Adicionado: Tradução de **Subtitles Translation** em tempo real agora suporta ativação via "float ball", disponível no Zoom, Google Meet e Microsoft Teams.
...
- Serviços de tradução por IA agora podem personalizar a lista de modelos, como [OpenAI], o sistema só tem alguns dos modelos mais usados embutidos. Clicando na lista suspensa de modelos, o último item que você vê é [Definir Mais Modelos], após a configuração, será automaticamente lembrado para a conveniência dos usuários testarem diferentes modelos personalizados.
...
- Corrigido o desaparecimento de legendas em tela cheia no Safari do iOS
...
- **Otimização de UI**: Redesenhada a interface do usuário para avisos de erro de tradução de página para torná-los mais fáceis de entender. Quando há muitos erros, um pop-up irá ativamente alertar o usuário.
...
- A ferramenta de tradução PDF foi migrada para a versão online: https://app.immersivetranslate.com/pdf/ , para que Grease Monkey e Safari possam usar a tradução PDF, e os problemas podem ser melhor iterados sem a necessidade de emitir uma versão para resolver o problema.
...
- correção do problema de rolagem automática em leitura móvel online de epub
...
- Funcionalidade: aplicativo iOS adiciona botão de ativação de extensão e link de comunidades
...
- Corrigir: sincronização do google drive nativa no firefox android.
...
- Corrigir erro de divisão de tencent.
...
- Suporte para definir a primeira contagem de x textos para traduzir imediatamente.
...
- Adicionar ficheiro js dist ao repositório público
