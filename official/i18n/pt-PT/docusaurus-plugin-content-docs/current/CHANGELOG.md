...
- Melhorado: Aprimoramento do renderização de fórmulas traduzidas
...
- Corrigir os problemas de layout de texto das traduções de quadrinhos para idiomas no alfabeto latino.
...
- Quando especialistas em IA são usados para "Intelligent Selection", diferentes especialistas em IA podem ser personalizados para diferentes sites. Isso pode ser configurado em [Settings] -> [AI Experts] -> [Enter any expert].
...
- Lista de modelos de IA personalizados suporta sintaxe `-all`, que pode deletar todos os modelos predefinidos.
...
- Suporte para adicionar serviços de tradução de IA personalizados compatíveis com OpenAI, acessível na parte inferior da página [Settings]->[Translation Services].
...
- Suporte para serviços de tradução de IA para definir [AI Expert] para especificar a estratégia de tradução, atualmente um recurso Beta, que pode ser ativado em [Developer Settings](https://dash.immersivetranslate.com/#developer) após ativar o Beta, e o menu [AI Expert] pode ser visto após atualizar.
- Serviços de tradução de IA agora podem personalizar a lista de modelos, como [OpenAI], o sistema só tem alguns dos modelos mais comumente usados embutidos. Clicando na lista suspensa de modelos, o último item que você vê é [Set More Models], após configurar, será automaticamente lembrado para a conveniência dos usuários testarem diferentes modelos personalizados.
...
- Adicionada uma funcionalidade temporária para habilitar edição de tradução na entrada "More" do painel
...
- Suporte para selecionar o serviço de tradução padrão na página Settings -> Translation Service
...
- Otimização dos pop-ups de erro, os pop-ups de erro de problema de rede detectam automaticamente serviços de tradução gratuitos válidos.
...
- **Otimização da UI**: Redesenhada a UI para os avisos de erro de tradução de página para torná-los mais fáceis de entender. Quando há muitos erros, um pop-up irá ativamente alertar o utilizador.
...
- Otimizado: Ao usar o mouse hover, o problema em que perder o foco na página e depois reativar torna-se ineficaz.
...
- Corrigir a criação de Epubs clicando no painel em traduções que não funcionam
...
- [Suporte a bola flutuante configurada para ser fixada à esquerda #1168](https://github.com/immersive-translate/immersive-translate/issues/1168)
...
- Adicionado um portal de tradução rápida de PDF ao lado direito do site de artigos [Arxiv](https://arxiv.org/abs/1910.06709), que vai para uma página HTML limpa (apenas suportado por alguns artigos, pois requer que os autores originais submetam o código-fonte, então aproximadamente 50% dos artigos mostrarão este portal)
...
- Resolvido o problema de que algumas plataformas não conseguiam reconhecer se o mouse era suportado ou não
  - Existem alguns navegadores de desktop que suportam tanto touchscreen quanto mouse, e o Immersive Translates é tecnicamente incapaz de detectar se tais plataformas suportam mouse, então adicionamos a opção [Forçar Ativar Suporte a Mouse] na configuração [Mouse Hover]
...
- Corrigir problema de tradução com a Chave de Autenticação Custom DeppL
...
- Otimizar tradução de arquivos de legendas pelo OpenAI para contextualização
...
- Funcionalidades Beta: API Customizada (Beta ativada nas configurações do desenvolvedor)
...
- Otimização de tradução de PDF, área de tradução agora pode ser editada/arrastada/excluída
  - Arrastar canto superior esquerdo, excluir canto superior direito, alterar tamanho canto inferior direito
...
- Corrigir: seção de comentários do medium não traduzida
...
- Corrigir: detecção de espaço em branco da tag sup, sub.
...
- Corrigir: estado de entrada dos serviços de tradução de switch UI de Opções não alterado.
...
- Funcionalidade: Suporte a múltiplas chaves do OpenAI, use `,` para separá-las.
...
- Corrigir o problema do safari globalThis.GM não funcionar
...
- Corrigir a distância da altura da linha do pdf
...
- Corrigir exibição de elemento nenhum.
