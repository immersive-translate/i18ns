...
브라우저 오른쪽 상단의 확장 프로그램 아이콘을 클릭하고 [【설정】](https://dash.immersivetranslate.com/)을 클릭하면 확장 프로그램의 설정 페이지로 들어갈 수 있습니다.
...
[더 많은 웹사이트 지원 요청 또는 문제 피드백](https://github.com/immersive-translate/immersive-translate/issues/1809)
