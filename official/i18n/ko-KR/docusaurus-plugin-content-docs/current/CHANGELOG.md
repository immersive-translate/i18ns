...
- 개선: 사이드바 텍스트 번역 경험을 개선했습니다.
- 개선: 온라인 자막 번역 요청이 이제 번역 서비스의 단락 수 제한에 따라 제어됩니다.
- 개선: 403 / Cloudflare 오류 대화상자 메시지를 개선했습니다.
- 추가: 팝업의 더 많은 기능에 번역 캐시 토글을 추가했습니다.
- 추가: 자막 번역에 사이트별 독립 토글을 추가했습니다.

## 1.29.6 Release (2026-05-20)

- 개선: 소수 언어 시나리오에서 [텍스트 선택 번역]의 발음 표기와 번역 결과를 개선했습니다.
- 수정: 회원의 맞춤 AI 전문가가 동기화 중 덮어써질 수 있던 문제를 수정했습니다.
- 추가: toptoon.com 만화 사이트 번역을 지원합니다.
...
- 추가: plamo 번역 서비스를 지원합니다.
- 개선: 번역문만 모드에서 RTL 언어의 레이아웃 마커를 개선했습니다.
- 개선: 일부 영어 용어의 복수형 매칭 성능을 개선해 용어 매칭 누락을 줄였습니다.
- 수정: Teams 자막 번역 시 자막이 흔들리는 문제를 수정했습니다.
- 수정: [텍스트 선택 번역]이 ShadowRoot 환경에서 단어를 정상적으로 가져오지 못하는 문제를 수정했습니다.
...
- 수정: DeepSeek 사용자 지정 API Key `401: Authentication Fails` 오류.
...
- 개선: **이미지 번역**이 이제 weibo.com 과 호환 (Chrome 및 Edge 에서만 지원).
...
- 추가: Pro 멤버는 이제 **zhipu 4.5** 모델을 직접 사용할 수 있음.
- 개선: Gemini 번역.
...
- 개선: Twitter 의 경우, 다중 라인 콘텐츠 번역은 기본적으로 줄 바꿈이 설정되지 않음. 콘텐츠가 10 줄 또는 1000 자를 초과할 때만 줄 바꿈이 발생. 줄 바꿈은 설정 **고급 설정** -> **긴 단락에 대한 자동 줄 바꿈 활성화**를 통해 활성화 가능.
...
- 개선: **x.com**에서 번역 시, 자막이 있는 비디오는 자동으로 이중 언어 자막 번역.
...
- ~~개선: "**고급 설정**"에서 "**사이드바 및 네비게이션 바 번역 활성화**"를 사용자 지정할 수 있는 옵션 추가.~~
- 개선: "**호버 - 즉시 이 단락 번역**" 모드에서 이미지는 더 이상 번역되지 않음.
...
- ~~개선: Twitter 에서 다중 라인 이중 언어 번역의 표시 향상.~~
- 개선: 패널의 번역 서비스 드롭다운 목록 UI 업데이트.

## 1.11.1 (2024-11-05)

- 추가: 실시간 회의 **자막 번역**이 이제 "플로트 볼"을 통해 활성화 가능, Zoom, Google Meet, Microsoft Teams 에서 사용 가능.
...
- 수정: 리치 텍스트 공백 문자 번역 문제 [#2175](https://github.com/immersive-translate/immersive-translate/issues/2175).
...
- 수정: 리치 텍스트 번역 문제 [#2163](https://github.com/immersive-translate/immersive-translate/issues/2163).
...
- [PDF Pro](https://app.immersivetranslate.com/pdf-pro/)는 수식 복사를 지원 (수식을 오른쪽 클릭하여 복사 메뉴 확인)
...
- 타사 웹사이트를 위한 몰입형 [JS SDK](https://immersivetranslate.com/docs/js-sdk/) 통합 지원
- Hulu 자막 표시 최적화
...
- 모든 사용자가 몰입형 번역 인터페이스의 다국어 번역에 [온라인 기여](https://weblate.immersivetranslate.com/projects/immersive-translate/extension/)할 수 있습니다.
...
- 새로운 기능: AI 번역이 [Doubao large model](https://www.volcengine.com/product/doubao)을 지원합니다.
...
- 일반 전문가 프롬프트 변경이 지정된 AI 전문가 프롬프트를 덮어쓰는 문제를 수정했습니다 [#1692](https://github.com/immersive-translate/immersive-translate/issues/1692).
...
- YouTube 가 전체 화면일 때 글꼴 크기가 비례적으로 조정되지 않는 문제를 수정했습니다 [#1681](https://github.com/immersive-translate/immersive-translate/issues/1681).

## 1.5.1

- AI 번역 서비스는 [AI Expert]를 설정하여 번역 전략을 지정할 수 있으며, 현재 Beta 기능으로, [개발자 설정](https://dash.immersivetranslate.com/#developer)에서 Beta 를 활성화한 후 새로 고침하면 [AI Expert] 메뉴를 볼 수 있습니다.
...
- 자막이 없는 YouTube Shorts 가 항상 이전 비디오의 자막을 표시하는 문제를 수정했습니다 [#1655](https://github.com/immersive-translate/immersive-translate/issues/1655).
...
- 번역 서비스가 이제 별도의 탭 아래에 명확하게 정리되어 모든 사용 가능한 번역 서비스를 포괄적으로 볼 수 있습니다. 또한 사용자는 표시할 번역 서비스를 사용자 정의할 수 있는 유연성을 가지고 있습니다. 기본적으로 제한된 번역 서비스만 표시되지만, 사용자는 [More Services](https://dash.immersivetranslate.com/#services) 섹션에서 표시 환경 설정을 조정할 수 있습니다.
...
- Claude 라는 임시 번역을 위한 새로운 바로 가기가 도입되었으며, [Shortcut Settings page](https://dash.immersivetranslate.com/#shortcuts)에서 구성할 수 있습니다.
...
- 비디오 자막 플랫폼은 [DeepLearning.ai](https://learn.deeplearning.ai)를 지원합니다.
...
- 비디오 자막 번역은 [Unreal Sensei](https://www.unrealsenseiacademy.com/)를 지원합니다.
...
- [pluto](https://pluto.tv/), [STARZ](https://www.starz.com/), [Paramount Plus](https://www.paramountplus.com/), [Rotten Tomatoes](https://www.rottentomatoes.com/), [Dailymotion](https://www.dailymotion.com/), [FMovies](https://fmoviesz.to/), [AniWatch](https://aniwatch.to/), [iQIYI](https://www.iq.com/), [Youku](https://www.youku.tv/), [movie-web](https://movie-web.app/)에 대한 비디오 자막 번역 지원. 또한 Twitter 의 일부 CC 자막 비디오 번역 지원.
- 오류 팝업 최적화, 네트워크 문제 오류 팝업이 유효한 무료 번역 서비스를 자동으로 감지.
- YouTube 전체 화면 재생에 대한 몰입형 iOS 앱 지원 문제 수정.
- Perplexity.ai 의 단락 번역 문제 수정 [#707](https://github.com/immersive-translate/immersive-translate/issues/707).

## 1.2.1

- [Kanopy](https://www.kanopy.com/), [RachelsEnglishAcademy](https://www.rachelsenglishacademy.com/), [Hulu](https://www.hulu.com/), [Three.js Journey](https://threejs-journey.com/)에 대한 비디오 자막 번역 지원.
...
- [Amazon Prime Video](https://www.primevideo.com)의 이중 언어 자막 지원
...
- `Ctrl+C`를 `Ctrl`로 잘못 인식하지 않도록 마우스 호버 감도 최적화
- 비디오 자막이 내장된 기계 번역 자막을 사용할지 여부를 빠르게 전환할 수 있는 새로운 바로 가기 설정 추가
...
- **고전 중국어 번역 수정:** Microsoft 및 OpenAI 의 고전 중국어 번역 기능 수정.
...
- 수정: 일부 경우 OpenAI 긴 단락 번역 연결 문제. [#1276](https://github.com/immersive-translate/immersive-translate/issues/1276)
...
- 추가됨: [ArtStation](https://www.artstation.com/learning) 학습 플랫폼과 [ZDF](https://www.zdf.de/)에 대한 이중 언어 자막 지원.
- 수정됨: jstor 목록 페이지의 제목이 번역되지 않는 문제 해결 [#1268](https://github.com/immersive-translate/immersive-translate/issues/1268).
- 수정됨: Hacknews 에서 일부 콘텐츠만 사라지는 문제 해결 [#1264](https://github.com/immersive-translate/immersive-translate/issues/1264).
...
- [웹페이지 번역을 일시적으로 켜고 오랜 시간 동안 패널 [항상 이 웹사이트 번역]을 클릭해도 항상 번역이 취소되지 않는 문제 #1172](https://github.com/immersive-translate/immersive-translate/issues/1172) 수정.
...
- [Arxiv](https://arxiv.org/abs/1910.06709) 논문 사이트에서 모든 논문의 이중 언어 버전에 빠르게 접근할 수 있는 기능 제공.
- [호버볼이 왼쪽에 고정되도록 설정 #1168](https://github.com/immersive-translate/immersive-translate/issues/1168)
- [학습 모드 표시 문제 수정 #1180](https://github.com/immersive-translate/immersive-translate/issues/1180)
- [웹 번역을 일시적으로 켜고 오랜 시간 동안 항상 번역이 취소되지 않는 문제 #1172](https://github.com/immersive-translate/immersive-translate/issues/1172)
- PDF 파일 초기화 문제 최적화.
...
- 확장된 PDF 다운로드 문제 수정.
- [Arxiv](https://arxiv.org/abs/1910.06709) 논문 사이트의 오른쪽에 빠른 번역 PDF 포털 추가, 깨끗한 HTML 페이지로 이동 (일부 논문만 지원, 원저자가 소스 코드를 제출해야 하므로 약 50% 의 논문이 이 포털을 표시).
...
- 사용자 정의 규칙이 이제 기본 내장 규칙과 병합을 지원합니다. 예: `{"id": "youtube", "selectors.add":["#test"]}`는 기존 선택기에 `#test`를 추가하는 것을 의미하며, `selectors`는 기본값을 덮어쓰고, `selectors.remove`는 기본 선택기 중 하나를 삭제하는 것을 의미합니다.
...
- 기본 설정 수정: 많은 사용자가 설치 후 번역 도구를 사용하지 않을 것이라는 피드백을 받았으며, 번역 도구에 대한 기대는 설치 후 자동으로 영어 웹 페이지를 번역하는 것이므로, 이 버전부터 중국 사용자에게는 기본적으로 영어 페이지 번역 옵션이 활성화되었습니다 (사용자가 항상 번역할 언어를 이전에 설정한 경우 이를 존중하며, 변경은 확장의 초기 설정만 수정합니다). 이를 취소하려면 [팝업 패널 또는 설정 페이지](/docs/faq/#%E5%A6%82%E4%BD%95%E5%85%B3%E9%97%AD%E8%87%AA%E5%8A%A8%E7%BF%BB%E8%AF%91)에서 쉽게 취소할 수 있습니다.
...
[여기를 클릭하여 30 초간의 빠른 소개를 확인하세요](/docs/input/)
...
- ShadowRoot 의 모든 웹사이트 번역 지원.
  ...
  - 예를 들어, 댓글 섹션: https://news.yahoo.com/gma/virginia-mom-facing-charges-6-190600893.html
...
- 수정: 컨텍스트 메뉴 비활성화가 작동하지 않음 [#428](https://github.com/immersive-translate/immersive-translate/issues/428)
...
- 기능: 로컬 .txt 파일 번역 지원.
- 수정: 컨텍스트 메뉴가 가끔 사용 불가능한 문제. [#273](https://github.com/immersive-translate/immersive-translate/issues/273)
...
- 수정: 일부 사이트가 스타일에 `span`을 사용하므로 번역 대상 래퍼에 span 대신 `font` 사용
- 수정: OpenAI 최대 토큰 제한, 최대 문자 수를 1500 에서 1300 으로 변경.
...
- 수정: 여러 코드 태그 오류.[#178](https://github.com/immersive-translate/immersive-translate/issues/178)
...
- google drive 업로드 문제 수정 (정말로) [#81](https://github.com/immersive-translate/immersive-translate/issues/81)

## 0.2.49

- 기본 단축키와 충돌할 수 있으므로 단축키 alt+d, alt+s 제거.
- google drive 업로드 문제 수정 [#81](https://github.com/immersive-translate/immersive-translate/issues/81)
...
- 수정
  ...
  Annas archive 페이지의 주요 콘텐츠를 번역할 수 없음
...
- 번역을 토글하는 기본 단축키가 `alt+A`로 변경되었습니다. 이는 가장 편리한 키입니다.
