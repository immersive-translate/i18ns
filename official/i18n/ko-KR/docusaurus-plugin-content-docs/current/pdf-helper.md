...
만약 여러분의 PDF에 표와 수학 공식이 포함되어 있고, 이들에 대해 더 높은 품질의 번역을 원한다면, 우리의 [PDF PRO](https://app.immersivetranslate.com/pdf-pro/)를 체험해 보세요.
...
문제 설명과 스크린샷을 PDF 원본과 함께 support@immersivetranslate.com으로 보낼 수 있습니다. PDF 상황을 확인하고, 계획을 세워 지능형 인식 규칙에 포함시킬 예정입니다.